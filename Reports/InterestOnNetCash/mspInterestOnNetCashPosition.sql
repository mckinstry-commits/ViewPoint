...
--sp_helptext mckvJCWIPCashFlowContractActive 10086

use Viewpoint 
go

if exists ( select 1 from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME='mspInterestOnNetCashPosition' and ROUTINE_SCHEMA='dbo' and ROUTINE_TYPE='PROCEDURE' )
begin
	print 'DROP PROCEDURE dbo.mspInterestOnNetCashPosition'
	DROP PROCEDURE dbo.mspInterestOnNetCashPosition
end
go

print 'CREATE PROCEDURE dbo.mspInterestOnNetCashPosition'
go

CREATE PROCEDURE dbo.mspInterestOnNetCashPosition(
	@JCCo bCompany = null
...
BEGIN
	...
	,	coalesce(r.ThroughMonth, c.ThroughMonth) as ThroughMonth
...
grant exec on dbo.mspInterestOnNetCashPosition to Viewpoint
grant exec on dbo.mspInterestOnNetCashPosition to public
...
exec dbo.mspInterestOnNetCashPosition @JCCo=@JCCo, @Contract=@Contract, @Month=@Month
