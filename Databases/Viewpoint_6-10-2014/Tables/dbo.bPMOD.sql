...
GO
ALTER TABLE [dbo].[bPMOD] WITH NOCHECK ADD CONSTRAINT [FK_bPMOD_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
...
GO
ALTER TABLE [dbo].[bPMOD] NOCHECK CONSTRAINT [FK_bPMOD_bPMDT]
GO
ALTER TABLE [dbo].[bPMOD] NOCHECK CONSTRAINT [FK_bPMOD_bJCJM]
GO
ALTER TABLE [dbo].[bPMOD] NOCHECK CONSTRAINT [FK_bPMOD_bPMSC]
GO
ALTER TABLE [dbo].[bPMOD] NOCHECK CONSTRAINT [FK_bPMOD_bPMFM]
GO
ALTER TABLE [dbo].[bPMOD] NOCHECK CONSTRAINT [FK_bPMOD_bPMPM]
GO
