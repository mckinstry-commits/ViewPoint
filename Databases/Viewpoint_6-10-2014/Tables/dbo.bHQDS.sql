...
GO
ALTER TABLE [dbo].[bHQDS] WITH NOCHECK ADD CONSTRAINT [CK_bHQDS_YNBeginStatus] CHECK (([YNBeginStatus]='Y' OR [YNBeginStatus]='N'))
GO
ALTER TABLE [dbo].[bHQDS] WITH NOCHECK ADD CONSTRAINT [CK_bHQDS_YNComplete] CHECK (([YNComplete]='Y' OR [YNComplete]='N'))
GO
