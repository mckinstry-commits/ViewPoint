...
GO
ALTER TABLE [dbo].[vPRAUEmployees] WITH NOCHECK ADD CONSTRAINT [FK_bPREH_vPRAUEmployees_Employee] FOREIGN KEY ([PRCo], [Employee]) REFERENCES [dbo].[bPREH] ([PRCo], [Employee])
GO
...
GO
ALTER TABLE [dbo].[vPRAUEmployees] NOCHECK CONSTRAINT [FK_bPREH_vPRAUEmployees_Employee]
GO
ALTER TABLE [dbo].[vPRAUEmployees] NOCHECK CONSTRAINT [FK_vPRAUEmployer_vPRAUEmployees_PRCo_TaxYear]
GO
