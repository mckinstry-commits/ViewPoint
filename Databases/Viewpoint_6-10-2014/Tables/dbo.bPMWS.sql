...
GO
ALTER TABLE [dbo].[bPMWS] WITH NOCHECK ADD CONSTRAINT [CK_bPMWS_ECM] CHECK (([ECM]='M' OR [ECM]='C' OR [ECM]='E' OR [ECM] IS NULL))
GO
...
GO
ALTER TABLE [dbo].[bPMWS] NOCHECK CONSTRAINT [FK_bPMWS_bPMWH]
GO
