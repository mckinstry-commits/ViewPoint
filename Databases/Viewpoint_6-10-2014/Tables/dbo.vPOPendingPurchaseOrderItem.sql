...
GO
ALTER TABLE [dbo].[vPOPendingPurchaseOrderItem] WITH NOCHECK ADD CONSTRAINT [CK_vPOPendingPurchaseOrderItem_ItemType] CHECK (([ItemType]>(0) AND [ItemType]<(6)))
GO
ALTER TABLE [dbo].[vPOPendingPurchaseOrderItem] WITH NOCHECK ADD CONSTRAINT [CK_vPOPendingPurchaseOrderItem_OrigECM] CHECK (([OrigECM]='E' OR [OrigECM]='C' OR [OrigECM]='M'))
GO
ALTER TABLE [dbo].[vPOPendingPurchaseOrderItem] WITH NOCHECK ADD CONSTRAINT [CK_vPOPendingPurchaseOrderItem_RecvYN] CHECK (([RecvYN]='Y' OR [RecvYN]='N'))
GO
...
GO
ALTER TABLE [dbo].[vPOPendingPurchaseOrderItem] NOCHECK CONSTRAINT [FK_vPOPendingPurchaseOrderItem_vPOPendingPurchaseOrderItem_Equip]
GO
ALTER TABLE [dbo].[vPOPendingPurchaseOrderItem] NOCHECK CONSTRAINT [FK_vPOPendingPurchaseOrderItem_bEMWH_WorkOrder]
GO
ALTER TABLE [dbo].[vPOPendingPurchaseOrderItem] NOCHECK CONSTRAINT [FK_vPOPendingPurchaseOrderItem_bINLM_Loc]
GO
ALTER TABLE [dbo].[vPOPendingPurchaseOrderItem] NOCHECK CONSTRAINT [FK_vPOPendingPurchaseOrderItem_vPOPendingPurchaseOrder_PO]
GO
ALTER TABLE [dbo].[vPOPendingPurchaseOrderItem] NOCHECK CONSTRAINT [FK_vPOPendingPurchaseOrderItem_vSMWorkOrder_WorkOrder]
GO
