...
GO
ALTER TABLE [dbo].[bEMUC] WITH NOCHECK ADD CONSTRAINT [FK_bEMUC_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMUC] WITH NOCHECK ADD CONSTRAINT [FK_bEMUC_bEMUH_AUTemplate] FOREIGN KEY ([EMCo], [AUTemplate]) REFERENCES [dbo].[bEMUH] ([EMCo], [AUTemplate]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[bEMUC] WITH NOCHECK ADD CONSTRAINT [FK_bEMUC_bEMCM_Category] FOREIGN KEY ([EMCo], [Category]) REFERENCES [dbo].[bEMCM] ([EMCo], [Category])
GO
ALTER TABLE [dbo].[bEMUC] WITH NOCHECK ADD CONSTRAINT [FK_bEMUC_bEMUR_RulesTable] FOREIGN KEY ([EMCo], [RulesTable]) REFERENCES [dbo].[bEMUR] ([EMCo], [RulesTable])
GO
ALTER TABLE [dbo].[bEMUC] NOCHECK CONSTRAINT [FK_bEMUC_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMUC] NOCHECK CONSTRAINT [FK_bEMUC_bEMUH_AUTemplate]
GO
ALTER TABLE [dbo].[bEMUC] NOCHECK CONSTRAINT [FK_bEMUC_bEMCM_Category]
GO
ALTER TABLE [dbo].[bEMUC] NOCHECK CONSTRAINT [FK_bEMUC_bEMUR_RulesTable]
GO
