...
GO
ALTER TABLE [dbo].[pPortalControlLayout] ADD CONSTRAINT [PK_pPortalControlLayout] PRIMARY KEY CLUSTERED  ([PortalControlID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[pPortalControlLayout] NOCHECK CONSTRAINT [FK_pPortalControlLayout_pPortalHTMLTables7]
GO
ALTER TABLE [dbo].[pPortalControlLayout] NOCHECK CONSTRAINT [FK_pPortalControlLayout_pPortalHTMLTables6]
GO
ALTER TABLE [dbo].[pPortalControlLayout] NOCHECK CONSTRAINT [FK_pPortalControlLayout_pPortalHTMLTables8]
GO
ALTER TABLE [dbo].[pPortalControlLayout] NOCHECK CONSTRAINT [FK_pPortalControlLayout_pPortalHTMLTables4]
GO
ALTER TABLE [dbo].[pPortalControlLayout] NOCHECK CONSTRAINT [FK_pPortalControlLayout_pPortalHTMLTables3]
GO
ALTER TABLE [dbo].[pPortalControlLayout] NOCHECK CONSTRAINT [FK_pPortalControlLayout_pPortalHTMLTables5]
GO
ALTER TABLE [dbo].[pPortalControlLayout] NOCHECK CONSTRAINT [FK_pPortalControlLayout_pPortalControls]
GO
ALTER TABLE [dbo].[pPortalControlLayout] NOCHECK CONSTRAINT [FK_pPortalControlLayout_pPortalHTMLTables1]
GO
ALTER TABLE [dbo].[pPortalControlLayout] NOCHECK CONSTRAINT [FK_pPortalControlLayout_pPortalHTMLTables]
GO
ALTER TABLE [dbo].[pPortalControlLayout] NOCHECK CONSTRAINT [FK_pPortalControlLayout_pPortalHTMLTables2]
GO
