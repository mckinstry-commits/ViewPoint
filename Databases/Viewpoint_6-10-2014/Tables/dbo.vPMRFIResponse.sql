...
GO
ALTER TABLE [dbo].[vPMRFIResponse] WITH NOCHECK ADD CONSTRAINT [CK_vPMRFIResponse_Send] CHECK (([Send]='Y' OR [Send]='N'))
GO
...
GO
ALTER TABLE [dbo].[vPMRFIResponse] NOCHECK CONSTRAINT [FK_vPMRFIResponse_bJCJM]
GO
ALTER TABLE [dbo].[vPMRFIResponse] NOCHECK CONSTRAINT [FK_vPMRFIResponse_bPMRI]
GO
ALTER TABLE [dbo].[vPMRFIResponse] NOCHECK CONSTRAINT [FK_vPMRFIResponse_bPMFM]
GO
ALTER TABLE [dbo].[vPMRFIResponse] NOCHECK CONSTRAINT [FK_vPMRFIResponse_bPMPM]
GO
