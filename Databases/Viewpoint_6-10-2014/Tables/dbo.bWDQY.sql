...
GO
ALTER TABLE [dbo].[bWDQY] WITH NOCHECK ADD CONSTRAINT [CK_bWDQY_Standard] CHECK (([Standard]='Y' OR [Standard]='N'))
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bWDQY] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biWDQY] ON [dbo].[bWDQY] ([QueryName]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
