...
GO
ALTER TABLE [dbo].[bPMFM] NOCHECK CONSTRAINT [FK_bPMFM_bPMFT]
GO
ALTER TABLE [dbo].[bPMFM] NOCHECK CONSTRAINT [FK_bPMFM_bHQCountry_MailCountry]
GO
ALTER TABLE [dbo].[bPMFM] NOCHECK CONSTRAINT [FK_bPMFM_bHQST_MailState]
GO
ALTER TABLE [dbo].[bPMFM] NOCHECK CONSTRAINT [FK_bPMFM_bHQCountry_ShipCountry]
GO
ALTER TABLE [dbo].[bPMFM] NOCHECK CONSTRAINT [FK_bPMFM_bHQST_ShipState]
GO
ALTER TABLE [dbo].[bPMFM] NOCHECK CONSTRAINT [FK_bPMFM_bHQGP]
GO
ALTER TABLE [dbo].[bPMFM] NOCHECK CONSTRAINT [FK_bPMFM_bAPVM]
GO
