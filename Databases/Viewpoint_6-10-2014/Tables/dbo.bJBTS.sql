...
GO
ALTER TABLE [dbo].[bJBTS] WITH NOCHECK ADD CONSTRAINT [CK_bJBTS_APYN] CHECK (([APYN]='Y' OR [APYN]='N'))
GO
ALTER TABLE [dbo].[bJBTS] WITH NOCHECK ADD CONSTRAINT [CK_bJBTS_EMYN] CHECK (([EMYN]='Y' OR [EMYN]='N'))
GO
ALTER TABLE [dbo].[bJBTS] WITH NOCHECK ADD CONSTRAINT [CK_bJBTS_INYN] CHECK (([INYN]='Y' OR [INYN]='N'))
GO
ALTER TABLE [dbo].[bJBTS] WITH NOCHECK ADD CONSTRAINT [CK_bJBTS_JCYN] CHECK (([JCYN]='Y' OR [JCYN]='N'))
GO
ALTER TABLE [dbo].[bJBTS] WITH NOCHECK ADD CONSTRAINT [CK_bJBTS_MSYN] CHECK (([MSYN]='Y' OR [MSYN]='N'))
GO
ALTER TABLE [dbo].[bJBTS] WITH NOCHECK ADD CONSTRAINT [CK_bJBTS_PRYN] CHECK (([PRYN]='Y' OR [PRYN]='N'))
GO
