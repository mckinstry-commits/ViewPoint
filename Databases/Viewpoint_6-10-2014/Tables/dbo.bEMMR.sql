...
GO
ALTER TABLE [dbo].[bEMMR] WITH NOCHECK ADD CONSTRAINT [FK_bEMMR_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMMR] WITH NOCHECK ADD CONSTRAINT [FK_bEMMR_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[bEMMR] NOCHECK CONSTRAINT [FK_bEMMR_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMMR] NOCHECK CONSTRAINT [FK_bEMMR_bEMEM_Equipment]
GO
