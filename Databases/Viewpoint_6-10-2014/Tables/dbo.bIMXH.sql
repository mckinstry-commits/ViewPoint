...
GO
ALTER TABLE [dbo].[bIMXH] WITH NOCHECK ADD CONSTRAINT [CK_bIMXH_PMCrossReference] CHECK (([PMCrossReference]='Y' OR [PMCrossReference]='N'))
GO
CREATE UNIQUE CLUSTERED INDEX [biIMXH] ON [dbo].[bIMXH] ([ImportTemplate], [XRefName], [RecordType]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bIMXH] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
