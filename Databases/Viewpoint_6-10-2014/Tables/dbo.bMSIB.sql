...
GO
ALTER TABLE [dbo].[bMSIB] WITH NOCHECK ADD CONSTRAINT [CK_bMSIB_CMAcct] CHECK (([CMAcct] IS NULL OR [CMAcct]>(0) AND [CMAcct]<(10000)))
GO
ALTER TABLE [dbo].[bMSIB] WITH NOCHECK ADD CONSTRAINT [CK_bMSIB_InterCoInv] CHECK (([InterCoInv]='N' OR [InterCoInv]='Y'))
GO
ALTER TABLE [dbo].[bMSIB] WITH NOCHECK ADD CONSTRAINT [CK_bMSIB_Interfaced] CHECK (([Interfaced]='N' OR [Interfaced]='Y'))
GO
ALTER TABLE [dbo].[bMSIB] WITH NOCHECK ADD CONSTRAINT [CK_bMSIB_PrintedYN] CHECK (([PrintedYN]='N' OR [PrintedYN]='Y'))
GO
ALTER TABLE [dbo].[bMSIB] WITH NOCHECK ADD CONSTRAINT [CK_bMSIB_SepHaul] CHECK (([SepHaul]='N' OR [SepHaul]='Y'))
GO
ALTER TABLE [dbo].[bMSIB] WITH NOCHECK ADD CONSTRAINT [CK_bMSIB_Void] CHECK (([Void]='N' OR [Void]='Y'))
GO
