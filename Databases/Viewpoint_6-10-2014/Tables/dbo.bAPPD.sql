...
GO
ALTER TABLE [dbo].[bAPPD] WITH NOCHECK ADD CONSTRAINT [CK_bAPPD_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000)))
GO
CREATE UNIQUE CLUSTERED INDEX [biAPPD] ON [dbo].[bAPPD] ([APCo], [CMCo], [CMAcct], [PayMethod], [CMRef], [CMRefSeq], [EFTSeq], [Mth], [APTrans]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPPD] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
