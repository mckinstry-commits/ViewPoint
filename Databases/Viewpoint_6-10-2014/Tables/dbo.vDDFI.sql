...
GO
ALTER TABLE [dbo].[vDDFI] WITH NOCHECK ADD CONSTRAINT [CK_vDDFI_ActiveLookup] CHECK (([ActiveLookup]='Y' OR [ActiveLookup]='N' OR [ActiveLookup] IS NULL))
GO
ALTER TABLE [dbo].[vDDFI] WITH NOCHECK ADD CONSTRAINT [CK_vDDFI_Computed] CHECK (([Computed]='Y' OR [Computed]='N'))
GO
ALTER TABLE [dbo].[vDDFI] WITH NOCHECK ADD CONSTRAINT [CK_vDDFI_Req] CHECK (([Req]='Y' OR [Req]='N'))
GO
ALTER TABLE [dbo].[vDDFI] WITH NOCHECK ADD CONSTRAINT [CK_vDDFI_ShowForm] CHECK (([ShowForm]='Y' OR [ShowForm]='N'))
GO
ALTER TABLE [dbo].[vDDFI] WITH NOCHECK ADD CONSTRAINT [CK_vDDFI_ShowGrid] CHECK (([ShowGrid]='Y' OR [ShowGrid]='N'))
GO
CREATE UNIQUE CLUSTERED INDEX [viDDFI] ON [dbo].[vDDFI] ([Form], [Seq]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
