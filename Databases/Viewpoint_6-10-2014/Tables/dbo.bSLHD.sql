...
[Purge] [dbo].[bYN] NOT NULL CONSTRAINT [DF_bSLHD_Purge] DEFAULT ('N'),
...
[udSLDrawings] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udSLDrawings__DEFAULT] DEFAULT ('N'),
[udSafety] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udSafety__DEFAULT] DEFAULT ('N'),
[udScheduleOVal] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udScheduleOVal__DEFAULT] DEFAULT ('N'),
[udProjSchedule] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udProjSchedule__DEFAULT] DEFAULT ('N'),
[udBalancing] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udBalancing__DEFAULT] DEFAULT ('N'),
[udConsulting] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udConsulting__DEFAULT] DEFAULT ('N'),
[udFacility] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udFacility__DEFAULT] DEFAULT ('N'),
[udControls] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udControls__DEFAULT] DEFAULT ('N'),
[udDesignServ] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udDesignServ__DEFAULT] DEFAULT ('N'),
[udProServTesting] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udProServTesting__DEFAULT] DEFAULT ('N'),
[udSoftProServ] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udSoftProServ__DEFAULT] DEFAULT ('N'),
[udSoftLicense] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udSoftLicense__DEFAULT] DEFAULT ('N'),
[udSoftSupMaintYN] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udSoftSupMaintYN__DEFAULT] DEFAULT ('N'),
[udSoftHost] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udSoftHost__DEFAULT] DEFAULT ('N'),
[udWorkOrderYN] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udWorkOrderYN__DEFAULT] DEFAULT ('N'),
[udFederalYN] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udFederalYN__DEFAULT] DEFAULT ('N'),
[udPerfBondYN] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udPerfBondYN__DEFAULT] DEFAULT ('N'),
[udCostPlusYN] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udCostPlusYN__DEFAULT] DEFAULT ('N'),
[udNegMods] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udNegMods__DEFAULT] DEFAULT ('N'),
[udSubType] [varchar] (30) COLLATE Latin1_General_BIN NULL,
[udGTC] [varchar] (30) COLLATE Latin1_General_BIN NULL,
[udInvYN] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udInvYN__DEFAULT] DEFAULT ('N'),
[udEEO] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udEEO__DEFAULT] DEFAULT ('N'),
[udMastSub] [int] NULL,
[udInsurance] [varchar] (5) COLLATE Latin1_General_BIN NULL,
[udCommissioningYN] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udCommissioningYN__DEFAULT] DEFAULT ('N'),
[udRoofingYN] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udRoofingYN__DEFAULT] DEFAULT ('N'),
[udLighting] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udLighting__DEFAULT] DEFAULT ('N'),
[udAddendum] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udAddendum__DEFAULT] DEFAULT ('N'),
[udMasIns] [varchar] (30) COLLATE Latin1_General_BIN NULL,
[udCertPRPrevYN] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udCertPRPrevYN__DEFAULT] DEFAULT ('N'),
[udConstruction] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udConstruction__DEFAULT] DEFAULT ('N'),
[DocType] [dbo].[bDocType] NULL,
[udProServYN] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHD__udProServYN__DEFAULT] DEFAULT ('N'),
[udBillType] [varchar] (5) COLLATE Latin1_General_BIN NULL,
[udSbstntlComp] [smalldatetime] NULL,
[udScope] [dbo].[bNotes] NULL
...
*				SCOTTP 05/03/2014 TFS-13563 Remove code that uses PMSS. Distribution is now managed via the form or C&S Form
*
*--------------------------------------------------------------*/
declare @numrows int, @errmsg varchar(255), @validcnt int, @validcnt2 int,
...
GO
ALTER TABLE [dbo].[bSLHD] WITH NOCHECK ADD CONSTRAINT [CK_bSLHD_ApprovalRequired] CHECK (([ApprovalRequired]='N' OR [ApprovalRequired]='Y'))
GO
ALTER TABLE [dbo].[bSLHD] WITH NOCHECK ADD CONSTRAINT [CK_bSLHD_Approved] CHECK (([Approved]='Y' OR [Approved]='N' OR [Approved] IS NULL))
GO
ALTER TABLE [dbo].[bSLHD] WITH NOCHECK ADD CONSTRAINT [CK_bSLHD_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
...
GO
ALTER TABLE [dbo].[bSLHD] WITH NOCHECK ADD CONSTRAINT [FK_bSLHD_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
ALTER TABLE [dbo].[bSLHD] NOCHECK CONSTRAINT [FK_bSLHD_bPMDT]
GO
