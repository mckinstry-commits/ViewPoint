...
GO
ALTER TABLE [dbo].[vSMRateOverrideEquipment] WITH NOCHECK ADD CONSTRAINT [FK_vSMRateOverrideEquipment_vSMEntity] FOREIGN KEY ([SMCo], [EntitySeq]) REFERENCES [dbo].[vSMEntity] ([SMCo], [EntitySeq]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[vSMRateOverrideEquipment] NOCHECK CONSTRAINT [FK_vSMRateOverrideEquipment_bEMEM]
GO
ALTER TABLE [dbo].[vSMRateOverrideEquipment] NOCHECK CONSTRAINT [FK_vSMRateOverrideEquipment_vSMEntity]
GO
