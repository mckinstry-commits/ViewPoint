...
GO
ALTER TABLE [dbo].[bEMRC] WITH NOCHECK ADD CONSTRAINT [CK_bEMRC_Basis] CHECK (([Basis]='U' OR [Basis]='H'))
GO
ALTER TABLE [dbo].[bEMRC] WITH NOCHECK ADD CONSTRAINT [CK_bEMRC_HaulBased] CHECK (([HaulBased]='N' OR [HaulBased]='Y'))
GO
ALTER TABLE [dbo].[bEMRC] WITH NOCHECK ADD CONSTRAINT [CK_bEMRC_MonthlyRevCodeYN] CHECK (([MonthlyRevCodeYN]='N' OR [MonthlyRevCodeYN]='Y'))
GO
ALTER TABLE [dbo].[bEMRC] WITH NOCHECK ADD CONSTRAINT [CK_bEMRC_UpdateHourMeter] CHECK (([UpdateHourMeter]='N' OR [UpdateHourMeter]='Y'))
GO
...
GO
ALTER TABLE [dbo].[bEMRC] WITH NOCHECK ADD CONSTRAINT [FK_bEMRC_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMRC] NOCHECK CONSTRAINT [FK_bEMRC_bHQGP_EMGroup]
GO
