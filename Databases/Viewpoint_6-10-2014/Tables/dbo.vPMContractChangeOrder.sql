...
GO
ALTER TABLE [dbo].[vPMContractChangeOrder] WITH NOCHECK ADD CONSTRAINT [CK_vPMContractChangeOrder_ChangeInDaysOverride] CHECK (([ChangeInDaysOverride]='N' OR [ChangeInDaysOverride]='Y'))
GO
...
GO
ALTER TABLE [dbo].[vPMContractChangeOrder] WITH NOCHECK ADD CONSTRAINT [FK_vPMContractChangeOrder_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
...
GO
ALTER TABLE [dbo].[vPMContractChangeOrder] WITH NOCHECK ADD CONSTRAINT [FK_vPMContractChangeOrder_bJCCM] FOREIGN KEY ([PMCo], [Contract]) REFERENCES [dbo].[bJCCM] ([JCCo], [Contract])
GO
...
GO
ALTER TABLE [dbo].[vPMContractChangeOrder] NOCHECK CONSTRAINT [FK_vPMContractChangeOrder_bPMDT]
GO
ALTER TABLE [dbo].[vPMContractChangeOrder] NOCHECK CONSTRAINT [FK_vPMContractChangeOrder_bPMCO]
GO
ALTER TABLE [dbo].[vPMContractChangeOrder] NOCHECK CONSTRAINT [FK_vPMContractChangeOrder_bJCCM]
GO
ALTER TABLE [dbo].[vPMContractChangeOrder] NOCHECK CONSTRAINT [FK_vPMContractChangeOrder_bPMFM_FromFirm]
GO
ALTER TABLE [dbo].[vPMContractChangeOrder] NOCHECK CONSTRAINT [FK_vPMContractChangeOrder_bPMPM_FromContact]
GO
ALTER TABLE [dbo].[vPMContractChangeOrder] NOCHECK CONSTRAINT [FK_vPMContractChangeOrder_bPMPM_ToContact]
GO
ALTER TABLE [dbo].[vPMContractChangeOrder] NOCHECK CONSTRAINT [FK_vPMContractChangeOrder_bPMFM_ToFirm]
GO
