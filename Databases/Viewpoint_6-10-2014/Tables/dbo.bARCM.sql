...
[CreditLimit] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bARCM_CreditLimit] DEFAULT ((0)),
...
[FCPct] [dbo].[bPct] NOT NULL CONSTRAINT [DF_bARCM_FCPct] DEFAULT ((0)),
[MarkupDiscPct] [dbo].[bRate] NOT NULL CONSTRAINT [DF_bARCM_MarkupDiscPct] DEFAULT ((0)),
...
[udASTCust] [varchar] (30) COLLATE Latin1_General_BIN NULL
...
GO
ALTER TABLE [dbo].[bARCM] WITH NOCHECK ADD CONSTRAINT [CK_bARCM_ExclContFromFC] CHECK (([ExclContFromFC]='Y' OR [ExclContFromFC]='N'))
GO
ALTER TABLE [dbo].[bARCM] WITH NOCHECK ADD CONSTRAINT [CK_bARCM_MiscOnInv] CHECK (([MiscOnInv]='Y' OR [MiscOnInv]='N'))
GO
ALTER TABLE [dbo].[bARCM] WITH NOCHECK ADD CONSTRAINT [CK_bARCM_MiscOnPay] CHECK (([MiscOnPay]='Y' OR [MiscOnPay]='N'))
GO
ALTER TABLE [dbo].[bARCM] WITH NOCHECK ADD CONSTRAINT [CK_bARCM_SelPurge] CHECK (([SelPurge]='Y' OR [SelPurge]='N'))
GO
ALTER TABLE [dbo].[bARCM] WITH NOCHECK ADD CONSTRAINT [CK_bARCM_SepHaul] CHECK (([SepHaul]='Y' OR [SepHaul]='N'))
GO
ALTER TABLE [dbo].[bARCM] WITH NOCHECK ADD CONSTRAINT [CK_bARCM_Status] CHECK (([Status]='A' OR [Status]='H' OR [Status]='I'))
GO
ALTER TABLE [dbo].[bARCM] WITH NOCHECK ADD CONSTRAINT [CK_bARCM_StmntPrint] CHECK (([StmntPrint]='Y' OR [StmntPrint]='N'))
GO
ALTER TABLE [dbo].[bARCM] WITH NOCHECK ADD CONSTRAINT [CK_bARCM_StmtType] CHECK (([StmtType]='B' OR [StmtType]='O'))
GO
ALTER TABLE [dbo].[bARCM] WITH NOCHECK ADD CONSTRAINT [CK_bARCM_TempYN] CHECK (([TempYN]='Y' OR [TempYN]='N'))
GO
