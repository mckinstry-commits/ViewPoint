...
GO
ALTER TABLE [dbo].[vSMRateOverrideMaterial] WITH NOCHECK ADD CONSTRAINT [FK_vSMRateOverrideMaterial_vSMEntity] FOREIGN KEY ([SMCo], [EntitySeq]) REFERENCES [dbo].[vSMEntity] ([SMCo], [EntitySeq]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[vSMRateOverrideMaterial] NOCHECK CONSTRAINT [FK_vSMRateOverrideMaterial_bHQMC]
GO
ALTER TABLE [dbo].[vSMRateOverrideMaterial] NOCHECK CONSTRAINT [FK_vSMRateOverrideMaterial_bHQMT]
GO
ALTER TABLE [dbo].[vSMRateOverrideMaterial] NOCHECK CONSTRAINT [FK_vSMRateOverrideMaterial_vSMEntity]
GO
