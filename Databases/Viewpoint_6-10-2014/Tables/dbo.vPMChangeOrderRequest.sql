...
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] WITH NOCHECK ADD CONSTRAINT [CK_vPMChangeOrderRequest_ChangeInDaysOverride] CHECK (([ChangeInDaysOverride]='Y' OR [ChangeInDaysOverride]='N'))
GO
...
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] WITH NOCHECK ADD CONSTRAINT [FK_vPMChangeOrderRequest_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] WITH NOCHECK ADD CONSTRAINT [FK_vPMChangeOrderRequest_bPMCO] FOREIGN KEY ([PMCo]) REFERENCES [dbo].[bPMCO] ([PMCo])
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] WITH NOCHECK ADD CONSTRAINT [FK_vPMChangeOrderRequest_bJCCM] FOREIGN KEY ([PMCo], [Contract]) REFERENCES [dbo].[bJCCM] ([JCCo], [Contract])
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] WITH NOCHECK ADD CONSTRAINT [FK_vPMChangeOrderRequest_bPMSC] FOREIGN KEY ([Status]) REFERENCES [dbo].[bPMSC] ([Status])
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] WITH NOCHECK ADD CONSTRAINT [FK_vPMChangeOrderRequest_bPMFM_FromFirm] FOREIGN KEY ([VendorGroup], [FromFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] WITH NOCHECK ADD CONSTRAINT [FK_vPMChangeOrderRequest_bPMPM_FromContact] FOREIGN KEY ([VendorGroup], [FromFirm], [FromContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] WITH NOCHECK ADD CONSTRAINT [FK_vPMChangeOrderRequest_bPMPM_ToContact] FOREIGN KEY ([VendorGroup], [FromFirm], [ToContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] WITH NOCHECK ADD CONSTRAINT [FK_vPMChangeOrderRequest_bPMFM_ToFirm] FOREIGN KEY ([VendorGroup], [ToFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] NOCHECK CONSTRAINT [FK_vPMChangeOrderRequest_bPMDT]
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] NOCHECK CONSTRAINT [FK_vPMChangeOrderRequest_bPMCO]
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] NOCHECK CONSTRAINT [FK_vPMChangeOrderRequest_bJCCM]
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] NOCHECK CONSTRAINT [FK_vPMChangeOrderRequest_bPMSC]
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] NOCHECK CONSTRAINT [FK_vPMChangeOrderRequest_bPMFM_FromFirm]
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] NOCHECK CONSTRAINT [FK_vPMChangeOrderRequest_bPMPM_FromContact]
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] NOCHECK CONSTRAINT [FK_vPMChangeOrderRequest_bPMPM_ToContact]
GO
ALTER TABLE [dbo].[vPMChangeOrderRequest] NOCHECK CONSTRAINT [FK_vPMChangeOrderRequest_bPMFM_ToFirm]
GO
