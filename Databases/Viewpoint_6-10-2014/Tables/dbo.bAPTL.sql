...
GO
ALTER TABLE [dbo].[bAPTL] WITH NOCHECK ADD CONSTRAINT [CK_bAPTL_BECM] CHECK (([BECM]='E' OR [BECM]='C' OR [BECM]='M' OR [BECM] IS NULL))
GO
ALTER TABLE [dbo].[bAPTL] WITH NOCHECK ADD CONSTRAINT [CK_bAPTL_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
GO
ALTER TABLE [dbo].[bAPTL] WITH NOCHECK ADD CONSTRAINT [CK_bAPTL_MiscYN] CHECK (([MiscYN]='Y' OR [MiscYN]='N'))
GO
ALTER TABLE [dbo].[bAPTL] WITH NOCHECK ADD CONSTRAINT [CK_bAPTL_POPayTypeYN] CHECK (([POPayTypeYN]='Y' OR [POPayTypeYN]='N'))
GO
CREATE UNIQUE CLUSTERED INDEX [biAPTL] ON [dbo].[bAPTL] ([APCo], [Mth], [APTrans], [APLine]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPTLJob] ON [dbo].[bAPTL] ([Job]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPTL] ([KeyID]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPTLPO ] ON [dbo].[bAPTL] ([PO]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPTLSL] ON [dbo].[bAPTL] ([SL]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bAPTL_SLKeyID] ON [dbo].[bAPTL] ([SLKeyID]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
