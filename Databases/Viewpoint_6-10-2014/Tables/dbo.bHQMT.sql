...
[Cost] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bHQMT_Cost] DEFAULT ((0)),
[CostECM] [dbo].[bECM] NOT NULL,
[Price] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bHQMT_Price] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[bHQMT] WITH NOCHECK ADD CONSTRAINT [CK_bHQMT_Active] CHECK (([Active]='Y' OR [Active]='N'))
GO
ALTER TABLE [dbo].[bHQMT] WITH NOCHECK ADD CONSTRAINT [CK_bHQMT_CostECM] CHECK (([CostECM]='E' OR [CostECM]='C' OR [CostECM]='M'))
GO
ALTER TABLE [dbo].[bHQMT] WITH NOCHECK ADD CONSTRAINT [CK_bHQMT_PriceECM] CHECK (([PriceECM]='E' OR [PriceECM]='C' OR [PriceECM]='M'))
GO
ALTER TABLE [dbo].[bHQMT] WITH NOCHECK ADD CONSTRAINT [CK_bHQMT_Stocked] CHECK (([Stocked]='Y' OR [Stocked]='N'))
GO
ALTER TABLE [dbo].[bHQMT] WITH NOCHECK ADD CONSTRAINT [CK_bHQMT_Taxable] CHECK (([Taxable]='Y' OR [Taxable]='N'))
GO
