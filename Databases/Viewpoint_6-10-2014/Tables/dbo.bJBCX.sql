...
GO
ALTER TABLE [dbo].[bJBCX] WITH NOCHECK ADD CONSTRAINT [CK_bJBCX_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
GO
ALTER TABLE [dbo].[bJBCX] WITH NOCHECK ADD CONSTRAINT [CK_bJBCX_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
CREATE UNIQUE CLUSTERED INDEX [biJBCX] ON [dbo].[bJBCX] ([JBCo], [BillMonth], [BillNumber], [Job], [ACO], [ACOItem]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBCX] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
