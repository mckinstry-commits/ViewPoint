...
GO
ALTER TABLE [dbo].[bEMDP] WITH NOCHECK ADD CONSTRAINT [CK_bEMDP_UseResidualVal] CHECK (([UseResidualVal]='N' OR [UseResidualVal]='Y'))
GO
...
GO
ALTER TABLE [dbo].[bEMDP] WITH NOCHECK ADD CONSTRAINT [FK_bEMDP_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMDP] WITH NOCHECK ADD CONSTRAINT [FK_bEMDP_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[bEMDP] NOCHECK CONSTRAINT [FK_bEMDP_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMDP] NOCHECK CONSTRAINT [FK_bEMDP_bEMEM_Equipment]
GO
