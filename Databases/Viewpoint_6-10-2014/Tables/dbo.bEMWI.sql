...
GO
ALTER TABLE [dbo].[bEMWI] WITH NOCHECK ADD CONSTRAINT [CK_bEMWI_InHseSubFlag] CHECK (([InHseSubFlag]='O' OR [InHseSubFlag]='I'))
GO
ALTER TABLE [dbo].[bEMWI] WITH NOCHECK ADD CONSTRAINT [CK_bEMWI_Priority] CHECK (([Priority]='L' OR [Priority]='N' OR [Priority]='U' OR [Priority] IS NULL))
GO
...
GO
ALTER TABLE [dbo].[bEMWI] WITH NOCHECK ADD CONSTRAINT [FK_bEMWI_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMWI] WITH NOCHECK ADD CONSTRAINT [FK_bEMWI_bEMEM_Component] FOREIGN KEY ([EMCo], [Component]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment])
GO
ALTER TABLE [dbo].[bEMWI] WITH NOCHECK ADD CONSTRAINT [FK_bEMWI_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[bEMWI] WITH NOCHECK ADD CONSTRAINT [FK_bEMWI_bEMSH_EquipStdMaintGroup] FOREIGN KEY ([EMCo], [Equipment], [StdMaintGroup]) REFERENCES [dbo].[bEMSH] ([EMCo], [Equipment], [StdMaintGroup])
GO
ALTER TABLE [dbo].[bEMWI] WITH NOCHECK ADD CONSTRAINT [FK_bEMWI_bEMSI_EquipStdMaintItem] FOREIGN KEY ([EMCo], [Equipment], [StdMaintGroup], [StdMaintItem]) REFERENCES [dbo].[bEMSI] ([EMCo], [Equipment], [StdMaintGroup], [StdMaintItem])
GO
ALTER TABLE [dbo].[bEMWI] WITH NOCHECK ADD CONSTRAINT [FK_bEMWI_bEMWH_WorkOrder] FOREIGN KEY ([EMCo], [WorkOrder]) REFERENCES [dbo].[bEMWH] ([EMCo], [WorkOrder])
GO
ALTER TABLE [dbo].[bEMWI] WITH NOCHECK ADD CONSTRAINT [FK_bEMWI_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMWI] WITH NOCHECK ADD CONSTRAINT [FK_bEMWI_bEMTY_ComponentTypeCode] FOREIGN KEY ([EMGroup], [ComponentTypeCode]) REFERENCES [dbo].[bEMTY] ([EMGroup], [ComponentTypeCode])
GO
ALTER TABLE [dbo].[bEMWI] WITH NOCHECK ADD CONSTRAINT [FK_bEMWI_bEMCC_CostCode] FOREIGN KEY ([EMGroup], [CostCode]) REFERENCES [dbo].[bEMCC] ([EMGroup], [CostCode])
GO
ALTER TABLE [dbo].[bEMWI] WITH NOCHECK ADD CONSTRAINT [FK_bEMWI_bEMRX_RepairType] FOREIGN KEY ([EMGroup], [RepairType]) REFERENCES [dbo].[bEMRX] ([EMGroup], [RepType])
GO
ALTER TABLE [dbo].[bEMWI] WITH NOCHECK ADD CONSTRAINT [FK_bEMWI_bEMWS_StatusCode] FOREIGN KEY ([EMGroup], [StatusCode]) REFERENCES [dbo].[bEMWS] ([EMGroup], [StatusCode])
GO
ALTER TABLE [dbo].[bEMWI] NOCHECK CONSTRAINT [FK_bEMWI_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMWI] NOCHECK CONSTRAINT [FK_bEMWI_bEMEM_Component]
GO
ALTER TABLE [dbo].[bEMWI] NOCHECK CONSTRAINT [FK_bEMWI_bEMEM_Equipment]
GO
ALTER TABLE [dbo].[bEMWI] NOCHECK CONSTRAINT [FK_bEMWI_bEMSH_EquipStdMaintGroup]
GO
ALTER TABLE [dbo].[bEMWI] NOCHECK CONSTRAINT [FK_bEMWI_bEMSI_EquipStdMaintItem]
GO
ALTER TABLE [dbo].[bEMWI] NOCHECK CONSTRAINT [FK_bEMWI_bEMWH_WorkOrder]
GO
ALTER TABLE [dbo].[bEMWI] NOCHECK CONSTRAINT [FK_bEMWI_bHQGP_EMGroup]
GO
ALTER TABLE [dbo].[bEMWI] NOCHECK CONSTRAINT [FK_bEMWI_bEMTY_ComponentTypeCode]
GO
ALTER TABLE [dbo].[bEMWI] NOCHECK CONSTRAINT [FK_bEMWI_bEMCC_CostCode]
GO
ALTER TABLE [dbo].[bEMWI] NOCHECK CONSTRAINT [FK_bEMWI_bEMRX_RepairType]
GO
ALTER TABLE [dbo].[bEMWI] NOCHECK CONSTRAINT [FK_bEMWI_bEMWS_StatusCode]
GO
