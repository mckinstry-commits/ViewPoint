...
GO
ALTER TABLE [dbo].[bPMOH] WITH NOCHECK ADD CONSTRAINT [CK_bPMOH_IntExt] CHECK (([IntExt] = 'E' OR [IntExt] = 'I'))
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMOH] ([KeyID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMOH] ON [dbo].[bPMOH] ([PMCo], [Project], [ACO]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
ALTER TABLE [dbo].[bPMOH] WITH NOCHECK ADD CONSTRAINT [FK_bPMOH_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
ALTER TABLE [dbo].[bPMOH] WITH NOCHECK ADD CONSTRAINT [FK_bPMOH_bJCCM] FOREIGN KEY ([PMCo], [Contract]) REFERENCES [dbo].[bJCCM] ([JCCo], [Contract])
GO
ALTER TABLE [dbo].[bPMOH] WITH NOCHECK ADD CONSTRAINT [FK_bPMOH_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
ALTER TABLE [dbo].[bPMOH] NOCHECK CONSTRAINT [FK_bPMOH_bPMDT]
GO
ALTER TABLE [dbo].[bPMOH] NOCHECK CONSTRAINT [FK_bPMOH_bJCCM]
GO
ALTER TABLE [dbo].[bPMOH] NOCHECK CONSTRAINT [FK_bPMOH_bJCJM]
GO
