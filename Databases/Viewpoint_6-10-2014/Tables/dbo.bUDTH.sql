...
GO
ALTER TABLE [dbo].[bUDTH] WITH NOCHECK ADD CONSTRAINT [CK_bUDTH_CompanyBasedYN] CHECK (([CompanyBasedYN]='Y' OR [CompanyBasedYN]='N'))
GO
ALTER TABLE [dbo].[bUDTH] WITH NOCHECK ADD CONSTRAINT [CK_bUDTH_Created] CHECK (([Created]='Y' OR [Created]='N'))
GO
ALTER TABLE [dbo].[bUDTH] WITH NOCHECK ADD CONSTRAINT [CK_bUDTH_Dirty] CHECK (([Dirty]='Y' OR [Dirty]='N'))
GO
