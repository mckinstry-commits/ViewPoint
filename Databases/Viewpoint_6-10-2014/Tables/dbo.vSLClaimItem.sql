...
[ApproveToDateUnits] [dbo].[bUnits] NOT NULL CONSTRAINT [DF_vSLClaimItem_ApproveToDateUnits] DEFAULT ((0)),
[ApproveToDateAmt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_vSLClaimItem_ApproveToDateAmt] DEFAULT ((0))
...
CREATE TRIGGER dbo.vtvSLClaimItem_Audit_Delete ON dbo.vSLClaimItem
 ...
 BEGIN TRY 
							...
							SELECT
								...
								'D' , 
								'ApproveToDateAmt' , 
								CONVERT(VARCHAR(MAX), deleted.[ApproveToDateAmt]) , 								NULL , 
								GETDATE() , 
								SUSER_SNAME()
							FROM deleted
							...
							SELECT
								...
								'D' , 
								'ApproveToDateUnits' , 
								CONVERT(VARCHAR(MAX), deleted.[ApproveToDateUnits]) , 								NULL , 
								GETDATE() , 
								SUSER_SNAME()
							FROM deleted
...
-- log additions to the ApproveToDateAmt column
							INSERT dbo.bHQMA (	
													TableName, 
													KeyString, 
													Co, 
...
-- log additions to the ApproveToDateUnits column
							INSERT dbo.bHQMA (	
													TableName, 
													KeyString, 
													Co, 
...
CREATE TRIGGER dbo.vtvSLClaimItem_Audit_Update ON dbo.vSLClaimItem
 ...
 BEGIN TRY 
							...
							INSERT dbo.bHQMA (	TableName, 
								...
								SELECT 							'vSLClaimItem' , 								'<KeyString ClaimNo = "' + REPLACE(CAST(ISNULL(inserted.[ClaimNo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SL = "' + REPLACE(CAST(ISNULL(inserted.[SL],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SLCo = "' + REPLACE(CAST(ISNULL(inserted.[SLCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SLItem = "' + REPLACE(CAST(ISNULL(inserted.[SLItem],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SLCo , 								'C' , 								'ApproveToDateAmt' , 								CONVERT(VARCHAR(MAX), deleted.[ApproveToDateAmt]) , 								CONVERT(VARCHAR(MAX), inserted.[ApproveToDateAmt]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[KeyID] = deleted.[KeyID] 
									AND ((inserted.[ApproveToDateAmt] <> deleted.[ApproveToDateAmt]) OR (inserted.[ApproveToDateAmt] IS NULL AND deleted.[ApproveToDateAmt] IS NOT NULL) OR (inserted.[ApproveToDateAmt] IS NOT NULL AND deleted.[ApproveToDateAmt] IS NULL))
								

							END 

							IF UPDATE([ApproveToDateUnits])
							BEGIN
							INSERT dbo.bHQMA (	TableName, 
																	KeyString, 
																	Co, 
								...
								SELECT 							'vSLClaimItem' , 								'<KeyString ClaimNo = "' + REPLACE(CAST(ISNULL(inserted.[ClaimNo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SL = "' + REPLACE(CAST(ISNULL(inserted.[SL],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SLCo = "' + REPLACE(CAST(ISNULL(inserted.[SLCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SLItem = "' + REPLACE(CAST(ISNULL(inserted.[SLItem],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SLCo , 								'C' , 								'ApproveToDateUnits' , 								CONVERT(VARCHAR(MAX), deleted.[ApproveToDateUnits]) , 								CONVERT(VARCHAR(MAX), inserted.[ApproveToDateUnits]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[KeyID] = deleted.[KeyID] 
									AND ((inserted.[ApproveToDateUnits] <> deleted.[ApproveToDateUnits]) OR (inserted.[ApproveToDateUnits] IS NULL AND deleted.[ApproveToDateUnits] IS NOT NULL) OR (inserted.[ApproveToDateUnits] IS NOT NULL AND deleted.[ApproveToDateUnits] IS NULL))
...
GO
ALTER TABLE [dbo].[vSLClaimItem] NOCHECK CONSTRAINT [FK_vSLClaimItem_bSLHD]
GO
ALTER TABLE [dbo].[vSLClaimItem] NOCHECK CONSTRAINT [FK_vSLClaimItem_vSLClaimHeader]
GO
ALTER TABLE [dbo].[vSLClaimItem] NOCHECK CONSTRAINT [FK_vSLClaimItem_bSLIT]
GO
