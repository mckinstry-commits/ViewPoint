...
[UnitCost] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bAPEM_UnitCost] DEFAULT ((0)),
[ECM] [dbo].[bECM] NULL,
...
GO
ALTER TABLE [dbo].[bAPEM] WITH NOCHECK ADD CONSTRAINT [CK_bAPEM_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
GO
