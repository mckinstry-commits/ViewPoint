...
GO
ALTER TABLE [dbo].[bPMCA] WITH NOCHECK ADD CONSTRAINT [CK_bPMCA_Include] CHECK (([Include]='Y' OR [Include]='N'))
GO
ALTER TABLE [dbo].[bPMCA] WITH NOCHECK ADD CONSTRAINT [CK_bPMCA_RoundAmount] CHECK (([RoundAmount]='Y' OR [RoundAmount]='N'))
GO
ALTER TABLE [dbo].[bPMCA] WITH NOCHECK ADD CONSTRAINT [CK_bPMCA_Standard] CHECK (([Standard]='Y' OR [Standard]='N'))
GO
ALTER TABLE [dbo].[bPMCA] ADD CONSTRAINT [PK_bPMCA] PRIMARY KEY CLUSTERED  ([PMCo], [Addon]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMCA] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[bPMCA] NOCHECK CONSTRAINT [FK_bPMCA_bJCCT_BasisCostType]
GO
ALTER TABLE [dbo].[bPMCA] NOCHECK CONSTRAINT [FK_bPMCA_bJCCT_CostType]
GO
ALTER TABLE [dbo].[bPMCA] NOCHECK CONSTRAINT [FK_bPMCA_bJCPM]
GO
ALTER TABLE [dbo].[bPMCA] NOCHECK CONSTRAINT [FK_bPMCA_bPMCo]
GO
