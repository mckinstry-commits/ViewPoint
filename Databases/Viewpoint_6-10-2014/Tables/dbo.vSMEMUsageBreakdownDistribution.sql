...
GO
ALTER TABLE [dbo].[vSMEMUsageBreakdownDistribution] WITH NOCHECK ADD CONSTRAINT [FK_vSMEMUsageBreakdownDistribution_bHQBC] FOREIGN KEY ([SMCo], [Mth], [BatchId]) REFERENCES [dbo].[bHQBC] ([Co], [Mth], [BatchId])
GO
ALTER TABLE [dbo].[vSMEMUsageBreakdownDistribution] NOCHECK CONSTRAINT [FK_vSMEMUsageBreakdownDistribution_bHQBC]
GO
