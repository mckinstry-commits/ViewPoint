...
/*--------------------------------------------------------------
    ...
    *
    *--------------------------------------------------------------*/
   declare @numrows int, @validcnt int, @nullcnt int, @rcode int, @errmsg varchar(255)
...
GO
ALTER TABLE [dbo].[bEMDG] WITH NOCHECK ADD CONSTRAINT [FK_bEMDG_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMDG] WITH NOCHECK ADD CONSTRAINT [FK_bEMDG_bEMDM_Department] FOREIGN KEY ([EMCo], [Department]) REFERENCES [dbo].[bEMDM] ([EMCo], [Department])
GO
ALTER TABLE [dbo].[bEMDG] WITH NOCHECK ADD CONSTRAINT [FK_bEMDG_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMDG] WITH NOCHECK ADD CONSTRAINT [FK_bEMDG_bEMCT_CostType] FOREIGN KEY ([EMGroup], [CostType]) REFERENCES [dbo].[bEMCT] ([EMGroup], [CostType])
GO
ALTER TABLE [dbo].[bEMDG] NOCHECK CONSTRAINT [FK_bEMDG_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMDG] NOCHECK CONSTRAINT [FK_bEMDG_bEMDM_Department]
GO
ALTER TABLE [dbo].[bEMDG] NOCHECK CONSTRAINT [FK_bEMDG_bHQGP_EMGroup]
GO
ALTER TABLE [dbo].[bEMDG] NOCHECK CONSTRAINT [FK_bEMDG_bEMCT_CostType]
GO
