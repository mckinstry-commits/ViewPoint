...
GO
ALTER TABLE [dbo].[bEMUE] WITH NOCHECK ADD CONSTRAINT [FK_bEMUE_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMUE] WITH NOCHECK ADD CONSTRAINT [FK_bEMUE_bEMUH_AUTemplate] FOREIGN KEY ([EMCo], [AUTemplate]) REFERENCES [dbo].[bEMUH] ([EMCo], [AUTemplate]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[bEMUE] WITH NOCHECK ADD CONSTRAINT [FK_bEMUE_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[bEMUE] WITH NOCHECK ADD CONSTRAINT [FK_bEMUE_bEMUR_RulesTable] FOREIGN KEY ([EMCo], [RulesTable]) REFERENCES [dbo].[bEMUR] ([EMCo], [RulesTable])
GO
ALTER TABLE [dbo].[bEMUE] NOCHECK CONSTRAINT [FK_bEMUE_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMUE] NOCHECK CONSTRAINT [FK_bEMUE_bEMUH_AUTemplate]
GO
ALTER TABLE [dbo].[bEMUE] NOCHECK CONSTRAINT [FK_bEMUE_bEMEM_Equipment]
GO
ALTER TABLE [dbo].[bEMUE] NOCHECK CONSTRAINT [FK_bEMUE_bEMUR_RulesTable]
GO
