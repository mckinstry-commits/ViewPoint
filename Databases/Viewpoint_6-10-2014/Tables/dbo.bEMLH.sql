...
GO
ALTER TABLE [dbo].[bEMLH] WITH NOCHECK ADD CONSTRAINT [FK_bEMLH_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMLH] WITH NOCHECK ADD CONSTRAINT [FK_bEMLH_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[bEMLH] NOCHECK CONSTRAINT [FK_bEMLH_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMLH] NOCHECK CONSTRAINT [FK_bEMLH_bEMEM_Equipment]
GO
