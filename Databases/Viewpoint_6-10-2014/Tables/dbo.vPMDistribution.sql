...
GO
ALTER TABLE [dbo].[vPMDistribution] WITH NOCHECK ADD CONSTRAINT [FK_vPMDistribution_bPMOH] FOREIGN KEY ([ApprovedCOID]) REFERENCES [dbo].[bPMOH] ([KeyID]) ON DELETE CASCADE
GO
...
GO
ALTER TABLE [dbo].[vPMDistribution] WITH NOCHECK ADD CONSTRAINT [FK_vPMDistribution_bPMMM] FOREIGN KEY ([MeetingMinuteID]) REFERENCES [dbo].[bPMMM] ([KeyID]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[vPMDistribution] WITH NOCHECK ADD CONSTRAINT [FK_vPMDistribution_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
...
GO
ALTER TABLE [dbo].[vPMDistribution] WITH NOCHECK ADD CONSTRAINT [FK_vPMDistribution_bPMPU] FOREIGN KEY ([PunchListID]) REFERENCES [dbo].[bPMPU] ([KeyID]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[vPMDistribution] WITH NOCHECK ADD CONSTRAINT [FK_vPMDistribution_bPOHD] FOREIGN KEY ([PurchaseOrderID]) REFERENCES [dbo].[bPOHD] ([KeyID]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[vPMDistribution] WITH NOCHECK ADD CONSTRAINT [FK_vPMDistribution_vPMRequestForQuote] FOREIGN KEY ([RFQID]) REFERENCES [dbo].[vPMRequestForQuote] ([KeyID]) ON DELETE CASCADE
GO
...
GO
ALTER TABLE [dbo].[vPMDistribution] WITH NOCHECK ADD CONSTRAINT [FK_vPMDistribution_bSLHD] FOREIGN KEY ([SubcontractID]) REFERENCES [dbo].[bSLHD] ([KeyID]) ON DELETE CASCADE
GO
...
GO
ALTER TABLE [dbo].[vPMDistribution] WITH NOCHECK ADD CONSTRAINT [FK_vPMDistribution_vPMSubmittalPackage] FOREIGN KEY ([SubmittalPackageID]) REFERENCES [dbo].[vPMSubmittalPackage] ([KeyID]) ON DELETE CASCADE
GO
...
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_bPMOH]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_vPMContractChangeOrder]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_vPMChangeOrderRequest]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_bPMDG]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_bPMIL]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_bPMIM]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_bPMMM]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_bJCJM]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_vPMPOCO_POCOID]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_bPMPU]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_bPOHD]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_vPMRequestForQuote]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_vPMSubcontractCO]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_bSLHD]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_bPMSM]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_vPMSubmittalPackage]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_bPMTL]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_bPMFM]
GO
ALTER TABLE [dbo].[vPMDistribution] NOCHECK CONSTRAINT [FK_vPMDistribution_bPMPM]
GO
