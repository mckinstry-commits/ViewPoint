...
GO
ALTER TABLE [dbo].[vJCJobApprovalProcess] WITH NOCHECK ADD CONSTRAINT [FK_vJCJobApprovalProcess_bJCJM_Job] FOREIGN KEY ([JCCo], [Job]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
...
GO
ALTER TABLE [dbo].[vJCJobApprovalProcess] NOCHECK CONSTRAINT [FK_vJCJobApprovalProcess_bJCJM_Job]
GO
ALTER TABLE [dbo].[vJCJobApprovalProcess] NOCHECK CONSTRAINT [FK_vJCJobApprovalProcess_vWFProcess_Process]
GO
