...
GO
ALTER TABLE [dbo].[vPRCraftClassAllowance] ADD CONSTRAINT [PK_vPRCraftClassAllowance] PRIMARY KEY CLUSTERED  ([PRCo], [Craft], [Class], [AllowanceTypeName]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[vPRCraftClassAllowance] NOCHECK CONSTRAINT [FK_vPRCraftClassAllowance_vPRAllowanceType]
GO
ALTER TABLE [dbo].[vPRCraftClassAllowance] NOCHECK CONSTRAINT [FK_vPRCraftClassAllowance_vPRAllowanceRuleSet]
GO
ALTER TABLE [dbo].[vPRCraftClassAllowance] NOCHECK CONSTRAINT [FK_vPRCraftClassAllowance_bPRCC]
GO
