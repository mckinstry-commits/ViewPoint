...
[UnitCost] [dbo].[bUnitCost] NULL CONSTRAINT [DF_bPOJM_UnitCost] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[bPOJM] WITH NOCHECK ADD CONSTRAINT [CK_bPOJM_CostECM] CHECK (([CostECM]='E' OR [CostECM]='C' OR [CostECM]='M' OR [CostECM] IS NULL))
GO
