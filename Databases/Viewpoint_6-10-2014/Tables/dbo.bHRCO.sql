...
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AccidentHistYN] CHECK (([AccidentHistYN]='Y' OR [AccidentHistYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditAccidentsYN] CHECK (([AuditAccidentsYN]='Y' OR [AuditAccidentsYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditAssetYN] CHECK (([AuditAssetYN]='Y' OR [AuditAssetYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditBenefitsYN] CHECK (([AuditBenefitsYN]='Y' OR [AuditBenefitsYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditCoYN] CHECK (([AuditCoYN]='Y' OR [AuditCoYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditDisciplineYN] CHECK (([AuditDisciplineYN]='Y' OR [AuditDisciplineYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditDrugYN] CHECK (([AuditDrugYN]='Y' OR [AuditDrugYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditEmplHistYN] CHECK (([AuditEmplHistYN]='Y' OR [AuditEmplHistYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditGrievanceYN] CHECK (([AuditGrievanceYN]='Y' OR [AuditGrievanceYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditPositionsYN] CHECK (([AuditPositionsYN]='Y' OR [AuditPositionsYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditResourceYN] CHECK (([AuditResourceYN]='Y' OR [AuditResourceYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditReviewYN] CHECK (([AuditReviewYN]='Y' OR [AuditReviewYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditRewardsYN] CHECK (([AuditRewardsYN]='Y' OR [AuditRewardsYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditSalaryHistYN] CHECK (([AuditSalaryHistYN]='Y' OR [AuditSalaryHistYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditSkillsYN] CHECK (([AuditSkillsYN]='Y' OR [AuditSkillsYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_AuditTrainingYN] CHECK (([AuditTrainingYN]='Y' OR [AuditTrainingYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_BenefitHistYN] CHECK (([BenefitHistYN]='Y' OR [BenefitHistYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_DependHistYN] CHECK (([DependHistYN]='Y' OR [DependHistYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_DisciplineHistYN] CHECK (([DisciplineHistYN]='Y' OR [DisciplineHistYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_DrugHistYN] CHECK (([DrugHistYN]='Y' OR [DrugHistYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_GrievHistYN] CHECK (([GrievHistYN]='Y' OR [GrievHistYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_ReviewHistYN] CHECK (([ReviewHistYN]='Y' OR [ReviewHistYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_RewardHistYN] CHECK (([RewardHistYN]='Y' OR [RewardHistYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_SalaryHistYN] CHECK (([SalaryHistYN]='Y' OR [SalaryHistYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_SkillsHistYN] CHECK (([SkillsHistYN]='Y' OR [SkillsHistYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_TrainHistYN] CHECK (([TrainHistYN]='Y' OR [TrainHistYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_UpdateActiveYN] CHECK (([UpdateActiveYN]='Y' OR [UpdateActiveYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_UpdateAddressYN] CHECK (([UpdateAddressYN]='Y' OR [UpdateAddressYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_UpdateBenefitsYN] CHECK (([UpdateBenefitsYN]='Y' OR [UpdateBenefitsYN]='N' OR [UpdateBenefitsYN] IS NULL))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_UpdateHireDateYN] CHECK (([UpdateHireDateYN]='Y' OR [UpdateHireDateYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_UpdateNameYN] CHECK (([UpdateNameYN]='Y' OR [UpdateNameYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_UpdateOccupCatYN] CHECK (([UpdateOccupCatYN]='Y' OR [UpdateOccupCatYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_UpdatePRGroupYN] CHECK (([UpdatePRGroupYN]='Y' OR [UpdatePRGroupYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_UpdateSSNYN] CHECK (([UpdateSSNYN]='Y' OR [UpdateSSNYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_UpdateSalaryYN] CHECK (([UpdateSalaryYN]='Y' OR [UpdateSalaryYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_UpdateTimecardYN] CHECK (([UpdateTimecardYN]='Y' OR [UpdateTimecardYN]='N'))
GO
ALTER TABLE [dbo].[bHRCO] WITH NOCHECK ADD CONSTRAINT [CK_bHRCO_UpdateW4YN] CHECK (([UpdateW4YN]='Y' OR [UpdateW4YN]='N'))
GO
