...
GO
ALTER TABLE [dbo].[vJCJPRoles] WITH NOCHECK ADD CONSTRAINT [CK_vJCJPRoles_Process] CHECK (([Process]='C' OR [Process]='P'))
GO
...
GO
ALTER TABLE [dbo].[vJCJPRoles] WITH NOCHECK ADD CONSTRAINT [FK_vJCJPRoles_bJCJP] FOREIGN KEY ([JCCo], [Job], [PhaseGroup], [Phase]) REFERENCES [dbo].[bJCJP] ([JCCo], [Job], [PhaseGroup], [Phase]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[vJCJPRoles] NOCHECK CONSTRAINT [FK_vJCJPRoles_bJCJP]
GO
