...
[UseStdDocumentTitle] [char] (1) COLLATE Latin1_General_BIN NOT NULL CONSTRAINT [DF_bPMCU_UseStdDocumentTitle] DEFAULT ('Y'),
...
GO
ALTER TABLE [dbo].[bPMCU] WITH NOCHECK ADD CONSTRAINT [CK_bPMCU_AttachToParent] CHECK (([AttachToParent]='Y' OR [AttachToParent]='N'))
GO
ALTER TABLE [dbo].[bPMCU] WITH NOCHECK ADD CONSTRAINT [CK_bPMCU_Inactive] CHECK (([Inactive]='N' OR [Inactive]='Y'))
GO
ALTER TABLE [dbo].[bPMCU] WITH NOCHECK ADD CONSTRAINT [CK_bPMCU_UseStdCCList] CHECK (([UseStdCCList]='N' OR [UseStdCCList]='Y'))
GO
ALTER TABLE [dbo].[bPMCU] WITH NOCHECK ADD CONSTRAINT [CK_bPMCU_UseStdFileName] CHECK (([UseStdFileName]='N' OR [UseStdFileName]='Y'))
GO
ALTER TABLE [dbo].[bPMCU] WITH NOCHECK ADD CONSTRAINT [CK_bPMCU_UseStdSubject] CHECK (([UseStdSubject]='N' OR [UseStdSubject]='Y'))
GO
...
GO
ALTER TABLE [dbo].[bPMCU] NOCHECK CONSTRAINT [FK_bPMCU_bPMCT]
GO
