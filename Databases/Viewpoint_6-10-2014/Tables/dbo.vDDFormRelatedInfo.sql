...
GO
ALTER TABLE [dbo].[vDDFormRelatedInfo] WITH NOCHECK ADD CONSTRAINT [FK_vDDFormRelatedInfo_vDDFH_Form] FOREIGN KEY ([Form]) REFERENCES [dbo].[vDDFH] ([Form]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[vDDFormRelatedInfo] NOCHECK CONSTRAINT [FK_vDDFormRelatedInfo_vDDFH_Form]
GO
