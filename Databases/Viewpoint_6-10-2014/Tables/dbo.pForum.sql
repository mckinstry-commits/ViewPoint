...
GO
ALTER TABLE [dbo].[pForum] ADD CONSTRAINT [PK_pForum] PRIMARY KEY CLUSTERED  ([ForumID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
ALTER TABLE [dbo].[pForum] WITH NOCHECK ADD CONSTRAINT [FK_pForum_pForum] FOREIGN KEY ([ParentID]) REFERENCES [dbo].[pForum] ([ForumID])
GO
ALTER TABLE [dbo].[pForum] NOCHECK CONSTRAINT [FK_pForum_pForum]
GO
