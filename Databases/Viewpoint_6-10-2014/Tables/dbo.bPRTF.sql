...
[OldRate] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPRTF_OldRate] DEFAULT ((0)),
[NewRate] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPRTF_NewRate] DEFAULT ((0)),
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRTF] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRTF] ON [dbo].[bPRTF] ([PRCo], [Craft], [Class], [Template], [EarnCode], [Factor]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
