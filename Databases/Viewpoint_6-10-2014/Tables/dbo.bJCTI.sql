...
GO
CREATE UNIQUE CLUSTERED INDEX [biJCTI] ON [dbo].[bJCTI] ([JCCo], [InsTemplate], [PhaseGroup], [Phase]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCTI] ([KeyID]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
