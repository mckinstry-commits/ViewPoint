...
GO
ALTER TABLE [dbo].[bJBER] WITH NOCHECK ADD CONSTRAINT [CK_bJBER_RestrictByEquip] CHECK (([RestrictByEquip]='Y' OR [RestrictByEquip]='N'))
GO
ALTER TABLE [dbo].[bJBER] WITH NOCHECK ADD CONSTRAINT [CK_bJBER_RestrictByRevCode] CHECK (([RestrictByRevCode]='Y' OR [RestrictByRevCode]='N'))
GO
