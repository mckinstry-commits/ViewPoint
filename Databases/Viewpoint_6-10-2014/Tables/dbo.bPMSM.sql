...
if @subfirm is not null and @subcontact is not null
	...
	exec @rcode = dbo.vspPMDistSubmittalInit @pmco, @project, @submittaltype, @submittal, @rev,
				@subfirm, @subcontact, @pmsm_keyid, @errmsg output
	if @rcode <> 0
		begin
...
if @archengfirm is not null and @archengcontact is not null
	...
	exec @rcode = dbo.vspPMDistSubmittalInit @pmco, @project, @submittaltype, @submittal, @rev,
				@archengfirm, @archengcontact, @pmsm_keyid, @errmsg output
	if @rcode <> 0
		begin
...
GO
ALTER TABLE [dbo].[bPMSM] WITH NOCHECK ADD CONSTRAINT [FK_bPMSM_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
ALTER TABLE [dbo].[bPMSM] WITH NOCHECK ADD CONSTRAINT [FK_bPMSM_bPMSC] FOREIGN KEY ([Status]) REFERENCES [dbo].[bPMSC] ([Status])
GO
ALTER TABLE [dbo].[bPMSM] WITH NOCHECK ADD CONSTRAINT [FK_bPMSM_bPMDT] FOREIGN KEY ([SubmittalType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
ALTER TABLE [dbo].[bPMSM] WITH NOCHECK ADD CONSTRAINT [FK_bPMSM_bPMFM_ArchEngFirm] FOREIGN KEY ([VendorGroup], [ArchEngFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
GO
ALTER TABLE [dbo].[bPMSM] WITH NOCHECK ADD CONSTRAINT [FK_bPMSM_bPMPM_ArchEngContact] FOREIGN KEY ([VendorGroup], [ArchEngFirm], [ArchEngContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
GO
ALTER TABLE [dbo].[bPMSM] WITH NOCHECK ADD CONSTRAINT [FK_bPMSM_bPMPM_ResponsiblePerson] FOREIGN KEY ([VendorGroup], [ResponsibleFirm], [ResponsiblePerson]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
GO
ALTER TABLE [dbo].[bPMSM] WITH NOCHECK ADD CONSTRAINT [FK_bPMSM_bPMFM_SubFirm] FOREIGN KEY ([VendorGroup], [SubFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
GO
ALTER TABLE [dbo].[bPMSM] WITH NOCHECK ADD CONSTRAINT [FK_bPMSM_bPMPM_SubContact] FOREIGN KEY ([VendorGroup], [SubFirm], [SubContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
GO
ALTER TABLE [dbo].[bPMSM] NOCHECK CONSTRAINT [FK_bPMSM_bJCJM]
GO
ALTER TABLE [dbo].[bPMSM] NOCHECK CONSTRAINT [FK_bPMSM_bPMSC]
GO
ALTER TABLE [dbo].[bPMSM] NOCHECK CONSTRAINT [FK_bPMSM_bPMDT]
GO
ALTER TABLE [dbo].[bPMSM] NOCHECK CONSTRAINT [FK_bPMSM_bPMFM_ArchEngFirm]
GO
ALTER TABLE [dbo].[bPMSM] NOCHECK CONSTRAINT [FK_bPMSM_bPMPM_ArchEngContact]
GO
ALTER TABLE [dbo].[bPMSM] NOCHECK CONSTRAINT [FK_bPMSM_bPMPM_ResponsiblePerson]
GO
ALTER TABLE [dbo].[bPMSM] NOCHECK CONSTRAINT [FK_bPMSM_bPMFM_SubFirm]
GO
ALTER TABLE [dbo].[bPMSM] NOCHECK CONSTRAINT [FK_bPMSM_bPMPM_SubContact]
GO
