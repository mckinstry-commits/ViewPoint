...
GO
ALTER TABLE [dbo].[bMSTX] WITH NOCHECK ADD CONSTRAINT [CK_bMSTX_Changed] CHECK (([Changed]='Y' OR [Changed]='N'))
GO
ALTER TABLE [dbo].[bMSTX] WITH NOCHECK ADD CONSTRAINT [CK_bMSTX_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M'))
GO
ALTER TABLE [dbo].[bMSTX] WITH NOCHECK ADD CONSTRAINT [CK_bMSTX_Hold] CHECK (([Hold]='Y' OR [Hold]='N'))
GO
ALTER TABLE [dbo].[bMSTX] WITH NOCHECK ADD CONSTRAINT [CK_bMSTX_VerifyHaul] CHECK (([VerifyHaul]='Y' OR [VerifyHaul]='N'))
GO
ALTER TABLE [dbo].[bMSTX] WITH NOCHECK ADD CONSTRAINT [CK_bMSTX_Void] CHECK (([Void]='N' OR [Void]='Y'))
GO
