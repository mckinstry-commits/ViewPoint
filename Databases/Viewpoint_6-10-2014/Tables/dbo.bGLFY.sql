...
GO
ALTER TABLE [dbo].[bGLFY] WITH NOCHECK ADD CONSTRAINT [CK_bGLFY_BeginMthDayOfMth] CHECK ((datepart(day,[BeginMth])=(1)))
GO
ALTER TABLE [dbo].[bGLFY] WITH NOCHECK ADD CONSTRAINT [CK_bGLFY_FYEMO1to12BeginMth] CHECK ((datediff(month,[BeginMth],[FYEMO])<=(12)))
GO
ALTER TABLE [dbo].[bGLFY] WITH NOCHECK ADD CONSTRAINT [CK_bGLFY_FYEMOFirstDayOfMth] CHECK ((datepart(day,[FYEMO])=(1)))
GO
ALTER TABLE [dbo].[bGLFY] WITH NOCHECK ADD CONSTRAINT [CK_bGLFY_FYEMOgtBeginMth] CHECK (([FYEMO]>=[BeginMth]))
GO
ALTER TABLE [dbo].[bGLFY] WITH NOCHECK ADD CONSTRAINT [CK_bGLFY_FirstDayOfMth] CHECK ((datepart(day,[FYEMO])=(1)))
GO
...
GO
ALTER TABLE [dbo].[bGLFY] NOCHECK CONSTRAINT [FK_bGLFY_bGLCO_GLCo]
GO
