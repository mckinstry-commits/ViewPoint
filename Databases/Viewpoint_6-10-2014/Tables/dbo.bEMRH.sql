...
GO
ALTER TABLE [dbo].[bEMRH] WITH NOCHECK ADD CONSTRAINT [CK_bEMRH_AllowPostOride] CHECK (([AllowPostOride]='N' OR [AllowPostOride]='Y'))
GO
ALTER TABLE [dbo].[bEMRH] WITH NOCHECK ADD CONSTRAINT [CK_bEMRH_ORideRate] CHECK (([ORideRate]='N' OR [ORideRate]='Y'))
GO
ALTER TABLE [dbo].[bEMRH] WITH NOCHECK ADD CONSTRAINT [CK_bEMRH_PostWorkUnits] CHECK (([PostWorkUnits]='N' OR [PostWorkUnits]='Y'))
GO
ALTER TABLE [dbo].[bEMRH] WITH NOCHECK ADD CONSTRAINT [CK_bEMRH_UpdtHrMeter] CHECK (([UpdtHrMeter]='N' OR [UpdtHrMeter]='Y'))
GO
...
GO
ALTER TABLE [dbo].[bEMRH] WITH NOCHECK ADD CONSTRAINT [FK_bEMRH_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMRH] WITH NOCHECK ADD CONSTRAINT [FK_bEMRH_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[bEMRH] WITH NOCHECK ADD CONSTRAINT [FK_bEMRH_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMRH] WITH NOCHECK ADD CONSTRAINT [FK_bEMRH_bEMRC_RevCode] FOREIGN KEY ([EMGroup], [RevCode]) REFERENCES [dbo].[bEMRC] ([EMGroup], [RevCode])
GO
ALTER TABLE [dbo].[bEMRH] NOCHECK CONSTRAINT [FK_bEMRH_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMRH] NOCHECK CONSTRAINT [FK_bEMRH_bEMEM_Equipment]
GO
ALTER TABLE [dbo].[bEMRH] NOCHECK CONSTRAINT [FK_bEMRH_bHQGP_EMGroup]
GO
ALTER TABLE [dbo].[bEMRH] NOCHECK CONSTRAINT [FK_bEMRH_bEMRC_RevCode]
GO
