...
GO
ALTER TABLE [dbo].[bHQWO] WITH NOCHECK ADD CONSTRAINT [CK_bHQWO_Required] CHECK (([Required]='Y' OR [Required]='N'))
GO
ALTER TABLE [dbo].[bHQWO] WITH NOCHECK ADD CONSTRAINT [CK_bHQWO_WordTable] CHECK (([WordTable]='Y' OR [WordTable]='N'))
GO
