...
[udOperatingAs] [varchar] (30) COLLATE Latin1_General_BIN NULL,
[udEmployeeYN] [dbo].[bYN] NULL CONSTRAINT [DF__bAPVM__udEmployeeYN__DEFAULT] DEFAULT ('N'),
[udMaterialVendYN] [dbo].[bYN] NULL CONSTRAINT [DF__bAPVM__udMaterialVendYN__DEFAULT] DEFAULT ('N'),
[udSubYN] [dbo].[bYN] NULL CONSTRAINT [DF__bAPVM__udSubYN__DEFAULT] DEFAULT ('N')
...
-- Description:	Remove confidential info from employee records
/*
--Added NULL TaxId when udEmployeeYN = Y --2/11/14
*/
-- =============================================
CREATE TRIGGER [dbo].[mckSensitiveInfoDelete] 
   ON  [dbo].[bAPVM] 
   AFTER INSERT,UPDATE
AS 
BEGIN
	...
	DECLARE @VendorGroup TINYINT, @Vendor INT

	SELECT @VendorGroup = VendorGroup, @Vendor = Vendor FROM INSERTED

	IF EXISTS(SELECT 1 FROM INSERTED WHERE udEmployeeYN = 'Y')
	BEGIN
		UPDATE bAPVM 
		SET Address = NULL, Address2 = NULL, City = NULL, State = NULL, Zip = NULL, POAddress = NULL, POAddress2 = NULL, POCity = NULL, POState = NULL, POZip = NULL, TaxId=NULL
...
END
GO
ALTER TABLE [dbo].[bAPVM] WITH NOCHECK ADD CONSTRAINT [CK_bAPVM_ActiveYN] CHECK (([ActiveYN]='Y' OR [ActiveYN]='N'))
GO
ALTER TABLE [dbo].[bAPVM] WITH NOCHECK ADD CONSTRAINT [CK_bAPVM_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
GO
ALTER TABLE [dbo].[bAPVM] WITH NOCHECK ADD CONSTRAINT [CK_bAPVM_OverrideMinAmtYN] CHECK (([OverrideMinAmtYN]='Y' OR [OverrideMinAmtYN]='N'))
GO
ALTER TABLE [dbo].[bAPVM] WITH NOCHECK ADD CONSTRAINT [CK_bAPVM_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
ALTER TABLE [dbo].[bAPVM] WITH NOCHECK ADD CONSTRAINT [CK_bAPVM_SeparatePayInvYN] CHECK (([SeparatePayInvYN]='Y' OR [SeparatePayInvYN]='N'))
GO
ALTER TABLE [dbo].[bAPVM] WITH NOCHECK ADD CONSTRAINT [CK_bAPVM_TempYN] CHECK (([TempYN]='Y' OR [TempYN]='N'))
GO
ALTER TABLE [dbo].[bAPVM] WITH NOCHECK ADD CONSTRAINT [CK_bAPVM_UpdatePMYN] CHECK (([UpdatePMYN]='Y' OR [UpdatePMYN]='N'))
GO
ALTER TABLE [dbo].[bAPVM] WITH NOCHECK ADD CONSTRAINT [CK_bAPVM_V1099YN] CHECK (([V1099YN]='Y' OR [V1099YN]='N'))
GO
