...
GO
ALTER TABLE [dbo].[bPMIL] WITH NOCHECK ADD CONSTRAINT [FK_bPMIL_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
...
GO
ALTER TABLE [dbo].[bPMIL] NOCHECK CONSTRAINT [FK_bPMIL_bPMDT]
GO
ALTER TABLE [dbo].[bPMIL] NOCHECK CONSTRAINT [FK_bPMIL_bJCJM]
GO
ALTER TABLE [dbo].[bPMIL] NOCHECK CONSTRAINT [FK_bPMIL_bPMPL]
GO
ALTER TABLE [dbo].[bPMIL] NOCHECK CONSTRAINT [FK_bPMIL_bPMSC]
GO
ALTER TABLE [dbo].[bPMIL] NOCHECK CONSTRAINT [FK_bPMIL_bPMFM]
GO
ALTER TABLE [dbo].[bPMIL] NOCHECK CONSTRAINT [FK_bPMIL_bPMPM]
GO
