...
/*--------------------------------------------------------------
* Created By:   TRL 03/25/10 Issue 129350
* Modified By:	GF 04/26/2013 TFS-48496 removed old rate/min amount check for less than zero
*				
...
GO
ALTER TABLE [dbo].[bMSSurchargeOverrides] NOCHECK CONSTRAINT [FK_bMSSurchargeOverrides_bMSQH]
GO
ALTER TABLE [dbo].[bMSSurchargeOverrides] NOCHECK CONSTRAINT [FK_bMSSurchargeOverrides_bMSSurchargeCodes]
GO
