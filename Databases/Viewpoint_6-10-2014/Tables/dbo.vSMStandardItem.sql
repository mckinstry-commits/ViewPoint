...
GO
ALTER TABLE [dbo].[vSMStandardItem] WITH NOCHECK ADD CONSTRAINT [CK_vSMStandardItem_CostRate_BillableRate] CHECK (([CostRate] IS NOT NULL OR [BillableRate] IS NOT NULL))
GO
...
GO
ALTER TABLE [dbo].[vSMStandardItem] NOCHECK CONSTRAINT [FK_vSMStandardItem_vSMCO]
GO
ALTER TABLE [dbo].[vSMStandardItem] NOCHECK CONSTRAINT [FK_vSMStandardItem_vSMCostType]
GO
