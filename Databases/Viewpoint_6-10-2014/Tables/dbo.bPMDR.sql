...
GO
ALTER TABLE [dbo].[bPMDR] ADD CONSTRAINT [PK_bPMDR] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [DrawingType], [Drawing], [Rev]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[bPMDR] NOCHECK CONSTRAINT [FK_bPMDR_bPMDG]
GO
ALTER TABLE [dbo].[bPMDR] NOCHECK CONSTRAINT [FK_bPMDR_bPMSC]
GO
