...
GO
ALTER TABLE [dbo].[bPMSI] WITH NOCHECK ADD CONSTRAINT [CK_bPMSI_Send] CHECK (([Send]='Y' OR [Send]='N'))
GO
...
GO
ALTER TABLE [dbo].[bPMSI] WITH NOCHECK ADD CONSTRAINT [FK_bPMSI_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
...
GO
ALTER TABLE [dbo].[bPMSI] NOCHECK CONSTRAINT [FK_bPMSI_bJCJM]
GO
ALTER TABLE [dbo].[bPMSI] NOCHECK CONSTRAINT [FK_bPMSI_bPMSM]
GO
ALTER TABLE [dbo].[bPMSI] NOCHECK CONSTRAINT [FK_bPMSI_bPMSC]
GO
