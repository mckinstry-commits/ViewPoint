...
GO
ALTER TABLE [dbo].[bINPD] WITH NOCHECK ADD CONSTRAINT [CK_bINPD_ECM] CHECK (([ECM]='M' OR [ECM]='C' OR [ECM]='E'))
GO
ALTER TABLE [dbo].[bINPD] WITH NOCHECK ADD CONSTRAINT [CK_bINPD_PECM] CHECK (([PECM]='M' OR [PECM]='C' OR [PECM]='E'))
GO
