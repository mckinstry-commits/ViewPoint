...
GO
ALTER TABLE [dbo].[bARTH] WITH NOCHECK ADD CONSTRAINT [CK_bARTH_ARTransType] CHECK (([ARTransType]='A' OR [ARTransType]='C' OR [ARTransType]='F' OR [ARTransType]='I' OR [ARTransType]='M' OR [ARTransType]='P' OR [ARTransType]='R' OR [ARTransType]='V' OR [ARTransType]='W'))
GO
ALTER TABLE [dbo].[bARTH] WITH NOCHECK ADD CONSTRAINT [CK_bARTH_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000) OR [CMAcct] IS NULL))
GO
ALTER TABLE [dbo].[bARTH] WITH NOCHECK ADD CONSTRAINT [CK_bARTH_EditTrans] CHECK (([EditTrans]='Y' OR [EditTrans]='N'))
GO
ALTER TABLE [dbo].[bARTH] WITH NOCHECK ADD CONSTRAINT [CK_bARTH_ExcludeFC] CHECK (([ExcludeFC]='Y' OR [ExcludeFC]='N'))
GO
ALTER TABLE [dbo].[bARTH] WITH NOCHECK ADD CONSTRAINT [CK_bARTH_PurgeFlag] CHECK (([PurgeFlag]='Y' OR [PurgeFlag]='N'))
GO
