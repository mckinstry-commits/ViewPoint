...
GO
ALTER TABLE [dbo].[bJBMD] WITH NOCHECK ADD CONSTRAINT [CK_bJBMD_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
GO
ALTER TABLE [dbo].[bJBMD] WITH NOCHECK ADD CONSTRAINT [CK_bJBMD_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
