...
GO
ALTER TABLE [dbo].[bEMJT] WITH NOCHECK ADD CONSTRAINT [FK_bEMJT_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMJT] WITH NOCHECK ADD CONSTRAINT [FK_bEMJT_bEMUH_AUTemplate] FOREIGN KEY ([EMCo], [AUTemplate]) REFERENCES [dbo].[bEMUH] ([EMCo], [AUTemplate])
GO
ALTER TABLE [dbo].[bEMJT] WITH NOCHECK ADD CONSTRAINT [FK_bEMJT_bEMTH_RevTemplate] FOREIGN KEY ([EMCo], [RevTemplate]) REFERENCES [dbo].[bEMTH] ([EMCo], [RevTemplate])
GO
ALTER TABLE [dbo].[bEMJT] NOCHECK CONSTRAINT [FK_bEMJT_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMJT] NOCHECK CONSTRAINT [FK_bEMJT_bEMUH_AUTemplate]
GO
ALTER TABLE [dbo].[bEMJT] NOCHECK CONSTRAINT [FK_bEMJT_bEMTH_RevTemplate]
GO
