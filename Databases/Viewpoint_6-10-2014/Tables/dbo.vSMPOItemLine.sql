...
GO
ALTER TABLE [dbo].[vSMPOItemLine] ADD CONSTRAINT [PK_vSMPOItemLine] PRIMARY KEY CLUSTERED  ([POCo], [PO], [POItem], [POItemLine]) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[vSMPOItemLine] NOCHECK CONSTRAINT [FK_vSMPOItemLine_vPOItemLine]
GO
