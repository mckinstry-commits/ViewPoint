...
GO
ALTER TABLE [dbo].[bMSTB] WITH NOCHECK ADD CONSTRAINT [CK_bMSTB_Changed] CHECK (([Changed]='Y' OR [Changed]='N' OR [Changed] IS NULL))
GO
ALTER TABLE [dbo].[bMSTB] WITH NOCHECK ADD CONSTRAINT [CK_bMSTB_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
GO
ALTER TABLE [dbo].[bMSTB] WITH NOCHECK ADD CONSTRAINT [CK_bMSTB_Hold] CHECK (([Hold]='Y' OR [Hold]='N' OR [Hold] IS NULL))
GO
ALTER TABLE [dbo].[bMSTB] WITH NOCHECK ADD CONSTRAINT [CK_bMSTB_OldECM] CHECK (([OldECM]='E' OR [OldECM]='C' OR [OldECM]='M' OR [OldECM] IS NULL))
GO
ALTER TABLE [dbo].[bMSTB] WITH NOCHECK ADD CONSTRAINT [CK_bMSTB_OldHold] CHECK (([OldHold]='Y' OR [OldHold]='N' OR [OldHold] IS NULL))
GO
ALTER TABLE [dbo].[bMSTB] WITH NOCHECK ADD CONSTRAINT [CK_bMSTB_OldVerifyHaul] CHECK (([OldVerifyHaul]='Y' OR [OldVerifyHaul]='N' OR [OldVerifyHaul] IS NULL))
GO
ALTER TABLE [dbo].[bMSTB] WITH NOCHECK ADD CONSTRAINT [CK_bMSTB_OldVoid] CHECK (([OldVoid]='Y' OR [OldVoid]='N' OR [OldVoid] IS NULL))
GO
ALTER TABLE [dbo].[bMSTB] WITH NOCHECK ADD CONSTRAINT [CK_bMSTB_Void] CHECK (([Void]='Y' OR [Void]='N' OR [Void] IS NULL))
GO
