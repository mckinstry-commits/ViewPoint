...
----TFS-49039  
SELECT @validcnt = COUNT(*) FROM dbo.bEMEM EMEM JOIN inserted i ON i.Co = EMEM.EMCo AND i.Equipment = EMEM.Equipment and EMEM.ChangeInProgress = 'Y'
...
GO
ALTER TABLE [dbo].[bEMLB] WITH NOCHECK ADD CONSTRAINT [FK_bEMLB_bEMEM_Equipment] FOREIGN KEY ([Co], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment])
GO
ALTER TABLE [dbo].[bEMLB] NOCHECK CONSTRAINT [FK_bEMLB_bEMEM_Equipment]
GO
