...
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_AllowNoPhase] CHECK (([AllowNoPhase]='Y' OR [AllowNoPhase]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_AuditAccums] CHECK (([AuditAccums]='Y' OR [AuditAccums]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_AuditCoParams] CHECK (([AuditCoParams]='Y' OR [AuditCoParams]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_AuditCraftClass] CHECK (([AuditCraftClass]='Y' OR [AuditCraftClass]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_AuditDLs] CHECK (([AuditDLs]='Y' OR [AuditDLs]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_AuditEmployees] CHECK (([AuditEmployees]='Y' OR [AuditEmployees]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_AuditPayHistory] CHECK (([AuditPayHistory]='Y' OR [AuditPayHistory]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_AuditStateIns] CHECK (([AuditStateIns]='Y' OR [AuditStateIns]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_AuditTaxes] CHECK (([AuditTaxes]='Y' OR [AuditTaxes]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_AutoOT] CHECK (([AutoOT]='Y' OR [AutoOT]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_EMCostEmployee] CHECK (([EMCostEmployee]='Y' OR [EMCostEmployee]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_EMInterface] CHECK (([EMInterface]='Y' OR [EMInterface]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_EMRevEmployee] CHECK (([EMRevEmployee]='Y' OR [EMRevEmployee]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_EMRevPhase] CHECK (([EMRevPhase]='Y' OR [EMRevPhase]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_EMRevPostingDate] CHECK (([EMRevPostingDate]='Y' OR [EMRevPostingDate]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_EMUsage] CHECK (([EMUsage]='Y' OR [EMUsage]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_ExcludeSSN] CHECK (([ExcludeSSN]='Y' OR [ExcludeSSN]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_GLInterface] CHECK (([GLInterface]='Y' OR [GLInterface]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_InsByPhase] CHECK (([InsByPhase]='Y' OR [InsByPhase]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_InsStateOpt] CHECK (([InsStateOpt]='Y' OR [InsStateOpt]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_JCICraftClass] CHECK (([JCICraftClass]='Y' OR [JCICraftClass]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_JCICrew] CHECK (([JCICrew]='Y' OR [JCICrew]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_JCIEarnType] CHECK (([JCIEarnType]='Y' OR [JCIEarnType]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_JCIEmployee] CHECK (([JCIEmployee]='Y' OR [JCIEmployee]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_JCIEquip] CHECK (([JCIEquip]='Y' OR [JCIEquip]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_JCIFactor] CHECK (([JCIFactor]='Y' OR [JCIFactor]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_JCILiabFactor] CHECK (([JCILiabFactor]='Y' OR [JCILiabFactor]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_JCILiabShift] CHECK (([JCILiabShift]='Y' OR [JCILiabShift]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_JCILiabType] CHECK (([JCILiabType]='Y' OR [JCILiabType]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_JCIPostingDate] CHECK (([JCIPostingDate]='Y' OR [JCIPostingDate]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_JCIRevCode] CHECK (([JCIRevCode]='Y' OR [JCIRevCode]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_JCIShift] CHECK (([JCIShift]='Y' OR [JCIShift]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_JCInterface] CHECK (([JCInterface]='Y' OR [JCInterface]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_LocalOpt] CHECK (([LocalOpt]='Y' OR [LocalOpt]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_NonNegCheckPrint] CHECK (([NonNegCheckPrint]='Y' OR [NonNegCheckPrint]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_TaxStateOpt] CHECK (([TaxStateOpt]='Y' OR [TaxStateOpt]='N'))
GO
ALTER TABLE [dbo].[bPRCO] WITH NOCHECK ADD CONSTRAINT [CK_bPRCO_UnempStateOpt] CHECK (([UnempStateOpt]='Y' OR [UnempStateOpt]='N'))
GO
