...
GO
ALTER TABLE [dbo].[bPMMM] NOCHECK CONSTRAINT [FK_bPMMM_bPMDT]
GO
ALTER TABLE [dbo].[bPMMM] NOCHECK CONSTRAINT [FK_bPMMM_bJCJM]
GO
ALTER TABLE [dbo].[bPMMM] NOCHECK CONSTRAINT [FK_bPMMM_bPMPM]
GO
