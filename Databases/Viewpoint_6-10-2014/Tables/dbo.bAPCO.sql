...
error:
	...
	ROLLBACK TRANSACTION
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_APRefUnqYN] CHECK (([APRefUnqYN]='Y' OR [APRefUnqYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_AllAllowPayYN] CHECK (([AllAllowPayYN]='Y' OR [AllAllowPayYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_AllCompChkYN] CHECK (([AllCompChkYN]='Y' OR [AllCompChkYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_AuditCoParams] CHECK (([AuditCoParams]='Y' OR [AuditCoParams]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_AuditComp] CHECK (([AuditComp]='Y' OR [AuditComp]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_AuditHold] CHECK (([AuditHold]='Y' OR [AuditHold]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_AuditPay] CHECK (([AuditPay]='Y' OR [AuditPay]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_AuditPayTypes] CHECK (([AuditPayTypes]='Y' OR [AuditPayTypes]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_AuditRecur] CHECK (([AuditRecur]='Y' OR [AuditRecur]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_AuditTrans] CHECK (([AuditTrans]='Y' OR [AuditTrans]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_AuditUnappInv] CHECK (([AuditUnappInv]='Y' OR [AuditUnappInv]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_AuditVendors] CHECK (([AuditVendors]='Y' OR [AuditVendors]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000) OR [CMAcct] IS NULL))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_ICRptYN] CHECK (([ICRptYN]='Y' OR [ICRptYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_InvExceedRecvdYN] CHECK (([InvExceedRecvdYN]='Y' OR [InvExceedRecvdYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_InvTotYN] CHECK (([InvTotYN]='Y' OR [InvTotYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_JobLineDescDfltYN] CHECK (([JobLineDescDfltYN]='Y' OR [JobLineDescDfltYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_NetAmtOpt] CHECK (([NetAmtOpt]='Y' OR [NetAmtOpt]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_OverridePayType] CHECK (([OverridePayType]='Y' OR [OverridePayType]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_PMVendAddYN] CHECK (([PMVendAddYN]='Y' OR [PMVendAddYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_PMVendUpdYN] CHECK (([PMVendUpdYN]='Y' OR [PMVendUpdYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_POAllowPayYN] CHECK (([POAllowPayYN]='Y' OR [POAllowPayYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_POCompChkYN] CHECK (([POCompChkYN]='Y' OR [POCompChkYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_POItemTotYN] CHECK (([POItemTotYN]='Y' OR [POItemTotYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_POTotYN] CHECK (([POTotYN]='Y' OR [POTotYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_PayCategoryYN] CHECK (([PayCategoryYN]='Y' OR [PayCategoryYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_SLAllowPayYN] CHECK (([SLAllowPayYN]='Y' OR [SLAllowPayYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_SLCompChkYN] CHECK (([SLCompChkYN]='Y' OR [SLCompChkYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_SLTotYN] CHECK (([SLTotYN]='Y' OR [SLTotYN]='N'))
GO
ALTER TABLE [dbo].[bAPCO] WITH NOCHECK ADD CONSTRAINT [CK_bAPCO_UseTaxDiscountYN] CHECK (([UseTaxDiscountYN]='Y' OR [UseTaxDiscountYN]='N'))
GO
CREATE UNIQUE CLUSTERED INDEX [biAPCO] ON [dbo].[bAPCO] ([APCo]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPCO] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
