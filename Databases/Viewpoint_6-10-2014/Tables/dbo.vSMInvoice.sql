...
[InvoiceNumber] [varchar] (10) COLLATE Latin1_General_BIN NOT NULL,
...
DECLARE @HQMAKeys TABLE
	(
		...
		, KeyString		varchar(max)
							...
							SELECT
								'vSMInvoice' , 
								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(deleted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(deleted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 
								deleted.SMCo , 
								'D' , 
								'ARCo' , 
							...
							SELECT
								...
								'D' , 
								'InvoiceNumber' , 
								CONVERT(VARCHAR(MAX), deleted.[InvoiceNumber]) , 								NULL , 
								GETDATE() , 
								SUSER_SNAME()
							FROM deleted
								JOIN dbo.vAuditFlagCompany AS afc ON deleted.SMCo = afc.AuditCo 
				...
				FROM deleted AS d
				INNER JOIN @HQMAKeys AS Keys ON Keys.KeyString = '<KeyString Invoice = "' + REPLACE(CAST(ISNULL(d.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(d.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />'
...
-- log additions to the ARCo column
							...
							SELECT 
								'vSMInvoice' , 
								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 
...
-- log additions to the InvoiceNumber column
							INSERT dbo.bHQMA (	
													TableName, 
													KeyString, 
													Co, 
...
-- log additions to the WorkOrder column
 ...
 INSERT INTO HQSA ( AuditID, Datatype, Qualifier, Instance, TableName)
				...
				FROM inserted AS i
				INNER JOIN @HQMAKeys AS Keys ON Keys.KeyString = '<KeyString Invoice = "' + REPLACE(CAST(ISNULL(i.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(i.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />'
	...
	(
		...
		, KeyString		varchar(max)
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'ARCo' , 								CONVERT(VARCHAR(MAX), deleted.[ARCo]) , 								CONVERT(VARCHAR(MAX), inserted.[ARCo]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'ARPostedMth' , 								CONVERT(VARCHAR(MAX), deleted.[ARPostedMth]) , 								CONVERT(VARCHAR(MAX), inserted.[ARPostedMth]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'ARTrans' , 								CONVERT(VARCHAR(MAX), deleted.[ARTrans]) , 								CONVERT(VARCHAR(MAX), inserted.[ARTrans]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'BatchMonth' , 								CONVERT(VARCHAR(MAX), deleted.[BatchMonth]) , 								CONVERT(VARCHAR(MAX), inserted.[BatchMonth]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'BillAddress' , 								CONVERT(VARCHAR(MAX), deleted.[BillAddress]) , 								CONVERT(VARCHAR(MAX), inserted.[BillAddress]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'BillAddress2' , 								CONVERT(VARCHAR(MAX), deleted.[BillAddress2]) , 								CONVERT(VARCHAR(MAX), inserted.[BillAddress2]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'BillCity' , 								CONVERT(VARCHAR(MAX), deleted.[BillCity]) , 								CONVERT(VARCHAR(MAX), inserted.[BillCity]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'BillCountry' , 								CONVERT(VARCHAR(MAX), deleted.[BillCountry]) , 								CONVERT(VARCHAR(MAX), inserted.[BillCountry]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'BillState' , 								CONVERT(VARCHAR(MAX), deleted.[BillState]) , 								CONVERT(VARCHAR(MAX), inserted.[BillState]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'BillToARCustomer' , 								CONVERT(VARCHAR(MAX), deleted.[BillToARCustomer]) , 								CONVERT(VARCHAR(MAX), inserted.[BillToARCustomer]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'BillZip' , 								CONVERT(VARCHAR(MAX), deleted.[BillZip]) , 								CONVERT(VARCHAR(MAX), inserted.[BillZip]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'CustGroup' , 								CONVERT(VARCHAR(MAX), deleted.[CustGroup]) , 								CONVERT(VARCHAR(MAX), inserted.[CustGroup]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'Customer' , 								CONVERT(VARCHAR(MAX), deleted.[Customer]) , 								CONVERT(VARCHAR(MAX), inserted.[Customer]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'DeliveredBy' , 								CONVERT(VARCHAR(MAX), deleted.[DeliveredBy]) , 								CONVERT(VARCHAR(MAX), inserted.[DeliveredBy]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'DeliveredDate' , 								CONVERT(VARCHAR(MAX), deleted.[DeliveredDate]) , 								CONVERT(VARCHAR(MAX), inserted.[DeliveredDate]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'DiscDate' , 								CONVERT(VARCHAR(MAX), deleted.[DiscDate]) , 								CONVERT(VARCHAR(MAX), inserted.[DiscDate]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'DiscRate' , 								CONVERT(VARCHAR(MAX), deleted.[DiscRate]) , 								CONVERT(VARCHAR(MAX), inserted.[DiscRate]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'DueDate' , 								CONVERT(VARCHAR(MAX), deleted.[DueDate]) , 								CONVERT(VARCHAR(MAX), inserted.[DueDate]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'Invoice' , 								CONVERT(VARCHAR(MAX), deleted.[Invoice]) , 								CONVERT(VARCHAR(MAX), inserted.[Invoice]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'InvoiceDate' , 								CONVERT(VARCHAR(MAX), deleted.[InvoiceDate]) , 								CONVERT(VARCHAR(MAX), inserted.[InvoiceDate]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'InvoiceNumber' , 								CONVERT(VARCHAR(MAX), deleted.[InvoiceNumber]) , 								CONVERT(VARCHAR(MAX), inserted.[InvoiceNumber]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
									AND ((inserted.[InvoiceNumber] <> deleted.[InvoiceNumber]) OR (inserted.[InvoiceNumber] IS NULL AND deleted.[InvoiceNumber] IS NOT NULL) OR (inserted.[InvoiceNumber] IS NOT NULL AND deleted.[InvoiceNumber] IS NULL))
								JOIN dbo.vAuditFlagCompany AS afc ON inserted.SMCo = afc.AuditCo 
							WHERE afc.AuditFlagID = 13
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'InvoiceSummaryLevel' , 								CONVERT(VARCHAR(MAX), deleted.[InvoiceSummaryLevel]) , 								CONVERT(VARCHAR(MAX), inserted.[InvoiceSummaryLevel]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'InvoiceType' , 								CONVERT(VARCHAR(MAX), deleted.[InvoiceType]) , 								CONVERT(VARCHAR(MAX), inserted.[InvoiceType]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'Invoiced' , 								CONVERT(VARCHAR(MAX), deleted.[Invoiced]) , 								CONVERT(VARCHAR(MAX), inserted.[Invoiced]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'PayTerms' , 								CONVERT(VARCHAR(MAX), deleted.[PayTerms]) , 								CONVERT(VARCHAR(MAX), inserted.[PayTerms]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'ReportID' , 								CONVERT(VARCHAR(MAX), deleted.[ReportID]) , 								CONVERT(VARCHAR(MAX), inserted.[ReportID]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'SMCo' , 								CONVERT(VARCHAR(MAX), deleted.[SMCo]) , 								CONVERT(VARCHAR(MAX), inserted.[SMCo]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'SMInvoiceID' , 								CONVERT(VARCHAR(MAX), deleted.[SMInvoiceID]) , 								CONVERT(VARCHAR(MAX), inserted.[SMInvoiceID]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'ServiceSite' , 								CONVERT(VARCHAR(MAX), deleted.[ServiceSite]) , 								CONVERT(VARCHAR(MAX), inserted.[ServiceSite]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'SessionDeliver' , 								CONVERT(VARCHAR(MAX), deleted.[SessionDeliver]) , 								CONVERT(VARCHAR(MAX), inserted.[SessionDeliver]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'UniqueAttchID' , 								CONVERT(VARCHAR(MAX), deleted.[UniqueAttchID]) , 								CONVERT(VARCHAR(MAX), inserted.[UniqueAttchID]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'VoidDate' , 								CONVERT(VARCHAR(MAX), deleted.[VoidDate]) , 								CONVERT(VARCHAR(MAX), inserted.[VoidDate]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'VoidedBy' , 								CONVERT(VARCHAR(MAX), deleted.[VoidedBy]) , 								CONVERT(VARCHAR(MAX), inserted.[VoidedBy]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
							...
							INSERT dbo.bHQMA (	TableName, 
																	...
																	UserName)
										OUTPUT inserted.AuditID, inserted.KeyString INTO @HQMAKeys (AuditID, KeyString) 
								SELECT 							'vSMInvoice' , 								'<KeyString Invoice = "' + REPLACE(CAST(ISNULL(inserted.[Invoice],'') AS VARCHAR(MAX)),'"', '&quot;') + '" SMCo = "' + REPLACE(CAST(ISNULL(inserted.[SMCo],'') AS VARCHAR(MAX)),'"', '&quot;') + '" />' , 								inserted.SMCo , 								'C' , 								'WorkOrder' , 								CONVERT(VARCHAR(MAX), deleted.[WorkOrder]) , 								CONVERT(VARCHAR(MAX), inserted.[WorkOrder]) , 								GETDATE() , 								SUSER_SNAME()
							FROM inserted
								INNER JOIN deleted
									ON  inserted.[SMInvoiceID] = deleted.[SMInvoiceID] 
...
GO
ALTER TABLE [dbo].[vSMInvoice] WITH NOCHECK ADD CONSTRAINT [CK_vSMInvoice_InvoiceType] CHECK (([InvoiceType]='W' OR [InvoiceType]='A'))
GO
ALTER TABLE [dbo].[vSMInvoice] WITH NOCHECK ADD CONSTRAINT [CK_vSMInvoice_Invoiced] CHECK (([Invoiced]=case when [ARPostedMth] IS NOT NULL OR [ARTrans] IS NOT NULL then (1) else [Invoiced] end))
GO
ALTER TABLE [dbo].[vSMInvoice] ADD CONSTRAINT [PK_vSMInvoice] PRIMARY KEY CLUSTERED  ([SMInvoiceID]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[vSMInvoice] ADD CONSTRAINT [IX_vSMInvoice] UNIQUE NONCLUSTERED  ([SMCo], [Invoice]) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[vSMInvoice] WITH NOCHECK ADD CONSTRAINT [FK_vSMInvoice_bARTH] FOREIGN KEY ([ARCo], [ARPostedMth], [ARTrans]) REFERENCES [dbo].[bARTH] ([ARCo], [Mth], [ARTrans])
GO
ALTER TABLE [dbo].[vSMInvoice] WITH NOCHECK ADD CONSTRAINT [FK_vSMInvoice_vRPRTc] FOREIGN KEY ([ReportID]) REFERENCES [dbo].[vRPRTc] ([ReportID])
GO
...
GO
ALTER TABLE [dbo].[vSMInvoice] NOCHECK CONSTRAINT [FK_vSMInvoice_bARTH]
GO
ALTER TABLE [dbo].[vSMInvoice] NOCHECK CONSTRAINT [FK_vSMInvoice_vRPRTc]
GO
ALTER TABLE [dbo].[vSMInvoice] NOCHECK CONSTRAINT [FK_vSMInvoice_vSMCustomer]
GO
