...
GO
ALTER TABLE [dbo].[bINMO] WITH NOCHECK ADD CONSTRAINT [CK_bINMO_Approved] CHECK (([Approved]='Y' OR [Approved]='N' OR [Approved] IS NULL))
GO
ALTER TABLE [dbo].[bINMO] WITH NOCHECK ADD CONSTRAINT [CK_bINMO_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
