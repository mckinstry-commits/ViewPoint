...
GO
ALTER TABLE [dbo].[bEMDM] WITH NOCHECK ADD CONSTRAINT [FK_bEMDM_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMDM] NOCHECK CONSTRAINT [FK_bEMDM_bEMCO_EMCo]
GO
