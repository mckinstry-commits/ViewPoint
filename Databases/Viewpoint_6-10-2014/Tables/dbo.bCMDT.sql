...
GO
ALTER TABLE [dbo].[bCMDT] WITH NOCHECK ADD CONSTRAINT [CK_bCMDT_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000)))
GO
ALTER TABLE [dbo].[bCMDT] WITH NOCHECK ADD CONSTRAINT [CK_bCMDT_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
ALTER TABLE [dbo].[bCMDT] WITH NOCHECK ADD CONSTRAINT [CK_bCMDT_Void] CHECK (([Void]='Y' OR [Void]='N'))
GO
CREATE UNIQUE NONCLUSTERED INDEX [biCMDTCMRefUnique] ON [dbo].[bCMDT] ([CMCo], [CMAcct], [CMTransType], [CMRef], [CMRefSeq]) WITH (FILLFACTOR=90, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biCMDT] ON [dbo].[bCMDT] ([CMCo], [Mth], [CMTrans]) WITH (FILLFACTOR=90, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biCMDTCMRef] ON [dbo].[bCMDT] ([CMRef]) WITH (FILLFACTOR=90, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[bCMDT] NOCHECK CONSTRAINT [FK_bCMDT_bCMAC_CMCoCMAcct]
GO
ALTER TABLE [dbo].[bCMDT] NOCHECK CONSTRAINT [FK_bCMDT_bHQBC_SourceCoBatchID]
GO
