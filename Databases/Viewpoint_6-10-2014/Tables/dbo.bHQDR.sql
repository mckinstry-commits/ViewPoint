...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHQDR] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biHQDR] ON [dbo].[bHQDR] ([UserName], [AttachmentID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biHQDR_ATT_Status2] ON [dbo].[bHQDR] ([UserName], [DateAdded], [AttachmentID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
