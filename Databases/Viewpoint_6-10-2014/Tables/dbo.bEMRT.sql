...
GO
ALTER TABLE [dbo].[bEMRT] WITH NOCHECK ADD CONSTRAINT [FK_bEMRT_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMRT] NOCHECK CONSTRAINT [FK_bEMRT_bHQGP_EMGroup]
GO
