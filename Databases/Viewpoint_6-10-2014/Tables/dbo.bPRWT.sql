...
GO
ALTER TABLE [dbo].[bPRWT] WITH NOCHECK ADD CONSTRAINT [CK_bPRWT_Initialize] CHECK (([Initialize]='Y' OR [Initialize]='N'))
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRWT] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
