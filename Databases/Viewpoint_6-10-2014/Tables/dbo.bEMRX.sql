...
GO
ALTER TABLE [dbo].[bEMRX] WITH NOCHECK ADD CONSTRAINT [FK_bEMRX_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMRX] NOCHECK CONSTRAINT [FK_bEMRX_bHQGP_EMGroup]
GO
