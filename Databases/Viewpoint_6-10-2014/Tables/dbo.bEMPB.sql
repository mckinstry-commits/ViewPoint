...
GO
ALTER TABLE [dbo].[bEMPB] WITH NOCHECK ADD CONSTRAINT [FK_bEMPB_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMPB] NOCHECK CONSTRAINT [FK_bEMPB_bEMCO_EMCo]
GO
