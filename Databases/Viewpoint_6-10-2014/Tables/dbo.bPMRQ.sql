...
GO
ALTER TABLE [dbo].[bPMRQ] ADD CONSTRAINT [PK_bPMRQ] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [PCOType], [PCO], [RFQ]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMRQ] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
ALTER TABLE [dbo].[bPMRQ] WITH NOCHECK ADD CONSTRAINT [FK_bPMRQ_bPMDT] FOREIGN KEY ([PCOType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
ALTER TABLE [dbo].[bPMRQ] WITH NOCHECK ADD CONSTRAINT [FK_bPMRQ_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
ALTER TABLE [dbo].[bPMRQ] WITH NOCHECK ADD CONSTRAINT [FK_bPMRQ_bPMSC] FOREIGN KEY ([Status]) REFERENCES [dbo].[bPMSC] ([Status])
GO
ALTER TABLE [dbo].[bPMRQ] WITH NOCHECK ADD CONSTRAINT [FK_bPMRQ_bPMPM] FOREIGN KEY ([VendorGroup], [FirmNumber], [ResponsiblePerson]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
GO
ALTER TABLE [dbo].[bPMRQ] NOCHECK CONSTRAINT [FK_bPMRQ_bPMDT]
GO
ALTER TABLE [dbo].[bPMRQ] NOCHECK CONSTRAINT [FK_bPMRQ_bJCJM]
GO
ALTER TABLE [dbo].[bPMRQ] NOCHECK CONSTRAINT [FK_bPMRQ_bPMSC]
GO
ALTER TABLE [dbo].[bPMRQ] NOCHECK CONSTRAINT [FK_bPMRQ_bPMPM]
GO
