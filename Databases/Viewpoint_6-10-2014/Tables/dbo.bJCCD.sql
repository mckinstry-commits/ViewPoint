...
GO
ALTER TABLE [dbo].[bJCCD] WITH NOCHECK ADD CONSTRAINT [CK_bJCCD_DeleteFlag] CHECK (([DeleteFlag]='Y' OR [DeleteFlag]='N'))
GO
ALTER TABLE [dbo].[bJCCD] WITH NOCHECK ADD CONSTRAINT [CK_bJCCD_INStdECM] CHECK (([INStdECM]='E' OR [INStdECM]='C' OR [INStdECM]='M' OR [INStdECM] IS NULL))
GO
ALTER TABLE [dbo].[bJCCD] WITH NOCHECK ADD CONSTRAINT [CK_bJCCD_PerECM] CHECK (([PerECM]='E' OR [PerECM]='C' OR [PerECM]='M' OR [PerECM] IS NULL))
GO
ALTER TABLE [dbo].[bJCCD] WITH NOCHECK ADD CONSTRAINT [CK_bJCCD_PostedECM] CHECK (([PostedECM]='E' OR [PostedECM]='C' OR [PostedECM]='M' OR [PostedECM] IS NULL))
GO
