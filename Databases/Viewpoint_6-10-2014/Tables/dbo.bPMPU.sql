...
GO
ALTER TABLE [dbo].[bPMPU] WITH NOCHECK ADD CONSTRAINT [FK_bPMPU_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
ALTER TABLE [dbo].[bPMPU] WITH NOCHECK ADD CONSTRAINT [FK_bPMPU_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
ALTER TABLE [dbo].[bPMPU] NOCHECK CONSTRAINT [FK_bPMPU_bPMDT]
GO
ALTER TABLE [dbo].[bPMPU] NOCHECK CONSTRAINT [FK_bPMPU_bJCJM]
GO
