...
GO
ALTER TABLE [dbo].[vDDFormRelated] NOCHECK CONSTRAINT [FK_vDDFormRelated_vDDFH_Form]
GO
ALTER TABLE [dbo].[vDDFormRelated] NOCHECK CONSTRAINT [FK_vDDFormRelated_vDDFH_RelatedForm]
GO
