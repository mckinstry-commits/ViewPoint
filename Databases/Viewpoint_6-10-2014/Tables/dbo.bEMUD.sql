...
GO
ALTER TABLE [dbo].[bEMUD] WITH NOCHECK ADD CONSTRAINT [FK_bEMUD_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMUD] WITH NOCHECK ADD CONSTRAINT [FK_bEMUD_bEMUR_RulesTable] FOREIGN KEY ([EMCo], [RulesTable]) REFERENCES [dbo].[bEMUR] ([EMCo], [RulesTable]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[bEMUD] WITH NOCHECK ADD CONSTRAINT [FK_bEMUD_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMUD] WITH NOCHECK ADD CONSTRAINT [FK_bEMUD_bEMRC_RevCode] FOREIGN KEY ([EMGroup], [RevCode]) REFERENCES [dbo].[bEMRC] ([EMGroup], [RevCode])
GO
ALTER TABLE [dbo].[bEMUD] NOCHECK CONSTRAINT [FK_bEMUD_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMUD] NOCHECK CONSTRAINT [FK_bEMUD_bEMUR_RulesTable]
GO
ALTER TABLE [dbo].[bEMUD] NOCHECK CONSTRAINT [FK_bEMUD_bHQGP_EMGroup]
GO
ALTER TABLE [dbo].[bEMUD] NOCHECK CONSTRAINT [FK_bEMUD_bEMRC_RevCode]
GO
