...
[Hours] [dbo].[bHrs] NOT NULL CONSTRAINT [DF_bPREA_Hours] DEFAULT ((0)),
[Amount] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPREA_Amount] DEFAULT ((0)),
[SubjectAmt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPREA_SubjectAmt] DEFAULT ((0)),
[EligibleAmt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPREA_EligibleAmt] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[bPREA] WITH NOCHECK ADD CONSTRAINT [CK_bPREA_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPREA] ([KeyID]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPREA] ON [dbo].[bPREA] ([PRCo], [Employee], [Mth], [EDLType], [EDLCode]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
