...
[TaxGroup] [dbo].[bGroup] NOT NULL CONSTRAINT [DF_bJCJM_TaxGroup] DEFAULT ((0)),
[TaxCode] [dbo].[bTaxCode] NULL,
[InsTemplate] [smallint] NULL,
[MarkUpDiscRate] [dbo].[bRate] NOT NULL CONSTRAINT [DF_bJCJM_MarkUpDiscRate] DEFAULT ((0)),
...
[ProjMinPct] [dbo].[bPct] NOT NULL CONSTRAINT [DF_bJCJM_ProjMinPct] DEFAULT ((0)),
...
[FourProjectsContainerName] [nvarchar] (100) COLLATE Latin1_General_BIN NULL,
[FourProjectsContainerId] [uniqueidentifier] NULL,
[udWABOTax] [dbo].[bRate] NULL,
[udGovtOwnYN] [dbo].[bYN] NULL CONSTRAINT [DF__bJCJM__udGovtOwnYN__DEFAULT] DEFAULT ('N'),
[udRiskProfile] [varchar] (1) COLLATE Latin1_General_BIN NULL,
[udOCCIPCCIPYN] [dbo].[bYN] NULL CONSTRAINT [DF__bJCJM__udOCCIPCCIPYN__DEFAULT] DEFAULT ('N'),
[udExistingBuildYN] [dbo].[bYN] NULL CONSTRAINT [DF__bJCJM__udExistingBuildYN__DEFAULT] DEFAULT ('N'),
[udPrevailWage] [dbo].[bYN] NULL CONSTRAINT [DF__bJCJM__udPrevailWage__DEFAULT] DEFAULT ('N'),
[udWorkRecYN] [dbo].[bYN] NULL CONSTRAINT [DF__bJCJM__udWorkRecYN__DEFAULT] DEFAULT ('N'),
[udAuthType] [dbo].[bDesc] NULL,
[udFAR] [dbo].[bNotes] NULL,
[udFARYN] [dbo].[bYN] NULL CONSTRAINT [DF__bJCJM__udFARYN__DEFAULT] DEFAULT ('N'),
[udVARYN] [dbo].[bYN] NULL CONSTRAINT [DF__bJCJM__udVARYN__DEFAULT] DEFAULT ('N'),
[udDEARYN] [dbo].[bYN] NULL CONSTRAINT [DF__bJCJM__udDEARYN__DEFAULT] DEFAULT ('N'),
[udBOClass] [varchar] (2) COLLATE Latin1_General_BIN NULL,
[udStateSpecificTax] [dbo].[bTaxCode] NULL,
[udProjIns] [varchar] (3) COLLATE Latin1_General_BIN NULL,
[udProjSummary] [dbo].[bNotes] NULL
...
-- =============================================
CREATE TRIGGER [dbo].[mckJCJMJobDuplicateValidation] 
   ON  [dbo].[bJCJM] 
   AFTER INSERT
AS 
BEGIN
...
-- =============================================
CREATE TRIGGER dbo.mtrJCJM_CascadeD_d 
   ON  dbo.bJCJM 
   AFTER DELETE
AS 
BEGIN
...
-- =============================================
CREATE TRIGGER dbo.mtrJCJMAutoPopulate 
   ON  dbo.bJCJM 
   AFTER INSERT,UPDATE
AS 
BEGIN
...
END
GO
ALTER TABLE [dbo].[bJCJM] WITH NOCHECK ADD CONSTRAINT [CK_bJCJM_AutoAddItemYN] CHECK (([AutoAddItemYN]='Y' OR [AutoAddItemYN]='N'))
GO
...
GO
ALTER TABLE [dbo].[bJCJM] WITH NOCHECK ADD CONSTRAINT [CK_bJCJM_Certified] CHECK (([Certified]='Y' OR [Certified]='N'))
GO
ALTER TABLE [dbo].[bJCJM] WITH NOCHECK ADD CONSTRAINT [CK_bJCJM_ClosePurgeFlag] CHECK (([ClosePurgeFlag]='Y' OR [ClosePurgeFlag]='N' OR [ClosePurgeFlag] IS NULL))
GO
ALTER TABLE [dbo].[bJCJM] WITH NOCHECK ADD CONSTRAINT [CK_bJCJM_LockPhases] CHECK (([LockPhases]='Y' OR [LockPhases]='N'))
GO
ALTER TABLE [dbo].[bJCJM] WITH NOCHECK ADD CONSTRAINT [CK_bJCJM_UpdateAPActualsYN] CHECK (([UpdateAPActualsYN]='Y' OR [UpdateAPActualsYN]='N'))
GO
ALTER TABLE [dbo].[bJCJM] WITH NOCHECK ADD CONSTRAINT [CK_bJCJM_UpdateMSActualsYN] CHECK (([UpdateMSActualsYN]='Y' OR [UpdateMSActualsYN]='N'))
GO
ALTER TABLE [dbo].[bJCJM] WITH NOCHECK ADD CONSTRAINT [CK_bJCJM_UpdatePlugs] CHECK (([UpdatePlugs]='Y' OR [UpdatePlugs]='N'))
GO
ALTER TABLE [dbo].[bJCJM] WITH NOCHECK ADD CONSTRAINT [CK_bJCJM_WghtAvgOT] CHECK (([WghtAvgOT]='Y' OR [WghtAvgOT]='N'))
GO
