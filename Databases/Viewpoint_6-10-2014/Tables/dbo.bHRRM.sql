...
GO
ALTER TABLE [dbo].[bHRRM] WITH NOCHECK ADD CONSTRAINT [CK_bHRRM_ActiveYN] CHECK (([ActiveYN]='Y' OR [ActiveYN]='N'))
GO
ALTER TABLE [dbo].[bHRRM] WITH NOCHECK ADD CONSTRAINT [CK_bHRRM_DisabledVetYN] CHECK (([DisabledVetYN]='Y' OR [DisabledVetYN]='N' OR [DisabledVetYN] IS NULL))
GO
ALTER TABLE [dbo].[bHRRM] WITH NOCHECK ADD CONSTRAINT [CK_bHRRM_DriveCoVehiclesYN] CHECK (([DriveCoVehiclesYN]='Y' OR [DriveCoVehiclesYN]='N'))
GO
ALTER TABLE [dbo].[bHRRM] WITH NOCHECK ADD CONSTRAINT [CK_bHRRM_ExistsInPR] CHECK (([ExistsInPR]='Y' OR [ExistsInPR]='N'))
GO
ALTER TABLE [dbo].[bHRRM] WITH NOCHECK ADD CONSTRAINT [CK_bHRRM_HandicapYN] CHECK (([HandicapYN]='Y' OR [HandicapYN]='N'))
GO
ALTER TABLE [dbo].[bHRRM] WITH NOCHECK ADD CONSTRAINT [CK_bHRRM_NoContactEmplYN] CHECK (([NoContactEmplYN]='Y' OR [NoContactEmplYN]='N'))
GO
ALTER TABLE [dbo].[bHRRM] WITH NOCHECK ADD CONSTRAINT [CK_bHRRM_NoRehireYN] CHECK (([NoRehireYN]='Y' OR [NoRehireYN]='N'))
GO
ALTER TABLE [dbo].[bHRRM] WITH NOCHECK ADD CONSTRAINT [CK_bHRRM_OtherVetYN] CHECK (([OtherVetYN]='Y' OR [OtherVetYN]='N' OR [OtherVetYN] IS NULL))
GO
ALTER TABLE [dbo].[bHRRM] WITH NOCHECK ADD CONSTRAINT [CK_bHRRM_PassPort] CHECK (([PassPort]='Y' OR [PassPort]='N'))
GO
ALTER TABLE [dbo].[bHRRM] WITH NOCHECK ADD CONSTRAINT [CK_bHRRM_PhysicalYN] CHECK (([PhysicalYN]='Y' OR [PhysicalYN]='N'))
GO
ALTER TABLE [dbo].[bHRRM] WITH NOCHECK ADD CONSTRAINT [CK_bHRRM_RelativesYN] CHECK (([RelativesYN]='Y' OR [RelativesYN]='N'))
GO
ALTER TABLE [dbo].[bHRRM] WITH NOCHECK ADD CONSTRAINT [CK_bHRRM_TempWorker] CHECK (([TempWorker]='Y' OR [TempWorker]='N'))
GO
ALTER TABLE [dbo].[bHRRM] WITH NOCHECK ADD CONSTRAINT [CK_bHRRM_VietnamVetYN] CHECK (([VietnamVetYN]='Y' OR [VietnamVetYN]='N' OR [VietnamVetYN] IS NULL))
GO
ALTER TABLE [dbo].[bHRRM] WITH NOCHECK ADD CONSTRAINT [CK_bHRRM_W4CompleteYN] CHECK (([W4CompleteYN]='Y' OR [W4CompleteYN]='N'))
GO
