...
declare @numrows int, @errmsg varchar(255),
		@validcnt int, @nullcnt int,@changeinprogress bYN
...
GO
ALTER TABLE [dbo].[bEMTE] WITH NOCHECK ADD CONSTRAINT [FK_bEMTE_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMTE] WITH NOCHECK ADD CONSTRAINT [FK_bEMTE_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[bEMTE] WITH NOCHECK ADD CONSTRAINT [FK_bEMTE_bEMTH_RevTemplate] FOREIGN KEY ([EMCo], [RevTemplate]) REFERENCES [dbo].[bEMTH] ([EMCo], [RevTemplate]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[bEMTE] WITH NOCHECK ADD CONSTRAINT [FK_bEMTE_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMTE] WITH NOCHECK ADD CONSTRAINT [FK_bEMTE_bEMRC_RevCode] FOREIGN KEY ([EMGroup], [RevCode]) REFERENCES [dbo].[bEMRC] ([EMGroup], [RevCode])
GO
ALTER TABLE [dbo].[bEMTE] NOCHECK CONSTRAINT [FK_bEMTE_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMTE] NOCHECK CONSTRAINT [FK_bEMTE_bEMEM_Equipment]
GO
ALTER TABLE [dbo].[bEMTE] NOCHECK CONSTRAINT [FK_bEMTE_bEMTH_RevTemplate]
GO
ALTER TABLE [dbo].[bEMTE] NOCHECK CONSTRAINT [FK_bEMTE_bHQGP_EMGroup]
GO
ALTER TABLE [dbo].[bEMTE] NOCHECK CONSTRAINT [FK_bEMTE_bEMRC_RevCode]
GO
