...
GO
ALTER TABLE [dbo].[vDDCT] WITH NOCHECK ADD CONSTRAINT [FK_vDDCT_vDDTM] FOREIGN KEY ([TextID]) REFERENCES [dbo].[vDDTM] ([TextID])
GO
ALTER TABLE [dbo].[vDDCT] NOCHECK CONSTRAINT [FK_vDDCT_vDDCL]
GO
ALTER TABLE [dbo].[vDDCT] NOCHECK CONSTRAINT [FK_vDDCT_vDDTM]
GO
