...
GO
ALTER TABLE [dbo].[vSMTechnicianPreferences] NOCHECK CONSTRAINT [FK_vSMTechnicianPreferences_vSMCustomer]
GO
ALTER TABLE [dbo].[vSMTechnicianPreferences] NOCHECK CONSTRAINT [FK_vSMTechnicianPreferences_vSMServiceSite]
GO
ALTER TABLE [dbo].[vSMTechnicianPreferences] NOCHECK CONSTRAINT [FK_vSMTechnicianPreferences_vSMTechnician]
GO
