...
GO
ALTER TABLE [dbo].[bEMUH] WITH NOCHECK ADD CONSTRAINT [FK_bEMUH_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMUH] NOCHECK CONSTRAINT [FK_bEMUH_bEMCO_EMCo]
GO
