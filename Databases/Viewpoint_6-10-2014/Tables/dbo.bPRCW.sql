...
[AddOnHrs] [dbo].[bHrs] NULL CONSTRAINT [DF_bPRCW_AddOnHrs] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[bPRCW] WITH NOCHECK ADD CONSTRAINT [CK_bPRCW_UseStdHrs] CHECK (([UseStdHrs]='Y' OR [UseStdHrs]='N'))
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRCW] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRCW] ON [dbo].[bPRCW] ([PRCo], [Crew], [Seq]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
