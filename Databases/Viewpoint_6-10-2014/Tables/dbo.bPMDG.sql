...
GO
ALTER TABLE [dbo].[bPMDG] NOCHECK CONSTRAINT [FK_bPMDG_bPMDT]
GO
ALTER TABLE [dbo].[bPMDG] NOCHECK CONSTRAINT [FK_bPMDG_bJCJM]
GO
ALTER TABLE [dbo].[bPMDG] NOCHECK CONSTRAINT [FK_bPMDG_bPMSC]
GO
