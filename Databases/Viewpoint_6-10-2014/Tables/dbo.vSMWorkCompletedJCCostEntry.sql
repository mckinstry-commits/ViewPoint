...
GO
ALTER TABLE [dbo].[vSMWorkCompletedJCCostEntry] NOCHECK CONSTRAINT [FK_vSMWorkCompletedJCCostEntry_vJCCostEntry]
GO
ALTER TABLE [dbo].[vSMWorkCompletedJCCostEntry] NOCHECK CONSTRAINT [FK_vSMWorkCompletedJCCostEntry_vSMWorkCompleted]
GO
