...
[Status] [char] (1) COLLATE Latin1_General_BIN NULL CONSTRAINT [DF_bEMWF_Status] DEFAULT ('A'),
...
*
*--------------------------------------------------------------*/
declare @rcode int,@matlvalid bYN, @numrows int, @validcnt int,
...
GO
ALTER TABLE [dbo].[bEMWF] WITH NOCHECK ADD CONSTRAINT [CK_bEMWF_Status] CHECK (([Status]='A' OR [Status]='I' OR [Status] IS NULL))
GO
ALTER TABLE [dbo].[bEMWF] WITH NOCHECK ADD CONSTRAINT [CK_bEMWF_WarrantyUM] CHECK (([WarrantyUM]='Years' OR [WarrantyUM]='Months' OR [WarrantyUM]='Days' OR [WarrantyUM] IS NULL))
GO
...
GO
ALTER TABLE [dbo].[bEMWF] WITH NOCHECK ADD CONSTRAINT [FK_bEMWF_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMWF] WITH NOCHECK ADD CONSTRAINT [FK_bEMWF_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[bEMWF] NOCHECK CONSTRAINT [FK_bEMWF_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMWF] NOCHECK CONSTRAINT [FK_bEMWF_bEMEM_Equipment]
GO
