...
GO
ALTER TABLE [dbo].[bPMPD] WITH NOCHECK ADD CONSTRAINT [FK_bPMPD_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
...
GO
ALTER TABLE [dbo].[bPMPD] NOCHECK CONSTRAINT [FK_bPMPD_bJCJM]
GO
ALTER TABLE [dbo].[bPMPD] NOCHECK CONSTRAINT [FK_bPMPD_bPMPL]
GO
ALTER TABLE [dbo].[bPMPD] NOCHECK CONSTRAINT [FK_bPMPD_bPMPU]
GO
ALTER TABLE [dbo].[bPMPD] NOCHECK CONSTRAINT [FK_bPMPD_bPMPI]
GO
ALTER TABLE [dbo].[bPMPD] NOCHECK CONSTRAINT [FK_bPMPD_bPMFM]
GO
