...
GO
ALTER TABLE [dbo].[bMSLB] WITH NOCHECK ADD CONSTRAINT [CK_bMSLB_Hold] CHECK (([Hold]='Y' OR [Hold]='N'))
GO
ALTER TABLE [dbo].[bMSLB] WITH NOCHECK ADD CONSTRAINT [CK_bMSLB_OldHold] CHECK (([OldHold]='Y' OR [OldHold]='N' OR [OldHold] IS NULL))
GO
