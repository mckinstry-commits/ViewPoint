...
GO
ALTER TABLE [dbo].[bPOCB] WITH NOCHECK ADD CONSTRAINT [CK_bPOCB_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
GO
ALTER TABLE [dbo].[bPOCB] WITH NOCHECK ADD CONSTRAINT [CK_bPOCB_OldECM] CHECK (([OldECM]='E' OR [OldECM]='C' OR [OldECM]='M' OR [OldECM] IS NULL))
GO
