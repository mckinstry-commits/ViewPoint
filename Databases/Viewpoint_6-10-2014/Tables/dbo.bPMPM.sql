...
GO
ALTER TABLE [dbo].[bPMPM] WITH NOCHECK ADD CONSTRAINT [CK_bPMPM_ExcludeYN] CHECK (([ExcludeYN]='Y' OR [ExcludeYN]='N'))
GO
ALTER TABLE [dbo].[bPMPM] ADD CONSTRAINT [PK_bPMPM] PRIMARY KEY CLUSTERED  ([VendorGroup], [FirmNumber], [ContactCode]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[bPMPM] NOCHECK CONSTRAINT [FK_bPMPM_bHQCountry]
GO
ALTER TABLE [dbo].[bPMPM] NOCHECK CONSTRAINT [FK_bPMPM_bHQST]
GO
ALTER TABLE [dbo].[bPMPM] NOCHECK CONSTRAINT [FK_bPMPM_bPMFM]
GO
