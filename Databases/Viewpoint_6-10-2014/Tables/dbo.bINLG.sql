...
GO
CREATE UNIQUE CLUSTERED INDEX [biINLG] ON [dbo].[bINLG] ([INCo], [LocGroup]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINLG] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
