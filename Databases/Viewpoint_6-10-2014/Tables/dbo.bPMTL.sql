...
GO
ALTER TABLE [dbo].[bPMTL] NOCHECK CONSTRAINT [FK_bPMTL_bJCJM]
GO
ALTER TABLE [dbo].[bPMTL] NOCHECK CONSTRAINT [FK_bPMTL_bPMPL]
GO
ALTER TABLE [dbo].[bPMTL] NOCHECK CONSTRAINT [FK_bPMTL_bPMSC]
GO
ALTER TABLE [dbo].[bPMTL] NOCHECK CONSTRAINT [FK_bPMTL_bPMDT]
GO
ALTER TABLE [dbo].[bPMTL] NOCHECK CONSTRAINT [FK_bPMTL_bPMFM]
GO
ALTER TABLE [dbo].[bPMTL] NOCHECK CONSTRAINT [FK_bPMTL_bPMPM]
GO
