...
GO
ALTER TABLE [dbo].[bPMWM] WITH NOCHECK ADD CONSTRAINT [CK_bPMWM_ECM] CHECK (([ECM]='M' OR [ECM]='C' OR [ECM]='E' OR [ECM] IS NULL))
GO
...
GO
ALTER TABLE [dbo].[bPMWM] NOCHECK CONSTRAINT [FK_bPMWM_bPMWH]
GO
