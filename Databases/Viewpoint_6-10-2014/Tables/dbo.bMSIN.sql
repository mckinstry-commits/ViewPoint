...
GO
ALTER TABLE [dbo].[bMSIN] WITH NOCHECK ADD CONSTRAINT [CK_bMSIN_PECM] CHECK (([PECM]='E' OR [PECM]='C' OR [PECM]='M'))
GO
ALTER TABLE [dbo].[bMSIN] WITH NOCHECK ADD CONSTRAINT [CK_bMSIN_PostECM] CHECK (([PostECM]='E' OR [PostECM]='C' OR [PostECM]='M'))
GO
ALTER TABLE [dbo].[bMSIN] WITH NOCHECK ADD CONSTRAINT [CK_bMSIN_StkECM] CHECK (([StkECM]='E' OR [StkECM]='C' OR [StkECM]='M'))
GO
