...
GO
ALTER TABLE [dbo].[bJBTM] WITH NOCHECK ADD CONSTRAINT [CK_bJBTM_CopyInProgress] CHECK (([CopyInProgress]='Y' OR [CopyInProgress]='N'))
GO
ALTER TABLE [dbo].[bJBTM] WITH NOCHECK ADD CONSTRAINT [CK_bJBTM_EquipCatYN] CHECK (([EquipCatYN]='Y' OR [EquipCatYN]='N'))
GO
ALTER TABLE [dbo].[bJBTM] WITH NOCHECK ADD CONSTRAINT [CK_bJBTM_LaborCatYN] CHECK (([LaborCatYN]='Y' OR [LaborCatYN]='N'))
GO
ALTER TABLE [dbo].[bJBTM] WITH NOCHECK ADD CONSTRAINT [CK_bJBTM_LaborOverrideYN] CHECK (([LaborOverrideYN]='Y' OR [LaborOverrideYN]='N'))
GO
ALTER TABLE [dbo].[bJBTM] WITH NOCHECK ADD CONSTRAINT [CK_bJBTM_MatlCatYN] CHECK (([MatlCatYN]='Y' OR [MatlCatYN]='N'))
GO
