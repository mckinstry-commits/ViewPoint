...
GO
ALTER TABLE [dbo].[vAuditFlagCompany] NOCHECK CONSTRAINT [FK_vAuditFlagCompany_bHQCO]
GO
ALTER TABLE [dbo].[vAuditFlagCompany] NOCHECK CONSTRAINT [FK_vAuditFlagCompany_vAuditFlags]
GO
