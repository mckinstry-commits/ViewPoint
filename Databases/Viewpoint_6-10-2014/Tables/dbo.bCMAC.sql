...
[udBankCity] [varchar] (20) COLLATE Latin1_General_BIN NULL,
[udBankState] [varchar] (4) COLLATE Latin1_General_BIN NULL,
[udBankZip] [varchar] (12) COLLATE Latin1_General_BIN NULL,
[udBankStreet] [varchar] (40) COLLATE Latin1_General_BIN NULL,
[udBankFraction] [varchar] (20) COLLATE Latin1_General_BIN NULL
...
GO
ALTER TABLE [dbo].[bCMAC] WITH NOCHECK ADD CONSTRAINT [CK_bCMAC_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000)))
GO
...
GO
ALTER TABLE [dbo].[bCMAC] NOCHECK CONSTRAINT [FK_bCMAC_bCMCO_CMCo]
GO
