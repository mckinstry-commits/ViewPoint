...
GO
ALTER TABLE [dbo].[vPMContractChangeOrderACO] NOCHECK CONSTRAINT [FK_bPMOH_vPMContractChangeOrderACO_ACOID]
GO
ALTER TABLE [dbo].[vPMContractChangeOrderACO] NOCHECK CONSTRAINT [FK_vPMContractChangeOrder_vPMContractChangeOrderACO_CCOID]
GO
ALTER TABLE [dbo].[vPMContractChangeOrderACO] NOCHECK CONSTRAINT [FK_vPMContractChangeOrderACO_bJCCM]
GO
