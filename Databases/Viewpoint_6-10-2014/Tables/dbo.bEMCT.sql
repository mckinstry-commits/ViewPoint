...
GO
ALTER TABLE [dbo].[bEMCT] WITH NOCHECK ADD CONSTRAINT [FK_bEMCT_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMCT] NOCHECK CONSTRAINT [FK_bEMCT_bHQGP_EMGroup]
GO
