...
GO
ALTER TABLE [dbo].[bEMSP] WITH NOCHECK ADD CONSTRAINT [CK_bEMSP_PSFlag] CHECK (([PSFlag]='S' OR [PSFlag]='P'))
GO
ALTER TABLE [dbo].[bEMSP] WITH NOCHECK ADD CONSTRAINT [CK_bEMSP_Required] CHECK (([Required]='N' OR [Required]='Y'))
GO
...
GO
ALTER TABLE [dbo].[bEMSP] WITH NOCHECK ADD CONSTRAINT [FK_bEMSP_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMSP] WITH NOCHECK ADD CONSTRAINT [FK_bEMSP_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[bEMSP] WITH NOCHECK ADD CONSTRAINT [FK_bEMSP_bEMSH_EquipStdMaintGroup] FOREIGN KEY ([EMCo], [Equipment], [StdMaintGroup]) REFERENCES [dbo].[bEMSH] ([EMCo], [Equipment], [StdMaintGroup])
GO
ALTER TABLE [dbo].[bEMSP] WITH NOCHECK ADD CONSTRAINT [FK_bEMSP_bEMSI_EquipStdMaintItem] FOREIGN KEY ([EMCo], [Equipment], [StdMaintGroup], [StdMaintItem]) REFERENCES [dbo].[bEMSI] ([EMCo], [Equipment], [StdMaintGroup], [StdMaintItem]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[bEMSP] NOCHECK CONSTRAINT [FK_bEMSP_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMSP] NOCHECK CONSTRAINT [FK_bEMSP_bEMEM_Equipment]
GO
ALTER TABLE [dbo].[bEMSP] NOCHECK CONSTRAINT [FK_bEMSP_bEMSH_EquipStdMaintGroup]
GO
ALTER TABLE [dbo].[bEMSP] NOCHECK CONSTRAINT [FK_bEMSP_bEMSI_EquipStdMaintItem]
GO
