...
GO
ALTER TABLE [dbo].[bMSTP] WITH NOCHECK ADD CONSTRAINT [CK_bMSTP_NewECM] CHECK (([NewECM]='E' OR [NewECM]='M' OR [NewECM]='C' OR [NewECM] IS NULL))
GO
ALTER TABLE [dbo].[bMSTP] WITH NOCHECK ADD CONSTRAINT [CK_bMSTP_OldECM] CHECK (([OldECM]='E' OR [OldECM]='M' OR [OldECM]='C' OR [OldECM] IS NULL))
GO
