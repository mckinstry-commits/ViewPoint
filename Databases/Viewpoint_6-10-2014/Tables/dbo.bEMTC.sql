...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMTC] ON [dbo].[bEMTC] ([EMCo], [RevTemplate], [Category], [RevCode], [EMGroup]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMTC] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
ALTER TABLE [dbo].[bEMTC] WITH NOCHECK ADD CONSTRAINT [FK_bEMTC_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMTC] WITH NOCHECK ADD CONSTRAINT [FK_bEMTC_bEMCM_Category] FOREIGN KEY ([EMCo], [Category]) REFERENCES [dbo].[bEMCM] ([EMCo], [Category])
GO
ALTER TABLE [dbo].[bEMTC] WITH NOCHECK ADD CONSTRAINT [FK_bEMTC_bEMTH_RevTemplate] FOREIGN KEY ([EMCo], [RevTemplate]) REFERENCES [dbo].[bEMTH] ([EMCo], [RevTemplate]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[bEMTC] WITH NOCHECK ADD CONSTRAINT [FK_bEMTC_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMTC] WITH NOCHECK ADD CONSTRAINT [FK_bEMTC_bEMRC_RevCode] FOREIGN KEY ([EMGroup], [RevCode]) REFERENCES [dbo].[bEMRC] ([EMGroup], [RevCode])
GO
ALTER TABLE [dbo].[bEMTC] NOCHECK CONSTRAINT [FK_bEMTC_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMTC] NOCHECK CONSTRAINT [FK_bEMTC_bEMCM_Category]
GO
ALTER TABLE [dbo].[bEMTC] NOCHECK CONSTRAINT [FK_bEMTC_bEMTH_RevTemplate]
GO
ALTER TABLE [dbo].[bEMTC] NOCHECK CONSTRAINT [FK_bEMTC_bHQGP_EMGroup]
GO
ALTER TABLE [dbo].[bEMTC] NOCHECK CONSTRAINT [FK_bEMTC_bEMRC_RevCode]
GO
