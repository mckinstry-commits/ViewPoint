...
GO
ALTER TABLE [dbo].[bJBLR] WITH NOCHECK ADD CONSTRAINT [CK_bJBLR_RestrictByEarn] CHECK (([RestrictByEarn]='Y' OR [RestrictByEarn]='N'))
GO
ALTER TABLE [dbo].[bJBLR] WITH NOCHECK ADD CONSTRAINT [CK_bJBLR_RestrictByFactor] CHECK (([RestrictByFactor]='Y' OR [RestrictByFactor]='N'))
GO
ALTER TABLE [dbo].[bJBLR] WITH NOCHECK ADD CONSTRAINT [CK_bJBLR_RestrictByShift] CHECK (([RestrictByShift]='Y' OR [RestrictByShift]='N'))
GO
