...
GO
ALTER TABLE [dbo].[bEMEH] WITH NOCHECK ADD CONSTRAINT [FK_bEMEH_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMEH] NOCHECK CONSTRAINT [FK_bEMEH_bEMCO_EMCo]
GO
