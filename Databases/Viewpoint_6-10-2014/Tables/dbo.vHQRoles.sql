...
GO
ALTER TABLE [dbo].[vHQRoles] WITH NOCHECK ADD CONSTRAINT [CK_vHQRoles_Active] CHECK (([Active]='N' OR [Active]='Y'))
GO
ALTER TABLE [dbo].[vHQRoles] WITH NOCHECK ADD CONSTRAINT [CK_vHQRoles_UsableInPC] CHECK (([UsableInPC]='N' OR [UsableInPC]='Y'))
GO
ALTER TABLE [dbo].[vHQRoles] WITH NOCHECK ADD CONSTRAINT [CK_vHQRoles_UsableInPM] CHECK (([UsableInPM]='N' OR [UsableInPM]='Y'))
GO
ALTER TABLE [dbo].[vHQRoles] WITH NOCHECK ADD CONSTRAINT [CK_vHQRoles_UsableInSM] CHECK (([UsableInSM]='N' OR [UsableInSM]='Y'))
GO
