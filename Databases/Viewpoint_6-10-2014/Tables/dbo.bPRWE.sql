...
[Misc1Amt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRWE_Misc1Amt] DEFAULT ((0)),
[Misc2Amt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRWE_Misc2Amt] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[bPRWE] WITH NOCHECK ADD CONSTRAINT [CK_bPRWE_ThirdPartySickPay] CHECK (([ThirdPartySickPay]='Y' OR [ThirdPartySickPay]='N'))
GO
