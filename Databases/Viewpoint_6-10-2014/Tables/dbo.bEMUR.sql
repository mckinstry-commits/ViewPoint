...
GO
ALTER TABLE [dbo].[bEMUR] WITH NOCHECK ADD CONSTRAINT [FK_bEMUR_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMUR] NOCHECK CONSTRAINT [FK_bEMUR_bEMCO_EMCo]
GO
