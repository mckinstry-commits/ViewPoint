...
GO
ALTER TABLE [dbo].[pPortalButtons] ADD CONSTRAINT [PK_pButtons] PRIMARY KEY CLUSTERED  ([ButtonName]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[pPortalButtons] NOCHECK CONSTRAINT [FK_pPortalButtons_pPortalMessages]
GO
