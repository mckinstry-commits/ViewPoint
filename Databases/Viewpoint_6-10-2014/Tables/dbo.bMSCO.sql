...
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_AuditCoParams] CHECK (([AuditCoParams]='N' OR [AuditCoParams]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_AuditHaulCodes] CHECK (([AuditHaulCodes]='N' OR [AuditHaulCodes]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_AuditHaulers] CHECK (([AuditHaulers]='N' OR [AuditHaulers]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_AuditInvDetail] CHECK (([AuditInvDetail]='N' OR [AuditInvDetail]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_AuditPayCodes] CHECK (([AuditPayCodes]='N' OR [AuditPayCodes]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_AuditQuotes] CHECK (([AuditQuotes]='N' OR [AuditQuotes]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_AuditTemplates] CHECK (([AuditTemplates]='N' OR [AuditTemplates]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_AuditYN] CHECK (([AuditYN]='N' OR [AuditYN]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_AutoApplyCash] CHECK (([AutoApplyCash]='N' OR [AutoApplyCash]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_AutoQuote] CHECK (([AutoQuote]='N' OR [AutoQuote]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_DateSort] CHECK (([DateSort]='N' OR [DateSort]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_HaulDisc] CHECK (([HaulDisc]='N' OR [HaulDisc]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_HaulHrs] CHECK (([HaulHrs]='N' OR [HaulHrs]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_HaulLoads] CHECK (([HaulLoads]='N' OR [HaulLoads]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_HaulMatlVendor] CHECK (([HaulMatlVendor]='N' OR [HaulMatlVendor]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_HaulMiles] CHECK (([HaulMiles]='N' OR [HaulMiles]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_HaulPay] CHECK (([HaulPay]='N' OR [HaulPay]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_HaulRev] CHECK (([HaulRev]='N' OR [HaulRev]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_HaulTax] CHECK (([HaulTax]='N' OR [HaulTax]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_HaulTimes] CHECK (([HaulTimes]='N' OR [HaulTimes]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_HaulZone] CHECK (([HaulZone]='N' OR [HaulZone]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_InterCoInv] CHECK (([InterCoInv]='N' OR [InterCoInv]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_LimitChk] CHECK (([LimitChk]='N' OR [LimitChk]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_LocSort] CHECK (([LocSort]='N' OR [LocSort]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_SaveDeleted] CHECK (([SaveDeleted]='N' OR [SaveDeleted]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_TicDisc] CHECK (([TicDisc]='N' OR [TicDisc]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_TicDriver] CHECK (([TicDriver]='N' OR [TicDriver]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_TicEmployee] CHECK (([TicEmployee]='N' OR [TicEmployee]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_TicHrs] CHECK (([TicHrs]='N' OR [TicHrs]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_TicLoads] CHECK (([TicLoads]='N' OR [TicLoads]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_TicMatlVendor] CHECK (([TicMatlVendor]='N' OR [TicMatlVendor]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_TicMiles] CHECK (([TicMiles]='N' OR [TicMiles]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_TicPay] CHECK (([TicPay]='N' OR [TicPay]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_TicReason] CHECK (([TicReason]='N' OR [TicReason]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_TicRev] CHECK (([TicRev]='N' OR [TicRev]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_TicTax] CHECK (([TicTax]='N' OR [TicTax]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_TicTimes] CHECK (([TicTimes]='N' OR [TicTimes]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_TicWeights] CHECK (([TicWeights]='N' OR [TicWeights]='Y'))
GO
ALTER TABLE [dbo].[bMSCO] WITH NOCHECK ADD CONSTRAINT [CK_bMSCO_TicZone] CHECK (([TicZone]='N' OR [TicZone]='Y'))
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSCO] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biMSCO] ON [dbo].[bMSCO] ([MSCo]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
