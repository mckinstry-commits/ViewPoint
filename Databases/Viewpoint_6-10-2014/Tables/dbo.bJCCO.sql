...
[ProjMinPct] [dbo].[bPct] NOT NULL CONSTRAINT [DF_bJCCO_ProjMinPct] DEFAULT ((0)),
[ProjPercent] [dbo].[bYN] NOT NULL CONSTRAINT [DF_bJCCO_ProjPercent] DEFAULT ('Y'),
[ProjOverUnder] [dbo].[bYN] NOT NULL CONSTRAINT [DF_bJCCO_ProjOverUnder] DEFAULT ('Y'),
[ProjRemain] [dbo].[bYN] NOT NULL CONSTRAINT [DF_bJCCO_ProjRemain] DEFAULT ('Y'),
...
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_AddJCSICode] CHECK (([AddJCSICode]='Y' OR [AddJCSICode]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_AuditChngOrders] CHECK (([AuditChngOrders]='Y' OR [AuditChngOrders]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_AuditCoParams] CHECK (([AuditCoParams]='Y' OR [AuditCoParams]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_AuditContracts] CHECK (([AuditContracts]='Y' OR [AuditContracts]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_AuditDepts] CHECK (([AuditDepts]='Y' OR [AuditDepts]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_AuditJobs] CHECK (([AuditJobs]='Y' OR [AuditJobs]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_CFCostInterval] CHECK (([CFCostInterval] IS NULL OR [CFCostInterval]>(1) AND [CFCostInterval]<(11)))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_CFCostMethod] CHECK (([CFCostMethod]='N' OR [CFCostMethod]='L' OR [CFCostMethod]='C'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_CFRevInterval] CHECK (([CFRevInterval] IS NULL OR [CFRevInterval]>(1) AND [CFRevInterval]<(11)))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_CFRevMethod] CHECK (([CFRevMethod]='N' OR [CFRevMethod]='L' OR [CFRevMethod]='C'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_DefaultBillType] CHECK (([DefaultBillType]='T' OR [DefaultBillType]='P' OR [DefaultBillType]='B' OR [DefaultBillType]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_GLCostOveride] CHECK (([GLCostOveride]='Y' OR [GLCostOveride]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_GLRevOveride] CHECK (([GLRevOveride]='Y' OR [GLRevOveride]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_PostClosedJobs] CHECK (([PostClosedJobs]='Y' OR [PostClosedJobs]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_PostCrewProgress] CHECK (([PostCrewProgress]='Y' OR [PostCrewProgress]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_ProjInactivePhases] CHECK (([ProjInactivePhases]='Y' OR [ProjInactivePhases]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_ProjOverUnder] CHECK (([ProjOverUnder]='Y' OR [ProjOverUnder]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_ProjPercent] CHECK (([ProjPercent]='Y' OR [ProjPercent]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_ProjRemain] CHECK (([ProjRemain]='Y' OR [ProjRemain]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_ProjRemainUCOpt] CHECK (([ProjRemainUCOpt]='A' OR [ProjRemainUCOpt]='E'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_UseJobBilling] CHECK (([UseJobBilling]='Y' OR [UseJobBilling]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_UseTaxOnMaterial] CHECK (([UseTaxOnMaterial]='Y' OR [UseTaxOnMaterial]='N'))
GO
ALTER TABLE [dbo].[bJCCO] WITH NOCHECK ADD CONSTRAINT [CK_bJCCO_ValidateMaterial] CHECK (([ValidateMaterial]='Y' OR [ValidateMaterial]='N'))
GO
