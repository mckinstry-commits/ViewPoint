...
GO
ALTER TABLE [dbo].[bCMCO] WITH NOCHECK ADD CONSTRAINT [CK_bCMCO_AuditAccts] CHECK (([AuditAccts]='Y' OR [AuditAccts]='N'))
GO
ALTER TABLE [dbo].[bCMCO] WITH NOCHECK ADD CONSTRAINT [CK_bCMCO_AuditCoParams] CHECK (([AuditCoParams]='Y' OR [AuditCoParams]='N'))
GO
ALTER TABLE [dbo].[bCMCO] WITH NOCHECK ADD CONSTRAINT [CK_bCMCO_AuditDetail] CHECK (([AuditDetail]='Y' OR [AuditDetail]='N'))
GO
ALTER TABLE [dbo].[bCMCO] WITH NOCHECK ADD CONSTRAINT [CK_bCMCO_ChangeBegBal] CHECK (([ChangeBegBal]='Y' OR [ChangeBegBal]='N'))
GO
...
GO
ALTER TABLE [dbo].[bCMCO] NOCHECK CONSTRAINT [FK_bCMCO_bHQCO_CMCo]
GO
