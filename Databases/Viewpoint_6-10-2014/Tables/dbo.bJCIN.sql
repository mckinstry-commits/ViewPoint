...
GO
ALTER TABLE [dbo].[bJCIN] WITH NOCHECK ADD CONSTRAINT [CK_bJCIN_PstECM] CHECK (([PstECM]='E' OR [PstECM]='C' OR [PstECM]='M'))
GO
ALTER TABLE [dbo].[bJCIN] WITH NOCHECK ADD CONSTRAINT [CK_bJCIN_StdECM] CHECK (([StdECM]='E' OR [StdECM]='C' OR [StdECM]='M'))
GO
