...
GO
ALTER TABLE [dbo].[bCMTT] WITH NOCHECK ADD CONSTRAINT [CK_bCMTT_FromCMAcct] CHECK (([FromCMAcct]>(0) AND [FromCMAcct]<(10000)))
GO
ALTER TABLE [dbo].[bCMTT] WITH NOCHECK ADD CONSTRAINT [CK_bCMTT_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
ALTER TABLE [dbo].[bCMTT] WITH NOCHECK ADD CONSTRAINT [CK_bCMTT_ToCMAcct] CHECK (([ToCMAcct]>(0) AND [ToCMAcct]<(10000)))
GO
...
GO
ALTER TABLE [dbo].[bCMTT] WITH NOCHECK ADD CONSTRAINT [FK_bCMTT_bCMCO_CMCo] FOREIGN KEY ([CMCo]) REFERENCES [dbo].[bCMCO] ([CMCo])
GO
ALTER TABLE [dbo].[bCMTT] NOCHECK CONSTRAINT [FK_bCMTT_bCMCO_CMCo]
GO
