...
GO
ALTER TABLE [dbo].[bPMTS] WITH NOCHECK ADD CONSTRAINT [CK_bPMTS_DocType_Document] CHECK (([DocType] IS NULL AND [Document] IS NULL OR [DocType] IS NOT NULL AND [Document] IS NOT NULL))
GO
...
GO
ALTER TABLE [dbo].[bPMTS] WITH NOCHECK ADD CONSTRAINT [FK_bPMTS_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
ALTER TABLE [dbo].[bPMTS] WITH NOCHECK ADD CONSTRAINT [FK_bPMTS_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
ALTER TABLE [dbo].[bPMTS] WITH NOCHECK ADD CONSTRAINT [FK_bPMTS_bPMTM] FOREIGN KEY ([PMCo], [Project], [Transmittal]) REFERENCES [dbo].[bPMTM] ([PMCo], [Project], [Transmittal]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[bPMTS] WITH NOCHECK ADD CONSTRAINT [FK_bPMTS_bPMSC] FOREIGN KEY ([Status]) REFERENCES [dbo].[bPMSC] ([Status])
GO
ALTER TABLE [dbo].[bPMTS] NOCHECK CONSTRAINT [FK_bPMTS_bPMDT]
GO
ALTER TABLE [dbo].[bPMTS] NOCHECK CONSTRAINT [FK_bPMTS_bJCJM]
GO
ALTER TABLE [dbo].[bPMTS] NOCHECK CONSTRAINT [FK_bPMTS_bPMTM]
GO
ALTER TABLE [dbo].[bPMTS] NOCHECK CONSTRAINT [FK_bPMTS_bPMSC]
GO
