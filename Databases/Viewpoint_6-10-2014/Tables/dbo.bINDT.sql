...
GO
ALTER TABLE [dbo].[bINDT] WITH NOCHECK ADD CONSTRAINT [CK_bINDT_PECM] CHECK (([PECM]='M' OR [PECM]='C' OR [PECM]='E'))
GO
ALTER TABLE [dbo].[bINDT] WITH NOCHECK ADD CONSTRAINT [CK_bINDT_PostECM] CHECK (([PostECM]='M' OR [PostECM]='C' OR [PostECM]='E'))
GO
ALTER TABLE [dbo].[bINDT] WITH NOCHECK ADD CONSTRAINT [CK_bINDT_PurgeYN] CHECK (([PurgeYN]='Y' OR [PurgeYN]='N'))
GO
ALTER TABLE [dbo].[bINDT] WITH NOCHECK ADD CONSTRAINT [CK_bINDT_StkECM] CHECK (([StkECM]='M' OR [StkECM]='C' OR [StkECM]='E'))
GO
CREATE NONCLUSTERED INDEX [biINDTReconcile] ON [dbo].[bINDT] ([INCo], [Loc], [MatlGroup], [Material], [Mth]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biINDT] ON [dbo].[bINDT] ([INCo], [Mth], [INTrans]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINDT] ([KeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bINDT_LocMatl] ON [dbo].[bINDT] ([Mth], [INCo], [Loc], [MatlGroup], [Material]) INCLUDE ([ActDate], [UniqueAttchID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biINDTRollup] ON [dbo].[bINDT] ([Mth], [Loc], [Material], [TransType]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
