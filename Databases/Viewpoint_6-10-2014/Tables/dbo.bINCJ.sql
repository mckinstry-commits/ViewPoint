...
GO
ALTER TABLE [dbo].[bINCJ] WITH NOCHECK ADD CONSTRAINT [CK_bINCJ_ECM] CHECK (([ECM]='M' OR [ECM]='C' OR [ECM]='E'))
GO
ALTER TABLE [dbo].[bINCJ] WITH NOCHECK ADD CONSTRAINT [CK_bINCJ_StkECM] CHECK (([StkECM]='M' OR [StkECM]='C' OR [StkECM]='E'))
GO
