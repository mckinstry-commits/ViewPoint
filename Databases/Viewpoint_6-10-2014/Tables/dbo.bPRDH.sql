...
[Amt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRDH_Amt] DEFAULT ((0))
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[bPRDH] WITH NOCHECK ADD CONSTRAINT [CK_bPRDH_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000)))
GO
