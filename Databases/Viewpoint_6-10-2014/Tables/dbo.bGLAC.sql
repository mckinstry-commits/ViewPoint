...
GO
ALTER TABLE [dbo].[bGLAC] WITH NOCHECK ADD CONSTRAINT [CK_bGLAC_Active] CHECK (([Active]='Y' OR [Active]='N'))
GO
ALTER TABLE [dbo].[bGLAC] WITH NOCHECK ADD CONSTRAINT [CK_bGLAC_InterfaceDetail] CHECK (([InterfaceDetail]='Y' OR [InterfaceDetail]='N'))
GO
...
GO
ALTER TABLE [dbo].[bGLAC] ADD CONSTRAINT [PK_bGLAC] PRIMARY KEY NONCLUSTERED  ([KeyID]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biGLACAcctType] ON [dbo].[bGLAC] ([AcctType]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biGLAC] ON [dbo].[bGLAC] ([GLCo], [GLAcct]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
ALTER TABLE [dbo].[bGLAC] WITH NOCHECK ADD CONSTRAINT [FK_bGLAC_bGLCO_GLCo] FOREIGN KEY ([GLCo]) REFERENCES [dbo].[bGLCO] ([GLCo])
GO
ALTER TABLE [dbo].[bGLAC] NOCHECK CONSTRAINT [FK_bGLAC_bGLCO_GLCo]
GO
