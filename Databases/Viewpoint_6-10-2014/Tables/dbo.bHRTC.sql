...
GO
ALTER TABLE [dbo].[bHRTC] WITH NOCHECK ADD CONSTRAINT [CK_bHRTC_CPRYN] CHECK (([CPRYN]='Y' OR [CPRYN]='N'))
GO
ALTER TABLE [dbo].[bHRTC] WITH NOCHECK ADD CONSTRAINT [CK_bHRTC_FirstAidYN] CHECK (([FirstAidYN]='Y' OR [FirstAidYN]='N'))
GO
ALTER TABLE [dbo].[bHRTC] WITH NOCHECK ADD CONSTRAINT [CK_bHRTC_Instructor1099YN] CHECK (([Instructor1099YN]='Y' OR [Instructor1099YN]='N'))
GO
ALTER TABLE [dbo].[bHRTC] WITH NOCHECK ADD CONSTRAINT [CK_bHRTC_MSHAYN] CHECK (([MSHAYN]='Y' OR [MSHAYN]='N'))
GO
ALTER TABLE [dbo].[bHRTC] WITH NOCHECK ADD CONSTRAINT [CK_bHRTC_OSHAYN] CHECK (([OSHAYN]='Y' OR [OSHAYN]='N'))
GO
ALTER TABLE [dbo].[bHRTC] WITH NOCHECK ADD CONSTRAINT [CK_bHRTC_ReimbursedYN] CHECK (([ReimbursedYN]='Y' OR [ReimbursedYN]='N'))
GO
ALTER TABLE [dbo].[bHRTC] WITH NOCHECK ADD CONSTRAINT [CK_bHRTC_WorkRelatedYN] CHECK (([WorkRelatedYN]='Y' OR [WorkRelatedYN]='N'))
GO
CREATE UNIQUE CLUSTERED INDEX [biHRTC] ON [dbo].[bHRTC] ([HRCo], [TrainCode], [Type], [ClassSeq]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRTC] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
