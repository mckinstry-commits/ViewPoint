...
GO
ALTER TABLE [dbo].[bPMDZ] ADD CONSTRAINT [PK_bPMDZ] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [DocCategory], [UserName], [VendorGroup], [Sequence]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
