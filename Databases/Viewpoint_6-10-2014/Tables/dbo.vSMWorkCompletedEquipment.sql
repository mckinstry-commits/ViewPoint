...
GO
ALTER TABLE [dbo].[vSMWorkCompletedEquipment] NOCHECK CONSTRAINT [FK_vSMWorkCompletedEquipment_bEMEM]
GO
ALTER TABLE [dbo].[vSMWorkCompletedEquipment] NOCHECK CONSTRAINT [FK_vSMWorkCompletedEquipment_bEMRC]
GO
ALTER TABLE [dbo].[vSMWorkCompletedEquipment] NOCHECK CONSTRAINT [FK_vSMWorkCompletedEquipment_bJCCT]
GO
ALTER TABLE [dbo].[vSMWorkCompletedEquipment] NOCHECK CONSTRAINT [FK_vSMWorkCompletedEquipment_vSMWorkCompleted]
GO
ALTER TABLE [dbo].[vSMWorkCompletedEquipment] NOCHECK CONSTRAINT [FK_vSMWorkCompletedEquipment_vSMWorkCompletedDetail]
GO
