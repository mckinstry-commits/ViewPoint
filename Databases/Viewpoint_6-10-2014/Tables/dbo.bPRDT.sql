...
[Hours] [dbo].[bHrs] NOT NULL CONSTRAINT [DF_bPRDT_Hours] DEFAULT ((0)),
[Amount] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRDT_Amount] DEFAULT ((0)),
[SubjectAmt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRDT_SubjectAmt] DEFAULT ((0)),
[EligibleAmt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRDT_EligibleAmt] DEFAULT ((0)),
[UseOver] [dbo].[bYN] NOT NULL CONSTRAINT [DF_bPRDT_UseOver] DEFAULT ('N'),
[OverAmt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRDT_OverAmt] DEFAULT ((0)),
[OverProcess] [dbo].[bYN] NOT NULL CONSTRAINT [DF_bPRDT_OverProcess] DEFAULT ('N'),
[VendorGroup] [dbo].[bGroup] NULL,
[Vendor] [dbo].[bVendor] NULL,
[APDesc] [dbo].[bDesc] NULL,
[OldHours] [dbo].[bHrs] NOT NULL CONSTRAINT [DF_bPRDT_OldHours] DEFAULT ((0)),
[OldAmt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRDT_OldAmt] DEFAULT ((0)),
[OldSubject] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRDT_OldSubject] DEFAULT ((0)),
[OldEligible] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRDT_OldEligible] DEFAULT ((0)),
[OldMth] [dbo].[bMonth] NULL,
[OldVendor] [dbo].[bVendor] NULL,
[OldAPMth] [dbo].[bMonth] NULL,
[OldAPAmt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRDT_OldAPAmt] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[bPRDT] WITH NOCHECK ADD CONSTRAINT [CK_bPRDT_OverProcess] CHECK (([OverProcess]='Y' OR [OverProcess]='N'))
GO
ALTER TABLE [dbo].[bPRDT] WITH NOCHECK ADD CONSTRAINT [CK_bPRDT_UseOver] CHECK (([UseOver]='Y' OR [UseOver]='N'))
GO
CREATE NONCLUSTERED INDEX [biPRDTEmployee] ON [dbo].[bPRDT] ([Employee], [PRCo], [PRGroup]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bPRDT_PrcoEmpEDLOldAmt_PrintCheck] ON [dbo].[bPRDT] ([PRCo], [Employee], [EDLType], [EDLCode], [OldMth], [PREndDate], [PaySeq]) INCLUDE ([OldAmt]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRDT] ON [dbo].[bPRDT] ([PRCo], [PRGroup], [PREndDate], [Employee], [PaySeq], [EDLType], [EDLCode]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
