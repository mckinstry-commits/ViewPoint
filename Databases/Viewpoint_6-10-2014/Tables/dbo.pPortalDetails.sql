...
GO
ALTER TABLE [dbo].[pPortalDetails] NOCHECK CONSTRAINT [FK_pPortalDetails_pPortalStoredProcedures1]
GO
ALTER TABLE [dbo].[pPortalDetails] NOCHECK CONSTRAINT [FK_pPortalDetails_pPortalStoredProcedures3]
GO
ALTER TABLE [dbo].[pPortalDetails] NOCHECK CONSTRAINT [FK_pPortalDetails_pPortalStoredProcedures]
GO
ALTER TABLE [dbo].[pPortalDetails] NOCHECK CONSTRAINT [FK_pPortalDetails_pPortalMessages]
GO
ALTER TABLE [dbo].[pPortalDetails] NOCHECK CONSTRAINT [FK_pPortalDetails_pPortalStoredProcedures2]
GO
