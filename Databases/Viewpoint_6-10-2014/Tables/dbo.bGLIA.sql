...
GO
ALTER TABLE [dbo].[bGLIA] WITH NOCHECK ADD CONSTRAINT [CK_bGLIA_APGLCoNot0] CHECK (([APGLCo]>(0)))
GO
ALTER TABLE [dbo].[bGLIA] WITH NOCHECK ADD CONSTRAINT [CK_bGLIA_ARGLCoNEQAPGLCo] CHECK (([ARGLCo]<>[APGLCo]))
GO
ALTER TABLE [dbo].[bGLIA] WITH NOCHECK ADD CONSTRAINT [CK_bGLIA_ARGLCoNot0] CHECK (([ARGLCo]>(0)))
GO
...
GO
ALTER TABLE [dbo].[bGLIA] NOCHECK CONSTRAINT [FK_bGLIA_bGLAC_APGLCo]
GO
ALTER TABLE [dbo].[bGLIA] NOCHECK CONSTRAINT [FK_bGLIA_bGLAC_ARGLCo]
GO
