...
GO
ALTER TABLE [dbo].[vPCContacts] WITH NOCHECK ADD CONSTRAINT [CK_vPCContacts_IsBidContact] CHECK (([IsBidContact]='N' OR [IsBidContact]='Y'))
GO
ALTER TABLE [dbo].[vPCContacts] WITH NOCHECK ADD CONSTRAINT [CK_vPCContacts_PrefMethod] CHECK (([PrefMethod]='F' OR [PrefMethod]='E' OR [PrefMethod]='M'))
GO
...
GO
ALTER TABLE [dbo].[vPCContacts] NOCHECK CONSTRAINT [FK_vPCContacts_vPCContactTypeCodes]
GO
