...
GO
ALTER TABLE [dbo].[vHQCompanyProcess] NOCHECK CONSTRAINT [FK_vHQCompanyProcess_vDDMO]
GO
ALTER TABLE [dbo].[vHQCompanyProcess] NOCHECK CONSTRAINT [FK_vHQCompanyProcess_vWFProcess]
GO
