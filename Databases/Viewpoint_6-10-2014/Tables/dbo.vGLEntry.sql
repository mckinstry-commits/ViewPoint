...
GO
ALTER TABLE [dbo].[vGLEntry] NOCHECK CONSTRAINT [FK_vGLEntry_vHQBatchDistribution]
GO
ALTER TABLE [dbo].[vGLEntry] NOCHECK CONSTRAINT [FK_vGLEntry_vPRLedgerUpdateMonth]
GO
