...
GO
ALTER TABLE [dbo].[bJBID] WITH NOCHECK ADD CONSTRAINT [CK_bJBID_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
GO
ALTER TABLE [dbo].[bJBID] WITH NOCHECK ADD CONSTRAINT [CK_bJBID_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
GO
ALTER TABLE [dbo].[bJBID] WITH NOCHECK ADD CONSTRAINT [CK_bJBID_PreBillYN] CHECK (([PreBillYN]='Y' OR [PreBillYN]='N'))
GO
ALTER TABLE [dbo].[bJBID] WITH NOCHECK ADD CONSTRAINT [CK_bJBID_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
ALTER TABLE [dbo].[bJBID] WITH NOCHECK ADD CONSTRAINT [CK_bJBID_StdECM] CHECK (([StdECM]='E' OR [StdECM]='C' OR [StdECM]='M' OR [StdECM] IS NULL))
GO
