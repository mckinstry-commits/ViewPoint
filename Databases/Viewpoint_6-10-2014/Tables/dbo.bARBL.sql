...
[TaxDisc] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bARBL_TaxDisc] DEFAULT ((0)),
...
[UnitPrice] [dbo].[bUnitCost] NULL CONSTRAINT [DF_bARBL_UnitPrice] DEFAULT ((0)),
[ECM] [dbo].[bECM] NULL,
...
[oldUnitPrice] [dbo].[bUnitCost] NULL CONSTRAINT [DF_bARBL_oldUnitPrice] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[bARBL] WITH NOCHECK ADD CONSTRAINT [CK_bARBL_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
GO
ALTER TABLE [dbo].[bARBL] WITH NOCHECK ADD CONSTRAINT [CK_bARBL_oldECM] CHECK (([oldECM]='E' OR [oldECM]='C' OR [oldECM]='M' OR [oldECM] IS NULL))
GO
