...
GO
ALTER TABLE [dbo].[bHRAT] WITH NOCHECK ADD CONSTRAINT [CK_bHRAT_EmployerPremYN] CHECK (([EmployerPremYN]='Y' OR [EmployerPremYN]='N'))
GO
ALTER TABLE [dbo].[bHRAT] WITH NOCHECK ADD CONSTRAINT [CK_bHRAT_JobSiteYN] CHECK (([JobSiteYN]='Y' OR [JobSiteYN]='N'))
GO
