...
[OldRate] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPRTI_OldRate] DEFAULT ((0)),
[NewRate] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPRTI_NewRate] DEFAULT ((0)),
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRTI] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRTI] ON [dbo].[bPRTI] ([PRCo], [Craft], [Template], [EDLType], [EDLCode], [Factor]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
