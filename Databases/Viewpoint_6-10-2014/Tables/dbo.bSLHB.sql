...
[udCommissioningYN] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHB__udCommissioningYN__DEFAULT] DEFAULT ('N'),
[udRoofingYN] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHB__udRoofingYN__DEFAULT] DEFAULT ('N'),
[udLighting] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHB__udLighting__DEFAULT] DEFAULT ('N'),
[udAddendum] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHB__udAddendum__DEFAULT] DEFAULT ('N'),
[udMasIns] [varchar] (30) COLLATE Latin1_General_BIN NULL,
[udCertPRPrevYN] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHB__udCertPRPrevYN__DEFAULT] DEFAULT ('N'),
[udConstruction] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHB__udConstruction__DEFAULT] DEFAULT ('N'),
[udProServYN] [dbo].[bYN] NULL CONSTRAINT [DF__bSLHB__udProServYN__DEFAULT] DEFAULT ('N'),
