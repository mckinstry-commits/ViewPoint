...
[CurUnitCost] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bSLWI_CurUnitCost] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[bSLWI] WITH NOCHECK ADD CONSTRAINT [CK_bSLWI_BillChangedYN] CHECK (([BillChangedYN]='Y' OR [BillChangedYN]='N' OR [BillChangedYN] IS NULL))
GO
