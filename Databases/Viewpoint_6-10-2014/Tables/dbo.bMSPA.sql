...
GO
ALTER TABLE [dbo].[bMSPA] WITH NOCHECK ADD CONSTRAINT [CK_bMSPA_ECM] CHECK (([ECM]='E' OR [ECM]='M' OR [ECM]='C'))
GO
ALTER TABLE [dbo].[bMSPA] WITH NOCHECK ADD CONSTRAINT [CK_bMSPA_PECM] CHECK (([PECM]='E' OR [PECM]='M' OR [PECM]='C'))
GO
