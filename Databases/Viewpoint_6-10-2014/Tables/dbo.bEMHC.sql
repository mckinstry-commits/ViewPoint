...
GO
ALTER TABLE [dbo].[bEMHC] WITH NOCHECK ADD CONSTRAINT [FK_bEMHC_bEMEM_Component] FOREIGN KEY ([EMCo], [Component]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment])
GO
ALTER TABLE [dbo].[bEMHC] WITH NOCHECK ADD CONSTRAINT [FK_bEMHC_bEMEM_ComponentOfEquip] FOREIGN KEY ([EMCo], [ComponentOfEquip]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment])
GO
ALTER TABLE [dbo].[bEMHC] NOCHECK CONSTRAINT [FK_bEMHC_bEMEM_Component]
GO
ALTER TABLE [dbo].[bEMHC] NOCHECK CONSTRAINT [FK_bEMHC_bEMEM_ComponentOfEquip]
GO
