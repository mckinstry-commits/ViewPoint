 ...
 *					MarkH 12/2/2013 - TFS-67705 - Remove the check for deleting default doc types and doc types
 *					marked as system use.
 *
 *--------------------------------------------------------------*/
...
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_Active] CHECK (([Active]='Y' OR [Active]='N'))
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_BudgetType] CHECK (([BudgetType]='Y' OR [BudgetType]='N'))
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_ContractType] CHECK (([ContractType]='Y' OR [ContractType]='N'))
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_DocCategory] CHECK (([DocCategory]='SBMTLPCKG' OR [DocCategory]='SBMTL' OR [DocCategory]='DAILYLOG' OR [DocCategory]='ACO' OR [DocCategory]='PURCHASE' OR [DocCategory]='PO' OR [DocCategory]='PUNCH' OR [DocCategory]='CCO' OR [DocCategory]='POCO' OR [DocCategory]='PURCHASECO' OR [DocCategory]='COR' OR [DocCategory]='SUBCO' OR [DocCategory]='ISSUE' OR [DocCategory]='TEST' OR [DocCategory]='INSPECT' OR [DocCategory]='DRAWING' OR [DocCategory]='OTHER' OR [DocCategory]='MTG' OR [DocCategory]='SUBMIT' OR [DocCategory]='RFI' OR [DocCategory]='REQQUOTE' OR [DocCategory]='PCO' OR [DocCategory]='SUB' OR [DocCategory]='TRANSMIT'))
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_IncludeInProj] CHECK (([IncludeInProj]='Y' OR [IncludeInProj]='N'))
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_IntExtDefault] CHECK (([IntExtDefault]='I' OR [IntExtDefault]='E' OR [IntExtDefault]='N'))
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_POType] CHECK (([POType]='Y' OR [POType]='N'))
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_PriceMethod] CHECK (([PriceMethod]='U' OR [PriceMethod]='L'))
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_ShowPCODate1] CHECK (([ShowPCODate1]='Y' OR [ShowPCODate1]='N'))
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_ShowPCODate2] CHECK (([ShowPCODate2]='Y' OR [ShowPCODate2]='N'))
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_ShowPCODate3] CHECK (([ShowPCODate3]='Y' OR [ShowPCODate3]='N'))
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_ShowPCOItemDate1] CHECK (([ShowPCOItemDate1]='Y' OR [ShowPCOItemDate1]='N'))
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_ShowPCOItemDate2] CHECK (([ShowPCOItemDate2]='Y' OR [ShowPCOItemDate2]='N'))
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_ShowPCOItemDate3] CHECK (([ShowPCOItemDate3]='Y' OR [ShowPCOItemDate3]='N'))
GO
ALTER TABLE [dbo].[bPMDT] WITH NOCHECK ADD CONSTRAINT [CK_bPMDT_SubType] CHECK (([SubType]='Y' OR [SubType]='N'))
GO
