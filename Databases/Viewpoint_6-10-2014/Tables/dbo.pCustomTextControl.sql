...
GO
ALTER TABLE [dbo].[pCustomTextControl] NOCHECK CONSTRAINT [FK_pCustomTextControl_pPageSiteControl]
GO
ALTER TABLE [dbo].[pCustomTextControl] NOCHECK CONSTRAINT [FK_pCustomTextControl_pSites]
GO
