...
GO
ALTER TABLE [dbo].[bEMWH] WITH NOCHECK ADD CONSTRAINT [CK_bEMWH_Complete] CHECK (([Complete]='N' OR [Complete]='Y'))
GO
...
GO
ALTER TABLE [dbo].[bEMWH] WITH NOCHECK ADD CONSTRAINT [FK_bEMWH_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMWH] WITH NOCHECK ADD CONSTRAINT [FK_bEMWH_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[bEMWH] WITH NOCHECK ADD CONSTRAINT [FK_bEMWH_bHQGP_ShopGroup] FOREIGN KEY ([ShopGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMWH] NOCHECK CONSTRAINT [FK_bEMWH_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMWH] NOCHECK CONSTRAINT [FK_bEMWH_bEMEM_Equipment]
GO
ALTER TABLE [dbo].[bEMWH] NOCHECK CONSTRAINT [FK_bEMWH_bHQGP_ShopGroup]
GO
