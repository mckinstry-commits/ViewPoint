...
GO
ALTER TABLE [dbo].[vSMWorkOrderPOHB] WITH NOCHECK ADD CONSTRAINT [FK_vSMWorkOrderPOHB_bPOHB] FOREIGN KEY ([POCo], [BatchMth], [BatchId], [BatchSeq]) REFERENCES [dbo].[bPOHB] ([Co], [Mth], [BatchId], [BatchSeq]) ON DELETE CASCADE
GO
...
GO
ALTER TABLE [dbo].[vSMWorkOrderPOHB] NOCHECK CONSTRAINT [FK_vSMWorkOrderPOHB_bPOHB]
GO
ALTER TABLE [dbo].[vSMWorkOrderPOHB] NOCHECK CONSTRAINT [FK_vSMWorkOrderPOHB_vSMWorkOrder]
GO
