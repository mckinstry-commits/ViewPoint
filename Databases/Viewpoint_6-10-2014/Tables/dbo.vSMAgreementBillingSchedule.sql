...
GO
ALTER TABLE [dbo].[vSMAgreementBillingSchedule] WITH NOCHECK ADD CONSTRAINT [FK_vSMAgreementBillingSchedule_vSMAgreement] FOREIGN KEY ([SMCo], [Agreement], [Revision]) REFERENCES [dbo].[vSMAgreement] ([SMCo], [Agreement], [Revision])
GO
...
GO
ALTER TABLE [dbo].[vSMAgreementBillingSchedule] WITH NOCHECK ADD CONSTRAINT [FK_vSMAgreementBillingSchedule_vSMInvoice] FOREIGN KEY ([SMInvoiceID]) REFERENCES [dbo].[vSMInvoice] ([SMInvoiceID])
GO
ALTER TABLE [dbo].[vSMAgreementBillingSchedule] WITH NOCHECK ADD CONSTRAINT [FK_vSMAgreementBillingSchedule_bHQTX] FOREIGN KEY ([TaxGroup], [TaxCode]) REFERENCES [dbo].[bHQTX] ([TaxGroup], [TaxCode])
GO
ALTER TABLE [dbo].[vSMAgreementBillingSchedule] NOCHECK CONSTRAINT [FK_vSMAgreementBillingSchedule_vSMAgreement]
GO
ALTER TABLE [dbo].[vSMAgreementBillingSchedule] NOCHECK CONSTRAINT [FK_vSMAgreementBillingSchedule_vSMAgreementService]
GO
ALTER TABLE [dbo].[vSMAgreementBillingSchedule] NOCHECK CONSTRAINT [FK_vSMAgreementBillingSchedule_vSMInvoice]
GO
ALTER TABLE [dbo].[vSMAgreementBillingSchedule] NOCHECK CONSTRAINT [FK_vSMAgreementBillingSchedule_bHQTX]
GO
