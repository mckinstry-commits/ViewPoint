...
GO
ALTER TABLE [dbo].[vPRAUEmployeeMiscItemAmounts] NOCHECK CONSTRAINT [FK_vPRAUItems_vPRAUEmployeeMiscItemAmounts_ItemCode]
GO
ALTER TABLE [dbo].[vPRAUEmployeeMiscItemAmounts] NOCHECK CONSTRAINT [FK_vPRAUEmployees_vPRAUEmployeeMiscItemAmounts_PRCo_TaxYear_Employee]
GO
