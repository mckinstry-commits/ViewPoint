...
[UnitCost] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bAPRL_UnitCost] DEFAULT ((0)),
[ECM] [dbo].[bECM] NULL,
...
GO
ALTER TABLE [dbo].[bAPRL] WITH NOCHECK ADD CONSTRAINT [CK_bAPRL_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
GO
ALTER TABLE [dbo].[bAPRL] WITH NOCHECK ADD CONSTRAINT [CK_bAPRL_MiscYN] CHECK (([MiscYN]='Y' OR [MiscYN]='N'))
GO
