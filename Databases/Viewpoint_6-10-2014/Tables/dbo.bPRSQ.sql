...
GO
ALTER TABLE [dbo].[bPRSQ] WITH NOCHECK ADD CONSTRAINT [CK_bPRSQ_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000)))
GO
ALTER TABLE [dbo].[bPRSQ] WITH NOCHECK ADD CONSTRAINT [CK_bPRSQ_CMInterface] CHECK (([CMInterface]='Y' OR [CMInterface]='N'))
GO
ALTER TABLE [dbo].[bPRSQ] WITH NOCHECK ADD CONSTRAINT [CK_bPRSQ_PostToAll] CHECK (([PostToAll]='Y' OR [PostToAll]='N'))
GO
ALTER TABLE [dbo].[bPRSQ] WITH NOCHECK ADD CONSTRAINT [CK_bPRSQ_Processed] CHECK (([Processed]='Y' OR [Processed]='N'))
GO
ALTER TABLE [dbo].[bPRSQ] ADD CONSTRAINT [PK_bPRSQ] PRIMARY KEY NONCLUSTERED  ([KeyID]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biPRSQEFT] ON [dbo].[bPRSQ] ([CMCo], [CMAcct], [PayMethod], [CMRef], [EFTSeq]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bPRSQ_PaidDate] ON [dbo].[bPRSQ] ([PaidDate], [PRCo]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biPRSQNoGroup] ON [dbo].[bPRSQ] ([PRCo], [PREndDate], [Employee], [CMCo], [CMAcct], [CMRef]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRSQ] ON [dbo].[bPRSQ] ([PRCo], [PRGroup], [PREndDate], [Employee], [PaySeq]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
