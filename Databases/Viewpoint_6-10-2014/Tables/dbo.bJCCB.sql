...
GO
ALTER TABLE [dbo].[bJCCB] WITH NOCHECK ADD CONSTRAINT [CK_bJCCB_INStdECM] CHECK (([INStdECM]='E' OR [INStdECM]='C' OR [INStdECM]='M' OR [INStdECM] IS NULL))
GO
ALTER TABLE [dbo].[bJCCB] WITH NOCHECK ADD CONSTRAINT [CK_bJCCB_OldINStdECM] CHECK (([OldINStdECM]='E' OR [OldINStdECM]='C' OR [OldINStdECM]='M' OR [OldINStdECM] IS NULL))
GO
ALTER TABLE [dbo].[bJCCB] WITH NOCHECK ADD CONSTRAINT [CK_bJCCB_OldPstECM] CHECK (([OldPstECM]='E' OR [OldPstECM]='C' OR [OldPstECM]='M' OR [OldPstECM] IS NULL))
GO
ALTER TABLE [dbo].[bJCCB] WITH NOCHECK ADD CONSTRAINT [CK_bJCCB_PstECM] CHECK (([PstECM]='E' OR [PstECM]='C' OR [PstECM]='M' OR [PstECM] IS NULL))
GO
