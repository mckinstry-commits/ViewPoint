 ...
 *************************************************************************/
 AS
    ...
    BEGIN TRY	;
		...
		END CATCH 
GO
ALTER TABLE [dbo].[bHQAI] WITH NOCHECK ADD CONSTRAINT [CK_bHQAI_CustomYN] CHECK (([CustomYN]='Y' OR [CustomYN]='N'))
GO
ALTER TABLE [dbo].[bHQAI] ADD CONSTRAINT [PK_bHQAI] PRIMARY KEY CLUSTERED  ([AttachmentID], [IndexSeq]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
