...
GO
ALTER TABLE [dbo].[vSMCustomerContact] NOCHECK CONSTRAINT [FK_vSMCustomerContact_vHQContact]
GO
ALTER TABLE [dbo].[vSMCustomerContact] NOCHECK CONSTRAINT [FK_vSMCustomerContact_vSMCO]
GO
ALTER TABLE [dbo].[vSMCustomerContact] NOCHECK CONSTRAINT [FK_vSMCustomerContact_vCustomer]
GO
