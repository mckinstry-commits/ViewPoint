...
[HrlyRate] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPREH_HrlyRate] DEFAULT ((0)),
[SalaryAmt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPREH_SalaryAmt] DEFAULT ((0)),
[OTOpt] [char] (1) COLLATE Latin1_General_BIN NOT NULL,
[OTSched] [tinyint] NULL,
[JCFixedRate] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPREH_JCFixedRate] DEFAULT ((0)),
[EMFixedRate] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPREH_EMFixedRate] DEFAULT ((0)),
[YTDSUI] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPREH_YTDSUI] DEFAULT ((0)),
...
[udJobTitle] [dbo].[bItemDesc] NULL,
[udExempt] [varchar] (1) COLLATE Latin1_General_BIN NULL,
[ud401kEligYN] [dbo].[bYN] NULL CONSTRAINT [DF__bPREH__ud401kEligYN__DEFAULT] DEFAULT ('N'),
[ud401kElgDate] [smalldatetime] NULL
...
-- =============================================
CREATE TRIGGER [dbo].[mckAutomateEmplCopy] 
   ON  [dbo].[bPREH] 
   AFTER INSERT
AS 
BEGIN
...
GO
ALTER TABLE [dbo].[bPREH] WITH NOCHECK ADD CONSTRAINT [CK_bPREH_ActiveYN] CHECK (([ActiveYN]='Y' OR [ActiveYN]='N'))
GO
ALTER TABLE [dbo].[bPREH] WITH NOCHECK ADD CONSTRAINT [CK_bPREH_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
GO
ALTER TABLE [dbo].[bPREH] WITH NOCHECK ADD CONSTRAINT [CK_bPREH_CertYN] CHECK (([CertYN]='Y' OR [CertYN]='N'))
GO
ALTER TABLE [dbo].[bPREH] WITH NOCHECK ADD CONSTRAINT [CK_bPREH_DefaultPaySeq] CHECK (([DefaultPaySeq]='Y' OR [DefaultPaySeq]='N'))
GO
ALTER TABLE [dbo].[bPREH] WITH NOCHECK ADD CONSTRAINT [CK_bPREH_PensionYN] CHECK (([PensionYN]='Y' OR [PensionYN]='N'))
GO
ALTER TABLE [dbo].[bPREH] WITH NOCHECK ADD CONSTRAINT [CK_bPREH_PostToAll] CHECK (([PostToAll]='Y' OR [PostToAll]='N'))
GO
ALTER TABLE [dbo].[bPREH] WITH NOCHECK ADD CONSTRAINT [CK_bPREH_UseIns] CHECK (([UseIns]='Y' OR [UseIns]='N'))
GO
ALTER TABLE [dbo].[bPREH] WITH NOCHECK ADD CONSTRAINT [CK_bPREH_UseLocal] CHECK (([UseLocal]='Y' OR [UseLocal]='N'))
GO
ALTER TABLE [dbo].[bPREH] WITH NOCHECK ADD CONSTRAINT [CK_bPREH_UseState] CHECK (([UseState]='Y' OR [UseState]='N'))
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPREH] ([KeyID]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPREH] ON [dbo].[bPREH] ([PRCo], [Employee]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biPREHSortName] ON [dbo].[bPREH] ([SortName]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
