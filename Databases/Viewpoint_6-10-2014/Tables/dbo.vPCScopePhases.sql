...
GO
ALTER TABLE [dbo].[vPCScopePhases] WITH NOCHECK ADD CONSTRAINT [FK_vPCScopePhases_bJCPM] FOREIGN KEY ([PhaseGroup], [Phase]) REFERENCES [dbo].[bJCPM] ([PhaseGroup], [Phase])
GO
...
GO
ALTER TABLE [dbo].[vPCScopePhases] NOCHECK CONSTRAINT [FK_vPCScopePhases_bJCPM]
GO
ALTER TABLE [dbo].[vPCScopePhases] NOCHECK CONSTRAINT [FK_vPCScopePhases_vPCScopeCodes]
GO
