...
GO
ALTER TABLE [dbo].[bINMU] WITH NOCHECK ADD CONSTRAINT [CK_bINMU_LastECM] CHECK (([LastECM]='M' OR [LastECM]='C' OR [LastECM]='E'))
GO
ALTER TABLE [dbo].[bINMU] WITH NOCHECK ADD CONSTRAINT [CK_bINMU_PriceECM] CHECK (([PriceECM]='M' OR [PriceECM]='C' OR [PriceECM]='E'))
GO
ALTER TABLE [dbo].[bINMU] WITH NOCHECK ADD CONSTRAINT [CK_bINMU_StdCostECM] CHECK (([StdCostECM]='M' OR [StdCostECM]='C' OR [StdCostECM]='E'))
GO
