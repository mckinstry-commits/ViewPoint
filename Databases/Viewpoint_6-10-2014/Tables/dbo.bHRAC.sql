...
GO
ALTER TABLE [dbo].[bHRAC] WITH NOCHECK ADD CONSTRAINT [CK_bHRAC_FiledYN] CHECK (([FiledYN]='Y' OR [FiledYN]='N'))
GO
ALTER TABLE [dbo].[bHRAC] WITH NOCHECK ADD CONSTRAINT [CK_bHRAC_PaidYN] CHECK (([PaidYN]='Y' OR [PaidYN]='N'))
GO
