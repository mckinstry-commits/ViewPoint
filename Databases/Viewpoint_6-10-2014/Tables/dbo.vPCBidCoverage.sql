...
GO
ALTER TABLE [dbo].[vPCBidCoverage] NOCHECK CONSTRAINT [FK_vPCBidCoverage_vPCBidPackageScopes]
GO
ALTER TABLE [dbo].[vPCBidCoverage] NOCHECK CONSTRAINT [FK_vPCBidCoverage_vPCBidPackageBidList]
GO
