...
GO
ALTER TABLE [dbo].[bHQCO] WITH NOCHECK ADD CONSTRAINT [CK_bHQCO_AuditCoParams] CHECK (([AuditCoParams]='Y' OR [AuditCoParams]='N'))
GO
ALTER TABLE [dbo].[bHQCO] WITH NOCHECK ADD CONSTRAINT [CK_bHQCO_AuditMatl] CHECK (([AuditMatl]='Y' OR [AuditMatl]='N'))
GO
ALTER TABLE [dbo].[bHQCO] WITH NOCHECK ADD CONSTRAINT [CK_bHQCO_AuditTax] CHECK (([AuditTax]='Y' OR [AuditTax]='N'))
GO
...
GO
ALTER TABLE [dbo].[bHQCO] NOCHECK CONSTRAINT [FK_bHQCO_vCurrency_CurrencyID]
GO
ALTER TABLE [dbo].[bHQCO] NOCHECK CONSTRAINT [FK_bHQCO_vDateFormat_DFId]
GO
ALTER TABLE [dbo].[bHQCO] NOCHECK CONSTRAINT [FK_bHQCO_vNumericMaskDetails_MaskId]
GO
