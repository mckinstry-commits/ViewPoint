...
GO
ALTER TABLE [dbo].[bPMUR] WITH NOCHECK ADD CONSTRAINT [FK_bPMUR_bPMUT] FOREIGN KEY ([Template]) REFERENCES [dbo].[bPMUT] ([Template]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[bPMUR] NOCHECK CONSTRAINT [FK_bPMUR_bPMUT]
GO
