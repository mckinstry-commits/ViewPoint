...
GO
ALTER TABLE [dbo].[vPMChangeOrderRequestPCO] WITH NOCHECK ADD CONSTRAINT [FK_vPMChangeOrderRequestPCO_vPMChangeOrderRequestPCO_PCOID] FOREIGN KEY ([PCOID]) REFERENCES [dbo].[bPMOP] ([KeyID]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[vPMChangeOrderRequestPCO] WITH NOCHECK ADD CONSTRAINT [FK_vPMChangeOrderRequestPCO_bPMCO] FOREIGN KEY ([PMCo]) REFERENCES [dbo].[bPMCO] ([PMCo])
GO
ALTER TABLE [dbo].[vPMChangeOrderRequestPCO] WITH NOCHECK ADD CONSTRAINT [FK_vPMChangeOrderRequestPCO_bJCCM] FOREIGN KEY ([PMCo], [Contract]) REFERENCES [dbo].[bJCCM] ([JCCo], [Contract])
GO
ALTER TABLE [dbo].[vPMChangeOrderRequestPCO] WITH NOCHECK ADD CONSTRAINT [FK_vPMChangeOrderRequestPCO_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
ALTER TABLE [dbo].[vPMChangeOrderRequestPCO] WITH NOCHECK ADD CONSTRAINT [FK_vPMChangeOrderRequestPCO_bPMOP] FOREIGN KEY ([PMCo], [Project], [PCOType], [PCO]) REFERENCES [dbo].[bPMOP] ([PMCo], [Project], [PCOType], [PCO])
GO
ALTER TABLE [dbo].[vPMChangeOrderRequestPCO] NOCHECK CONSTRAINT [FK_vPMChangeOrderRequestPCO_vPMChangeOrderRequestPCO_KeyID]
GO
ALTER TABLE [dbo].[vPMChangeOrderRequestPCO] NOCHECK CONSTRAINT [FK_vPMChangeOrderRequestPCO_vPMChangeOrderRequestPCO_PCOID]
GO
ALTER TABLE [dbo].[vPMChangeOrderRequestPCO] NOCHECK CONSTRAINT [FK_vPMChangeOrderRequestPCO_bPMCO]
GO
ALTER TABLE [dbo].[vPMChangeOrderRequestPCO] NOCHECK CONSTRAINT [FK_vPMChangeOrderRequestPCO_bJCCM]
GO
ALTER TABLE [dbo].[vPMChangeOrderRequestPCO] NOCHECK CONSTRAINT [FK_vPMChangeOrderRequestPCO_bJCJM]
GO
ALTER TABLE [dbo].[vPMChangeOrderRequestPCO] NOCHECK CONSTRAINT [FK_vPMChangeOrderRequestPCO_bPMOP]
GO
