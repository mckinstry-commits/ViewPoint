...
[InviteTo4PRequested] [dbo].[bYN] NOT NULL CONSTRAINT [DF_bPMPF_InviteTo4PRequested] DEFAULT ('N')
 ...
 *				ScottP 02/05/2013 TK-29964 When a Project Firm Contact is deleted, 
 *					add to trigger to delete possible related contact records
 *					from PMProjectDefaultDistributions and PMProjDefDistDocType
 *				GP 5/1/2013 - TFS 47661 Removed delete from removed table for default distribution
 *--------------------------------------------------------------*/

if @@rowcount = 0 return
set nocount on

--- Delete Contact records from Default Distribution
delete vPMProjectDefaultDistributions from vPMProjectDefaultDistributions a
join deleted d on a.PMCo = d.PMCo AND a.Project=d.Project AND a.FirmNumber=d.FirmNumber AND a.ContactCode=d.ContactCode
...
GO
ALTER TABLE [dbo].[bPMPF] NOCHECK CONSTRAINT [FK_bPMPF_bJCJM]
GO
ALTER TABLE [dbo].[bPMPF] NOCHECK CONSTRAINT [FK_bPMPF_bPMFM]
GO
ALTER TABLE [dbo].[bPMPF] NOCHECK CONSTRAINT [FK_bPMPF_bPMPM]
GO
