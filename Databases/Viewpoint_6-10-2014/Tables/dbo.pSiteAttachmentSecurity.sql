...
GO
ALTER TABLE [dbo].[pSiteAttachmentSecurity] NOCHECK CONSTRAINT [FK_pSiteAttachmentSecurity_pRoles]
GO
ALTER TABLE [dbo].[pSiteAttachmentSecurity] NOCHECK CONSTRAINT [FK_pSiteAttachmentSecurity_pSites]
GO
