...
GO
ALTER TABLE [dbo].[bRQQH] WITH NOCHECK ADD CONSTRAINT [CK_bRQQH_Locked] CHECK (([Locked]='Y' OR [Locked]='N'))
GO
ALTER TABLE [dbo].[bRQQH] ADD CONSTRAINT [biRQQH] PRIMARY KEY CLUSTERED  ([RQCo], [Quote]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
