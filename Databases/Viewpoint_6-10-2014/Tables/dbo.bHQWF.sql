...
GO
ALTER TABLE [dbo].[bHQWF] WITH NOCHECK ADD CONSTRAINT [CK_bHQWF_WordTableYN] CHECK (([WordTableYN]='Y' OR [WordTableYN]='N'))
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHQWF] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biHQWF] ON [dbo].[bHQWF] ([TemplateName], [Seq]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
