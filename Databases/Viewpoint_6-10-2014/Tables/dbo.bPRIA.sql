...
[Rate] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPRIA_Rate] DEFAULT ((0)),
...
GO
CREATE UNIQUE CLUSTERED INDEX [biPRIA] ON [dbo].[bPRIA] ([PRCo], [PRGroup], [PREndDate], [Employee], [PaySeq], [State], [InsCode], [DLCode]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
