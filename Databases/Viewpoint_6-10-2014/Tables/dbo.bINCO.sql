...
GO
ALTER TABLE [dbo].[bINCO] WITH NOCHECK ADD CONSTRAINT [CK_bINCO_AttachBatchReportsYN] CHECK (([AttachBatchReportsYN]='Y' OR [AttachBatchReportsYN]='N'))
GO
ALTER TABLE [dbo].[bINCO] WITH NOCHECK ADD CONSTRAINT [CK_bINCO_AuditBoM] CHECK (([AuditBoM]='Y' OR [AuditBoM]='N'))
GO
ALTER TABLE [dbo].[bINCO] WITH NOCHECK ADD CONSTRAINT [CK_bINCO_AuditCoParams] CHECK (([AuditCoParams]='Y' OR [AuditCoParams]='N'))
GO
ALTER TABLE [dbo].[bINCO] WITH NOCHECK ADD CONSTRAINT [CK_bINCO_AuditLoc] CHECK (([AuditLoc]='Y' OR [AuditLoc]='N'))
GO
ALTER TABLE [dbo].[bINCO] WITH NOCHECK ADD CONSTRAINT [CK_bINCO_AuditMOs] CHECK (([AuditMOs]='Y' OR [AuditMOs]='N'))
GO
ALTER TABLE [dbo].[bINCO] WITH NOCHECK ADD CONSTRAINT [CK_bINCO_AuditMatl] CHECK (([AuditMatl]='Y' OR [AuditMatl]='N'))
GO
ALTER TABLE [dbo].[bINCO] WITH NOCHECK ADD CONSTRAINT [CK_bINCO_AutoMO] CHECK (([AutoMO]='Y' OR [AutoMO]='N'))
GO
ALTER TABLE [dbo].[bINCO] WITH NOCHECK ADD CONSTRAINT [CK_bINCO_BurdenCost] CHECK (([BurdenCost]='Y' OR [BurdenCost]='N'))
GO
ALTER TABLE [dbo].[bINCO] WITH NOCHECK ADD CONSTRAINT [CK_bINCO_CmtdDetailToJC] CHECK (([CmtdDetailToJC]='Y' OR [CmtdDetailToJC]='N'))
GO
ALTER TABLE [dbo].[bINCO] WITH NOCHECK ADD CONSTRAINT [CK_bINCO_CostOver] CHECK (([CostOver]='Y' OR [CostOver]='N'))
GO
ALTER TABLE [dbo].[bINCO] WITH NOCHECK ADD CONSTRAINT [CK_bINCO_NegWarn] CHECK (([NegWarn]='Y' OR [NegWarn]='N'))
GO
ALTER TABLE [dbo].[bINCO] WITH NOCHECK ADD CONSTRAINT [CK_bINCO_OverrideGL] CHECK (([OverrideGL]='Y' OR [OverrideGL]='N'))
GO
CREATE UNIQUE CLUSTERED INDEX [biINCO] ON [dbo].[bINCO] ([INCo]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINCO] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
