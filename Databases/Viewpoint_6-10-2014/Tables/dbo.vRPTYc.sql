...
GO
ALTER TABLE [dbo].[vRPTYc] WITH NOCHECK ADD CONSTRAINT [CK_vRPTYc_Active] CHECK (([Active]='Y' OR [Active]='N' OR [Active] IS NULL))
GO
CREATE UNIQUE CLUSTERED INDEX [viRPTYc] ON [dbo].[vRPTYc] ([ReportType]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
