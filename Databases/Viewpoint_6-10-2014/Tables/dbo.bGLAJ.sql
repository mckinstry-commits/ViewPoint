...
GO
ALTER TABLE [dbo].[bGLAJ] WITH NOCHECK ADD CONSTRAINT [CK_bGLAJ_FixedPercentRatio] CHECK (([AllocType]<>(2) AND [RatioType1] IS NULL AND [RatioAcct1] IS NULL AND [RatioBasis1] IS NULL AND [RatioType2] IS NULL AND [RatioAcct2] IS NULL AND [RatioBasis2] IS NULL OR [AllocType]=(2)))
GO
ALTER TABLE [dbo].[bGLAJ] WITH NOCHECK ADD CONSTRAINT [CK_bGLAJ_MissingRatioType] CHECK (([AllocType]=(2) AND [RatioType1] IS NOT NULL OR [AllocType]<>(2)))
GO
ALTER TABLE [dbo].[bGLAJ] WITH NOCHECK ADD CONSTRAINT [CK_bGLAJ_MissingRatioType2] CHECK (([AllocType]=(2) AND [RatioType2] IS NOT NULL OR [AllocType]<>(2)))
GO
ALTER TABLE [dbo].[bGLAJ] WITH NOCHECK ADD CONSTRAINT [CK_bGLAJ_SourceTypeAllocation] CHECK ((([AllocType]=(2) OR [AllocType]=(1)) AND [SourceType] IS NOT NULL OR NOT ([AllocType]=(2) OR [AllocType]=(1))))
GO
...
GO
ALTER TABLE [dbo].[bGLAJ] NOCHECK CONSTRAINT [FK_bGLAJ_bHQFC_Frequency]
GO
ALTER TABLE [dbo].[bGLAJ] NOCHECK CONSTRAINT [FK_bGLAJ_bGLJR_GLCoJrnl]
GO
