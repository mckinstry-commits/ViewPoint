...
GO
ALTER TABLE [dbo].[pLookups] ADD CONSTRAINT [PK_pLookups] PRIMARY KEY CLUSTERED  ([LookupID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
ALTER TABLE [dbo].[pLookups] WITH NOCHECK ADD CONSTRAINT [FK_pLookups_pLookupColumns] FOREIGN KEY ([DefaultSortID]) REFERENCES [dbo].[pLookupColumns] ([LookupColumnID])
GO
ALTER TABLE [dbo].[pLookups] WITH NOCHECK ADD CONSTRAINT [FK_pLookups_pLookupColumns2] FOREIGN KEY ([DisplayColumnID]) REFERENCES [dbo].[pLookupColumns] ([LookupColumnID])
GO
ALTER TABLE [dbo].[pLookups] WITH NOCHECK ADD CONSTRAINT [FK_pLookups_pLookupColumns1] FOREIGN KEY ([ReturnColumnID]) REFERENCES [dbo].[pLookupColumns] ([LookupColumnID])
GO
ALTER TABLE [dbo].[pLookups] NOCHECK CONSTRAINT [FK_pLookups_pLookupColumns]
GO
ALTER TABLE [dbo].[pLookups] NOCHECK CONSTRAINT [FK_pLookups_pLookupColumns2]
GO
ALTER TABLE [dbo].[pLookups] NOCHECK CONSTRAINT [FK_pLookups_pLookupColumns1]
GO
