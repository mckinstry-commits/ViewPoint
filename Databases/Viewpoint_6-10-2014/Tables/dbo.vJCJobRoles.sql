...
GO
ALTER TABLE [dbo].[vJCJobRoles] WITH NOCHECK ADD CONSTRAINT [CK_vJCJobRoles_Active] CHECK (([Active]='Y' OR [Active]='N'))
GO
ALTER TABLE [dbo].[vJCJobRoles] WITH NOCHECK ADD CONSTRAINT [CK_vJCJobRoles_Lead] CHECK (([Lead]='Y' OR [Lead]='N'))
GO
...
GO
ALTER TABLE [dbo].[vJCJobRoles] WITH NOCHECK ADD CONSTRAINT [FK_vJCJobRoles_bJCJM] FOREIGN KEY ([JCCo], [Job]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
...
GO
ALTER TABLE [dbo].[vJCJobRoles] NOCHECK CONSTRAINT [FK_vJCJobRoles_bJCJM]
GO
ALTER TABLE [dbo].[vJCJobRoles] NOCHECK CONSTRAINT [FK_vJCJobRoles_vHQRoles]
GO
