...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSVT] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biMSVT] ON [dbo].[bMSVT] ([VendorGroup], [Vendor], [Truck]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
