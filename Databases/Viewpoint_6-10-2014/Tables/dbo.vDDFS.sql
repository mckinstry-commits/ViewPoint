...
GO
ALTER TABLE [dbo].[vDDFS] WITH NOCHECK ADD CONSTRAINT [CK_vDDFS_RecAdd] CHECK (([RecAdd]='Y' OR [RecAdd]='N'))
GO
ALTER TABLE [dbo].[vDDFS] WITH NOCHECK ADD CONSTRAINT [CK_vDDFS_RecDelete] CHECK (([RecDelete]='Y' OR [RecDelete]='N'))
GO
ALTER TABLE [dbo].[vDDFS] WITH NOCHECK ADD CONSTRAINT [CK_vDDFS_RecUpdate] CHECK (([RecUpdate]='Y' OR [RecUpdate]='N'))
GO
