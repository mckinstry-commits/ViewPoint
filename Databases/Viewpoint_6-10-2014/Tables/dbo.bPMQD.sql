...
GO
ALTER TABLE [dbo].[bPMQD] WITH NOCHECK ADD CONSTRAINT [CK_bPMQD_CC] CHECK (([CC]='C' OR [CC]='B' OR [CC]='N'))
GO
ALTER TABLE [dbo].[bPMQD] WITH NOCHECK ADD CONSTRAINT [CK_bPMQD_Send] CHECK (([Send]='Y' OR [Send]='N'))
GO
ALTER TABLE [dbo].[bPMQD] ADD CONSTRAINT [PK_bPMQD] PRIMARY KEY CLUSTERED  ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[bPMQD] NOCHECK CONSTRAINT [FK_bPMQD_bPMDT]
GO
ALTER TABLE [dbo].[bPMQD] NOCHECK CONSTRAINT [FK_bPMQD_bJCJM]
GO
ALTER TABLE [dbo].[bPMQD] NOCHECK CONSTRAINT [FK_bPMQD_bPMOP]
GO
ALTER TABLE [dbo].[bPMQD] NOCHECK CONSTRAINT [FK_bPMQD_bPMRQ]
GO
ALTER TABLE [dbo].[bPMQD] NOCHECK CONSTRAINT [FK_bPMQD_bPMFM]
GO
ALTER TABLE [dbo].[bPMQD] NOCHECK CONSTRAINT [FK_bPMQD_bPMPM]
GO
