...
GO
ALTER TABLE [dbo].[bHQMU] WITH NOCHECK ADD CONSTRAINT [CK_bHQMU_CostECM] CHECK (([CostECM]='E' OR [CostECM]='C' OR [CostECM]='M'))
GO
ALTER TABLE [dbo].[bHQMU] WITH NOCHECK ADD CONSTRAINT [CK_bHQMU_PriceECM] CHECK (([PriceECM]='E' OR [PriceECM]='C' OR [PriceECM]='M'))
GO
