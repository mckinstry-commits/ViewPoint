...
GO
ALTER TABLE [dbo].[bGLRF] WITH NOCHECK ADD CONSTRAINT [CK_bGLRF_Adjust] CHECK (([Adjust]='Y' OR [Adjust]='N' OR [Adjust] IS NULL))
GO
...
GO
ALTER TABLE [dbo].[bGLRF] WITH NOCHECK ADD CONSTRAINT [FK_bGLRF_bGLJR_GLCoJrnl] FOREIGN KEY ([GLCo], [Jrnl]) REFERENCES [dbo].[bGLJR] ([GLCo], [Jrnl])
GO
ALTER TABLE [dbo].[bGLRF] NOCHECK CONSTRAINT [FK_bGLRF_bGLJR_GLCoJrnl]
GO
