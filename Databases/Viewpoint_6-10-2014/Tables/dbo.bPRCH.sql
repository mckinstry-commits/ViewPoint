...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRCH] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRCH] ON [dbo].[bPRCH] ([PRCo], [Craft], [Holiday]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
