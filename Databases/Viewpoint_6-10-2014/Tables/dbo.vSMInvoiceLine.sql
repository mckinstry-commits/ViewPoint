...
GO
ALTER TABLE [dbo].[vSMInvoiceLine] WITH NOCHECK ADD CONSTRAINT [CK_vSMInvoiceLine_Invoiced] CHECK (([Invoiced]=[dbo].[vfEqualsNull]([Invoice]) AND [Invoiced]=[dbo].[vfEqualsNull]([InvoiceDetail])))
GO
...
GO
ALTER TABLE [dbo].[vSMInvoiceLine] WITH NOCHECK ADD CONSTRAINT [FK_vSMInvoiceLine_bGLAC] FOREIGN KEY ([GLCo], [GLAccount]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
GO
ALTER TABLE [dbo].[vSMInvoiceLine] WITH NOCHECK ADD CONSTRAINT [FK_vSMInvoiceLine_bARTL] FOREIGN KEY ([LastPostedARCo], [LastPostedARMth], [LastPostedARTrans], [LastPostedARLine]) REFERENCES [dbo].[bARTL] ([ARCo], [Mth], [ARTrans], [ARLine])
GO
ALTER TABLE [dbo].[vSMInvoiceLine] WITH NOCHECK ADD CONSTRAINT [FK_vSMInvoiceLine_vSMInvoiceDetail] FOREIGN KEY ([SMCo], [Invoice], [InvoiceDetail]) REFERENCES [dbo].[vSMInvoiceDetail] ([SMCo], [Invoice], [InvoiceDetail])
GO
ALTER TABLE [dbo].[vSMInvoiceLine] WITH NOCHECK ADD CONSTRAINT [FK_vSMInvoiceLine_bHQTX] FOREIGN KEY ([TaxGroup], [TaxCode]) REFERENCES [dbo].[bHQTX] ([TaxGroup], [TaxCode])
GO
ALTER TABLE [dbo].[vSMInvoiceLine] NOCHECK CONSTRAINT [FK_vSMInvoiceLine_bGLAC]
GO
ALTER TABLE [dbo].[vSMInvoiceLine] NOCHECK CONSTRAINT [FK_vSMInvoiceLine_bARTL]
GO
ALTER TABLE [dbo].[vSMInvoiceLine] NOCHECK CONSTRAINT [FK_vSMInvoiceLine_vSMInvoiceDetail]
GO
ALTER TABLE [dbo].[vSMInvoiceLine] NOCHECK CONSTRAINT [FK_vSMInvoiceLine_bHQTX]
GO
