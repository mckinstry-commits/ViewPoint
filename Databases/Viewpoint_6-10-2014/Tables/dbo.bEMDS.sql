...
GO
ALTER TABLE [dbo].[bEMDS] WITH NOCHECK ADD CONSTRAINT [FK_bEMDS_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMDS] WITH NOCHECK ADD CONSTRAINT [FK_bEMDS_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[bEMDS] WITH NOCHECK ADD CONSTRAINT [FK_bEMDS_bEMDP_EquipAsset] FOREIGN KEY ([EMCo], [Equipment], [Asset]) REFERENCES [dbo].[bEMDP] ([EMCo], [Equipment], [Asset]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[bEMDS] NOCHECK CONSTRAINT [FK_bEMDS_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMDS] NOCHECK CONSTRAINT [FK_bEMDS_bEMEM_Equipment]
GO
ALTER TABLE [dbo].[bEMDS] NOCHECK CONSTRAINT [FK_bEMDS_bEMDP_EquipAsset]
GO
