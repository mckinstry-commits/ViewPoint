...
GO
ALTER TABLE [dbo].[bINAB] WITH NOCHECK ADD CONSTRAINT [CK_bINAB_BatchTransType] CHECK (([BatchTransType]='A' OR [BatchTransType]='C' OR [BatchTransType]='D'))
GO
ALTER TABLE [dbo].[bINAB] WITH NOCHECK ADD CONSTRAINT [CK_bINAB_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M'))
GO
ALTER TABLE [dbo].[bINAB] WITH NOCHECK ADD CONSTRAINT [CK_bINAB_OldECM] CHECK (([OldECM]='E' OR [OldECM]='C' OR [OldECM]='M' OR [OldECM] IS NULL))
GO
