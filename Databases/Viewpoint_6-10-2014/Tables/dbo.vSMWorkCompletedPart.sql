...
GO
ALTER TABLE [dbo].[vSMWorkCompletedPart] NOCHECK CONSTRAINT [FK_vSMWorkCompletedPart_bINLM]
GO
ALTER TABLE [dbo].[vSMWorkCompletedPart] NOCHECK CONSTRAINT [FK_vSMWorkCompletedPart_bJCCT]
GO
ALTER TABLE [dbo].[vSMWorkCompletedPart] NOCHECK CONSTRAINT [FK_vSMWorkCompletedPart_vPOItemLine]
GO
ALTER TABLE [dbo].[vSMWorkCompletedPart] NOCHECK CONSTRAINT [FK_vSMWorkCompletedPart_bHQUM_PriceUM]
GO
ALTER TABLE [dbo].[vSMWorkCompletedPart] NOCHECK CONSTRAINT [FK_vSMWorkCompletedPart_vSMWorkCompleted]
GO
ALTER TABLE [dbo].[vSMWorkCompletedPart] NOCHECK CONSTRAINT [FK_vSMWorkCompletedPart_bHQUM_UM]
GO
ALTER TABLE [dbo].[vSMWorkCompletedPart] NOCHECK CONSTRAINT [FK_vSMWorkCompletedPart_vSMWorkCompletedDetail]
GO
