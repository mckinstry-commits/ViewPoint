...
GO
ALTER TABLE [dbo].[vAuditFlagGroup] NOCHECK CONSTRAINT [FK_vAuditFlagGroup_vAuditFlags]
GO
ALTER TABLE [dbo].[vAuditFlagGroup] NOCHECK CONSTRAINT [FK_vAuditFlagGroup_bHQGP]
GO
