...
GO
ALTER TABLE [dbo].[bAPLB] WITH NOCHECK ADD CONSTRAINT [CK_bAPLB_BECM] CHECK (([BECM]='E' OR [BECM]='C' OR [BECM]='M' OR [BECM] IS NULL))
GO
ALTER TABLE [dbo].[bAPLB] WITH NOCHECK ADD CONSTRAINT [CK_bAPLB_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
GO
ALTER TABLE [dbo].[bAPLB] WITH NOCHECK ADD CONSTRAINT [CK_bAPLB_MiscYN] CHECK (([MiscYN]='Y' OR [MiscYN]='N'))
GO
ALTER TABLE [dbo].[bAPLB] WITH NOCHECK ADD CONSTRAINT [CK_bAPLB_OldBECM] CHECK (([OldBECM]='E' OR [OldBECM]='C' OR [OldBECM]='M' OR [OldBECM] IS NULL))
GO
ALTER TABLE [dbo].[bAPLB] WITH NOCHECK ADD CONSTRAINT [CK_bAPLB_OldECM] CHECK (([OldECM]='E' OR [OldECM]='C' OR [OldECM]='M' OR [OldECM] IS NULL))
GO
ALTER TABLE [dbo].[bAPLB] WITH NOCHECK ADD CONSTRAINT [CK_bAPLB_OldMiscYN] CHECK (([OldMiscYN]='Y' OR [OldMiscYN]='N' OR [OldMiscYN] IS NULL))
GO
ALTER TABLE [dbo].[bAPLB] WITH NOCHECK ADD CONSTRAINT [CK_bAPLB_POPayTypeYN] CHECK (([POPayTypeYN]='Y' OR [POPayTypeYN]='N'))
GO
ALTER TABLE [dbo].[bAPLB] WITH NOCHECK ADD CONSTRAINT [CK_bAPLB_PaidYN] CHECK (([PaidYN]='Y' OR [PaidYN]='N'))
GO
