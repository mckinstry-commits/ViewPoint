...
GO
ALTER TABLE [dbo].[vSMWorkOrderScope] WITH NOCHECK ADD CONSTRAINT [CK_vSMWorkOrderScope_Agreement] CHECK (([dbo].[vfEqualsNull]([Agreement])=[dbo].[vfEqualsNull]([Revision]) AND ([Service] IS NULL OR [Agreement] IS NOT NULL)))
GO
ALTER TABLE [dbo].[vSMWorkOrderScope] WITH NOCHECK ADD CONSTRAINT [CK_vSMWorkOrderScope_FlatPrice] CHECK (([PriceMethod]<>'F' OR [dbo].[vfEqualsNull]([Price])=(0)))
GO
...
GO
ALTER TABLE [dbo].[vSMWorkOrderScope] WITH NOCHECK ADD CONSTRAINT [FK_vSMWorkOrderScope_vSMWorkOrderQuote] FOREIGN KEY ([SMCo], [WorkOrderQuote]) REFERENCES [dbo].[vSMWorkOrderQuote] ([SMCo], [WorkOrderQuote])
GO
...
GO
ALTER TABLE [dbo].[vSMWorkOrderScope] NOCHECK CONSTRAINT [FK_vSMWorkOrderScope_vSMScopePriority]
GO
ALTER TABLE [dbo].[vSMWorkOrderScope] NOCHECK CONSTRAINT [FK_vSMWorkOrderScope_vSMAgreementService]
GO
ALTER TABLE [dbo].[vSMWorkOrderScope] NOCHECK CONSTRAINT [FK_vSMWorkOrderScope_vSMCallType]
GO
ALTER TABLE [dbo].[vSMWorkOrderScope] NOCHECK CONSTRAINT [FK_vSMWorkOrderScope_vSMRateTemplate]
GO
ALTER TABLE [dbo].[vSMWorkOrderScope] NOCHECK CONSTRAINT [FK_vSMWorkOrderScope_vSMDivision]
GO
ALTER TABLE [dbo].[vSMWorkOrderScope] NOCHECK CONSTRAINT [FK_vSMWorkOrderScope_vSMWorkOrder]
GO
ALTER TABLE [dbo].[vSMWorkOrderScope] NOCHECK CONSTRAINT [FK_vSMWorkOrderScope_vSMWorkOrderQuote]
GO
ALTER TABLE [dbo].[vSMWorkOrderScope] NOCHECK CONSTRAINT [FK_vSMWorkOrderScope_vSMWorkScope]
GO
