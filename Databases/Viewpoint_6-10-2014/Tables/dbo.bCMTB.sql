...
GO
ALTER TABLE [dbo].[bCMTB] WITH NOCHECK ADD CONSTRAINT [CK_bCMTB_FromCMAcct] CHECK (([FromCMAcct]>(0) AND [FromCMAcct]<(10000)))
GO
ALTER TABLE [dbo].[bCMTB] WITH NOCHECK ADD CONSTRAINT [CK_bCMTB_OldFromCMAcct] CHECK (([OldFromCMAcct]>(0) AND [OldFromCMAcct]<(10000) OR [OldFromCMAcct] IS NULL))
GO
ALTER TABLE [dbo].[bCMTB] WITH NOCHECK ADD CONSTRAINT [CK_bCMTB_OldToCMAcct] CHECK (([OldToCMAcct]>(0) AND [OldToCMAcct]<(10000) OR [OldToCMAcct] IS NULL))
GO
ALTER TABLE [dbo].[bCMTB] WITH NOCHECK ADD CONSTRAINT [CK_bCMTB_ToCMAcct] CHECK (([ToCMAcct]>(0) AND [ToCMAcct]<(10000)))
GO
