...
[udProjRevPct] [varchar] (10) COLLATE Latin1_General_BIN NULL
...
GO
ALTER TABLE [dbo].[bPMOP] WITH NOCHECK ADD CONSTRAINT [CK_bPMOP_BudgetType] CHECK (([BudgetType]='N' OR [BudgetType]='Y'))
GO
ALTER TABLE [dbo].[bPMOP] WITH NOCHECK ADD CONSTRAINT [CK_bPMOP_Contract] CHECK (([Contract] IS NOT NULL))
GO
ALTER TABLE [dbo].[bPMOP] WITH NOCHECK ADD CONSTRAINT [CK_bPMOP_ContractType] CHECK (([ContractType]='N' OR [ContractType]='Y'))
GO
ALTER TABLE [dbo].[bPMOP] WITH NOCHECK ADD CONSTRAINT [CK_bPMOP_POType] CHECK (([POType]='N' OR [POType]='Y'))
GO
ALTER TABLE [dbo].[bPMOP] WITH NOCHECK ADD CONSTRAINT [CK_bPMOP_PricingMethod] CHECK (([PricingMethod]='L' OR [PricingMethod]='U'))
GO
ALTER TABLE [dbo].[bPMOP] WITH NOCHECK ADD CONSTRAINT [CK_bPMOP_Priority] CHECK (([Priority]=(4) OR [Priority]=(3) OR [Priority]=(2) OR [Priority]=(1)))
GO
ALTER TABLE [dbo].[bPMOP] WITH NOCHECK ADD CONSTRAINT [CK_bPMOP_SubType] CHECK (([SubType]='N' OR [SubType]='Y'))
GO
ALTER TABLE [dbo].[bPMOP] ADD CONSTRAINT [PK_bPMOP] PRIMARY KEY NONCLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMOP] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMOP] ON [dbo].[bPMOP] ([PMCo], [Project], [PCOType], [PCO]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[bPMOP] NOCHECK CONSTRAINT [FK_bPMOP_bPMDT]
GO
ALTER TABLE [dbo].[bPMOP] NOCHECK CONSTRAINT [FK_bPMOP_bJCCM]
GO
ALTER TABLE [dbo].[bPMOP] NOCHECK CONSTRAINT [FK_bPMOP_bJCJM]
GO
ALTER TABLE [dbo].[bPMOP] NOCHECK CONSTRAINT [FK_bPMOP_bHQRC]
GO
ALTER TABLE [dbo].[bPMOP] NOCHECK CONSTRAINT [FK_bPMOP_bPMSC]
GO
