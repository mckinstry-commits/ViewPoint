...
GO
ALTER TABLE [dbo].[vSMAssociatedCallType] NOCHECK CONSTRAINT [FK_vSMAssociatedCallType_vSMCallType]
GO
ALTER TABLE [dbo].[vSMAssociatedCallType] NOCHECK CONSTRAINT [FK_vSMAssociatedCallType_vSMServiceCenter]
GO
ALTER TABLE [dbo].[vSMAssociatedCallType] NOCHECK CONSTRAINT [FK_vSMAssociatedCallType_vSMDivision]
GO
