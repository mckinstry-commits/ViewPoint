...
GO
ALTER TABLE [dbo].[bPMMI] WITH NOCHECK ADD CONSTRAINT [FK_bPMMI_bPMDT] FOREIGN KEY ([MeetingType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
ALTER TABLE [dbo].[bPMMI] WITH NOCHECK ADD CONSTRAINT [FK_bPMMI_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
ALTER TABLE [dbo].[bPMMI] WITH NOCHECK ADD CONSTRAINT [FK_bPMMI_bPMMM] FOREIGN KEY ([PMCo], [Project], [MeetingType], [Meeting], [MinutesType]) REFERENCES [dbo].[bPMMM] ([PMCo], [Project], [MeetingType], [Meeting], [MinutesType])
GO
ALTER TABLE [dbo].[bPMMI] WITH NOCHECK ADD CONSTRAINT [FK_bPMMI_bPMSC] FOREIGN KEY ([Status]) REFERENCES [dbo].[bPMSC] ([Status])
GO
ALTER TABLE [dbo].[bPMMI] WITH NOCHECK ADD CONSTRAINT [FK_bPMMI_bPMPM_Initiator] FOREIGN KEY ([VendorGroup], [InitFirm], [Initiator]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
GO
ALTER TABLE [dbo].[bPMMI] WITH NOCHECK ADD CONSTRAINT [FK_bPMMI_bPMPM_ResponsiblePerson] FOREIGN KEY ([VendorGroup], [ResponsibleFirm], [ResponsiblePerson]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
GO
ALTER TABLE [dbo].[bPMMI] NOCHECK CONSTRAINT [FK_bPMMI_bPMDT]
GO
ALTER TABLE [dbo].[bPMMI] NOCHECK CONSTRAINT [FK_bPMMI_bJCJM]
GO
ALTER TABLE [dbo].[bPMMI] NOCHECK CONSTRAINT [FK_bPMMI_bPMMM]
GO
ALTER TABLE [dbo].[bPMMI] NOCHECK CONSTRAINT [FK_bPMMI_bPMSC]
GO
ALTER TABLE [dbo].[bPMMI] NOCHECK CONSTRAINT [FK_bPMMI_bPMPM_Initiator]
GO
ALTER TABLE [dbo].[bPMMI] NOCHECK CONSTRAINT [FK_bPMMI_bPMPM_ResponsiblePerson]
GO
