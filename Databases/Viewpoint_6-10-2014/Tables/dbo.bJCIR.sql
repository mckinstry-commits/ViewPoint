...
GO
ALTER TABLE [dbo].[bJCIR] WITH NOCHECK ADD CONSTRAINT [CK_bJCIR_RevProjPlugged] CHECK (([RevProjPlugged]='Y' OR [RevProjPlugged]='N'))
GO
ALTER TABLE [dbo].[bJCIR] ADD CONSTRAINT [PK_bJCIR] PRIMARY KEY CLUSTERED  ([Co], [Mth], [BatchId], [BatchSeq]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
