...
GO
ALTER TABLE [dbo].[bRQRH] ADD CONSTRAINT [biRQRH] PRIMARY KEY CLUSTERED  ([RQCo], [RQID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bRQRH] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
