...
GO
ALTER TABLE [dbo].[bJBTC] WITH NOCHECK ADD CONSTRAINT [CK_bJBTC_APYN] CHECK (([APYN]='Y' OR [APYN]='N'))
GO
ALTER TABLE [dbo].[bJBTC] WITH NOCHECK ADD CONSTRAINT [CK_bJBTC_EMYN] CHECK (([EMYN]='Y' OR [EMYN]='N'))
GO
ALTER TABLE [dbo].[bJBTC] WITH NOCHECK ADD CONSTRAINT [CK_bJBTC_INYN] CHECK (([INYN]='Y' OR [INYN]='N'))
GO
ALTER TABLE [dbo].[bJBTC] WITH NOCHECK ADD CONSTRAINT [CK_bJBTC_JCYN] CHECK (([JCYN]='Y' OR [JCYN]='N'))
GO
ALTER TABLE [dbo].[bJBTC] WITH NOCHECK ADD CONSTRAINT [CK_bJBTC_MSYN] CHECK (([MSYN]='Y' OR [MSYN]='N'))
GO
ALTER TABLE [dbo].[bJBTC] WITH NOCHECK ADD CONSTRAINT [CK_bJBTC_PRYN] CHECK (([PRYN]='Y' OR [PRYN]='N'))
GO
