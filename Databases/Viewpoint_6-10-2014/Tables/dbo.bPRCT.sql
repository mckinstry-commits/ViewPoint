...
GO
ALTER TABLE [dbo].[bPRCT] WITH NOCHECK ADD CONSTRAINT [CK_bPRCT_OverEffectDate] CHECK (([OverEffectDate]='Y' OR [OverEffectDate]='N'))
GO
ALTER TABLE [dbo].[bPRCT] WITH NOCHECK ADD CONSTRAINT [CK_bPRCT_OverOT] CHECK (([OverOT]='Y' OR [OverOT]='N'))
GO
