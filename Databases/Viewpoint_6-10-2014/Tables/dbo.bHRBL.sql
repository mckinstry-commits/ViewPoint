...
GO
ALTER TABLE [dbo].[bHRBL] WITH NOCHECK ADD CONSTRAINT [CK_bHRBL_EmplBasedYN] CHECK (([EmplBasedYN]='Y' OR [EmplBasedYN]='N'))
GO
ALTER TABLE [dbo].[bHRBL] WITH NOCHECK ADD CONSTRAINT [CK_bHRBL_ReadyYN] CHECK (([ReadyYN]='Y' OR [ReadyYN]='N'))
GO
