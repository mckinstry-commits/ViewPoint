...
GO
ALTER TABLE [dbo].[vWFProcessStep] WITH NOCHECK ADD CONSTRAINT [FK_vWFProcessStep_vDDUP] FOREIGN KEY ([UserName]) REFERENCES [dbo].[vDDUP] ([VPUserName])
GO
ALTER TABLE [dbo].[vWFProcessStep] NOCHECK CONSTRAINT [FK_vWFProcessStep_vWFProcess]
GO
ALTER TABLE [dbo].[vWFProcessStep] NOCHECK CONSTRAINT [FK_vWFProcessStep_vHQRoles]
GO
ALTER TABLE [dbo].[vWFProcessStep] NOCHECK CONSTRAINT [FK_vWFProcessStep_vDDUP]
GO
