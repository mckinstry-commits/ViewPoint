...
[RateAmt] [dbo].[bUnitCost] NULL CONSTRAINT [DF_bPRED_RateAmt] DEFAULT ((0)),
...
[SuperWeeklyMin] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRED_SuperWeeklyMin] DEFAULT ((0.00))
...
GO
ALTER TABLE [dbo].[bPRED] WITH NOCHECK ADD CONSTRAINT [CK_bPRED_CSAllocYN] CHECK (([CSAllocYN]='Y' OR [CSAllocYN]='N'))
GO
ALTER TABLE [dbo].[bPRED] WITH NOCHECK ADD CONSTRAINT [CK_bPRED_CSMedCov] CHECK (([CSMedCov]='Y' OR [CSMedCov]='N' OR [CSMedCov] IS NULL))
GO
ALTER TABLE [dbo].[bPRED] WITH NOCHECK ADD CONSTRAINT [CK_bPRED_EmplBased] CHECK (([EmplBased]='Y' OR [EmplBased]='N'))
GO
ALTER TABLE [dbo].[bPRED] WITH NOCHECK ADD CONSTRAINT [CK_bPRED_OverLimit] CHECK (([OverLimit]='Y' OR [OverLimit]='N'))
GO
ALTER TABLE [dbo].[bPRED] WITH NOCHECK ADD CONSTRAINT [CK_bPRED_OverMiscAmt] CHECK (([OverMiscAmt]='Y' OR [OverMiscAmt]='N'))
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRED] ([KeyID]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRED] ON [dbo].[bPRED] ([PRCo], [Employee], [DLCode]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
