...
GO
ALTER TABLE [dbo].[bMSQD] WITH NOCHECK ADD CONSTRAINT [CK_bMSQD_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
GO
ALTER TABLE [dbo].[bMSQD] WITH NOCHECK ADD CONSTRAINT [CK_bMSQD_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M'))
GO
