...
GO
CREATE UNIQUE CLUSTERED INDEX [biPMTP] ON [dbo].[bPMTP] ([PMCo], [Template], [PhaseGroup], [Phase]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
ALTER TABLE [dbo].[bPMTP] WITH NOCHECK ADD CONSTRAINT [FK_bPMTP_bPMCO] FOREIGN KEY ([PMCo]) REFERENCES [dbo].[bPMCO] ([PMCo])
GO
ALTER TABLE [dbo].[bPMTP] WITH NOCHECK ADD CONSTRAINT [FK_bPMTP_bPMTH] FOREIGN KEY ([PMCo], [Template]) REFERENCES [dbo].[bPMTH] ([PMCo], [Template]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[bPMTP] NOCHECK CONSTRAINT [FK_bPMTP_bPMCO]
GO
ALTER TABLE [dbo].[bPMTP] NOCHECK CONSTRAINT [FK_bPMTP_bPMTH]
GO
