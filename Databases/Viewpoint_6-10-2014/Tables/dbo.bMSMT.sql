...
GO
ALTER TABLE [dbo].[bMSMT] WITH NOCHECK ADD CONSTRAINT [CK_bMSMT_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M'))
GO
ALTER TABLE [dbo].[bMSMT] WITH NOCHECK ADD CONSTRAINT [CK_bMSMT_PECM] CHECK (([PECM]='E' OR [PECM]='C' OR [PECM]='M'))
GO
