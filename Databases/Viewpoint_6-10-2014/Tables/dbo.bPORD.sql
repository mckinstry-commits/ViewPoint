...
GO
ALTER TABLE [dbo].[bPORD] WITH NOCHECK ADD CONSTRAINT [CK_bPORD_InvdFlag] CHECK (([InvdFlag]='Y' OR [InvdFlag]='N'))
GO
ALTER TABLE [dbo].[bPORD] WITH NOCHECK ADD CONSTRAINT [CK_bPORD_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
