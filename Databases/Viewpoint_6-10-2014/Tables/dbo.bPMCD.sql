...
GO
ALTER TABLE [dbo].[bPMCD] WITH NOCHECK ADD CONSTRAINT [CK_bPMCD_CC] CHECK (([CC]='C' OR [CC]='B' OR [CC]='N'))
GO
ALTER TABLE [dbo].[bPMCD] WITH NOCHECK ADD CONSTRAINT [CK_bPMCD_Send] CHECK (([Send]='Y' OR [Send]='N'))
GO
ALTER TABLE [dbo].[bPMCD] ADD CONSTRAINT [PK_bPMCD] PRIMARY KEY CLUSTERED  ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[bPMCD] NOCHECK CONSTRAINT [FK_bPMCD_bPMDT]
GO
ALTER TABLE [dbo].[bPMCD] NOCHECK CONSTRAINT [FK_bPMCD_bJCJM]
GO
ALTER TABLE [dbo].[bPMCD] NOCHECK CONSTRAINT [FK_bPMCD_bPMOP]
GO
ALTER TABLE [dbo].[bPMCD] NOCHECK CONSTRAINT [FK_bPMCD_bPMPM]
GO
