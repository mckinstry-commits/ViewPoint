...
[Basis] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRCA_Basis] DEFAULT ((0)),
[Amt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRCA_Amt] DEFAULT ((0)),
...
GO
CREATE UNIQUE CLUSTERED INDEX [biPRCA] ON [dbo].[bPRCA] ([PRCo], [PRGroup], [PREndDate], [Employee], [PaySeq], [Craft], [Class], [EDLType], [EDLCode]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
