...
GO
ALTER TABLE [dbo].[bHRBD] WITH NOCHECK ADD CONSTRAINT [CK_bHRBD_EmplBasedYN] CHECK (([EmplBasedYN]='Y' OR [EmplBasedYN]='N'))
GO
ALTER TABLE [dbo].[bHRBD] WITH NOCHECK ADD CONSTRAINT [CK_bHRBD_StdHours] CHECK (([StdHours]='Y' OR [StdHours]='N'))
GO
