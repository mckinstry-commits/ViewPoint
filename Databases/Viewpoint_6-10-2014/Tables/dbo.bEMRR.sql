...
GO
ALTER TABLE [dbo].[bEMRR] WITH NOCHECK ADD CONSTRAINT [CK_bEMRR_AllowPostOride] CHECK (([AllowPostOride]='N' OR [AllowPostOride]='Y'))
GO
ALTER TABLE [dbo].[bEMRR] WITH NOCHECK ADD CONSTRAINT [CK_bEMRR_PostWorkUnits] CHECK (([PostWorkUnits]='N' OR [PostWorkUnits]='Y'))
GO
ALTER TABLE [dbo].[bEMRR] WITH NOCHECK ADD CONSTRAINT [CK_bEMRR_UpdtHrMeter] CHECK (([UpdtHrMeter]='N' OR [UpdtHrMeter]='Y'))
GO
...
GO
ALTER TABLE [dbo].[bEMRR] WITH NOCHECK ADD CONSTRAINT [FK_bEMRR_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMRR] WITH NOCHECK ADD CONSTRAINT [FK_bEMRR_bEMCM_Category] FOREIGN KEY ([EMCo], [Category]) REFERENCES [dbo].[bEMCM] ([EMCo], [Category])
GO
ALTER TABLE [dbo].[bEMRR] WITH NOCHECK ADD CONSTRAINT [FK_bEMRR_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMRR] WITH NOCHECK ADD CONSTRAINT [FK_bEMRR_bEMRC_RevCode] FOREIGN KEY ([EMGroup], [RevCode]) REFERENCES [dbo].[bEMRC] ([EMGroup], [RevCode])
GO
ALTER TABLE [dbo].[bEMRR] NOCHECK CONSTRAINT [FK_bEMRR_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMRR] NOCHECK CONSTRAINT [FK_bEMRR_bEMCM_Category]
GO
ALTER TABLE [dbo].[bEMRR] NOCHECK CONSTRAINT [FK_bEMRR_bHQGP_EMGroup]
GO
ALTER TABLE [dbo].[bEMRR] NOCHECK CONSTRAINT [FK_bEMRR_bEMRC_RevCode]
GO
