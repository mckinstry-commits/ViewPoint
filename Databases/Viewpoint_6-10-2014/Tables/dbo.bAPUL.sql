...
[UnitCost] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bAPUL_UnitCost] DEFAULT ((0)),
[ECM] [dbo].[bECM] NULL,
...
GO
ALTER TABLE [dbo].[bAPUL] WITH NOCHECK ADD CONSTRAINT [CK_bAPUL_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
GO
ALTER TABLE [dbo].[bAPUL] WITH NOCHECK ADD CONSTRAINT [CK_bAPUL_MiscYN] CHECK (([MiscYN]='Y' OR [MiscYN]='N'))
GO
