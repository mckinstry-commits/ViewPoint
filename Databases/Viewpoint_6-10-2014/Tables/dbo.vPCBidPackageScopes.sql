...
GO
ALTER TABLE [dbo].[vPCBidPackageScopes] NOCHECK CONSTRAINT [FK_vPCBidPackageScopes_vPCBidPackage]
GO
ALTER TABLE [dbo].[vPCBidPackageScopes] NOCHECK CONSTRAINT [FK_vPCBidPackageScopes_vPCBidPackageBidList]
GO
ALTER TABLE [dbo].[vPCBidPackageScopes] NOCHECK CONSTRAINT [FK_vPCBidPackageScopes_bJCPM]
GO
ALTER TABLE [dbo].[vPCBidPackageScopes] NOCHECK CONSTRAINT [FK_vPCBidPackageScopes_vPCScopeCodes]
GO
