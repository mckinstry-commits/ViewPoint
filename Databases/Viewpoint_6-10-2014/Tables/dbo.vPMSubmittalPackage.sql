...
[udEquipTag] [varchar] (10) COLLATE Latin1_General_BIN NULL,
...
GO
ALTER TABLE [dbo].[vPMSubmittalPackage] WITH NOCHECK ADD CONSTRAINT [CK_vPMSubmittalPackage_ApprovingContact] CHECK ((NOT ([ApprovingFirm] IS NULL AND [ApprovingContact] IS NOT NULL)))
GO
ALTER TABLE [dbo].[vPMSubmittalPackage] WITH NOCHECK ADD CONSTRAINT [CK_vPMSubmittalPackage_OurFirmContact] CHECK ((NOT ([OurFirm] IS NULL AND [OurFirmContact] IS NOT NULL)))
GO
ALTER TABLE [dbo].[vPMSubmittalPackage] WITH NOCHECK ADD CONSTRAINT [CK_vPMSubmittalPackage_ResponsibleContact] CHECK ((NOT ([ResponsibleFirm] IS NULL AND [ResponsibleContact] IS NOT NULL)))
GO
...
GO
ALTER TABLE [dbo].[vPMSubmittalPackage] WITH NOCHECK ADD CONSTRAINT [FK_vPMSubmittalPackage_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
ALTER TABLE [dbo].[vPMSubmittalPackage] NOCHECK CONSTRAINT [FK_vPMSubmittalPackage_bJCJM]
GO
