...
[UnitCost] [dbo].[bUnitCost] NULL CONSTRAINT [DF_bPOVM_UnitCost] DEFAULT ((0)),
[CostECM] [dbo].[bECM] NULL,
[BookPrice] [dbo].[bUnitCost] NULL CONSTRAINT [DF_bPOVM_BookPrice] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[bPOVM] WITH NOCHECK ADD CONSTRAINT [CK_bPOVM_CostECM] CHECK (([CostECM]='E' OR [CostECM]='C' OR [CostECM]='M' OR [CostECM] IS NULL))
GO
ALTER TABLE [dbo].[bPOVM] WITH NOCHECK ADD CONSTRAINT [CK_bPOVM_PriceECM] CHECK (([PriceECM]='E' OR [PriceECM]='C' OR [PriceECM]='M' OR [PriceECM] IS NULL))
GO
