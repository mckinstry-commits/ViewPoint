...
GO
ALTER TABLE [dbo].[bJBIJ] WITH NOCHECK ADD CONSTRAINT [CK_bJBIJ_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
GO
ALTER TABLE [dbo].[bJBIJ] WITH NOCHECK ADD CONSTRAINT [CK_bJBIJ_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
