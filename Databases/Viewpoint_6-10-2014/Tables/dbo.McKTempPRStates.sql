CREATE TABLE [dbo].[McKTempPRStates]
(
[CMSUnion] [nvarchar] (255) COLLATE Latin1_General_BIN NULL,
[ResidentState] [nvarchar] (255) COLLATE Latin1_General_BIN NULL,
...
[McKGroup] [nvarchar] (255) COLLATE Latin1_General_BIN NULL
) ON [PRIMARY]
GO
