...
GO
ALTER TABLE [dbo].[bSLCO] WITH NOCHECK ADD CONSTRAINT [CK_bSLCO_AuditCoParams] CHECK (([AuditCoParams]='Y' OR [AuditCoParams]='N'))
GO
ALTER TABLE [dbo].[bSLCO] WITH NOCHECK ADD CONSTRAINT [CK_bSLCO_AuditSLCompliance] CHECK (([AuditSLCompliance]='Y' OR [AuditSLCompliance]='N'))
GO
ALTER TABLE [dbo].[bSLCO] WITH NOCHECK ADD CONSTRAINT [CK_bSLCO_AuditSLs] CHECK (([AuditSLs]='Y' OR [AuditSLs]='N'))
GO
ALTER TABLE [dbo].[bSLCO] WITH NOCHECK ADD CONSTRAINT [CK_bSLCO_CmtdDetailToJC] CHECK (([CmtdDetailToJC]='Y' OR [CmtdDetailToJC]='N'))
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bSLCO] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biSLCO] ON [dbo].[bSLCO] ([SLCo]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
