...
GO
ALTER TABLE [dbo].[bPMPI] WITH NOCHECK ADD CONSTRAINT [CK_bPMPI_BillableYN] CHECK (([BillableYN]='Y' OR [BillableYN]='N'))
GO
...
GO
ALTER TABLE [dbo].[bPMPI] WITH NOCHECK ADD CONSTRAINT [FK_bPMPI_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
...
GO
ALTER TABLE [dbo].[bPMPI] NOCHECK CONSTRAINT [FK_bPMPI_bJCJM]
GO
ALTER TABLE [dbo].[bPMPI] NOCHECK CONSTRAINT [FK_bPMPI_bPMPL]
GO
ALTER TABLE [dbo].[bPMPI] NOCHECK CONSTRAINT [FK_bPMPI_bPMPU]
GO
ALTER TABLE [dbo].[bPMPI] NOCHECK CONSTRAINT [FK_bPMPI_bPMFM_BillableFirm]
GO
ALTER TABLE [dbo].[bPMPI] NOCHECK CONSTRAINT [FK_bPMPI_bPMFM_ResponsibleFirm]
GO
