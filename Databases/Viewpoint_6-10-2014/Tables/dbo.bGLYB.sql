...
GO
ALTER TABLE [dbo].[bGLYB] WITH NOCHECK ADD CONSTRAINT [FK_bGLYB_bGLFY_GLCoFYEMO] FOREIGN KEY ([GLCo], [FYEMO]) REFERENCES [dbo].[bGLFY] ([GLCo], [FYEMO])
GO
ALTER TABLE [dbo].[bGLYB] NOCHECK CONSTRAINT [FK_bGLYB_bGLFY_GLCoFYEMO]
GO
