...
GO
ALTER TABLE [dbo].[bJCPC] WITH NOCHECK ADD CONSTRAINT [CK_bJCPC_ItemUnitFlag] CHECK (([ItemUnitFlag]='Y' OR [ItemUnitFlag]='N'))
GO
ALTER TABLE [dbo].[bJCPC] WITH NOCHECK ADD CONSTRAINT [CK_bJCPC_PhaseUnitFlag] CHECK (([PhaseUnitFlag]='Y' OR [PhaseUnitFlag]='N'))
GO
CREATE UNIQUE CLUSTERED INDEX [biJCPC] ON [dbo].[bJCPC] ([PhaseGroup], [Phase], [CostType]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
