...
GO
ALTER TABLE [dbo].[bINMT] WITH NOCHECK ADD CONSTRAINT [CK_bINMT_Active] CHECK (([Active]='Y' OR [Active]='N'))
GO
ALTER TABLE [dbo].[bINMT] WITH NOCHECK ADD CONSTRAINT [CK_bINMT_AllowNegWarnMSTickets] CHECK (([AllowNegWarnMSTickets]='N' OR [AllowNegWarnMSTickets]='Y'))
GO
ALTER TABLE [dbo].[bINMT] WITH NOCHECK ADD CONSTRAINT [CK_bINMT_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
GO
ALTER TABLE [dbo].[bINMT] WITH NOCHECK ADD CONSTRAINT [CK_bINMT_AutoProd] CHECK (([AutoProd]='Y' OR [AutoProd]='N'))
GO
ALTER TABLE [dbo].[bINMT] WITH NOCHECK ADD CONSTRAINT [CK_bINMT_AvgECM] CHECK (([AvgECM]='M' OR [AvgECM]='C' OR [AvgECM]='E'))
GO
ALTER TABLE [dbo].[bINMT] WITH NOCHECK ADD CONSTRAINT [CK_bINMT_GLProdUnits] CHECK (([GLProdUnits]='Y' OR [GLProdUnits]='N'))
GO
ALTER TABLE [dbo].[bINMT] WITH NOCHECK ADD CONSTRAINT [CK_bINMT_GLSaleUnits] CHECK (([GLSaleUnits]='Y' OR [GLSaleUnits]='N'))
GO
ALTER TABLE [dbo].[bINMT] WITH NOCHECK ADD CONSTRAINT [CK_bINMT_LastECM] CHECK (([LastECM]='M' OR [LastECM]='C' OR [LastECM]='E'))
GO
ALTER TABLE [dbo].[bINMT] WITH NOCHECK ADD CONSTRAINT [CK_bINMT_PriceECM] CHECK (([PriceECM]='M' OR [PriceECM]='C' OR [PriceECM]='E'))
GO
ALTER TABLE [dbo].[bINMT] WITH NOCHECK ADD CONSTRAINT [CK_bINMT_StdECM] CHECK (([StdECM]='M' OR [StdECM]='C' OR [StdECM]='E'))
GO
