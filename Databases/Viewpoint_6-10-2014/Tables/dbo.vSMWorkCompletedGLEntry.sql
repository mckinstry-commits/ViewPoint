...
GO
ALTER TABLE [dbo].[vSMWorkCompletedGLEntry] NOCHECK CONSTRAINT [FK_vSMWorkCompletedGLEntry_vGLEntry]
GO
ALTER TABLE [dbo].[vSMWorkCompletedGLEntry] NOCHECK CONSTRAINT [FK_vSMWorkCompletedGLEntry_vGLEntryTransaction]
GO
ALTER TABLE [dbo].[vSMWorkCompletedGLEntry] NOCHECK CONSTRAINT [FK_vSMWorkCompletedGLEntry_vSMWorkCompleted]
GO
