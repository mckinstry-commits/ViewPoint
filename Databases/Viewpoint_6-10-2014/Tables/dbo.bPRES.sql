...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRES] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRES] ON [dbo].[bPRES] ([PRCo], [EarnCode], [SubjEarnCode]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
