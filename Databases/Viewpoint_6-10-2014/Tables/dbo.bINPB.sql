...
GO
ALTER TABLE [dbo].[bINPB] WITH NOCHECK ADD CONSTRAINT [CK_bINPB_ECM] CHECK (([ECM]='M' OR [ECM]='C' OR [ECM]='E'))
GO
CREATE UNIQUE CLUSTERED INDEX [biINPB] ON [dbo].[bINPB] ([Co], [Mth], [BatchId], [BatchSeq]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINPB] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
