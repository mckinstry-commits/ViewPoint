...
[ProjMinPct] [dbo].[bPct] NULL CONSTRAINT [DF_bJCJP_ProjMinPct] DEFAULT ((0)),
[ActiveYN] [dbo].[bYN] NOT NULL CONSTRAINT [DF_bJCJP_ActiveYN] DEFAULT ('Y'),
...
GO
ALTER TABLE [dbo].[bJCJP] WITH NOCHECK ADD CONSTRAINT [CK_bJCJP_ActiveYN] CHECK (([ActiveYN]='Y' OR [ActiveYN]='N'))
GO
CREATE NONCLUSTERED INDEX [biJCJPContract] ON [dbo].[bJCJP] ([JCCo], [Contract], [Item], [Job]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biJCJP] ON [dbo].[bJCJP] ([JCCo], [Job], [PhaseGroup], [Phase]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCJP] ([KeyID]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
