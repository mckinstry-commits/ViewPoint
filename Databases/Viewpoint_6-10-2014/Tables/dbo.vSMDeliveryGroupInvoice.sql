...
GO
ALTER TABLE [dbo].[vSMDeliveryGroupInvoice] NOCHECK CONSTRAINT [FK_vSMDeliveryGroupInvoice_vSMDeliveryGroup]
GO
ALTER TABLE [dbo].[vSMDeliveryGroupInvoice] NOCHECK CONSTRAINT [FK_vSMDeliveryGroupInvoice_vSMDeliveryReport]
GO
ALTER TABLE [dbo].[vSMDeliveryGroupInvoice] NOCHECK CONSTRAINT [FK_vSMDeliveryGroupInvoice_vSMInvoice]
GO
