 ...
 *				SCOTTP 05/03/2014 TFS-13563 Remove code that uses PMRD. Distribution is now managed via the form or C&S Form
 *
 *--------------------------------------------------------------*/
...
GO
ALTER TABLE [dbo].[bPMRI] ADD CONSTRAINT [PK_bPMRI] PRIMARY KEY CLUSTERED  ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[bPMRI] NOCHECK CONSTRAINT [FK_bPMRI_bJCJM]
GO
ALTER TABLE [dbo].[bPMRI] NOCHECK CONSTRAINT [FK_bPMRI_bPMDT]
GO
ALTER TABLE [dbo].[bPMRI] NOCHECK CONSTRAINT [FK_bPMRI_bPMSC]
GO
ALTER TABLE [dbo].[bPMRI] NOCHECK CONSTRAINT [FK_bPMRI_bPMFM_ReqFirm]
GO
ALTER TABLE [dbo].[bPMRI] NOCHECK CONSTRAINT [FK_bPMRI_bPMPM_ReqContact]
GO
ALTER TABLE [dbo].[bPMRI] NOCHECK CONSTRAINT [FK_bPMRI_bPMFM_RespondFirm]
GO
ALTER TABLE [dbo].[bPMRI] NOCHECK CONSTRAINT [FK_bPMRI_bPMPM_RespondContact]
GO
ALTER TABLE [dbo].[bPMRI] NOCHECK CONSTRAINT [FK_bPMRI_bPMPM_ResponsiblePerson]
GO
