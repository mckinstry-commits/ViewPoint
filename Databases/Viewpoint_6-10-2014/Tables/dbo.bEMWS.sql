...
GO
ALTER TABLE [dbo].[bEMWS] WITH NOCHECK ADD CONSTRAINT [CK_bEMWS_StatusType] CHECK (([StatusType]='N' OR [StatusType]='F' OR [StatusType]='B'))
GO
...
GO
ALTER TABLE [dbo].[bEMWS] WITH NOCHECK ADD CONSTRAINT [FK_bEMWS_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMWS] NOCHECK CONSTRAINT [FK_bEMWS_bHQGP_EMGroup]
GO
