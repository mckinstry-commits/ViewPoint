...
GO
ALTER TABLE [dbo].[bSLCT] WITH NOCHECK ADD CONSTRAINT [CK_bSLCT_Complied] CHECK (([Complied]='Y' OR [Complied]='N' OR [Complied] IS NULL))
GO
ALTER TABLE [dbo].[bSLCT] WITH NOCHECK ADD CONSTRAINT [CK_bSLCT_PurgeYN] CHECK (([PurgeYN]='Y' OR [PurgeYN]='N'))
GO
ALTER TABLE [dbo].[bSLCT] WITH NOCHECK ADD CONSTRAINT [CK_bSLCT_Verify] CHECK (([Verify]='Y' OR [Verify]='N'))
GO
