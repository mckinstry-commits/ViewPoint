...
GO
ALTER TABLE [dbo].[bAPUI] WITH NOCHECK ADD CONSTRAINT [CK_bAPUI_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000) OR [CMAcct] IS NULL))
GO
ALTER TABLE [dbo].[bAPUI] WITH NOCHECK ADD CONSTRAINT [CK_bAPUI_PayOverrideYN] CHECK (([PayOverrideYN]='Y' OR [PayOverrideYN]='N'))
GO
ALTER TABLE [dbo].[bAPUI] WITH NOCHECK ADD CONSTRAINT [CK_bAPUI_SeparatePayYN] CHECK (([SeparatePayYN]='Y' OR [SeparatePayYN]='N'))
GO
ALTER TABLE [dbo].[bAPUI] WITH NOCHECK ADD CONSTRAINT [CK_bAPUI_V1099YN] CHECK (([V1099YN]='Y' OR [V1099YN]='N'))
GO
