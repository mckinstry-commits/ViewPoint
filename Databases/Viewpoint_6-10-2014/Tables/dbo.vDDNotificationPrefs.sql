...
GO
ALTER TABLE [dbo].[vDDNotificationPrefs] ADD CONSTRAINT [PK_vDDNotificationPrefs] PRIMARY KEY CLUSTERED  ([VPUserName], [Source], [Destination]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
ALTER TABLE [dbo].[vDDNotificationPrefs] WITH NOCHECK ADD CONSTRAINT [FK_vDDUP_vDDNP] FOREIGN KEY ([VPUserName]) REFERENCES [dbo].[vDDUP] ([VPUserName])
GO
ALTER TABLE [dbo].[vDDNotificationPrefs] NOCHECK CONSTRAINT [FK_vDDUP_vDDNP]
GO
