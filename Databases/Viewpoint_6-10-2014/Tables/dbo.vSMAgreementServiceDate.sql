...
GO
ALTER TABLE [dbo].[vSMAgreementServiceDate] NOCHECK CONSTRAINT [FK_vSMAgreementServiceDate_vSMAgreementService]
GO
ALTER TABLE [dbo].[vSMAgreementServiceDate] NOCHECK CONSTRAINT [FK_vSMAgreementServiceDate_vSMWorkOrderScope]
GO
