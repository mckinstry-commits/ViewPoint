...
GO
ALTER TABLE [dbo].[bPOCD] WITH NOCHECK ADD CONSTRAINT [CK_bPOCD_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
GO
ALTER TABLE [dbo].[bPOCD] WITH NOCHECK ADD CONSTRAINT [CK_bPOCD_PurgeYN] CHECK (([PurgeYN]='Y' OR [PurgeYN]='N'))
GO
