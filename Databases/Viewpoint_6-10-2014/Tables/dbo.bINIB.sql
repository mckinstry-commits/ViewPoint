...
GO
ALTER TABLE [dbo].[bINIB] WITH NOCHECK ADD CONSTRAINT [CK_bINIB_ECM] CHECK (([ECM]='M' OR [ECM]='C' OR [ECM]='E'))
GO
ALTER TABLE [dbo].[bINIB] WITH NOCHECK ADD CONSTRAINT [CK_bINIB_OldECM] CHECK (([OldECM]='M' OR [OldECM]='C' OR [OldECM]='E' OR [OldECM] IS NULL))
GO
CREATE UNIQUE CLUSTERED INDEX [biINIB] ON [dbo].[bINIB] ([Co], [Mth], [BatchId], [BatchSeq], [MOItem]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
