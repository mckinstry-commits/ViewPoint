...
GO
ALTER TABLE [dbo].[vSMWorkCompletedMisc] NOCHECK CONSTRAINT [FK_vSMWorkCompletedMisc_bJCCT]
GO
ALTER TABLE [dbo].[vSMWorkCompletedMisc] NOCHECK CONSTRAINT [FK_vSMWorkCompletedMisc_vSMWorkCompleted]
GO
ALTER TABLE [dbo].[vSMWorkCompletedMisc] NOCHECK CONSTRAINT [FK_vSMWorkCompletedMisc_vSMWorkCompletedDetail]
GO
