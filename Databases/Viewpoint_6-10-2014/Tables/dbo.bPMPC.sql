...
GO
ALTER TABLE [dbo].[bPMPC] WITH NOCHECK ADD CONSTRAINT [CK_bPMPC_RoundAmount] CHECK (([RoundAmount]='Y' OR [RoundAmount]='N'))
GO
...
GO
ALTER TABLE [dbo].[bPMPC] NOCHECK CONSTRAINT [FK_bPMPC_bJCCT]
GO
ALTER TABLE [dbo].[bPMPC] NOCHECK CONSTRAINT [FK_bPMPC_bJCJM]
GO
