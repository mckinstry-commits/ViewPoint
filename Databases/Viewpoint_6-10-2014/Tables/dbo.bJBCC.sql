...
GO
ALTER TABLE [dbo].[bJBCC] WITH NOCHECK ADD CONSTRAINT [CK_bJBCC_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
GO
ALTER TABLE [dbo].[bJBCC] WITH NOCHECK ADD CONSTRAINT [CK_bJBCC_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
