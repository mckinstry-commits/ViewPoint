...
GO
ALTER TABLE [dbo].[vSMTechnician] WITH NOCHECK ADD CONSTRAINT [FK_vSMTechnician_bPREH] FOREIGN KEY ([PRCo], [Employee]) REFERENCES [dbo].[bPREH] ([PRCo], [Employee])
GO
...
GO
ALTER TABLE [dbo].[vSMTechnician] NOCHECK CONSTRAINT [FK_vSMTechnician_bINLM]
GO
ALTER TABLE [dbo].[vSMTechnician] NOCHECK CONSTRAINT [FK_vSMTechnician_bPREH]
GO
ALTER TABLE [dbo].[vSMTechnician] NOCHECK CONSTRAINT [FK_vSMTechnician_vSMCO]
GO
