...
GO
ALTER TABLE [dbo].[bAPHB] WITH NOCHECK ADD CONSTRAINT [CK_bAPHB_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000) OR [CMAcct] IS NULL))
GO
ALTER TABLE [dbo].[bAPHB] WITH NOCHECK ADD CONSTRAINT [CK_bAPHB_ChkRev] CHECK (([ChkRev]='Y' OR [ChkRev]='N'))
GO
ALTER TABLE [dbo].[bAPHB] WITH NOCHECK ADD CONSTRAINT [CK_bAPHB_Old1099YN] CHECK (([Old1099YN]='Y' OR [Old1099YN]='N' OR [Old1099YN] IS NULL))
GO
ALTER TABLE [dbo].[bAPHB] WITH NOCHECK ADD CONSTRAINT [CK_bAPHB_OldCMAcct] CHECK (([OldCMAcct]>(0) AND [OldCMAcct]<(10000) OR [OldCMAcct] IS NULL))
GO
ALTER TABLE [dbo].[bAPHB] WITH NOCHECK ADD CONSTRAINT [CK_bAPHB_OldPayOverrideYN] CHECK (([OldPayOverrideYN]='Y' OR [OldPayOverrideYN]='N' OR [OldPayOverrideYN] IS NULL))
GO
ALTER TABLE [dbo].[bAPHB] WITH NOCHECK ADD CONSTRAINT [CK_bAPHB_OldPrePaidProcYN] CHECK (([OldPrePaidProcYN]='Y' OR [OldPrePaidProcYN]='N' OR [OldPrePaidProcYN] IS NULL))
GO
ALTER TABLE [dbo].[bAPHB] WITH NOCHECK ADD CONSTRAINT [CK_bAPHB_OldPrePaidYN] CHECK (([OldPrePaidYN]='Y' OR [OldPrePaidYN]='N' OR [OldPrePaidYN] IS NULL))
GO
ALTER TABLE [dbo].[bAPHB] WITH NOCHECK ADD CONSTRAINT [CK_bAPHB_OldSeparatePayYN] CHECK (([OldSeparatePayYN]='Y' OR [OldSeparatePayYN]='N' OR [OldSeparatePayYN] IS NULL))
GO
ALTER TABLE [dbo].[bAPHB] WITH NOCHECK ADD CONSTRAINT [CK_bAPHB_PaidYN] CHECK (([PaidYN]='Y' OR [PaidYN]='N'))
GO
ALTER TABLE [dbo].[bAPHB] WITH NOCHECK ADD CONSTRAINT [CK_bAPHB_PayOverrideYN] CHECK (([PayOverrideYN]='Y' OR [PayOverrideYN]='N'))
GO
ALTER TABLE [dbo].[bAPHB] WITH NOCHECK ADD CONSTRAINT [CK_bAPHB_PrePaidProcYN] CHECK (([PrePaidProcYN]='Y' OR [PrePaidProcYN]='N'))
GO
ALTER TABLE [dbo].[bAPHB] WITH NOCHECK ADD CONSTRAINT [CK_bAPHB_PrePaidYN] CHECK (([PrePaidYN]='Y' OR [PrePaidYN]='N'))
GO
ALTER TABLE [dbo].[bAPHB] WITH NOCHECK ADD CONSTRAINT [CK_bAPHB_SeparatePayYN] CHECK (([SeparatePayYN]='Y' OR [SeparatePayYN]='N'))
GO
ALTER TABLE [dbo].[bAPHB] WITH NOCHECK ADD CONSTRAINT [CK_bAPHB_V1099YN] CHECK (([V1099YN]='Y' OR [V1099YN]='N'))
GO
