...
[SuperWeeklyMin] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPRTC_SuperWeeklyMin] DEFAULT ((0))
...
GO
ALTER TABLE [dbo].[bPRTC] WITH NOCHECK ADD CONSTRAINT [CK_bPRTC_OverCapLimit] CHECK (([OverCapLimit]='Y' OR [OverCapLimit]='N'))
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRTC] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRTC] ON [dbo].[bPRTC] ([PRCo], [Craft], [Class], [Template]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
