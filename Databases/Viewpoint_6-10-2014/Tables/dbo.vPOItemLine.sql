...
*				DAN SO 04/20/2012 TK-14139 - Committed costs for SM PO w/job
*				GF 05/17/2012 TK-14983
*				JVH 4/1/13 TFS-43390 - Consolidated vspSMModifySMPOItemLine logic into vspSMWorkCompletedPurchaseUpdate
*
...
GO
ALTER TABLE [dbo].[vPOItemLine] WITH NOCHECK ADD CONSTRAINT [CK_vPOItemLine_ItemType] CHECK (([ItemType]>(0) AND [ItemType]<(8)))
GO
ALTER TABLE [dbo].[vPOItemLine] WITH NOCHECK ADD CONSTRAINT [CK_vPOItemLine_LineDelete] CHECK (([LineDelete]='N' OR [LineDelete]='Y' OR [LineDelete]='C' OR [LineDelete]='I'))
GO
ALTER TABLE [dbo].[vPOItemLine] WITH NOCHECK ADD CONSTRAINT [CK_vPOItemLine_PurgeYN] CHECK (([PurgeYN]='N' OR [PurgeYN]='Y'))
GO
ALTER TABLE [dbo].[vPOItemLine] WITH NOCHECK ADD CONSTRAINT [CK_vPOItemLine_TaxType] CHECK (([TaxType] IS NULL OR ([TaxType]=(3) OR [TaxType]=(2) OR [TaxType]=(1))))
GO
ALTER TABLE [dbo].[vPOItemLine] ADD CONSTRAINT [PK_vPOItemLine] PRIMARY KEY CLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_vPOItemLine_ItemType] ON [dbo].[vPOItemLine] ([ItemType]) INCLUDE ([PO], [POCo], [SMCo], [SMWorkOrder]) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[vPOItemLine] NOCHECK CONSTRAINT [FK_vPOItemLine_bPOIT_KeyID]
GO
