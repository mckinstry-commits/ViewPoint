...
[udAsteaSiteId] [varchar] (50) COLLATE Latin1_General_BIN NULL
...
GO
ALTER TABLE [dbo].[vSMServiceSite] ADD CONSTRAINT [PK_vSMServiceSite] PRIMARY KEY CLUSTERED  ([SMServiceSiteID]) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[vSMServiceSite] WITH NOCHECK ADD CONSTRAINT [FK_vSMServiceSite_bARCM_BillTo] FOREIGN KEY ([CustGroup], [BillToARCustomer]) REFERENCES [dbo].[bARCM] ([CustGroup], [Customer])
GO
ALTER TABLE [dbo].[vSMServiceSite] WITH NOCHECK ADD CONSTRAINT [FK_vSMServiceSite_bJCJM] FOREIGN KEY ([JCCo], [Job]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
ALTER TABLE [dbo].[vSMServiceSite] WITH NOCHECK ADD CONSTRAINT [FK_vSMServiceSite_vRPRTc] FOREIGN KEY ([ReportID]) REFERENCES [dbo].[vRPRTc] ([ReportID])
GO
ALTER TABLE [dbo].[vSMServiceSite] WITH NOCHECK ADD CONSTRAINT [FK_vSMServiceSite_vSMCO] FOREIGN KEY ([SMCo]) REFERENCES [dbo].[vSMCO] ([SMCo])
GO
ALTER TABLE [dbo].[vSMServiceSite] WITH NOCHECK ADD CONSTRAINT [FK_vSMServiceSite_vSMCustomer] FOREIGN KEY ([SMCo], [CustGroup], [Customer]) REFERENCES [dbo].[vSMCustomer] ([SMCo], [CustGroup], [Customer])
GO
ALTER TABLE [dbo].[vSMServiceSite] WITH NOCHECK ADD CONSTRAINT [FK_vSMServiceSite_vSMServiceCenter] FOREIGN KEY ([SMCo], [DefaultServiceCenter]) REFERENCES [dbo].[vSMServiceCenter] ([SMCo], [ServiceCenter])
GO
ALTER TABLE [dbo].[vSMServiceSite] WITH NOCHECK ADD CONSTRAINT [FK_vSMServiceSite_vSMTechnician] FOREIGN KEY ([SMCo], [PrimaryTechnician]) REFERENCES [dbo].[vSMTechnician] ([SMCo], [Technician])
GO
ALTER TABLE [dbo].[vSMServiceSite] WITH NOCHECK ADD CONSTRAINT [FK_vSMServiceSite_vSMRateTemplate] FOREIGN KEY ([SMCo], [RateTemplate]) REFERENCES [dbo].[vSMRateTemplate] ([SMCo], [RateTemplate])
GO
ALTER TABLE [dbo].[vSMServiceSite] NOCHECK CONSTRAINT [FK_vSMServiceSite_bARCM_BillTo]
GO
ALTER TABLE [dbo].[vSMServiceSite] NOCHECK CONSTRAINT [FK_vSMServiceSite_bJCJM]
GO
ALTER TABLE [dbo].[vSMServiceSite] NOCHECK CONSTRAINT [FK_vSMServiceSite_vRPRTc]
GO
ALTER TABLE [dbo].[vSMServiceSite] NOCHECK CONSTRAINT [FK_vSMServiceSite_vSMCO]
GO
ALTER TABLE [dbo].[vSMServiceSite] NOCHECK CONSTRAINT [FK_vSMServiceSite_vSMCustomer]
GO
ALTER TABLE [dbo].[vSMServiceSite] NOCHECK CONSTRAINT [FK_vSMServiceSite_vSMServiceCenter]
GO
ALTER TABLE [dbo].[vSMServiceSite] NOCHECK CONSTRAINT [FK_vSMServiceSite_vSMTechnician]
GO
ALTER TABLE [dbo].[vSMServiceSite] NOCHECK CONSTRAINT [FK_vSMServiceSite_vSMRateTemplate]
GO
