...
GO
ALTER TABLE [dbo].[vDDCustomActionGroup] NOCHECK CONSTRAINT [FK_vDDCustomActionGroup_vDDCustomActionsTEMP]
GO
ALTER TABLE [dbo].[vDDCustomActionGroup] NOCHECK CONSTRAINT [FK_vDDCustomActionGroup_vDDCustomGroups]
GO
