...
GO
CREATE UNIQUE CLUSTERED INDEX [biPRRB] ON [dbo].[bPRRB] ([PRCo], [PRGroup], [PREndDate], [Mth], [EMCo], [Equipment], [EMGroup], [RevCode], [EMFields], [RevBdownCode], [Employee], [PaySeq], [PostSeq]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
