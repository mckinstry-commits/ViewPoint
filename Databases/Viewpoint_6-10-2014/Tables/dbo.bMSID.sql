...
GO
CREATE UNIQUE CLUSTERED INDEX [biMSID] ON [dbo].[bMSID] ([Co], [Mth], [BatchId], [BatchSeq], [MSTrans]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biMSIDTrans] ON [dbo].[bMSID] ([Co], [Mth], [MSTrans]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSID] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
