...
GO
ALTER TABLE [dbo].[bPOCO] WITH NOCHECK ADD CONSTRAINT [CK_bPOCO_AuditCoParams] CHECK (([AuditCoParams]='Y' OR [AuditCoParams]='N'))
GO
ALTER TABLE [dbo].[bPOCO] WITH NOCHECK ADD CONSTRAINT [CK_bPOCO_AuditPOCompliance] CHECK (([AuditPOCompliance]='Y' OR [AuditPOCompliance]='N'))
GO
ALTER TABLE [dbo].[bPOCO] WITH NOCHECK ADD CONSTRAINT [CK_bPOCO_AuditPOs] CHECK (([AuditPOs]='Y' OR [AuditPOs]='N'))
GO
ALTER TABLE [dbo].[bPOCO] WITH NOCHECK ADD CONSTRAINT [CK_bPOCO_AutoPO] CHECK (([AutoPO]='Y' OR [AutoPO]='N'))
GO
ALTER TABLE [dbo].[bPOCO] WITH NOCHECK ADD CONSTRAINT [CK_bPOCO_CmtdDetailToJC] CHECK (([CmtdDetailToJC]='Y' OR [CmtdDetailToJC]='N'))
GO
ALTER TABLE [dbo].[bPOCO] WITH NOCHECK ADD CONSTRAINT [CK_bPOCO_PayTypeYN] CHECK (([PayTypeYN]='Y' OR [PayTypeYN]='N'))
GO
ALTER TABLE [dbo].[bPOCO] WITH NOCHECK ADD CONSTRAINT [CK_bPOCO_ReceiptUpdate] CHECK (([ReceiptUpdate]='Y' OR [ReceiptUpdate]='N'))
GO
