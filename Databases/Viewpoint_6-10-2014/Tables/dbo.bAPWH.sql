...
ROLLBACK TRANSACTION
GO
ALTER TABLE [dbo].[bAPWH] WITH NOCHECK ADD CONSTRAINT [CK_bAPWH_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000) OR [CMAcct] IS NULL))
GO
ALTER TABLE [dbo].[bAPWH] WITH NOCHECK ADD CONSTRAINT [CK_bAPWH_CompliedYN] CHECK (([CompliedYN]='Y' OR [CompliedYN]='N'))
GO
ALTER TABLE [dbo].[bAPWH] WITH NOCHECK ADD CONSTRAINT [CK_bAPWH_HoldYN] CHECK (([HoldYN]='Y' OR [HoldYN]='N'))
GO
ALTER TABLE [dbo].[bAPWH] WITH NOCHECK ADD CONSTRAINT [CK_bAPWH_ManualAddYN] CHECK (([ManualAddYN]='Y' OR [ManualAddYN]='N'))
GO
ALTER TABLE [dbo].[bAPWH] WITH NOCHECK ADD CONSTRAINT [CK_bAPWH_PayYN] CHECK (([PayYN]='Y' OR [PayYN]='N'))
GO
ALTER TABLE [dbo].[bAPWH] WITH NOCHECK ADD CONSTRAINT [CK_bAPWH_SeparatePayJobYN] CHECK (([SeparatePayJobYN]='Y' OR [SeparatePayJobYN]='N'))
GO
ALTER TABLE [dbo].[bAPWH] WITH NOCHECK ADD CONSTRAINT [CK_bAPWH_SeparatePaySLYN] CHECK (([SeparatePaySLYN]='Y' OR [SeparatePaySLYN]='N'))
GO
ALTER TABLE [dbo].[bAPWH] WITH NOCHECK ADD CONSTRAINT [CK_bAPWH_TakeAllDiscYN] CHECK (([TakeAllDiscYN]='Y' OR [TakeAllDiscYN]='N'))
GO
