...
GO
ALTER TABLE [dbo].[bMSSurcharges] WITH NOCHECK ADD CONSTRAINT [CK_bMSSurcharges_BatchTransType] CHECK (([BatchTransType]='A' OR [BatchTransType]='C' OR [BatchTransType]='D'))
GO
