...
GO
ALTER TABLE [dbo].[vAPAUPayeeTaxPaymentATO] WITH NOCHECK ADD CONSTRAINT [FK_vAPAUPayeeTaxPaymentATO_vAPAUPayerTaxPaymentATO] FOREIGN KEY ([APCo], [TaxYear]) REFERENCES [dbo].[vAPAUPayerTaxPaymentATO] ([APCo], [TaxYear]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[vAPAUPayeeTaxPaymentATO] NOCHECK CONSTRAINT [FK_vAPAUPayeeTaxPaymentATO_vAPAUPayerTaxPaymentATO]
GO
