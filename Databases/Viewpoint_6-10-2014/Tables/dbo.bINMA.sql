...
GO
ALTER TABLE [dbo].[bINMA] WITH NOCHECK ADD CONSTRAINT [CK_bINMA_BeginAvgECM] CHECK (([BeginAvgECM]='M' OR [BeginAvgECM]='C' OR [BeginAvgECM]='E'))
GO
ALTER TABLE [dbo].[bINMA] WITH NOCHECK ADD CONSTRAINT [CK_bINMA_BeginLastECM] CHECK (([BeginLastECM]='M' OR [BeginLastECM]='C' OR [BeginLastECM]='E'))
GO
ALTER TABLE [dbo].[bINMA] WITH NOCHECK ADD CONSTRAINT [CK_bINMA_BeginStdECM] CHECK (([BeginStdECM]='M' OR [BeginStdECM]='C' OR [BeginStdECM]='E'))
GO
ALTER TABLE [dbo].[bINMA] WITH NOCHECK ADD CONSTRAINT [CK_bINMA_EndAvgECM] CHECK (([EndAvgECM]='M' OR [EndAvgECM]='C' OR [EndAvgECM]='E'))
GO
ALTER TABLE [dbo].[bINMA] WITH NOCHECK ADD CONSTRAINT [CK_bINMA_EndLastECM] CHECK (([EndLastECM]='M' OR [EndLastECM]='C' OR [EndLastECM]='E'))
GO
ALTER TABLE [dbo].[bINMA] WITH NOCHECK ADD CONSTRAINT [CK_bINMA_EndStdECM] CHECK (([EndStdECM]='M' OR [EndStdECM]='C' OR [EndStdECM]='E'))
GO
CREATE UNIQUE CLUSTERED INDEX [biINMA] ON [dbo].[bINMA] ([INCo], [Loc], [MatlGroup], [Material], [Mth]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biINMAINCoMth] ON [dbo].[bINMA] ([INCo], [Mth]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINMA] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
