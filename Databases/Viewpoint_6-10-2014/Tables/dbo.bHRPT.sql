...
GO
ALTER TABLE [dbo].[bHRPT] WITH NOCHECK ADD CONSTRAINT [CK_bHRPT_RequiredYN] CHECK (([RequiredYN]='Y' OR [RequiredYN]='N'))
GO
CREATE UNIQUE CLUSTERED INDEX [biHRPT] ON [dbo].[bHRPT] ([HRCo], [PositionCode], [TrainCode]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRPT] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
