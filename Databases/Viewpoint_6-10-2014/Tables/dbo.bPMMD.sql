...
GO
ALTER TABLE [dbo].[bPMMD] WITH NOCHECK ADD CONSTRAINT [CK_bPMMD_CC] CHECK (([CC]='C' OR [CC]='B' OR [CC]='N'))
GO
ALTER TABLE [dbo].[bPMMD] WITH NOCHECK ADD CONSTRAINT [CK_bPMMD_PresentYN] CHECK (([PresentYN]='Y' OR [PresentYN]='N'))
GO
...
GO
ALTER TABLE [dbo].[bPMMD] WITH NOCHECK ADD CONSTRAINT [FK_bPMMD_bPMDT] FOREIGN KEY ([MeetingType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
ALTER TABLE [dbo].[bPMMD] WITH NOCHECK ADD CONSTRAINT [FK_bPMMD_bPMMM] FOREIGN KEY ([PMCo], [Project], [MeetingType], [Meeting], [MinutesType]) REFERENCES [dbo].[bPMMM] ([PMCo], [Project], [MeetingType], [Meeting], [MinutesType]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[bPMMD] WITH NOCHECK ADD CONSTRAINT [FK_bPMMD_bPMPM] FOREIGN KEY ([VendorGroup], [FirmNumber], [ContactCode]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
GO
ALTER TABLE [dbo].[bPMMD] NOCHECK CONSTRAINT [FK_bPMMD_bPMDT]
GO
ALTER TABLE [dbo].[bPMMD] NOCHECK CONSTRAINT [FK_bPMMD_bPMMM]
GO
ALTER TABLE [dbo].[bPMMD] NOCHECK CONSTRAINT [FK_bPMMD_bPMPM]
GO
