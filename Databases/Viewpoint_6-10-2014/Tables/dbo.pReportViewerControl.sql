...
GO
ALTER TABLE [dbo].[pReportViewerControl] WITH NOCHECK ADD CONSTRAINT [FK_pReportViewerControl_pPageSiteControls] FOREIGN KEY ([PageSiteControlID]) REFERENCES [dbo].[pPageSiteControls] ([PageSiteControlID]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[pReportViewerControl] WITH NOCHECK ADD CONSTRAINT [FK_pReportViewerControl_pSites] FOREIGN KEY ([SiteID]) REFERENCES [dbo].[pSites] ([SiteID])
GO
ALTER TABLE [dbo].[pReportViewerControl] NOCHECK CONSTRAINT [FK_pReportViewerControl_pPageSiteControls]
GO
ALTER TABLE [dbo].[pReportViewerControl] NOCHECK CONSTRAINT [FK_pReportViewerControl_pSites]
GO
