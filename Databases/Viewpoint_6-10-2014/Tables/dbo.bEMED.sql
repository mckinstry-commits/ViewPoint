...
GO
ALTER TABLE [dbo].[bEMED] WITH NOCHECK ADD CONSTRAINT [FK_bEMED_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMED] NOCHECK CONSTRAINT [FK_bEMED_bEMCO_EMCo]
GO
