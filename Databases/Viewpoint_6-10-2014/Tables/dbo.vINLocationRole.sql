...
GO
ALTER TABLE [dbo].[vINLocationRole] NOCHECK CONSTRAINT [FK_vINLocationRole_bINLM]
GO
ALTER TABLE [dbo].[vINLocationRole] NOCHECK CONSTRAINT [FK_vINLocationRole_vHQRoles]
GO
