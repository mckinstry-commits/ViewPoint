...
GO
ALTER TABLE [dbo].[bEMDE] WITH NOCHECK ADD CONSTRAINT [FK_bEMDE_bEMDM_Department] FOREIGN KEY ([EMCo], [Department]) REFERENCES [dbo].[bEMDM] ([EMCo], [Department])
GO
ALTER TABLE [dbo].[bEMDE] NOCHECK CONSTRAINT [FK_bEMDE_bEMDM_Department]
GO
