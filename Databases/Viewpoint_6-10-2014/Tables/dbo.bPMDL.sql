...
GO
ALTER TABLE [dbo].[bPMDL] WITH NOCHECK ADD CONSTRAINT [CK_bPMDL_AccidentsYN] CHECK (([AccidentsYN]='Y' OR [AccidentsYN]='N'))
GO
ALTER TABLE [dbo].[bPMDL] WITH NOCHECK ADD CONSTRAINT [CK_bPMDL_ActivityYN] CHECK (([ActivityYN]='Y' OR [ActivityYN]='N'))
GO
ALTER TABLE [dbo].[bPMDL] WITH NOCHECK ADD CONSTRAINT [CK_bPMDL_ConversationsYN] CHECK (([ConversationsYN]='Y' OR [ConversationsYN]='N'))
GO
ALTER TABLE [dbo].[bPMDL] WITH NOCHECK ADD CONSTRAINT [CK_bPMDL_CrewYN] CHECK (([CrewYN]='Y' OR [CrewYN]='N'))
GO
ALTER TABLE [dbo].[bPMDL] WITH NOCHECK ADD CONSTRAINT [CK_bPMDL_DeliveriesYN] CHECK (([DeliveriesYN]='Y' OR [DeliveriesYN]='N'))
GO
ALTER TABLE [dbo].[bPMDL] WITH NOCHECK ADD CONSTRAINT [CK_bPMDL_EmployeeYN] CHECK (([EmployeeYN]='Y' OR [EmployeeYN]='N'))
GO
ALTER TABLE [dbo].[bPMDL] WITH NOCHECK ADD CONSTRAINT [CK_bPMDL_EquipmentYN] CHECK (([EquipmentYN]='Y' OR [EquipmentYN]='N'))
GO
ALTER TABLE [dbo].[bPMDL] WITH NOCHECK ADD CONSTRAINT [CK_bPMDL_SubcontractYN] CHECK (([SubcontractYN]='Y' OR [SubcontractYN]='N'))
GO
ALTER TABLE [dbo].[bPMDL] WITH NOCHECK ADD CONSTRAINT [CK_bPMDL_VisitorsYN] CHECK (([VisitorsYN]='Y' OR [VisitorsYN]='N'))
GO
...
GO
ALTER TABLE [dbo].[bPMDL] WITH NOCHECK ADD CONSTRAINT [FK_bPMDL_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
ALTER TABLE [dbo].[bPMDL] WITH NOCHECK ADD CONSTRAINT [FK_bPMDL_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
ALTER TABLE [dbo].[bPMDL] NOCHECK CONSTRAINT [FK_bPMDL_bPMDT]
GO
ALTER TABLE [dbo].[bPMDL] NOCHECK CONSTRAINT [FK_bPMDL_bJCJM]
GO
