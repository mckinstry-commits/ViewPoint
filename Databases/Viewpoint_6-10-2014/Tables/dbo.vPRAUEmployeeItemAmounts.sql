...
GO
ALTER TABLE [dbo].[vPRAUEmployeeItemAmounts] NOCHECK CONSTRAINT [FK_vPRAUItems_vPRAUEmployeeItemAmounts_ItemCode]
GO
ALTER TABLE [dbo].[vPRAUEmployeeItemAmounts] NOCHECK CONSTRAINT [FK_vPRAUEmployees_vPRAUEmployeeItemAmounts_PRCo_TaxYear_Employee]
GO
