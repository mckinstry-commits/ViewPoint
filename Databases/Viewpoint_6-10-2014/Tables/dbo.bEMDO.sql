...
GO
ALTER TABLE [dbo].[bEMDO] WITH NOCHECK ADD CONSTRAINT [CK_bEMDO_ExcludePR] CHECK (([ExcludePR]='N' OR [ExcludePR]='Y'))
GO
...
GO
ALTER TABLE [dbo].[bEMDO] WITH NOCHECK ADD CONSTRAINT [FK_bEMDO_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMDO] WITH NOCHECK ADD CONSTRAINT [FK_bEMDO_bEMDM_Department] FOREIGN KEY ([EMCo], [Department]) REFERENCES [dbo].[bEMDM] ([EMCo], [Department])
GO
ALTER TABLE [dbo].[bEMDO] WITH NOCHECK ADD CONSTRAINT [FK_bEMDO_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMDO] WITH NOCHECK ADD CONSTRAINT [FK_bEMDO_bEMCC_CostCode] FOREIGN KEY ([EMGroup], [CostCode]) REFERENCES [dbo].[bEMCC] ([EMGroup], [CostCode])
GO
ALTER TABLE [dbo].[bEMDO] NOCHECK CONSTRAINT [FK_bEMDO_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMDO] NOCHECK CONSTRAINT [FK_bEMDO_bEMDM_Department]
GO
ALTER TABLE [dbo].[bEMDO] NOCHECK CONSTRAINT [FK_bEMDO_bHQGP_EMGroup]
GO
ALTER TABLE [dbo].[bEMDO] NOCHECK CONSTRAINT [FK_bEMDO_bEMCC_CostCode]
GO
