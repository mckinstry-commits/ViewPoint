...
GO
ALTER TABLE [dbo].[bPMCO] ADD CONSTRAINT [PK_bPMCO] PRIMARY KEY CLUSTERED  ([PMCo]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[bPMCO] NOCHECK CONSTRAINT [FK_bPMCO_bJCCT_MtlCostType]
GO
ALTER TABLE [dbo].[bPMCO] NOCHECK CONSTRAINT [FK_bPMCO_bJCCT_SLCostType]
GO
ALTER TABLE [dbo].[bPMCO] NOCHECK CONSTRAINT [FK_bPMCO_bJCCT_SLCostType2]
GO
ALTER TABLE [dbo].[bPMCO] NOCHECK CONSTRAINT [FK_bPMCO_bHQCO]
GO
ALTER TABLE [dbo].[bPMCO] NOCHECK CONSTRAINT [FK_bPMCO_bJCCO]
GO
ALTER TABLE [dbo].[bPMCO] NOCHECK CONSTRAINT [FK_bPMCO_bPMFM]
GO
