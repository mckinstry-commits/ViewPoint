...
GO
ALTER TABLE [dbo].[bEMSM] WITH NOCHECK ADD CONSTRAINT [FK_bEMSM_bEMEM_Equipment] FOREIGN KEY ([Co], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[bEMSM] NOCHECK CONSTRAINT [FK_bEMSM_bEMEM_Equipment]
GO
