...
GO
ALTER TABLE [dbo].[bPRDB] WITH NOCHECK ADD CONSTRAINT [CK_bPRDB_SubjectOnly] CHECK (([SubjectOnly]='Y' OR [SubjectOnly]='N'))
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRDB] ([KeyID]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [IX_bPRDB_EDL] ON [dbo].[bPRDB] ([PRCo], [DLCode], [EDLType], [EDLCode]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
