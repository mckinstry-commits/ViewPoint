...
[OrigUnitCost] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPOIB_OrigUnitCost] DEFAULT ((0)),
[OrigECM] [dbo].[bECM] NULL,
[OrigCost] [dbo].[bDollar] NOT NULL,
[OrigTax] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPOIB_OrigTax] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[bPOIB] WITH NOCHECK ADD CONSTRAINT [CK_bPOIB_OldOrigECM] CHECK (([OldOrigECM]='E' OR [OldOrigECM]='C' OR [OldOrigECM]='M' OR [OldOrigECM] IS NULL))
GO
ALTER TABLE [dbo].[bPOIB] WITH NOCHECK ADD CONSTRAINT [CK_bPOIB_OldRecvYN] CHECK (([OldRecvYN]='Y' OR [OldRecvYN]='N' OR [OldRecvYN] IS NULL))
GO
ALTER TABLE [dbo].[bPOIB] WITH NOCHECK ADD CONSTRAINT [CK_bPOIB_OrigECM] CHECK (([OrigECM]='E' OR [OrigECM]='C' OR [OrigECM]='M' OR [OrigECM] IS NULL))
GO
ALTER TABLE [dbo].[bPOIB] WITH NOCHECK ADD CONSTRAINT [CK_bPOIB_RecvYN] CHECK (([RecvYN]='Y' OR [RecvYN]='N'))
GO
...
GO
ALTER TABLE [dbo].[bPOIB] NOCHECK CONSTRAINT [FK_bPOIB_vSMWorkOrderScope]
GO
