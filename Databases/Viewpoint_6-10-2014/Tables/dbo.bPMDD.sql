...
GO
ALTER TABLE [dbo].[bPMDD] WITH NOCHECK ADD CONSTRAINT [FK_bPMDD_bPMPL] FOREIGN KEY ([PMCo], [Project], [Location]) REFERENCES [dbo].[bPMPL] ([PMCo], [Project], [Location])
GO
ALTER TABLE [dbo].[bPMDD] WITH NOCHECK ADD CONSTRAINT [FK_bPMDD_bPMDL] FOREIGN KEY ([PMCo], [Project], [LogDate], [DailyLog]) REFERENCES [dbo].[bPMDL] ([PMCo], [Project], [LogDate], [DailyLog])
GO
ALTER TABLE [dbo].[bPMDD] WITH NOCHECK ADD CONSTRAINT [FK_bPMDD_bPMFM] FOREIGN KEY ([VendorGroup], [FirmNumber]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
GO
ALTER TABLE [dbo].[bPMDD] WITH NOCHECK ADD CONSTRAINT [FK_bPMDD_bPMPM] FOREIGN KEY ([VendorGroup], [FirmNumber], [ContactCode]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
GO
ALTER TABLE [dbo].[bPMDD] NOCHECK CONSTRAINT [FK_bPMDD_bPMPL]
GO
ALTER TABLE [dbo].[bPMDD] NOCHECK CONSTRAINT [FK_bPMDD_bPMDL]
GO
ALTER TABLE [dbo].[bPMDD] NOCHECK CONSTRAINT [FK_bPMDD_bPMFM]
GO
ALTER TABLE [dbo].[bPMDD] NOCHECK CONSTRAINT [FK_bPMDD_bPMPM]
GO
