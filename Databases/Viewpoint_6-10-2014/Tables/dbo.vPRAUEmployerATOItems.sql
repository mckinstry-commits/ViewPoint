...
GO
ALTER TABLE [dbo].[vPRAUEmployerATOItems] NOCHECK CONSTRAINT [FK_vPRAUItems_ItemCode]
GO
ALTER TABLE [dbo].[vPRAUEmployerATOItems] NOCHECK CONSTRAINT [FK_vPRAUEmployer_PRCo_TaxYear]
GO
