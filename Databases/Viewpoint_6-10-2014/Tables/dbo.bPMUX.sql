...
GO
ALTER TABLE [dbo].[bPMUX] WITH NOCHECK ADD CONSTRAINT [CK_bPMUX_CostOnly] CHECK (([CostOnly]='Y' OR [CostOnly]='N'))
GO
...
GO
ALTER TABLE [dbo].[bPMUX] NOCHECK CONSTRAINT [FK_bPMUX_bPMUT]
GO
