...
BEGIN
	...
	IF UPDATE(IsDeleted) AND EXISTS
	(
		SELECT 1
		FROM inserted
...
GO
ALTER TABLE [dbo].[vSMWorkCompleted] WITH NOCHECK ADD CONSTRAINT [CK_vSMWorkCompleted_NonBillable] CHECK (([NonBillable]='Y' OR [NonBillable]='N'))
GO
...
GO
ALTER TABLE [dbo].[vSMWorkCompleted] WITH NOCHECK ADD CONSTRAINT [FK_vSMWorkCompleted_bJCCD_TaxTrans] FOREIGN KEY ([JCCostTaxTrans], [JCMth], [JCCo]) REFERENCES [dbo].[bJCCD] ([CostTrans], [Mth], [JCCo])
GO
ALTER TABLE [dbo].[vSMWorkCompleted] WITH NOCHECK ADD CONSTRAINT [FK_vSMWorkCompleted_bJCCD] FOREIGN KEY ([JCCostTrans], [JCMth], [JCCo]) REFERENCES [dbo].[bJCCD] ([CostTrans], [Mth], [JCCo])
GO
...
GO
ALTER TABLE [dbo].[vSMWorkCompleted] NOCHECK CONSTRAINT [FK_vSMWorkCompleted_vHQDetail]
GO
ALTER TABLE [dbo].[vSMWorkCompleted] NOCHECK CONSTRAINT [FK_vSMWorkCompleted_vSMWorkCompletedJCCostEntry]
GO
ALTER TABLE [dbo].[vSMWorkCompleted] NOCHECK CONSTRAINT [FK_vSMWorkCompleted_bJCCD_TaxTrans]
GO
ALTER TABLE [dbo].[vSMWorkCompleted] NOCHECK CONSTRAINT [FK_vSMWorkCompleted_bJCCD]
GO
ALTER TABLE [dbo].[vSMWorkCompleted] NOCHECK CONSTRAINT [FK_vSMWorkCompleted_vPRLedgerUpdateMonth]
GO
ALTER TABLE [dbo].[vSMWorkCompleted] NOCHECK CONSTRAINT [FK_vSMWorkCompleted_vSMWorkCompletedGLEntryRevenue]
GO
ALTER TABLE [dbo].[vSMWorkCompleted] NOCHECK CONSTRAINT [FK_vSMWorkCompleted_vGLEntryRevenueJCWIP]
GO
ALTER TABLE [dbo].[vSMWorkCompleted] NOCHECK CONSTRAINT [FK_vSMWorkCompleted_vSMWorkCompletedGLEntryRevenueSMWIP]
GO
ALTER TABLE [dbo].[vSMWorkCompleted] NOCHECK CONSTRAINT [FK_vSMWorkCompleted_vSMWorkOrder]
GO
