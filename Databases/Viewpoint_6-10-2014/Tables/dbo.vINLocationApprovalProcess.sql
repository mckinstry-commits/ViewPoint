...
GO
ALTER TABLE [dbo].[vINLocationApprovalProcess] WITH NOCHECK ADD CONSTRAINT [FK_vINLocationApprovalProcess_bINLM_Loc] FOREIGN KEY ([INCo], [Loc]) REFERENCES [dbo].[bINLM] ([INCo], [Loc])
GO
...
GO
ALTER TABLE [dbo].[vINLocationApprovalProcess] NOCHECK CONSTRAINT [FK_vINLocationApprovalProcess_bINLM_Loc]
GO
ALTER TABLE [dbo].[vINLocationApprovalProcess] NOCHECK CONSTRAINT [FK_vINLocationApprovalProcess_vWFProcess_Process]
GO
