...
GO
ALTER TABLE [dbo].[vSMServiceItems] NOCHECK CONSTRAINT [FK_vSMServiceItems_vSMClass]
GO
ALTER TABLE [dbo].[vSMServiceItems] NOCHECK CONSTRAINT [FK_vSMServiceItems_vSMType]
GO
ALTER TABLE [dbo].[vSMServiceItems] NOCHECK CONSTRAINT [FK_vSMServiceItems_vSMServiceSite]
GO
