...
GO
ALTER TABLE [dbo].[vPRCraftMasterAllowance] NOCHECK CONSTRAINT [FK_vPRCraftMasterAllowance_vPRAllowanceTypes]
GO
ALTER TABLE [dbo].[vPRCraftMasterAllowance] NOCHECK CONSTRAINT [FK_vPRCraftMasterAllowance_vPRAllowanceRuleSet]
GO
ALTER TABLE [dbo].[vPRCraftMasterAllowance] NOCHECK CONSTRAINT [FK_vPRCraftMasterAllowance_bPRCM]
GO
