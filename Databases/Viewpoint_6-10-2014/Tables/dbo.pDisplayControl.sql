...
GO
ALTER TABLE [dbo].[pDisplayControl] ADD CONSTRAINT [PK_pDisplayBox] PRIMARY KEY CLUSTERED  ([PageSiteControlID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
ALTER TABLE [dbo].[pDisplayControl] WITH NOCHECK ADD CONSTRAINT [FK_pDisplayControl_pSiteAttachments] FOREIGN KEY ([AttachmentID]) REFERENCES [dbo].[pSiteAttachments] ([SiteAttachmentID])
GO
ALTER TABLE [dbo].[pDisplayControl] WITH NOCHECK ADD CONSTRAINT [FK_pDisplayControl_pPageSiteControls] FOREIGN KEY ([PageSiteControlID]) REFERENCES [dbo].[pPageSiteControls] ([PageSiteControlID]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[pDisplayControl] WITH NOCHECK ADD CONSTRAINT [FK_pDisplayControl_pSites] FOREIGN KEY ([SiteID]) REFERENCES [dbo].[pSites] ([SiteID])
GO
ALTER TABLE [dbo].[pDisplayControl] NOCHECK CONSTRAINT [FK_pDisplayControl_pSiteAttachments]
GO
ALTER TABLE [dbo].[pDisplayControl] NOCHECK CONSTRAINT [FK_pDisplayControl_pPageSiteControls]
GO
ALTER TABLE [dbo].[pDisplayControl] NOCHECK CONSTRAINT [FK_pDisplayControl_pSites]
GO
