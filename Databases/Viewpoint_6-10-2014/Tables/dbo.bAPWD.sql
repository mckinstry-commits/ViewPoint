...
GO
ALTER TABLE [dbo].[bAPWD] WITH NOCHECK ADD CONSTRAINT [CK_bAPWD_HoldYN] CHECK (([HoldYN]='Y' OR [HoldYN]='N'))
GO
ALTER TABLE [dbo].[bAPWD] WITH NOCHECK ADD CONSTRAINT [CK_bAPWD_PayYN] CHECK (([PayYN]='Y' OR [PayYN]='N'))
GO
