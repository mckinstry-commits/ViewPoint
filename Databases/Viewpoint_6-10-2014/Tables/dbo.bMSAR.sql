...
GO
ALTER TABLE [dbo].[bMSAR] WITH NOCHECK ADD CONSTRAINT [CK_bMSAR_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
GO
CREATE UNIQUE CLUSTERED INDEX [biMSAR] ON [dbo].[bMSAR] ([MSCo], [Mth], [BatchId], [BatchSeq], [ARFields], [MSTrans]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
