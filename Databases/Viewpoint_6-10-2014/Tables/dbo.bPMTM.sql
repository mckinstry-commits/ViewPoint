...
GO
ALTER TABLE [dbo].[bPMTM] WITH NOCHECK ADD CONSTRAINT [FK_bPMTM_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
...
GO
ALTER TABLE [dbo].[bPMTM] NOCHECK CONSTRAINT [FK_bPMTM_bPMDT]
GO
ALTER TABLE [dbo].[bPMTM] NOCHECK CONSTRAINT [FK_bPMTM_bJCJM]
GO
ALTER TABLE [dbo].[bPMTM] NOCHECK CONSTRAINT [FK_bPMTM_bPMPM]
GO
