...
GO
ALTER TABLE [dbo].[bEMTD] WITH NOCHECK ADD CONSTRAINT [FK_bEMTD_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMTD] WITH NOCHECK ADD CONSTRAINT [FK_bEMTD_bEMCM_Category] FOREIGN KEY ([EMCo], [Category]) REFERENCES [dbo].[bEMCM] ([EMCo], [Category])
GO
ALTER TABLE [dbo].[bEMTD] WITH NOCHECK ADD CONSTRAINT [FK_bEMTD_bEMTH_RevTemplate] FOREIGN KEY ([EMCo], [RevTemplate]) REFERENCES [dbo].[bEMTH] ([EMCo], [RevTemplate])
GO
ALTER TABLE [dbo].[bEMTD] WITH NOCHECK ADD CONSTRAINT [FK_bEMTD_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMTD] WITH NOCHECK ADD CONSTRAINT [FK_bEMTD_bEMRT_RevBdownCode] FOREIGN KEY ([EMGroup], [RevBdownCode]) REFERENCES [dbo].[bEMRT] ([EMGroup], [RevBdownCode])
GO
ALTER TABLE [dbo].[bEMTD] WITH NOCHECK ADD CONSTRAINT [FK_bEMTD_bEMRC_RevCode] FOREIGN KEY ([EMGroup], [RevCode]) REFERENCES [dbo].[bEMRC] ([EMGroup], [RevCode])
GO
ALTER TABLE [dbo].[bEMTD] NOCHECK CONSTRAINT [FK_bEMTD_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMTD] NOCHECK CONSTRAINT [FK_bEMTD_bEMCM_Category]
GO
ALTER TABLE [dbo].[bEMTD] NOCHECK CONSTRAINT [FK_bEMTD_bEMTH_RevTemplate]
GO
ALTER TABLE [dbo].[bEMTD] NOCHECK CONSTRAINT [FK_bEMTD_bHQGP_EMGroup]
GO
ALTER TABLE [dbo].[bEMTD] NOCHECK CONSTRAINT [FK_bEMTD_bEMRT_RevBdownCode]
GO
ALTER TABLE [dbo].[bEMTD] NOCHECK CONSTRAINT [FK_bEMTD_bEMRC_RevCode]
GO
