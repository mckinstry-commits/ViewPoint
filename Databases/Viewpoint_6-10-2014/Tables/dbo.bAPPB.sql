...
[Overflow] [dbo].[bYN] NOT NULL CONSTRAINT [DF_bAPPB_Overflow] DEFAULT ('N'),
...
GO
ALTER TABLE [dbo].[bAPPB] WITH NOCHECK ADD CONSTRAINT [CK_bAPPB_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000)))
GO
ALTER TABLE [dbo].[bAPPB] WITH NOCHECK ADD CONSTRAINT [CK_bAPPB_Overflow] CHECK (([Overflow]='Y' OR [Overflow]='N'))
GO
ALTER TABLE [dbo].[bAPPB] WITH NOCHECK ADD CONSTRAINT [CK_bAPPB_PayOverrideYN] CHECK (([PayOverrideYN]='Y' OR [PayOverrideYN]='N'))
GO
ALTER TABLE [dbo].[bAPPB] WITH NOCHECK ADD CONSTRAINT [CK_bAPPB_ReuseYN] CHECK (([ReuseYN]='Y' OR [ReuseYN]='N' OR [ReuseYN] IS NULL))
GO
ALTER TABLE [dbo].[bAPPB] WITH NOCHECK ADD CONSTRAINT [CK_bAPPB_SeparatePayYN] CHECK (([SeparatePayYN]='Y' OR [SeparatePayYN]='N'))
GO
ALTER TABLE [dbo].[bAPPB] WITH NOCHECK ADD CONSTRAINT [CK_bAPPB_VoidYN] CHECK (([VoidYN]='Y' OR [VoidYN]='N'))
GO
CREATE NONCLUSTERED INDEX [biAPPBCMRef] ON [dbo].[bAPPB] ([CMRef]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biAPPB] ON [dbo].[bAPPB] ([Co], [Mth], [BatchId], [BatchSeq]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPPB] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPPBVendor] ON [dbo].[bAPPB] ([Vendor]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
