...
GO
ALTER TABLE [dbo].[bEMDR] WITH NOCHECK ADD CONSTRAINT [FK_bEMDR_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
ALTER TABLE [dbo].[bEMDR] WITH NOCHECK ADD CONSTRAINT [FK_bEMDR_bEMDM_Department] FOREIGN KEY ([EMCo], [Department]) REFERENCES [dbo].[bEMDM] ([EMCo], [Department])
GO
ALTER TABLE [dbo].[bEMDR] WITH NOCHECK ADD CONSTRAINT [FK_bEMDR_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
ALTER TABLE [dbo].[bEMDR] WITH NOCHECK ADD CONSTRAINT [FK_bEMDR_bEMRC_RevCode] FOREIGN KEY ([EMGroup], [RevCode]) REFERENCES [dbo].[bEMRC] ([EMGroup], [RevCode])
GO
ALTER TABLE [dbo].[bEMDR] NOCHECK CONSTRAINT [FK_bEMDR_bEMCO_EMCo]
GO
ALTER TABLE [dbo].[bEMDR] NOCHECK CONSTRAINT [FK_bEMDR_bEMDM_Department]
GO
ALTER TABLE [dbo].[bEMDR] NOCHECK CONSTRAINT [FK_bEMDR_bHQGP_EMGroup]
GO
ALTER TABLE [dbo].[bEMDR] NOCHECK CONSTRAINT [FK_bEMDR_bEMRC_RevCode]
GO
