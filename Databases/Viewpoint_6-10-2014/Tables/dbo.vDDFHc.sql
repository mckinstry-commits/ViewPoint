...
GO
ALTER TABLE [dbo].[vDDFHc] WITH NOCHECK ADD CONSTRAINT [CK_vDDFHc_AllowAttachments] CHECK (([AllowAttachments]='Y' OR [AllowAttachments]='N' OR [AllowAttachments] IS NULL))
GO
ALTER TABLE [dbo].[vDDFHc] WITH NOCHECK ADD CONSTRAINT [CK_vDDFHc_ShowOnMenu] CHECK (([ShowOnMenu]='Y' OR [ShowOnMenu]='N' OR [ShowOnMenu] IS NULL))
GO
