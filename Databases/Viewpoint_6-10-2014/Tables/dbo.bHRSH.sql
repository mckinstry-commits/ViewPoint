...
GO
ALTER TABLE [dbo].[bHRSH] WITH NOCHECK ADD CONSTRAINT [CK_bHRSH_CalcYN] CHECK (([CalcYN]='Y' OR [CalcYN]='N'))
GO
ALTER TABLE [dbo].[bHRSH] WITH NOCHECK ADD CONSTRAINT [CK_bHRSH_UpdatedYN] CHECK (([UpdatedYN]='Y' OR [UpdatedYN]='N'))
GO
