...
GRANT SELECT ON  [dbo].[DDQueryableColumns] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDQueryableColumns] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDQueryableColumns] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDQueryableColumns] TO [Viewpoint]
GO
