...
GRANT SELECT ON  [dbo].[JCOITotals] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCOITotals] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCOITotals] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCOITotals] TO [Viewpoint]
GO
