...
GRANT SELECT ON  [dbo].[vrvSMInvoiceListOnlyInvoiced] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvSMInvoiceListOnlyInvoiced] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvSMInvoiceListOnlyInvoiced] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvSMInvoiceListOnlyInvoiced] TO [Viewpoint]
GO
