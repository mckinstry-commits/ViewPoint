...
GRANT SELECT ON  [dbo].[VPCanvasNavigationSettings] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VPCanvasNavigationSettings] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VPCanvasNavigationSettings] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VPCanvasNavigationSettings] TO [Viewpoint]
GO
