...
GRANT SELECT ON  [dbo].[brvPRECConvert] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPRECConvert] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPRECConvert] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPRECConvert] TO [Viewpoint]
GO
