...
GRANT SELECT ON  [dbo].[SLWHInvoiceTotals] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SLWHInvoiceTotals] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SLWHInvoiceTotals] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SLWHInvoiceTotals] TO [Viewpoint]
GO
