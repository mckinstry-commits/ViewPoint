...
GRANT SELECT ON  [dbo].[IMWHImportId] TO [Viewpoint]
GRANT INSERT ON  [dbo].[IMWHImportId] TO [Viewpoint]
GRANT DELETE ON  [dbo].[IMWHImportId] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[IMWHImportId] TO [Viewpoint]
GO
