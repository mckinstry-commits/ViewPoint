...
GRANT SELECT ON  [dbo].[PREHFullName] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PREHFullName] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PREHFullName] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PREHFullName] TO [Viewpoint]
GO
