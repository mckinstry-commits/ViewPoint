...
GRANT SELECT ON  [dbo].[APLBforWO] TO [Viewpoint]
GRANT INSERT ON  [dbo].[APLBforWO] TO [Viewpoint]
GRANT DELETE ON  [dbo].[APLBforWO] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[APLBforWO] TO [Viewpoint]
GO
