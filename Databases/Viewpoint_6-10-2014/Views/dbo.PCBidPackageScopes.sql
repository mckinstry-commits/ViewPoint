...
GRANT SELECT ON  [dbo].[PCBidPackageScopes] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PCBidPackageScopes] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PCBidPackageScopes] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PCBidPackageScopes] TO [Viewpoint]
GO
