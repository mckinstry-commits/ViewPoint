...
GRANT SELECT ON  [dbo].[vrvPRPAYGFBTDateRange] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvPRPAYGFBTDateRange] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvPRPAYGFBTDateRange] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvPRPAYGFBTDateRange] TO [Viewpoint]
GO
