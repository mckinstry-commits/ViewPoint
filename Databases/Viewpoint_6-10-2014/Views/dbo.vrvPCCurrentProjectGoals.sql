...
GRANT SELECT ON  [dbo].[vrvPCCurrentProjectGoals] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvPCCurrentProjectGoals] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvPCCurrentProjectGoals] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvPCCurrentProjectGoals] TO [Viewpoint]
GO
