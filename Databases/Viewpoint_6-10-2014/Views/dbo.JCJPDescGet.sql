...
GRANT SELECT ON  [dbo].[JCJPDescGet] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCJPDescGet] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCJPDescGet] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCJPDescGet] TO [Viewpoint]
GO
