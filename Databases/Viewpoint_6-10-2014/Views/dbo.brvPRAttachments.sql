...
GRANT SELECT ON  [dbo].[brvPRAttachments] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPRAttachments] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPRAttachments] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPRAttachments] TO [Viewpoint]
GO
