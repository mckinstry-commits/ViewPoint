...
GRANT SELECT ON  [dbo].[viDim_CubeDataSecurity] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_CubeDataSecurity] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_CubeDataSecurity] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_CubeDataSecurity] TO [Viewpoint]
GO
