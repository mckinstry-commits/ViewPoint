...
GRANT SELECT ON  [dbo].[brvGLFSPart3] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvGLFSPart3] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvGLFSPart3] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvGLFSPart3] TO [Viewpoint]
GO
