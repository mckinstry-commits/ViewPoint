...
GRANT SELECT ON  [dbo].[INLocationRole] TO [Viewpoint]
GRANT INSERT ON  [dbo].[INLocationRole] TO [Viewpoint]
GRANT DELETE ON  [dbo].[INLocationRole] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[INLocationRole] TO [Viewpoint]
GO
