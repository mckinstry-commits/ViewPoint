...
GRANT SELECT ON  [dbo].[WFSentNotifications] TO [Viewpoint]
GRANT INSERT ON  [dbo].[WFSentNotifications] TO [Viewpoint]
GRANT DELETE ON  [dbo].[WFSentNotifications] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[WFSentNotifications] TO [Viewpoint]
GO
