...
GRANT SELECT ON  [dbo].[DDFSForm] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDFSForm] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDFSForm] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDFSForm] TO [Viewpoint]
GO
