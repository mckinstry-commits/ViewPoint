...
GRANT SELECT ON  [dbo].[SLHDPM] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SLHDPM] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SLHDPM] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SLHDPM] TO [Viewpoint]
GO
