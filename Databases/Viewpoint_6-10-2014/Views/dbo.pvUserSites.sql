...
GRANT SELECT ON  [dbo].[pvUserSites] TO [Viewpoint]
GRANT INSERT ON  [dbo].[pvUserSites] TO [Viewpoint]
GRANT DELETE ON  [dbo].[pvUserSites] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[pvUserSites] TO [Viewpoint]
GO
