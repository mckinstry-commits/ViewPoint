...
CREATE VIEW [dbo].[brvPOCurCostByVendor]      
...
GO
GRANT SELECT ON  [dbo].[brvPOCurCostByVendor] TO [public]
GRANT INSERT ON  [dbo].[brvPOCurCostByVendor] TO [public]
GRANT DELETE ON  [dbo].[brvPOCurCostByVendor] TO [public]
GRANT UPDATE ON  [dbo].[brvPOCurCostByVendor] TO [public]
GRANT SELECT ON  [dbo].[brvPOCurCostByVendor] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPOCurCostByVendor] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPOCurCostByVendor] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPOCurCostByVendor] TO [Viewpoint]
GO
