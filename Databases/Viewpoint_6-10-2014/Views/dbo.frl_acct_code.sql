...
GRANT SELECT ON  [dbo].[frl_acct_code] TO [Viewpoint]
GRANT INSERT ON  [dbo].[frl_acct_code] TO [Viewpoint]
GRANT DELETE ON  [dbo].[frl_acct_code] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[frl_acct_code] TO [Viewpoint]
GO
