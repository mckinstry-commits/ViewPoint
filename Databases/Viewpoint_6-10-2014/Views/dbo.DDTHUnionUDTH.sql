...
GRANT SELECT ON  [dbo].[DDTHUnionUDTH] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDTHUnionUDTH] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDTHUnionUDTH] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDTHUnionUDTH] TO [Viewpoint]
GO
