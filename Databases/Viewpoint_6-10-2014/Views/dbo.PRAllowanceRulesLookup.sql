...
GRANT SELECT ON  [dbo].[PRAllowanceRulesLookup] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PRAllowanceRulesLookup] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PRAllowanceRulesLookup] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PRAllowanceRulesLookup] TO [Viewpoint]
GO
