...
GRANT SELECT ON  [dbo].[VPDisplayTreeItems] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VPDisplayTreeItems] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VPDisplayTreeItems] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VPDisplayTreeItems] TO [Viewpoint]
GO
