...
GRANT SELECT ON  [dbo].[JCJPPM] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCJPPM] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCJPPM] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCJPPM] TO [Viewpoint]
GO
