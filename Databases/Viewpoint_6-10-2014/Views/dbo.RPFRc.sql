...
GRANT SELECT ON  [dbo].[RPFRc] TO [Viewpoint]
GRANT INSERT ON  [dbo].[RPFRc] TO [Viewpoint]
GRANT DELETE ON  [dbo].[RPFRc] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[RPFRc] TO [Viewpoint]
GO
