...
GRANT SELECT ON  [dbo].[brvAPOpenInvoicesByJob] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvAPOpenInvoicesByJob] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvAPOpenInvoicesByJob] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvAPOpenInvoicesByJob] TO [Viewpoint]
GO
