...
GRANT SELECT ON  [dbo].[brvAPAllInvoices] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvAPAllInvoices] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvAPAllInvoices] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvAPAllInvoices] TO [Viewpoint]
GO
