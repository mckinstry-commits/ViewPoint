...
GRANT SELECT ON  [dbo].[frl_attr_value] TO [Viewpoint]
GRANT INSERT ON  [dbo].[frl_attr_value] TO [Viewpoint]
GRANT DELETE ON  [dbo].[frl_attr_value] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[frl_attr_value] TO [Viewpoint]
GO
