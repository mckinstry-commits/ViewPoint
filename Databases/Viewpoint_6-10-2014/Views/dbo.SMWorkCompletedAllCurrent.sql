...
GRANT SELECT ON  [dbo].[SMWorkCompletedAllCurrent] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMWorkCompletedAllCurrent] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMWorkCompletedAllCurrent] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMWorkCompletedAllCurrent] TO [Viewpoint]
GO
