...
GRANT SELECT ON  [dbo].[SLCBGrid] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SLCBGrid] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SLCBGrid] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SLCBGrid] TO [Viewpoint]
GO
