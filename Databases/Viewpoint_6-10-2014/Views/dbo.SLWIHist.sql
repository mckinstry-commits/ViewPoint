...
GRANT SELECT ON  [dbo].[SLWIHist] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SLWIHist] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SLWIHist] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SLWIHist] TO [Viewpoint]
GO
