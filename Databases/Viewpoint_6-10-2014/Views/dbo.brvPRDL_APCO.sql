...
GRANT SELECT ON  [dbo].[brvPRDL_APCO] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPRDL_APCO] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPRDL_APCO] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPRDL_APCO] TO [Viewpoint]
GO
