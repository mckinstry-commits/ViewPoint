...
GRANT SELECT ON  [dbo].[PMRelateRecord] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMRelateRecord] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMRelateRecord] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMRelateRecord] TO [Viewpoint]
GO
