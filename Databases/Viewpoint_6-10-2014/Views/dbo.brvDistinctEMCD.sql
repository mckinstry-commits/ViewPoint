...
GRANT SELECT ON  [dbo].[brvDistinctEMCD] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvDistinctEMCD] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvDistinctEMCD] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvDistinctEMCD] TO [Viewpoint]
GO
