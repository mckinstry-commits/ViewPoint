...
GRANT SELECT ON  [dbo].[SLClaimHeaderTotal] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SLClaimHeaderTotal] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SLClaimHeaderTotal] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SLClaimHeaderTotal] TO [Viewpoint]
GO
