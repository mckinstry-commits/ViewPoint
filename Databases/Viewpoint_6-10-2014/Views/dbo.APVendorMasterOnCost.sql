...
GRANT SELECT ON  [dbo].[APVendorMasterOnCost] TO [Viewpoint]
GRANT INSERT ON  [dbo].[APVendorMasterOnCost] TO [Viewpoint]
GRANT DELETE ON  [dbo].[APVendorMasterOnCost] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[APVendorMasterOnCost] TO [Viewpoint]
GO
