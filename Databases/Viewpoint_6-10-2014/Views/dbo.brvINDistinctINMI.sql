...
GRANT SELECT ON  [dbo].[brvINDistinctINMI] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvINDistinctINMI] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvINDistinctINMI] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvINDistinctINMI] TO [Viewpoint]
GO
