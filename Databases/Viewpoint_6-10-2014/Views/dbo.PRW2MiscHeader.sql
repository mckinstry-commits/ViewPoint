...
GRANT SELECT ON  [dbo].[PRW2MiscHeader] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PRW2MiscHeader] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PRW2MiscHeader] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PRW2MiscHeader] TO [Viewpoint]
GO
