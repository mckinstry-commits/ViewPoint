...
GRANT SELECT ON  [dbo].[ptvPOIT] TO [Viewpoint]
GRANT INSERT ON  [dbo].[ptvPOIT] TO [Viewpoint]
GRANT DELETE ON  [dbo].[ptvPOIT] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[ptvPOIT] TO [Viewpoint]
GO
