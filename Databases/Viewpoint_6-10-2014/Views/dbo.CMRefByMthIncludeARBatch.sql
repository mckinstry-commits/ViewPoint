...
GRANT SELECT ON  [dbo].[CMRefByMthIncludeARBatch] TO [Viewpoint]
GRANT INSERT ON  [dbo].[CMRefByMthIncludeARBatch] TO [Viewpoint]
GRANT DELETE ON  [dbo].[CMRefByMthIncludeARBatch] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[CMRefByMthIncludeARBatch] TO [Viewpoint]
GO
