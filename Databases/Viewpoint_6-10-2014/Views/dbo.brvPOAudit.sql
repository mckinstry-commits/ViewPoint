...
GRANT SELECT ON  [dbo].[brvPOAudit] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPOAudit] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPOAudit] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPOAudit] TO [Viewpoint]
GO
