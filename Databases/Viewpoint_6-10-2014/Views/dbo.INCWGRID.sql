...
GRANT SELECT ON  [dbo].[INCWGRID] TO [Viewpoint]
GRANT INSERT ON  [dbo].[INCWGRID] TO [Viewpoint]
GRANT DELETE ON  [dbo].[INCWGRID] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[INCWGRID] TO [Viewpoint]
GO
