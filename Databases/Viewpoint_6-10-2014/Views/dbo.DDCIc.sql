...
GRANT SELECT ON  [dbo].[DDCIc] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDCIc] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDCIc] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDCIc] TO [Viewpoint]
GO
