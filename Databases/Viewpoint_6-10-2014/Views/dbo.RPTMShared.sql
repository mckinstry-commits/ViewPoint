...
GRANT SELECT ON  [dbo].[RPTMShared] TO [Viewpoint]
GRANT INSERT ON  [dbo].[RPTMShared] TO [Viewpoint]
GRANT DELETE ON  [dbo].[RPTMShared] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[RPTMShared] TO [Viewpoint]
GO
