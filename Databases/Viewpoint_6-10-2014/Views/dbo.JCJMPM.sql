...
GRANT SELECT ON  [dbo].[JCJMPM] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCJMPM] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCJMPM] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCJMPM] TO [Viewpoint]
GO
