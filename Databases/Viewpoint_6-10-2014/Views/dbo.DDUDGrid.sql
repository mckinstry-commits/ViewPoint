...
GRANT SELECT ON  [dbo].[DDUDGrid] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDUDGrid] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDUDGrid] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDUDGrid] TO [Viewpoint]
GO
