...
GRANT SELECT ON  [dbo].[RPPLc] TO [Viewpoint]
GRANT INSERT ON  [dbo].[RPPLc] TO [Viewpoint]
GRANT DELETE ON  [dbo].[RPPLc] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[RPPLc] TO [Viewpoint]
GO
