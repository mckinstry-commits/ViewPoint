...
GRANT SELECT ON  [dbo].[PMRQGrid] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMRQGrid] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMRQGrid] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMRQGrid] TO [Viewpoint]
GO
