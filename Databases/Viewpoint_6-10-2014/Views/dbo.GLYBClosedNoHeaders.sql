...
GRANT SELECT ON  [dbo].[GLYBClosedNoHeaders] TO [Viewpoint]
GRANT INSERT ON  [dbo].[GLYBClosedNoHeaders] TO [Viewpoint]
GRANT DELETE ON  [dbo].[GLYBClosedNoHeaders] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[GLYBClosedNoHeaders] TO [Viewpoint]
GO
