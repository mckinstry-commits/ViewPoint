...
GRANT SELECT ON  [dbo].[vrvJCJobEstDrill] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvJCJobEstDrill] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvJCJobEstDrill] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvJCJobEstDrill] TO [Viewpoint]
GO
