...
GRANT SELECT ON  [dbo].[VCEmailTemplate] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VCEmailTemplate] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VCEmailTemplate] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VCEmailTemplate] TO [Viewpoint]
GO
