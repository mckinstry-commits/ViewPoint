...
GRANT SELECT ON  [dbo].[DDCustomActions] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDCustomActions] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDCustomActions] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDCustomActions] TO [Viewpoint]
GO
