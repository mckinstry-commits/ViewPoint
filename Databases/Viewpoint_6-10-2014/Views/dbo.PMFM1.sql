...
GRANT SELECT ON  [dbo].[PMFM1] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMFM1] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMFM1] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMFM1] TO [Viewpoint]
GO
