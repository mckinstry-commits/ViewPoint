...
GRANT SELECT ON  [dbo].[pvPMBillFlagLookup] TO [Viewpoint]
GRANT INSERT ON  [dbo].[pvPMBillFlagLookup] TO [Viewpoint]
GRANT DELETE ON  [dbo].[pvPMBillFlagLookup] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[pvPMBillFlagLookup] TO [Viewpoint]
GO
