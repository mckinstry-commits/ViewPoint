...
GRANT SELECT ON  [dbo].[PMPL1] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMPL1] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMPL1] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMPL1] TO [Viewpoint]
GO
