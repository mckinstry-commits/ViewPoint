...
GRANT SELECT ON  [dbo].[PCIntentToBidTemplateScopes] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PCIntentToBidTemplateScopes] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PCIntentToBidTemplateScopes] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PCIntentToBidTemplateScopes] TO [Viewpoint]
GO
