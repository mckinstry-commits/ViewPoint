...
GRANT SELECT ON  [dbo].[brvPOCT_DistinctPO] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPOCT_DistinctPO] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPOCT_DistinctPO] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPOCT_DistinctPO] TO [Viewpoint]
GO
