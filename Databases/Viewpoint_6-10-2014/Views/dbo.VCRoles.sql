...
GRANT SELECT ON  [dbo].[VCRoles] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VCRoles] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VCRoles] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VCRoles] TO [Viewpoint]
GO
