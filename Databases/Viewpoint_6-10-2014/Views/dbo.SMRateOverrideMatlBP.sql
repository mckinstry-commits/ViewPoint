...
GRANT SELECT ON  [dbo].[SMRateOverrideMatlBP] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMRateOverrideMatlBP] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMRateOverrideMatlBP] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMRateOverrideMatlBP] TO [Viewpoint]
GO
