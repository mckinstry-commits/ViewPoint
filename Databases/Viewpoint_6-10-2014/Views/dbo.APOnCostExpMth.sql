...
GRANT SELECT ON  [dbo].[APOnCostExpMth] TO [Viewpoint]
GRANT INSERT ON  [dbo].[APOnCostExpMth] TO [Viewpoint]
GRANT DELETE ON  [dbo].[APOnCostExpMth] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[APOnCostExpMth] TO [Viewpoint]
GO
