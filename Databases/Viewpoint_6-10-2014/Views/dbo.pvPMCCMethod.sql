...
GRANT SELECT ON  [dbo].[pvPMCCMethod] TO [Viewpoint]
GRANT INSERT ON  [dbo].[pvPMCCMethod] TO [Viewpoint]
GRANT DELETE ON  [dbo].[pvPMCCMethod] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[pvPMCCMethod] TO [Viewpoint]
GO
