...
GRANT SELECT ON  [dbo].[vrvPMIHIssueHistory] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvPMIHIssueHistory] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvPMIHIssueHistory] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvPMIHIssueHistory] TO [Viewpoint]
GO
