...
GRANT SELECT ON  [dbo].[EMSMMaxReadingDateEndOdo] TO [Viewpoint]
GRANT INSERT ON  [dbo].[EMSMMaxReadingDateEndOdo] TO [Viewpoint]
GRANT DELETE ON  [dbo].[EMSMMaxReadingDateEndOdo] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[EMSMMaxReadingDateEndOdo] TO [Viewpoint]
GO
