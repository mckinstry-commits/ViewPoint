...
GRANT SELECT ON  [dbo].[MSSurchargeCodes] TO [Viewpoint]
GRANT INSERT ON  [dbo].[MSSurchargeCodes] TO [Viewpoint]
GRANT DELETE ON  [dbo].[MSSurchargeCodes] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[MSSurchargeCodes] TO [Viewpoint]
GO
