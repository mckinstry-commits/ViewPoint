...
GRANT SELECT ON  [dbo].[APWDReleaseHoldCode] TO [Viewpoint]
GRANT INSERT ON  [dbo].[APWDReleaseHoldCode] TO [Viewpoint]
GRANT DELETE ON  [dbo].[APWDReleaseHoldCode] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[APWDReleaseHoldCode] TO [Viewpoint]
GO
