...
GRANT SELECT ON  [dbo].[DDFLc] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDFLc] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDFLc] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDFLc] TO [Viewpoint]
GO
