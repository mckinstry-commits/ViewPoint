...
GRANT SELECT ON  [dbo].[ptvPMPunchList] TO [Viewpoint]
GRANT INSERT ON  [dbo].[ptvPMPunchList] TO [Viewpoint]
GRANT DELETE ON  [dbo].[ptvPMPunchList] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[ptvPMPunchList] TO [Viewpoint]
GO
