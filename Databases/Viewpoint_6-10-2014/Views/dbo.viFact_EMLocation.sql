...
GRANT SELECT ON  [dbo].[viFact_EMLocation] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viFact_EMLocation] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viFact_EMLocation] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viFact_EMLocation] TO [Viewpoint]
GO
