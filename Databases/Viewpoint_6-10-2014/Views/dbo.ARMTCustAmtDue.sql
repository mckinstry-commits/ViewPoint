...
GRANT SELECT ON  [dbo].[ARMTCustAmtDue] TO [Viewpoint]
GRANT INSERT ON  [dbo].[ARMTCustAmtDue] TO [Viewpoint]
GRANT DELETE ON  [dbo].[ARMTCustAmtDue] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[ARMTCustAmtDue] TO [Viewpoint]
GO
