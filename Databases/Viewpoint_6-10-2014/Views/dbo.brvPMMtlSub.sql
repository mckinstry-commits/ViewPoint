...
GRANT SELECT ON  [dbo].[brvPMMtlSub] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPMMtlSub] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPMMtlSub] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPMMtlSub] TO [Viewpoint]
GO
