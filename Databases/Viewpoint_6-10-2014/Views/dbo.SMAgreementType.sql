...
GRANT SELECT ON  [dbo].[SMAgreementType] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMAgreementType] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMAgreementType] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMAgreementType] TO [Viewpoint]
GO
