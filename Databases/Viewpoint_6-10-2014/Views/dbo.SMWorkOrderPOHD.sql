...
GRANT SELECT ON  [dbo].[SMWorkOrderPOHD] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMWorkOrderPOHD] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMWorkOrderPOHD] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMWorkOrderPOHD] TO [Viewpoint]
GO
