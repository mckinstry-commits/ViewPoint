...
GRANT SELECT ON  [dbo].[PMJCJMFuturePMOI] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMJCJMFuturePMOI] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMJCJMFuturePMOI] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMJCJMFuturePMOI] TO [Viewpoint]
GO
