...
GRANT SELECT ON  [dbo].[pvPMRFIType] TO [Viewpoint]
GRANT INSERT ON  [dbo].[pvPMRFIType] TO [Viewpoint]
GRANT DELETE ON  [dbo].[pvPMRFIType] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[pvPMRFIType] TO [Viewpoint]
GO
