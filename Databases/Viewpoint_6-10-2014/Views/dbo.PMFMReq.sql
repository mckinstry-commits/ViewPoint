...
GRANT SELECT ON  [dbo].[PMFMReq] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMFMReq] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMFMReq] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMFMReq] TO [Viewpoint]
GO
