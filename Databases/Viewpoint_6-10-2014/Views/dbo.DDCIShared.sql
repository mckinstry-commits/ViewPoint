...
GRANT SELECT ON  [dbo].[DDCIShared] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDCIShared] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDCIShared] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDCIShared] TO [Viewpoint]
GO
