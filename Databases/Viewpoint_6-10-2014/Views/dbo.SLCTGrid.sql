...
GRANT SELECT ON  [dbo].[SLCTGrid] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SLCTGrid] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SLCTGrid] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SLCTGrid] TO [Viewpoint]
GO
