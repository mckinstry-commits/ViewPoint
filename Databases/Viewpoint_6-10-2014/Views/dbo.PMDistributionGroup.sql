...
GRANT SELECT ON  [dbo].[PMDistributionGroup] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMDistributionGroup] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMDistributionGroup] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMDistributionGroup] TO [Viewpoint]
GO
