...
GRANT SELECT ON  [dbo].[APURRevTot] TO [Viewpoint]
GRANT INSERT ON  [dbo].[APURRevTot] TO [Viewpoint]
GRANT DELETE ON  [dbo].[APURRevTot] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[APURRevTot] TO [Viewpoint]
GO
