...
GRANT SELECT ON  [dbo].[brvAPTaxGST] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvAPTaxGST] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvAPTaxGST] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvAPTaxGST] TO [Viewpoint]
GO
