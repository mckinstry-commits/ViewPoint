...
GRANT SELECT ON  [dbo].[PMNRReviewer] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMNRReviewer] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMNRReviewer] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMNRReviewer] TO [Viewpoint]
GO
