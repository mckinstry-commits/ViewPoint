...
GRANT SELECT ON  [dbo].[PMJCProjects] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMJCProjects] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMJCProjects] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMJCProjects] TO [Viewpoint]
GO
