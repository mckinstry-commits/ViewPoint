...
GRANT SELECT ON  [dbo].[SMCallType] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMCallType] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMCallType] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMCallType] TO [Viewpoint]
GO
