...
GRANT SELECT ON  [dbo].[PMDHInspect] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMDHInspect] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMDHInspect] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMDHInspect] TO [Viewpoint]
GO
