...
GRANT SELECT ON  [dbo].[ARBLSumFCAmount] TO [Viewpoint]
GRANT INSERT ON  [dbo].[ARBLSumFCAmount] TO [Viewpoint]
GRANT DELETE ON  [dbo].[ARBLSumFCAmount] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[ARBLSumFCAmount] TO [Viewpoint]
GO
