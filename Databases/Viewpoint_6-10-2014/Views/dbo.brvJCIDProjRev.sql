...
GRANT SELECT ON  [dbo].[brvJCIDProjRev] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvJCIDProjRev] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvJCIDProjRev] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvJCIDProjRev] TO [Viewpoint]
GO
