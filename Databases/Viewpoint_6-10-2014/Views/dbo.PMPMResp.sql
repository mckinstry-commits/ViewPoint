...
GRANT SELECT ON  [dbo].[PMPMResp] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMPMResp] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMPMResp] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMPMResp] TO [Viewpoint]
GO
