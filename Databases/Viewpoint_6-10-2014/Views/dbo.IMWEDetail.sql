...
GRANT SELECT ON  [dbo].[IMWEDetail] TO [Viewpoint]
GRANT INSERT ON  [dbo].[IMWEDetail] TO [Viewpoint]
GRANT DELETE ON  [dbo].[IMWEDetail] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[IMWEDetail] TO [Viewpoint]
GO
