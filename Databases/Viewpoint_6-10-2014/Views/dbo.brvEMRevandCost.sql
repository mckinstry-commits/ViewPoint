...
GRANT SELECT ON  [dbo].[brvEMRevandCost] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvEMRevandCost] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvEMRevandCost] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvEMRevandCost] TO [Viewpoint]
GO
