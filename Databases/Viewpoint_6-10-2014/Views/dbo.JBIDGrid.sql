...
GRANT SELECT ON  [dbo].[JBIDGrid] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JBIDGrid] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JBIDGrid] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JBIDGrid] TO [Viewpoint]
GO
