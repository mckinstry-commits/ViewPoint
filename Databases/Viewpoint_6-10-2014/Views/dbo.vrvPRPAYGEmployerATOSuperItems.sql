...
GRANT SELECT ON  [dbo].[vrvPRPAYGEmployerATOSuperItems] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvPRPAYGEmployerATOSuperItems] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvPRPAYGEmployerATOSuperItems] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvPRPAYGEmployerATOSuperItems] TO [Viewpoint]
GO
