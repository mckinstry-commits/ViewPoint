...
GRANT SELECT ON  [dbo].[PCProjectTypes] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PCProjectTypes] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PCProjectTypes] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PCProjectTypes] TO [Viewpoint]
GO
