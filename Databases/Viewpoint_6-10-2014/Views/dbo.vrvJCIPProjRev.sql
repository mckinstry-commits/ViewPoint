...
GRANT SELECT ON  [dbo].[vrvJCIPProjRev] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvJCIPProjRev] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvJCIPProjRev] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvJCIPProjRev] TO [Viewpoint]
GO
