...
GRANT SELECT ON  [dbo].[JCCINotes] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCCINotes] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCCINotes] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCCINotes] TO [Viewpoint]
GO
