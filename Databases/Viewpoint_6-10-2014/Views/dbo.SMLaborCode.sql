...
GRANT SELECT ON  [dbo].[SMLaborCode] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMLaborCode] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMLaborCode] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMLaborCode] TO [Viewpoint]
GO
