...
GRANT SELECT ON  [dbo].[vrvPMVendorRegister] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvPMVendorRegister] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvPMVendorRegister] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvPMVendorRegister] TO [Viewpoint]
GO
