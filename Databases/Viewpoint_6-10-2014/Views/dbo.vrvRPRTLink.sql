...
GRANT SELECT ON  [dbo].[vrvRPRTLink] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvRPRTLink] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvRPRTLink] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvRPRTLink] TO [Viewpoint]
GO
