...
GRANT SELECT ON  [dbo].[PRCAEmployerCodes] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PRCAEmployerCodes] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PRCAEmployerCodes] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PRCAEmployerCodes] TO [Viewpoint]
GO
