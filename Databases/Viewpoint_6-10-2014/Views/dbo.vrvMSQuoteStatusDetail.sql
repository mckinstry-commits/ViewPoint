...
GRANT SELECT ON  [dbo].[vrvMSQuoteStatusDetail] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvMSQuoteStatusDetail] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvMSQuoteStatusDetail] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvMSQuoteStatusDetail] TO [Viewpoint]
GO
