...
GRANT SELECT ON  [dbo].[vrvPMCommitmentCompliance] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvPMCommitmentCompliance] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvPMCommitmentCompliance] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvPMCommitmentCompliance] TO [Viewpoint]
GO
