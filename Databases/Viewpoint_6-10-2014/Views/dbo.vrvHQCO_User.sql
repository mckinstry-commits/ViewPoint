...
GRANT SELECT ON  [dbo].[vrvHQCO_User] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvHQCO_User] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvHQCO_User] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvHQCO_User] TO [Viewpoint]
GO
