...
GRANT SELECT ON  [dbo].[viDim_APVendor] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_APVendor] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_APVendor] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_APVendor] TO [Viewpoint]
GO
