...
GRANT SELECT ON  [dbo].[PRMyTimesheetDetail] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PRMyTimesheetDetail] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PRMyTimesheetDetail] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PRMyTimesheetDetail] TO [Viewpoint]
GO
