...
GRANT SELECT ON  [dbo].[viDim_ARInvoice] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_ARInvoice] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_ARInvoice] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_ARInvoice] TO [Viewpoint]
GO
