...
GRANT SELECT ON  [dbo].[SMMiscellaneousBatch] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMMiscellaneousBatch] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMMiscellaneousBatch] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMMiscellaneousBatch] TO [Viewpoint]
GO
