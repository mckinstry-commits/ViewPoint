...
GRANT SELECT ON  [dbo].[PMDHPCO] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMDHPCO] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMDHPCO] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMDHPCO] TO [Viewpoint]
GO
