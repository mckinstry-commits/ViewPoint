...
GRANT SELECT ON  [dbo].[RFEpisodeUsage] TO [Viewpoint]
GRANT INSERT ON  [dbo].[RFEpisodeUsage] TO [Viewpoint]
GRANT DELETE ON  [dbo].[RFEpisodeUsage] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[RFEpisodeUsage] TO [Viewpoint]
GO
