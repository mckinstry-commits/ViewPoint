...
GRANT SELECT ON  [dbo].[EMChangeBatchList] TO [Viewpoint]
GRANT INSERT ON  [dbo].[EMChangeBatchList] TO [Viewpoint]
GRANT DELETE ON  [dbo].[EMChangeBatchList] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[EMChangeBatchList] TO [Viewpoint]
GO
