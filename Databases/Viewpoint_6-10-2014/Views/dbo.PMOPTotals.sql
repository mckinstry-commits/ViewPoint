...
GRANT SELECT ON  [dbo].[PMOPTotals] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMOPTotals] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMOPTotals] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMOPTotals] TO [Viewpoint]
GO
