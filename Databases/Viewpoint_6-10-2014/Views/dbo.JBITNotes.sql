...
GRANT SELECT ON  [dbo].[JBITNotes] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JBITNotes] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JBITNotes] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JBITNotes] TO [Viewpoint]
GO
