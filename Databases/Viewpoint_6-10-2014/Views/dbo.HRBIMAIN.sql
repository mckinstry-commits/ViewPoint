...
GRANT SELECT ON  [dbo].[HRBIMAIN] TO [Viewpoint]
GRANT INSERT ON  [dbo].[HRBIMAIN] TO [Viewpoint]
GRANT DELETE ON  [dbo].[HRBIMAIN] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[HRBIMAIN] TO [Viewpoint]
GO
