...
GRANT SELECT ON  [dbo].[brvGLFSPart2] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvGLFSPart2] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvGLFSPart2] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvGLFSPart2] TO [Viewpoint]
GO
