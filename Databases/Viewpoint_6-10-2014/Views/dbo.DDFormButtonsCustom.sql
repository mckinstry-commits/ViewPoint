...
GRANT SELECT ON  [dbo].[DDFormButtonsCustom] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDFormButtonsCustom] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDFormButtonsCustom] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDFormButtonsCustom] TO [Viewpoint]
GO
