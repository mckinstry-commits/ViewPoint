...
GRANT SELECT ON  [dbo].[PMDGGrid] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMDGGrid] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMDGGrid] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMDGGrid] TO [Viewpoint]
GO
