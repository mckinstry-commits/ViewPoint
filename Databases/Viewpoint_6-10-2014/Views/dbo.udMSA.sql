...
GRANT SELECT ON  [dbo].[udMSA] TO [Viewpoint]
GRANT INSERT ON  [dbo].[udMSA] TO [Viewpoint]
GRANT DELETE ON  [dbo].[udMSA] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[udMSA] TO [Viewpoint]
GO
