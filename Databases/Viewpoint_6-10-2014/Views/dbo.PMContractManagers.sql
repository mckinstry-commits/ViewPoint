...
GRANT SELECT ON  [dbo].[PMContractManagers] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMContractManagers] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMContractManagers] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMContractManagers] TO [Viewpoint]
GO
