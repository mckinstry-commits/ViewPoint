...
GRANT SELECT ON  [dbo].[PRAUEmployeeETPAmounts] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PRAUEmployeeETPAmounts] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PRAUEmployeeETPAmounts] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PRAUEmployeeETPAmounts] TO [Viewpoint]
GO
