...
GRANT SELECT ON  [dbo].[RFCommandUsage] TO [Viewpoint]
GRANT INSERT ON  [dbo].[RFCommandUsage] TO [Viewpoint]
GRANT DELETE ON  [dbo].[RFCommandUsage] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[RFCommandUsage] TO [Viewpoint]
GO
