...
GRANT SELECT ON  [dbo].[SMSession] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMSession] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMSession] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMSession] TO [Viewpoint]
GO
