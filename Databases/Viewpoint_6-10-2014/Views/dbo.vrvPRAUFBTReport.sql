...
GRANT SELECT ON  [dbo].[vrvPRAUFBTReport] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvPRAUFBTReport] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvPRAUFBTReport] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvPRAUFBTReport] TO [Viewpoint]
GO
