...
GRANT SELECT ON  [dbo].[brvINAllocInventory] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvINAllocInventory] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvINAllocInventory] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvINAllocInventory] TO [Viewpoint]
GO
