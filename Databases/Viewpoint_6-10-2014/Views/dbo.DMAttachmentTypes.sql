...
GRANT SELECT ON  [dbo].[DMAttachmentTypes] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DMAttachmentTypes] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DMAttachmentTypes] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DMAttachmentTypes] TO [Viewpoint]
GO
