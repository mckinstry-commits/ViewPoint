...
GRANT SELECT ON  [dbo].[PRCAEmployerItems] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PRCAEmployerItems] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PRCAEmployerItems] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PRCAEmployerItems] TO [Viewpoint]
GO
