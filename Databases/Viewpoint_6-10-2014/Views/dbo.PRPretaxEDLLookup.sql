...
GRANT SELECT ON  [dbo].[PRPretaxEDLLookup] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PRPretaxEDLLookup] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PRPretaxEDLLookup] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PRPretaxEDLLookup] TO [Viewpoint]
GO
