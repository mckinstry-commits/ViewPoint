...
GRANT SELECT ON  [dbo].[HRRMName] TO [Viewpoint]
GRANT INSERT ON  [dbo].[HRRMName] TO [Viewpoint]
GRANT DELETE ON  [dbo].[HRRMName] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[HRRMName] TO [Viewpoint]
GO
