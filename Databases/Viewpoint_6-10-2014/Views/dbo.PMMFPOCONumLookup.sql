...
GRANT SELECT ON  [dbo].[PMMFPOCONumLookup] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMMFPOCONumLookup] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMMFPOCONumLookup] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMMFPOCONumLookup] TO [Viewpoint]
GO
