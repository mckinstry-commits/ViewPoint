...
GRANT SELECT ON  [dbo].[brvPRRecon] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPRRecon] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPRRecon] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPRRecon] TO [Viewpoint]
GO
