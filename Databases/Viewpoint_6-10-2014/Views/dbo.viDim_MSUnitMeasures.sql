...
GRANT SELECT ON  [dbo].[viDim_MSUnitMeasures] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_MSUnitMeasures] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_MSUnitMeasures] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_MSUnitMeasures] TO [Viewpoint]
GO
