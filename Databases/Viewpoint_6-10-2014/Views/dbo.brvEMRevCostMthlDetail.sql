...
GRANT SELECT ON  [dbo].[brvEMRevCostMthlDetail] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvEMRevCostMthlDetail] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvEMRevCostMthlDetail] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvEMRevCostMthlDetail] TO [Viewpoint]
GO
