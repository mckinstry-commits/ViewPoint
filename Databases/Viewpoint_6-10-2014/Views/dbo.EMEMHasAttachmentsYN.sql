...
GRANT SELECT ON  [dbo].[EMEMHasAttachmentsYN] TO [Viewpoint]
GRANT INSERT ON  [dbo].[EMEMHasAttachmentsYN] TO [Viewpoint]
GRANT DELETE ON  [dbo].[EMEMHasAttachmentsYN] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[EMEMHasAttachmentsYN] TO [Viewpoint]
GO
