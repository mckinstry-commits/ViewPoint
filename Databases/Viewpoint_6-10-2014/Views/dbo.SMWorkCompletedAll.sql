...
GRANT SELECT ON  [dbo].[SMWorkCompletedAll] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMWorkCompletedAll] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMWorkCompletedAll] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMWorkCompletedAll] TO [Viewpoint]
GO
