...
GRANT SELECT ON  [dbo].[PMDistributionLists] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMDistributionLists] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMDistributionLists] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMDistributionLists] TO [Viewpoint]
GO
