...
GRANT SELECT ON  [dbo].[SMTechnician] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMTechnician] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMTechnician] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMTechnician] TO [Viewpoint]
GO
