...
GRANT SELECT ON  [dbo].[DDFHUserMemoExist] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDFHUserMemoExist] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDFHUserMemoExist] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDFHUserMemoExist] TO [Viewpoint]
GO
