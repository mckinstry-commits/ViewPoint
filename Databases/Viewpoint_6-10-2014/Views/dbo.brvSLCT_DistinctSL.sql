...
GRANT SELECT ON  [dbo].[brvSLCT_DistinctSL] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvSLCT_DistinctSL] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvSLCT_DistinctSL] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvSLCT_DistinctSL] TO [Viewpoint]
GO
