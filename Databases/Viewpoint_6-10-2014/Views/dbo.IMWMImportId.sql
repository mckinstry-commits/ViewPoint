...
GRANT SELECT ON  [dbo].[IMWMImportId] TO [Viewpoint]
GRANT INSERT ON  [dbo].[IMWMImportId] TO [Viewpoint]
GRANT DELETE ON  [dbo].[IMWMImportId] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[IMWMImportId] TO [Viewpoint]
GO
