...
GRANT SELECT ON  [dbo].[HQBatchDistributionGLEntryTransaction] TO [Viewpoint]
GRANT INSERT ON  [dbo].[HQBatchDistributionGLEntryTransaction] TO [Viewpoint]
GRANT DELETE ON  [dbo].[HQBatchDistributionGLEntryTransaction] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[HQBatchDistributionGLEntryTransaction] TO [Viewpoint]
GO
