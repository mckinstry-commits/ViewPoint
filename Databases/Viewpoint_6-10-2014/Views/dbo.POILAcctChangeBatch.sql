...
GRANT SELECT ON  [dbo].[POILAcctChangeBatch] TO [Viewpoint]
GRANT INSERT ON  [dbo].[POILAcctChangeBatch] TO [Viewpoint]
GRANT DELETE ON  [dbo].[POILAcctChangeBatch] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[POILAcctChangeBatch] TO [Viewpoint]
GO
