...
GRANT SELECT ON  [dbo].[VPCanvasGridColumns] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VPCanvasGridColumns] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VPCanvasGridColumns] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VPCanvasGridColumns] TO [Viewpoint]
GO
