...
GRANT SELECT ON  [dbo].[PRAUEmployerMaster] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PRAUEmployerMaster] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PRAUEmployerMaster] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PRAUEmployerMaster] TO [Viewpoint]
GO
