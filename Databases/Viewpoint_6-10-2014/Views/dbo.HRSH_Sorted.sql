...
GRANT SELECT ON  [dbo].[HRSH_Sorted] TO [Viewpoint]
GRANT INSERT ON  [dbo].[HRSH_Sorted] TO [Viewpoint]
GRANT DELETE ON  [dbo].[HRSH_Sorted] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[HRSH_Sorted] TO [Viewpoint]
GO
