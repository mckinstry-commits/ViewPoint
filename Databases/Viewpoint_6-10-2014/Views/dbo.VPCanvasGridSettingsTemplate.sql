...
GRANT SELECT ON  [dbo].[VPCanvasGridSettingsTemplate] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VPCanvasGridSettingsTemplate] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VPCanvasGridSettingsTemplate] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VPCanvasGridSettingsTemplate] TO [Viewpoint]
GO
