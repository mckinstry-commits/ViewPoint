...
GRANT SELECT ON  [dbo].[viFact_APJobCost] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viFact_APJobCost] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viFact_APJobCost] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viFact_APJobCost] TO [Viewpoint]
GO
