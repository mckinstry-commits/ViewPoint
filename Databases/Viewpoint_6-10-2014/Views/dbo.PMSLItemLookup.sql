...
GRANT SELECT ON  [dbo].[PMSLItemLookup] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMSLItemLookup] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMSLItemLookup] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMSLItemLookup] TO [Viewpoint]
GO
