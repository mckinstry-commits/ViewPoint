...
GRANT SELECT ON  [dbo].[ptvJCJP] TO [Viewpoint]
GRANT INSERT ON  [dbo].[ptvJCJP] TO [Viewpoint]
GRANT DELETE ON  [dbo].[ptvJCJP] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[ptvJCJP] TO [Viewpoint]
GO
