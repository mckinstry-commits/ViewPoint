...
GRANT SELECT ON  [dbo].[brvMSHaul_APTH_DistinctAPRef] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvMSHaul_APTH_DistinctAPRef] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvMSHaul_APTH_DistinctAPRef] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvMSHaul_APTH_DistinctAPRef] TO [Viewpoint]
GO
