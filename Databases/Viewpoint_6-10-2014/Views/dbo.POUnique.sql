...
GRANT SELECT ON  [dbo].[POUnique] TO [Viewpoint]
GRANT INSERT ON  [dbo].[POUnique] TO [Viewpoint]
GRANT DELETE ON  [dbo].[POUnique] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[POUnique] TO [Viewpoint]
GO
