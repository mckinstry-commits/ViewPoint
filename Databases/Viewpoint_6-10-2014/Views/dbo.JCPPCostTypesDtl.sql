...
GRANT SELECT ON  [dbo].[JCPPCostTypesDtl] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCPPCostTypesDtl] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCPPCostTypesDtl] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCPPCostTypesDtl] TO [Viewpoint]
GO
