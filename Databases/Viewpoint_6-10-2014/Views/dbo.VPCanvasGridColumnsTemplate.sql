...
GRANT SELECT ON  [dbo].[VPCanvasGridColumnsTemplate] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VPCanvasGridColumnsTemplate] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VPCanvasGridColumnsTemplate] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VPCanvasGridColumnsTemplate] TO [Viewpoint]
GO
