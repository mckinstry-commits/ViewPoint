...
GRANT SELECT ON  [dbo].[PMOMTotals] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMOMTotals] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMOMTotals] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMOMTotals] TO [Viewpoint]
GO
