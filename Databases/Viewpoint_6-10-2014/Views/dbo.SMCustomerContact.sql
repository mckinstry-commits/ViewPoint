...
GRANT SELECT ON  [dbo].[SMCustomerContact] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMCustomerContact] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMCustomerContact] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMCustomerContact] TO [Viewpoint]
GO
