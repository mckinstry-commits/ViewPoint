...
GRANT SELECT ON  [dbo].[APLBOnCostStatus] TO [Viewpoint]
GRANT INSERT ON  [dbo].[APLBOnCostStatus] TO [Viewpoint]
GRANT DELETE ON  [dbo].[APLBOnCostStatus] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[APLBOnCostStatus] TO [Viewpoint]
GO
