...
GRANT SELECT ON  [dbo].[PMMFPOItemLookup] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMMFPOItemLookup] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMMFPOItemLookup] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMMFPOItemLookup] TO [Viewpoint]
GO
