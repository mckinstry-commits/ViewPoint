...
GRANT SELECT ON  [dbo].[pvPRStatusTypes] TO [Viewpoint]
GRANT INSERT ON  [dbo].[pvPRStatusTypes] TO [Viewpoint]
GRANT DELETE ON  [dbo].[pvPRStatusTypes] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[pvPRStatusTypes] TO [Viewpoint]
GO
