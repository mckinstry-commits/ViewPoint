...
GRANT SELECT ON  [dbo].[brvPRMissingTimecards] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPRMissingTimecards] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPRMissingTimecards] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPRMissingTimecards] TO [Viewpoint]
GO
