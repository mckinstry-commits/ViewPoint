...
GRANT SELECT ON  [dbo].[JCProductionCalcs] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCProductionCalcs] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCProductionCalcs] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCProductionCalcs] TO [Viewpoint]
GO
