...
GRANT SELECT ON  [dbo].[WFProcessDetailForPMMF] TO [Viewpoint]
GRANT INSERT ON  [dbo].[WFProcessDetailForPMMF] TO [Viewpoint]
GRANT DELETE ON  [dbo].[WFProcessDetailForPMMF] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[WFProcessDetailForPMMF] TO [Viewpoint]
GO
