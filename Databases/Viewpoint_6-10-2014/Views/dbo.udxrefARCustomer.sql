...
GRANT SELECT ON  [dbo].[udxrefARCustomer] TO [Viewpoint]
GRANT INSERT ON  [dbo].[udxrefARCustomer] TO [Viewpoint]
GRANT DELETE ON  [dbo].[udxrefARCustomer] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[udxrefARCustomer] TO [Viewpoint]
GO
