...
GRANT SELECT ON  [dbo].[DDLHShared] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDLHShared] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDLHShared] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDLHShared] TO [Viewpoint]
GO
