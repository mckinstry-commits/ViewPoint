...
GRANT SELECT ON  [dbo].[PMWDPhase] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMWDPhase] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMWDPhase] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMWDPhase] TO [Viewpoint]
GO
