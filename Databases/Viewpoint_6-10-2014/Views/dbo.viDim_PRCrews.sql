...
GRANT SELECT ON  [dbo].[viDim_PRCrews] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_PRCrews] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_PRCrews] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_PRCrews] TO [Viewpoint]
GO
