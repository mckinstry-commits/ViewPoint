...
GRANT SELECT ON  [dbo].[brvPREH] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPREH] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPREH] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPREH] TO [Viewpoint]
GO
