...
GRANT SELECT ON  [dbo].[viDim_MSCustomerPO] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_MSCustomerPO] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_MSCustomerPO] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_MSCustomerPO] TO [Viewpoint]
GO
