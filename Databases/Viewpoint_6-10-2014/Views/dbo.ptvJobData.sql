...
GRANT SELECT ON  [dbo].[ptvJobData] TO [Viewpoint]
GRANT INSERT ON  [dbo].[ptvJobData] TO [Viewpoint]
GRANT DELETE ON  [dbo].[ptvJobData] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[ptvJobData] TO [Viewpoint]
GO
