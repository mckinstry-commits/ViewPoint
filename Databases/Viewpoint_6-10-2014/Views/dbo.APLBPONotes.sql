...
GRANT SELECT ON  [dbo].[APLBPONotes] TO [Viewpoint]
GRANT INSERT ON  [dbo].[APLBPONotes] TO [Viewpoint]
GRANT DELETE ON  [dbo].[APLBPONotes] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[APLBPONotes] TO [Viewpoint]
GO
