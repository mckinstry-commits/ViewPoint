...
GRANT SELECT ON  [dbo].[viDim_EMRevenueCode] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_EMRevenueCode] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_EMRevenueCode] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_EMRevenueCode] TO [Viewpoint]
GO
