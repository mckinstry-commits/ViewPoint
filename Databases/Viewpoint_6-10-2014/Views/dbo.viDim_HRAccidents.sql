...
GRANT SELECT ON  [dbo].[viDim_HRAccidents] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_HRAccidents] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_HRAccidents] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_HRAccidents] TO [Viewpoint]
GO
