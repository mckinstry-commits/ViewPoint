...
GRANT SELECT ON  [dbo].[PMDHRFI] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMDHRFI] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMDHRFI] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMDHRFI] TO [Viewpoint]
GO
