...
GRANT SELECT ON  [dbo].[SMServiceCenterCallType] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMServiceCenterCallType] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMServiceCenterCallType] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMServiceCenterCallType] TO [Viewpoint]
GO
