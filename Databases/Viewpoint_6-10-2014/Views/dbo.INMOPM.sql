...
GRANT SELECT ON  [dbo].[INMOPM] TO [Viewpoint]
GRANT INSERT ON  [dbo].[INMOPM] TO [Viewpoint]
GRANT DELETE ON  [dbo].[INMOPM] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[INMOPM] TO [Viewpoint]
GO
