...
GRANT SELECT ON  [dbo].[udCustomerDefaults] TO [Viewpoint]
GRANT INSERT ON  [dbo].[udCustomerDefaults] TO [Viewpoint]
GRANT DELETE ON  [dbo].[udCustomerDefaults] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[udCustomerDefaults] TO [Viewpoint]
GO
