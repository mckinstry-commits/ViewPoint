...
GRANT SELECT ON  [dbo].[SMWorkOrderQuoteScope] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMWorkOrderQuoteScope] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMWorkOrderQuoteScope] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMWorkOrderQuoteScope] TO [Viewpoint]
GO
