...
GRANT SELECT ON  [dbo].[frl_per_bal] TO [Viewpoint]
GRANT INSERT ON  [dbo].[frl_per_bal] TO [Viewpoint]
GRANT DELETE ON  [dbo].[frl_per_bal] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[frl_per_bal] TO [Viewpoint]
GO
