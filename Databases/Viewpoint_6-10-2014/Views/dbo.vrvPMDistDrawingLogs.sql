...
GRANT SELECT ON  [dbo].[vrvPMDistDrawingLogs] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvPMDistDrawingLogs] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvPMDistDrawingLogs] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvPMDistDrawingLogs] TO [Viewpoint]
GO
