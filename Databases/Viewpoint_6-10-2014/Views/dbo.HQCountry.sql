...
GRANT SELECT ON  [dbo].[HQCountry] TO [Viewpoint]
GRANT INSERT ON  [dbo].[HQCountry] TO [Viewpoint]
GRANT DELETE ON  [dbo].[HQCountry] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[HQCountry] TO [Viewpoint]
GO
