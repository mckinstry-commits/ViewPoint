...
GRANT SELECT ON  [dbo].[PORBGrid] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PORBGrid] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PORBGrid] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PORBGrid] TO [Viewpoint]
GO
