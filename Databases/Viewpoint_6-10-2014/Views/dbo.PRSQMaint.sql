...
GRANT SELECT ON  [dbo].[PRSQMaint] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PRSQMaint] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PRSQMaint] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PRSQMaint] TO [Viewpoint]
GO
