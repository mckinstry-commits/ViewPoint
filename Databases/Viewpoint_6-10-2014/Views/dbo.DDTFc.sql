...
GRANT SELECT ON  [dbo].[DDTFc] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDTFc] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDTFc] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDTFc] TO [Viewpoint]
GO
