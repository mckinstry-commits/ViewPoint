...
GRANT SELECT ON  [dbo].[brvEMEquipCategory] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvEMEquipCategory] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvEMEquipCategory] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvEMEquipCategory] TO [Viewpoint]
GO
