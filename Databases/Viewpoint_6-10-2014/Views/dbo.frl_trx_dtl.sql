...
GRANT SELECT ON  [dbo].[frl_trx_dtl] TO [Viewpoint]
GRANT INSERT ON  [dbo].[frl_trx_dtl] TO [Viewpoint]
GRANT DELETE ON  [dbo].[frl_trx_dtl] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[frl_trx_dtl] TO [Viewpoint]
GO
