...
GRANT SELECT ON  [dbo].[vrvAPVM_MasterVendor] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvAPVM_MasterVendor] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvAPVM_MasterVendor] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvAPVM_MasterVendor] TO [Viewpoint]
GO
