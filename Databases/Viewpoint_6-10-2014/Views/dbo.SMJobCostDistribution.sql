...
GRANT SELECT ON  [dbo].[SMJobCostDistribution] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMJobCostDistribution] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMJobCostDistribution] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMJobCostDistribution] TO [Viewpoint]
GO
