...
GRANT SELECT ON  [dbo].[DDCustomRecordTypeGroups] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDCustomRecordTypeGroups] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDCustomRecordTypeGroups] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDCustomRecordTypeGroups] TO [Viewpoint]
GO
