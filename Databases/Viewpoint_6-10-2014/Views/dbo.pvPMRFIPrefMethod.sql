...
GRANT SELECT ON  [dbo].[pvPMRFIPrefMethod] TO [Viewpoint]
GRANT INSERT ON  [dbo].[pvPMRFIPrefMethod] TO [Viewpoint]
GRANT DELETE ON  [dbo].[pvPMRFIPrefMethod] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[pvPMRFIPrefMethod] TO [Viewpoint]
GO
