...
GRANT SELECT ON  [dbo].[DDSLShared] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDSLShared] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDSLShared] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDSLShared] TO [Viewpoint]
GO
