...
GRANT SELECT ON  [dbo].[DDFHSharedSingleForm] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDFHSharedSingleForm] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDFHSharedSingleForm] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDFHSharedSingleForm] TO [Viewpoint]
GO
