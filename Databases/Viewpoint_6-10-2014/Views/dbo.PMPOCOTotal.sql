...
GRANT SELECT ON  [dbo].[PMPOCOTotal] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMPOCOTotal] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMPOCOTotal] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMPOCOTotal] TO [Viewpoint]
GO
