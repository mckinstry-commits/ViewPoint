...
GRANT SELECT ON  [dbo].[APOnCostGroupTypes] TO [Viewpoint]
GRANT INSERT ON  [dbo].[APOnCostGroupTypes] TO [Viewpoint]
GRANT DELETE ON  [dbo].[APOnCostGroupTypes] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[APOnCostGroupTypes] TO [Viewpoint]
GO
