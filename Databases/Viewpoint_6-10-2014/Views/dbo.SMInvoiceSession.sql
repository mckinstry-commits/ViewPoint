...
GRANT SELECT ON  [dbo].[SMInvoiceSession] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMInvoiceSession] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMInvoiceSession] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMInvoiceSession] TO [Viewpoint]
GO
