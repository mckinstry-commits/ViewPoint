...
GRANT SELECT ON  [dbo].[JCJR1] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCJR1] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCJR1] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCJR1] TO [Viewpoint]
GO
