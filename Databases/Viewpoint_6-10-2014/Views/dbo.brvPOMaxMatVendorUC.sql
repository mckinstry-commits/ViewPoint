...
GRANT SELECT ON  [dbo].[brvPOMaxMatVendorUC] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPOMaxMatVendorUC] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPOMaxMatVendorUC] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPOMaxMatVendorUC] TO [Viewpoint]
GO
