...
GRANT SELECT ON  [dbo].[brvAPTL_DistinctSL] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvAPTL_DistinctSL] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvAPTL_DistinctSL] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvAPTL_DistinctSL] TO [Viewpoint]
GO
