...
GRANT SELECT ON  [dbo].[brvAPTotalAPTDAmt] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvAPTotalAPTDAmt] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvAPTotalAPTDAmt] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvAPTotalAPTDAmt] TO [Viewpoint]
GO
