...
GRANT SELECT ON  [dbo].[PCBidPackageBidList] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PCBidPackageBidList] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PCBidPackageBidList] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PCBidPackageBidList] TO [Viewpoint]
GO
