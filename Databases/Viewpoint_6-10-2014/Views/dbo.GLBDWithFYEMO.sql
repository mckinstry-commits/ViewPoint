...
GRANT SELECT ON  [dbo].[GLBDWithFYEMO] TO [Viewpoint]
GRANT INSERT ON  [dbo].[GLBDWithFYEMO] TO [Viewpoint]
GRANT DELETE ON  [dbo].[GLBDWithFYEMO] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[GLBDWithFYEMO] TO [Viewpoint]
GO
