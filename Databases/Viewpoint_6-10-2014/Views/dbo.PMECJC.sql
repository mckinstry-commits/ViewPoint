...
GRANT SELECT ON  [dbo].[PMECJC] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMECJC] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMECJC] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMECJC] TO [Viewpoint]
GO
