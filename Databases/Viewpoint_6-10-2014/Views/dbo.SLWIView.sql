...
GRANT SELECT ON  [dbo].[SLWIView] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SLWIView] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SLWIView] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SLWIView] TO [Viewpoint]
GO
