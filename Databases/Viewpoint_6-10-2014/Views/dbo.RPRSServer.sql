...
GRANT SELECT ON  [dbo].[RPRSServer] TO [Viewpoint]
GRANT INSERT ON  [dbo].[RPRSServer] TO [Viewpoint]
GRANT DELETE ON  [dbo].[RPRSServer] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[RPRSServer] TO [Viewpoint]
GO
