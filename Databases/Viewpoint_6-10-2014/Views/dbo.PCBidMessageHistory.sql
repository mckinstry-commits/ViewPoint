...
GRANT SELECT ON  [dbo].[PCBidMessageHistory] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PCBidMessageHistory] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PCBidMessageHistory] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PCBidMessageHistory] TO [Viewpoint]
GO
