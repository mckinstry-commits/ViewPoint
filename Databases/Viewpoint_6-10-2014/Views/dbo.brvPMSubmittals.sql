...
GRANT SELECT ON  [dbo].[brvPMSubmittals] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPMSubmittals] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPMSubmittals] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPMSubmittals] TO [Viewpoint]
GO
