...
GRANT SELECT ON  [dbo].[PMFMInsp] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMFMInsp] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMFMInsp] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMFMInsp] TO [Viewpoint]
GO
