...
GRANT SELECT ON  [dbo].[PCWorkRegions] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PCWorkRegions] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PCWorkRegions] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PCWorkRegions] TO [Viewpoint]
GO
