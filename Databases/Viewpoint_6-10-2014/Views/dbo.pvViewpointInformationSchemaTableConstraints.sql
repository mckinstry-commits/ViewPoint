...
GRANT SELECT ON  [dbo].[pvViewpointInformationSchemaTableConstraints] TO [Viewpoint]
GRANT INSERT ON  [dbo].[pvViewpointInformationSchemaTableConstraints] TO [Viewpoint]
GRANT DELETE ON  [dbo].[pvViewpointInformationSchemaTableConstraints] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[pvViewpointInformationSchemaTableConstraints] TO [Viewpoint]
GO
