...
GRANT SELECT ON  [dbo].[JCIRForJCCP] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCIRForJCCP] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCIRForJCCP] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCIRForJCCP] TO [Viewpoint]
GO
