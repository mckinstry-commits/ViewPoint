...
GRANT SELECT ON  [dbo].[SMEMUsageBatch] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMEMUsageBatch] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMEMUsageBatch] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMEMUsageBatch] TO [Viewpoint]
GO
