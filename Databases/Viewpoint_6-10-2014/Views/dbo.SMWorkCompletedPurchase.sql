...
GRANT SELECT ON  [dbo].[SMWorkCompletedPurchase] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMWorkCompletedPurchase] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMWorkCompletedPurchase] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMWorkCompletedPurchase] TO [Viewpoint]
GO
