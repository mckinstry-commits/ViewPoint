...
GRANT SELECT ON  [dbo].[PCUnionContracts] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PCUnionContracts] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PCUnionContracts] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PCUnionContracts] TO [Viewpoint]
GO
