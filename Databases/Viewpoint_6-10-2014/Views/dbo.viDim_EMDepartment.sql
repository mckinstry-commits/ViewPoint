...
GRANT SELECT ON  [dbo].[viDim_EMDepartment] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_EMDepartment] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_EMDepartment] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_EMDepartment] TO [Viewpoint]
GO
