...
GRANT SELECT ON  [dbo].[SLWHView] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SLWHView] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SLWHView] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SLWHView] TO [Viewpoint]
GO
