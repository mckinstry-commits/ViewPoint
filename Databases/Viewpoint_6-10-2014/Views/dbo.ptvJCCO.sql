...
GRANT SELECT ON  [dbo].[ptvJCCO] TO [Viewpoint]
GRANT INSERT ON  [dbo].[ptvJCCO] TO [Viewpoint]
GRANT DELETE ON  [dbo].[ptvJCCO] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[ptvJCCO] TO [Viewpoint]
GO
