...
GRANT SELECT ON  [dbo].[VPCanvasGridGroupedColumnsUser] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VPCanvasGridGroupedColumnsUser] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VPCanvasGridGroupedColumnsUser] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VPCanvasGridGroupedColumnsUser] TO [Viewpoint]
GO
