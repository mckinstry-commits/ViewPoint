...
GRANT SELECT ON  [dbo].[DDLTForm] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDLTForm] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDLTForm] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDLTForm] TO [Viewpoint]
GO
