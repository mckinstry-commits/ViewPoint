...
GRANT SELECT ON  [dbo].[brvMSQuoteForm] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvMSQuoteForm] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvMSQuoteForm] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvMSQuoteForm] TO [Viewpoint]
GO
