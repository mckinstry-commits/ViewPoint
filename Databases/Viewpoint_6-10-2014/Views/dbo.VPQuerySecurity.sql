...
GRANT SELECT ON  [dbo].[VPQuerySecurity] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VPQuerySecurity] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VPQuerySecurity] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VPQuerySecurity] TO [Viewpoint]
GO
