...
GRANT SELECT ON  [dbo].[MSSurchargeGroups] TO [Viewpoint]
GRANT INSERT ON  [dbo].[MSSurchargeGroups] TO [Viewpoint]
GRANT DELETE ON  [dbo].[MSSurchargeGroups] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[MSSurchargeGroups] TO [Viewpoint]
GO
