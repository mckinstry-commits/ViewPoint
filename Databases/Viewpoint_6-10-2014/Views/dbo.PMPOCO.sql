...
GRANT SELECT ON  [dbo].[PMPOCO] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMPOCO] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMPOCO] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMPOCO] TO [Viewpoint]
GO
