...
SET ANSI_NULLS ON
GO
CREATE view [dbo].[brvSLSubContrByJob] as                           
/**************************                              
...
group by SLIT.SLCo, SLIT.SL, SLIT.SLItem, SLIT.ItemType,         
 SLIT.JCCo, SLIT.Job, TCO.Mth, SLIT.TaxType, TCO.ChgToJCCmtdTax            
...
group by APTL.APCo, APTL.SL, APTL.SLItem, SLIT.ItemType,        
 ...
 APTD.PayCategory, APTD.PaidMth, APTL.TaxType                
...
GO
GRANT SELECT ON  [dbo].[brvSLSubContrByJob] TO [public]
GRANT INSERT ON  [dbo].[brvSLSubContrByJob] TO [public]
GRANT DELETE ON  [dbo].[brvSLSubContrByJob] TO [public]
GRANT UPDATE ON  [dbo].[brvSLSubContrByJob] TO [public]
GRANT SELECT ON  [dbo].[brvSLSubContrByJob] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvSLSubContrByJob] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvSLSubContrByJob] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvSLSubContrByJob] TO [Viewpoint]
GO
