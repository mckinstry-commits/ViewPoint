...
GRANT SELECT ON  [dbo].[udJobResSys] TO [Viewpoint]
GRANT INSERT ON  [dbo].[udJobResSys] TO [Viewpoint]
GRANT DELETE ON  [dbo].[udJobResSys] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[udJobResSys] TO [Viewpoint]
GO
