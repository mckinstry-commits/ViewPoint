...
GRANT SELECT ON  [dbo].[udGovmtSec] TO [Viewpoint]
GRANT INSERT ON  [dbo].[udGovmtSec] TO [Viewpoint]
GRANT DELETE ON  [dbo].[udGovmtSec] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[udGovmtSec] TO [Viewpoint]
GO
