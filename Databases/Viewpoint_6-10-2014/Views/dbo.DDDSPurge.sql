...
GRANT SELECT ON  [dbo].[DDDSPurge] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDDSPurge] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDDSPurge] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDDSPurge] TO [Viewpoint]
GO
