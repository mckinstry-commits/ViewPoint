...
GRANT SELECT ON  [dbo].[PMSubmittalPackage] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMSubmittalPackage] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMSubmittalPackage] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMSubmittalPackage] TO [Viewpoint]
GO
