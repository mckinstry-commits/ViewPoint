...
GRANT SELECT ON  [dbo].[WFMail] TO [Viewpoint]
GRANT INSERT ON  [dbo].[WFMail] TO [Viewpoint]
GRANT DELETE ON  [dbo].[WFMail] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[WFMail] TO [Viewpoint]
GO
