...
GRANT SELECT ON  [dbo].[SLEntryTotal] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SLEntryTotal] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SLEntryTotal] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SLEntryTotal] TO [Viewpoint]
GO
