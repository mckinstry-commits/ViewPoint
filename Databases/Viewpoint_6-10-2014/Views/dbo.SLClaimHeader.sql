...
GRANT SELECT ON  [dbo].[SLClaimHeader] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SLClaimHeader] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SLClaimHeader] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SLClaimHeader] TO [Viewpoint]
GO
