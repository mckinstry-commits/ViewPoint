...
GRANT SELECT ON  [dbo].[ptvPRMechWO] TO [Viewpoint]
GRANT INSERT ON  [dbo].[ptvPRMechWO] TO [Viewpoint]
GRANT DELETE ON  [dbo].[ptvPRMechWO] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[ptvPRMechWO] TO [Viewpoint]
GO
