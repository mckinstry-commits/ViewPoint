...
GRANT SELECT ON  [dbo].[DDCBShared] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDCBShared] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDCBShared] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDCBShared] TO [Viewpoint]
GO
