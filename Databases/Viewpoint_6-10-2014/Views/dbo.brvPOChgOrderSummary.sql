...
GRANT SELECT ON  [dbo].[brvPOChgOrderSummary] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPOChgOrderSummary] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPOChgOrderSummary] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPOChgOrderSummary] TO [Viewpoint]
GO
