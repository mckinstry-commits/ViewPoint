...
GRANT SELECT ON  [dbo].[APULGridTotal] TO [Viewpoint]
GRANT INSERT ON  [dbo].[APULGridTotal] TO [Viewpoint]
GRANT DELETE ON  [dbo].[APULGridTotal] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[APULGridTotal] TO [Viewpoint]
GO
