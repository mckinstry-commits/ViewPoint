...
GRANT SELECT ON  [dbo].[PMPCPct] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMPCPct] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMPCPct] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMPCPct] TO [Viewpoint]
GO
