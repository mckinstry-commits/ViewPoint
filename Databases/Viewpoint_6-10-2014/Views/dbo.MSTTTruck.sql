...
GRANT SELECT ON  [dbo].[MSTTTruck] TO [Viewpoint]
GRANT INSERT ON  [dbo].[MSTTTruck] TO [Viewpoint]
GRANT DELETE ON  [dbo].[MSTTTruck] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[MSTTTruck] TO [Viewpoint]
GO
