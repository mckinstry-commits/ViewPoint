...
GRANT SELECT ON  [dbo].[SLInExclusionsPM] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SLInExclusionsPM] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SLInExclusionsPM] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SLInExclusionsPM] TO [Viewpoint]
GO
