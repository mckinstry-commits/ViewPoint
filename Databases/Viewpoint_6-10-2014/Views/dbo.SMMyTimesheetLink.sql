...
GRANT SELECT ON  [dbo].[SMMyTimesheetLink] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMMyTimesheetLink] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMMyTimesheetLink] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMMyTimesheetLink] TO [Viewpoint]
GO
