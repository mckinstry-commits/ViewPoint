...
GRANT SELECT ON  [dbo].[JCIBGrid] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCIBGrid] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCIBGrid] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCIBGrid] TO [Viewpoint]
GO
