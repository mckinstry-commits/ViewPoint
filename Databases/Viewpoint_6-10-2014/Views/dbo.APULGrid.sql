...
GRANT SELECT ON  [dbo].[APULGrid] TO [Viewpoint]
GRANT INSERT ON  [dbo].[APULGrid] TO [Viewpoint]
GRANT DELETE ON  [dbo].[APULGrid] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[APULGrid] TO [Viewpoint]
GO
