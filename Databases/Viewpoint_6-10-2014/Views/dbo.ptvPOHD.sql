...
GRANT SELECT ON  [dbo].[ptvPOHD] TO [Viewpoint]
GRANT INSERT ON  [dbo].[ptvPOHD] TO [Viewpoint]
GRANT DELETE ON  [dbo].[ptvPOHD] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[ptvPOHD] TO [Viewpoint]
GO
