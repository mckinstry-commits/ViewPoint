...
GRANT SELECT ON  [dbo].[udxrefPREarn] TO [Viewpoint]
GRANT INSERT ON  [dbo].[udxrefPREarn] TO [Viewpoint]
GRANT DELETE ON  [dbo].[udxrefPREarn] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[udxrefPREarn] TO [Viewpoint]
GO
