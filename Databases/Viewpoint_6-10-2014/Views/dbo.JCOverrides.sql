...
GRANT SELECT ON  [dbo].[JCOverrides] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCOverrides] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCOverrides] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCOverrides] TO [Viewpoint]
GO
