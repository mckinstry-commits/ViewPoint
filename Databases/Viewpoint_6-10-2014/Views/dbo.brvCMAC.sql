...
GRANT SELECT ON  [dbo].[brvCMAC] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvCMAC] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvCMAC] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvCMAC] TO [Viewpoint]
GO
