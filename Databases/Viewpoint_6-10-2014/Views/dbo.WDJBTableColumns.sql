...
GRANT SELECT ON  [dbo].[WDJBTableColumns] TO [Viewpoint]
GRANT INSERT ON  [dbo].[WDJBTableColumns] TO [Viewpoint]
GRANT DELETE ON  [dbo].[WDJBTableColumns] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[WDJBTableColumns] TO [Viewpoint]
GO
