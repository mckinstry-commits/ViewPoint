...
GRANT SELECT ON  [dbo].[PMFMResp] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMFMResp] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMFMResp] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMFMResp] TO [Viewpoint]
GO
