...
GRANT SELECT ON  [dbo].[brvSLClaimTaxInvoice] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvSLClaimTaxInvoice] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvSLClaimTaxInvoice] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvSLClaimTaxInvoice] TO [Viewpoint]
GO
