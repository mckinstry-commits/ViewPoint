...
GRANT SELECT ON  [dbo].[DDSLc] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDSLc] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDSLc] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDSLc] TO [Viewpoint]
GO
