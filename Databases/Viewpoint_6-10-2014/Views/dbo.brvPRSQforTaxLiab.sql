...
GRANT SELECT ON  [dbo].[brvPRSQforTaxLiab] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPRSQforTaxLiab] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPRSQforTaxLiab] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPRSQforTaxLiab] TO [Viewpoint]
GO
