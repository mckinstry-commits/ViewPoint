...
GRANT SELECT ON  [dbo].[IMKVImportId] TO [Viewpoint]
GRANT INSERT ON  [dbo].[IMKVImportId] TO [Viewpoint]
GRANT DELETE ON  [dbo].[IMKVImportId] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[IMKVImportId] TO [Viewpoint]
GO
