...
GRANT SELECT ON  [dbo].[PRW2MiscDetail] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PRW2MiscDetail] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PRW2MiscDetail] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PRW2MiscDetail] TO [Viewpoint]
GO
