...
GRANT SELECT ON  [dbo].[frl_seg_tree] TO [Viewpoint]
GRANT INSERT ON  [dbo].[frl_seg_tree] TO [Viewpoint]
GRANT DELETE ON  [dbo].[frl_seg_tree] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[frl_seg_tree] TO [Viewpoint]
GO
