...
GRANT SELECT ON  [dbo].[PRABGrid] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PRABGrid] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PRABGrid] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PRABGrid] TO [Viewpoint]
GO
