...
GRANT SELECT ON  [dbo].[viFact_JCCompanySecureUsers] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viFact_JCCompanySecureUsers] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viFact_JCCompanySecureUsers] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viFact_JCCompanySecureUsers] TO [Viewpoint]
GO
