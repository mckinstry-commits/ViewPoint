...
GRANT SELECT ON  [dbo].[udxrefEMCostType] TO [Viewpoint]
GRANT INSERT ON  [dbo].[udxrefEMCostType] TO [Viewpoint]
GRANT DELETE ON  [dbo].[udxrefEMCostType] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[udxrefEMCostType] TO [Viewpoint]
GO
