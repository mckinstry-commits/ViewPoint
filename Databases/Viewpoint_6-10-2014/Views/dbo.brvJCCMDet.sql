...
GRANT SELECT ON  [dbo].[brvJCCMDet] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvJCCMDet] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvJCCMDet] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvJCCMDet] TO [Viewpoint]
GO
