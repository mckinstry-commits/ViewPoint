...
GRANT SELECT ON  [dbo].[APOnCostWorkFileDetail] TO [Viewpoint]
GRANT INSERT ON  [dbo].[APOnCostWorkFileDetail] TO [Viewpoint]
GRANT DELETE ON  [dbo].[APOnCostWorkFileDetail] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[APOnCostWorkFileDetail] TO [Viewpoint]
GO
