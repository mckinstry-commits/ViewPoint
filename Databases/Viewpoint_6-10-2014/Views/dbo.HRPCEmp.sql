...
GRANT SELECT ON  [dbo].[HRPCEmp] TO [Viewpoint]
GRANT INSERT ON  [dbo].[HRPCEmp] TO [Viewpoint]
GRANT DELETE ON  [dbo].[HRPCEmp] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[HRPCEmp] TO [Viewpoint]
GO
