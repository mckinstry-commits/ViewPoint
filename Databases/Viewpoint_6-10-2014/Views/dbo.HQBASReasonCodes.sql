...
GRANT SELECT ON  [dbo].[HQBASReasonCodes] TO [Viewpoint]
GRANT INSERT ON  [dbo].[HQBASReasonCodes] TO [Viewpoint]
GRANT DELETE ON  [dbo].[HQBASReasonCodes] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[HQBASReasonCodes] TO [Viewpoint]
GO
