...
GRANT SELECT ON  [dbo].[viDim_EMWorkOrder] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_EMWorkOrder] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_EMWorkOrder] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_EMWorkOrder] TO [Viewpoint]
GO
