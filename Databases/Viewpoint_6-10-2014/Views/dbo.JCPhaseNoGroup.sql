...
GRANT SELECT ON  [dbo].[JCPhaseNoGroup] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCPhaseNoGroup] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCPhaseNoGroup] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCPhaseNoGroup] TO [Viewpoint]
GO
