...
GRANT SELECT ON  [dbo].[HRADMAIN] TO [Viewpoint]
GRANT INSERT ON  [dbo].[HRADMAIN] TO [Viewpoint]
GRANT DELETE ON  [dbo].[HRADMAIN] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[HRADMAIN] TO [Viewpoint]
GO
