...
Revision History        
	...
	06/04/13 ScottAlvey TFS-44858 Change AR Batch creation and posting for SM Invoices
...
GRANT SELECT ON  [dbo].[vrvSMInvoicesByInvoiceNumber] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvSMInvoicesByInvoiceNumber] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvSMInvoicesByInvoiceNumber] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvSMInvoicesByInvoiceNumber] TO [Viewpoint]
GO
