...
GRANT SELECT ON  [dbo].[MSHaulCodeNoCompany] TO [Viewpoint]
GRANT INSERT ON  [dbo].[MSHaulCodeNoCompany] TO [Viewpoint]
GRANT DELETE ON  [dbo].[MSHaulCodeNoCompany] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[MSHaulCodeNoCompany] TO [Viewpoint]
GO
