...
GRANT SELECT ON  [dbo].[brvViewLookup] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvViewLookup] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvViewLookup] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvViewLookup] TO [Viewpoint]
GO
