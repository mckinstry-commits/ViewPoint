...
GRANT SELECT ON  [dbo].[brvPOCurCost] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPOCurCost] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPOCurCost] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPOCurCost] TO [Viewpoint]
GO
