...
GRANT SELECT ON  [dbo].[brvEMGLFiscalPeriods] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvEMGLFiscalPeriods] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvEMGLFiscalPeriods] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvEMGLFiscalPeriods] TO [Viewpoint]
GO
