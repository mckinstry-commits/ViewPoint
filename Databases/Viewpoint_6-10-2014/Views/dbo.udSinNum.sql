...
GRANT SELECT ON  [dbo].[udSinNum] TO [Viewpoint]
GRANT INSERT ON  [dbo].[udSinNum] TO [Viewpoint]
GRANT DELETE ON  [dbo].[udSinNum] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[udSinNum] TO [Viewpoint]
GO
