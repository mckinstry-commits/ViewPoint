...
GRANT SELECT ON  [dbo].[VADDFSUsersAndGroups] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VADDFSUsersAndGroups] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VADDFSUsersAndGroups] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VADDFSUsersAndGroups] TO [Viewpoint]
GO
