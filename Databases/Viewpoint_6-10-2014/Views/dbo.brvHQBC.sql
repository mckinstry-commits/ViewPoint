...
GRANT SELECT ON  [dbo].[brvHQBC] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvHQBC] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvHQBC] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvHQBC] TO [Viewpoint]
GO
