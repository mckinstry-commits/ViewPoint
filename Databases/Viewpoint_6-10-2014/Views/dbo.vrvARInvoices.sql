...
GRANT SELECT ON  [dbo].[vrvARInvoices] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvARInvoices] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvARInvoices] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvARInvoices] TO [Viewpoint]
GO
