...
GRANT SELECT ON  [dbo].[viFact_EMWarranty] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viFact_EMWarranty] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viFact_EMWarranty] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viFact_EMWarranty] TO [Viewpoint]
GO
