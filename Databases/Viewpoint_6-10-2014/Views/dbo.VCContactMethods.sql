...
GRANT SELECT ON  [dbo].[VCContactMethods] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VCContactMethods] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VCContactMethods] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VCContactMethods] TO [Viewpoint]
GO
