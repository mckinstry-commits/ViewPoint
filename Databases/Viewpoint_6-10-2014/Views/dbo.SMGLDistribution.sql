...
GRANT SELECT ON  [dbo].[SMGLDistribution] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMGLDistribution] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMGLDistribution] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMGLDistribution] TO [Viewpoint]
GO
