...
GRANT SELECT ON  [dbo].[viFact_INCurrentInventory] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viFact_INCurrentInventory] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viFact_INCurrentInventory] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viFact_INCurrentInventory] TO [Viewpoint]
GO
