...
GRANT SELECT ON  [dbo].[JCForecastTotalsRev] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCForecastTotalsRev] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCForecastTotalsRev] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCForecastTotalsRev] TO [Viewpoint]
GO
