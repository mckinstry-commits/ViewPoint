...
GRANT SELECT ON  [dbo].[VCPasswordRules] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VCPasswordRules] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VCPasswordRules] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VCPasswordRules] TO [Viewpoint]
GO
