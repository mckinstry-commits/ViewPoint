...
GRANT SELECT ON  [dbo].[PMDHPunch] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMDHPunch] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMDHPunch] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMDHPunch] TO [Viewpoint]
GO
