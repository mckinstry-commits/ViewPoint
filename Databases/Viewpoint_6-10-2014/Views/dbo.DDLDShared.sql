...
GRANT SELECT ON  [dbo].[DDLDShared] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDLDShared] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDLDShared] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDLDShared] TO [Viewpoint]
GO
