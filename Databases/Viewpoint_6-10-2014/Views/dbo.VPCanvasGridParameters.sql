...
GRANT SELECT ON  [dbo].[VPCanvasGridParameters] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VPCanvasGridParameters] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VPCanvasGridParameters] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VPCanvasGridParameters] TO [Viewpoint]
GO
