...
GRANT SELECT ON  [dbo].[viDim_EMCategory] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_EMCategory] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_EMCategory] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_EMCategory] TO [Viewpoint]
GO
