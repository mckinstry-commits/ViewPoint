...
GRANT SELECT ON  [dbo].[APRLTotals] TO [Viewpoint]
GRANT INSERT ON  [dbo].[APRLTotals] TO [Viewpoint]
GRANT DELETE ON  [dbo].[APRLTotals] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[APRLTotals] TO [Viewpoint]
GO
