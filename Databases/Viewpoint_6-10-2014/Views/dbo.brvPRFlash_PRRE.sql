...
GO
   ...
   CREATE  view [dbo].[brvPRFlash_PRRE] as
   select
   	PRRH.PRCo, PRRH.Crew, PRRH.PostDate, PRRH.SheetNum, PRRH.PRGroup, PRRH.JCCo, PRRH.Job,PRRH.PhaseGroup, 
           Phase = PRRH.Phase1,  PhaseUnits=PRRH.Phase1Units, CostType=PRRH.Phase1CostType, Record='1',PRRH.Status, PRRE.Employee, PRRE.LineSeq, 	PRRE.Craft, PRRE.Class, RegHrs = PRRE.Phase1RegHrs, OT_Hrs=PRRE.Phase1OTHrs, 
...
GO
GRANT SELECT ON  [dbo].[brvPRFlash_PRRE] TO [public]
GRANT INSERT ON  [dbo].[brvPRFlash_PRRE] TO [public]
GRANT DELETE ON  [dbo].[brvPRFlash_PRRE] TO [public]
GRANT UPDATE ON  [dbo].[brvPRFlash_PRRE] TO [public]
GRANT SELECT ON  [dbo].[brvPRFlash_PRRE] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPRFlash_PRRE] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPRFlash_PRRE] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPRFlash_PRRE] TO [Viewpoint]
GO
