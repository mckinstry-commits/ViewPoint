...
GRANT SELECT ON  [dbo].[vrvPCSubcontractRisk] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvPCSubcontractRisk] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvPCSubcontractRisk] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvPCSubcontractRisk] TO [Viewpoint]
GO
