...
GRANT SELECT ON  [dbo].[PMPCOApprove] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMPCOApprove] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMPCOApprove] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMPCOApprove] TO [Viewpoint]
GO
