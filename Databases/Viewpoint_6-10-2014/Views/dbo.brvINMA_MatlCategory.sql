...
GRANT SELECT ON  [dbo].[brvINMA_MatlCategory] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvINMA_MatlCategory] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvINMA_MatlCategory] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvINMA_MatlCategory] TO [Viewpoint]
GO
