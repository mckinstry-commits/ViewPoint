...
GRANT SELECT ON  [dbo].[brvPMBuyOutACO] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPMBuyOutACO] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPMBuyOutACO] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPMBuyOutACO] TO [Viewpoint]
GO
