...
GRANT SELECT ON  [dbo].[JCJMJobs] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCJMJobs] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCJMJobs] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCJMJobs] TO [Viewpoint]
GO
