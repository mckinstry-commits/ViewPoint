...
GRANT SELECT ON  [dbo].[PRCAEmployerItemLookup] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PRCAEmployerItemLookup] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PRCAEmployerItemLookup] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PRCAEmployerItemLookup] TO [Viewpoint]
GO
