...
GRANT SELECT ON  [dbo].[viDim_EMCompany] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_EMCompany] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_EMCompany] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_EMCompany] TO [Viewpoint]
GO
