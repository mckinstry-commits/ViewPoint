...
GRANT SELECT ON  [dbo].[IMTDLookup] TO [Viewpoint]
GRANT INSERT ON  [dbo].[IMTDLookup] TO [Viewpoint]
GRANT DELETE ON  [dbo].[IMTDLookup] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[IMTDLookup] TO [Viewpoint]
GO
