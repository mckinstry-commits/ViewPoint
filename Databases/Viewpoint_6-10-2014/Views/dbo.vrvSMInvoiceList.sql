...
GRANT SELECT ON  [dbo].[vrvSMInvoiceList] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvSMInvoiceList] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvSMInvoiceList] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvSMInvoiceList] TO [Viewpoint]
GO
