...
GRANT SELECT ON  [dbo].[brvAROpenTrans] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvAROpenTrans] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvAROpenTrans] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvAROpenTrans] TO [Viewpoint]
GO
