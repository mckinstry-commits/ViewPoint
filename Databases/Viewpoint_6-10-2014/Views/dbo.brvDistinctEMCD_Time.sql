...
GRANT SELECT ON  [dbo].[brvDistinctEMCD_Time] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvDistinctEMCD_Time] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvDistinctEMCD_Time] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvDistinctEMCD_Time] TO [Viewpoint]
GO
