...
GRANT SELECT ON  [dbo].[PMDHSubmittal] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMDHSubmittal] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMDHSubmittal] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMDHSubmittal] TO [Viewpoint]
GO
