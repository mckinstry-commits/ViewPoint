...
GRANT SELECT ON  [dbo].[vrvPMDistInspectionLogs] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvPMDistInspectionLogs] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvPMDistInspectionLogs] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvPMDistInspectionLogs] TO [Viewpoint]
GO
