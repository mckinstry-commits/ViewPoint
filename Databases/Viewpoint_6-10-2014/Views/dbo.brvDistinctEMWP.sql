...
GRANT SELECT ON  [dbo].[brvDistinctEMWP] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvDistinctEMWP] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvDistinctEMWP] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvDistinctEMWP] TO [Viewpoint]
GO
