...
GRANT SELECT ON  [dbo].[EMBFFuelInit] TO [Viewpoint]
GRANT INSERT ON  [dbo].[EMBFFuelInit] TO [Viewpoint]
GRANT DELETE ON  [dbo].[EMBFFuelInit] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[EMBFFuelInit] TO [Viewpoint]
GO
