...
GRANT SELECT ON  [dbo].[pvPMMinutesType] TO [Viewpoint]
GRANT INSERT ON  [dbo].[pvPMMinutesType] TO [Viewpoint]
GRANT DELETE ON  [dbo].[pvPMMinutesType] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[pvPMMinutesType] TO [Viewpoint]
GO
