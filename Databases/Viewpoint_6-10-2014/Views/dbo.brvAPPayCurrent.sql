...
GRANT SELECT ON  [dbo].[brvAPPayCurrent] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvAPPayCurrent] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvAPPayCurrent] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvAPPayCurrent] TO [Viewpoint]
GO
