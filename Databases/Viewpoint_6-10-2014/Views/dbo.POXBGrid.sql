...
GRANT SELECT ON  [dbo].[POXBGrid] TO [Viewpoint]
GRANT INSERT ON  [dbo].[POXBGrid] TO [Viewpoint]
GRANT DELETE ON  [dbo].[POXBGrid] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[POXBGrid] TO [Viewpoint]
GO
