...
GRANT SELECT ON  [dbo].[SMWorkOrder] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMWorkOrder] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMWorkOrder] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMWorkOrder] TO [Viewpoint]
GO
