...
GRANT SELECT ON  [dbo].[pvPMIssueStatus] TO [Viewpoint]
GRANT INSERT ON  [dbo].[pvPMIssueStatus] TO [Viewpoint]
GRANT DELETE ON  [dbo].[pvPMIssueStatus] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[pvPMIssueStatus] TO [Viewpoint]
GO
