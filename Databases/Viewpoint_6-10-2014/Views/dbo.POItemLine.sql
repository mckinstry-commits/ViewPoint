...
GRANT SELECT ON  [dbo].[POItemLine] TO [Viewpoint]
GRANT INSERT ON  [dbo].[POItemLine] TO [Viewpoint]
GRANT DELETE ON  [dbo].[POItemLine] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[POItemLine] TO [Viewpoint]
GO
