...
GRANT SELECT ON  [dbo].[EMSMLastReadDate] TO [Viewpoint]
GRANT INSERT ON  [dbo].[EMSMLastReadDate] TO [Viewpoint]
GRANT DELETE ON  [dbo].[EMSMLastReadDate] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[EMSMLastReadDate] TO [Viewpoint]
GO
