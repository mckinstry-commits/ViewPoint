...
GRANT SELECT ON  [dbo].[PMDHDrawingRev] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMDHDrawingRev] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMDHDrawingRev] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMDHDrawingRev] TO [Viewpoint]
GO
