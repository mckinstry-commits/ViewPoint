...
GRANT SELECT ON  [dbo].[viDim_EMCostType] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_EMCostType] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_EMCostType] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_EMCostType] TO [Viewpoint]
GO
