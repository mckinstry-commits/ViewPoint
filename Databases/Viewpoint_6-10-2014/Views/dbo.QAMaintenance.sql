...
GRANT SELECT ON  [dbo].[QAMaintenance] TO [Viewpoint]
GRANT INSERT ON  [dbo].[QAMaintenance] TO [Viewpoint]
GRANT DELETE ON  [dbo].[QAMaintenance] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[QAMaintenance] TO [Viewpoint]
GO
