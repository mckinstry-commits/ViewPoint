...
GRANT SELECT ON  [dbo].[PMDGUnionPMDR] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMDGUnionPMDR] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMDGUnionPMDR] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMDGUnionPMDR] TO [Viewpoint]
GO
