...
GRANT SELECT ON  [dbo].[APOnCostType] TO [Viewpoint]
GRANT INSERT ON  [dbo].[APOnCostType] TO [Viewpoint]
GRANT DELETE ON  [dbo].[APOnCostType] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[APOnCostType] TO [Viewpoint]
GO
