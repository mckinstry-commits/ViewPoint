...
GRANT SELECT ON  [dbo].[vDDFHSecurable] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vDDFHSecurable] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vDDFHSecurable] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vDDFHSecurable] TO [Viewpoint]
GO
