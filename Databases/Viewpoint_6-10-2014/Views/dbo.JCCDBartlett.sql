...
GRANT SELECT ON  [dbo].[JCCDBartlett] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCCDBartlett] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCCDBartlett] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCCDBartlett] TO [Viewpoint]
GO
