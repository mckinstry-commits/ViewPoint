...
GRANT SELECT ON  [dbo].[DDTDShared] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDTDShared] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDTDShared] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDTDShared] TO [Viewpoint]
GO
