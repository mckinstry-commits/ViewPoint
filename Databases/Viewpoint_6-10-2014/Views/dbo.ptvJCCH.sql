...
GRANT SELECT ON  [dbo].[ptvJCCH] TO [Viewpoint]
GRANT INSERT ON  [dbo].[ptvJCCH] TO [Viewpoint]
GRANT DELETE ON  [dbo].[ptvJCCH] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[ptvJCCH] TO [Viewpoint]
GO
