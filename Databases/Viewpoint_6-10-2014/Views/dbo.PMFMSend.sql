...
GRANT SELECT ON  [dbo].[PMFMSend] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMFMSend] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMFMSend] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMFMSend] TO [Viewpoint]
GO
