...
GRANT SELECT ON  [dbo].[vrvJCLastMonthOfActivityByContract] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvJCLastMonthOfActivityByContract] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvJCLastMonthOfActivityByContract] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvJCLastMonthOfActivityByContract] TO [Viewpoint]
GO
