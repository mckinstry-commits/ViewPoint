...
GRANT SELECT ON  [dbo].[VCPortalControls] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VCPortalControls] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VCPortalControls] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VCPortalControls] TO [Viewpoint]
GO
