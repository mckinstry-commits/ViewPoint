...
CREATE		VIEW [dbo].[brvJCCostRevenue]
	AS
...
GO
GRANT SELECT ON  [dbo].[brvJCCostRevenue] TO [public]
GRANT INSERT ON  [dbo].[brvJCCostRevenue] TO [public]
GRANT DELETE ON  [dbo].[brvJCCostRevenue] TO [public]
GRANT UPDATE ON  [dbo].[brvJCCostRevenue] TO [public]
GRANT SELECT ON  [dbo].[brvJCCostRevenue] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvJCCostRevenue] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvJCCostRevenue] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvJCCostRevenue] TO [Viewpoint]
GO
