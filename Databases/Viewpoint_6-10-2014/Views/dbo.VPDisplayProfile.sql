...
GRANT SELECT ON  [dbo].[VPDisplayProfile] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VPDisplayProfile] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VPDisplayProfile] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VPDisplayProfile] TO [Viewpoint]
GO
