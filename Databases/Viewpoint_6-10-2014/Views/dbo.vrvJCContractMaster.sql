...
GRANT SELECT ON  [dbo].[vrvJCContractMaster] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvJCContractMaster] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvJCContractMaster] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvJCContractMaster] TO [Viewpoint]
GO
