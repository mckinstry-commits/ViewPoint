...
GRANT SELECT ON  [dbo].[SMDeliveryGroupInvoice] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMDeliveryGroupInvoice] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMDeliveryGroupInvoice] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMDeliveryGroupInvoice] TO [Viewpoint]
GO
