...
GRANT SELECT ON  [dbo].[SMAgreementServiceDate] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMAgreementServiceDate] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMAgreementServiceDate] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMAgreementServiceDate] TO [Viewpoint]
GO
