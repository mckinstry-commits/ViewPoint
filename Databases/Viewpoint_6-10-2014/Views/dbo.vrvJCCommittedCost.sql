...
GRANT SELECT ON  [dbo].[vrvJCCommittedCost] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvJCCommittedCost] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvJCCommittedCost] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvJCCommittedCost] TO [Viewpoint]
GO
