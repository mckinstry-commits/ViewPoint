...
GRANT SELECT ON  [dbo].[vrvAPPBaus] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvAPPBaus] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvAPPBaus] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvAPPBaus] TO [Viewpoint]
GO
