 ...
 * test firm Contacts in PM Document Tracking.
 *
 *****************************************/

CREATE  view [dbo].[PMPMTest] as
		select a.*,
...
GO
GRANT SELECT ON  [dbo].[PMPMTest] TO [public]
GRANT INSERT ON  [dbo].[PMPMTest] TO [public]
GRANT DELETE ON  [dbo].[PMPMTest] TO [public]
GRANT UPDATE ON  [dbo].[PMPMTest] TO [public]
GRANT SELECT ON  [dbo].[PMPMTest] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMPMTest] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMPMTest] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMPMTest] TO [Viewpoint]
GO
