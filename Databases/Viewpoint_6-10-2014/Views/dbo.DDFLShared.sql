...
GRANT SELECT ON  [dbo].[DDFLShared] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDFLShared] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDFLShared] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDFLShared] TO [Viewpoint]
GO
