...
GRANT SELECT ON  [dbo].[viFact_HRCobra] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viFact_HRCobra] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viFact_HRCobra] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viFact_HRCobra] TO [Viewpoint]
GO
