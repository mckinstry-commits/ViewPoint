...
GRANT SELECT ON  [dbo].[vrvPRCrewOtherJob] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvPRCrewOtherJob] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvPRCrewOtherJob] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvPRCrewOtherJob] TO [Viewpoint]
GO
