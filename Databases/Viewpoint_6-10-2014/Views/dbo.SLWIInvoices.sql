...
GRANT SELECT ON  [dbo].[SLWIInvoices] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SLWIInvoices] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SLWIInvoices] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SLWIInvoices] TO [Viewpoint]
GO
