...
GRANT SELECT ON  [dbo].[RPRTShared] TO [Viewpoint]
GRANT INSERT ON  [dbo].[RPRTShared] TO [Viewpoint]
GRANT DELETE ON  [dbo].[RPRTShared] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[RPRTShared] TO [Viewpoint]
GO
