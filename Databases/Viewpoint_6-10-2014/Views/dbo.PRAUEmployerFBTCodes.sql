...
GRANT SELECT ON  [dbo].[PRAUEmployerFBTCodes] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PRAUEmployerFBTCodes] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PRAUEmployerFBTCodes] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PRAUEmployerFBTCodes] TO [Viewpoint]
GO
