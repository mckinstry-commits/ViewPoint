...
GRANT SELECT ON  [dbo].[DDRelatedFormsShared] TO [Viewpoint]
GRANT INSERT ON  [dbo].[DDRelatedFormsShared] TO [Viewpoint]
GRANT DELETE ON  [dbo].[DDRelatedFormsShared] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[DDRelatedFormsShared] TO [Viewpoint]
GO
