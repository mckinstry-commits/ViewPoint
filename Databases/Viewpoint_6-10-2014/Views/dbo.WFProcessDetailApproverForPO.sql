...
GRANT SELECT ON  [dbo].[WFProcessDetailApproverForPO] TO [Viewpoint]
GRANT INSERT ON  [dbo].[WFProcessDetailApproverForPO] TO [Viewpoint]
GRANT DELETE ON  [dbo].[WFProcessDetailApproverForPO] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[WFProcessDetailApproverForPO] TO [Viewpoint]
GO
