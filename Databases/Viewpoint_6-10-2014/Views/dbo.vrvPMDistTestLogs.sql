...
GRANT SELECT ON  [dbo].[vrvPMDistTestLogs] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvPMDistTestLogs] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvPMDistTestLogs] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvPMDistTestLogs] TO [Viewpoint]
GO
