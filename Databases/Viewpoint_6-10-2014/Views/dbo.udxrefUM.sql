...
GRANT SELECT ON  [dbo].[udxrefUM] TO [Viewpoint]
GRANT INSERT ON  [dbo].[udxrefUM] TO [Viewpoint]
GRANT DELETE ON  [dbo].[udxrefUM] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[udxrefUM] TO [Viewpoint]
GO
