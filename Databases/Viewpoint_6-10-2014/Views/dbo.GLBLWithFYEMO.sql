...
GRANT SELECT ON  [dbo].[GLBLWithFYEMO] TO [Viewpoint]
GRANT INSERT ON  [dbo].[GLBLWithFYEMO] TO [Viewpoint]
GRANT DELETE ON  [dbo].[GLBLWithFYEMO] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[GLBLWithFYEMO] TO [Viewpoint]
GO
