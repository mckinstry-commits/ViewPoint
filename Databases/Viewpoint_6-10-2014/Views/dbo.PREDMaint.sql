...
GRANT SELECT ON  [dbo].[PREDMaint] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PREDMaint] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PREDMaint] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PREDMaint] TO [Viewpoint]
GO
