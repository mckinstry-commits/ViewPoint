...
GRANT SELECT ON  [dbo].[VCContactTypes] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VCContactTypes] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VCContactTypes] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VCContactTypes] TO [Viewpoint]
GO
