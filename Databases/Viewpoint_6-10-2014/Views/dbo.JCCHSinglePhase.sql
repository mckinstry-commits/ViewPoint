...
GRANT SELECT ON  [dbo].[JCCHSinglePhase] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCCHSinglePhase] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCCHSinglePhase] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCCHSinglePhase] TO [Viewpoint]
GO
