...
GRANT SELECT ON  [dbo].[PRLedgerUpdateJCCostEntryTransaction] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PRLedgerUpdateJCCostEntryTransaction] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PRLedgerUpdateJCCostEntryTransaction] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PRLedgerUpdateJCCostEntryTransaction] TO [Viewpoint]
GO
