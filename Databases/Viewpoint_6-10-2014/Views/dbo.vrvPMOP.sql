...
GRANT SELECT ON  [dbo].[vrvPMOP] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvPMOP] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvPMOP] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvPMOP] TO [Viewpoint]
GO
