...
GRANT SELECT ON  [dbo].[udJNRFResSys] TO [Viewpoint]
GRANT INSERT ON  [dbo].[udJNRFResSys] TO [Viewpoint]
GRANT DELETE ON  [dbo].[udJNRFResSys] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[udJNRFResSys] TO [Viewpoint]
GO
