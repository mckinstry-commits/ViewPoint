...
GRANT SELECT ON  [dbo].[vrvPRCrewEquipSub] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvPRCrewEquipSub] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvPRCrewEquipSub] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvPRCrewEquipSub] TO [Viewpoint]
GO
