...
GRANT SELECT ON  [dbo].[brvSLChangeOrders] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvSLChangeOrders] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvSLChangeOrders] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvSLChangeOrders] TO [Viewpoint]
GO
