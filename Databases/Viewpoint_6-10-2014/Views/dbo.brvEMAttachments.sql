...
GRANT SELECT ON  [dbo].[brvEMAttachments] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvEMAttachments] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvEMAttachments] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvEMAttachments] TO [Viewpoint]
GO
