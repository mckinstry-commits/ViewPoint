...
GRANT SELECT ON  [dbo].[APTransTotals] TO [Viewpoint]
GRANT INSERT ON  [dbo].[APTransTotals] TO [Viewpoint]
GRANT DELETE ON  [dbo].[APTransTotals] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[APTransTotals] TO [Viewpoint]
GO
