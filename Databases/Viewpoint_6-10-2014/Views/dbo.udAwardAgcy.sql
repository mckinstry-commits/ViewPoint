...
GRANT SELECT ON  [dbo].[udAwardAgcy] TO [Viewpoint]
GRANT INSERT ON  [dbo].[udAwardAgcy] TO [Viewpoint]
GRANT DELETE ON  [dbo].[udAwardAgcy] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[udAwardAgcy] TO [Viewpoint]
GO
