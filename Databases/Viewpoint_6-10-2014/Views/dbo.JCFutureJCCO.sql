...
GRANT SELECT ON  [dbo].[JCFutureJCCO] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCFutureJCCO] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCFutureJCCO] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCFutureJCCO] TO [Viewpoint]
GO
