...
GRANT SELECT ON  [dbo].[vrvJCCP] TO [Viewpoint]
GRANT INSERT ON  [dbo].[vrvJCCP] TO [Viewpoint]
GRANT DELETE ON  [dbo].[vrvJCCP] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[vrvJCCP] TO [Viewpoint]
GO
