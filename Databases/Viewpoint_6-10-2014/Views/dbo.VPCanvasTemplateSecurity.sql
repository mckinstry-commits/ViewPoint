...
GRANT SELECT ON  [dbo].[VPCanvasTemplateSecurity] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VPCanvasTemplateSecurity] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VPCanvasTemplateSecurity] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VPCanvasTemplateSecurity] TO [Viewpoint]
GO
