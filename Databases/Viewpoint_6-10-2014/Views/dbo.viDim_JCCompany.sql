...
GRANT SELECT ON  [dbo].[viDim_JCCompany] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_JCCompany] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_JCCompany] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_JCCompany] TO [Viewpoint]
GO
