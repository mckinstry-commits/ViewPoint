...
GRANT SELECT ON  [dbo].[VCSiteAttachments] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VCSiteAttachments] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VCSiteAttachments] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VCSiteAttachments] TO [Viewpoint]
GO
