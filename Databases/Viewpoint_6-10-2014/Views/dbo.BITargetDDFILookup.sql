...
GRANT SELECT ON  [dbo].[BITargetDDFILookup] TO [Viewpoint]
GRANT INSERT ON  [dbo].[BITargetDDFILookup] TO [Viewpoint]
GRANT DELETE ON  [dbo].[BITargetDDFILookup] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[BITargetDDFILookup] TO [Viewpoint]
GO
