...
GRANT SELECT ON  [dbo].[JCIPForJCIR] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCIPForJCIR] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCIPForJCIR] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCIPForJCIR] TO [Viewpoint]
GO
