...
GRANT SELECT ON  [dbo].[WFProcessDetailApprover] TO [Viewpoint]
GRANT INSERT ON  [dbo].[WFProcessDetailApprover] TO [Viewpoint]
GRANT DELETE ON  [dbo].[WFProcessDetailApprover] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[WFProcessDetailApprover] TO [Viewpoint]
GO
