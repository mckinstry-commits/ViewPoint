...
GRANT SELECT ON  [dbo].[HRDLGrid] TO [Viewpoint]
GRANT INSERT ON  [dbo].[HRDLGrid] TO [Viewpoint]
GRANT DELETE ON  [dbo].[HRDLGrid] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[HRDLGrid] TO [Viewpoint]
GO
