...
GRANT SELECT ON  [dbo].[WDJobParameters] TO [Viewpoint]
GRANT INSERT ON  [dbo].[WDJobParameters] TO [Viewpoint]
GRANT DELETE ON  [dbo].[WDJobParameters] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[WDJobParameters] TO [Viewpoint]
GO
