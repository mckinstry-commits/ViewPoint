...
GRANT SELECT ON  [dbo].[viDim_MSCompany] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_MSCompany] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_MSCompany] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_MSCompany] TO [Viewpoint]
GO
