...
GRANT SELECT ON  [dbo].[JCJobRolesPM] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCJobRolesPM] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCJobRolesPM] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCJobRolesPM] TO [Viewpoint]
GO
