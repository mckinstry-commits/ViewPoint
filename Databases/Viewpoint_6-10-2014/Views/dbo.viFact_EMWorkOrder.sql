...
GRANT SELECT ON  [dbo].[viFact_EMWorkOrder] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viFact_EMWorkOrder] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viFact_EMWorkOrder] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viFact_EMWorkOrder] TO [Viewpoint]
GO
