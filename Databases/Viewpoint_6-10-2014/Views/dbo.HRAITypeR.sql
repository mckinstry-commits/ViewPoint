...
GRANT SELECT ON  [dbo].[HRAITypeR] TO [Viewpoint]
GRANT INSERT ON  [dbo].[HRAITypeR] TO [Viewpoint]
GRANT DELETE ON  [dbo].[HRAITypeR] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[HRAITypeR] TO [Viewpoint]
GO
