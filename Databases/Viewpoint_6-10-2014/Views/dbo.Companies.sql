...
GRANT SELECT ON  [dbo].[Companies] TO [Viewpoint]
GRANT INSERT ON  [dbo].[Companies] TO [Viewpoint]
GRANT DELETE ON  [dbo].[Companies] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[Companies] TO [Viewpoint]
GO
