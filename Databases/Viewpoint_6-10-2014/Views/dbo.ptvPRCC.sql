...
GRANT SELECT ON  [dbo].[ptvPRCC] TO [Viewpoint]
GRANT INSERT ON  [dbo].[ptvPRCC] TO [Viewpoint]
GRANT DELETE ON  [dbo].[ptvPRCC] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[ptvPRCC] TO [Viewpoint]
GO
