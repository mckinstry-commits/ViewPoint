...
GRANT SELECT ON  [dbo].[VPPartFormChangedParameters] TO [Viewpoint]
GRANT INSERT ON  [dbo].[VPPartFormChangedParameters] TO [Viewpoint]
GRANT DELETE ON  [dbo].[VPPartFormChangedParameters] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[VPPartFormChangedParameters] TO [Viewpoint]
GO
