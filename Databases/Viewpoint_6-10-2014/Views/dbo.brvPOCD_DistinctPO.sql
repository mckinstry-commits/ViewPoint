...
GRANT SELECT ON  [dbo].[brvPOCD_DistinctPO] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvPOCD_DistinctPO] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvPOCD_DistinctPO] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvPOCD_DistinctPO] TO [Viewpoint]
GO
