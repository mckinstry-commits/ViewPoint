...
GRANT SELECT ON  [dbo].[brvGLFSSum] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvGLFSSum] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvGLFSSum] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvGLFSSum] TO [Viewpoint]
GO
