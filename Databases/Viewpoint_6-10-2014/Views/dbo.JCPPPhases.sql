...
GRANT SELECT ON  [dbo].[JCPPPhases] TO [Viewpoint]
GRANT INSERT ON  [dbo].[JCPPPhases] TO [Viewpoint]
GRANT DELETE ON  [dbo].[JCPPPhases] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[JCPPPhases] TO [Viewpoint]
GO
