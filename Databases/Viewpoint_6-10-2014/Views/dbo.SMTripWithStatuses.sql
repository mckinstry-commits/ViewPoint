...
GRANT SELECT ON  [dbo].[SMTripWithStatuses] TO [Viewpoint]
GRANT INSERT ON  [dbo].[SMTripWithStatuses] TO [Viewpoint]
GRANT DELETE ON  [dbo].[SMTripWithStatuses] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[SMTripWithStatuses] TO [Viewpoint]
GO
