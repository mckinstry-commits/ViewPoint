...
GRANT SELECT ON  [dbo].[PMSCOTotal] TO [Viewpoint]
GRANT INSERT ON  [dbo].[PMSCOTotal] TO [Viewpoint]
GRANT DELETE ON  [dbo].[PMSCOTotal] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[PMSCOTotal] TO [Viewpoint]
GO
