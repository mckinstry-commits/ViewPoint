...
GRANT SELECT ON  [dbo].[viDim_ARCustomer] TO [Viewpoint]
GRANT INSERT ON  [dbo].[viDim_ARCustomer] TO [Viewpoint]
GRANT DELETE ON  [dbo].[viDim_ARCustomer] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[viDim_ARCustomer] TO [Viewpoint]
GO
