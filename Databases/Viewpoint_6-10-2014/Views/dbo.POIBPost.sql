...
GRANT SELECT ON  [dbo].[POIBPost] TO [Viewpoint]
GRANT INSERT ON  [dbo].[POIBPost] TO [Viewpoint]
GRANT DELETE ON  [dbo].[POIBPost] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[POIBPost] TO [Viewpoint]
GO
