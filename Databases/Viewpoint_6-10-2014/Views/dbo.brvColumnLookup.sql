...
GRANT SELECT ON  [dbo].[brvColumnLookup] TO [Viewpoint]
GRANT INSERT ON  [dbo].[brvColumnLookup] TO [Viewpoint]
GRANT DELETE ON  [dbo].[brvColumnLookup] TO [Viewpoint]
GRANT UPDATE ON  [dbo].[brvColumnLookup] TO [Viewpoint]
GO
