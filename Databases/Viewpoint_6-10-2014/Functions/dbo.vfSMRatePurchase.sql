...
(
	@SMCo bCompany, @WorkOrder int, @Scope int, @Date bDate, @Agreement varchar(15), @Revision int, @NonBillable bYN, @UseAgreementRates bYN, @MaterialGroup bGroup, @Material bMatl, @CostUM bUM, @CostQuantity bUnits, @CostTotal bDollar, @PriceUM bUM, @PriceECM bECM
)
RETURNS TABLE
AS
RETURN
