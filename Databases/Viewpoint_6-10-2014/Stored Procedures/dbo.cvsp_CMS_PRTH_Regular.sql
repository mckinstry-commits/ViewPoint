...
=========================================================================
	...
	EXEC cvsp_CMS_PRTH_Regular 1,1,Error,0
**/
...
--Regular Earnings
--declare @toco int = 1,@fromco int = 1,@PhaseGroup varchar(10) = '1',@defaultJCDept varchar(10) = '1'
select PRCo=@toco
	, PRGroup=e.PRGroup
	...
	, PRDept = e.PRDept
	, Cert=EXEMPTCERTPR
	, Craft=case when x.Class is not null and x.Craft is null then '1'/*@defaultCraft*/ else
				x.Craft end 
	, Class=case when x.Class is null and x.Craft is not null then '1'/*@defaultCraft*/ else
				x.Class end 
	, Shift=SHIFTNO
	, EarnCode=case when e.HrlyRate=0 then '1'/*@defaultCraft*/ else '1'/*@defaultCraft*/ end
