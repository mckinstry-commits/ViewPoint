 ...
 *              STO 5/15/2013 TFS BUG 50164 - PM PCO - PO/SL Item -- not populating correctly. Removed the
 *                          check for @header when the code is entered.  Is a valid condition (called that
 *                          way in calling sp).  Verified sp returns proper value (1) under those conditions.
 *              STO 5/15/2013 TFS BUG 50164 - PM PCO - PO/SL Item -- not populating correctly.  Rolling back
 *                          changes - reinstating check for @header.
 *
 *
