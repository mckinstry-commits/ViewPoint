...
*				AJW 05/10/13 TFS-47275 support word new to flag new item
* 
*
* USAGE:
...
-- standards passes in ''+'' intstead of + in VPForm.ParseStringToNumeric
IF (@SLItemIN = '''+''')  SET @SLItemIN = '+'
SET @rcode = 0
...
IF UPPER(@SLItemIN) NOT IN ('+','N','NEW')
	BEGIN
