...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMTT052    Script Date: 8/28/99 9:33:29 AM ******/
    CREATE proc [dbo].[bspPRMTT052]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @deduction = 1900, @procname = 'bspPRMTT052'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMTT052] TO [public]
GO
