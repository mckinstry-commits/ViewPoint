...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMIT042    Script Date: 8/28/99 9:33:27 AM ******/
   CREATE    proc [dbo].[bspPRMIT042]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate = .04,  @procname = 'bspPRMIT042'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMIT042] TO [public]
GO
