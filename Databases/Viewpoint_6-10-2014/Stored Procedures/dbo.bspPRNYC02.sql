...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNYC02    Script Date: 8/28/99 9:33:30 AM ******/
   CREATE    proc [dbo].[bspPRNYC02]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @allowance = 1000, @procname = 'bspPRNYC02'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNYC02] TO [public]
GO
