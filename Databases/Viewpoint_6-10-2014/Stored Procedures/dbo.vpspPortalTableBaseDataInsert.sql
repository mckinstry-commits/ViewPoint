...
BEGIN
	...
	BEGIN TRY
		...
		SET @Name = 'pSites'
		EXEC vpspPortalTableDataSynchByValue @SourceDB, @SourceServer, @TargetDB, @Name, 'SiteID', 'SiteID', '0'
		IF (@Debug = 1) PRINT 'Synch Complete: ' + @Name
		
		SET @Name = 'pPageSiteControls'
		EXEC vpspPortalTableDataSynchByValue @SourceDB, @SourceServer, @TargetDB, @Name, 'PageSiteControlID', 'SiteID', '0'
		IF (@Debug = 1) PRINT 'Synch Complete: ' + @Name
		
		SET @Name = 'pPageSiteControlSecurity'
		EXEC vpspPortalTableDataSynchMultiKeyByValue @SourceDB, @SourceServer, @TargetDB, @Name, 'SiteID', '0', 'PageSiteControlID', 'RoleID'
		IF (@Debug = 1) PRINT 'Synch Complete: ' + @Name
		
		SET @Name = 'pPageSiteTemplates'
		EXEC vpspPortalTableDataSynchByValue @SourceDB, @SourceServer, @TargetDB, @Name, 'PageSiteTemplateID', 'SiteID', '0'
		IF (@Debug = 1) PRINT 'Synch Complete: ' + @Name
		
		SET @Name = 'pMenuSiteLinks'
		EXEC vpspPortalTableDataSynchByValue @SourceDB, @SourceServer, @TargetDB, @Name, 'MenuSiteLinkID', 'SiteID', '0'
		IF (@Debug = 1) PRINT 'Synch Complete: ' + @Name
		
		SET @Name = 'pMenuSiteLinkRoles'
		EXEC vpspPortalTableDataSynchMultiKeyByValue @SourceDB, @SourceServer, @TargetDB, @Name, 'SiteID', '0', 'MenuSiteLinkID', 'SiteID', 'RoleID'
		IF (@Debug = 1) PRINT 'Synch Complete: ' + @Name
		
		SET @Name = 'pContacts'
		EXEC vpspPortalTableDataSynchByValue @SourceDB, @SourceServer, @TargetDB, @Name, 'ContactID', 'SiteID', '0'
		IF (@Debug = 1) PRINT 'Synch Complete: ' + @Name
		
		SET @Name = 'pLinkControl'
		EXEC vpspPortalTableDataSynchByValue @SourceDB, @SourceServer, @TargetDB, @Name, 'LinkControlID', 'SiteID', '0'
		IF (@Debug = 1) PRINT 'Synch Complete: ' + @Name
		
		SET @Name = 'pSiteAttachments'
		EXEC vpspPortalTableDataSynchByValue @SourceDB, @SourceServer, @TargetDB, @Name, 'SiteAttachmentID', 'SiteID', '0'
		IF (@Debug = 1) PRINT 'Synch Complete: ' + @Name
		...
		+ ' FROM ' + @SourceServer + @SourceDB + '.[dbo].' + @Name + ' s'
		+ ' WHERE s.[SiteAttachmentID] IN (SELECT [SiteAttachmentID]'
		+ ' FROM ' + @SourceServer + @SourceDB + '.[dbo].[pSiteAttachments]'
		...
		EXEC vpspPortalTableDataSynchByValue @SourceDB, @SourceServer, @TargetDB, @Name, 'SiteFooterLinkID', 'SiteID', '0'
		IF (@Debug = 1) PRINT 'Synch Complete: ' + @Name
		
		
		SET @Name = 'pPasswordRules'
		EXEC vpspPortalTableDataSynchByValue @SourceDB, @SourceServer, @TargetDB, @Name, 'PasswordRuleID', 'PasswordRuleID', '1'
		IF (@Debug = 1) PRINT 'Synch Complete: ' + @Name
		...
		+ ' FROM ' + @SourceServer + @SourceDB + '.[dbo].[pPageSiteControls]'
