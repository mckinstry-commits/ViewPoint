...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPR_CA_MBT10]    Script Date: 02/27/2008 13:19:16 ******/
   CREATE  proc [dbo].[bspPR_CA_MBT12]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @procname = 'bspPR_CA_MBT12'
   ...
   if @TCP is null select @TCP = 8634 --8134
...
GO
GRANT EXECUTE ON  [dbo].[bspPR_CA_MBT12] TO [public]
GO
