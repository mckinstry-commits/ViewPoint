...
CREATE  proc [dbo].[bspPR_CA_ONT13]
/********************************************************
...
SELECT	@procname = 'bspPR_CA_ONT13'
...
ELSE IF @A BETWEEN 39020.01 AND 78043  SELECT @rate = .0915, @KP = 1600
ELSE IF @A BETWEEN 78043.01 AND 500000 SELECT @rate = .1116, @KP = 3168
ELSE IF @A > 500000.01				   SELECT @rate = .1316, @KP = 13168
...
RETURN 0
GO
GRANT EXECUTE ON  [dbo].[bspPR_CA_ONT13] TO [public]
GO
