...
begin
	...
	begin
		...
		,	@DefCompany
		FROM 
			OpenQuery(ADSI, '<LDAP://mckdc01.mckinstry.com>;(&(objectClass=*)(memberOf=CN=ERPProcessTeam,OU=Viewpoint,OU=Distribution Lists,OU=Mckinstry Co.,DC=mckinstry,DC=com)); givenName, sn, mail, objectCategory, cn, userAccountControl, sAMAccountName;subtree')
		WHERE
			userAccountControl & 2 = 0
		and	'MCKINSTRY\' + sAMAccountName not in
		(
...
GO
GRANT EXECUTE ON  [dbo].[mckspAddADUsers] TO [public]
GO
