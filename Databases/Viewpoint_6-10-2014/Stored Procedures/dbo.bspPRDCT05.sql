...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRDCT05    Script Date: 8/28/99 9:33:16 AM ******/
       CREATE      proc [dbo].[bspPRDCT05]
       /********************************************************
       ...
       **********************************************************/
       ...
       select @rcode = 0, @procname = 'bspPRDCT05'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRDCT05] TO [public]
GO
