...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRMIT09]    Script Date: 11/09/2007 11:13:02 ******/
  CREATE  proc [dbo].[bspPRMIT09]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @rate = .0435,  @procname = 'bspPRMIT09'
  ...
  select @annualized_wage = (@subjamt * @ppds) - ((@exempts + @addtl_exempts) * 3600)
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMIT09] TO [public]
GO
