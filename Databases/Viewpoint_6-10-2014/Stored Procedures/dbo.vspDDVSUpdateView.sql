...
*				KSE 05/15/2013 - Added the colun for SendViaSmtp
				CC 05/14/2013 - Add 4Project integration fields
...
*	@4PApplicationId The applicationId for the 4p service integration for this installation
*
* Returns:
*	0 if successful.
...
*************************************************************************/
    ...
    (@DaysToKeepLogHistory smallint, @MaxLookupRows int, @MaxFilterRows int, 
	 ...
	 @NumberOfWorkCenterTabs int = 6, @SendViaSmtp bYN = 'N',
	 @4PUserName nvarchar(128) = NULL, @4PPassword nvarchar(128) = NULL, 
	 @4PEnterprise nvarchar(128) = NULL, @4PEnterpriseId uniqueidentifier = NULL,	
...
SET NOCOUNT ON
	...
	UPDATE vDDVS SET DaysToKeepLogHistory = convert(varchar(5), @DaysToKeepLogHistory), 
					 ...
					 FourProjectsUserName = @4PUserName,
					 FourProjectsPassword = @4PPassword,
					 FourProjectsEnterpriseName = @4PEnterprise,
					 FourProjectsEnterpriseId = @4PEnterpriseId;
