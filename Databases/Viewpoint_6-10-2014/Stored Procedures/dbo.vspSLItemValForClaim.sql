...
* MODIFIED BY:	AW 06/06/2013 TFS-47800
* 
*
* USAGE:
...
(@SLCo bCompany = 0, @Subcontract varchar(30) = NULL,
 ...
 @ApproveToDatePct bPct = 0 OUTPUT,
 @ApproveToDateUnits bUnits = 0 OUTPUT,
 @ApproveToDateAmt bDollar = 0 OUTPUT,
...
SET @ApproveToDatePct = 0
SET @ApproveToDateUnits = 0
SET @ApproveToDateAmt = 0
...
---- SET APPROVE TO DATE VALUES
SET @ApproveToDateUnits = @PrevApproveUnits
SET @ApproveToDateAmt = @PrevApproveAmt
---- CALCULATE PCT CLAIM TO DATE
SELECT @ApproveToDatePct = 
	CASE @UM WHEN 'LS' THEN
		CASE @CurCost WHEN 0 THEN 0
			ELSE @ApproveToDateAmt / @CurCost END
		ELSE
		CASE @CurUnits WHEN 0 THEN 0 
			ELSE @ApproveToDateUnits / @CurUnits END
	END
