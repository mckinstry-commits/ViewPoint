...
*		ScottP 02/05/2012 TK-39638 Fix call to bspAPPayTypeGet.
*			Stored proc had an extra param added to it (SM Pay Type) but some calls did not get changed to pass in another param.
*
*
* USED IN
*    RQ PO Initialize
