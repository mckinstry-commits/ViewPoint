...
*			   SCOTTP 04/03/2013 - TFS-38671  In @GridConfigurationIdMappings, set TemplateConfigurationId
*												to VPCanvasGridSettingsTemplate.KeyID instead of VPCanvasGridSettings.KeyID
*												This allows for the Template table (like VPCanvasGridColumnsTemplate) to be used
*												because it now has the proper like to the template records.
*
...
BEGIN
   SET NOCOUNT ON
	...
	SET TemplateConfigurationId = VPCanvasGridSettingsTemplate.KeyID
