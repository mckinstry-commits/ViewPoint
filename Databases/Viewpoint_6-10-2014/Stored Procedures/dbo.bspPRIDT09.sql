...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRIDT09    Script Date: 8/28/99 9:33:22 AM ******/
   CREATE  proc [dbo].[bspPRIDT09]
   /********************************************************
   ...
   *				EN 4/21/2009 #133238 update was effective 1/1/2009
   *
   * USAGE:
...
GO
GRANT EXECUTE ON  [dbo].[bspPRIDT09] TO [public]
GO
