 ...
 *				GF 05/29/2013 - TFS-51569 added output parameter HQPT.DiscOpt
 *				GF 07/23/2013 - TFS-56649 return correct pay terms and discount option
 *
 ...
 *  @discopt		HQPT Discount Option (1,2,3)
 *
...
(@msco bCompany = null, @saletype varchar(1) = null, @custgroup tinyint = null,
 ...
 @discopt tinyint = null output, @msg varchar(255) output)
as
set nocount on
...
select @rcode = 0, @payterms = NULL,  @discopt = 3
...
---- TFS-56649  check for quote overrides
if @saletype = 'C'
	begin
