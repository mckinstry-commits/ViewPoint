...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMOT05    Script Date: 8/28/99 9:33:28 AM ******/
   CREATE          proc [dbo].[bspPRMOT05]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate = 0, @counter = 1, @procname = 'bspPRMOT05', @allowances = 0
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMOT05] TO [public]
GO
