...
*			AJW 01/07/2014 TFS 70345 verify UniqueAttchID column exists before adding it to query
*           
*			
...
BEGIN
	...
	IF EXISTS(SELECT 1 FROM syscolumns WHERE id = OBJECT_ID(@viewName) and name = 'UniqueAttchID')
	BEGIN
