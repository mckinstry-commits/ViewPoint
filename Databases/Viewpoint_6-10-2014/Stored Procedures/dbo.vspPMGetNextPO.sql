 ...
 *				AW 6/6/2013 - TFS 29977 add support of Auto-number
 *				TRL 10/21/2013 - 64937	Expanded @polength to 30
 *
...
if isnull(@polength,'') = '' select @polength = '30'
if @pomask in ('R','L')
begin
...
if @pono = 'A'
begin
	exec bspPOHDNextPO @poco, @po output
	goto bspexit
end
...
DECLARE @maxPOSeqLen varchar(29)
SET @maxPOSeqLen = '00000000000000000000000000000'
...
select @paddedstring = reverse(substring(reverse(@maxPOSeqLen + ltrim(str(@mseq))),1,@poseqlen))
