...
/****** Object:  Stored Procedure dbo.bspPRRMInit    Script Date: 8/28/99 9:35:39 AM ******/
   ...
   *				MV 09/23/2013 TFS 62215 Correct proc name (vspPRMedicareSurcharge)inserted into PRRM for additional medicare surcharge
   *
   * USAGE:
  ...
  begin
	  ...
	  BEGIN
		  ...
		  WHERE PRCo = @prco AND ProcName LIKE 'vspPRMedicareSurcharge%'
	  END
