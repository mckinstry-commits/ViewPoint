...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNYT04    Script Date: 8/28/99 9:33:30 AM ******/
   CREATE  proc [dbo].[bspPRNYT04]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @allowance = 1000, @procname = 'bspPRNYT04'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNYT04] TO [public]
GO
