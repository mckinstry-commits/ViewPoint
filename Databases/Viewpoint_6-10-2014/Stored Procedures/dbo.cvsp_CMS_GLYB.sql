...
=========================================================================
	...
	EXEC cvsp_CMS_GLYB 2014,1,15,50,1,'',0
**/
...
select @defaultYearEndMth=isnull(b.DefaultNumeric,a.DefaultNumeric) 
 ...
 where a.Company=0 
   and a.ColName='YearEndMth' 
   and a.TableName='bGLFY';
...
delete 
 ...
 where GLCo=@toco 
   and GLAcct in
   (select GLAcct from budxrefGLAcct where newCompany = @toco)
   --and udConv = 'Y';
COMMIT TRAN;
...
where g.FISCALTAXRECCDE = 'F'
	...
	and g.ACYEAR >= @lFiscalYear
group by newCompany, ACYEAR, newGLAcct;
