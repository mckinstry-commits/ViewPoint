...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRKYT06    Script Date: 8/28/99 9:33:25 AM ******/
  CREATE   proc [dbo].[bspPRKYT06]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @stddedn = 1970, @creditamt = 20
  select @procname = 'bspPRKYT06'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRKYT06] TO [public]
GO
