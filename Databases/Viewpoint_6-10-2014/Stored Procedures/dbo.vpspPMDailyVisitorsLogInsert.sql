...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[vpspPMDailyVisitorsLogInsert]
/************************************************************
* CREATED:		6/13/06	CHS
* MODIFIED		6/6/07	chs
...
*
* USAGE:
*   Inserts PM Daily Visitors Logs
*
* CALLED FROM:
*	ViewpointCS Portal  
*   
...
*/
    ...
    EXECUTE vpspPMDailyVisitorsLogGet @PMCo, @Project, @DailyLog, @LogDate,
        @VendorGroup, @KeyID
GO
GRANT EXECUTE ON  [dbo].[vpspPMDailyVisitorsLogInsert] TO [VCSPortal]
GO
