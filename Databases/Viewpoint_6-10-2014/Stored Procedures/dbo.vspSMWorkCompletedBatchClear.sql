...
-- Modified:	6/27/13 TFS-54115 Cleaned up some batch records that weren't getting cleaned up.
...
BEGIN
	...
	BEGIN TRY
		...
		DELETE vGLEntryBatch
			OUTPUT DELETED.GLEntryID
				INTO @EntriesToDelete (CurrentRevenueGLEntryID)
