...
CREATE PROC [dbo].[vspPMImportEstimate]
  ...
  *					GP 07/08/2013 - TFS-55160 UD field values were not being set into SQLString
  *
  *
				...
				begin
					...
					begin
						...
						begin							 
							...
							--Add formatted value to update statement
							set @Value = replace(@Value,'''','''''')
							set @Value = char(39) + @Value + char(39)
							set @FixedSQLString1 = @FixedSQLString1 + ' ' + @ColumnName + ' = ' + ISNULL(@Value,'') + ','
 						end
