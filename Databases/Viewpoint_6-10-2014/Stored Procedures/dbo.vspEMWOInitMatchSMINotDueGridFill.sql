...
*						GF 04/26/2013 TFS-48552 EMSH/EMSI descriptions expanded
*
* USAGE:
...
----TFS-38171
,@DateDone DATETIME, @IntervalDate DATETIME


--Create table variable for final list of Equipment
----TFS-48552
create table #DisplaySMIInfo(Item int null, ItemDesc varchar(60) null,
StdMaintGroup varchar(10) null, SMGDesc varchar(60) null, Equipment varchar(10) null, EquipDesc varchar(60) null,CompOfEquip varchar(10) null,
	   ...
	   from dbo.EMSI with(nolock)
		...
		IF @basis IN ('H','M','G') AND ISNULL(@intervaldays,0) <> 0
			...
			IF @IntervalDate BETWEEN '19000101 00:00:00.000' AND '20790606 23:59:29.997'
						AND @wodate >= CAST(@IntervalDate AS SMALLDATETIME)
						BEGIN
						SET @itemdue = 'Y'	                      
						GOTO smgdue
						END
