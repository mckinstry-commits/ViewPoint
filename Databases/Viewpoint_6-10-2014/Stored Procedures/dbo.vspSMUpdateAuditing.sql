...
BEGIN
	...
	FROM dbo.vAuditFlags
		CROSS APPLY(
			SELECT CASE FlagName 
				...
				WHEN 'SMWorkOrderQuotes' THEN 'AuditWorkOrderQuotes'
	...
	FROM dbo.vSMCO
		UNPIVOT (EnableAuditYN FOR ColumnName IN 
			(AuditCompanySettings, AuditServiceCenters, AuditTechnicians, AuditRateTemplates, AuditDepartments, AuditWorkScopes, AuditStandardTasks, AuditStandardItems, AuditCustomers, AuditWorkOrders, AuditAgreements, AuditWorkOrderQuotes)) Unpvt
