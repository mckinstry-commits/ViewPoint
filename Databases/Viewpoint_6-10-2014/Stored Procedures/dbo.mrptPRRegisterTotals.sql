...
CREATE PROCEDURE [dbo].[mrptPRRegisterTotals]
(
	@PRCo			tinyint,
...
/*****************************************************************
CREATED:	3/21/2014
PURPOSE:	copy brptPRRegisterTotals PR Payroll Register Totals
MODIFIED:	3/21/2014 add PaySeq parameter range
TEST:		mrptPRRegisterTotals 1,	 0,	 255,	'3/1/2014',	'4/1/2014',2,255
grant all on mrptPRRegisterTotals to public
...
SELECT 
	...
	@BegPRGroup		= 0,
	@EndPRGroup		= 255,
	@BegPREndDate	='3/1/2014',
	@EndPREndDate	='4/1/2014',
	@BegPaySeq		=2,
	@EndPaySeq		=255	
*/	
...
AND PRDT.PaySeq Between @BegPaySeq and @EndPaySeq
AND PRDT.EDLType = 'D'
UNION ALL
...
DECLARE bcPRTA CURSOR LOCAL FAST_FORWARD FOR
	...
	AND PRTA.PaySeq Between @BegPaySeq and @EndPaySeq
...
GO
GRANT EXECUTE ON  [dbo].[mrptPRRegisterTotals] TO [public]
GO
