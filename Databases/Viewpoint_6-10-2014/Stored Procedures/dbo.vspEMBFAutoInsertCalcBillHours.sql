...
*				GF 07/23/2013 TFS-55951 do not use start on tranfer date if no max per month value exists
*
*
*				
...
----TFS-55951 if no max per month then start on transfer date needs to be 'N'
IF ISNULL(@maxpermth, 0) = 0
	BEGIN
	SET @startbillingintrnsfrindate = 'N'
	END
