...
select 
	...
	, PO=cast(c.COMPANYNUMBER as varchar(30)) + '-' + cast(c.PONUMBER as varchar(30))
	, POItem=c.POITEMT
...
join bPOIT it
	on it.PO=cast(c.COMPANYNUMBER as varchar(30)) + '-' + cast(c.PONUMBER as varchar(30)) 
	and it.POItem=c.POITEMT 
	and it.POCo=@toco
	
where c.COMPANYNUMBER in (@fromco1,@fromco2,@fromco3);
