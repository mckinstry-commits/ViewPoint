...
CREATE proc [dbo].[vspDMCheckRecordSecurity]  
  ...
  * GarthT	  04/10/2013 - TFS 38917 Do security access lookup instead of checking user access via an "Execute As".
  *     
  * Usage:  
 ...
 -- Check if the the user has access to the record
 exec @rowCount = vspCheckUserRecordAccess @hqattable, @keystring, @user  
