...
SET ANSI_NULLS ON
GO
CREATE  proc [dbo].[bspSLHoldCodeVal]
   /***********************************************************
    * CREATED BY: MV 01/02/03
    * MODIFIED By : 
    *
    * USAGE:
    *  Validates HQ Hold Code in SLEntry. Returns an error
...
GO
GRANT EXECUTE ON  [dbo].[bspSLHoldCodeVal] TO [public]
GO
