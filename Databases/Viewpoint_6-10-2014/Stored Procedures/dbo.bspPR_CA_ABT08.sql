...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPR_CA_ABT08]    Script Date: 02/27/2008 13:19:16 ******/
   CREATE  proc [dbo].[bspPR_CA_ABT08]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate = 0.10, @K1P = 0, @K2P = 0, @T4 = 0, @T2 = 0
   select @calcamt = 0, @procname = 'bspPR_CA_ABT08'
...
GO
GRANT EXECUTE ON  [dbo].[bspPR_CA_ABT08] TO [public]
GO
