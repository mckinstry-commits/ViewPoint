...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPR_AU_PAYG112]    Script Date: 02/27/2008 13:19:16 ******/
   CREATE PROC [dbo].[bspPR_AU_PAYG112]
/********************************************************
...
END
-- Validate scale
IF @Scale NOT IN (1,2,3,4,5,6,7,11,21,31,51,61,71,12,22,32,52,62,72,13,23,33,53,63,73)
BEGIN
...
BEGIN
	IF @x BETWEEN 0 AND 258.99 SELECT @a = .1650, @b = .1650
	ELSE IF @x BETWEEN 259 AND 393.99 SELECT @a = .2284, @b = 16.4596
	ELSE IF @x BETWEEN 394 AND 979.99 SELECT @a = .3430, @b = 61.6385
	ELSE IF @x BETWEEN 980 AND 1220.99 SELECT @a = .3150, @b = 34.1769
	ELSE IF @x BETWEEN 1221 AND 3143.99 SELECT @a = .3850, @b = 119.6577
	ELSE SELECT @a = .4650, @b = 371.1962
END
ELSE IF @Scale = 13
BEGIN
	IF @x BETWEEN 0 AND 258.99 SELECT @a = .1650, @b = .1650
	ELSE IF @x BETWEEN 259 AND 393.99 SELECT @a = .2284, @b = 16.4596
	ELSE IF @x BETWEEN 394 AND 589.99 SELECT @a = .3430, @b = 61.6385
	ELSE IF @x BETWEEN 590 AND 692.99 SELECT @a = .3830, @b = 61.6385
	ELSE IF @x BETWEEN 693 AND 796.99 SELECT @a = .3880, @b = 61.6385
	ELSE IF @x BETWEEN 797 AND 854.99 SELECT @a = .3930, @b = 61.6385
	ELSE IF @x BETWEEN 855 AND 942.99 SELECT @a = .3980, @b = 61.6385
	ELSE IF @x BETWEEN 943 AND 979.99 SELECT @a = .4030, @b = 61.6385
	ELSE IF @x BETWEEN 980 AND 1047.99 SELECT @a = .3750, @b = 34.1769
	ELSE IF @x BETWEEN 1048 AND 1119.99 SELECT @a = .3800, @b = 34.1769
	ELSE IF @x BETWEEN 1120 AND 1220.99 SELECT @a = .3850, @b = 34.1769
	ELSE IF @x BETWEEN 1221 AND 1263.99 SELECT @a = .4550, @b = 119.6577
	ELSE IF @x BETWEEN 1264 AND 1367.99 SELECT @a = .4600, @b = 119.6577
	ELSE IF @x BETWEEN 1368 AND 3143.99 SELECT @a = .4650, @b = 119.6577
	ELSE SELECT @a = .5450, @b = 371.1962
END
ELSE IF @Scale = 2
BEGIN
...
BEGIN
	...
	ELSE IF @x BETWEEN 422 AND 570.99 SELECT @a = .1664, @b = 36.9239
	ELSE IF @x BETWEEN 571 AND 704.99 SELECT @a = .1947, @b = 53.0778
	ELSE IF @x BETWEEN 705 AND 1290.99 SELECT @a = .3430, @b = 157.6978
	ELSE IF @x BETWEEN 1291 AND 1531.99 SELECT @a = .3150, @b = 121.5239
	ELSE IF @x BETWEEN 1532 AND 3454.99 SELECT @a = .3850, @b = 228.7855
...
BEGIN
	...
	ELSE IF @x BETWEEN 571 AND 704.99 SELECT @a = .1947, @b = 53.0778
	ELSE IF @x BETWEEN 705 AND 906.99 SELECT @a = .3430, @b = 157.6978
	ELSE IF @x BETWEEN 907 AND 1010.99 SELECT @a = .3830, @b = 157.6978
	ELSE IF @x BETWEEN 1011 AND 1113.99 SELECT @a = .3880, @b = 157.6978
	ELSE IF @x BETWEEN 1114 AND 1171.99 SELECT @a = .3930, @b = 157.6978
	ELSE IF @x BETWEEN 1172 AND 1259.99 SELECT @a = .3980, @b = 157.6978
	ELSE IF @x BETWEEN 1260 AND 1290.99 SELECT @a = .4030, @b = 157.6978
	ELSE IF @x BETWEEN 1291 AND 1364.99 SELECT @a = .3750, @b = 121.5239
	ELSE IF @x BETWEEN 1365 AND 1436.99 SELECT @a = .3800, @b = 121.5239
	ELSE IF @x BETWEEN 1437 AND 1531.99 SELECT @a = .3850, @b = 121.5239
	ELSE IF @x BETWEEN 1532 AND 1580.99 SELECT @a = .4550, @b = 228.7855
	ELSE IF @x BETWEEN 1581 AND 1684.99 SELECT @a = .4600, @b = 228.7855
	ELSE IF @x BETWEEN 1685 AND 3454.99 SELECT @a = .4650, @b = 228.7855
...
BEGIN
	IF @x BETWEEN 0 AND 710.99 SELECT @a = .2900, @b = .2900
	ELSE IF @x BETWEEN 711 AND 906.99 SELECT @a = .3000, @b = 7.1154
	ELSE IF @x BETWEEN 907 AND 1010.99 SELECT @a = .3400, @b = 7.1154
	ELSE IF @x BETWEEN 1011 AND 1113.99 SELECT @a = .3450, @b = 7.1154
	ELSE IF @x BETWEEN 1114 AND 1171.99 SELECT @a = .3500, @b = 7.1154
	ELSE IF @x BETWEEN 1172 AND 1259.99 SELECT @a = .3550, @b = 7.1154
	ELSE IF @x BETWEEN 1260 AND 1364.99 SELECT @a = .3600, @b = 7.1154
	ELSE IF @x BETWEEN 1365 AND 1436.99 SELECT @a = .3650, @b = 7.1154
	ELSE IF @x BETWEEN 1437 AND 1537.99 SELECT @a = .3700, @b = 7.1154
	ELSE IF @x BETWEEN 1538 AND 1580.99 SELECT @a = .4400, @b = 114.8077
	ELSE IF @x BETWEEN 1581 AND 1684.99 SELECT @a = .4450, @b = 114.8077
	ELSE IF @x BETWEEN 1685 AND 3460.99 SELECT @a = .4500, @b = 114.8077
...
BEGIN
	...
	ELSE IF @x BETWEEN 244 AND 570.99 SELECT @a = .1513, @b = 36.9231
	ELSE IF @x BETWEEN 571 AND 704.99 SELECT @a = .1796, @b = 53.0769
	ELSE IF @x BETWEEN 705 AND 1290.99 SELECT @a = .3280, @b = 157.7892
	ELSE IF @x BETWEEN 1291 AND 1531.99 SELECT @a = .3000, @b = 121.6154
	ELSE IF @x BETWEEN 1532 AND 3454.99 SELECT @a = .3700, @b = 228.8769
...
BEGIN
	...
	ELSE IF @x BETWEEN 571 AND 704.99 SELECT @a = .1796, @b = 53.0769
	ELSE IF @x BETWEEN 705 AND 906.99 SELECT @a = .3280, @b = 157.7892
	ELSE IF @x BETWEEN 907 AND 1010.99 SELECT @a = .3680, @b = 157.7892
	ELSE IF @x BETWEEN 1011 AND 1113.99 SELECT @a = .3730, @b = 157.7892
	ELSE IF @x BETWEEN 1114 AND 1171.99 SELECT @a = .3780, @b = 157.7892
	ELSE IF @x BETWEEN 1172 AND 1259.99 SELECT @a = .3830, @b = 157.7892
	ELSE IF @x BETWEEN 1260 AND 1290.99 SELECT @a = .3880, @b = 157.7892
	ELSE IF @x BETWEEN 1291 AND 1364.99 SELECT @a = .3600, @b = 121.6154
	ELSE IF @x BETWEEN 1365 AND 1436.99 SELECT @a = .3650, @b = 121.6154
	ELSE IF @x BETWEEN 1437 AND 1531.99 SELECT @a = .3700, @b = 121.6154
	ELSE IF @x BETWEEN 1532 AND 1580.99 SELECT @a = .4400, @b = 228.8769
	ELSE IF @x BETWEEN 1581 AND 1684.99 SELECT @a = .4450, @b = 228.8769
	ELSE IF @x BETWEEN 1685 AND 3454.99 SELECT @a = .4500, @b = 228.8769
...
BEGIN
	...
	ELSE IF @x BETWEEN 606 AND 704.99 SELECT @a = .2300, @b = 83.6433
	ELSE IF @x BETWEEN 705 AND 712.99 SELECT @a = .3780, @b = 188.0479
	ELSE IF @x BETWEEN 713 AND 1290.99 SELECT @a = .3355, @b = 157.7438
	ELSE IF @x BETWEEN 1291 AND 1531.99 SELECT @a = .3075, @b = 121.5699
	ELSE IF @x BETWEEN 1532 AND 3454.99 SELECT @a = .3775, @b = 228.8314
	ELSE SELECT @a = .4575, @b = 505.2622
END
ELSE IF @Scale = 63
BEGIN
	IF @x BETWEEN 0 AND 243.99 SELECT @a = 0, @b = 0
	...
	ELSE IF @x BETWEEN 705 AND 712.99 SELECT @a = .3780, @b = 188.0479
	ELSE IF @x BETWEEN 713 AND 906.99 SELECT @a = .3355, @b = 157.7438
	ELSE IF @x BETWEEN 907 AND 1010.99 SELECT @a = .3755, @b = 157.7438
	ELSE IF @x BETWEEN 1011 AND 1113.99 SELECT @a = .3805, @b = 157.7438
	ELSE IF @x BETWEEN 1114 AND 1171.99 SELECT @a = .3855, @b = 157.7438
	ELSE IF @x BETWEEN 1172 AND 1259.99 SELECT @a = .3905, @b = 157.7438
	ELSE IF @x BETWEEN 1260 AND 1290.99 SELECT @a = .3955, @b = 157.7438
	ELSE IF @x BETWEEN 1291 AND 1364.99 SELECT @a = .3675, @b = 121.5699
	ELSE IF @x BETWEEN 1365 AND 1436.99 SELECT @a = .3725, @b = 121.5699
	ELSE IF @x BETWEEN 1437 AND 1531.99 SELECT @a = .3775, @b = 121.5699
	ELSE IF @x BETWEEN 1532 AND 1580.99 SELECT @a = .4475, @b = 228.8314
	ELSE IF @x BETWEEN 1581 AND 1684.99 SELECT @a = .4525, @b = 228.8314
	ELSE IF @x BETWEEN 1685 AND 3454.99 SELECT @a = .4575, @b = 228.8314
	ELSE SELECT @a = .5375, @b = 505.2622
END
ELSE IF @Scale = 7
BEGIN
...
BEGIN
	...
	ELSE IF @x BETWEEN 426 AND 575.99 SELECT @a = .1650, @b = 36.9239
	ELSE IF @x BETWEEN 576 AND 710.99 SELECT @a = .1930, @b = 53.0778
	ELSE IF @x BETWEEN 711 AND 1297.99 SELECT @a = .3430, @b = 159.8086
	ELSE IF @x BETWEEN 1298 AND 1537.99 SELECT @a = .3150, @b = 123.4624
	ELSE IF @x BETWEEN 1538 AND 3460.99 SELECT @a = .3850, @b = 231.1547
	ELSE SELECT @a = .4650, @b = 508.0778
END
ELSE IF @Scale = 73
BEGIN
	IF @x BETWEEN 0 AND 245.99 SELECT @a = 0, @b = 0
	...
	ELSE IF @x BETWEEN 576 AND 710.99 SELECT @a = .1930, @b = 53.0778
	ELSE IF @x BETWEEN 711 AND 906.99 SELECT @a = .3430, @b = 159.8086
	ELSE IF @x BETWEEN 907 AND 1010.99 SELECT @a = .3830, @b = 159.8086
	ELSE IF @x BETWEEN 1011 AND 1113.99 SELECT @a = .3880, @b = 159.8086
	ELSE IF @x BETWEEN 1114 AND 1171.99 SELECT @a = .3930, @b = 159.8086
	ELSE IF @x BETWEEN 1172 AND 1259.99 SELECT @a = .3980, @b = 159.8086
	ELSE IF @x BETWEEN 1260 AND 1297.99 SELECT @a = .4030, @b = 159.8086
	ELSE IF @x BETWEEN 1298 AND 1364.99 SELECT @a = .3750, @b = 123.4624
	ELSE IF @x BETWEEN 1365 AND 1436.99 SELECT @a = .3800, @b = 123.4624
	ELSE IF @x BETWEEN 1437 AND 1537.99 SELECT @a = .3850, @b = 123.4624
	ELSE IF @x BETWEEN 1538 AND 1580.99 SELECT @a = .4550, @b = 231.1547
	ELSE IF @x BETWEEN 1581 AND 1684.99 SELECT @a = .4600, @b = 231.1547
	ELSE IF @x BETWEEN 1685 AND 3460.99 SELECT @a = .4650, @b = 231.1547
	ELSE SELECT @a = .5450, @b = 508.0778
END
...
IF @Scale IN (2,6,7,21,61,71,22,62,72,23,63,73) 
	AND (@status = 'M' OR @addlexempts > 0) 
	AND NOT (@Scale = 4 AND @nonresalienyn = 'Y')
	AND ((@Scale IN (2,21,22,23) AND @x >= 359) OR (@Scale IN (6,61,62,63) AND @x >= 606) OR (@Scale IN (7,71,72,73) AND @x >= 362))
...
IF @ftb_offset > 0 AND @Scale IN (2,5,6,7,21,51,61,71,22,52,62,72,23,53,63,73)
BEGIN
...
RETURN 0
GO
GRANT EXECUTE ON  [dbo].[bspPR_AU_PAYG112] TO [public]
GO
