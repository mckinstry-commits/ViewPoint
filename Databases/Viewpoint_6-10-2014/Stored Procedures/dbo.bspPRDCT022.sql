...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRDCT022    Script Date: 8/28/99 9:33:16 AM ******/
       CREATE     proc [dbo].[bspPRDCT022]
       /********************************************************
       ...
       **********************************************************/
       ...
       select @rcode = 0, @procname = 'bspPRDCT022'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRDCT022] TO [public]
GO
