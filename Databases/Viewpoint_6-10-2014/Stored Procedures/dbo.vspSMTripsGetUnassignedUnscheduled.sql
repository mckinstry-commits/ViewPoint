...
-- =============================================
CREATE PROCEDURE dbo.vspSMTripsGetUnassignedUnscheduled
	@SMCo				bCompany,
...
BEGIN
	...
	WHERE
		...
		and trip.SMCo = @SMCo
		and	trip.ScheduledDate is null and trip.Technician is null
...
END
GO
GRANT EXECUTE ON  [dbo].[vspSMTripsGetUnassignedUnscheduled] TO [public]
GO
