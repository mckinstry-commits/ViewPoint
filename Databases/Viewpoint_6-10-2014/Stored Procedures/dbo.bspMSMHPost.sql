...
*				GF 04/25/2013 TFS-48153 write back APTL KeyId to MSTD MatlAPTLKeyId
*
*
...
declare @rcode int, @status tinyint, @seq int, @openMSMH_cursor tinyint, @openMSMH_trans tinyint,
		...
		@Eft char(1), @SeparatePayInvYN bYN, @VendorPaymethod char(1), @ApcoCsCmAcct bCMAcct
		----TFS-48153
		,@APTL_KeyId BIGINT	
