...
insert into bPRGS2 select distinct PRCo, PRGroup, VPUserName, UniqueAttchID  
from bPRGS where PRCo = @toco;


--Delete records in VP table
delete bPRGS where PRCo=@toco;
insert into bPRGS 
select distinct PRCo, PRGroup, VPUserName, UniqueAttchID 
from bPRGS2
where PRCo=@toco;
