...
*				TFS-38671 ScottP 04/03/2013 Only add a new record if the Columnn is visible
*
*	Inputs:
*	
*
...
BEGIN
	...
	IF EXISTS (	SELECT 1
		...
		END
	ELSE IF @IsVisible = 'Y'
		-- Only add a new record if Column is Visible
		-- Default for an invisible column is not to have a record
		BEGIN
