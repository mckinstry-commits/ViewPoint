...
CREATE  proc [dbo].[bspPMOCInitialize]
   ...
   *				SCOTTP 05/10/2013 - TFS-49587,49703 Check first if Distribution record already exists
   *
   ...
   **************************************/
   ...
   if not exists(select top 1 1 from dbo.bPMOC where PMCo=@pmco AND Project=@project
