...
GO
CREATE UNIQUE CLUSTERED INDEX [biAPTB] ON [dbo].[bAPTB] ([Co], [Mth], [BatchId], [BatchSeq], [ExpMth], [APTrans]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPTB] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
