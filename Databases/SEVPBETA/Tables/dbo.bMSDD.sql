...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSDD] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biMSDD] ON [dbo].[bMSDD] ([MSCo], [DiscTemplate], [LocGroup], [FromLoc], [MatlGroup], [Category], [Material], [UM]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biMSDDSeq] ON [dbo].[bMSDD] ([MSCo], [DiscTemplate], [Seq]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
