...
GO
ALTER TABLE [dbo].[vSMWorkCompletedDetail] WITH NOCHECK ADD CONSTRAINT [FK_vSMWorkCompletedDetail_bGLAC_CostAccount] FOREIGN KEY ([GLCo], [CostAccount]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
GO
ALTER TABLE [dbo].[vSMWorkCompletedDetail] WITH NOCHECK ADD CONSTRAINT [FK_vSMWorkCompletedDetail_bGLAC_CostWIPAccount] FOREIGN KEY ([GLCo], [CostWIPAccount]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
GO
ALTER TABLE [dbo].[vSMWorkCompletedDetail] WITH NOCHECK ADD CONSTRAINT [FK_vSMWorkCompletedDetail_bGLAC_RevenueAccount] FOREIGN KEY ([GLCo], [RevenueAccount]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
GO
ALTER TABLE [dbo].[vSMWorkCompletedDetail] WITH NOCHECK ADD CONSTRAINT [FK_vSMWorkCompletedDetail_bGLAC_RevenueWIPAccount] FOREIGN KEY ([GLCo], [RevenueWIPAccount]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
GO
