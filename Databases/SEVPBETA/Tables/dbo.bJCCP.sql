...
GO
CREATE UNIQUE CLUSTERED INDEX [IX_bJCCP_JCCoJobPhase] ON [dbo].[bJCCP] ([JCCo], [Job], [Phase], [PhaseGroup], [CostType], [Mth]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
