...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bWDQP] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biWDQP] ON [dbo].[bWDQP] ([QueryName], [Param]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
