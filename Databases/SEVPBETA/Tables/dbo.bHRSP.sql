...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRSP] ON [dbo].[bHRSP] ([HRCo], [HRRef], [EffectiveDate], [ReasonSeq]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRSP] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
