...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHQMC] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biHQMC] ON [dbo].[bHQMC] ([MatlGroup], [Category]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
