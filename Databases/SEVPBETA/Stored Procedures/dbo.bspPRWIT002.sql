...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRWIT002    Script Date: 8/28/99 9:33:37 AM ******/
   CREATE proc [dbo].[bspPRWIT002]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @procname = 'bspPRWIT002'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRWIT002] TO [public]
GO
