...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNET982    Script Date: 8/28/99 9:33:29 AM ******/
   CREATE proc [dbo].[bspPRNET982]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @allowance = 1490, @procname = 'bspPRNET982'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNET982] TO [public]
GO
