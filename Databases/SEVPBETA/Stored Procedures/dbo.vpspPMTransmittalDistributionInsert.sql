...
CREATE PROCEDURE [dbo].[vpspPMTransmittalDistributionInsert]
/************************************************************
...
*
* USAGE:
*   Inserts PM Transmittal Distribution
*
* CALLED FROM:
*	ViewpointCS Portal  
*
...
AS 
    ...
    EXECUTE vpspPMTransmittalDistributionGet @PMCo, @Project, @VendorGroup,
        @SentToFirm, @Transmittal, @KeyID
...
GO
GRANT EXECUTE ON  [dbo].[vpspPMTransmittalDistributionInsert] TO [VCSPortal]
GO
