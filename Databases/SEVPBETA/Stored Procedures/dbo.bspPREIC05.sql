...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPREIC05    Script Date: 8/28/99 9:33:34 AM ******/
    CREATE proc [dbo].[bspPREIC05]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @rate1 = .204, @rate2 = .09588, @procname = 'bspPREIC05'
    ...
    if @EICStatus = 'S'
        select @bracket1 = 7830, @bracket2 = 14370, @maxpayamt = 1597
    if @EICStatus = 'M'
        select @bracket1 = 7830, @bracket2 = 16370, @maxpayamt = 1597
    if @EICStatus = 'B'
        select @bracket1 = 3915, @bracket2 = 8185, @maxpayamt = 799
...
GO
GRANT EXECUTE ON  [dbo].[bspPREIC05] TO [public]
GO
