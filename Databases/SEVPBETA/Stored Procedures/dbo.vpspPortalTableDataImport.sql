...
END
    ...
    BEGIN TRY
        ...
        EXEC vpspPortalTableDataSynch @SourceDB, @TargetDB, @Name,
            'PortalControlID'
        IF ( @Debug = 1 ) 
            PRINT 'Synch Complete: ' + @Name
		
        SET @Name = 'pDates'
        EXEC vpspPortalTableDataSynch @SourceDB, @TargetDB, @Name, 'DateID'
        IF ( @Debug = 1 ) 
            PRINT 'Synch Complete: ' + @Name
        ...
        EXEC vpspPortalTableDataSynch @SourceDB, @TargetDB, @Name, 'MessageID'
        IF ( @Debug = 1 ) 
            PRINT 'Synch Complete: ' + @Name
        ...
        EXEC vpspPortalImportDataNonIdentity @SourceDB, @Name
        IF ( @Debug = 1 ) 
            PRINT 'Synch Complete: ' + @Name
		
        SET @Name = 'pPortalDetails'
        EXEC vpspPortalTableDataSynch @SourceDB, @TargetDB, @Name, 'DetailsID'
        IF ( @Debug = 1 ) 
            PRINT 'Synch Complete: ' + @Name
        ...
        EXEC vpspPortalTableDataSynch @SourceDB, @TargetDB, @Name, 'ButtonID'
        IF ( @Debug = 1 ) 
            PRINT 'Synch Complete: ' + @Name
        ...
        SET @Name = 'pLookups'
        EXEC vpspPortalTableDataSynch @SourceDB, @TargetDB, @Name, 'LookupID'
        IF ( @Debug = 1 ) 
            PRINT 'Synch Complete: ' + @Name
        ...
        SET @Name = 'pRoles'
        EXEC vpspPortalTableDataSynch @SourceDB, @TargetDB, @Name, 'RoleID',
            '[Name]'
        IF ( @Debug = 1 ) 
            PRINT 'Synch Complete: ' + @Name
        ...
        EXEC vpspPortalTableDataSynchMultiKey @SourceDB, @TargetDB, @Name,
        ...
        SET @SQLString = 'UPDATE ' + QUOTENAME(@TargetDB) + '.[dbo].' + @Name
            ...
            + ' INNER JOIN ' + QUOTENAME(@SourceDB) + '.[dbo].' + @Name + ' s'
