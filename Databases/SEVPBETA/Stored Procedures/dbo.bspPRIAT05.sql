...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRIAT05    Script Date: 8/28/99 9:33:22 AM ******/
     CREATE  proc [dbo].[bspPRIAT05]
     /********************************************************
...
GO
GRANT EXECUTE ON  [dbo].[bspPRIAT05] TO [public]
GO
