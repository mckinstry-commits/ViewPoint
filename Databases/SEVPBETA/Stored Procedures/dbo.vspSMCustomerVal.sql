...
BEGIN
	...
	SELECT @Active = Active,
			@SMRateOverridesExist = dbo.vfSMRateOverridesExist(SMCustomer.SMRateOverrideID),
			@SMStandardItemDefaultsExist = dbo.vfSMStandardItemDefaultsExist(SMCustomer.SMStandardItemDefaultID),
			@SMTechPrefAdvExist = TechPrefExits
	FROM SMCustomer 
		CROSS APPLY dbo.vfSMTechPrefAdvExist(SMCo,CustGroup,Customer,NULL)
	WHERE SMCo = @SMCo AND CustGroup = @CustomerGroup AND Customer = @CustomerOutput
