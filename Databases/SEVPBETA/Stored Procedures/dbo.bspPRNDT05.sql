...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNDT05    Script Date: 8/28/99 9:33:29 AM ******/
    CREATE proc [dbo].[bspPRNDT05]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @procname = 'bspPRNDT05'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNDT05] TO [public]
GO
