...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMIT072    Script Date: 8/28/99 9:33:27 AM ******/
  CREATE  proc [dbo].[bspPRMIT072]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @rate = .0435,  @procname = 'bspPRMIT072'
  ...
  select @annualized_wage = (@subjamt * @ppds) - ((@exempts + @addtl_exempts) * 3400)
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMIT072] TO [public]
GO
