...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNYY98    Script Date: 8/28/99 9:33:31 AM ******/
   CREATE   proc [dbo].[bspPRNYY98]
   /********************************************************
   ...
   *
   * USAGE:
   * 	Calculates 1998 Yonkers City Tax
   *
   * INPUT PARAMETERS:
   ...
   **********************************************************/
   ...
   select @rcode = 0, @allowance = 1000, @procname = 'bspPRNYY98'
   ...
   /* initialize calculation elements */
   	...
   	if @annualized_wage <= 8000 select @wage_bracket = 0, @rate = .04
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNYY98] TO [public]
GO
