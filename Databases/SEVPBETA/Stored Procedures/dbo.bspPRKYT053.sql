...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRKYT053    Script Date: 8/28/99 9:33:25 AM ******/
    CREATE  proc [dbo].[bspPRKYT053]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @stddedn = 1910, @creditamt = 20
    select @procname = 'bspPRKYT053'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRKYT053] TO [public]
GO
