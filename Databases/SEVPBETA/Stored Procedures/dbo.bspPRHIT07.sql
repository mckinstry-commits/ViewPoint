...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRHIT07    Script Date: 8/28/99 9:33:22 AM ******/
 CREATE proc [dbo].[bspPRHIT07]
 /********************************************************
 ...
 **********************************************************/
 ...
 if @status = 'S'
 	begin
 	 ...
 	 if @taxincome > 24000 select @basetax = 1354, @limit = 24000, @rate = @rate7
 ...
 if @status = 'M'
 	begin
 	 ...
 	 if @taxincome > 48000 select @basetax = 2707, @limit = 48000, @rate = @rate7
 	end
...
GO
GRANT EXECUTE ON  [dbo].[bspPRHIT07] TO [public]
GO
