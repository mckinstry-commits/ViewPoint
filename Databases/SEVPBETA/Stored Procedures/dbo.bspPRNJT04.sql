...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNJT04    Script Date: 8/28/99 9:33:29 AM ******/
   CREATE   proc [dbo].[bspPRNJT04]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @allowance = 1000, @procname = 'bspPRNJT04'
   ...
   begin
   	...
   	if @annualized_wage > 500000 select @tax_addition = 32680, @wage_bracket = 500000, @rate = .12
   end
   ...
   begin
   	...
   	if @annualized_wage > 500000 select @tax_addition = 30600, @wage_bracket = 500000, @rate = .12
   end
   ...
   begin
   	...
   	if @annualized_wage > 500000 select @tax_addition = 29530, @wage_bracket = 500000, @rate = .12
   end
   ...
   begin
   	...
   	if @annualized_wage > 500000 select @tax_addition = 29400, @wage_bracket = 500000, @rate = .12
   end
   ...
   begin
   	...
   	if @annualized_wage > 500000 select @tax_addition = 30370, @wage_bracket = 500000, @rate = .12
   end
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNJT04] TO [public]
GO
