...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMDT04    Script Date: 8/28/99 9:33:26 AM ******/
   CREATE   proc [dbo].[bspPRMDT04]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate = 0, @procname = 'bspPRMDT04'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMDT04] TO [public]
GO
