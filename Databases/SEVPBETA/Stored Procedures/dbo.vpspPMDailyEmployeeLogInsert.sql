...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[vpspPMDailyEmployeeLogInsert]
/************************************************************
* CREATED:		6/13/06	CHS
* MODIFIED		6/6/07	chs
...
*/
    ...
    IF @PhaseGroup IS NULL 
        BEGIN
            SET @PhaseGroup = ( SELECT  JCJP.PhaseGroup
                                ...
                                WHERE   JCJP.JCCo = @PMCo
                                        AND JCJP.Job = @Project
                                        AND JCJP.Phase = @Phase
                              )
        END
    ...
    EXECUTE vpspPMDailyEmployeeLogGet @PMCo, @Project, @DailyLog, @LogDate,
        @VendorGroup, @KeyID
GO
GRANT EXECUTE ON  [dbo].[vpspPMDailyEmployeeLogInsert] TO [VCSPortal]
GO
