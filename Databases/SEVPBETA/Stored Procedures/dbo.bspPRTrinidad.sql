...
SET ANSI_NULLS ON
GO
CREATE  proc [dbo].[bspPRTrinidad]
 /********************************************************
 * CREATED:  GG 01/20/06 - #119961 Trinidad Tax Routine
 * MODIFIED BY:	
 *
 * USAGE:
 *   Calculates Trinidad tax amount as a rate of gross
 ...
 *	@rate			dedn/liab rate
 *	@accumsubj		accumulated pay period subject amount
 *	@accumelig		accumulated pay period eligible amount
 ...
 **********************************************************/
 ...
 select @rcode = 0, @procname = 'bspPRTrinidad'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRTrinidad] TO [public]
GO
