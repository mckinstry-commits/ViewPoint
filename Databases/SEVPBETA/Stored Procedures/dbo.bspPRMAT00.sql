...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMAT00    Script Date: 8/28/99 9:33:26 AM ******/
   CREATE   proc [dbo].[bspPRMAT00]
   /********************************************************
   * CREATED BY: 	bc 6/1/98
   * MODIFIED BY:  EN 12/17/98
   * MODIFIED BY:  EN 12/22/99 - tax routine update effective 1/1/2000; also fixed to subtract head of household deduction from wage
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate = .0585, @procname = 'bspPRMAT00', @FICArate = .0765
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMAT00] TO [public]
GO
