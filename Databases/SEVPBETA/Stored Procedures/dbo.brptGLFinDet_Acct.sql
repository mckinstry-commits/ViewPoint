...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.brptGLFinDet_Acct    Script Date: 8/28/99 9:33:49 AM ******/
    /****** Object:  PROC dbo.brptGLFinDet_Acct   Script Date: 3/3/97 2:24:47 PM ******/
   CREATE                         PROC dbo.brptGLFinDet_Acct
    ...
    @BegMonth bMonth ='01/01/1950', @EndMonth bMonth = '12/01/2050',@DetailLevel char(1) = 'D')
 	/*created 10/12/04 */
 	/*Made copy of dbo.brptGLFinDet and changed to execute level='A'
    ...
    Create clustered index iGLParts on #GLParts(GLCo)
 ...
 --   end
  ...
  bspexit:
GO
GRANT EXECUTE ON  [dbo].[brptGLFinDet_Acct] TO [public]
GO
