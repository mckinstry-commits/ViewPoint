...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[vpspPMDailyVisitorsLogGet]
/************************************************************
* CREATED:		6/01/06	chs
...
*
* USAGE:
*   Returns the PM Daily Visitor Log
*
* CALLED FROM:
*	ViewpointCS Portal  
*
...
SELECT  d.KeyID,
d.PMCo, d.Project, d.LogDate, d.DailyLog, d.LogType, 
...
d.Quantity, d.Location, l.Description as 'Location Description', 
d.Issue, i.Description as 'Issue Description', d.DelTicket, 
...
Where d.PMCo=@JCCo and d.Project=@Job and d.LogDate=@LogDate 
and d.LogType=@logtype and d.DailyLog = @DailyLog
and d.KeyID = IsNull(@KeyID, d.KeyID)

GO
GRANT EXECUTE ON  [dbo].[vpspPMDailyVisitorsLogGet] TO [VCSPortal]
GO
