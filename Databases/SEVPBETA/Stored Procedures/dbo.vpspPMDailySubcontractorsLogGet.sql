...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[vpspPMDailySubcontractorsLogGet]
/************************************************************
* CREATED:		6/01/06	chs
* MODIFIED:		6/7/07	CHS
*
* USAGE:
*   Returns the PM Daily Subcontractors Log
*
* CALLED FROM:
*	ViewpointCS Portal  
*
...
d.Quantity, d.Location, l.Description as 'Location Description', d.Issue, 
i.Description as 'Issue Description', d.DelTicket, 
d.CreatedChangedBy, d.MatlGroup, d.UM, d.UniqueAttchID, d.EMCo,

substring(d.Description, 1, 90) as 'RemarksTruncated'
...
GO
GRANT EXECUTE ON  [dbo].[vpspPMDailySubcontractorsLogGet] TO [VCSPortal]
GO
