...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRKYT07    Script Date: 8/28/99 9:33:25 AM ******/
  CREATE   proc [dbo].[bspPRKYT07]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @stddedn = 2050, @creditamt = 20
  select @procname = 'bspPRKYT07'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRKYT07] TO [public]
GO
