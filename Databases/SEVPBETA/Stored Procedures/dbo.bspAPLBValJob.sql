...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspAPLBValJob    Script Date: 8/28/99 9:36:01 AM ******/
   CREATE procedure [dbo].[bspAPLBValJob]
   /*********************************************
    * Created: GG 6/25/99
    * Modified: DANF 09/05/02 - 17738 Added PhaseGroup to be passed into bspJobTypeVal
    *
    * Usage:
...
GO
GRANT EXECUTE ON  [dbo].[bspAPLBValJob] TO [public]
GO
