...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRKST992    Script Date: 8/28/99 9:33:24 AM ******/
   CREATE proc [dbo].[bspPRKST992]
   /********************************************************
...
GO
GRANT EXECUTE ON  [dbo].[bspPRKST992] TO [public]
GO
