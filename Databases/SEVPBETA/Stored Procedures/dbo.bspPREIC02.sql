...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPREIC02    Script Date: 8/28/99 9:33:34 AM ******/
   CREATE     proc [dbo].[bspPREIC02]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate1 = .204, @rate2 = .09588, @procname = 'bspPREIC02'
   ...
   if @EICStatus = 'S'
       select @bracket1 = 7370, @bracket2 = 13520, @maxpayamt = 1503
   if @EICStatus = 'M'
       select @bracket1 = 7370, @bracket2 = 14520, @maxpayamt = 1503
   if @EICStatus = 'B'
       select @bracket1 = 3685, @bracket2 = 7260, @maxpayamt = 752
...
GO
GRANT EXECUTE ON  [dbo].[bspPREIC02] TO [public]
GO
