...
SET ANSI_NULLS ON
GO
/****** Object:  PROC dbo.brptGLFinDet_PC    Script Date: 3/3/97 2:24:47 PM ******/
       CREATE       PROC [dbo].[brptGLFinDet_PC]
    ...
    */  
      ...
      selectresults:
   	exec dbo.brptGLFinDetSelect_PC @GLCo , @BegAcct , @EndAcct , @BegMonth, @EndMonth ,
                @Part2, @IncludeInactive, @Source, @Journal, @DetailLevel,
                @FYEMO, @FYBMO, @EndAcctFull, @ErrorMessage

GO
GRANT EXECUTE ON  [dbo].[brptGLFinDet_PC] TO [public]
GO
