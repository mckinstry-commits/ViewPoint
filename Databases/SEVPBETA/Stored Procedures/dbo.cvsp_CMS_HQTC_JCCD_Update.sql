...
create proc [dbo].[cvsp_CMS_HQTC_JCCD_Update] (@fromco smallint, @toco smallint, 
...
delete bHQTC where Co=@toco and TableName='bJCCD'
...
select 'bJCCD',JCCo, Mth, Max(CostTrans)  
from bJCCD 
where JCCo=@toco  
group by JCCo,Mth;
