...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[bspIMViewpointDefaultsGLBD]
   /***********************************************************
   ...
   bspexit:
       ...
       select @msg = isnull(@desc,'Clear') + char(13) + char(10) + '[bspIMViewpointDefaultsGLBD]'
   
       return @rcode


GO
GRANT EXECUTE ON  [dbo].[bspIMViewpointDefaultsGLBD] TO [public]
GO
