...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPREIC09]    Script Date: 12/13/2007 15:47:30 ******/
  CREATE  proc [dbo].[bspPREIC09]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @rate1 = .204, @rate2 = .09588, @procname = 'bspPREIC09'
  ...
  if @EICStatus = 'M'
      select @bracket1 = 8950, @bracket2 = 19540, @maxpayamt = 1826
  if @EICStatus = 'B'
      select @bracket1 = 4475, @bracket2 = 9770, @maxpayamt = 913
...
GO
GRANT EXECUTE ON  [dbo].[bspPREIC09] TO [public]
GO
