...
CREATE                View [dbo].[brvPMBallInCourt] as
       ...
       ************************************/
       ...
       PCOType=null,PCO=null,RFQ=null,RFQSeq=null,VendorGroup=PMRI.VendorGroup, headerCodeType=PMSC.CodeType, ItemCodeType=null
       from PMRI
       ...
       null,null,null,PMTM.Transmittal,null,null,null,null,null,null,null,null,null,PMTM.VendorGroup,null,null
       from PMTM
   ...
   where PMTM.DateDue is not null and PMTM.DateResponded is null 
      ...
      (case when PMSM.DateRecd is null then PMSM.DateReqd 
       ...
       null,null,null,null,PMSM.Submittal,PMSM.Rev,PMSI.Item,null,null,null,null,null,null,PMSM.VendorGroup, 
      ...
      --removed during issue 29940, I don't think they need to be here anymore.
       ...
       null,null,null,null,null,null,null,PMOD.DocType,PMOD.Document,null,null,null,null,PMOD.VendorGroup, CodeType=PMSC.CodeType,null
       from PMOD
   ...
   where isnull(PMSC.CodeType,'') <> 'F' and PMOD.DateRecdBack is  null 
       ...
       null,null,null,null,null,null,null,null,null,PMRQ.PCOType, PMRQ.PCO,PMRQ.RFQ, PMQD.RFQSeq, PMRQ.VendorGroup, CodeType=PMSC.CodeType,null
       from PMRQ
