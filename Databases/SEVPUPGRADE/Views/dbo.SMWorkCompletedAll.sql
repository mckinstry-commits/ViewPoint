...
SELECT vSMWorkCompleted.SMWorkCompletedID AS KeyID, vSMWorkCompleted.[Type], vSMWorkCompleted.IsDeleted, vSMWorkCompleted.UniqueAttchID,
	vSMWorkCompleted.SMWorkCompletedARTLID,
	...
	vSMInvoiceSession.SMSessionID, vSMInvoiceSession.SessionInvoice,
	CASE WHEN vSMWorkCompleted.Provisional = 1 THEN 'Provisional' 
	...
	~dbo.vfEqualsNull(WorkCompletedDetailBackup.SMWorkCompletedID) AS SessionRecordExists, WorkCompletedDetailBackup.SMInvoiceID AS BackupSMInvoiceID,
	BackupInvoiceSession.SMSessionID AS BackupSMSessionID,
	NULL AS CostTotal,
...
FROM dbo.vSMWorkCompleted
	...
	LEFT JOIN dbo.vSMInvoice ON SMWorkCompletedDetail.SMInvoiceID = vSMInvoice.SMInvoiceID
	...
	LEFT JOIN dbo.SMWorkCompletedDetail WorkCompletedDetailBackup ON 
		vSMWorkCompleted.SMWorkCompletedID = WorkCompletedDetailBackup.SMWorkCompletedID
		AND WorkCompletedDetailBackup.IsSession = 1
	LEFT JOIN dbo.vSMInvoiceSession BackupInvoiceSession ON
		WorkCompletedDetailBackup.SMInvoiceID = BackupInvoiceSession.SMInvoiceID
