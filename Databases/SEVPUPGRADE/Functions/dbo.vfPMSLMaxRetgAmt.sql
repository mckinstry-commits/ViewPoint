...
/***********************************************************
* CREATED BY:	GF 10/10/2010 - issue #141789 incorporated functon vfPMSLItemMaxRetgAmt into view for performance
...
CREATE FUNCTION [dbo].[vfPMSLMaxRetgAmt]
(
		@SLCO int = null,
		@SL varchar(30) = null
)

RETURNS @MaxRetgByPct TABLE (MaxRetgByPct numeric(20,2))
...
BEGIN
	...
	INSERT INTO @MaxRetgByPct (MaxRetgByPct)  VALUES (ISNULL(@PMMaxRetgByPct,0) + ISNULL(@SLMaxRetgByPct,0))
...
GO
GRANT SELECT ON  [dbo].[vfPMSLMaxRetgAmt] TO [public]
GO
