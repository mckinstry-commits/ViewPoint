...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPREmplValForAutoEarn    Script Date: 8/28/99 9:33:19 AM ******/
   CREATE      proc [dbo].[bspPREmplValForAutoEarn]
   
   /***********************************************************
    * CREATED BY: EN 2/18/09 copied from bspPREmplVal ... customized for issue #130631 to return PREH_EarnCode,
	*						 earn code method, and PREH_SalaryAmt 
    * MODIFIED BY:  
    *
    *
    * Usage:
    *	Used by PR Automatic Earnings to validate the entry by either Sort Name or number.
    *
    * Input params:
    *	@prco		PR company
    ...
    *	@class		Class
    *	@jcco		JC Company
    *	@job		Last Job Posted for employee
    *	@earncode	Earnings Code
    *	@method		Earnings code method
    *	@salaryamt	Salary Amount
	*	@emco		EM Company from PREH
	*	@emgroup	EM Group from PREH
	*	@equip		Equipment from PREH
    *
    * Return code:
    *	0 = success, 1 = failure
    ************************************************************/
	...
	@earncode bEDLCode=null output,
	@method char(1)=null output,
	@salaryamt bDollar=null output,
   ...
   begin
   	...
   	begin
   		select @emplout = Employee, @sortname=SortName, @lastname=LastName,
			...
			@earncode=EarnCode, @salaryamt=SalaryAmt
   ...
   --lookup method of earnings code
...
GO
GRANT EXECUTE ON  [dbo].[bspPREmplValForAutoEarn] TO [public]
GO
