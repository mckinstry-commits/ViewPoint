...
/****** Object:  StoredProcedure [dbo].[bspPR_CA_NST11]    Script Date: 02/27/2008 13:19:16 ******/
CREATE  PROC [dbo].[bspPR_CA_NST11]
/********************************************************
...
BEGIN
	...
	SELECT @ProcName = 'bspPR_CA_NST11'
...
GO
GRANT EXECUTE ON  [dbo].[bspPR_CA_NST11] TO [public]
GO
