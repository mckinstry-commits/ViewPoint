...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPREIC08]    Script Date: 12/13/2007 15:47:30 ******/
  CREATE  proc [dbo].[bspPREIC08]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @rate1 = .204, @rate2 = .09588, @procname = 'bspPREIC08'
  ...
  if @EICStatus = 'S'
      select @bracket1 = 8580, @bracket2 = 15740, @maxpayamt = 1750
  if @EICStatus = 'M'
      select @bracket1 = 8580, @bracket2 = 18740, @maxpayamt = 1750
  if @EICStatus = 'B'
      select @bracket1 = 4290, @bracket2 = 9370, @maxpayamt = 875
...
GO
GRANT EXECUTE ON  [dbo].[bspPREIC08] TO [public]
GO
