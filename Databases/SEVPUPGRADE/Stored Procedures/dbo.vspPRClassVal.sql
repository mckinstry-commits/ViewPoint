...
CREATE   proc [dbo].[vspPRClassVal]
  ...
  bspexit:
  if @rcode<>0 select @msg=isnull(@msg,'') --+ char(13) + char(10) + '[vspPRClassVal]'
  	return @rcode

GO
GRANT EXECUTE ON  [dbo].[vspPRClassVal] TO [public]
GO
