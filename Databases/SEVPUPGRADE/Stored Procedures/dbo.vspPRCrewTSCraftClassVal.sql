...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[vspPRCrewTSCraftClassVal]
/************************************************************************
* CREATED:  mh 7/13/07    
* MODIFIED:    
*
...
*
*    Validate Craft/Class and then return appropriate rates to Crew TS.
*    
*           
...
*************************************************************************/
	...
	if @@rowcount = 0
	begin
		select @msg = 'Craft/Class combination not on file!', @rcode = 1 	goto vspexit
	end
...
GO
GRANT EXECUTE ON  [dbo].[vspPRCrewTSCraftClassVal] TO [public]
GO
