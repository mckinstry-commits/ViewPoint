...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRMIT11]    Script Date: 11/09/2007 11:13:02 ******/
CREATE  proc [dbo].[bspPRMIT11]
/********************************************************
...
**********************************************************/
  ...
  select @rcode = 0, @rate = .0435,  @procname = 'bspPRMIT11'
  ...
  select @annualized_wage = (@subjamt * @ppds) - ((@exempts + @addtl_exempts) * 3700)
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMIT11] TO [public]
GO
