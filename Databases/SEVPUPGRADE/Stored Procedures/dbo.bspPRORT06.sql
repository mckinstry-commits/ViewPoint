...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRORT06    Script Date: 8/28/99 9:33:32 AM ******/
 CREATE  proc [dbo].[bspPRORT06]
 /********************************************************
 ...
 **********************************************************/
 ...
 select @rcode = 0, @basetax = 0, @dedn = 0, @rate = 0, @procname = 'bspPRORT06'
 ...
 bspcalc: /* calculate Oregon Tax */
 	select @amt = ((@basetax + (@a - @dedn) * @rate) - (159 * @exempts)) / @ppds
...
GO
GRANT EXECUTE ON  [dbo].[bspPRORT06] TO [public]
GO
