...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNYT98    Script Date: 8/28/99 9:33:30 AM ******/
   CREATE   proc [dbo].[bspPRNYT98]
   /********************************************************
   ...
   *
   * USAGE:
   * 	Calculates 1998 New York Income Tax
   *
   * INPUT PARAMETERS:
   ...
   **********************************************************/
   ...
   select @rcode = 0, @allowance = 1000, @procname = 'bspPRNYT98'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNYT98] TO [public]
GO
