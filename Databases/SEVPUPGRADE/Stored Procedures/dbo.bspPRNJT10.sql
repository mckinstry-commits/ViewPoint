...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNJT10    Script Date: 8/28/99 9:33:29 AM ******/
    CREATE proc [dbo].[bspPRNJT10]
    /********************************************************
	...
	*				EN 11/25/2009 #135436  tax update effective 1/1/2010
    * USAGE:
    ...
    **********************************************************/
    ...
    select @rcode = 0, @allowance = 1000, @procname = 'bspPRNJT10'
   ...
   if @exempts is null select @exempts = 0
    ...
    begin
    	...
    	if @annualized_wage > 500000 select @tax_addition = 32680, @wage_bracket = 500000, @rate = .099
    end
    ...
    begin
    	...
    	if @annualized_wage > 500000 select @tax_addition = 30600, @wage_bracket = 500000, @rate = .099
    end
    ...
    begin
    	...
    	if @annualized_wage > 500000 select @tax_addition = 29530, @wage_bracket = 500000, @rate = .099
    end
    ...
    begin
    	...
    	if @annualized_wage > 500000 select @tax_addition = 29400, @wage_bracket = 500000, @rate = .099
    end
    ...
    begin
    	...
    	if @annualized_wage > 500000 select @tax_addition = 30370, @wage_bracket = 500000, @rate = .099
    end
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNJT10] TO [public]
GO
