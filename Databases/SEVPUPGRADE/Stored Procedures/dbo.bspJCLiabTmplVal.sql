...
CREATE   proc [dbo].[bspJCLiabTmplVal]
/***********************************************************
...
*   1         Failure
*****************************************************/ 
(@jcco bCompany = 0, @liabtemplate smallint = null, @desc varchar(60) output, @msg varchar(60) output)
...
GO
GRANT EXECUTE ON  [dbo].[bspJCLiabTmplVal] TO [public]
GO
