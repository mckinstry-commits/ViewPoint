...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPROHT982    Script Date: 8/28/99 9:33:31 AM ******/
   CREATE proc [dbo].[bspPROHT982]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @allowance = 650, @procname = 'bspPROHT982'
...
GO
GRANT EXECUTE ON  [dbo].[bspPROHT982] TO [public]
GO
