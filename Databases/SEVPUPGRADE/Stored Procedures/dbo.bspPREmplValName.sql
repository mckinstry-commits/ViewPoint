...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPREmplValName    Script Date: 8/28/99 9:33:19 AM ******/
   CREATE    proc [dbo].[bspPREmplValName]
    ...
    *
    * Usage:
    *	Used to bypass data security for the posting and validating on entries in EM.
    *
    * Input params:
    *	@prco		PR company
...
GO
GRANT EXECUTE ON  [dbo].[bspPREmplValName] TO [public]
GO
