...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRHIT02    Script Date: 8/28/99 9:33:22 AM ******/
   CREATE   proc [dbo].[bspPRHIT02]
   /********************************************************
...
GO
GRANT EXECUTE ON  [dbo].[bspPRHIT02] TO [public]
GO
