...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRVIT10]    Script Date: 12/13/2007 15:22:31 ******/
   CREATE  proc [dbo].[bspPRVIT10]
   /********************************************************
   * CREATED BY: 	EN 3/09/10
   * MODIFIED BY:  
   *
   * USAGE:
   * 	Calculates Virgin Islands Income Tax by calling Federal tax routine.
   *
   * INPUT PARAMETERS:
...
GO
GRANT EXECUTE ON  [dbo].[bspPRVIT10] TO [public]
GO
