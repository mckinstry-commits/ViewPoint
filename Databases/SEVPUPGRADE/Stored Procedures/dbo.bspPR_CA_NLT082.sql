...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPR_CA_NLT082]    Script Date: 02/27/2008 13:19:16 ******/
   CREATE  proc [dbo].[bspPR_CA_NLT082]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @calcamt = 0, @procname = 'bspPR_CA_NLT082'
   ...
   select @rate = .155, @KP = 3173
   if @A <= 60429 select @rate = .128, @KP = 1541
   if @A <= 30215 select @rate = .077, @KP = 0
...
GO
GRANT EXECUTE ON  [dbo].[bspPR_CA_NLT082] TO [public]
GO
