...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRCTT02    Script Date: 8/28/99 9:33:14 AM ******/
   CREATE    proc [dbo].[bspPRCTT02]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @procname = 'bspPRCTT02'
   ...
   if @status = 'S' --aka. Conn. filing status 'F'
   	begin
   	 ...
   	 if @asubjamt >= 25500 and @asubjamt <= 37500 select @exemptamt = floor ((38500 - @asubjamt) / 1000) * 1000 - 1750
   	end
...
GO
GRANT EXECUTE ON  [dbo].[bspPRCTT02] TO [public]
GO
