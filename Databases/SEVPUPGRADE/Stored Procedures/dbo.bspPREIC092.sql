...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPREIC092]    Script Date: 12/13/2007 15:47:30 ******/
  CREATE  proc [dbo].[bspPREIC092]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @rate1 = .204, @rate2 = .09588, @procname = 'bspPREIC092'
  ...
  if @EICStatus = 'S'
      select @bracket1 = 8950, @bracket2 = 16420, @maxpayamt = 1826
  if @EICStatus = 'M'
      select @bracket1 = 8950, @bracket2 = 21420, @maxpayamt = 1826
  if @EICStatus = 'B'
      select @bracket1 = 4475, @bracket2 = 10710, @maxpayamt = 913
...
GO
GRANT EXECUTE ON  [dbo].[bspPREIC092] TO [public]
GO
