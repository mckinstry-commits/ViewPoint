...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRCTT08]    Script Date: 01/03/2008 16:16:03 ******/
  CREATE proc [dbo].[bspPRCTT08]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @procname = 'bspPRCTT08'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRCTT08] TO [public]
GO
