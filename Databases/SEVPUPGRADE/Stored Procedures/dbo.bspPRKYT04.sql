...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRKYT04    Script Date: 8/28/99 9:33:25 AM ******/
   CREATE     proc [dbo].[bspPRKYT04]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @stddedn = 1870, @creditamt = 20
   select @procname = 'bspPRKYT04'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRKYT04] TO [public]
GO
