...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMDT05    Script Date: 8/28/99 9:33:26 AM ******/
    CREATE proc [dbo].[bspPRMDT05]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @rate = 0, @procname = 'bspPRMDT05'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMDT05] TO [public]
GO
