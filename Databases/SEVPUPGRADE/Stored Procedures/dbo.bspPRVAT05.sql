...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRVAT05    Script Date: 8/28/99 9:33:36 AM ******/
    CREATE proc [dbo].[bspPRVAT05]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @deduction = 3000, @allowance1 = 800, @allowance2 = 900, @procname = 'bspPRVAT05'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRVAT05] TO [public]
GO
