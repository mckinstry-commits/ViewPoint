...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMAT02    Script Date: 8/28/99 9:33:26 AM ******/
    CREATE     proc [dbo].[bspPRMAT02]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @rate = .053, @procname = 'bspPRMAT02', @FICArate = .0765
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMAT02] TO [public]
GO
