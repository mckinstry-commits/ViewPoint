...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMAT01    Script Date: 8/28/99 9:33:26 AM ******/
    CREATE    proc [dbo].[bspPRMAT01]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @rate = .056, @procname = 'bspPRMAT01', @FICArate = .0765
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMAT01] TO [public]
GO
