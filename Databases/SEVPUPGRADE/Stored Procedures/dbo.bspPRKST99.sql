...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRKST99    Script Date: 8/28/99 9:33:24 AM ******/
   CREATE   proc [dbo].[bspPRKST99]
   /********************************************************
...
GO
GRANT EXECUTE ON  [dbo].[bspPRKST99] TO [public]
GO
