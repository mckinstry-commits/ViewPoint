   ...
   ************************************************************/
   ...
   /*  If @Column='ReversalStatus' select @EMTransType = @Uploadval */
   	...
   	If @Column='Job' select @Job = @Uploadval
    	...
    	If @Column='PstUnits' and isnumeric(@Uploadval) = 1 select @PstUnits = Convert( decimal(10,5),@Uploadval)
    	If @Column='PstUnitCost' and isnumeric(@Uploadval) = 1 select @PstUnitCost = Convert ( decimal(10,5),@Uploadval)
    	If @Column='PstECM' select @PstECM = @Uploadval
    	If @Column='Cost' and isnumeric(@Uploadval) = 1 select @Cost = Convert ( decimal(10,5),@Uploadval)
    	...
    	If @Column='TaxAmt' and isnumeric(@Uploadval) = 1 select @TaxAmt = Convert ( decimal(10,5),@Uploadval)
