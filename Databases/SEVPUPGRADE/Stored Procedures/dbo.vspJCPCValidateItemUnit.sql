...
SET ANSI_NULLS ON
GO
CREATE      proc [dbo].[vspJCPCValidateItemUnit]
  /***********************************************************
   ...
   *****************************************************/ 
  	...
  	(@phasegroup bGroup = 0, @phase bPhase = null, @costtype bJCCType = null, @itemunit bYN = null,
	...
	as
  	...
  	where PhaseGroup = @phasegroup and Phase = @phase and CostType <> @costtype and ItemUnitFlag = 'Y'
...
GO
GRANT EXECUTE ON  [dbo].[vspJCPCValidateItemUnit] TO [public]
GO
