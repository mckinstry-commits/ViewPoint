...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[vpspPMDailyEquipmentLogGet]
/************************************************************
* CREATED:		6/01/06	chs
* MODIFIED		6/6/07	chs
* MODIFIED:		6/7/07	CHS
*
* USAGE:
*   Returns the PM Daily Equipment Log	
*
* CALLED FROM:
*	ViewpointCS Portal  
*
...
d.Description as 'EquipDescription', 
...
d.CreatedChangedBy, d.MatlGroup, d.UM, d.UniqueAttchID, 
cast (d.EMCo AS int) as 'EMCo',
h.Name as 'EMCoName' 
...
FROM PMDD d with (nolock)
	...
	Left Join HQCO h with (nolock) on d.EMCo=h.HQCo
...
GO
GRANT EXECUTE ON  [dbo].[vpspPMDailyEquipmentLogGet] TO [VCSPortal]
GO
