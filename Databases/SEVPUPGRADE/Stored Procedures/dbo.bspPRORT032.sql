...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRORT032    Script Date: 8/28/99 9:33:32 AM ******/
   CREATE proc [dbo].[bspPRORT032]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @basetax = 0, @dedn = 0, @rate = 0, @procname = 'bspPRORT032'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRORT032] TO [public]
GO
