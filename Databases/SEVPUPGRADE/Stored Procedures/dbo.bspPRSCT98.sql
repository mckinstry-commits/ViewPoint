...
CREATE  proc [dbo].[bspPRSCT98]
     ...
     *
     * USAGE:
     * 	Calculates 1998 South Carolina Income Tax
     *
     * INPUT PARAMETERS:
     ...
     **********************************************************/
     ...
     select @rcode = 0, @allowance = 2300, @procname = 'bspPRSCT98'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRSCT98] TO [public]
GO
