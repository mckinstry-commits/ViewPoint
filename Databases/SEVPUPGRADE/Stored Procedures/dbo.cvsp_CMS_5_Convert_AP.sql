...
--Add columns/indexes
exec @rc= dbo.cvsp_CMS_PO_AddColsIndexes @fromco, @toco, @errmsg output, @rowcount output;
--insert into cvLog
select getdate(),'cvsp_CMS_PO_AddColsIndexes',@fromco, @toco, @rowcount, @errmsg;
--select getdate(),'cvsp_CMS_AP_AddColsIndexes',[FromCo]=@fromco,[ToCo]= @toco, [Rows]=@rowcount, [ErrMsg]=@errmsg;
...
exec @rc=dbo.cvsp_CMS_HQTC_POCD_Update @fromco, @toco, @errmsg output, @rowcount output;
--insert into cvLog
select GETDATE(), 'cvsp_CMS_HQTC_POCD_Update', @fromco, @toco, @rowcount, @errmsg;
--select GETDATE(), 'cvsp_CMS_POCD', [FromCo]=@fromco, [ToCo]=@toco, [Rows]=@rowcount, [ErrMsg]=@errmsg;
