...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPREIC06    Script Date: 8/28/99 9:33:34 AM ******/
  CREATE  proc [dbo].[bspPREIC06]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @rate1 = .204, @rate2 = .09588, @procname = 'bspPREIC06'
  ...
  if @EICStatus = 'S'
      select @bracket1 = 8080, @bracket2 = 14810, @maxpayamt = 1648
  if @EICStatus = 'M'
      select @bracket1 = 8080, @bracket2 = 16810, @maxpayamt = 1648
  if @EICStatus = 'B'
      select @bracket1 = 4040, @bracket2 = 8405, @maxpayamt = 824
...
GO
GRANT EXECUTE ON  [dbo].[bspPREIC06] TO [public]
GO
