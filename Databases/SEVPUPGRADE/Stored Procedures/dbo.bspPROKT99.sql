...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPROKT99    Script Date: 8/28/99 9:33:32 AM ******/
   CREATE   proc [dbo].[bspPROKT99]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @procname = 'bspPROKT99'
   ...
   if @status = 'M' or @status = 'H' select @deduction_2 = @annualized_wage - (@exempts * 2700) - 7200
   	else
   	select @deduction_2 = @annualized_wage - (@exempts * 2700) - 4300
    ...
    * 6.75% * (gross wage - $22,560) to determine total withholding */
   
   if @subjamt * @ppds > 22560 select @amt = @amt + (@subjamt * @ppds - 22560) * .0675
...
GO
GRANT EXECUTE ON  [dbo].[bspPROKT99] TO [public]
GO
