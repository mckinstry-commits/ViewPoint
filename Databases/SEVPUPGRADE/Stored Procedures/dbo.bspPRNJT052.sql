...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNJT052    Script Date: 8/28/99 9:33:29 AM ******/
    CREATE proc [dbo].[bspPRNJT052]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @allowance = 1000, @procname = 'bspPRNJT052'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNJT052] TO [public]
GO
