...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMIT052    Script Date: 8/28/99 9:33:27 AM ******/
    CREATE proc [dbo].[bspPRMIT052]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @rate = .039,  @procname = 'bspPRMIT052'
    ...
    select @annualized_wage = (@subjamt * @ppds) - ((@exempts + @addtl_exempts) * 3200)
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMIT052] TO [public]
GO
