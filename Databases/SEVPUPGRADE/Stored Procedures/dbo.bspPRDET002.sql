...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRDET002    Script Date: 8/28/99 9:33:16 AM ******/
   CREATE proc [dbo].[bspPRDET002]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @persexempt = 110, @procname = 'bspPRDET002'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRDET002] TO [public]
GO
