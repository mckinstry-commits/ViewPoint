...
-- ==========================================================================================
CREATE PROCEDURE [dbo].[vspDDGetIdentityColumn] (@tableOrView varchar(128), @identityColumnName varchar(128) OUTPUT )
AS
BEGIN
	...
	BEGIN
		...
		IF EXISTS(SELECT TOP 1 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = @tableOrView AND COLUMN_NAME = 'KeyID')
		BEGIN
