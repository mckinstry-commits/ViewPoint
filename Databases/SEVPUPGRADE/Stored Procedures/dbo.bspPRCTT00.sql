...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRCTT00    Script Date: 8/28/99 9:33:14 AM ******/
   CREATE   proc [dbo].[bspPRCTT00]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @procname = 'bspPRCTT00'
   ...
   if @status = 'S' --aka. Conn. filing status 'F'
   	begin
   	 if @asubjamt <= 24500 select @exemptamt = 12250
   	 if @asubjamt >= 24500 and @asubjamt <= 36500 select @exemptamt = floor ((37500 - @asubjamt) / 1000) * 1000 - 750
   	end
   ...
   if @status = 'S'
   	begin
   	 if @asubjamt > 12250 and @asubjamt <=15300 select @pcredits = .75
   	 if @asubjamt > 15300 and @asubjamt <=15800 select @pcredits = .7
   	 if @asubjamt > 15800 and @asubjamt <=16300 select @pcredits = .65
   	 if @asubjamt > 16300 and @asubjamt <=16800 select @pcredits = .6
   	 if @asubjamt > 16800 and @asubjamt <=17300 select @pcredits = .55
   	 if @asubjamt > 17300 and @asubjamt <=17800 select @pcredits = .5
   	 if @asubjamt > 17800 and @asubjamt <=18300 select @pcredits = .45
   	 if @asubjamt > 18300 and @asubjamt <=18800 select @pcredits = .4
   	 if @asubjamt > 18800 and @asubjamt <=20400 select @pcredits = .35
   	 if @asubjamt > 20400 and @asubjamt <=20900 select @pcredits = .3
   	 if @asubjamt > 20900 and @asubjamt <=21400 select @pcredits = .25
   	 if @asubjamt > 21400 and @asubjamt <=21900 select @pcredits = .2
   	 if @asubjamt > 21900 and @asubjamt <=25500 select @pcredits = .15
   	 if @asubjamt > 25500 and @asubjamt <=26000 select @pcredits = .14
   	 if @asubjamt > 26000 and @asubjamt <=26500 select @pcredits = .13
   	 if @asubjamt > 26500 and @asubjamt <=27000 select @pcredits = .12
   	 if @asubjamt > 27000 and @asubjamt <=27500 select @pcredits = .11
   	 if @asubjamt > 27500 and @asubjamt <=49000 select @pcredits = .1
   	 if @asubjamt > 49000 and @asubjamt <=49500 select @pcredits = .09
   	 if @asubjamt > 49500 and @asubjamt <=50000 select @pcredits = .08
   	 if @asubjamt > 50000 and @asubjamt <=50500 select @pcredits = .07
   	 if @asubjamt > 50500 and @asubjamt <=51000 select @pcredits = .06
   	 if @asubjamt > 51000 and @asubjamt <=51500 select @pcredits = .05
   	 if @asubjamt > 51500 and @asubjamt <=52000 select @pcredits = .04
   	 if @asubjamt > 52000 and @asubjamt <=52500 select @pcredits = .03
   	 if @asubjamt > 52500 and @asubjamt <=53000 select @pcredits = .02
   	 if @asubjamt > 53000 and @asubjamt <=53500 select @pcredits = .01
   	 if @asubjamt > 53500 select @pcredits = 0
   	end
...
GO
GRANT EXECUTE ON  [dbo].[bspPRCTT00] TO [public]
GO
