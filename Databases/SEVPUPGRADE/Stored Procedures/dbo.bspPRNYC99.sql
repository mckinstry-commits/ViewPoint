...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNYC99    Script Date: 8/28/99 9:33:30 AM ******/
   CREATE   proc [dbo].[bspPRNYC99]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @allowance = 1000, @procname = 'bspPRNYC99'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNYC99] TO [public]
GO
