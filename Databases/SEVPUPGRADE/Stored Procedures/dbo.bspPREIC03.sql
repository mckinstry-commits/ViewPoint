...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPREIC03    Script Date: 8/28/99 9:33:34 AM ******/
   CREATE      proc [dbo].[bspPREIC03]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate1 = .204, @rate2 = .09588, @procname = 'bspPREIC03'
   ...
   if @EICStatus = 'S'
       select @bracket1 = 7490, @bracket2 = 13730, @maxpayamt = 1528
   if @EICStatus = 'M'
       select @bracket1 = 7490, @bracket2 = 14730, @maxpayamt = 1528
   if @EICStatus = 'B'
       select @bracket1 = 3745, @bracket2 = 7365, @maxpayamt = 764
...
GO
GRANT EXECUTE ON  [dbo].[bspPREIC03] TO [public]
GO
