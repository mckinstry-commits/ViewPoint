...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRBG] ON [dbo].[bHRBG] ([HRCo], [BenefitGroup]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRBG] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
