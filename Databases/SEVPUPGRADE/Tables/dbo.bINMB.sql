...
GO
CREATE UNIQUE CLUSTERED INDEX [biINMB] ON [dbo].[bINMB] ([Co], [Mth], [BatchId], [BatchSeq]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINMB] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
