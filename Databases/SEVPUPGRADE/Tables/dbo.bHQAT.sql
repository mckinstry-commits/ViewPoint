...
GO
CREATE UNIQUE CLUSTERED INDEX [biHQAT] ON [dbo].[bHQAT] ([AttachmentID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biHQAT_AttchID] ON [dbo].[bHQAT] ([AttachmentID], [FormName], [UniqueAttchID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
...
GO
CREATE NONCLUSTERED INDEX [biHQATUniqueAttchID] ON [dbo].[bHQAT] ([UniqueAttchID]) INCLUDE ([AttachmentID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
