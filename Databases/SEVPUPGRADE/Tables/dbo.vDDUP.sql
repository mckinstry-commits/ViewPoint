...
insert into dbo.bHQMA (TableName, KeyString, Co, RecType, FieldName, OldValue, NewValue, DateTime, UserName)  
 ...
 null, 'D', null, null, null, getdate(), SUSER_SNAME() from deleted  
...
select 'vDDUP', 'Name: ' + VPUserName, null, 'A', null, null, null, getdate(), SUSER_SNAME()
from inserted
...
if update(ShowRates)
   	...
   	select 'vDDUP', 'VPUserName: ' + i.VPUserName, null, 'C', 'ShowRates',
		 d.ShowRates, i.ShowRates, getdate(), SUSER_SNAME() 
   	from inserted i
...
if update(RestrictedBatches)
   	...
   	select 'vDDUP', 'VPUserName: ' + i.VPUserName, null, 'C', 'RestrictedBatches',
		 d.RestrictedBatches, i.RestrictedBatches, getdate(), SUSER_SNAME() 
   	from inserted i
   	join deleted d on i.VPUserName = d.VPUserName 
...
if update(MenuAdmin)
   	...
   	select 'vDDUP', 'VPUserName: ' + i.VPUserName, null, 'C', 'MenuAdmin',
		 d.MenuAdmin, i.MenuAdmin, getdate(), SUSER_SNAME() 
   	from inserted i
   	join deleted d on i.VPUserName = d.VPUserName 
...
if update(FormAdmin)
   	...
   	select 'vDDUP', 'VPUserName: ' + i.VPUserName, null, 'C', 'FormAdmin',
		 d.FormAdmin, i.FormAdmin, getdate(), SUSER_SNAME() 
   	from inserted i
   	join deleted d on i.VPUserName = d.VPUserName 
...
if update(MaxLookupRows)
	insert into dbo.bHQMA (TableName, KeyString, Co, RecType, FieldName, OldValue, NewValue, DateTime, UserName)
   	select 'vDDUP', 'VPUserName: ' + i.VPUserName, null, 'C', 'MaxLookupRows',
		 d.MaxLookupRows, i.MaxLookupRows, getdate(), SUSER_SNAME() 
	from inserted i
  	join deleted d on i.VPUserName = d.VPUserName 
...
if update(MaxFilterRows)
	insert into dbo.bHQMA (TableName, KeyString, Co, RecType, FieldName, OldValue, NewValue, DateTime, UserName)
   	select 'vDDUP', 'VPUserName: ' + i.VPUserName, null, 'C', 'MaxFilterRows',
		 d.MaxFilterRows, i.MaxFilterRows, getdate(), SUSER_SNAME() 
	from inserted i
  	join deleted d on i.VPUserName = d.VPUserName 
...
IF update(HRCo)
   	INSERT INTO dbo.bHQMA (TableName, KeyString, Co, RecType, FieldName, OldValue, NewValue, DateTime, UserName)
   		SELECT 'vDDUP', 'VPUserName: ' + i.VPUserName, null, 'C', 'HRCo',
			   d.HRCo, i.HRCo, getdate(), SUSER_SNAME() 
   	      FROM inserted i
   	      JOIN deleted d ON i.VPUserName = d.VPUserName 
...
IF update(HRRef)
   	INSERT INTO dbo.bHQMA (TableName, KeyString, Co, RecType, FieldName, OldValue, NewValue, DateTime, UserName)
   		SELECT 'vDDUP', 'VPUserName: ' + i.VPUserName, null, 'C', 'HRRef',
		       d.HRRef, i.HRRef, getdate(), SUSER_SNAME() 
   	      FROM inserted i
   	      JOIN deleted d ON i.VPUserName = d.VPUserName 
