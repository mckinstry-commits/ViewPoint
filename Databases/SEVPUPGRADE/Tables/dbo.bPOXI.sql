...
GO
CREATE UNIQUE CLUSTERED INDEX [biPOXI] ON [dbo].[bPOXI] ([POCo], [Mth], [BatchId], [INCo], [Loc], [MatlGroup], [Material], [BatchSeq], [POItem], [POItemLine]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
