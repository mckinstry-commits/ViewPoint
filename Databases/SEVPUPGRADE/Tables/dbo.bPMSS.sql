...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMSS] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMSS] ON [dbo].[bPMSS] ([PMCo], [Project], [SLCo], [SL]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
