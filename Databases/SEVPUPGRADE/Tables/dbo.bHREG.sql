...
GO
CREATE UNIQUE CLUSTERED INDEX [biHREG] ON [dbo].[bHREG] ([HRCo], [HRRef], [Seq]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHREG] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
