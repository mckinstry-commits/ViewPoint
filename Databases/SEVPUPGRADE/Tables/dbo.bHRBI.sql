...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRBI] ON [dbo].[bHRBI] ([HRCo], [BenefitCode], [EDLType], [EDLCode], [BenefitOption]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRBI] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
