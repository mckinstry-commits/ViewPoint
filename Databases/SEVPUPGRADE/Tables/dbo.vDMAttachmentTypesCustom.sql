...
GO
ALTER TABLE [dbo].[vDMAttachmentTypesCustom] ADD CONSTRAINT [PK_vDMAttachmentTypesCustom] PRIMARY KEY CLUSTERED  ([AttachmentTypeID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
