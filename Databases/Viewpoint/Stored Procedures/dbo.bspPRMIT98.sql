...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMIT98    Script Date: 8/28/99 9:33:27 AM ******/
   CREATE  proc [dbo].[bspPRMIT98]
   /********************************************************
   ...
   *
   * USAGE:
   * 	Calculates 1998 Michigan (Home of the Red Wings) Income Tax
   *
   * INPUT PARAMETERS:
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate = .044,  @procname = 'bspPRMIT98'
   ...
   select @annualized_wage = (@subjamt * @ppds) - ((@exempts * 2800) + (@addtl_exempts * 900))
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMIT98] TO [public]
GO
