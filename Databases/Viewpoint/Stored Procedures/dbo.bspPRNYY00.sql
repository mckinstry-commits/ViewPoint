...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNYY00    Script Date: 8/28/99 9:33:31 AM ******/
    CREATE   proc [dbo].[bspPRNYY00]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @allowance = 1000, @procname = 'bspPRNYY00'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNYY00] TO [public]
GO
