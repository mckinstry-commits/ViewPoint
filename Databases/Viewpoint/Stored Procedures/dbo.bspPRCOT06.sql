...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRCOT06    Script Date: 8/28/99 9:33:14 AM ******/
 CREATE  proc [dbo].[bspPRCOT06]
 /********************************************************
 ...
 **********************************************************/
 ...
 select @rcode = 0, @amt = 0, @a = 0, @limit = 0, @procname = 'bspPRCOT06'
 ...
 select @a = @subjamt * @ppds - 3300 * @exempts
 
 /* get percentage limit */
 select @limit = 1850
 if @status = 'M' select @limit = 7000
...
GO
GRANT EXECUTE ON  [dbo].[bspPRCOT06] TO [public]
GO
