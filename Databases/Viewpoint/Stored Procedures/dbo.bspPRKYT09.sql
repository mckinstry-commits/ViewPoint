...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRKYT09]    Script Date: 12/20/2007 07:54:34 ******/
  CREATE proc [dbo].[bspPRKYT09]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @stddedn = 2190, @creditamt = 20
  select @procname = 'bspPRKYT09'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRKYT09] TO [public]
GO
