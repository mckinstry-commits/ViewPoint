...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPROKT05    Script Date: 8/28/99 9:33:32 AM ******/
   CREATE        proc [dbo].[bspPROKT05]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @procname = 'bspPROKT05'
...
GO
GRANT EXECUTE ON  [dbo].[bspPROKT05] TO [public]
GO
