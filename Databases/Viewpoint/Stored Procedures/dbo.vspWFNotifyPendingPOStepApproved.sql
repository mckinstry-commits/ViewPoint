...
*				6/05/2012 - Nels H. - updated the text of the email
...
*
*****************************************************/
CREATE PROCEDURE [dbo].[vspWFNotifyPendingPOStepApproved] 
...
GO
GRANT EXECUTE ON  [dbo].[vspWFNotifyPendingPOStepApproved] TO [public]
GO
