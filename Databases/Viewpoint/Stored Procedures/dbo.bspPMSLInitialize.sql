...
declare @rcode int, @retcode int, @validcnt int, @slno varchar(1), @sigpartjob bYN, @validpartjob varchar(30),
		...
		@projectpart bProject, @vendorPart varchar(30), @SL VARCHAR(30), @apco bCompany, @slitem bItem,
		@formattedsl varchar(30), @tmpsl varchar(30), @phase bPhase, @itemtype int,
		@slseqlen int, @phasegroup bGroup, @mseq int,
		...
		@defrecordtype char(1), @sllength varchar(30), @slmask varchar(30), @dummy_sl varchar(30),
		@slitemdescription bItemDesc, @lastslseq int, @tmpsl1 VARCHAR(30), --bSL,  DC #135813
		@i int, @value varchar(1),
		@tmpseq1 varchar(30), @active bYN, @phasemsg varchar(100), @opencursor int, @recordtype varchar(1),
		@pcotype bDocType, @pco bACO, @pcoitem bACOItem, @aco bACO, @acoitem bACOItem,
		@lastvendor bVendor, @slstartseq SMALLINT,
		@SLExists CHAR(1),
		---- TK-08876
