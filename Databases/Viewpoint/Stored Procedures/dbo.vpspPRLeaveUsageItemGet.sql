...
CREATE  PROCEDURE [dbo].[vpspPRLeaveUsageItemGet]
/************************************************************
* CREATED:     SDE 6/13/2006
* MODIFIED:    Chris G 8/7/12 TK-16896 | B-07454 - Added KeyID
*
* USAGE:
*   Returns the PR Leave Usage for a given PRCo and Employee and LeaveCode
...
where PRLH.PRCo = @PRCo and Employee = @Employee and Type='U' and PRLH.LeaveCode = @LeaveCode
...
GO
GRANT EXECUTE ON  [dbo].[vpspPRLeaveUsageItemGet] TO [VCSPortal]
GO
