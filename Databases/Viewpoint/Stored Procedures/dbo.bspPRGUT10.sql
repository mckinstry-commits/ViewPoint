...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRGUT10]    Script Date: 12/13/2007 15:22:31 ******/
   CREATE  proc [dbo].[bspPRGUT10]
   /********************************************************
   * CREATED BY: 	CHS 10/14/10
   * MODIFIED BY:  
   *
   * USAGE:
   * 	Calculates Guam Income Tax by calling Federal tax routine.
   *
   * INPUT PARAMETERS:
...
GO
GRANT EXECUTE ON  [dbo].[bspPRGUT10] TO [public]
GO
