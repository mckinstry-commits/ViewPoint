...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMDT01    Script Date: 8/28/99 9:33:26 AM ******/
   CREATE  proc [dbo].[bspPRMDT01]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate = 0, @procname = 'bspPRMDT01'
   ...
   select @annualized_wage = @annualized_wage - @deductions - (2100 * @exempts)
   ...
   begin
   	...
   	if @counter = 3000 select @tax_addition = 90, @wage_bracket = 3000, @rate = .048
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMDT01] TO [public]
GO
