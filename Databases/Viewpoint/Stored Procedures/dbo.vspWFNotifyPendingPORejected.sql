...
*
*****************************************************/
CREATE PROCEDURE [dbo].[vspWFNotifyPendingPORejected] 
...
BEGIN
	...
	-- The first join provides data on the approval process
...
GO
GRANT EXECUTE ON  [dbo].[vspWFNotifyPendingPORejected] TO [public]
GO
