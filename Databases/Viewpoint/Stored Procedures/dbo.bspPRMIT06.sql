...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMIT06    Script Date: 8/28/99 9:33:27 AM ******/
  CREATE  proc [dbo].[bspPRMIT06]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @rate = .039,  @procname = 'bspPRMIT06'
  ...
  select @annualized_wage = (@subjamt * @ppds) - ((@exempts + @addtl_exempts) * 3300)
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMIT06] TO [public]
GO
