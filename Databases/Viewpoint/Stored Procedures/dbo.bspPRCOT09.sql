...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRCOT09    Script Date: 8/28/99 9:33:14 AM ******/
 CREATE  proc [dbo].[bspPRCOT09]
 /********************************************************
 ...
 **********************************************************/
 ...
 select @rcode = 0, @amt = 0, @a = 0, @limit = 0, @procname = 'bspPRCOT09'
 ...
 select @a = @subjamt * @ppds - 3650 * @exempts
 
 /* get percentage limit */
 select @limit = 2050
 if @status = 'M' select @limit = 7750
...
GO
GRANT EXECUTE ON  [dbo].[bspPRCOT09] TO [public]
GO
