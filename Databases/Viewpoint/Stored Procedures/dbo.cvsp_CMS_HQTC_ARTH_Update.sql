...
create proc [dbo].[cvsp_CMS_HQTC_ARTH_Update] (@fromco smallint, @toco smallint, 
...
delete bHQTC where Co=@toco and TableName='bARTH'
...
select 'bARTH',ARCo, Mth, Max(ARTrans)  
from bARTH 
where ARCo=@toco  
group by ARCo,Mth;
