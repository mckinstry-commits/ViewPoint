...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPR_CA_MBT08]    Script Date: 02/27/2008 13:19:16 ******/
   CREATE  proc [dbo].[bspPR_CA_MBT08]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @calcamt = 0, @procname = 'bspPR_CA_MBT08'
   ...
   select @rate = .1740, @KP = 3634
   if @A <= 66000 select @rate = .1275, @KP = 565
   if @A <= 30544 select @rate = .1090, @KP = 0
...
GO
GRANT EXECUTE ON  [dbo].[bspPR_CA_MBT08] TO [public]
GO
