...
@posttoall bYN, @errmsg varchar(255) output
 ...
 --@hrs bHrs, 
 --@factor bRate, 
 --@incldliabdist char(1), 
 --@overrate bUnitCost, 
 --@liabbasis bDollar, --issue 20562
 --@accurcalc float,
 ...
 --@dldesc bDesc, 
 --@dltype char(1), @method varchar(10), @routine varchar(10),
 --@seq1only bYN, @ytdcorrect bYN, @bonusover bYN, @bonusrate bRate, @limitbasis char(1), @limitrate bRate, @empllimitrate bRate, /*issue 11030*/
 --@limitamt bDollar, @limitperiod char(1), @limitcorrect bYN, @autoAP bYN, @vendorgroup bGroup, @vendor bVendor, @apdesc bDesc,
 --@netpayopt char(1), @minnetpay bDollar, @preaaccums bDollar, @prdtcurr bDollar, @prdtold bDollar,
 --@prdtoldbackout bDollar, @calccategory varchar (1), @rndtodollar bYN, @outaccumbasis bDollar
...
-- end 137971
 ...
 next_EmplDL:
	...
	exec @rcode = bspPRProcessEmplDednLiabCalc @prco, @dlcode, @prgroup, @prenddate, 
		...
		@accumbeginmth, @accumendmth, @calcamt output, @errmsg output
