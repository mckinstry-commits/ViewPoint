...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNYY06    Script Date: 8/28/99 9:33:31 AM ******/
   CREATE  proc [dbo].[bspPRNYY06]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @allowance = 1000, @procname = 'bspPRNYY06'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNYY06] TO [public]
GO
