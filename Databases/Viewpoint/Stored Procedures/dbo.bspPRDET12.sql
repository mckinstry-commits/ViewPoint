...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRDET12    Script Date: 8/28/99 9:33:23 AM ******/
CREATE proc [dbo].[bspPRDET12]
/********************************************************
...
*				CHS	01/02/2012 B-08271 update effective 1/1/2012
*
* USAGE:
...
(@subjamt bDollar = 0, @ppds tinyint = 0, @status char(1) = 'S', @exempts tinyint = 0,
   ...
   select @rcode = 0, @persexempt = 110, @procname = 'bspPRDET12'
   ...
   if @taxincome >= 60000                        select @basetax = 2943.5, @limit = 60000, @rate = .0675
   ...
   bspexit:
   	return @rcode
GO
GRANT EXECUTE ON  [dbo].[bspPRDET12] TO [public]
GO
