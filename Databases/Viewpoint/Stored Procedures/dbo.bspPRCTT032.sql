...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRCTT032    Script Date: 8/28/99 9:33:14 AM ******/
    CREATE    proc [dbo].[bspPRCTT032]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @procname = 'bspPRCTT032'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRCTT032] TO [public]
GO
