...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRGAT042    Script Date: 8/28/99 9:33:20 AM ******/
   CREATE proc [dbo].[bspPRGAT042]
   /********************************************************
   ...
   **********************************************************/
   ...
   IF OBJECT_ID('dbo.bspPRGAT042') IS NOT NULL
       PRINT '<<< CREATED PROCEDURE dbo.bspPRGAT042 >>>'
   ELSE
       PRINT '<<< FAILED CREATING PROCEDURE dbo.bspPRGAT042 >>>'

GO
GRANT EXECUTE ON  [dbo].[bspPRGAT042] TO [public]
GO
