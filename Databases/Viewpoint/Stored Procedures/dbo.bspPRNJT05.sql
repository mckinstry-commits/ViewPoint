...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNJT05    Script Date: 8/28/99 9:33:29 AM ******/
    CREATE proc [dbo].[bspPRNJT05]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @allowance = 1000, @procname = 'bspPRNJT05'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNJT05] TO [public]
GO
