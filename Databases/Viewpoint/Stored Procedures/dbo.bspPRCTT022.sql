...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRCTT022    Script Date: 8/28/99 9:33:14 AM ******/
    CREATE  proc [dbo].[bspPRCTT022]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @procname = 'bspPRCTT022'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRCTT022] TO [public]
GO
