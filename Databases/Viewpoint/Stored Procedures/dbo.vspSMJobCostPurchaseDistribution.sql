...
AS
	...
	BEGIN
		...
		INSERT dbo.vSMDetailTransaction (IsReversing, Posted, SMWorkCompletedID, SMWorkOrderScopeID, SMWorkOrderID, LineType, TransactionType, SourceCo, Mth, BatchId, GLCo, GLAccount, Amount)
		SELECT 1 IsReversing, 1 Posted, SMWorkCompleted.SMWorkCompletedID, vSMWorkOrderScope.SMWorkOrderScopeID, vSMWorkOrder.SMWorkOrderID, 5 LineType, 'R' TransactionType, @BatchCo, @BatchMth, @BatchId, vGLEntryTransaction.GLCo, vGLEntryTransaction.GLAccount, -vGLEntryTransaction.Amount
	...
	INSERT dbo.vSMDetailTransaction (IsReversing, Posted, SMWorkCompletedID, SMWorkOrderScopeID, SMWorkOrderID, LineType, TransactionType, SourceCo, Mth, BatchId, GLCo, GLAccount, Amount)
	SELECT 0 IsReversing, 1 Posted, SMWorkCompleted.SMWorkCompletedID, vSMWorkOrderScope.SMWorkOrderScopeID, vSMWorkOrder.SMWorkOrderID, 5 LineType, 'R' TransactionType, @BatchCo, @BatchMth, @BatchId, @SMGLCo, @SMGLAcct, -@JCActualCost
	FROM dbo.SMWorkCompleted
		INNER JOIN dbo.vSMWorkOrderScope ON SMWorkCompleted.SMCo = vSMWorkOrderScope.SMCo AND SMWorkCompleted.WorkOrder = vSMWorkOrderScope.WorkOrder AND SMWorkCompleted.Scope = vSMWorkOrderScope.Scope
		INNER JOIN dbo.vSMWorkOrder ON SMWorkCompleted.SMCo = vSMWorkOrder.SMCo AND SMWorkCompleted.WorkOrder = vSMWorkOrder.WorkOrder
	WHERE SMWorkCompletedID = @SMWorkCompletedID
