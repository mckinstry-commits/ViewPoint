...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRORM042    Script Date: 8/28/99 9:33:32 AM ******/
   CREATE proc [dbo].[bspPRORM042]
   /********************************************************
   * CREATED BY: 	EN 2/6/04 - as per issue 23613
   * MODIFIED BY:	EN 1/11/05 - issue 26244  default status
   *
   * USAGE:
   ...
   **********************************************************/
   ...
   select @rcode = 0, @dedn = 0, @exmptn = 0, @rate = 0, @procname = 'bspPRORM042'
   
   -- #26244 set default status if passed in values are invalid
...
GO
GRANT EXECUTE ON  [dbo].[bspPRORM042] TO [public]
GO
