...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMNT05    Script Date: 8/28/99 9:33:28 AM ******/
     CREATE proc [dbo].[bspPRMNT05]
     /********************************************************
     ...
     **********************************************************/
     ...
     select @rcode = 0, @dedn = 3200, @procname = 'bspPRMNT05'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMNT05] TO [public]
GO
