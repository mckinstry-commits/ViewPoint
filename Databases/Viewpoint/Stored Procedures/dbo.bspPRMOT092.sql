...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRMOT092]    Script Date: 01/03/2008 10:56:16 ******/
 CREATE proc [dbo].[bspPRMOT092]
 /********************************************************
 ...
 **********************************************************/
 ...
 select @rcode = 0, @rate = 0, @counter = 1, @procname = 'bspPRMOT092', @allowances = 0
 ...
 if @status = 'H'
 begin
 	select @dedn = 8350, @fedlimit = 5000
 	while @counter <= @exempts
 	begin
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMOT092] TO [public]
GO
