...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRCOT01    Script Date: 8/28/99 9:33:14 AM ******/
   CREATE  proc [dbo].[bspPRCOT01]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @amt = 0, @a = 0, @limit = 0, @procname = 'bspPRCOT01'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRCOT01] TO [public]
GO
