...
ALTER TABLE [dbo].[bPMIL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMIL_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
ALTER TABLE [dbo].[bPMIL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMIL_bPMDT] FOREIGN KEY ([InspectionType]) REFERENCES [dbo].[bPMDT] ([DocType])
ALTER TABLE [dbo].[bPMIL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMIL_bPMFM] FOREIGN KEY ([VendorGroup], [InspectionFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
ALTER TABLE [dbo].[bPMIL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMIL_bPMPL] FOREIGN KEY ([PMCo], [Project], [Location]) REFERENCES [dbo].[bPMPL] ([PMCo], [Project], [Location])
ALTER TABLE [dbo].[bPMIL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMIL_bPMPM] FOREIGN KEY ([VendorGroup], [InspectionFirm], [InspectionContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
ALTER TABLE [dbo].[bPMIL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMIL_bPMSC] FOREIGN KEY ([Status]) REFERENCES [dbo].[bPMSC] ([Status])
GO
