...
CREATE UNIQUE CLUSTERED INDEX [biPRRQ] ON [dbo].[bPRRQ] ([PRCo], [Crew], [PostDate], [SheetNum], [EMCo], [EMGroup], [Equipment], [LineSeq]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRRQ] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
