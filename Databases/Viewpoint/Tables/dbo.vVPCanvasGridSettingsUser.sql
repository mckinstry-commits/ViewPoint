...
CREATE UNIQUE CLUSTERED INDEX [IX_vVPCanvasGridSettingsUser_VPUserName_QueryName_CustomName] ON [dbo].[vVPCanvasGridSettingsUser] ([VPUserName], [QueryName], [CustomName]) WITH (FILLFACTOR=90) ON [PRIMARY]
