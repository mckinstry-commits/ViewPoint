...
ALTER TABLE [dbo].[vDMAttachmentTypes] ADD 
CONSTRAINT [PK_vDMAttachmentTypes] PRIMARY KEY CLUSTERED  ([AttachmentTypeID]) WITH (FILLFACTOR=90) ON [PRIMARY]
ALTER TABLE [dbo].[vDMAttachmentTypes] WITH NOCHECK ADD
CONSTRAINT [FK_vDMAttachmentTypes_TextID] FOREIGN KEY ([TextID]) REFERENCES [dbo].[vDDTM] ([TextID])
GO
