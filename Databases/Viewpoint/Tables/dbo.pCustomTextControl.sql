...
ALTER TABLE [dbo].[pCustomTextControl] WITH NOCHECK ADD
CONSTRAINT [FK_pCustomTextControl_pPageSiteControl] FOREIGN KEY ([PageSiteControlID]) REFERENCES [dbo].[pPageSiteControls] ([PageSiteControlID]) ON DELETE CASCADE
ALTER TABLE [dbo].[pCustomTextControl] WITH NOCHECK ADD
CONSTRAINT [FK_pCustomTextControl_pSites] FOREIGN KEY ([SiteID]) REFERENCES [dbo].[pSites] ([SiteID])
GO
