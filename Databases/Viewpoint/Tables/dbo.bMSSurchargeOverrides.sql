...
ALTER TABLE [dbo].[bMSSurchargeOverrides] WITH NOCHECK ADD
CONSTRAINT [FK_bMSSurchargeOverrides_bMSQH] FOREIGN KEY ([MSCo], [Quote]) REFERENCES [dbo].[bMSQH] ([MSCo], [Quote])
GO
