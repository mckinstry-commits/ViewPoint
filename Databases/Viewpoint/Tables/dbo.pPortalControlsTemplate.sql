...
ALTER TABLE [dbo].[pPortalControlsTemplate] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalControlsTemplate_pPortalControls] FOREIGN KEY ([PortalControlID]) REFERENCES [dbo].[pPortalControls] ([PortalControlID])
GO
