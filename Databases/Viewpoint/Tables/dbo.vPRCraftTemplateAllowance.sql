...
CONSTRAINT [PK_vPRCraftTemplateAllowance] PRIMARY KEY CLUSTERED  ([PRCo], [Craft], [Template], [AllowanceTypeName]) WITH (FILLFACTOR=80) ON [PRIMARY]
...
ALTER TABLE [dbo].[vPRCraftTemplateAllowance] WITH NOCHECK ADD
CONSTRAINT [FK_vPRCraftTemplateAllowance_bPRCT] FOREIGN KEY ([PRCo], [Craft], [Template]) REFERENCES [dbo].[bPRCT] ([PRCo], [Craft], [Template])
ALTER TABLE [dbo].[vPRCraftTemplateAllowance] WITH NOCHECK ADD
CONSTRAINT [FK_vPRCraftTemplateAllowance_vPRAllowanceRuleSet] FOREIGN KEY ([PRCo], [AllowanceRulesetName]) REFERENCES [dbo].[vPRAllowanceRuleSet] ([PRCo], [AllowanceRulesetName])
ALTER TABLE [dbo].[vPRCraftTemplateAllowance] WITH NOCHECK ADD
CONSTRAINT [FK_vPRCraftTemplateAllowance_vPRAllowanceTypes] FOREIGN KEY ([AllowanceTypeName]) REFERENCES [dbo].[vPRAllowanceType] ([AllowanceTypeName])
GO
