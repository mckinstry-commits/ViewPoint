...
ALTER TABLE [dbo].[bPMNR] WITH NOCHECK ADD
CONSTRAINT [FK_bPMNR_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
ALTER TABLE [dbo].[bPMNR] WITH NOCHECK ADD
CONSTRAINT [FK_bPMNR_bPMPN] FOREIGN KEY ([PMCo], [Project], [NoteSeq]) REFERENCES [dbo].[bPMPN] ([PMCo], [Project], [NoteSeq]) ON DELETE CASCADE
GO
