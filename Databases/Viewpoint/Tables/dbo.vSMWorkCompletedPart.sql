...
[PriceTotal] [dbo].[bDollar] NOT NULL,
...
ALTER TABLE [dbo].[vSMWorkCompletedPart] WITH NOCHECK ADD
CONSTRAINT [FK_vSMWorkCompletedPart_bINLM] FOREIGN KEY ([INCo], [INLocation]) REFERENCES [dbo].[bINLM] ([INCo], [Loc])
ALTER TABLE [dbo].[vSMWorkCompletedPart] WITH NOCHECK ADD
CONSTRAINT [FK_vSMWorkCompletedPart_bJCCT] FOREIGN KEY ([PhaseGroup], [JCCostType]) REFERENCES [dbo].[bJCCT] ([PhaseGroup], [CostType])
ALTER TABLE [dbo].[vSMWorkCompletedPart] WITH NOCHECK ADD
CONSTRAINT [FK_vSMWorkCompletedPart_bHQUM_PriceUM] FOREIGN KEY ([PriceUM]) REFERENCES [dbo].[bHQUM] ([UM])
ALTER TABLE [dbo].[vSMWorkCompletedPart] WITH NOCHECK ADD
CONSTRAINT [FK_vSMWorkCompletedPart_bHQUM_UM] FOREIGN KEY ([UM]) REFERENCES [dbo].[bHQUM] ([UM])
GO
