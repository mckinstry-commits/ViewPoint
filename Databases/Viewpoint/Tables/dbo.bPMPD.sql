...
ALTER TABLE [dbo].[bPMPD] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPD_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
ALTER TABLE [dbo].[bPMPD] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPD_bPMPL] FOREIGN KEY ([PMCo], [Project], [Location]) REFERENCES [dbo].[bPMPL] ([PMCo], [Project], [Location])
ALTER TABLE [dbo].[bPMPD] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPD_bPMPU] FOREIGN KEY ([PMCo], [Project], [PunchList]) REFERENCES [dbo].[bPMPU] ([PMCo], [Project], [PunchList])
ALTER TABLE [dbo].[bPMPD] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPD_bPMPI] FOREIGN KEY ([PMCo], [Project], [PunchList], [Item]) REFERENCES [dbo].[bPMPI] ([PMCo], [Project], [PunchList], [Item])
ALTER TABLE [dbo].[bPMPD] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPD_bPMFM] FOREIGN KEY ([VendorGroup], [ResponsibleFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
GO
