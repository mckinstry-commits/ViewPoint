...
ALTER TABLE [dbo].[pSites] ADD 
CONSTRAINT [PK_pSites] PRIMARY KEY CLUSTERED  ([SiteID]) WITH (FILLFACTOR=90) ON [PRIMARY]
ALTER TABLE [dbo].[pSites] WITH NOCHECK ADD
CONSTRAINT [FK_pSites_pSiteAttachments] FOREIGN KEY ([SiteAttachmentID]) REFERENCES [dbo].[pSiteAttachments] ([SiteAttachmentID])
ALTER TABLE [dbo].[pSites] WITH NOCHECK ADD
CONSTRAINT [FK_pSites_pUsers] FOREIGN KEY ([UserID]) REFERENCES [dbo].[pUsers] ([UserID])
ALTER TABLE [dbo].[pSites] WITH NOCHECK ADD
CONSTRAINT [FK_pSites_pPageSiteTemplates] FOREIGN KEY ([PageSiteTemplateID]) REFERENCES [dbo].[pPageSiteTemplates] ([PageSiteTemplateID])
GO
