...
CREATE UNIQUE CLUSTERED INDEX [biPMPN] ON [dbo].[bPMPN] ([PMCo], [Project], [NoteSeq]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMPN] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
