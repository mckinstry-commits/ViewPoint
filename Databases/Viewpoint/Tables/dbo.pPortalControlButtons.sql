...
ALTER TABLE [dbo].[pPortalControlButtons] ADD 
CONSTRAINT [PK_pPortalControlButtons] PRIMARY KEY CLUSTERED  ([PortalControlID], [ButtonID]) WITH (FILLFACTOR=90) ON [PRIMARY]
ALTER TABLE [dbo].[pPortalControlButtons] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalControlButtons_pPortalMessages3] FOREIGN KEY ([ConfirmMessageID]) REFERENCES [dbo].[pPortalMessages] ([MessageID])
ALTER TABLE [dbo].[pPortalControlButtons] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalControlButtons_pPortalMessages2] FOREIGN KEY ([FailureMessageID]) REFERENCES [dbo].[pPortalMessages] ([MessageID])
ALTER TABLE [dbo].[pPortalControlButtons] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalControlButtons_pPortalMessages1] FOREIGN KEY ([InformationMessageID]) REFERENCES [dbo].[pPortalMessages] ([MessageID])
ALTER TABLE [dbo].[pPortalControlButtons] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalControlButtons_pPortalMessages] FOREIGN KEY ([SuccessMessageID]) REFERENCES [dbo].[pPortalMessages] ([MessageID])
ALTER TABLE [dbo].[pPortalControlButtons] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalControlButtons_pRoles] FOREIGN KEY ([RoleID]) REFERENCES [dbo].[pRoles] ([RoleID])
ALTER TABLE [dbo].[pPortalControlButtons] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalControlButtons_pPageTemplates] FOREIGN KEY ([NavigationPageID]) REFERENCES [dbo].[pPageTemplates] ([PageTemplateID])
ALTER TABLE [dbo].[pPortalControlButtons] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalControlButtons_pPortalButtons] FOREIGN KEY ([ButtonID]) REFERENCES [dbo].[pPortalButtons] ([ButtonID])
ALTER TABLE [dbo].[pPortalControlButtons] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalControlButtons_pPortalControls] FOREIGN KEY ([PortalControlID]) REFERENCES [dbo].[pPortalControls] ([PortalControlID])
GO
