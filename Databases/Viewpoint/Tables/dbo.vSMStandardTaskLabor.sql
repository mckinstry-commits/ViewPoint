...
ALTER TABLE [dbo].[vSMStandardTaskLabor] WITH NOCHECK ADD
CONSTRAINT [FK_vSMStandardTaskLabor_bPRCO] FOREIGN KEY ([PRCo]) REFERENCES [dbo].[bPRCO] ([PRCo])
ALTER TABLE [dbo].[vSMStandardTaskLabor] WITH NOCHECK ADD
CONSTRAINT [FK_vSMStandardTaskLabor_bPRCC] FOREIGN KEY ([PRCo], [Craft], [Class]) REFERENCES [dbo].[bPRCC] ([PRCo], [Craft], [Class])
GO
