...
CREATE UNIQUE CLUSTERED INDEX [biPOSL] ON [dbo].[bPOSL] ([POCo], [ShipLoc]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPOSL] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
