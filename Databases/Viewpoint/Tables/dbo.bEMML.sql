...
CREATE UNIQUE CLUSTERED INDEX [biEMML] ON [dbo].[bEMML] ([Co], [Mth], [BatchId], [BatchSeq], [Line]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMML] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
