...
ALTER TABLE [dbo].[bPMRI] ADD 
CONSTRAINT [PK_bPMRI] PRIMARY KEY CLUSTERED  ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
ALTER TABLE [dbo].[bPMRI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMRI_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
ALTER TABLE [dbo].[bPMRI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMRI_bPMDT] FOREIGN KEY ([RFIType]) REFERENCES [dbo].[bPMDT] ([DocType])
ALTER TABLE [dbo].[bPMRI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMRI_bPMFM_ReqFirm] FOREIGN KEY ([VendorGroup], [ReqFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
ALTER TABLE [dbo].[bPMRI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMRI_bPMFM_RespondFirm] FOREIGN KEY ([VendorGroup], [RespondFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
ALTER TABLE [dbo].[bPMRI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMRI_bPMPM_ReqContact] FOREIGN KEY ([VendorGroup], [ReqFirm], [ReqContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
ALTER TABLE [dbo].[bPMRI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMRI_bPMPM_RespondContact] FOREIGN KEY ([VendorGroup], [RespondFirm], [RespondContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
ALTER TABLE [dbo].[bPMRI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMRI_bPMPM_ResponsiblePerson] FOREIGN KEY ([VendorGroup], [ResponsibleFirm], [ResponsiblePerson]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
ALTER TABLE [dbo].[bPMRI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMRI_bPMSC] FOREIGN KEY ([Status]) REFERENCES [dbo].[bPMSC] ([Status])
GO
