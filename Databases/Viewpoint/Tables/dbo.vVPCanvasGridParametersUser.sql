...
CREATE UNIQUE CLUSTERED INDEX [IX_vVPCanvasGridParametersUser_VPUserName_QueryName_CustomName_Name] ON [dbo].[vVPCanvasGridParametersUser] ([VPUserName], [QueryName], [CustomName], [Name]) WITH (FILLFACTOR=90) ON [PRIMARY]
