...
ALTER TABLE [dbo].[vSMWorkCompletedEquipment] WITH NOCHECK ADD
CONSTRAINT [FK_vSMWorkCompletedEquipment_bEMEM] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
ALTER TABLE [dbo].[vSMWorkCompletedEquipment] WITH NOCHECK ADD
CONSTRAINT [FK_vSMWorkCompletedEquipment_bEMRC] FOREIGN KEY ([EMGroup], [RevCode]) REFERENCES [dbo].[bEMRC] ([EMGroup], [RevCode])
ALTER TABLE [dbo].[vSMWorkCompletedEquipment] WITH NOCHECK ADD
CONSTRAINT [FK_vSMWorkCompletedEquipment_bJCCT] FOREIGN KEY ([PhaseGroup], [JCCostType]) REFERENCES [dbo].[bJCCT] ([PhaseGroup], [CostType])
GO
