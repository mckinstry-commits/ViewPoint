...
ALTER TABLE [dbo].[bPMSL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMSL_bAPVM] FOREIGN KEY ([VendorGroup], [Vendor]) REFERENCES [dbo].[bAPVM] ([VendorGroup], [Vendor])
ALTER TABLE [dbo].[bPMSL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMSL_bHQTX] FOREIGN KEY ([TaxGroup], [TaxCode]) REFERENCES [dbo].[bHQTX] ([TaxGroup], [TaxCode])
ALTER TABLE [dbo].[bPMSL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMSL_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
ALTER TABLE [dbo].[bPMSL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMSL_bSLAD] FOREIGN KEY ([SLCo], [SLAddon]) REFERENCES [dbo].[bSLAD] ([SLCo], [Addon])
GO
