...
CREATE UNIQUE CLUSTERED INDEX [biHQIC] ON [dbo].[bHQIC] ([InsCode]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHQIC] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
