...
CREATE UNIQUE CLUSTERED INDEX [biPMTL] ON [dbo].[bPMTL] ([PMCo], [Project], [TestType], [TestCode]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMTL] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bPMTL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMTL_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
ALTER TABLE [dbo].[bPMTL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMTL_bPMPL] FOREIGN KEY ([PMCo], [Project], [Location]) REFERENCES [dbo].[bPMPL] ([PMCo], [Project], [Location])
ALTER TABLE [dbo].[bPMTL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMTL_bPMDT] FOREIGN KEY ([TestType]) REFERENCES [dbo].[bPMDT] ([DocType])
ALTER TABLE [dbo].[bPMTL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMTL_bPMFM] FOREIGN KEY ([VendorGroup], [TestFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
ALTER TABLE [dbo].[bPMTL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMTL_bPMPM] FOREIGN KEY ([VendorGroup], [TestFirm], [TestContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
ALTER TABLE [dbo].[bPMTL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMTL_bPMSC] FOREIGN KEY ([Status]) REFERENCES [dbo].[bPMSC] ([Status])
GO
