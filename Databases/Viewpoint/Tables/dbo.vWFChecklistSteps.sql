...
ALTER TABLE [dbo].[vWFChecklistSteps] WITH NOCHECK ADD
CONSTRAINT [FK_vWFChecklistSteps_vWFStatusCodes] FOREIGN KEY ([Status]) REFERENCES [dbo].[vWFStatusCodes] ([StatusID])
GO
