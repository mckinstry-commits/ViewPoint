...
CREATE UNIQUE CLUSTERED INDEX [biGLPD] ON [dbo].[bGLPD] ([GLCo], [PartNo]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bGLPD] ADD CONSTRAINT [PK_bGLPD] PRIMARY KEY NONCLUSTERED  ([KeyID]) WITH (FILLFACTOR=100) ON [PRIMARY]

ALTER TABLE [dbo].[bGLPD] WITH NOCHECK ADD
CONSTRAINT [FK_bGLPD_bGLCO_GLCo] FOREIGN KEY ([GLCo]) REFERENCES [dbo].[bGLCO] ([GLCo])
GO
