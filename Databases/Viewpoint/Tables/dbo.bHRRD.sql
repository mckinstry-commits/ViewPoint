...
CREATE UNIQUE CLUSTERED INDEX [biHRRD] ON [dbo].[bHRRD] ([HRCo], [HRRef], [Seq]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRRD] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
