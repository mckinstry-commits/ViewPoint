...
ALTER TABLE [dbo].[bPMEC] ADD 
CONSTRAINT [PK_bPMEC] PRIMARY KEY CLUSTERED  ([PMCo], [BudgetCode]) WITH (FILLFACTOR=90) ON [PRIMARY]
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMEC] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bPMEC] WITH NOCHECK ADD
CONSTRAINT [FK_bPMEC_bPMCO] FOREIGN KEY ([PMCo]) REFERENCES [dbo].[bPMCO] ([PMCo])
GO
