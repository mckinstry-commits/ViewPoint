...
CREATE UNIQUE CLUSTERED INDEX [biHRCL] ON [dbo].[bHRCL] ([HRCo], [Accident], [Seq], [ContactSeq]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRCL] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
