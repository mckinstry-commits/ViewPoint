...
ALTER TABLE [dbo].[vPMIssueHistory] WITH NOCHECK ADD
CONSTRAINT [FK_vPMIssueHistory_bPMIM_IssueKeyID] FOREIGN KEY ([IssueKeyID]) REFERENCES [dbo].[bPMIM] ([KeyID]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[vPMIssueHistory] ADD CONSTRAINT [CK_vPMIssueHistory_ActionType] CHECK (([ActionType]='D' OR [ActionType]='C' OR [ActionType]='A'))
GO
