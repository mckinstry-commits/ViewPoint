...
ALTER TABLE [dbo].[vEMDepartmentRole] WITH NOCHECK ADD
CONSTRAINT [FK_vEMDepartmentRole_bEMDM] FOREIGN KEY ([EMCo], [Department]) REFERENCES [dbo].[bEMDM] ([EMCo], [Department])
GO
