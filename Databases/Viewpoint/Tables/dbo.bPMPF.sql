...
CONSTRAINT [CK_bPMPF_EmailOption] CHECK (([EmailOption]='C' OR [EmailOption]='B' OR [EmailOption]='N'))
ALTER TABLE [dbo].[bPMPF] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPF_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job]) ON DELETE CASCADE ON UPDATE CASCADE
ALTER TABLE [dbo].[bPMPF] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPF_bPMFM] FOREIGN KEY ([VendorGroup], [FirmNumber]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
ALTER TABLE [dbo].[bPMPF] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPF_bPMPM] FOREIGN KEY ([VendorGroup], [FirmNumber], [ContactCode]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
GO
