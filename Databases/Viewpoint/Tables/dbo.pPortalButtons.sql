...
ALTER TABLE [dbo].[pPortalButtons] ADD 
CONSTRAINT [PK_pButtons] PRIMARY KEY CLUSTERED  ([ButtonName]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
ALTER TABLE [dbo].[pPortalButtons] ADD CONSTRAINT [IX_pPortalButtons] UNIQUE NONCLUSTERED  ([ButtonID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[pPortalButtons] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalButtons_pPortalMessages] FOREIGN KEY ([ConfirmMessageID]) REFERENCES [dbo].[pPortalMessages] ([MessageID])
GO
