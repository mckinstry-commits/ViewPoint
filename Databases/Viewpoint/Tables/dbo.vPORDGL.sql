...
ALTER TABLE [dbo].[vPORDGL] WITH NOCHECK ADD
CONSTRAINT [FK_vPORDGL_bPORD] FOREIGN KEY ([POCo], [Mth], [POTrans]) REFERENCES [dbo].[bPORD] ([POCo], [Mth], [POTrans]) ON DELETE CASCADE
GO
