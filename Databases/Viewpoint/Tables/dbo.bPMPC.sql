...
ALTER TABLE [dbo].[bPMPC] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPC_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job]) ON DELETE CASCADE ON UPDATE CASCADE
ALTER TABLE [dbo].[bPMPC] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPC_bJCCT] FOREIGN KEY ([PhaseGroup], [CostType]) REFERENCES [dbo].[bJCCT] ([PhaseGroup], [CostType])
GO
