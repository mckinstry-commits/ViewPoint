...
[SpecSection] [varchar] (10) COLLATE Latin1_General_BIN NULL,
[Copies] [tinyint] NULL,
...
ALTER TABLE [dbo].[vPMSubmittal] WITH NOCHECK ADD
CONSTRAINT [CK_vPMSubmittal_APCo] CHECK ((NOT ([APCo] IS NULL AND ([PurchaseOrder] IS NOT NULL OR [Subcontract] IS NOT NULL))))
ALTER TABLE [dbo].[vPMSubmittal] WITH NOCHECK ADD
CONSTRAINT [CK_vPMSubmittal_ApprovingFirmContact] CHECK ((NOT ([ApprovingFirm] IS NULL AND [ApprovingFirmContact] IS NOT NULL)))
ALTER TABLE [dbo].[vPMSubmittal] WITH NOCHECK ADD
CONSTRAINT [CK_vPMSubmittal_OurFirmContact] CHECK ((NOT ([OurFirm] IS NULL AND [OurFirmContact] IS NOT NULL)))
ALTER TABLE [dbo].[vPMSubmittal] WITH NOCHECK ADD
CONSTRAINT [CK_vPMSubmittal_ResponsibleFirmContact] CHECK ((NOT ([ResponsibleFirm] IS NULL AND [ResponsibleFirmContact] IS NOT NULL)))
ALTER TABLE [dbo].[vPMSubmittal] WITH NOCHECK ADD
CONSTRAINT [FK_vPMSubmittal_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
ALTER TABLE [dbo].[vPMSubmittal] WITH NOCHECK ADD
CONSTRAINT [FK_vPMSubmittal_bPMFM_ApprovingFirm] FOREIGN KEY ([VendorGroup], [ApprovingFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
ALTER TABLE [dbo].[vPMSubmittal] WITH NOCHECK ADD
CONSTRAINT [FK_vPMSubmittal_bPMFM_OurFirm] FOREIGN KEY ([VendorGroup], [OurFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
ALTER TABLE [dbo].[vPMSubmittal] WITH NOCHECK ADD
CONSTRAINT [FK_vPMSubmittal_bPMFM_ResponsibleFirm] FOREIGN KEY ([VendorGroup], [ResponsibleFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
ALTER TABLE [dbo].[vPMSubmittal] WITH NOCHECK ADD
CONSTRAINT [FK_vPMSubmittal_bPMPM_ApprovingFirm] FOREIGN KEY ([VendorGroup], [ApprovingFirm], [ApprovingFirmContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
ALTER TABLE [dbo].[vPMSubmittal] WITH NOCHECK ADD
CONSTRAINT [FK_vPMSubmittal_bPMPM_OurFirm] FOREIGN KEY ([VendorGroup], [OurFirm], [OurFirmContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
ALTER TABLE [dbo].[vPMSubmittal] WITH NOCHECK ADD
CONSTRAINT [FK_vPMSubmittal_bPMPM_ResponsibleFirm] FOREIGN KEY ([VendorGroup], [ResponsibleFirm], [ResponsibleFirmContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
ALTER TABLE [dbo].[vPMSubmittal] WITH NOCHECK ADD
CONSTRAINT [FK_vPMSubmittal_bPOHD_PurchaseOrder] FOREIGN KEY ([APCo], [PurchaseOrder]) REFERENCES [dbo].[bPOHD] ([POCo], [PO])
ALTER TABLE [dbo].[vPMSubmittal] WITH NOCHECK ADD
CONSTRAINT [FK_vPMSubmittal_bSLHD_Subcontract] FOREIGN KEY ([APCo], [Subcontract]) REFERENCES [dbo].[bSLHD] ([SLCo], [SL])
GO
