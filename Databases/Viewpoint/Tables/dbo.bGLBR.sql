...
CREATE UNIQUE CLUSTERED INDEX [biGLBR] ON [dbo].[bGLBR] ([GLCo], [FYEMO], [BudgetCode], [GLAcct]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]

ALTER TABLE [dbo].[bGLBR] ADD CONSTRAINT [PK_bGLBR] PRIMARY KEY NONCLUSTERED  ([KeyID]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]

ALTER TABLE [dbo].[bGLBR] WITH NOCHECK ADD
CONSTRAINT [FK_bGLBR_bGLBC_GLCoBudgetCode] FOREIGN KEY ([GLCo], [BudgetCode]) REFERENCES [dbo].[bGLBC] ([GLCo], [BudgetCode])
ALTER TABLE [dbo].[bGLBR] WITH NOCHECK ADD
CONSTRAINT [FK_bGLBR_bGLFY_GLCoFYEMO] FOREIGN KEY ([GLCo], [FYEMO]) REFERENCES [dbo].[bGLFY] ([GLCo], [FYEMO])
GO
