...
ALTER TABLE [dbo].[pSiteAttachments] ADD 
CONSTRAINT [PK_pSiteAttachments] PRIMARY KEY CLUSTERED  ([SiteAttachmentID]) WITH (FILLFACTOR=90) ON [PRIMARY]
ALTER TABLE [dbo].[pSiteAttachments] WITH NOCHECK ADD
CONSTRAINT [FK_pSiteAttachments_pAttachmentTypes] FOREIGN KEY ([AttachmentTypeID]) REFERENCES [dbo].[pAttachmentTypes] ([AttachmentTypeID])
ALTER TABLE [dbo].[pSiteAttachments] WITH NOCHECK ADD
CONSTRAINT [FK_pSiteAttachments_pSites] FOREIGN KEY ([SiteID]) REFERENCES [dbo].[pSites] ([SiteID])
GO
