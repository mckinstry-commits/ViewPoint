...
ALTER TABLE [dbo].[bPMOI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOI_bJCCI] FOREIGN KEY ([PMCo], [Contract], [ContractItem]) REFERENCES [dbo].[bJCCI] ([JCCo], [Contract], [Item])
ALTER TABLE [dbo].[bPMOI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOI_bPMOH] FOREIGN KEY ([PMCo], [Project], [ACO]) REFERENCES [dbo].[bPMOH] ([PMCo], [Project], [ACO])
ALTER TABLE [dbo].[bPMOI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOI_bPMOP] FOREIGN KEY ([PMCo], [Project], [PCOType], [PCO]) REFERENCES [dbo].[bPMOP] ([PMCo], [Project], [PCOType], [PCO])
ALTER TABLE [dbo].[bPMOI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOI_bPMDT] FOREIGN KEY ([PCOType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
