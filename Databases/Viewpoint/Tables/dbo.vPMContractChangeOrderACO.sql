...
ALTER TABLE [dbo].[vPMContractChangeOrderACO] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOH_vPMContractChangeOrderACO_ACOID] FOREIGN KEY ([ACOID]) REFERENCES [dbo].[bPMOH] ([KeyID]) ON DELETE CASCADE
ALTER TABLE [dbo].[vPMContractChangeOrderACO] WITH NOCHECK ADD
CONSTRAINT [FK_vPMContractChangeOrderACO_bJCCM] FOREIGN KEY ([PMCo], [Contract]) REFERENCES [dbo].[bJCCM] ([JCCo], [Contract])
GO
