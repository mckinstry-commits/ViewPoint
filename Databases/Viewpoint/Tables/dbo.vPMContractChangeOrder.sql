...
ALTER TABLE [dbo].[vPMContractChangeOrder] WITH NOCHECK ADD
CONSTRAINT [FK_vPMContractChangeOrder_bPMCO] FOREIGN KEY ([PMCo]) REFERENCES [dbo].[bPMCO] ([PMCo])
ALTER TABLE [dbo].[vPMContractChangeOrder] WITH NOCHECK ADD
CONSTRAINT [FK_vPMContractChangeOrder_bJCCM] FOREIGN KEY ([PMCo], [Contract]) REFERENCES [dbo].[bJCCM] ([JCCo], [Contract])
ALTER TABLE [dbo].[vPMContractChangeOrder] WITH NOCHECK ADD
CONSTRAINT [FK_vPMContractChangeOrder_bPMFM_FromFirm] FOREIGN KEY ([VendorGroup], [FromFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
ALTER TABLE [dbo].[vPMContractChangeOrder] WITH NOCHECK ADD
CONSTRAINT [FK_vPMContractChangeOrder_bPMPM_FromContact] FOREIGN KEY ([VendorGroup], [FromFirm], [FromContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
ALTER TABLE [dbo].[vPMContractChangeOrder] WITH NOCHECK ADD
CONSTRAINT [FK_vPMContractChangeOrder_bPMPM_ToContact] FOREIGN KEY ([VendorGroup], [FromFirm], [ToContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
ALTER TABLE [dbo].[vPMContractChangeOrder] WITH NOCHECK ADD
CONSTRAINT [FK_vPMContractChangeOrder_bPMFM_ToFirm] FOREIGN KEY ([VendorGroup], [ToFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
GO
