...
CREATE UNIQUE CLUSTERED INDEX [biJCDL] ON [dbo].[bJCDL] ([JCCo], [Department], [LiabType]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCDL] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
