...
ALTER TABLE [dbo].[pContacts] ADD 
CONSTRAINT [PK_pSiteContacts] PRIMARY KEY CLUSTERED  ([ContactID]) WITH (FILLFACTOR=90) ON [PRIMARY]
ALTER TABLE [dbo].[pContacts] WITH NOCHECK ADD
CONSTRAINT [FK_pContacts_pSites] FOREIGN KEY ([SiteID]) REFERENCES [dbo].[pSites] ([SiteID])
ALTER TABLE [dbo].[pContacts] WITH NOCHECK ADD
CONSTRAINT [FK_pContacts_pPageSiteControls] FOREIGN KEY ([PageSiteControlID]) REFERENCES [dbo].[pPageSiteControls] ([PageSiteControlID]) ON DELETE CASCADE
GO
