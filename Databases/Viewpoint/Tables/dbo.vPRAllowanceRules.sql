...
ALTER TABLE [dbo].[vPRAllowanceRules] ADD 
CONSTRAINT [PK_vPRAllowanceRules] PRIMARY KEY CLUSTERED  ([PRCo], [AllowanceRuleName], [AllowanceRulesetName]) WITH (FILLFACTOR=80) ON [PRIMARY]
