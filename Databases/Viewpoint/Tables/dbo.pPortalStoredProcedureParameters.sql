...
ALTER TABLE [dbo].[pPortalStoredProcedureParameters] ADD 
CONSTRAINT [PK_pStoredProcedureParameters] PRIMARY KEY CLUSTERED  ([ParameterID]) WITH (FILLFACTOR=90) ON [PRIMARY]
ALTER TABLE [dbo].[pPortalStoredProcedureParameters] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalStoredProcedureParameters_pPortalStoredProcedures] FOREIGN KEY ([StoredProcedureID]) REFERENCES [dbo].[pPortalStoredProcedures] ([StoredProcedureID])
GO
