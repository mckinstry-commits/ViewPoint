...
ALTER TABLE [dbo].[vPCBidPackageScopes] WITH NOCHECK ADD
CONSTRAINT [FK_vPCBidPackageScopes_bJCPM] FOREIGN KEY ([PhaseGroup], [Phase]) REFERENCES [dbo].[bJCPM] ([PhaseGroup], [Phase])
GO
