...
ALTER TABLE [dbo].[vSMWorkCompletedLabor] WITH NOCHECK ADD
CONSTRAINT [FK_vSMWorkCompletedLabor_bJCCT] FOREIGN KEY ([PhaseGroup], [JCCostType]) REFERENCES [dbo].[bJCCT] ([PhaseGroup], [CostType])
GO
