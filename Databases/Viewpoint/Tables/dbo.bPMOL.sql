...
CONSTRAINT [FK_bPMOL_bAPVM] FOREIGN KEY ([VendorGroup], [Vendor]) REFERENCES [dbo].[bAPVM] ([VendorGroup], [Vendor])
ALTER TABLE [dbo].[bPMOL] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOL_bPMDT] FOREIGN KEY ([PCOType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
