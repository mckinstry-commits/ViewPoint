...
ALTER TABLE [dbo].[pMenuTemplateLinkRoles] ADD 
CONSTRAINT [PK_pMenuTemplateLinkRoles] PRIMARY KEY CLUSTERED  ([MenuTemplateLinkID], [MenuTemplateID], [RoleID]) WITH (FILLFACTOR=90) ON [PRIMARY]
ALTER TABLE [dbo].[pMenuTemplateLinkRoles] WITH NOCHECK ADD
CONSTRAINT [FK_pMenuTemplateLinkRoles_pRoles] FOREIGN KEY ([RoleID]) REFERENCES [dbo].[pRoles] ([RoleID])
ALTER TABLE [dbo].[pMenuTemplateLinkRoles] WITH NOCHECK ADD
CONSTRAINT [FK_pMenuTemplateLinkRoles_pMenuTemplateLinks] FOREIGN KEY ([MenuTemplateLinkID], [MenuTemplateID]) REFERENCES [dbo].[pMenuTemplateLinks] ([MenuTemplateLinkID], [MenuTemplateID])
GO
