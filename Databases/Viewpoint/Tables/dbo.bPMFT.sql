...
CREATE UNIQUE CLUSTERED INDEX [biPMFT] ON [dbo].[bPMFT] ([FirmType]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMFT] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
