...
CREATE UNIQUE CLUSTERED INDEX [biPRSD] ON [dbo].[bPRSD] ([PRCo], [State], [DLCode]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRSD] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
