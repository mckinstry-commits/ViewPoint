...
ALTER TABLE [dbo].[vPOPendingPurchaseOrderItem] WITH NOCHECK ADD
CONSTRAINT [FK_vPOPendingPurchaseOrderItem_vPOPendingPurchaseOrderItem_Equip] FOREIGN KEY ([EMCo], [Equip]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment])
ALTER TABLE [dbo].[vPOPendingPurchaseOrderItem] WITH NOCHECK ADD
CONSTRAINT [FK_vPOPendingPurchaseOrderItem_bEMWH_WorkOrder] FOREIGN KEY ([EMCo], [WO]) REFERENCES [dbo].[bEMWH] ([EMCo], [WorkOrder])
ALTER TABLE [dbo].[vPOPendingPurchaseOrderItem] WITH NOCHECK ADD
CONSTRAINT [FK_vPOPendingPurchaseOrderItem_bINLM_Loc] FOREIGN KEY ([INCo], [Loc]) REFERENCES [dbo].[bINLM] ([INCo], [Loc])
GO
