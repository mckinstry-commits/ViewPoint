...
CONSTRAINT [PK_vPRCraftClassAllowance] PRIMARY KEY CLUSTERED  ([PRCo], [Craft], [Class], [AllowanceTypeName]) WITH (FILLFACTOR=80) ON [PRIMARY]
CREATE NONCLUSTERED INDEX [IX_vPRCraftClassAllowance_AllowanceRulesetName] ON [dbo].[vPRCraftClassAllowance] ([AllowanceRulesetName]) WITH (FILLFACTOR=80) ON [PRIMARY]

ALTER TABLE [dbo].[vPRCraftClassAllowance] WITH NOCHECK ADD
CONSTRAINT [FK_vPRCraftClassAllowance_bPRCC] FOREIGN KEY ([PRCo], [Craft], [Class]) REFERENCES [dbo].[bPRCC] ([PRCo], [Craft], [Class])
ALTER TABLE [dbo].[vPRCraftClassAllowance] WITH NOCHECK ADD
CONSTRAINT [FK_vPRCraftClassAllowance_vPRAllowanceRuleSet] FOREIGN KEY ([PRCo], [AllowanceRulesetName]) REFERENCES [dbo].[vPRAllowanceRuleSet] ([PRCo], [AllowanceRulesetName])
ALTER TABLE [dbo].[vPRCraftClassAllowance] WITH NOCHECK ADD
CONSTRAINT [FK_vPRCraftClassAllowance_vPRAllowanceType] FOREIGN KEY ([AllowanceTypeName]) REFERENCES [dbo].[vPRAllowanceType] ([AllowanceTypeName])
GO
