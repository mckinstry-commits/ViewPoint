...
[ClaimUnits] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_vSLClaimItem_UnitsClaimed] DEFAULT ((0)),
...
CONSTRAINT [FK_vSLClaimItem_bSLHD] FOREIGN KEY ([SLCo], [SL]) REFERENCES [dbo].[bSLHD] ([SLCo], [SL])
ALTER TABLE [dbo].[vSLClaimItem] WITH NOCHECK ADD
CONSTRAINT [FK_vSLClaimItem_bSLIT] FOREIGN KEY ([SLCo], [SL], [SLItem]) REFERENCES [dbo].[bSLIT] ([SLCo], [SL], [SLItem])
GO
