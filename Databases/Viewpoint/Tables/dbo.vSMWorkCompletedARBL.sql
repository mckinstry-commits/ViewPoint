...
ALTER TABLE [dbo].[vSMWorkCompletedARBL] WITH NOCHECK ADD
CONSTRAINT [FK_vSMWorkCompletedARBL_bARBL] FOREIGN KEY ([Co], [Mth], [BatchId], [BatchSeq], [ARLine]) REFERENCES [dbo].[bARBL] ([Co], [Mth], [BatchId], [BatchSeq], [ARLine]) ON DELETE CASCADE
GO
