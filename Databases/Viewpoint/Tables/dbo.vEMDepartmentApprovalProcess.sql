...
ALTER TABLE [dbo].[vEMDepartmentApprovalProcess] WITH NOCHECK ADD
CONSTRAINT [FK_vEMDepartmentApprovalProcess_bEMDM_Department] FOREIGN KEY ([EMCo], [Department]) REFERENCES [dbo].[bEMDM] ([EMCo], [Department])
GO
