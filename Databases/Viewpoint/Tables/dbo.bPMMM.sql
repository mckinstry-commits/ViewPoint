...
ALTER TABLE [dbo].[bPMMM] WITH NOCHECK ADD
CONSTRAINT [FK_bPMMM_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
ALTER TABLE [dbo].[bPMMM] WITH NOCHECK ADD
CONSTRAINT [FK_bPMMM_bPMDT] FOREIGN KEY ([MeetingType]) REFERENCES [dbo].[bPMDT] ([DocType])
ALTER TABLE [dbo].[bPMMM] WITH NOCHECK ADD
CONSTRAINT [FK_bPMMM_bPMPM] FOREIGN KEY ([VendorGroup], [FirmNumber], [Preparer]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
GO
