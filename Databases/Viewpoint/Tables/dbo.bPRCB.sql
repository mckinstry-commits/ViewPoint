...
CREATE UNIQUE CLUSTERED INDEX [biPRCB] ON [dbo].[bPRCB] ([PRCo], [Craft], [ELType], [ELCode]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRCB] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
