...
ALTER TABLE [dbo].[bJCID] ADD 
CONSTRAINT [biJCID] PRIMARY KEY CLUSTERED  ([JCCo], [Mth], [ItemTrans]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
...
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCID] ([KeyID]) WITH (FILLFACTOR=85, STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
