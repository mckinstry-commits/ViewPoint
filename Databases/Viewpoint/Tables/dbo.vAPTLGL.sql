...
ALTER TABLE [dbo].[vAPTLGL] WITH NOCHECK ADD
CONSTRAINT [FK_vAPTLGL_bAPTL] FOREIGN KEY ([APCo], [Mth], [APTrans], [APLine]) REFERENCES [dbo].[bAPTL] ([APCo], [Mth], [APTrans], [APLine]) ON DELETE CASCADE
GO
