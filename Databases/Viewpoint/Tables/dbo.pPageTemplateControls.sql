...
ALTER TABLE [dbo].[pPageTemplateControls] ADD 
CONSTRAINT [PK_pPageMaster] PRIMARY KEY CLUSTERED  ([PageTemplateControlID]) WITH (FILLFACTOR=90) ON [PRIMARY]
ALTER TABLE [dbo].[pPageTemplateControls] WITH NOCHECK ADD
CONSTRAINT [FK_pPageTemplateControls_pRoles] FOREIGN KEY ([RoleID]) REFERENCES [dbo].[pRoles] ([RoleID])
ALTER TABLE [dbo].[pPageTemplateControls] WITH NOCHECK ADD
CONSTRAINT [FK_pPageTemplateControls_pPageTemplates] FOREIGN KEY ([PageTemplateID]) REFERENCES [dbo].[pPageTemplates] ([PageTemplateID])
ALTER TABLE [dbo].[pPageTemplateControls] WITH NOCHECK ADD
CONSTRAINT [FK_pPageTemplateControls_pPortalControls] FOREIGN KEY ([PortalControlID]) REFERENCES [dbo].[pPortalControls] ([PortalControlID])
GO
