...
ALTER TABLE [dbo].[bPMFM] WITH NOCHECK ADD
CONSTRAINT [FK_bPMFM_bAPVM] FOREIGN KEY ([VendorGroup], [Vendor]) REFERENCES [dbo].[bAPVM] ([VendorGroup], [Vendor])
ALTER TABLE [dbo].[bPMFM] WITH NOCHECK ADD
CONSTRAINT [FK_bPMFM_bHQCountry_MailCountry] FOREIGN KEY ([MailCountry]) REFERENCES [dbo].[bHQCountry] ([Country])
ALTER TABLE [dbo].[bPMFM] WITH NOCHECK ADD
CONSTRAINT [FK_bPMFM_bHQCountry_ShipCountry] FOREIGN KEY ([ShipCountry]) REFERENCES [dbo].[bHQCountry] ([Country])
ALTER TABLE [dbo].[bPMFM] WITH NOCHECK ADD
CONSTRAINT [FK_bPMFM_bHQGP] FOREIGN KEY ([VendorGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
ALTER TABLE [dbo].[bPMFM] WITH NOCHECK ADD
CONSTRAINT [FK_bPMFM_bHQST_MailState] FOREIGN KEY ([MailCountry], [MailState]) REFERENCES [dbo].[bHQST] ([Country], [State])
ALTER TABLE [dbo].[bPMFM] WITH NOCHECK ADD
CONSTRAINT [FK_bPMFM_bHQST_ShipState] FOREIGN KEY ([ShipCountry], [ShipState]) REFERENCES [dbo].[bHQST] ([Country], [State])
ALTER TABLE [dbo].[bPMFM] WITH NOCHECK ADD
CONSTRAINT [FK_bPMFM_bPMFT] FOREIGN KEY ([FirmType]) REFERENCES [dbo].[bPMFT] ([FirmType])
GO
