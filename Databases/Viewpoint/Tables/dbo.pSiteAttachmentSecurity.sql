...
ALTER TABLE [dbo].[pSiteAttachmentSecurity] WITH NOCHECK ADD
CONSTRAINT [FK_pSiteAttachmentSecurity_pRoles] FOREIGN KEY ([RoleID]) REFERENCES [dbo].[pRoles] ([RoleID]) ON DELETE CASCADE
ALTER TABLE [dbo].[pSiteAttachmentSecurity] WITH NOCHECK ADD
CONSTRAINT [FK_pSiteAttachmentSecurity_pSites] FOREIGN KEY ([SiteID]) REFERENCES [dbo].[pSites] ([SiteID]) ON DELETE CASCADE
GO
