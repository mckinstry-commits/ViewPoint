...
ALTER TABLE [dbo].[vJCForecastMonth] WITH NOCHECK ADD
CONSTRAINT [FK_vJCForecastMonth_bJCCM] FOREIGN KEY ([JCCo], [Contract]) REFERENCES [dbo].[bJCCM] ([JCCo], [Contract]) ON DELETE CASCADE
GO
