...
ALTER TABLE [dbo].[vDDFormRelated] WITH NOCHECK ADD
CONSTRAINT [FK_vDDFormRelated_vDDFH_Form] FOREIGN KEY ([Form]) REFERENCES [dbo].[vDDFH] ([Form]) ON DELETE CASCADE
ALTER TABLE [dbo].[vDDFormRelated] WITH NOCHECK ADD
CONSTRAINT [FK_vDDFormRelated_vDDFH_RelatedForm] FOREIGN KEY ([RelatedForm]) REFERENCES [dbo].[vDDFH] ([Form])
GO
