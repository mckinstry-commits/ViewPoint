...
CREATE TRIGGER [dbo].[vctVU8085_PONumberUpdatebPMMF] ON [dbo].[bPMMF] FOR INSERT
...
CONSTRAINT [FK_bPMMF_bAPVM] FOREIGN KEY ([VendorGroup], [Vendor]) REFERENCES [dbo].[bAPVM] ([VendorGroup], [Vendor])
ALTER TABLE [dbo].[bPMMF] WITH NOCHECK ADD
CONSTRAINT [FK_bPMMF_bHQTX] FOREIGN KEY ([TaxGroup], [TaxCode]) REFERENCES [dbo].[bHQTX] ([TaxGroup], [TaxCode])
ALTER TABLE [dbo].[bPMMF] WITH NOCHECK ADD
