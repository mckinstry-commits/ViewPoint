...
ALTER TABLE [dbo].[vDDCT] ADD 
CONSTRAINT [PK_vDDCT] PRIMARY KEY CLUSTERED  ([CultureID], [TextID]) WITH (FILLFACTOR=90) ON [PRIMARY]
ALTER TABLE [dbo].[vDDCT] WITH NOCHECK ADD
CONSTRAINT [FK_vDDCT_vDDCL] FOREIGN KEY ([CultureID]) REFERENCES [dbo].[vDDCL] ([KeyID])
ALTER TABLE [dbo].[vDDCT] WITH NOCHECK ADD
CONSTRAINT [FK_vDDCT_vDDTT] FOREIGN KEY ([TextID]) REFERENCES [dbo].[vDDTM] ([TextID])
GO
