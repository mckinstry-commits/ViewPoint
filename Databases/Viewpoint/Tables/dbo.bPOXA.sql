...
CREATE UNIQUE CLUSTERED INDEX [biPOXA] ON [dbo].[bPOXA] ([POCo], [Mth], [BatchId], [JCCo], [Job], [PhaseGroup], [Phase], [JCCType], [BatchSeq], [POItem], [POItemLine]) WITH (FILLFACTOR=90) ON [PRIMARY]
