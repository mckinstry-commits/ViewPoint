...
ALTER TABLE [dbo].[vAuditFlagGroup] WITH NOCHECK ADD
CONSTRAINT [FK_vAuditFlagGroup_bHQGP] FOREIGN KEY ([AuditGroup]) REFERENCES [dbo].[bHQGP] ([Grp]) ON DELETE CASCADE
ALTER TABLE [dbo].[vAuditFlagGroup] WITH NOCHECK ADD
CONSTRAINT [FK_vAuditFlagGroup_vAuditFlags] FOREIGN KEY ([AuditFlagID]) REFERENCES [dbo].[vAuditFlags] ([KeyID])
GO
