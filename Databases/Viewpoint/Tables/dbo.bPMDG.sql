...
CREATE UNIQUE CLUSTERED INDEX [biPMDG] ON [dbo].[bPMDG] ([PMCo], [Project], [DrawingType], [Drawing]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMDG] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bPMDG] WITH NOCHECK ADD
CONSTRAINT [FK_bPMDG_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
ALTER TABLE [dbo].[bPMDG] WITH NOCHECK ADD
CONSTRAINT [FK_bPMDG_bPMDT] FOREIGN KEY ([DrawingType]) REFERENCES [dbo].[bPMDT] ([DocType])
ALTER TABLE [dbo].[bPMDG] WITH NOCHECK ADD
CONSTRAINT [FK_bPMDG_bPMSC] FOREIGN KEY ([Status]) REFERENCES [dbo].[bPMSC] ([Status])
GO
