...
ALTER TABLE [dbo].[pPortalDetails] ADD 
CONSTRAINT [PK_pDetails] PRIMARY KEY CLUSTERED  ([DetailsID]) WITH (FILLFACTOR=90) ON [PRIMARY]
ALTER TABLE [dbo].[pPortalDetails] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalDetails_pPortalMessages] FOREIGN KEY ([ParameterMissingMessageID]) REFERENCES [dbo].[pPortalMessages] ([MessageID])
ALTER TABLE [dbo].[pPortalDetails] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalDetails_pPortalStoredProcedures1] FOREIGN KEY ([AddStoredProcedureID]) REFERENCES [dbo].[pPortalStoredProcedures] ([StoredProcedureID])
ALTER TABLE [dbo].[pPortalDetails] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalDetails_pPortalStoredProcedures3] FOREIGN KEY ([DeleteStoredProcedureID]) REFERENCES [dbo].[pPortalStoredProcedures] ([StoredProcedureID])
ALTER TABLE [dbo].[pPortalDetails] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalDetails_pPortalStoredProcedures] FOREIGN KEY ([GetStoredProcedureID]) REFERENCES [dbo].[pPortalStoredProcedures] ([StoredProcedureID])
ALTER TABLE [dbo].[pPortalDetails] WITH NOCHECK ADD
CONSTRAINT [FK_pPortalDetails_pPortalStoredProcedures2] FOREIGN KEY ([UpdateStoredProcedureID]) REFERENCES [dbo].[pPortalStoredProcedures] ([StoredProcedureID])
GO
