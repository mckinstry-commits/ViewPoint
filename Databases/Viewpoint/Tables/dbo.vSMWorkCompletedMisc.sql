...
ALTER TABLE [dbo].[vSMWorkCompletedMisc] WITH NOCHECK ADD
CONSTRAINT [FK_vSMWorkCompletedMisc_bJCCT] FOREIGN KEY ([PhaseGroup], [JCCostType]) REFERENCES [dbo].[bJCCT] ([PhaseGroup], [CostType])
GO
