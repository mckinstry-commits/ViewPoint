...
CREATE CLUSTERED INDEX [IX_vWFChecklistTasks] ON [dbo].[vWFChecklistTasks] ([Task], [Checklist], [Company]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[vWFChecklistTasks] ADD CONSTRAINT [PK_vWFChecklistTasks] PRIMARY KEY NONCLUSTERED  ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[vWFChecklistTasks] WITH NOCHECK ADD
CONSTRAINT [FK_vWFChecklistTasks_vWFStatusCodes] FOREIGN KEY ([Status]) REFERENCES [dbo].[vWFStatusCodes] ([StatusID])
GO
