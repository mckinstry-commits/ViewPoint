...
ALTER TABLE [dbo].[bPMPI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPI_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
ALTER TABLE [dbo].[bPMPI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPI_bPMFM_BillableFirm] FOREIGN KEY ([VendorGroup], [BillableFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
ALTER TABLE [dbo].[bPMPI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPI_bPMFM_ResponsibleFirm] FOREIGN KEY ([VendorGroup], [ResponsibleFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
ALTER TABLE [dbo].[bPMPI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPI_bPMPL] FOREIGN KEY ([PMCo], [Project], [Location]) REFERENCES [dbo].[bPMPL] ([PMCo], [Project], [Location])
ALTER TABLE [dbo].[bPMPI] WITH NOCHECK ADD
CONSTRAINT [FK_bPMPI_bPMPU] FOREIGN KEY ([PMCo], [Project], [PunchList]) REFERENCES [dbo].[bPMPU] ([PMCo], [Project], [PunchList])
GO
