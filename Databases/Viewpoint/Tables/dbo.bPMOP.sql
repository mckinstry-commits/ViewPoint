...
ALTER TABLE [dbo].[bPMOP] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOP_bHQRC] FOREIGN KEY ([ReasonCode]) REFERENCES [dbo].[bHQRC] ([ReasonCode])
ALTER TABLE [dbo].[bPMOP] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOP_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
ALTER TABLE [dbo].[bPMOP] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOP_bJCCM] FOREIGN KEY ([PMCo], [Contract]) REFERENCES [dbo].[bJCCM] ([JCCo], [Contract])
ALTER TABLE [dbo].[bPMOP] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOP_bPMDT] FOREIGN KEY ([PCOType]) REFERENCES [dbo].[bPMDT] ([DocType])
ALTER TABLE [dbo].[bPMOP] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOP_bPMSC] FOREIGN KEY ([Status]) REFERENCES [dbo].[bPMSC] ([Status])
GO
