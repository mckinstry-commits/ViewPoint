...
CREATE UNIQUE CLUSTERED INDEX [biPOJC] ON [dbo].[bPOJC] ([VendorGroup], [Vendor], [MatlGroup], [Category], [JCCo], [Job]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPOJC] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
