...
ALTER TABLE [dbo].[bCMST] WITH NOCHECK ADD
CONSTRAINT [FK_bCMST_bCMAC_CMCoCMAcct] FOREIGN KEY ([CMCo], [CMAcct]) REFERENCES [dbo].[bCMAC] ([CMCo], [CMAcct])
GO
...
EXEC sp_bindrule N'[dbo].[brCMAcct]', N'[dbo].[bCMST].[CMAcct]'
GO
