...
ALTER TABLE [dbo].[bPMML] WITH NOCHECK ADD
CONSTRAINT [FK_bPMML_bPMMI] FOREIGN KEY ([PMCo], [Project], [MeetingType], [Meeting], [MinutesType], [Item]) REFERENCES [dbo].[bPMMI] ([PMCo], [Project], [MeetingType], [Meeting], [MinutesType], [Item])
ALTER TABLE [dbo].[bPMML] WITH NOCHECK ADD
CONSTRAINT [FK_bPMML_bPMDT] FOREIGN KEY ([MeetingType]) REFERENCES [dbo].[bPMDT] ([DocType])
ALTER TABLE [dbo].[bPMML] WITH NOCHECK ADD
CONSTRAINT [FK_bPMML_bPMPM] FOREIGN KEY ([VendorGroup], [ResponsibleFirm], [ResponsiblePerson]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
ALTER TABLE [dbo].[bPMML] WITH NOCHECK ADD
CONSTRAINT [FK_bPMML_bPMSC] FOREIGN KEY ([Status]) REFERENCES [dbo].[bPMSC] ([Status])
GO
