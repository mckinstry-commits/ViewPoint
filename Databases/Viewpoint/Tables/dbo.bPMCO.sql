...
ALTER TABLE [dbo].[bPMCO] ADD 
CONSTRAINT [PK_bPMCO] PRIMARY KEY CLUSTERED  ([PMCo]) WITH (FILLFACTOR=90) ON [PRIMARY]
CREATE UNIQUE NONCLUSTERED INDEX [IX_bPMCO_KeyID] ON [dbo].[bPMCO] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bPMCO] WITH NOCHECK ADD
CONSTRAINT [FK_bPMCO_bHQCO] FOREIGN KEY ([PMCo]) REFERENCES [dbo].[bHQCO] ([HQCo])
ALTER TABLE [dbo].[bPMCO] WITH NOCHECK ADD
CONSTRAINT [FK_bPMCO_bJCCO] FOREIGN KEY ([PMCo]) REFERENCES [dbo].[bJCCO] ([JCCo])
ALTER TABLE [dbo].[bPMCO] WITH NOCHECK ADD
CONSTRAINT [FK_bPMCO_bJCCT_MtlCostType] FOREIGN KEY ([PhaseGroup], [MtlCostType]) REFERENCES [dbo].[bJCCT] ([PhaseGroup], [CostType])
ALTER TABLE [dbo].[bPMCO] WITH NOCHECK ADD
CONSTRAINT [FK_bPMCO_bJCCT_SLCostType] FOREIGN KEY ([PhaseGroup], [SLCostType]) REFERENCES [dbo].[bJCCT] ([PhaseGroup], [CostType])
ALTER TABLE [dbo].[bPMCO] WITH NOCHECK ADD
CONSTRAINT [FK_bPMCO_bJCCT_SLCostType2] FOREIGN KEY ([PhaseGroup], [SLCostType2]) REFERENCES [dbo].[bJCCT] ([PhaseGroup], [CostType])
ALTER TABLE [dbo].[bPMCO] WITH NOCHECK ADD
CONSTRAINT [FK_bPMCO_bPMFM] FOREIGN KEY ([VendorGroup], [OurFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
GO
