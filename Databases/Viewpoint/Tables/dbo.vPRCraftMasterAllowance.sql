...
CONSTRAINT [PK_vPRCraftMasterAllowance] PRIMARY KEY CLUSTERED  ([PRCo], [Craft], [AllowanceTypeName]) WITH (FILLFACTOR=80) ON [PRIMARY]
...
ALTER TABLE [dbo].[vPRCraftMasterAllowance] WITH NOCHECK ADD
CONSTRAINT [FK_vPRCraftMasterAllowance_bPRCM] FOREIGN KEY ([PRCo], [Craft]) REFERENCES [dbo].[bPRCM] ([PRCo], [Craft])
ALTER TABLE [dbo].[vPRCraftMasterAllowance] WITH NOCHECK ADD
CONSTRAINT [FK_vPRCraftMasterAllowance_vPRAllowanceRuleSet] FOREIGN KEY ([PRCo], [AllowanceRulesetName]) REFERENCES [dbo].[vPRAllowanceRuleSet] ([PRCo], [AllowanceRulesetName])
ALTER TABLE [dbo].[vPRCraftMasterAllowance] WITH NOCHECK ADD
CONSTRAINT [FK_vPRCraftMasterAllowance_vPRAllowanceTypes] FOREIGN KEY ([AllowanceTypeName]) REFERENCES [dbo].[vPRAllowanceType] ([AllowanceTypeName])
GO
