...
CONSTRAINT [PK_vPRCraftClassTemplateAllowance] PRIMARY KEY CLUSTERED  ([PRCo], [Craft], [Class], [Template], [AllowanceTypeName]) WITH (FILLFACTOR=80) ON [PRIMARY]
...
ALTER TABLE [dbo].[vPRCraftClassTemplateAllowance] WITH NOCHECK ADD
CONSTRAINT [FK_vPRCraftClassTemplateAllowance_bPRTC] FOREIGN KEY ([PRCo], [Craft], [Class], [Template]) REFERENCES [dbo].[bPRTC] ([PRCo], [Craft], [Class], [Template])
ALTER TABLE [dbo].[vPRCraftClassTemplateAllowance] WITH NOCHECK ADD
CONSTRAINT [FK_vPRCraftClassTemplateAllowance_vPRAllowanceRuleSet] FOREIGN KEY ([PRCo], [AllowanceRulesetName]) REFERENCES [dbo].[vPRAllowanceRuleSet] ([PRCo], [AllowanceRulesetName])
ALTER TABLE [dbo].[vPRCraftClassTemplateAllowance] WITH NOCHECK ADD
CONSTRAINT [FK_vPRCraftClassTemplateAllowance_vPRAllowanceTypes] FOREIGN KEY ([AllowanceTypeName]) REFERENCES [dbo].[vPRAllowanceType] ([AllowanceTypeName])
GO
