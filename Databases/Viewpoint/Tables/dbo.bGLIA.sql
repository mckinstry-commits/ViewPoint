...
ALTER TABLE [dbo].[bGLIA] WITH NOCHECK ADD
CONSTRAINT [FK_bGLIA_bGLAC_ARGLCo] FOREIGN KEY ([ARGLCo], [ARGLAcct]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
ALTER TABLE [dbo].[bGLIA] WITH NOCHECK ADD
CONSTRAINT [FK_bGLIA_bGLAC_APGLCo] FOREIGN KEY ([APGLCo], [APGLAcct]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
GO
