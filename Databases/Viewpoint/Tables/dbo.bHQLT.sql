...
CREATE UNIQUE CLUSTERED INDEX [biHQLT] ON [dbo].[bHQLT] ([LiabType]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHQLT] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
