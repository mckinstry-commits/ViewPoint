...
CREATE UNIQUE CLUSTERED INDEX [biMSJP] ON [dbo].[bMSJP] ([MSCo], [Quote], [LocGroup], [FromLoc], [MatlGroup], [Category], [Material]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSJP] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biMSJPSeq] ON [dbo].[bMSJP] ([MSCo], [Quote], [Seq]) WITH (FILLFACTOR=90) ON [PRIMARY]
