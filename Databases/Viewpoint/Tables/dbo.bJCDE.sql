...
CREATE UNIQUE CLUSTERED INDEX [biJCDE] ON [dbo].[bJCDE] ([JCCo], [Department], [EarnType]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCDE] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
