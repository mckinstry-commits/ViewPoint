...
ALTER TABLE [dbo].[bPMOD] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOD_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
ALTER TABLE [dbo].[bPMOD] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOD_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
ALTER TABLE [dbo].[bPMOD] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOD_bPMFM] FOREIGN KEY ([VendorGroup], [RelatedFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
ALTER TABLE [dbo].[bPMOD] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOD_bPMPM] FOREIGN KEY ([VendorGroup], [ResponsibleFirm], [ResponsiblePerson]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
ALTER TABLE [dbo].[bPMOD] WITH NOCHECK ADD
CONSTRAINT [FK_bPMOD_bPMSC] FOREIGN KEY ([Status]) REFERENCES [dbo].[bPMSC] ([Status])
GO
