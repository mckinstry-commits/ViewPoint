...
CREATE UNIQUE CLUSTERED INDEX [biMSRB] ON [dbo].[bMSRB] ([MSCo], [Mth], [BatchId], [EMCo], [Equipment], [EMGroup], [RevCode], [SaleType], [RevBdownCode], [BatchSeq], [HaulLine], [OldNew]) WITH (FILLFACTOR=90) ON [PRIMARY]
