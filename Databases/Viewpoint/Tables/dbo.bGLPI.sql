...
CREATE UNIQUE CLUSTERED INDEX [biGLPI] ON [dbo].[bGLPI] ([GLCo], [PartNo], [Instance]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bGLPI] ADD CONSTRAINT [PK_bGLPI] PRIMARY KEY NONCLUSTERED  ([KeyID]) WITH (FILLFACTOR=100) ON [PRIMARY]

ALTER TABLE [dbo].[bGLPI] WITH NOCHECK ADD
CONSTRAINT [FK_bGLPI_bGLPD_GLCoPartNo] FOREIGN KEY ([GLCo], [PartNo]) REFERENCES [dbo].[bGLPD] ([GLCo], [PartNo])
GO
