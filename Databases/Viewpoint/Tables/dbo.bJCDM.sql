...
CREATE UNIQUE CLUSTERED INDEX [biJCDM] ON [dbo].[bJCDM] ([JCCo], [Department]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCDM] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
