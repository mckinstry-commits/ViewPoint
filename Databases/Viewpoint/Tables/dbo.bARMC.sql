...
CREATE UNIQUE CLUSTERED INDEX [biARMC] ON [dbo].[bARMC] ([CustGroup], [MiscDistCode]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bARMC] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
