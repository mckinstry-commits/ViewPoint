...
CREATE UNIQUE CLUSTERED INDEX [biJCTH] ON [dbo].[bJCTH] ([JCCo], [LiabTemplate]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCTH] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
