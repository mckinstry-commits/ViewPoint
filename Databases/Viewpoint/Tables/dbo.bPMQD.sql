...
CONSTRAINT [PK_bPMQD] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [PCOType], [PCO], [RFQ], [RFQSeq]) WITH (FILLFACTOR=90) ON [PRIMARY]
...
ALTER TABLE [dbo].[bPMQD] WITH NOCHECK ADD
CONSTRAINT [FK_bPMQD_bPMFM] FOREIGN KEY ([VendorGroup], [SentToFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
ALTER TABLE [dbo].[bPMQD] WITH NOCHECK ADD
CONSTRAINT [FK_bPMQD_bPMPM] FOREIGN KEY ([VendorGroup], [SentToFirm], [SentToContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
ALTER TABLE [dbo].[bPMQD] WITH NOCHECK ADD
