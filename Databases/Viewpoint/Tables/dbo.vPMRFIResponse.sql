...
ALTER TABLE [dbo].[vPMRFIResponse] WITH NOCHECK ADD
CONSTRAINT [FK_vPMRFIResponse_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
ALTER TABLE [dbo].[vPMRFIResponse] WITH NOCHECK ADD
CONSTRAINT [FK_vPMRFIResponse_bPMRI] FOREIGN KEY ([RFIID]) REFERENCES [dbo].[bPMRI] ([KeyID]) ON DELETE CASCADE
ALTER TABLE [dbo].[vPMRFIResponse] WITH NOCHECK ADD
CONSTRAINT [FK_vPMRFIResponse_bPMFM] FOREIGN KEY ([VendorGroup], [RespondFirm]) REFERENCES [dbo].[bPMFM] ([VendorGroup], [FirmNumber])
ALTER TABLE [dbo].[vPMRFIResponse] WITH NOCHECK ADD
CONSTRAINT [FK_vPMRFIResponse_bPMPM] FOREIGN KEY ([VendorGroup], [RespondFirm], [RespondContact]) REFERENCES [dbo].[bPMPM] ([VendorGroup], [FirmNumber], [ContactCode])
GO
