...
ALTER TABLE [dbo].[pForum] ADD 
CONSTRAINT [PK_pForum] PRIMARY KEY CLUSTERED  ([ForumID]) WITH (FILLFACTOR=90) ON [PRIMARY]
ALTER TABLE [dbo].[pForum] WITH NOCHECK ADD
CONSTRAINT [FK_pForum_pForum] FOREIGN KEY ([ParentID]) REFERENCES [dbo].[pForum] ([ForumID])
GO
