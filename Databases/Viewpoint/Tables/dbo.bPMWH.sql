...
CREATE UNIQUE CLUSTERED INDEX [biPMWH] ON [dbo].[bPMWH] ([PMCo], [ImportId]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMWH] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bPMWH] WITH NOCHECK ADD
CONSTRAINT [FK_bPMWH_bPMCO] FOREIGN KEY ([PMCo]) REFERENCES [dbo].[bPMCO] ([PMCo])
ALTER TABLE [dbo].[bPMWH] WITH NOCHECK ADD
CONSTRAINT [FK_bPMWH_bPMUT] FOREIGN KEY ([Template]) REFERENCES [dbo].[bPMUT] ([Template])
GO
