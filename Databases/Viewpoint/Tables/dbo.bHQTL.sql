...
CREATE UNIQUE CLUSTERED INDEX [biHQTL] ON [dbo].[bHQTL] ([TaxGroup], [TaxCode], [TaxLink]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHQTL] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
