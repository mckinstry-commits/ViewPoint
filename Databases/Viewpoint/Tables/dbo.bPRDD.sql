...
CREATE UNIQUE CLUSTERED INDEX [biPRDD] ON [dbo].[bPRDD] ([PRCo], [Employee], [Seq]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRDD] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
