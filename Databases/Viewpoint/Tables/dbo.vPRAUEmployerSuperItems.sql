...
ALTER TABLE [dbo].[vPRAUEmployerSuperItems] WITH NOCHECK ADD
CONSTRAINT [FK_vPRAUEmployerSuperItems_bPRDL_DLCode] FOREIGN KEY ([PRCo], [DLCode]) REFERENCES [dbo].[bPRDL] ([PRCo], [DLCode])
GO
