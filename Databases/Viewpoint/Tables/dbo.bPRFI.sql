...
CREATE UNIQUE CLUSTERED INDEX [IX_bPRFI_PRCo] ON [dbo].[bPRFI] ([PRCo]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [IX_bPRFI_KeyID] ON [dbo].[bPRFI] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
