...
/****** Object:  View [dbo].[vrvPRAUBASGSTRec]    Script Date: 07/21/2011 07:30:44 ******/        
        
CREATE view [dbo].[vrvPRAUBASGSTRec] as            
            
/*******************************************************************            
* Created: DML - 15 June 2011 - Issue # 144033, B-04906            
*             
* Created for the AP section of the PR BAS GST Reconciliation Report             
*              
********************************************************************/            
...
, D.APSeq    --APTD            
, D.Amount            
, Amount1 = case when ((D.Status <> 4) and (D.PayType <> O.RetPayType)) then D.Amount else 0 end            
...
, GSTtaxAmt1 = case when ((D.Status <> 4) and (D.PayType <> O.RetPayType)) then D.GSTtaxAmt else 0 end            
