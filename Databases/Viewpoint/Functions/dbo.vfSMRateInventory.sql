...
(
	@SMCo bCompany, @WorkOrder int, @Scope int, @Date bDate, @Agreement varchar(15), @Revision int, @Coverage varchar(1), @INCo bCompany, @INLocation bLoc, @MaterialGroup bGroup, @Material bMatl, @CostUM bUM, @CostQuantity bUnits, @CostTotal bDollar, @PriceUM bUM, @PriceECM bECM
)
RETURNS TABLE
AS
RETURN
