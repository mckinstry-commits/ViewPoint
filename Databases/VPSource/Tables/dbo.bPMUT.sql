...
CONSTRAINT [CK_bPMUT_Override] CHECK (([Override]='Y' OR [Override]='N'))
ALTER TABLE [dbo].[bPMUT] ADD
CONSTRAINT [CK_bPMUT_AccumCosts] CHECK (([AccumCosts]='Y' OR [AccumCosts]='N'))
ALTER TABLE [dbo].[bPMUT] ADD
CONSTRAINT [CK_bPMUT_ImportSICode] CHECK (([ImportSICode]='Y' OR [ImportSICode]='N'))
ALTER TABLE [dbo].[bPMUT] ADD
CONSTRAINT [CK_bPMUT_DefaultContract] CHECK (([DefaultContract]='Y' OR [DefaultContract]='N'))
ALTER TABLE [dbo].[bPMUT] ADD
CONSTRAINT [CK_bPMUT_DefaultFirm] CHECK (([DefaultFirm]='Y' OR [DefaultFirm]='N'))
ALTER TABLE [dbo].[bPMUT] ADD
CONSTRAINT [CK_bPMUT_COItem] CHECK (([COItem]='Y' OR [COItem]='N'))
ALTER TABLE [dbo].[bPMUT] ADD
CONSTRAINT [CK_bPMUT_CreateSubRecsYN] CHECK (([CreateSubRecsYN]='Y' OR [CreateSubRecsYN]='N' OR [CreateSubRecsYN] IS NULL))
ALTER TABLE [dbo].[bPMUT] ADD
CONSTRAINT [CK_bPMUT_DropMatlCode] CHECK (([DropMatlCode]='Y' OR [DropMatlCode]='N'))
ALTER TABLE [dbo].[bPMUT] ADD
CONSTRAINT [CK_bPMUT_FixedAmt] CHECK (([FixedAmt]='Y' OR [FixedAmt]='N'))
ALTER TABLE [dbo].[bPMUT] ADD
CONSTRAINT [CK_bPMUT_RollupMatlCode] CHECK (([RollupMatlCode]='Y' OR [RollupMatlCode]='N'))
ALTER TABLE [dbo].[bPMUT] ADD
CONSTRAINT [CK_bPMUT_UseItemQtyUM] CHECK (([UseItemQtyUM]='Y' OR [UseItemQtyUM]='N'))
ALTER TABLE [dbo].[bPMUT] ADD
CONSTRAINT [CK_bPMUT_UseSICodeDesc] CHECK (([UseSICodeDesc]='Y' OR [UseSICodeDesc]='N'))
GO
