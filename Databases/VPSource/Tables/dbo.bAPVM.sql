...
ALTER TABLE [dbo].[bAPVM] ADD
CONSTRAINT [CK_bAPVM_ActiveYN] CHECK (([ActiveYN]='Y' OR [ActiveYN]='N'))
ALTER TABLE [dbo].[bAPVM] ADD
CONSTRAINT [CK_bAPVM_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
ALTER TABLE [dbo].[bAPVM] ADD
CONSTRAINT [CK_bAPVM_OverrideMinAmtYN] CHECK (([OverrideMinAmtYN]='Y' OR [OverrideMinAmtYN]='N'))
ALTER TABLE [dbo].[bAPVM] ADD
CONSTRAINT [CK_bAPVM_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
ALTER TABLE [dbo].[bAPVM] ADD
CONSTRAINT [CK_bAPVM_SeparatePayInvYN] CHECK (([SeparatePayInvYN]='Y' OR [SeparatePayInvYN]='N'))
ALTER TABLE [dbo].[bAPVM] ADD
CONSTRAINT [CK_bAPVM_TempYN] CHECK (([TempYN]='Y' OR [TempYN]='N'))
ALTER TABLE [dbo].[bAPVM] ADD
CONSTRAINT [CK_bAPVM_UpdatePMYN] CHECK (([UpdatePMYN]='Y' OR [UpdatePMYN]='N'))
ALTER TABLE [dbo].[bAPVM] ADD
CONSTRAINT [CK_bAPVM_V1099YN] CHECK (([V1099YN]='Y' OR [V1099YN]='N'))
GO
