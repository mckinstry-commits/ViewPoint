...
ALTER TABLE [dbo].[bHRPC] ADD
CONSTRAINT [CK_bHRPC_AdYN] CHECK (([AdYN]='Y' OR [AdYN]='N'))
ALTER TABLE [dbo].[bHRPC] ADD
CONSTRAINT [CK_bHRPC_BonusYN] CHECK (([BonusYN]='Y' OR [BonusYN]='N'))
ALTER TABLE [dbo].[bHRPC] ADD
CONSTRAINT [CK_bHRPC_PartTimeYN] CHECK (([PartTimeYN]='Y' OR [PartTimeYN]='N'))
GO
