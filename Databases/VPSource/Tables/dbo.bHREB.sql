...
ALTER TABLE [dbo].[bHREB] ADD
CONSTRAINT [CK_bHREB_ActiveYN] CHECK (([ActiveYN]='Y' OR [ActiveYN]='N' OR [ActiveYN] IS NULL))
ALTER TABLE [dbo].[bHREB] ADD
CONSTRAINT [CK_bHREB_CafePlanYN] CHECK (([CafePlanYN]='Y' OR [CafePlanYN]='N' OR [CafePlanYN] IS NULL))
ALTER TABLE [dbo].[bHREB] ADD
CONSTRAINT [CK_bHREB_ReinstateYN] CHECK (([ReinstateYN]='Y' OR [ReinstateYN]='N' OR [ReinstateYN] IS NULL))
ALTER TABLE [dbo].[bHREB] ADD
CONSTRAINT [CK_bHREB_SmokerYN] CHECK (([SmokerYN]='Y' OR [SmokerYN]='N' OR [SmokerYN] IS NULL))
ALTER TABLE [dbo].[bHREB] ADD
CONSTRAINT [CK_bHREB_UpdatedYN] CHECK (([UpdatedYN]='Y' OR [UpdatedYN]='N' OR [UpdatedYN] IS NULL))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHREB].[ActiveYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHREB].[ReinstateYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHREB].[SmokerYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHREB].[UpdatedYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHREB].[CafePlanYN]'
GO
