...
ALTER TABLE [dbo].[bJBLR] ADD
CONSTRAINT [CK_bJBLR_RestrictByEarn] CHECK (([RestrictByEarn]='Y' OR [RestrictByEarn]='N'))
ALTER TABLE [dbo].[bJBLR] ADD
CONSTRAINT [CK_bJBLR_RestrictByFactor] CHECK (([RestrictByFactor]='Y' OR [RestrictByFactor]='N'))
ALTER TABLE [dbo].[bJBLR] ADD
CONSTRAINT [CK_bJBLR_RestrictByShift] CHECK (([RestrictByShift]='Y' OR [RestrictByShift]='N'))
GO
