...
ALTER TABLE [dbo].[bPRED] ADD
CONSTRAINT [CK_bPRED_CSAllocYN] CHECK (([CSAllocYN]='Y' OR [CSAllocYN]='N'))
ALTER TABLE [dbo].[bPRED] ADD
CONSTRAINT [CK_bPRED_CSMedCov] CHECK (([CSMedCov]='Y' OR [CSMedCov]='N' OR [CSMedCov] IS NULL))
ALTER TABLE [dbo].[bPRED] ADD
CONSTRAINT [CK_bPRED_EmplBased] CHECK (([EmplBased]='Y' OR [EmplBased]='N'))
ALTER TABLE [dbo].[bPRED] ADD
CONSTRAINT [CK_bPRED_OverLimit] CHECK (([OverLimit]='Y' OR [OverLimit]='N'))
ALTER TABLE [dbo].[bPRED] ADD
CONSTRAINT [CK_bPRED_OverMiscAmt] CHECK (([OverMiscAmt]='Y' OR [OverMiscAmt]='N'))
