...
ALTER TABLE [dbo].[bWDJB] ADD
CONSTRAINT [CK_bWDJB_Enable] CHECK (([Enable]='Y' OR [Enable]='N'))
ALTER TABLE [dbo].[bWDJB] ADD
CONSTRAINT [CK_bWDJB_Friday] CHECK (([Friday]='Y' OR [Friday]='N'))
ALTER TABLE [dbo].[bWDJB] ADD
CONSTRAINT [CK_bWDJB_Monday] CHECK (([Monday]='Y' OR [Monday]='N'))
ALTER TABLE [dbo].[bWDJB] ADD
CONSTRAINT [CK_bWDJB_Saturday] CHECK (([Saturday]='Y' OR [Saturday]='N'))
ALTER TABLE [dbo].[bWDJB] ADD
CONSTRAINT [CK_bWDJB_Sunday] CHECK (([Sunday]='Y' OR [Sunday]='N'))
ALTER TABLE [dbo].[bWDJB] ADD
CONSTRAINT [CK_bWDJB_Thursday] CHECK (([Thursday]='Y' OR [Thursday]='N'))
ALTER TABLE [dbo].[bWDJB] ADD
CONSTRAINT [CK_bWDJB_Tuesday] CHECK (([Tuesday]='Y' OR [Tuesday]='N'))
ALTER TABLE [dbo].[bWDJB] ADD
CONSTRAINT [CK_bWDJB_Wednesday] CHECK (([Wednesday]='Y' OR [Wednesday]='N'))
GO
