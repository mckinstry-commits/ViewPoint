...
ALTER TABLE [dbo].[bEMTE] ADD
CONSTRAINT [FK_bEMTE_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
ALTER TABLE [dbo].[bEMTE] ADD
CONSTRAINT [FK_bEMTE_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
ALTER TABLE [dbo].[bEMTE] ADD
CONSTRAINT [FK_bEMTE_bEMTH_RevTemplate] FOREIGN KEY ([EMCo], [RevTemplate]) REFERENCES [dbo].[bEMTH] ([EMCo], [RevTemplate]) ON DELETE CASCADE
ALTER TABLE [dbo].[bEMTE] ADD
CONSTRAINT [FK_bEMTE_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
ALTER TABLE [dbo].[bEMTE] ADD
CONSTRAINT [FK_bEMTE_bEMRC_RevCode] FOREIGN KEY ([EMGroup], [RevCode]) REFERENCES [dbo].[bEMRC] ([EMGroup], [RevCode])
GO
