...
ALTER TABLE [dbo].[bAPVC] ADD
CONSTRAINT [CK_bAPVC_Complied] CHECK (([Complied]='Y' OR [Complied]='N' OR [Complied] IS NULL))
ALTER TABLE [dbo].[bAPVC] ADD
CONSTRAINT [CK_bAPVC_Verify] CHECK (([Verify]='Y' OR [Verify]='N'))
GO
