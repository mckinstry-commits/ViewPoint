...
GO
ALTER TABLE [dbo].[vSMInvoiceDetail] ADD CONSTRAINT [CK_vSMInvoiceDetail_Agreement] CHECK (([dbo].[vfEqualsNull]([Agreement])=[dbo].[vfEqualsNull]([Revision]) AND ([Service] IS NULL OR [Agreement] IS NOT NULL) AND [dbo].[vfEqualsNull]([AgreementBilling])=[dbo].[vfEqualsNull]([Agreement])))
GO
ALTER TABLE [dbo].[vSMInvoiceDetail] ADD CONSTRAINT [CK_vSMInvoiceDetail_DetailSource] CHECK (([dbo].[vfEqualsNull]([WorkOrder])<>[dbo].[vfEqualsNull]([Agreement]) AND ([Scope] IS NULL OR [WorkCompleted] IS NULL)))
GO
ALTER TABLE [dbo].[vSMInvoiceDetail] ADD CONSTRAINT [CK_vSMInvoiceDetail_WorkCompleted] CHECK (([WorkCompleted] IS NULL OR [WorkOrder] IS NOT NULL))
GO
ALTER TABLE [dbo].[vSMInvoiceDetail] ADD CONSTRAINT [CK_vSMInvoiceDetail_WorkOrderScope] CHECK (([Scope] IS NULL OR [WorkOrder] IS NOT NULL))
GO
...
GO
ALTER TABLE [dbo].[vSMInvoiceDetail] ADD CONSTRAINT [FK_vSMInvoiceDetail_vSMAgreementBillingSchedule] FOREIGN KEY ([SMCo], [Agreement], [Revision], [Service], [AgreementBilling]) REFERENCES [dbo].[vSMAgreementBillingSchedule] ([SMCo], [Agreement], [Revision], [Service], [Billing])
GO
ALTER TABLE [dbo].[vSMInvoiceDetail] ADD CONSTRAINT [FK_vSMInvoiceDetail_vSMInvoice] FOREIGN KEY ([SMCo], [Invoice]) REFERENCES [dbo].[vSMInvoice] ([SMCo], [Invoice])
GO
ALTER TABLE [dbo].[vSMInvoiceDetail] ADD CONSTRAINT [FK_vSMInvoiceDetail_vSMWorkOrderScope] FOREIGN KEY ([SMCo], [WorkOrder], [Scope]) REFERENCES [dbo].[vSMWorkOrderScope] ([SMCo], [WorkOrder], [Scope])
GO
ALTER TABLE [dbo].[vSMInvoiceDetail] ADD CONSTRAINT [FK_vSMInvoiceDetail_vSMWorkCompleted] FOREIGN KEY ([SMCo], [WorkOrder], [WorkCompleted]) REFERENCES [dbo].[vSMWorkCompleted] ([SMCo], [WorkOrder], [WorkCompleted])
GO
