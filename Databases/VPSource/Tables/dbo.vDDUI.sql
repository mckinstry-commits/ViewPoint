...
ALTER TABLE [dbo].[vDDUI] ADD
CONSTRAINT [CK_vDDUI_InputReq] CHECK (([InputReq]='Y' OR [InputReq]='N' OR [InputReq] IS NULL))
ALTER TABLE [dbo].[vDDUI] ADD
CONSTRAINT [CK_vDDUI_InputSkip] CHECK (([InputSkip]='Y' OR [InputSkip]='N' OR [InputSkip] IS NULL))
ALTER TABLE [dbo].[vDDUI] ADD
CONSTRAINT [CK_vDDUI_ShowForm] CHECK (([ShowForm]='Y' OR [ShowForm]='N' OR [ShowForm] IS NULL))
ALTER TABLE [dbo].[vDDUI] ADD
CONSTRAINT [CK_vDDUI_ShowGrid] CHECK (([ShowGrid]='Y' OR [ShowGrid]='N' OR [ShowGrid] IS NULL))
GO
