...
[BeginBal] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bGLYB_BeginBal] DEFAULT ((0)),
[NetAdj] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bGLYB_NetAdj] DEFAULT ((0)),
...
CREATE UNIQUE CLUSTERED INDEX [biGLYB] ON [dbo].[bGLYB] ([GLCo], [FYEMO], [GLAcct]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bGLYB] ADD CONSTRAINT [PK_bGLYB] PRIMARY KEY NONCLUSTERED  ([KeyID]) WITH (FILLFACTOR=100) ON [PRIMARY]
