...
ALTER TABLE [dbo].[bINMT] ADD
CONSTRAINT [CK_bINMT_Active] CHECK (([Active]='Y' OR [Active]='N'))
ALTER TABLE [dbo].[bINMT] ADD
CONSTRAINT [CK_bINMT_AllowNegWarnMSTickets] CHECK (([AllowNegWarnMSTickets]='N' OR [AllowNegWarnMSTickets]='N'))
ALTER TABLE [dbo].[bINMT] ADD
CONSTRAINT [CK_bINMT_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
ALTER TABLE [dbo].[bINMT] ADD
CONSTRAINT [CK_bINMT_AutoProd] CHECK (([AutoProd]='Y' OR [AutoProd]='N'))
ALTER TABLE [dbo].[bINMT] ADD
CONSTRAINT [CK_bINMT_AvgECM] CHECK (([AvgECM]='M' OR [AvgECM]='C' OR [AvgECM]='E'))
ALTER TABLE [dbo].[bINMT] ADD
CONSTRAINT [CK_bINMT_GLProdUnits] CHECK (([GLProdUnits]='Y' OR [GLProdUnits]='N'))
ALTER TABLE [dbo].[bINMT] ADD
CONSTRAINT [CK_bINMT_GLSaleUnits] CHECK (([GLSaleUnits]='Y' OR [GLSaleUnits]='N'))
ALTER TABLE [dbo].[bINMT] ADD
CONSTRAINT [CK_bINMT_LastECM] CHECK (([LastECM]='M' OR [LastECM]='C' OR [LastECM]='E'))
ALTER TABLE [dbo].[bINMT] ADD
CONSTRAINT [CK_bINMT_PriceECM] CHECK (([PriceECM]='M' OR [PriceECM]='C' OR [PriceECM]='E'))
ALTER TABLE [dbo].[bINMT] ADD
CONSTRAINT [CK_bINMT_StdECM] CHECK (([StdECM]='M' OR [StdECM]='C' OR [StdECM]='E'))
GO
