...
ALTER TABLE [dbo].[bEMLM] ADD
CONSTRAINT [CK_bEMLM_Active] CHECK (([Active]='N' OR [Active]='Y'))
ALTER TABLE [dbo].[bEMLM] ADD
CONSTRAINT [FK_bEMLM_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
