...
CREATE UNIQUE CLUSTERED INDEX [biGLBR] ON [dbo].[bGLBR] ([GLCo], [FYEMO], [BudgetCode], [GLAcct]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bGLBR] ADD CONSTRAINT [PK_bGLBR] PRIMARY KEY NONCLUSTERED  ([KeyID]) WITH (FILLFACTOR=100) ON [PRIMARY]
