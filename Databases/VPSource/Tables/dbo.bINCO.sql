...
ALTER TABLE [dbo].[bINCO] ADD
CONSTRAINT [CK_bINCO_AttachBatchReportsYN] CHECK (([AttachBatchReportsYN]='Y' OR [AttachBatchReportsYN]='N'))
ALTER TABLE [dbo].[bINCO] ADD
CONSTRAINT [CK_bINCO_AuditBoM] CHECK (([AuditBoM]='Y' OR [AuditBoM]='N'))
ALTER TABLE [dbo].[bINCO] ADD
CONSTRAINT [CK_bINCO_AuditCoParams] CHECK (([AuditCoParams]='Y' OR [AuditCoParams]='N'))
ALTER TABLE [dbo].[bINCO] ADD
CONSTRAINT [CK_bINCO_AuditLoc] CHECK (([AuditLoc]='Y' OR [AuditLoc]='N'))
ALTER TABLE [dbo].[bINCO] ADD
CONSTRAINT [CK_bINCO_AuditMOs] CHECK (([AuditMOs]='Y' OR [AuditMOs]='N'))
ALTER TABLE [dbo].[bINCO] ADD
CONSTRAINT [CK_bINCO_AuditMatl] CHECK (([AuditMatl]='Y' OR [AuditMatl]='N'))
ALTER TABLE [dbo].[bINCO] ADD
CONSTRAINT [CK_bINCO_AutoMO] CHECK (([AutoMO]='Y' OR [AutoMO]='N'))
ALTER TABLE [dbo].[bINCO] ADD
CONSTRAINT [CK_bINCO_BurdenCost] CHECK (([BurdenCost]='Y' OR [BurdenCost]='N'))
ALTER TABLE [dbo].[bINCO] ADD
CONSTRAINT [CK_bINCO_CmtdDetailToJC] CHECK (([CmtdDetailToJC]='Y' OR [CmtdDetailToJC]='N'))
ALTER TABLE [dbo].[bINCO] ADD
CONSTRAINT [CK_bINCO_CostOver] CHECK (([CostOver]='Y' OR [CostOver]='N'))
ALTER TABLE [dbo].[bINCO] ADD
CONSTRAINT [CK_bINCO_NegWarn] CHECK (([NegWarn]='Y' OR [NegWarn]='N'))
ALTER TABLE [dbo].[bINCO] ADD
CONSTRAINT [CK_bINCO_OverrideGL] CHECK (([OverrideGL]='Y' OR [OverrideGL]='N'))
GO
