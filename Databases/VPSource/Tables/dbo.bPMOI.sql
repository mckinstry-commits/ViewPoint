...
ALTER TABLE [dbo].[bPMOI] ADD
CONSTRAINT [CK_bPMOI_Approved] CHECK (([Approved]='Y' OR [Approved]='N'))
ALTER TABLE [dbo].[bPMOI] ADD
CONSTRAINT [CK_bPMOI_ForcePhaseYN] CHECK (([ForcePhaseYN]='Y' OR [ForcePhaseYN]='N'))
ALTER TABLE [dbo].[bPMOI] ADD
CONSTRAINT [CK_bPMOI_FixedAmountYN] CHECK (([FixedAmountYN]='Y' OR [FixedAmountYN]='N'))
ALTER TABLE [dbo].[bPMOI] ADD
CONSTRAINT [FK_bPMOI_bJCCI] FOREIGN KEY ([PMCo], [Contract], [ContractItem]) REFERENCES [dbo].[bJCCI] ([JCCo], [Contract], [Item])
GO
