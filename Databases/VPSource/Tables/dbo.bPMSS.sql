...
ALTER TABLE [dbo].[bPMSS] ADD 
CONSTRAINT [PK_bPMSS] PRIMARY KEY CLUSTERED  ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
...
ALTER TABLE [dbo].[bPMSS] ADD
CONSTRAINT [CK_bPMSS_Send] CHECK (([Send]='Y' OR [Send]='N'))
ALTER TABLE [dbo].[bPMSS] ADD
CONSTRAINT [CK_bPMSS_PrefMethod] CHECK (([PrefMethod]='M' OR [PrefMethod]='E' OR [PrefMethod]='F'))
ALTER TABLE [dbo].[bPMSS] ADD
CONSTRAINT [CK_bPMSS_CC] CHECK (([CC]='N' OR [CC]='C' OR [CC]='B'))
GO
