...
ALTER TABLE [dbo].[vDDFH] ADD
CONSTRAINT [CK_vDDFH_AllowAttachments] CHECK (([AllowAttachments]='Y' OR [AllowAttachments]='N'))
ALTER TABLE [dbo].[vDDFH] ADD
CONSTRAINT [CK_vDDFH_HasProgressIndicator] CHECK (([HasProgressIndicator]='Y' OR [HasProgressIndicator]='N'))
ALTER TABLE [dbo].[vDDFH] ADD
CONSTRAINT [CK_vDDFH_ShowOnMenu] CHECK (([ShowOnMenu]='Y' OR [ShowOnMenu]='N'))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDFH].[ShowOnMenu]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDFH].[AllowAttachments]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDFH].[HasProgressIndicator]'
GO
