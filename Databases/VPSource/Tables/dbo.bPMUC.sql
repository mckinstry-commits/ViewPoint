...
ALTER TABLE [dbo].[bPMUC] ADD
CONSTRAINT [CK_bPMUC_UseUM] CHECK (([UseUM]='Y' OR [UseUM]='N'))
ALTER TABLE [dbo].[bPMUC] ADD
CONSTRAINT [CK_bPMUC_UseUnits] CHECK (([UseUnits]='Y' OR [UseUnits]='N'))
ALTER TABLE [dbo].[bPMUC] ADD
CONSTRAINT [CK_bPMUC_UseHours] CHECK (([UseHours]='Y' OR [UseHours]='N'))
GO
