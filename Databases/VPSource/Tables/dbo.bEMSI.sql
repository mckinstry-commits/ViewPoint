...
ALTER TABLE [dbo].[bEMSI] WITH NOCHECK ADD
CONSTRAINT [FK_bEMSI_bEMCC_CostCode] FOREIGN KEY ([EMGroup], [CostCode]) REFERENCES [dbo].[bEMCC] ([EMGroup], [CostCode])
ALTER TABLE [dbo].[bEMSI] WITH NOCHECK ADD
CONSTRAINT [FK_bEMSI_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
ALTER TABLE [dbo].[bEMSI] ADD
CONSTRAINT [CK_bEMSI_InOutFlag] CHECK (([InOutFlag]='O' OR [InOutFlag]='I'))
ALTER TABLE [dbo].[bEMSI] ADD
CONSTRAINT [FK_bEMSI_bEMSH_EquipStdMaintGroup] FOREIGN KEY ([EMCo], [Equipment], [StdMaintGroup]) REFERENCES [dbo].[bEMSH] ([EMCo], [Equipment], [StdMaintGroup]) ON DELETE CASCADE
ALTER TABLE [dbo].[bEMSI] ADD
CONSTRAINT [FK_bEMSI_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
ALTER TABLE [dbo].[bEMSI] ADD
CONSTRAINT [FK_bEMSI_bEMRX_RepairType] FOREIGN KEY ([EMGroup], [RepairType]) REFERENCES [dbo].[bEMRX] ([EMGroup], [RepType])
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
