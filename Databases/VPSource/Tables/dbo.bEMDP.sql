...
ALTER TABLE [dbo].[bEMDP] WITH NOCHECK ADD
CONSTRAINT [FK_bEMDP_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
ALTER TABLE [dbo].[bEMDP] ADD
CONSTRAINT [CK_bEMDP_UseResidualVal] CHECK (([UseResidualVal]='N' OR [UseResidualVal]='Y'))
ALTER TABLE [dbo].[bEMDP] ADD
CONSTRAINT [FK_bEMDP_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
