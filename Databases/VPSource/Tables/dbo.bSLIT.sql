...
[OrigUnitCost] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bSLIT_OrigUnitCost] DEFAULT ((0)),
[OrigCost] [dbo].[bDollar] NOT NULL,
[CurUnits] [dbo].[bUnits] NOT NULL,
[CurUnitCost] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bSLIT_CurUnitCost] DEFAULT ((0)),
...
CREATE UNIQUE CLUSTERED INDEX [biSLIT] ON [dbo].[bSLIT] ([SLCo], [SL], [SLItem]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bSLIT] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
