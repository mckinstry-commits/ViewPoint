...
ALTER TABLE [dbo].[bHQDS] ADD
CONSTRAINT [CK_bHQDS_YNBeginStatus] CHECK (([YNBeginStatus]='Y' OR [YNBeginStatus]='N'))
ALTER TABLE [dbo].[bHQDS] ADD
CONSTRAINT [CK_bHQDS_YNComplete] CHECK (([YNComplete]='Y' OR [YNComplete]='N'))
GO
