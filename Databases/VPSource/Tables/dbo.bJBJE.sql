...
ALTER TABLE [dbo].[bJBJE] ADD
CONSTRAINT [CK_bJBJE_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
ALTER TABLE [dbo].[bJBJE] ADD
CONSTRAINT [CK_bJBJE_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBJE].[Purge]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBJE].[AuditYN]'
GO
