...
ALTER TABLE [dbo].[bSLWH] ADD
CONSTRAINT [CK_bSLWH_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000) OR [CMAcct] IS NULL))
ALTER TABLE [dbo].[bSLWH] ADD
CONSTRAINT [CK_bSLWH_ReadyYN] CHECK (([ReadyYN]='Y' OR [ReadyYN]='N'))
GO
