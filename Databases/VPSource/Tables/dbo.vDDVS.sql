...
ALTER TABLE [dbo].[vDDVS] ADD 
CONSTRAINT [PK_vDDVS] PRIMARY KEY CLUSTERED  ([OnlyOneRow]) ON [PRIMARY]
ALTER TABLE [dbo].[vDDVS] ADD
CONSTRAINT [CK_vDDVS_UseAppRole] CHECK (([UseAppRole]='Y' OR [UseAppRole]='N'))
ALTER TABLE [dbo].[vDDVS] ADD
CONSTRAINT [CK_vDDVS_OnlyOneRow] CHECK (([OnlyOneRow]='X'))
GO
