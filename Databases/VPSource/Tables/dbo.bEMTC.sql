...
ALTER TABLE [dbo].[bEMTC] ADD
CONSTRAINT [FK_bEMTC_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
ALTER TABLE [dbo].[bEMTC] ADD
CONSTRAINT [FK_bEMTC_bEMCM_Category] FOREIGN KEY ([EMCo], [Category]) REFERENCES [dbo].[bEMCM] ([EMCo], [Category])
ALTER TABLE [dbo].[bEMTC] ADD
CONSTRAINT [FK_bEMTC_bEMTH_RevTemplate] FOREIGN KEY ([EMCo], [RevTemplate]) REFERENCES [dbo].[bEMTH] ([EMCo], [RevTemplate]) ON DELETE CASCADE
ALTER TABLE [dbo].[bEMTC] ADD
CONSTRAINT [FK_bEMTC_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
ALTER TABLE [dbo].[bEMTC] ADD
CONSTRAINT [FK_bEMTC_bEMRC_RevCode] FOREIGN KEY ([EMGroup], [RevCode]) REFERENCES [dbo].[bEMRC] ([EMGroup], [RevCode])
GO
