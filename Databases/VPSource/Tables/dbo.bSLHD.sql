...
[DocType] [dbo].[bDocType] NOT NULL CONSTRAINT [DF_bSLHD_DocType] DEFAULT ('SUB')
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bSLHD] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [IX_bSLHD_SL] ON [dbo].[bSLHD] ([SLCo], [SL]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bSLHD] ADD
CONSTRAINT [CK_bSLHD_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
ALTER TABLE [dbo].[bSLHD] ADD
CONSTRAINT [CK_bSLHD_Approved] CHECK (([Approved]='Y' OR [Approved]='N' OR [Approved] IS NULL))
ALTER TABLE [dbo].[bSLHD] ADD
CONSTRAINT [FK_bSLHD_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
