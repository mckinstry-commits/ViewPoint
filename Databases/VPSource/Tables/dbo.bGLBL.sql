...
CREATE UNIQUE CLUSTERED INDEX [biGLBL] ON [dbo].[bGLBL] ([GLCo], [GLAcct], [Mth]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bGLBL] ADD CONSTRAINT [PK_bGLBL] PRIMARY KEY NONCLUSTERED  ([KeyID]) WITH (FILLFACTOR=100) ON [PRIMARY]
