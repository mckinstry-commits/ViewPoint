...
ALTER TABLE [dbo].[bGLDT] ADD 
CONSTRAINT [PK_bGLDT] PRIMARY KEY CLUSTERED  ([GLCo], [Mth], [GLTrans]) WITH (FILLFACTOR=80) ON [PRIMARY]
CREATE NONCLUSTERED INDEX [IX_bGLDT_GLAcct] ON [dbo].[bGLDT] ([GLAcct]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [IX_bGLDT_Mth] ON [dbo].[bGLDT] ([Mth]) INCLUDE ([GLAcct], [GLCo]) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [IX_bGLDT_GLAcctMth] ON [dbo].[bGLDT] ([Mth], [GLCo], [GLAcct]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biGLDTUniqueAttchID] ON [dbo].[bGLDT] ([UniqueAttchID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bGLDT] ADD
CONSTRAINT [CK_bGLDT_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
