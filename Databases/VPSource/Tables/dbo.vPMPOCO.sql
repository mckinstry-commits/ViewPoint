...
[DocType] [dbo].[bDocType] NOT NULL CONSTRAINT [DF_vPMPOCO_DocType] DEFAULT ('POCO')
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
ALTER TABLE [dbo].[vPMPOCO] ADD
CONSTRAINT [FK_vPMPOCO_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
ALTER TABLE [dbo].[vPMPOCO] ADD
