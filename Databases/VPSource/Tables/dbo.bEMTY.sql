...
ALTER TABLE [dbo].[bEMTY] ADD
CONSTRAINT [FK_bEMTY_bEMCC_CostCode] FOREIGN KEY ([EMGroup], [CostCode]) REFERENCES [dbo].[bEMCC] ([EMGroup], [CostCode])
ALTER TABLE [dbo].[bEMTY] ADD
CONSTRAINT [FK_bEMTY_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
