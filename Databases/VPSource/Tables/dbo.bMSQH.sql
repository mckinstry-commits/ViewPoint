...
ALTER TABLE [dbo].[bMSQH] ADD
CONSTRAINT [CK_bMSQH_Active] CHECK (([Active]='Y' OR [Active]='N'))
ALTER TABLE [dbo].[bMSQH] ADD
CONSTRAINT [CK_bMSQH_Purge] CHECK (([PurgeYN]='Y' OR [PurgeYN]='N'))
ALTER TABLE [dbo].[bMSQH] ADD
CONSTRAINT [CK_bMSQH_SepHaul] CHECK (([SepHaul]='Y' OR [SepHaul]='N'))
ALTER TABLE [dbo].[bMSQH] ADD
CONSTRAINT [CK_bMSQH_SepInv] CHECK (([SepInv]='Y' OR [SepInv]='N'))
ALTER TABLE [dbo].[bMSQH] ADD
CONSTRAINT [CK_bMSQH_UseUMMetricYN] CHECK (([UseUMMetricYN]='Y' OR [UseUMMetricYN]='N'))
GO
