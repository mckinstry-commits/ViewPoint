...
[Amt] [dbo].[bHrs] NOT NULL CONSTRAINT [DF_bPRAB_Amt] DEFAULT ((0)),
[Accum1Adj] [dbo].[bHrs] NULL CONSTRAINT [DF_bPRAB_Accum1Adj] DEFAULT ((0)),
[Accum2Adj] [dbo].[bHrs] NULL CONSTRAINT [DF_bPRAB_Accum2Adj] DEFAULT ((0)),
[AvailBalAdj] [dbo].[bHrs] NULL CONSTRAINT [DF_bPRAB_AvailBalAdj] DEFAULT ((0)),
