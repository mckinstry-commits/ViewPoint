...
ALTER TABLE [dbo].[bEMMR] ADD
CONSTRAINT [FK_bEMMR_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
ALTER TABLE [dbo].[bEMMR] ADD
CONSTRAINT [FK_bEMMR_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
GO
