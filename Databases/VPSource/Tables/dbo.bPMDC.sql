...
ALTER TABLE [dbo].[bPMDC] ADD 
CONSTRAINT [PK_bPMDC] PRIMARY KEY CLUSTERED  ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
...
ALTER TABLE [dbo].[bPMDC] ADD
CONSTRAINT [CK_bPMDC_Send] CHECK (([Send]='Y' OR [Send]='N'))
ALTER TABLE [dbo].[bPMDC] ADD
CONSTRAINT [CK_bPMDC_PrefMethod] CHECK (([PrefMethod]='M' OR [PrefMethod]='E' OR [PrefMethod]='F'))
ALTER TABLE [dbo].[bPMDC] ADD
