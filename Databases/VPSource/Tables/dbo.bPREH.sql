...
CONSTRAINT [CK_bPREH_ActiveYN] CHECK (([ActiveYN]='Y' OR [ActiveYN]='N'))
ALTER TABLE [dbo].[bPREH] ADD
CONSTRAINT [CK_bPREH_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
ALTER TABLE [dbo].[bPREH] ADD
CONSTRAINT [CK_bPREH_CertYN] CHECK (([CertYN]='Y' OR [CertYN]='N'))
ALTER TABLE [dbo].[bPREH] ADD
CONSTRAINT [CK_bPREH_DefaultPaySeq] CHECK (([DefaultPaySeq]='Y' OR [DefaultPaySeq]='N'))
ALTER TABLE [dbo].[bPREH] ADD
CONSTRAINT [CK_bPREH_PensionYN] CHECK (([PensionYN]='Y' OR [PensionYN]='N'))
ALTER TABLE [dbo].[bPREH] ADD
CONSTRAINT [CK_bPREH_PostToAll] CHECK (([PostToAll]='Y' OR [PostToAll]='N'))
ALTER TABLE [dbo].[bPREH] ADD
CONSTRAINT [CK_bPREH_UseIns] CHECK (([UseIns]='Y' OR [UseIns]='N'))
ALTER TABLE [dbo].[bPREH] ADD
CONSTRAINT [CK_bPREH_UseLocal] CHECK (([UseLocal]='Y' OR [UseLocal]='N'))
ALTER TABLE [dbo].[bPREH] ADD
CONSTRAINT [CK_bPREH_UseState] CHECK (([UseState]='Y' OR [UseState]='N'))
