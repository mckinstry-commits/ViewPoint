...
CREATE UNIQUE CLUSTERED INDEX [biJCPC] ON [dbo].[bJCPC] ([PhaseGroup], [Phase], [CostType]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bJCPC] ADD
CONSTRAINT [CK_bJCPC_ItemUnitFlag] CHECK (([ItemUnitFlag]='Y' OR [ItemUnitFlag]='N'))
ALTER TABLE [dbo].[bJCPC] ADD
CONSTRAINT [CK_bJCPC_PhaseUnitFlag] CHECK (([PhaseUnitFlag]='Y' OR [PhaseUnitFlag]='N'))
GO
