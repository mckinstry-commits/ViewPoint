...
CREATE UNIQUE CLUSTERED INDEX [biGLFY] ON [dbo].[bGLFY] ([GLCo], [FYEMO]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bGLFY] ADD CONSTRAINT [PK_bGLFY] PRIMARY KEY NONCLUSTERED  ([KeyID]) WITH (FILLFACTOR=100) ON [PRIMARY]

ALTER TABLE [dbo].[bGLFY] WITH NOCHECK ADD
CONSTRAINT [FK_bGLFY_bGLCO_GLCo] FOREIGN KEY ([GLCo]) REFERENCES [dbo].[bGLCO] ([GLCo])
GO
