...
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_AllowNoPhase] CHECK (([AllowNoPhase]='Y' OR [AllowNoPhase]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_AuditAccums] CHECK (([AuditAccums]='Y' OR [AuditAccums]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_AuditCoParams] CHECK (([AuditCoParams]='Y' OR [AuditCoParams]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_AuditCraftClass] CHECK (([AuditCraftClass]='Y' OR [AuditCraftClass]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_AuditDLs] CHECK (([AuditDLs]='Y' OR [AuditDLs]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_AuditEmployees] CHECK (([AuditEmployees]='Y' OR [AuditEmployees]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_AuditPayHistory] CHECK (([AuditPayHistory]='Y' OR [AuditPayHistory]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_AuditStateIns] CHECK (([AuditStateIns]='Y' OR [AuditStateIns]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_AuditTaxes] CHECK (([AuditTaxes]='Y' OR [AuditTaxes]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_AutoOT] CHECK (([AutoOT]='Y' OR [AutoOT]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_EMCostEmployee] CHECK (([EMCostEmployee]='Y' OR [EMCostEmployee]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_EMInterface] CHECK (([EMInterface]='Y' OR [EMInterface]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_EMRevEmployee] CHECK (([EMRevEmployee]='Y' OR [EMRevEmployee]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_EMRevPhase] CHECK (([EMRevPhase]='Y' OR [EMRevPhase]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_EMRevPostingDate] CHECK (([EMRevPostingDate]='Y' OR [EMRevPostingDate]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_EMUsage] CHECK (([EMUsage]='Y' OR [EMUsage]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_ExcludeSSN] CHECK (([ExcludeSSN]='Y' OR [ExcludeSSN]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_GLInterface] CHECK (([GLInterface]='Y' OR [GLInterface]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_InsByPhase] CHECK (([InsByPhase]='Y' OR [InsByPhase]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_InsStateOpt] CHECK (([InsStateOpt]='Y' OR [InsStateOpt]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_JCICraftClass] CHECK (([JCICraftClass]='Y' OR [JCICraftClass]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_JCICrew] CHECK (([JCICrew]='Y' OR [JCICrew]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_JCIEarnType] CHECK (([JCIEarnType]='Y' OR [JCIEarnType]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_JCIEmployee] CHECK (([JCIEmployee]='Y' OR [JCIEmployee]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_JCIEquip] CHECK (([JCIEquip]='Y' OR [JCIEquip]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_JCIFactor] CHECK (([JCIFactor]='Y' OR [JCIFactor]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_JCILiabFactor] CHECK (([JCILiabFactor]='Y' OR [JCILiabFactor]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_JCILiabShift] CHECK (([JCILiabShift]='Y' OR [JCILiabShift]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_JCILiabType] CHECK (([JCILiabType]='Y' OR [JCILiabType]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_JCIPostingDate] CHECK (([JCIPostingDate]='Y' OR [JCIPostingDate]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_JCIRevCode] CHECK (([JCIRevCode]='Y' OR [JCIRevCode]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_JCIShift] CHECK (([JCIShift]='Y' OR [JCIShift]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_JCInterface] CHECK (([JCInterface]='Y' OR [JCInterface]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_LocalOpt] CHECK (([LocalOpt]='Y' OR [LocalOpt]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_NonNegCheckPrint] CHECK (([NonNegCheckPrint]='Y' OR [NonNegCheckPrint]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_TaxStateOpt] CHECK (([TaxStateOpt]='Y' OR [TaxStateOpt]='N'))
ALTER TABLE [dbo].[bPRCO] ADD
CONSTRAINT [CK_bPRCO_UnempStateOpt] CHECK (([UnempStateOpt]='Y' OR [UnempStateOpt]='N'))
GO
