...
ALTER TABLE [dbo].[bEMRR] ADD
CONSTRAINT [CK_bEMRR_AllowPostOride] CHECK (([AllowPostOride]='N' OR [AllowPostOride]='Y'))
ALTER TABLE [dbo].[bEMRR] ADD
CONSTRAINT [CK_bEMRR_PostWorkUnits] CHECK (([PostWorkUnits]='N' OR [PostWorkUnits]='Y'))
ALTER TABLE [dbo].[bEMRR] ADD
CONSTRAINT [CK_bEMRR_UpdtHrMeter] CHECK (([UpdtHrMeter]='N' OR [UpdtHrMeter]='Y'))
ALTER TABLE [dbo].[bEMRR] ADD
CONSTRAINT [FK_bEMRR_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
ALTER TABLE [dbo].[bEMRR] ADD
CONSTRAINT [FK_bEMRR_bEMCM_Category] FOREIGN KEY ([EMCo], [Category]) REFERENCES [dbo].[bEMCM] ([EMCo], [Category])
ALTER TABLE [dbo].[bEMRR] ADD
CONSTRAINT [FK_bEMRR_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
ALTER TABLE [dbo].[bEMRR] ADD
CONSTRAINT [FK_bEMRR_bEMRC_RevCode] FOREIGN KEY ([EMGroup], [RevCode]) REFERENCES [dbo].[bEMRC] ([EMGroup], [RevCode])
GO
