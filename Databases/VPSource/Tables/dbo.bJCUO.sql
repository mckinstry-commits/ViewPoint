...
ALTER TABLE [dbo].[bJCUO] ADD
CONSTRAINT [CK_bJCUO_ChangedOnly] CHECK (([ChangedOnly]='Y' OR [ChangedOnly]='N'))
ALTER TABLE [dbo].[bJCUO] ADD
CONSTRAINT [CK_bJCUO_ItemUnitsOnly] CHECK (([ItemUnitsOnly]='Y' OR [ItemUnitsOnly]='N'))
ALTER TABLE [dbo].[bJCUO] ADD
CONSTRAINT [CK_bJCUO_NoLinkedCT] CHECK (([NoLinkedCT]='Y' OR [NoLinkedCT]='N'))
ALTER TABLE [dbo].[bJCUO] ADD
CONSTRAINT [CK_bJCUO_OpenForm] CHECK (([OpenForm]='Y' OR [OpenForm]='N'))
ALTER TABLE [dbo].[bJCUO] ADD
CONSTRAINT [CK_bJCUO_PhaseUnitsOnly] CHECK (([PhaseUnitsOnly]='Y' OR [PhaseUnitsOnly]='N'))
ALTER TABLE [dbo].[bJCUO] ADD
CONSTRAINT [CK_bJCUO_ProjInactivePhases] CHECK (([ProjInactivePhases]='Y' OR [ProjInactivePhases]='N'))
ALTER TABLE [dbo].[bJCUO] ADD
CONSTRAINT [CK_bJCUO_RemainCosts] CHECK (([RemainCosts]='Y' OR [RemainCosts]='N'))
ALTER TABLE [dbo].[bJCUO] ADD
CONSTRAINT [CK_bJCUO_RemainHours] CHECK (([RemainHours]='Y' OR [RemainHours]='N'))
ALTER TABLE [dbo].[bJCUO] ADD
CONSTRAINT [CK_bJCUO_RemainUnits] CHECK (([RemainUnits]='Y' OR [RemainUnits]='N'))
ALTER TABLE [dbo].[bJCUO] ADD
CONSTRAINT [CK_bJCUO_ShowFutureCO] CHECK (([ShowFutureCO]='Y' OR [ShowFutureCO]='N'))
ALTER TABLE [dbo].[bJCUO] ADD
CONSTRAINT [CK_bJCUO_ShowLinkedCT] CHECK (([ShowLinkedCT]='Y' OR [ShowLinkedCT]='N'))
ALTER TABLE [dbo].[bJCUO] ADD
CONSTRAINT [CK_bJCUO_ThruPriorMonth] CHECK (([ThruPriorMonth]='Y' OR [ThruPriorMonth]='N'))
GO
