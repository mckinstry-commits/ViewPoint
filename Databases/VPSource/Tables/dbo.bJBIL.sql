...
ALTER TABLE [dbo].[bJBIL] ADD
CONSTRAINT [CK_bJBIL_ReseqYN] CHECK (([ReseqYN]='Y' OR [ReseqYN]='N'))
ALTER TABLE [dbo].[bJBIL] ADD
CONSTRAINT [CK_bJBIL_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
ALTER TABLE [dbo].[bJBIL] ADD
CONSTRAINT [CK_bJBIL_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
