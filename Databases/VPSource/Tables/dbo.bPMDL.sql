...
[DocType] [dbo].[bDocType] NOT NULL CONSTRAINT [DF_bPMDL_DocType] DEFAULT ('DAILYLOG')
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
ALTER TABLE [dbo].[bPMDL] ADD
CONSTRAINT [CK_bPMDL_AccidentsYN] CHECK (([AccidentsYN]='Y' OR [AccidentsYN]='N'))
ALTER TABLE [dbo].[bPMDL] ADD
CONSTRAINT [CK_bPMDL_ActivityYN] CHECK (([ActivityYN]='Y' OR [ActivityYN]='N'))
ALTER TABLE [dbo].[bPMDL] ADD
CONSTRAINT [CK_bPMDL_ConversationsYN] CHECK (([ConversationsYN]='Y' OR [ConversationsYN]='N'))
ALTER TABLE [dbo].[bPMDL] ADD
CONSTRAINT [CK_bPMDL_CrewYN] CHECK (([CrewYN]='Y' OR [CrewYN]='N'))
ALTER TABLE [dbo].[bPMDL] ADD
CONSTRAINT [CK_bPMDL_DeliveriesYN] CHECK (([DeliveriesYN]='Y' OR [DeliveriesYN]='N'))
ALTER TABLE [dbo].[bPMDL] ADD
CONSTRAINT [CK_bPMDL_EmployeeYN] CHECK (([EmployeeYN]='Y' OR [EmployeeYN]='N'))
ALTER TABLE [dbo].[bPMDL] ADD
CONSTRAINT [CK_bPMDL_EquipmentYN] CHECK (([EquipmentYN]='Y' OR [EquipmentYN]='N'))
ALTER TABLE [dbo].[bPMDL] ADD
CONSTRAINT [CK_bPMDL_SubcontractYN] CHECK (([SubcontractYN]='Y' OR [SubcontractYN]='N'))
ALTER TABLE [dbo].[bPMDL] ADD
CONSTRAINT [CK_bPMDL_VisitorsYN] CHECK (([VisitorsYN]='Y' OR [VisitorsYN]='N'))
ALTER TABLE [dbo].[bPMDL] ADD
CONSTRAINT [FK_bPMDL_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
ALTER TABLE [dbo].[bPMDL] ADD
CONSTRAINT [FK_bPMDL_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
