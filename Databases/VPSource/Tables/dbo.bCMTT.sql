...
ALTER TABLE [dbo].[bCMTT] ADD
CONSTRAINT [CK_bCMTT_FromCMAcct] CHECK (([FromCMAcct]>(0) AND [FromCMAcct]<(10000)))
ALTER TABLE [dbo].[bCMTT] ADD
CONSTRAINT [CK_bCMTT_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
ALTER TABLE [dbo].[bCMTT] ADD
CONSTRAINT [CK_bCMTT_ToCMAcct] CHECK (([ToCMAcct]>(0) AND [ToCMAcct]<(10000)))
GO
