...
ALTER TABLE [dbo].[bAPUI] ADD
CONSTRAINT [CK_bAPUI_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000) OR [CMAcct] IS NULL))
ALTER TABLE [dbo].[bAPUI] ADD
CONSTRAINT [CK_bAPUI_PayOverrideYN] CHECK (([PayOverrideYN]='Y' OR [PayOverrideYN]='N'))
ALTER TABLE [dbo].[bAPUI] ADD
CONSTRAINT [CK_bAPUI_SeparatePayYN] CHECK (([SeparatePayYN]='Y' OR [SeparatePayYN]='N'))
ALTER TABLE [dbo].[bAPUI] ADD
CONSTRAINT [CK_bAPUI_V1099YN] CHECK (([V1099YN]='Y' OR [V1099YN]='N'))
GO
