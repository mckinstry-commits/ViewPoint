...
ALTER TABLE [dbo].[bHQWD] ADD
CONSTRAINT [CK_bHQWD_Active] CHECK (([Active]='Y' OR [Active]='N'))
ALTER TABLE [dbo].[bHQWD] ADD
CONSTRAINT [CK_bHQWD_SuppressNotes] CHECK (([SuppressNotes]='Y' OR [SuppressNotes]='N'))
ALTER TABLE [dbo].[bHQWD] ADD
CONSTRAINT [CK_bHQWD_SuppressZeros] CHECK (([SuppressZeros]='Y' OR [SuppressZeros]='N'))
GO
