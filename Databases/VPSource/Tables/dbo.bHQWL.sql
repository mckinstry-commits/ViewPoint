...
GO
ALTER TABLE [dbo].[bHQWL] ADD CONSTRAINT [PK_bHQWL] PRIMARY KEY CLUSTERED  ([Location]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHQWL] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
