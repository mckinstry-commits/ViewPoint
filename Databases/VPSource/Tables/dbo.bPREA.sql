...
CREATE UNIQUE CLUSTERED INDEX [biPREA] ON [dbo].[bPREA] ([PRCo], [Employee], [Mth], [EDLType], [EDLCode]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPREA] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bPREA] ADD
CONSTRAINT [CK_bPREA_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
