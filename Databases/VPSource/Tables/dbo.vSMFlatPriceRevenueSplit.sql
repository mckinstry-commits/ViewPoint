...
GO
ALTER TABLE [dbo].[vSMFlatPriceRevenueSplit] ADD CONSTRAINT [FK_vSMFlatPriceRevenueSplit_vSMCostType] FOREIGN KEY ([SMCo], [CostType]) REFERENCES [dbo].[vSMCostType] ([SMCo], [SMCostType])
GO
ALTER TABLE [dbo].[vSMFlatPriceRevenueSplit] ADD CONSTRAINT [FK_vSMFlatPriceRevenueSplit_vSMEntity] FOREIGN KEY ([SMCo], [EntitySeq]) REFERENCES [dbo].[vSMEntity] ([SMCo], [EntitySeq]) ON DELETE CASCADE
GO
