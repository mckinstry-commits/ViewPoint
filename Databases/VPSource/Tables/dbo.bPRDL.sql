...
CREATE UNIQUE CLUSTERED INDEX [biPRDL] ON [dbo].[bPRDL] ([PRCo], [DLCode]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRDL] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bPRDL] WITH NOCHECK ADD
CONSTRAINT [FK_bPRDL_PRCo_PreTaxGroup] FOREIGN KEY ([PRCo], [PreTaxGroup]) REFERENCES [dbo].[bPRDeductionGroup] ([PRCo], [DednGroup])
ALTER TABLE [dbo].[bPRDL] ADD
CONSTRAINT [CK_bPRDL_AccumSubjAmts] CHECK (([AccumSubjAmts]='Y' OR [AccumSubjAmts]='N'))
ALTER TABLE [dbo].[bPRDL] ADD
CONSTRAINT [CK_bPRDL_AutoAP] CHECK (([AutoAP]='Y' OR [AutoAP]='N'))
ALTER TABLE [dbo].[bPRDL] ADD
CONSTRAINT [CK_bPRDL_BonusOverride] CHECK (([BonusOverride]='Y' OR [BonusOverride]='N'))
ALTER TABLE [dbo].[bPRDL] ADD
CONSTRAINT [CK_bPRDL_DetOnCert] CHECK (([DetOnCert]='Y' OR [DetOnCert]='N'))
ALTER TABLE [dbo].[bPRDL] ADD
CONSTRAINT [CK_bPRDL_IncldW2] CHECK (([IncldW2]='Y' OR [IncldW2]='N'))
ALTER TABLE [dbo].[bPRDL] ADD
CONSTRAINT [CK_bPRDL_LimitCorrect] CHECK (([LimitCorrect]='Y' OR [LimitCorrect]='N' OR [LimitCorrect] IS NULL))
ALTER TABLE [dbo].[bPRDL] ADD
CONSTRAINT [CK_bPRDL_RndToDollar] CHECK (([RndToDollar]='Y' OR [RndToDollar]='N'))
ALTER TABLE [dbo].[bPRDL] ADD
CONSTRAINT [CK_bPRDL_SelectPurge] CHECK (([SelectPurge]='Y' OR [SelectPurge]='N'))
ALTER TABLE [dbo].[bPRDL] ADD
CONSTRAINT [CK_bPRDL_SeqOneOnly] CHECK (([SeqOneOnly]='Y' OR [SeqOneOnly]='N'))
ALTER TABLE [dbo].[bPRDL] ADD
CONSTRAINT [CK_bPRDL_TransByEmployee] CHECK (([TransByEmployee]='Y' OR [TransByEmployee]='N' OR [TransByEmployee] IS NULL))
ALTER TABLE [dbo].[bPRDL] ADD
CONSTRAINT [CK_bPRDL_YTDCorrect] CHECK (([YTDCorrect]='Y' OR [YTDCorrect]='N'))
