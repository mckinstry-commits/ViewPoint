...
ALTER TABLE [dbo].[vSMAgreementService] WITH NOCHECK ADD
CONSTRAINT [FK_vSMAgreementService_vSMAgreement] FOREIGN KEY ([SMCo], [Agreement], [Revision]) REFERENCES [dbo].[vSMAgreement] ([SMCo], [Agreement], [Revision])
ALTER TABLE [dbo].[vSMAgreementService] WITH NOCHECK ADD
CONSTRAINT [FK_vSMAgreementService_vSMServiceSite] FOREIGN KEY ([SMCo], [ServiceSite]) REFERENCES [dbo].[vSMServiceSite] ([SMCo], [ServiceSite])
ALTER TABLE [dbo].[vSMAgreementService] ADD
CONSTRAINT [FK_vSMAgreementService_vSMDivision] FOREIGN KEY ([SMCo], [ServiceCenter], [Division]) REFERENCES [dbo].[vSMDivision] ([SMCo], [ServiceCenter], [Division])
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
