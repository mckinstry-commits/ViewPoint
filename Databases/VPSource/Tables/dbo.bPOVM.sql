...
ALTER TABLE [dbo].[bPOVM] ADD
CONSTRAINT [CK_bPOVM_CostECM] CHECK (([CostECM]='E' OR [CostECM]='C' OR [CostECM]='M' OR [CostECM] IS NULL))
ALTER TABLE [dbo].[bPOVM] ADD
CONSTRAINT [CK_bPOVM_PriceECM] CHECK (([PriceECM]='E' OR [PriceECM]='C' OR [PriceECM]='M' OR [PriceECM] IS NULL))
GO
