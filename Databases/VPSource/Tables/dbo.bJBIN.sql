...
ALTER TABLE [dbo].[bJBIN] ADD
CONSTRAINT [CK_bJBIN_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
ALTER TABLE [dbo].[bJBIN] ADD
CONSTRAINT [CK_bJBIN_AutoInitYN] CHECK (([AutoInitYN]='Y' OR [AutoInitYN]='N'))
ALTER TABLE [dbo].[bJBIN] ADD
CONSTRAINT [CK_bJBIN_BillOnCompleteYN] CHECK (([BillOnCompleteYN]='Y' OR [BillOnCompleteYN]='N'))
ALTER TABLE [dbo].[bJBIN] ADD
CONSTRAINT [CK_bJBIN_OverrideGLRevAcctYN] CHECK (([OverrideGLRevAcctYN]='Y' OR [OverrideGLRevAcctYN]='N'))
ALTER TABLE [dbo].[bJBIN] ADD
CONSTRAINT [CK_bJBIN_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
ALTER TABLE [dbo].[bJBIN] ADD
CONSTRAINT [CK_bJBIN_RestrictBillGroupYN] CHECK (([RestrictBillGroupYN]='Y' OR [RestrictBillGroupYN]='N'))
ALTER TABLE [dbo].[bJBIN] ADD
CONSTRAINT [CK_bJBIN_RevRelRetgYN] CHECK (([RevRelRetgYN]='Y' OR [RevRelRetgYN]='N'))
ALTER TABLE [dbo].[bJBIN] ADD
CONSTRAINT [CK_bJBIN_TMUpdateAddonYN] CHECK (([TMUpdateAddonYN]='Y' OR [TMUpdateAddonYN]='N'))
GO
