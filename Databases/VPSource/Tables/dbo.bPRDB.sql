...
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRDB] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bPRDB] ADD
CONSTRAINT [CK_bPRDB_SubjectOnly] CHECK (([SubjectOnly]='Y' OR [SubjectOnly]='N'))
