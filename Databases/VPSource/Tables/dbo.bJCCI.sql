...
CREATE UNIQUE CLUSTERED INDEX [biJCCI] ON [dbo].[bJCCI] ([JCCo], [Contract], [Item]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [IX_bJCCI_ItemContract] ON [dbo].[bJCCI] ([Contract], [Item]) WITH (FILLFACTOR=80) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCCI] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bJCCI] ADD
CONSTRAINT [CK_bJCCI_InitSubs] CHECK (([InitSubs]='Y' OR [InitSubs]='N'))
ALTER TABLE [dbo].[bJCCI] ADD
CONSTRAINT [CK_bJCCI_BillType] CHECK (([BillType]='T' OR [BillType]='P' OR [BillType]='B' OR [BillType]='N' OR [BillType] IS NULL))
ALTER TABLE [dbo].[bJCCI] ADD
CONSTRAINT [CK_bJCCI_ProjPlug] CHECK (([ProjPlug]='Y' OR [ProjPlug]='N'))
GO
...
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[RetainPCT]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[OrigContractAmt]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[OrigContractUnits]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[OrigUnitPrice]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[ContractAmt]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[ContractUnits]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[UnitPrice]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[BilledAmt]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[BilledUnits]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[ReceivedAmt]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[CurrentRetainAmt]'
GO
EXEC sp_bindrule N'[dbo].[brBillType]', N'[dbo].[bJCCI].[BillType]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[BillOriginalUnits]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[BillOriginalAmt]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[BillCurrentUnits]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[BillCurrentAmt]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCI].[BillUnitPrice]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJCCI].[InitSubs]'
GO
EXEC sp_bindefault N'[dbo].[bdYes]', N'[dbo].[bJCCI].[InitSubs]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJCCI].[ProjPlug]'
GO
