...
[DocType] [dbo].[bDocType] NOT NULL CONSTRAINT [DF_vPMChangeOrderRequest_DocType] DEFAULT ('COR')
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
ALTER TABLE [dbo].[vPMChangeOrderRequest] ADD
CONSTRAINT [FK_vPMChangeOrderRequest_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
ALTER TABLE [dbo].[vPMChangeOrderRequest] ADD
