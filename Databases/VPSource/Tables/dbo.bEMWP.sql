...
ALTER TABLE [dbo].[bEMWP] ADD
CONSTRAINT [CK_bEMWP_PSFlag] CHECK (([PSFlag]='S' OR [PSFlag]='P'))
ALTER TABLE [dbo].[bEMWP] ADD
CONSTRAINT [CK_bEMWP_Required] CHECK (([Required]='N' OR [Required]='Y'))
ALTER TABLE [dbo].[bEMWP] ADD
CONSTRAINT [FK_bEMWP_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
ALTER TABLE [dbo].[bEMWP] ADD
CONSTRAINT [FK_bEMWP_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
ALTER TABLE [dbo].[bEMWP] ADD
CONSTRAINT [FK_bEMWP_bEMWH_WorkOrder] FOREIGN KEY ([EMCo], [WorkOrder]) REFERENCES [dbo].[bEMWH] ([EMCo], [WorkOrder])
ALTER TABLE [dbo].[bEMWP] ADD
CONSTRAINT [FK_bEMWP_bEMWI_WOItem] FOREIGN KEY ([EMCo], [WorkOrder], [WOItem]) REFERENCES [dbo].[bEMWI] ([EMCo], [WorkOrder], [WOItem])
ALTER TABLE [dbo].[bEMWP] ADD
CONSTRAINT [FK_bEMWP_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
ALTER TABLE [dbo].[bEMWP] ADD
CONSTRAINT [FK_bEMWP_bEMPS_PartsStatusCode] FOREIGN KEY ([EMGroup], [PartsStatusCode]) REFERENCES [dbo].[bEMPS] ([EMGroup], [PartsStatusCode])
GO
