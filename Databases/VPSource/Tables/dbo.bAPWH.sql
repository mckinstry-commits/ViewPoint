...
ALTER TABLE [dbo].[bAPWH] ADD
CONSTRAINT [CK_bAPWH_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000) OR [CMAcct] IS NULL))
ALTER TABLE [dbo].[bAPWH] ADD
CONSTRAINT [CK_bAPWH_CompliedYN] CHECK (([CompliedYN]='Y' OR [CompliedYN]='N'))
ALTER TABLE [dbo].[bAPWH] ADD
CONSTRAINT [CK_bAPWH_HoldYN] CHECK (([HoldYN]='Y' OR [HoldYN]='N'))
ALTER TABLE [dbo].[bAPWH] ADD
CONSTRAINT [CK_bAPWH_ManualAddYN] CHECK (([ManualAddYN]='Y' OR [ManualAddYN]='N'))
ALTER TABLE [dbo].[bAPWH] ADD
CONSTRAINT [CK_bAPWH_PayYN] CHECK (([PayYN]='Y' OR [PayYN]='N'))
ALTER TABLE [dbo].[bAPWH] ADD
CONSTRAINT [CK_bAPWH_SeparatePayJobYN] CHECK (([SeparatePayJobYN]='Y' OR [SeparatePayJobYN]='N'))
ALTER TABLE [dbo].[bAPWH] ADD
CONSTRAINT [CK_bAPWH_SeparatePaySLYN] CHECK (([SeparatePaySLYN]='Y' OR [SeparatePaySLYN]='N'))
ALTER TABLE [dbo].[bAPWH] ADD
CONSTRAINT [CK_bAPWH_TakeAllDiscYN] CHECK (([TakeAllDiscYN]='Y' OR [TakeAllDiscYN]='N'))
GO
