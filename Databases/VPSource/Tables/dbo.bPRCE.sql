...
[OldRate] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPRCE_OldRate] DEFAULT ((0)),
[NewRate] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPRCE_NewRate] DEFAULT ((0)),
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRCE] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRCE] ON [dbo].[bPRCE] ([PRCo], [Craft], [Class], [Shift], [EarnCode]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
