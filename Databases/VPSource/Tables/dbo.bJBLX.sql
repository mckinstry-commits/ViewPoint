...
ALTER TABLE [dbo].[bJBLX] ADD
CONSTRAINT [CK_bJBLX_RestrictByClass] CHECK (([RestrictByClass]='Y' OR [RestrictByClass]='N'))
ALTER TABLE [dbo].[bJBLX] ADD
CONSTRAINT [CK_bJBLX_RestrictByCraft] CHECK (([RestrictByCraft]='Y' OR [RestrictByCraft]='N'))
GO
