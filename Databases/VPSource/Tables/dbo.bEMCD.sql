...
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [CK_bEMCD_EMTransType] CHECK (([EMTransType]='AR' OR [EMTransType]='PO Receipt' OR [EMTransType]='PR Entry' OR [EMTransType]='AP' OR [EMTransType]='Usage' OR [EMTransType]='Depn' OR [EMTransType]='Fuel' OR [EMTransType]='Parts' OR [EMTransType]='Alloc' OR [EMTransType]='WO' OR [EMTransType]='Equip' OR [EMTransType] IS NULL))
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [CK_bEMCD_INStkECM] CHECK (([INStkECM]='M' OR [INStkECM]='C' OR [INStkECM]='E' OR [INStkECM] IS NULL))
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [CK_bEMCD_PerECM] CHECK (([PerECM]='M' OR [PerECM]='C' OR [PerECM]='E' OR [PerECM] IS NULL))
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [CK_bEMCD_ReversalStatus] CHECK (([ReversalStatus]=(4) OR [ReversalStatus]=(3) OR [ReversalStatus]=(2) OR [ReversalStatus]=(1) OR [ReversalStatus]=(0) OR [ReversalStatus] IS NULL))
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [CK_bEMCD_Source] CHECK (([Source]='AR Receipt' OR [Source]='PO' OR [Source]='AP' OR [Source]='PR' OR [Source]='EMTime' OR [Source]='EMParts' OR [Source]='EMAlloc' OR [Source]='EMDepr' OR [Source]='EMFuel' OR [Source]='EMRev' OR [Source]='EMAdj' OR [Source] IS NULL))
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [FK_bEMCD_bEMCC_CostCode] FOREIGN KEY ([EMGroup], [CostCode]) REFERENCES [dbo].[bEMCC] ([EMGroup], [CostCode])
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [FK_bEMCD_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [FK_bEMCD_bEMAH_AllocCode] FOREIGN KEY ([EMCo], [AllocCode]) REFERENCES [dbo].[bEMAH] ([EMCo], [AllocCode])
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [FK_bEMCD_bEMEM_Component] FOREIGN KEY ([EMCo], [Component]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment])
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [FK_bEMCD_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [FK_bEMCD_bEMWH_WorkOrder] FOREIGN KEY ([EMCo], [WorkOrder]) REFERENCES [dbo].[bEMWH] ([EMCo], [WorkOrder])
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [FK_bEMCD_bEMWI_WOItem] FOREIGN KEY ([EMCo], [WorkOrder], [WOItem]) REFERENCES [dbo].[bEMWI] ([EMCo], [WorkOrder], [WOItem])
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [FK_bEMCD_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [FK_bEMCD_bEMTY_ComponentTypeCode] FOREIGN KEY ([EMGroup], [ComponentTypeCode]) REFERENCES [dbo].[bEMTY] ([EMGroup], [ComponentTypeCode])
ALTER TABLE [dbo].[bEMCD] ADD
CONSTRAINT [FK_bEMCD_bEMCT_EMCostType] FOREIGN KEY ([EMGroup], [EMCostType]) REFERENCES [dbo].[bEMCT] ([EMGroup], [CostType])
GO
