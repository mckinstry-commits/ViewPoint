...
GO
ALTER TABLE [dbo].[vPMProjectDefaultDocumentDistribution] ADD CONSTRAINT [FK_vPMProjectDefaultDocumentDistribution_vPMProjectDefaultDistributions] FOREIGN KEY ([ContactKeyID]) REFERENCES [dbo].[vPMProjectDefaultDistributions] ([KeyID]) ON DELETE CASCADE
GO
