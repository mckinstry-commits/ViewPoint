...
ALTER TABLE [dbo].[bARCO] ADD
CONSTRAINT [CK_bARCO_AuditCompany] CHECK (([AuditCompany]='Y' OR [AuditCompany]='N'))
ALTER TABLE [dbo].[bARCO] ADD
CONSTRAINT [CK_bARCO_AuditCustomers] CHECK (([AuditCustomers]='Y' OR [AuditCustomers]='N'))
ALTER TABLE [dbo].[bARCO] ADD
CONSTRAINT [CK_bARCO_AuditRecType] CHECK (([AuditRecType]='Y' OR [AuditRecType]='N'))
ALTER TABLE [dbo].[bARCO] ADD
CONSTRAINT [CK_bARCO_AuditTrans] CHECK (([AuditTrans]='Y' OR [AuditTrans]='N'))
ALTER TABLE [dbo].[bARCO] ADD
CONSTRAINT [CK_bARCO_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
ALTER TABLE [dbo].[bARCO] ADD
CONSTRAINT [CK_bARCO_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000) OR [CMAcct] IS NULL))
ALTER TABLE [dbo].[bARCO] ADD
CONSTRAINT [CK_bARCO_DiscTax] CHECK (([DiscTax]='Y' OR [DiscTax]='N'))
ALTER TABLE [dbo].[bARCO] ADD
CONSTRAINT [CK_bARCO_FCCalcOnFC] CHECK (([FCCalcOnFC]='Y' OR [FCCalcOnFC]='N'))
ALTER TABLE [dbo].[bARCO] ADD
CONSTRAINT [CK_bARCO_InvAutoNum] CHECK (([InvAutoNum]='Y' OR [InvAutoNum]='N'))
ALTER TABLE [dbo].[bARCO] ADD
CONSTRAINT [CK_bARCO_InvoiceTax] CHECK (([InvoiceTax]='Y' OR [InvoiceTax]='N'))
ALTER TABLE [dbo].[bARCO] ADD
CONSTRAINT [CK_bARCO_RecTypeOpt] CHECK (([RecTypeOpt]='Y' OR [RecTypeOpt]='N'))
ALTER TABLE [dbo].[bARCO] ADD
CONSTRAINT [CK_bARCO_ReceiptTax] CHECK (([ReceiptTax]='Y' OR [ReceiptTax]='N'))
ALTER TABLE [dbo].[bARCO] ADD
CONSTRAINT [CK_bARCO_RelRetainOpt] CHECK (([RelRetainOpt]='Y' OR [RelRetainOpt]='N'))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brCMAcct]', N'[dbo].[bARCO].[CMAcct]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bARCO].[FCCalcOnFC]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bARCO].[FCPct]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bARCO].[InvAutoNum]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bARCO].[RecTypeOpt]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bARCO].[InvoiceTax]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bARCO].[ReceiptTax]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bARCO].[RelRetainOpt]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bARCO].[AuditCompany]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bARCO].[AuditCustomers]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bARCO].[AuditRecType]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bARCO].[AuditTrans]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bARCO].[DiscTax]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bARCO].[AuditYN]'
GO
