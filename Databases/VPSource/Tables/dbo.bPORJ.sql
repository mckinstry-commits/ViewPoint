...
[JCUnitCost] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPORJ_JCUnitCost] DEFAULT ((0)),
[ECM] [dbo].[bECM] NULL,
[TotalCost] [dbo].[bDollar] NOT NULL,
[RNIUnits] [dbo].[bUnits] NOT NULL CONSTRAINT [DF_bPORJ_RNIUnits] DEFAULT ((0)),
[RNICost] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPORJ_RNICost] DEFAULT ((0)),
[RemCmtdCost] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bPORJ_RemCmtdCost] DEFAULT ((0)),
...
ALTER TABLE [dbo].[bPORJ] ADD
CONSTRAINT [CK_bPORJ_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
GO
