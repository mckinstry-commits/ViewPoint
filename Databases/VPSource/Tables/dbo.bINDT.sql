...
ALTER TABLE [dbo].[bINDT] ADD
CONSTRAINT [CK_bINDT_PECM] CHECK (([PECM]='M' OR [PECM]='C' OR [PECM]='E'))
ALTER TABLE [dbo].[bINDT] ADD
CONSTRAINT [CK_bINDT_PostECM] CHECK (([PostECM]='M' OR [PostECM]='C' OR [PostECM]='E'))
ALTER TABLE [dbo].[bINDT] ADD
CONSTRAINT [CK_bINDT_PurgeYN] CHECK (([PurgeYN]='Y' OR [PurgeYN]='N'))
ALTER TABLE [dbo].[bINDT] ADD
CONSTRAINT [CK_bINDT_StkECM] CHECK (([StkECM]='M' OR [StkECM]='C' OR [StkECM]='E'))
GO
