...
[Rate] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPRID_Rate] DEFAULT ((0)),
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRID] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRID] ON [dbo].[bPRID] ([PRCo], [State], [InsCode], [DLCode]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
