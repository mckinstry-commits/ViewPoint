...
ALTER TABLE [dbo].[bEMWF] ADD
CONSTRAINT [CK_bEMWF_Status] CHECK (([Status]='A' OR [Status]='I' OR [Status] IS NULL))
ALTER TABLE [dbo].[bEMWF] ADD
CONSTRAINT [CK_bEMWF_WarrantyUM] CHECK (([WarrantyUM]='Years' OR [WarrantyUM]='Months' OR [WarrantyUM]='Days' OR [WarrantyUM] IS NULL))
ALTER TABLE [dbo].[bEMWF] ADD
CONSTRAINT [FK_bEMWF_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
ALTER TABLE [dbo].[bEMWF] ADD
CONSTRAINT [FK_bEMWF_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
GO
