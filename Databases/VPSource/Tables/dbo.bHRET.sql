...
ALTER TABLE [dbo].[bHRET] ADD
CONSTRAINT [CK_bHRET_CPRYN] CHECK (([CPRYN]='Y' OR [CPRYN]='N'))
ALTER TABLE [dbo].[bHRET] ADD
CONSTRAINT [CK_bHRET_DegreeYN] CHECK (([DegreeYN]='Y' OR [DegreeYN]='N'))
ALTER TABLE [dbo].[bHRET] ADD
CONSTRAINT [CK_bHRET_FirstAidYN] CHECK (([FirstAidYN]='Y' OR [FirstAidYN]='N'))
ALTER TABLE [dbo].[bHRET] ADD
CONSTRAINT [CK_bHRET_Instructor1099YN] CHECK (([Instructor1099YN]='Y' OR [Instructor1099YN]='N'))
ALTER TABLE [dbo].[bHRET] ADD
CONSTRAINT [CK_bHRET_MSHAYN] CHECK (([MSHAYN]='Y' OR [MSHAYN]='N'))
ALTER TABLE [dbo].[bHRET] ADD
CONSTRAINT [CK_bHRET_OSHAYN] CHECK (([OSHAYN]='Y' OR [OSHAYN]='N'))
ALTER TABLE [dbo].[bHRET] ADD
CONSTRAINT [CK_bHRET_ReimbursedYN] CHECK (([ReimbursedYN]='Y' OR [ReimbursedYN]='N'))
ALTER TABLE [dbo].[bHRET] ADD
CONSTRAINT [CK_bHRET_WorkRelatedYN] CHECK (([WorkRelatedYN]='Y' OR [WorkRelatedYN]='N'))
GO
