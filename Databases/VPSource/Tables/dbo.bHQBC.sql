...
ALTER TABLE [dbo].[bHQBC] ADD
CONSTRAINT [CK_bHQBC_Adjust] CHECK (([Adjust]='Y' OR [Adjust]='N' OR [Adjust] IS NULL))
ALTER TABLE [dbo].[bHQBC] ADD
CONSTRAINT [CK_bHQBC_Rstrict] CHECK (([Rstrict]='Y' OR [Rstrict]='N'))
GO
