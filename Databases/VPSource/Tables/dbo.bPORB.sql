...
ALTER TABLE [dbo].[bPORB] ADD
CONSTRAINT [CK_bPORB_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
ALTER TABLE [dbo].[bPORB] ADD
CONSTRAINT [CK_bPORB_InvdFlag] CHECK (([InvdFlag]='Y' OR [InvdFlag]='N'))
ALTER TABLE [dbo].[bPORB] ADD
CONSTRAINT [CK_bPORB_OldECM] CHECK (([OldECM]='E' OR [OldECM]='C' OR [OldECM]='M' OR [OldECM] IS NULL))
ALTER TABLE [dbo].[bPORB] ADD
CONSTRAINT [CK_bPORB_OldInvdFlag] CHECK (([OldInvdFlag]='Y' OR [OldInvdFlag]='N' OR [OldInvdFlag] IS NULL))
GO
...
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bPORB].[UnitCost]'
GO
EXEC sp_bindrule N'[dbo].[brECM]', N'[dbo].[bPORB].[ECM]'
GO
EXEC sp_bindrule N'[dbo].[brECM]', N'[dbo].[bPORB].[OldECM]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bPORB].[InvdFlag]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bPORB].[OldInvdFlag]'
GO
