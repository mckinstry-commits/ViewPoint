...
ALTER TABLE [dbo].[bHRTC] ADD
CONSTRAINT [CK_bHRTC_CPRYN] CHECK (([CPRYN]='Y' OR [CPRYN]='N'))
ALTER TABLE [dbo].[bHRTC] ADD
CONSTRAINT [CK_bHRTC_FirstAidYN] CHECK (([FirstAidYN]='Y' OR [FirstAidYN]='N'))
ALTER TABLE [dbo].[bHRTC] ADD
CONSTRAINT [CK_bHRTC_Instructor1099YN] CHECK (([Instructor1099YN]='Y' OR [Instructor1099YN]='N'))
ALTER TABLE [dbo].[bHRTC] ADD
CONSTRAINT [CK_bHRTC_MSHAYN] CHECK (([MSHAYN]='Y' OR [MSHAYN]='N'))
ALTER TABLE [dbo].[bHRTC] ADD
CONSTRAINT [CK_bHRTC_OSHAYN] CHECK (([OSHAYN]='Y' OR [OSHAYN]='N'))
ALTER TABLE [dbo].[bHRTC] ADD
CONSTRAINT [CK_bHRTC_ReimbursedYN] CHECK (([ReimbursedYN]='Y' OR [ReimbursedYN]='N'))
ALTER TABLE [dbo].[bHRTC] ADD
CONSTRAINT [CK_bHRTC_WorkRelatedYN] CHECK (([WorkRelatedYN]='Y' OR [WorkRelatedYN]='N'))
GO
