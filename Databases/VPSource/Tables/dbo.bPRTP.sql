...
[OldRate] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPRTP_OldRate] DEFAULT ((0)),
[NewRate] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bPRTP_NewRate] DEFAULT ((0)),
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRTP] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRTP] ON [dbo].[bPRTP] ([PRCo], [Craft], [Class], [Template], [Shift]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
