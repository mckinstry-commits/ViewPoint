...
ALTER TABLE [dbo].[bEMDG] ADD
CONSTRAINT [FK_bEMDG_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
ALTER TABLE [dbo].[bEMDG] ADD
CONSTRAINT [FK_bEMDG_bEMDM_Department] FOREIGN KEY ([EMCo], [Department]) REFERENCES [dbo].[bEMDM] ([EMCo], [Department])
ALTER TABLE [dbo].[bEMDG] ADD
CONSTRAINT [FK_bEMDG_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
ALTER TABLE [dbo].[bEMDG] ADD
CONSTRAINT [FK_bEMDG_bEMCT_CostType] FOREIGN KEY ([EMGroup], [CostType]) REFERENCES [dbo].[bEMCT] ([EMGroup], [CostType])
GO
