...
CREATE UNIQUE CLUSTERED INDEX [biJCCH] ON [dbo].[bJCCH] ([JCCo], [Job], [PhaseGroup], [Phase], [CostType]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCCH] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [_dta_index_bJCCH_52_2023678257__K3_K1_K2_K4_K5_K6] ON [dbo].[bJCCH] ([PhaseGroup], [JCCo], [Job], [Phase], [CostType], [UM]) ON [PRIMARY]

ALTER TABLE [dbo].[bJCCH] WITH NOCHECK ADD
CONSTRAINT [CK_bJCCH_ActiveYN] CHECK (([ActiveYN]='Y' OR [ActiveYN]='N'))
ALTER TABLE [dbo].[bJCCH] ADD
CONSTRAINT [CK_bJCCH_ItemUnitFlag] CHECK (([ItemUnitFlag]='Y' OR [ItemUnitFlag]='N'))
ALTER TABLE [dbo].[bJCCH] ADD
CONSTRAINT [CK_bJCCH_PhaseUnitFlag] CHECK (([PhaseUnitFlag]='Y' OR [PhaseUnitFlag]='N'))
ALTER TABLE [dbo].[bJCCH] ADD
CONSTRAINT [CK_bJCCH_BuyOutYN] CHECK (([BuyOutYN]='Y' OR [BuyOutYN]='N'))
ALTER TABLE [dbo].[bJCCH] ADD
CONSTRAINT [CK_bJCCH_Plugged] CHECK (([Plugged]='Y' OR [Plugged]='N'))
GO
...
-- =============================================
CREATE TRIGGER [dbo].[trMckCTInsert] 
   ON  [dbo].[bJCCH] 
   AFTER INSERT
AS 
BEGIN
...
-- =============================================
CREATE TRIGGER [dbo].[trMckCTUpdate]
   ON  [dbo].[bJCCH] 
   AFTER UPDATE
AS 
BEGIN
...
CREATE STATISTICS [_dta_stat_2023678257_5_1_2_3] ON [dbo].[bJCCH] ([Job], [PhaseGroup], [CostType], [JCCo])
GO
...
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJCCH].[ItemUnitFlag]'
GO
EXEC sp_bindefault N'[dbo].[bdNo]', N'[dbo].[bJCCH].[ItemUnitFlag]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJCCH].[PhaseUnitFlag]'
GO
EXEC sp_bindefault N'[dbo].[bdNo]', N'[dbo].[bJCCH].[PhaseUnitFlag]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJCCH].[BuyOutYN]'
GO
EXEC sp_bindefault N'[dbo].[bdNo]', N'[dbo].[bJCCH].[BuyOutYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJCCH].[Plugged]'
GO
EXEC sp_bindefault N'[dbo].[bdNo]', N'[dbo].[bJCCH].[Plugged]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJCCH].[ActiveYN]'
GO
EXEC sp_bindefault N'[dbo].[bdYes]', N'[dbo].[bJCCH].[ActiveYN]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCH].[OrigHours]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCH].[OrigUnits]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCCH].[OrigCost]'
GO
