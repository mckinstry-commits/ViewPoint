...
ALTER TABLE [dbo].[bEMRD] ADD
CONSTRAINT [CK_bEMRD_Source] CHECK (([Source]='SM' OR [Source]='MS' OR [Source]='PR' OR [Source]='EMRev'))
ALTER TABLE [dbo].[bEMRD] ADD
CONSTRAINT [CK_bEMRD_TransType] CHECK (([TransType]='I' OR [TransType]='C' OR [TransType]='W' OR [TransType]='X' OR [TransType]='E' OR [TransType]='J'))
ALTER TABLE [dbo].[bEMRD] ADD
CONSTRAINT [FK_bEMRD_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
ALTER TABLE [dbo].[bEMRD] ADD
CONSTRAINT [FK_bEMRD_bEMCM_Category] FOREIGN KEY ([EMCo], [Category]) REFERENCES [dbo].[bEMCM] ([EMCo], [Category])
ALTER TABLE [dbo].[bEMRD] ADD
CONSTRAINT [FK_bEMRD_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
ALTER TABLE [dbo].[bEMRD] ADD
CONSTRAINT [FK_bEMRD_bEMEM_UsedOnComponent] FOREIGN KEY ([EMCo], [UsedOnComponent]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment])
ALTER TABLE [dbo].[bEMRD] ADD
CONSTRAINT [FK_bEMRD_bEMEM_UsedOnEquipment] FOREIGN KEY ([EMCo], [UsedOnEquipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment])
ALTER TABLE [dbo].[bEMRD] ADD
CONSTRAINT [FK_bEMRD_bEMWH_WorkOrder] FOREIGN KEY ([EMCo], [WorkOrder]) REFERENCES [dbo].[bEMWH] ([EMCo], [WorkOrder])
ALTER TABLE [dbo].[bEMRD] ADD
CONSTRAINT [FK_bEMRD_bEMWI_WOItem] FOREIGN KEY ([EMCo], [WorkOrder], [WOItem]) REFERENCES [dbo].[bEMWI] ([EMCo], [WorkOrder], [WOItem])
ALTER TABLE [dbo].[bEMRD] ADD
CONSTRAINT [FK_bEMRD_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
ALTER TABLE [dbo].[bEMRD] ADD
CONSTRAINT [FK_bEMRD_bEMCT_EMCostType] FOREIGN KEY ([EMGroup], [EMCostType]) REFERENCES [dbo].[bEMCT] ([EMGroup], [CostType])
ALTER TABLE [dbo].[bEMRD] ADD
CONSTRAINT [FK_bEMRD_bEMRC_RevCode] FOREIGN KEY ([EMGroup], [RevCode]) REFERENCES [dbo].[bEMRC] ([EMGroup], [RevCode])
GO
