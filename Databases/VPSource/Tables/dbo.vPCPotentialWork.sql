...
GO
ALTER TABLE [dbo].[vPCPotentialWork] ADD CONSTRAINT [CK_vPCPotentialWork_AllowForecast] CHECK (([AllowForecast]='Y' OR [AllowForecast]='N'))
GO
ALTER TABLE [dbo].[vPCPotentialWork] ADD CONSTRAINT [CK_vPCPotentialWork_Awarded] CHECK (([Awarded]='Y' OR [Awarded]='N'))
GO
