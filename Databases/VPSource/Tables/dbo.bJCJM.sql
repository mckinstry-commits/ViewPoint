...
CREATE UNIQUE CLUSTERED INDEX [biJCJM] ON [dbo].[bJCJM] ([JCCo], [Job]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCJM] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bJCJM] ADD
CONSTRAINT [CK_bJCJM_AutoAddItemYN] CHECK (([AutoAddItemYN]='Y' OR [AutoAddItemYN]='N'))
ALTER TABLE [dbo].[bJCJM] ADD
CONSTRAINT [CK_bJCJM_Certified] CHECK (([Certified]='Y' OR [Certified]='N'))
ALTER TABLE [dbo].[bJCJM] ADD
CONSTRAINT [CK_bJCJM_ClosePurgeFlag] CHECK (([ClosePurgeFlag]='Y' OR [ClosePurgeFlag]='N' OR [ClosePurgeFlag] IS NULL))
ALTER TABLE [dbo].[bJCJM] ADD
CONSTRAINT [CK_bJCJM_LockPhases] CHECK (([LockPhases]='Y' OR [LockPhases]='N'))
ALTER TABLE [dbo].[bJCJM] ADD
CONSTRAINT [CK_bJCJM_UpdateAPActualsYN] CHECK (([UpdateAPActualsYN]='Y' OR [UpdateAPActualsYN]='N'))
ALTER TABLE [dbo].[bJCJM] ADD
CONSTRAINT [CK_bJCJM_UpdateMSActualsYN] CHECK (([UpdateMSActualsYN]='Y' OR [UpdateMSActualsYN]='N'))
ALTER TABLE [dbo].[bJCJM] ADD
CONSTRAINT [CK_bJCJM_UpdatePlugs] CHECK (([UpdatePlugs]='Y' OR [UpdatePlugs]='N'))
ALTER TABLE [dbo].[bJCJM] ADD
CONSTRAINT [CK_bJCJM_WghtAvgOT] CHECK (([WghtAvgOT]='Y' OR [WghtAvgOT]='N'))
GO
