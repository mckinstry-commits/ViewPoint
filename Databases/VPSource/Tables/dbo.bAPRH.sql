...
ALTER TABLE [dbo].[bAPRH] ADD
CONSTRAINT [CK_bAPRH_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000) OR [CMAcct] IS NULL))
ALTER TABLE [dbo].[bAPRH] ADD
CONSTRAINT [CK_bAPRH_MnthlyYN] CHECK (([MnthlyYN]='Y' OR [MnthlyYN]='N'))
ALTER TABLE [dbo].[bAPRH] ADD
CONSTRAINT [CK_bAPRH_V1099YN] CHECK (([V1099YN]='Y' OR [V1099YN]='N'))
GO
