...
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_AccessibleOnly] CHECK (([AccessibleOnly]='Y' OR [AccessibleOnly]='N'))
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_ConfirmUpdate] CHECK (([ConfirmUpdate]='Y' OR [ConfirmUpdate]='N'))
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_EnterAsTab] CHECK (([EnterAsTab]='Y' OR [EnterAsTab]='N'))
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_ExtendControls] CHECK (([ExtendControls]='Y' OR [ExtendControls]='N'))
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_FormAdmin] CHECK (([FormAdmin]='Y' OR [FormAdmin]='N'))
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_HideModFolders] CHECK (([HideModFolders]='Y' OR [HideModFolders]='N'))
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_MenuAdmin] CHECK (([MenuAdmin]='Y' OR [MenuAdmin]='N'))
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_MinimizeUse] CHECK (([MinimizeUse]='Y' OR [MinimizeUse]='N'))
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_MultiFormInstance] CHECK (([MultiFormInstance]='Y' OR [MultiFormInstance]='N'))
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_RestrictedBatches] CHECK (([RestrictedBatches]='Y' OR [RestrictedBatches]='N'))
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_SavePrinterSettings] CHECK (([SavePrinterSettings]='Y' OR [SavePrinterSettings]='N'))
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_ShowRates] CHECK (([ShowRates]='Y' OR [ShowRates]='N'))
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_SmartCursor] CHECK (([SmartCursor]='Y' OR [SmartCursor]='N'))
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_ToolTipHelp] CHECK (([ToolTipHelp]='Y' OR [ToolTipHelp]='N'))
ALTER TABLE [dbo].[vDDUP] ADD
CONSTRAINT [CK_vDDUP_UseColorGrad] CHECK (([UseColorGrad]='Y' OR [UseColorGrad]='N' OR [UseColorGrad] IS NULL))
GO
...
AS 
	...
	BEGIN
		...
		IF EXISTS(
			...
			--INSERT Project Manager record from Employee table.
				...
				(JCCo, udPRCo, ProjectMgr, udEmployee, Name, Phone, MobilePhone, Email)
					SELECT e.PRCo, e.PRCo, (SELECT Max(ProjectMgr) FROM bJCMP)+ 1, e.Employee, e.FirstName + ' ' + e.LastName, e.Phone, e.CellPhone, e.Email
					FROM bPREH e
		...
		IF EXISTS(SELECT i.Employee 
			FROM INSERTED i
			WHERE i.udReviewer IS NOT NULL)
			BEGIN
			IF EXISTS(
				SELECT g.VPUserName 
				FROM vDDSU g
...
ALTER TABLE [dbo].[vDDUP] ADD CONSTRAINT [CK_vDDUP_DefaultDestType] CHECK (([DefaultDestType]='Viewpoint' OR [DefaultDestType]='EMail'))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[ShowRates]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[RestrictedBatches]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[ConfirmUpdate]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[EnterAsTab]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[ExtendControls]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[SavePrinterSettings]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[SmartCursor]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[ToolTipHelp]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[MinimizeUse]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[AccessibleOnly]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[UseColorGrad]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[MenuAdmin]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[FormAdmin]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[MultiFormInstance]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vDDUP].[HideModFolders]'
GO
