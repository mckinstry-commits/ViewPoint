...
ALTER TABLE [dbo].[vDDFS] ADD
CONSTRAINT [CK_vDDFS_RecAdd] CHECK (([RecAdd]='Y' OR [RecAdd]='N'))
ALTER TABLE [dbo].[vDDFS] ADD
CONSTRAINT [CK_vDDFS_RecDelete] CHECK (([RecDelete]='Y' OR [RecDelete]='N'))
ALTER TABLE [dbo].[vDDFS] ADD
CONSTRAINT [CK_vDDFS_RecUpdate] CHECK (([RecUpdate]='Y' OR [RecUpdate]='N'))
GO
