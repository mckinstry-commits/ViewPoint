...
CONSTRAINT [CK_bSLCO_AuditCoParams] CHECK (([AuditCoParams]='Y' OR [AuditCoParams]='N'))
ALTER TABLE [dbo].[bSLCO] ADD
CONSTRAINT [CK_bSLCO_AuditSLCompliance] CHECK (([AuditSLCompliance]='Y' OR [AuditSLCompliance]='N'))
ALTER TABLE [dbo].[bSLCO] ADD
CONSTRAINT [CK_bSLCO_AuditSLs] CHECK (([AuditSLs]='Y' OR [AuditSLs]='N'))
ALTER TABLE [dbo].[bSLCO] ADD
CONSTRAINT [CK_bSLCO_CmtdDetailToJC] CHECK (([CmtdDetailToJC]='Y' OR [CmtdDetailToJC]='N'))
GO
