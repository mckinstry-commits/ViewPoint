...
ALTER TABLE [dbo].[bDDUD] ADD
CONSTRAINT [CK_bDDUD_BidtekDefaultValue] CHECK (([BidtekDefaultValue]='Y' OR [BidtekDefaultValue]='N' OR [BidtekDefaultValue] IS NULL))
ALTER TABLE [dbo].[bDDUD] ADD
CONSTRAINT [CK_bDDUD_RequiredValue] CHECK (([RequiredValue]='Y' OR [RequiredValue]='N' OR [RequiredValue] IS NULL))
ALTER TABLE [dbo].[bDDUD] ADD
CONSTRAINT [CK_bDDUD_UpdateKeyYN] CHECK (([UpdateKeyYN]='Y' OR [UpdateKeyYN]='N'))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bDDUD].[BidtekDefaultValue]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bDDUD].[RequiredValue]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bDDUD].[UpdateKeyYN]'
GO
