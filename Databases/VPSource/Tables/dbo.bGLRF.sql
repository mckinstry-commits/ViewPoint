...
CREATE UNIQUE CLUSTERED INDEX [biGLRF] ON [dbo].[bGLRF] ([GLCo], [Mth], [Jrnl], [GLRef]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bGLRF] ADD CONSTRAINT [PK_bGLRF] PRIMARY KEY NONCLUSTERED  ([KeyID]) WITH (FILLFACTOR=100) ON [PRIMARY]
...
ALTER TABLE [dbo].[bGLRF] ADD
CONSTRAINT [CK_bGLRF_Adjust] CHECK (([Adjust]='Y' OR [Adjust]='N' OR [Adjust] IS NULL))
GO
