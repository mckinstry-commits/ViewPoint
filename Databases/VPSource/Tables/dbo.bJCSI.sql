...
[UM] [dbo].[bUM] NOT NULL,
[MUM] [dbo].[bUM] NULL,
[UnitPrice] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bJCSI_UnitPrice] DEFAULT ((0)),
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCSI] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biJCIC] ON [dbo].[bJCSI] ([SIRegion], [SICode]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
