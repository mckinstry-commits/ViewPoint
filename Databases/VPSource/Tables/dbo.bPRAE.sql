...
ALTER TABLE [dbo].[bPRAE] ADD
CONSTRAINT [CK_bPRAE_OvrStdLimitYN] CHECK (([OvrStdLimitYN]='Y' OR [OvrStdLimitYN]='N'))
ALTER TABLE [dbo].[bPRAE] ADD
CONSTRAINT [CK_bPRAE_StdHours] CHECK (([StdHours]='Y' OR [StdHours]='N'))
