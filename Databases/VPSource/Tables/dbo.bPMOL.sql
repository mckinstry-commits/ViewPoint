...
CONSTRAINT [CK_bPMOL_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M'))
ALTER TABLE [dbo].[bPMOL] ADD
CONSTRAINT [CK_bPMOL_SendYN] CHECK (([SendYN]='Y' OR [SendYN]='N'))
ALTER TABLE [dbo].[bPMOL] WITH NOCHECK ADD
CONSTRAINT [CK_bPMOL_POSL] CHECK ((NOT ([PO] IS NOT NULL AND [Subcontract] IS NOT NULL)))
GO
