...
CREATE UNIQUE CLUSTERED INDEX [biARTL] ON [dbo].[bARTL] ([ARCo], [Mth], [ARTrans], [ARLine]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biARTLApplied] ON [dbo].[bARTL] ([ARCo], [ApplyMth], [ApplyTrans], [ApplyLine], [Mth], [ARTrans], [ARLine]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biARTLContract] ON [dbo].[bARTL] ([JCCo], [Contract], [Item]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bARTL] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [iARTLudARTOPDID] ON [dbo].[bARTL] ([udARTOPDID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bARTL] ADD
CONSTRAINT [CK_bARTL_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
ALTER TABLE [dbo].[bARTL] ADD
CONSTRAINT [CK_bARTL_PurgeFlag] CHECK (([PurgeFlag]='Y' OR [PurgeFlag]='N'))
GO
...
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bARTL].[Amount]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bARTL].[TaxBasis]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bARTL].[TaxAmount]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bARTL].[Retainage]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bARTL].[DiscOffered]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bARTL].[TaxDisc]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bARTL].[DiscTaken]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bARTL].[UnitPrice]'
GO
EXEC sp_bindrule N'[dbo].[brECM]', N'[dbo].[bARTL].[ECM]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bARTL].[PurgeFlag]'
GO
