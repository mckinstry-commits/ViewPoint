...
CREATE UNIQUE CLUSTERED INDEX [biGLBD] ON [dbo].[bGLBD] ([GLCo], [GLAcct], [BudgetCode], [Mth]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biGLBD2] ON [dbo].[bGLBD] ([GLCo], [Mth], [BudgetCode], [GLAcct]) INCLUDE ([BudgetAmt]) WITH (FILLFACTOR=90) ON [PRIMARY]
