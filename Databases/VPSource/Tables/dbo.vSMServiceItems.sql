...
ALTER TABLE [dbo].[vSMServiceItems] WITH NOCHECK ADD
CONSTRAINT [FK_vSMServiceItems_vSMServiceSite] FOREIGN KEY ([SMCo], [ServiceSite]) REFERENCES [dbo].[vSMServiceSite] ([SMCo], [ServiceSite])
GO
