...
ALTER TABLE [dbo].[bHRRM] ADD
CONSTRAINT [CK_bHRRM_ActiveYN] CHECK (([ActiveYN]='Y' OR [ActiveYN]='N'))
ALTER TABLE [dbo].[bHRRM] ADD
CONSTRAINT [CK_bHRRM_DisabledVetYN] CHECK (([DisabledVetYN]='Y' OR [DisabledVetYN]='N' OR [DisabledVetYN] IS NULL))
ALTER TABLE [dbo].[bHRRM] ADD
CONSTRAINT [CK_bHRRM_DriveCoVehiclesYN] CHECK (([DriveCoVehiclesYN]='Y' OR [DriveCoVehiclesYN]='N'))
ALTER TABLE [dbo].[bHRRM] ADD
CONSTRAINT [CK_bHRRM_ExistsInPR] CHECK (([ExistsInPR]='Y' OR [ExistsInPR]='N'))
ALTER TABLE [dbo].[bHRRM] ADD
CONSTRAINT [CK_bHRRM_HandicapYN] CHECK (([HandicapYN]='Y' OR [HandicapYN]='N'))
ALTER TABLE [dbo].[bHRRM] ADD
CONSTRAINT [CK_bHRRM_NoContactEmplYN] CHECK (([NoContactEmplYN]='Y' OR [NoContactEmplYN]='N'))
ALTER TABLE [dbo].[bHRRM] ADD
CONSTRAINT [CK_bHRRM_NoRehireYN] CHECK (([NoRehireYN]='Y' OR [NoRehireYN]='N'))
ALTER TABLE [dbo].[bHRRM] ADD
CONSTRAINT [CK_bHRRM_OtherVetYN] CHECK (([OtherVetYN]='Y' OR [OtherVetYN]='N' OR [OtherVetYN] IS NULL))
ALTER TABLE [dbo].[bHRRM] ADD
CONSTRAINT [CK_bHRRM_PassPort] CHECK (([PassPort]='Y' OR [PassPort]='N'))
ALTER TABLE [dbo].[bHRRM] ADD
CONSTRAINT [CK_bHRRM_PhysicalYN] CHECK (([PhysicalYN]='Y' OR [PhysicalYN]='N'))
ALTER TABLE [dbo].[bHRRM] ADD
CONSTRAINT [CK_bHRRM_RelativesYN] CHECK (([RelativesYN]='Y' OR [RelativesYN]='N'))
ALTER TABLE [dbo].[bHRRM] ADD
CONSTRAINT [CK_bHRRM_TempWorker] CHECK (([TempWorker]='Y' OR [TempWorker]='N'))
ALTER TABLE [dbo].[bHRRM] ADD
CONSTRAINT [CK_bHRRM_VietnamVetYN] CHECK (([VietnamVetYN]='Y' OR [VietnamVetYN]='N' OR [VietnamVetYN] IS NULL))
ALTER TABLE [dbo].[bHRRM] ADD
CONSTRAINT [CK_bHRRM_W4CompleteYN] CHECK (([W4CompleteYN]='Y' OR [W4CompleteYN]='N'))
GO
