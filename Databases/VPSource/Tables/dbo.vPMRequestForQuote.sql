...
[DocType] [dbo].[bDocType] NOT NULL CONSTRAINT [DF_vPMRequestForQuote_DocType] DEFAULT ('REQQUOTE'),
...
GO
ALTER TABLE [dbo].[vPMRequestForQuote] ADD CONSTRAINT [FK_vPMRequestForQuote_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
ALTER TABLE [dbo].[vPMRequestForQuote] ADD CONSTRAINT [FK_vPMRequestForQuote_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
ALTER TABLE [dbo].[vPMRequestForQuote] ADD CONSTRAINT [FK_vPMRequestForQuote_bPMSC] FOREIGN KEY ([Status]) REFERENCES [dbo].[bPMSC] ([Status])
GO
