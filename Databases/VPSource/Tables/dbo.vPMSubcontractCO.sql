...
[DocType] [dbo].[bDocType] NOT NULL CONSTRAINT [DF_vPMSubcontractCO_DocType] DEFAULT ('SUBCO')
...
ALTER TABLE [dbo].[vPMSubcontractCO] ADD
CONSTRAINT [FK_vPMSubcontractCO_bPMDT] FOREIGN KEY ([DocType]) REFERENCES [dbo].[bPMDT] ([DocType])
ALTER TABLE [dbo].[vPMSubcontractCO] ADD
