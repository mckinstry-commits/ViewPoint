...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSDX] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biMSDX] ON [dbo].[bMSDX] ([MSCo], [Quote], [LocGroup], [Loc], [MatlGroup], [Category], [Material], [UM]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biMSDXSeq] ON [dbo].[bMSDX] ([MSCo], [Quote], [Seq]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
