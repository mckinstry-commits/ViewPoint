...
ALTER TABLE [dbo].[bEMSL] ADD
CONSTRAINT [FK_bEMSL_bEMSH_EquipLinkedMaintGrp] FOREIGN KEY ([EMCo], [Equipment], [LinkedMaintGrp]) REFERENCES [dbo].[bEMSH] ([EMCo], [Equipment], [StdMaintGroup])
ALTER TABLE [dbo].[bEMSL] ADD
CONSTRAINT [FK_bEMSL_bEMSH_EquipStdMaintGroup] FOREIGN KEY ([EMCo], [Equipment], [StdMaintGroup]) REFERENCES [dbo].[bEMSH] ([EMCo], [Equipment], [StdMaintGroup]) ON DELETE CASCADE
ALTER TABLE [dbo].[bEMSL] ADD
CONSTRAINT [FK_bEMSL_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
