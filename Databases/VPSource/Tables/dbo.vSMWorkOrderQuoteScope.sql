...
GO
ALTER TABLE [dbo].[vSMWorkOrderQuoteScope] ADD CONSTRAINT [FK_vSMWorkOrderQuoteScope_vSMCallType] FOREIGN KEY ([SMCo], [CallType]) REFERENCES [dbo].[vSMCallType] ([SMCo], [CallType])
GO
ALTER TABLE [dbo].[vSMWorkOrderQuoteScope] ADD CONSTRAINT [FK_vSMWorkOrderQuoteScope_vSMWorkOrderQuote] FOREIGN KEY ([SMCo], [WorkOrderQuote]) REFERENCES [dbo].[vSMWorkOrderQuote] ([SMCo], [WorkOrderQuote])
GO
ALTER TABLE [dbo].[vSMWorkOrderQuoteScope] ADD CONSTRAINT [FK_vSMWorkOrderQuoteScope_vSMWorkScope] FOREIGN KEY ([SMCo], [WorkScope]) REFERENCES [dbo].[vSMWorkScope] ([SMCo], [WorkScope])
GO
