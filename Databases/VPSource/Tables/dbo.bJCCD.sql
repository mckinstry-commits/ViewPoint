...
[ReversalStatus] [tinyint] NOT NULL CONSTRAINT [DF_bJCCD_ReversalStatus] DEFAULT ((0)),
[UM] [dbo].[bUM] NULL,
[ActualUnitCost] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bJCCD_ActualUnitCost] DEFAULT ((0)),
[PerECM] [dbo].[bECM] NULL,
[ActualHours] [dbo].[bHrs] NOT NULL CONSTRAINT [DF_bJCCD_ActualHours] DEFAULT ((0)),
[ActualUnits] [dbo].[bUnits] NOT NULL CONSTRAINT [DF_bJCCD_ActualUnits] DEFAULT ((0)),
[ActualCost] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bJCCD_ActualCost] DEFAULT ((0)),
[ProgressCmplt] [dbo].[bPct] NOT NULL CONSTRAINT [DF_bJCCD_ProgressCmplt] DEFAULT ((0)),
[EstHours] [dbo].[bHrs] NOT NULL CONSTRAINT [DF_bJCCD_EstHours] DEFAULT ((0)),
[EstUnits] [dbo].[bUnits] NOT NULL CONSTRAINT [DF_bJCCD_EstUnits] DEFAULT ((0)),
[EstCost] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bJCCD_EstCost] DEFAULT ((0)),
[ProjHours] [dbo].[bHrs] NOT NULL CONSTRAINT [DF_bJCCD_ProjHours] DEFAULT ((0)),
[ProjUnits] [dbo].[bUnits] NOT NULL CONSTRAINT [DF_bJCCD_ProjUnits] DEFAULT ((0)),
[ProjCost] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bJCCD_ProjCost] DEFAULT ((0)),
[ForecastHours] [dbo].[bHrs] NOT NULL CONSTRAINT [DF_bJCCD_ForecastHours] DEFAULT ((0)),
[ForecastUnits] [dbo].[bUnits] NOT NULL CONSTRAINT [DF_bJCCD_ForecastUnits] DEFAULT ((0)),
[ForecastCost] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bJCCD_ForecastCost] DEFAULT ((0)),
[PostedUM] [dbo].[bUM] NULL,
[PostedUnits] [dbo].[bUnits] NOT NULL CONSTRAINT [DF_bJCCD_PostedUnits] DEFAULT ((0)),
[PostedUnitCost] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bJCCD_PostedUnitCost] DEFAULT ((0)),
[PostedECM] [dbo].[bECM] NULL,
[PostTotCmUnits] [dbo].[bUnits] NOT NULL CONSTRAINT [DF_bJCCD_PostTotCmUnits] DEFAULT ((0)),
[PostRemCmUnits] [dbo].[bUnits] NOT NULL CONSTRAINT [DF_bJCCD_PostRemCmUnits] DEFAULT ((0)),
[TotalCmtdUnits] [dbo].[bUnits] NOT NULL CONSTRAINT [DF_bJCCD_TotalCmtdUnits] DEFAULT ((0)),
[TotalCmtdCost] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bJCCD_TotalCmtdCost] DEFAULT ((0)),
[RemainCmtdUnits] [dbo].[bUnits] NOT NULL CONSTRAINT [DF_bJCCD_RemainCmtdUnits] DEFAULT ((0)),
[RemainCmtdCost] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bJCCD_RemainCmtdCost] DEFAULT ((0)),
[DeleteFlag] [dbo].[bYN] NOT NULL CONSTRAINT [DF_bJCCD_DeleteFlag] DEFAULT ('N'),
...
[Loc] [dbo].[bLoc] NULL,
[INStdUnitCost] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bJCCD_INStdUnitCost] DEFAULT ((0)),
...
[TaxBasis] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bJCCD_TaxBasis] DEFAULT ((0)),
[TaxAmt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bJCCD_TaxAmt] DEFAULT ((0)),
...
CREATE UNIQUE CLUSTERED INDEX [biJCCD] ON [dbo].[bJCCD] ([JCCo], [Job], [Phase], [CostType], [Mth], [CostTrans]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biJCCDTrans] ON [dbo].[bJCCD] ([CostTrans], [Mth], [JCCo]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCCD] ([KeyID]) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [IX_bJCCD_MthJCCoTransSource] ON [dbo].[bJCCD] ([Mth], [JCCo], [CostTrans], [Source]) INCLUDE ([UniqueAttchID]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biJCCDUniqueAttchID] ON [dbo].[bJCCD] ([UniqueAttchID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bJCCD] ADD
CONSTRAINT [CK_bJCCD_DeleteFlag] CHECK (([DeleteFlag]='Y' OR [DeleteFlag]='N'))
ALTER TABLE [dbo].[bJCCD] ADD
CONSTRAINT [CK_bJCCD_INStdECM] CHECK (([INStdECM]='E' OR [INStdECM]='C' OR [INStdECM]='M' OR [INStdECM] IS NULL))
ALTER TABLE [dbo].[bJCCD] ADD
CONSTRAINT [CK_bJCCD_PerECM] CHECK (([PerECM]='E' OR [PerECM]='C' OR [PerECM]='M' OR [PerECM] IS NULL))
ALTER TABLE [dbo].[bJCCD] ADD
CONSTRAINT [CK_bJCCD_PostedECM] CHECK (([PostedECM]='E' OR [PostedECM]='C' OR [PostedECM]='M' OR [PostedECM] IS NULL))
GO
