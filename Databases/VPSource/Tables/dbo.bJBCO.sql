...
ALTER TABLE [dbo].[bJBCO] ADD
CONSTRAINT [CK_bJBCO_AuditBills] CHECK (([AuditBills]='Y' OR [AuditBills]='N'))
ALTER TABLE [dbo].[bJBCO] ADD
CONSTRAINT [CK_bJBCO_AuditCo] CHECK (([AuditCo]='Y' OR [AuditCo]='N'))
ALTER TABLE [dbo].[bJBCO] ADD
CONSTRAINT [CK_bJBCO_AuditTemplate] CHECK (([AuditTemplate]='Y' OR [AuditTemplate]='N'))
ALTER TABLE [dbo].[bJBCO] ADD
CONSTRAINT [CK_bJBCO_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
ALTER TABLE [dbo].[bJBCO] ADD
CONSTRAINT [CK_bJBCO_AutoSeqInvYN] CHECK (([AutoSeqInvYN]='Y' OR [AutoSeqInvYN]='N'))
ALTER TABLE [dbo].[bJBCO] ADD
CONSTRAINT [CK_bJBCO_ChgPrevProg] CHECK (([ChgPrevProg]='Y' OR [ChgPrevProg]='N'))
ALTER TABLE [dbo].[bJBCO] ADD
CONSTRAINT [CK_bJBCO_EditProgOnBothYN] CHECK (([EditProgOnBothYN]='Y' OR [EditProgOnBothYN]='N'))
ALTER TABLE [dbo].[bJBCO] ADD
CONSTRAINT [CK_bJBCO_PrevUpdateYN] CHECK (([PrevUpdateYN]='Y' OR [PrevUpdateYN]='N'))
ALTER TABLE [dbo].[bJBCO] ADD
CONSTRAINT [CK_bJBCO_UndefinedAsBilledYN] CHECK (([UndefinedAsBilledYN]='Y' OR [UndefinedAsBilledYN]='N'))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBCO].[AutoSeqInvYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBCO].[ChgPrevProg]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBCO].[AuditCo]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBCO].[AuditBills]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBCO].[UndefinedAsBilledYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBCO].[EditProgOnBothYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBCO].[AuditTemplate]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBCO].[PrevUpdateYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBCO].[AuditYN]'
GO
