...
ALTER TABLE [dbo].[bEMDB] ADD
CONSTRAINT [FK_bEMDB_bEMDM_Department] FOREIGN KEY ([EMCo], [Department]) REFERENCES [dbo].[bEMDM] ([EMCo], [Department])
ALTER TABLE [dbo].[bEMDB] ADD
CONSTRAINT [FK_bEMDB_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
ALTER TABLE [dbo].[bEMDB] ADD
CONSTRAINT [FK_bEMDB_bEMRT_RevBdownCode] FOREIGN KEY ([EMGroup], [RevBdownCode]) REFERENCES [dbo].[bEMRT] ([EMGroup], [RevBdownCode])
GO
