...
CREATE UNIQUE CLUSTERED INDEX [biJCIP] ON [dbo].[bJCIP] ([JCCo], [Contract], [Item], [Mth]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bJCIP] ADD
CONSTRAINT [CK_bJCIP_ProjPlug] CHECK (([ProjPlug]='Y' OR [ProjPlug]='N'))
GO
