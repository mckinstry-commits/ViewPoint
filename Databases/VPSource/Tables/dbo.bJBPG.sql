...
GO
CREATE UNIQUE CLUSTERED INDEX [biJBPG] ON [dbo].[bJBPG] ([JBCo], [ProcessGroup]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBPG] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
