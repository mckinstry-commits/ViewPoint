...
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_AdjstGLLvl] CHECK (([AdjstGLLvl]=(2) OR [AdjstGLLvl]=(1) OR [AdjstGLLvl]=(0) OR [AdjstGLLvl] IS NULL))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_AllSMG] CHECK (([AllSMG]='N' OR [AllSMG]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_AttachBatchReportsYN] CHECK (([AttachBatchReportsYN]='N' OR [AttachBatchReportsYN]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_AuditAsset] CHECK (([AuditAsset]='N' OR [AuditAsset]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_AuditCompXfer] CHECK (([AuditCompXfer]='N' OR [AuditCompXfer]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_AuditCompany] CHECK (([AuditCompany]='N' OR [AuditCompany]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_AuditDepartmentGL] CHECK (([AuditDepartmentGL]='N' OR [AuditDepartmentGL]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_AuditEquipment] CHECK (([AuditEquipment]='N' OR [AuditEquipment]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_AuditLocXfer] CHECK (([AuditLocXfer]='N' OR [AuditLocXfer]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_AuditRevenueRateCateg] CHECK (([AuditRevenueRateCateg]='N' OR [AuditRevenueRateCateg]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_AuditRevenueRateEquip] CHECK (([AuditRevenueRateEquip]='N' OR [AuditRevenueRateEquip]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_AuditWarrantys] CHECK (([AuditWarrantys]='N' OR [AuditWarrantys]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_CompPostCosts] CHECK (([CompPostCosts]='N' OR [CompPostCosts]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_DeprCalcReqd] CHECK (([DeprCalcReqd]='N' OR [DeprCalcReqd]='A' OR [DeprCalcReqd]='M'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_GLOverride] CHECK (([GLOverride]='N' OR [GLOverride]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_LaborCostCodeChg] CHECK (([LaborCostCodeChg]='N' OR [LaborCostCodeChg]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_MatlGLLvl] CHECK (([MatlGLLvl]=(2) OR [MatlGLLvl]=(1) OR [MatlGLLvl]=(0) OR [MatlGLLvl] IS NULL))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_MatlLastUsedYN] CHECK (([MatlLastUsedYN]='N' OR [MatlLastUsedYN]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_MatlTax] CHECK (([MatlTax]='N' OR [MatlTax]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_MatlValid] CHECK (([MatlValid]='N' OR [MatlValid]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_ShowAllWO] CHECK (([ShowAllWO]='N' OR [ShowAllWO]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_UseGLLvl] CHECK (([UseGLLvl]=(2) OR [UseGLLvl]=(1) OR [UseGLLvl]=(0) OR [UseGLLvl] IS NULL))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_UseRateOride] CHECK (([UseRateOride]='N' OR [UseRateOride]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_WOAutoSeq] CHECK (([WOAutoSeq]='N' OR [WOAutoSeq]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_WOCostCodeChg] CHECK (([WOCostCodeChg]='N' OR [WOCostCodeChg]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [CK_bEMCO_WOPostFinal] CHECK (([WOPostFinal]='N' OR [WOPostFinal]='Y'))
ALTER TABLE [dbo].[bEMCO] ADD
CONSTRAINT [FK_bEMCO_bHQCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bHQCO] ([HQCo])
GO
