...
ALTER TABLE [dbo].[bAPPB] ADD
CONSTRAINT [CK_bAPPB_Overflow] CHECK (([Overflow]='Y' OR [Overflow]='N'))
ALTER TABLE [dbo].[bAPPB] ADD
CONSTRAINT [CK_bAPPB_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000)))
ALTER TABLE [dbo].[bAPPB] ADD
CONSTRAINT [CK_bAPPB_PayOverrideYN] CHECK (([PayOverrideYN]='Y' OR [PayOverrideYN]='N'))
ALTER TABLE [dbo].[bAPPB] ADD
CONSTRAINT [CK_bAPPB_ReuseYN] CHECK (([ReuseYN]='Y' OR [ReuseYN]='N' OR [ReuseYN] IS NULL))
ALTER TABLE [dbo].[bAPPB] ADD
CONSTRAINT [CK_bAPPB_SeparatePayYN] CHECK (([SeparatePayYN]='Y' OR [SeparatePayYN]='N'))
ALTER TABLE [dbo].[bAPPB] ADD
CONSTRAINT [CK_bAPPB_VoidYN] CHECK (([VoidYN]='Y' OR [VoidYN]='N'))
GO
