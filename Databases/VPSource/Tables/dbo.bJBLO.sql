...
ALTER TABLE [dbo].[bJBLO] ADD
CONSTRAINT [CK_bJBLO_RestrictByClass] CHECK (([RestrictByClass]='Y' OR [RestrictByClass]='N'))
ALTER TABLE [dbo].[bJBLO] ADD
CONSTRAINT [CK_bJBLO_RestrictByCraft] CHECK (([RestrictByCraft]='Y' OR [RestrictByCraft]='N'))
ALTER TABLE [dbo].[bJBLO] ADD
CONSTRAINT [CK_bJBLO_RestrictByEarn] CHECK (([RestrictByEarn]='Y' OR [RestrictByEarn]='N'))
ALTER TABLE [dbo].[bJBLO] ADD
CONSTRAINT [CK_bJBLO_RestrictByEmployee] CHECK (([RestrictByEmployee]='Y' OR [RestrictByEmployee]='N'))
ALTER TABLE [dbo].[bJBLO] ADD
CONSTRAINT [CK_bJBLO_RestrictByFactor] CHECK (([RestrictByFactor]='Y' OR [RestrictByFactor]='N'))
ALTER TABLE [dbo].[bJBLO] ADD
CONSTRAINT [CK_bJBLO_RestrictByShift] CHECK (([RestrictByShift]='Y' OR [RestrictByShift]='N'))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBLO].[RestrictByEmployee]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBLO].[RestrictByClass]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBLO].[RestrictByCraft]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBLO].[RestrictByEarn]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBLO].[RestrictByFactor]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBLO].[RestrictByShift]'
GO
