...
ALTER TABLE [dbo].[bJBIT] ADD
CONSTRAINT [CK_bJBIT_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
ALTER TABLE [dbo].[bJBIT] ADD
CONSTRAINT [CK_bJBIT_ChangedYN] CHECK (([ChangedYN]='Y' OR [ChangedYN]='N'))
ALTER TABLE [dbo].[bJBIT] ADD
CONSTRAINT [CK_bJBIT_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
GO
