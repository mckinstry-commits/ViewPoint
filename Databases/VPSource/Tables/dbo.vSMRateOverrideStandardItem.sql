...
ALTER TABLE [dbo].[vSMRateOverrideStandardItem] ADD 
CONSTRAINT [PK_vSMRateOverrideStandardItem] PRIMARY KEY CLUSTERED  ([SMRateOverrideStandardItemID]) ON [PRIMARY]
GO
...
ALTER TABLE [dbo].[vSMRateOverrideStandardItem] ADD
CONSTRAINT [FK_vSMRateOverrideStandardItem_vSMEntity] FOREIGN KEY ([SMCo], [EntitySeq]) REFERENCES [dbo].[vSMEntity] ([SMCo], [EntitySeq]) ON DELETE CASCADE
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
