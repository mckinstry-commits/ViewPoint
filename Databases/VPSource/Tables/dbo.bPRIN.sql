...
ALTER TABLE [dbo].[bPRIN] ADD
CONSTRAINT [CK_bPRIN_ApplyLimit] CHECK (([ApplyLimit]='Y' OR [ApplyLimit]='N'))
ALTER TABLE [dbo].[bPRIN] ADD
CONSTRAINT [CK_bPRIN_UseThreshold] CHECK (([UseThreshold]='Y' OR [UseThreshold]='N'))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bPRIN].[ApplyLimit]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bPRIN].[UseThreshold]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bPRIN].[ThresholdRate]'
GO
