...
ALTER TABLE [dbo].[bHQMT] ADD
CONSTRAINT [CK_bHQMT_Active] CHECK (([Active]='Y' OR [Active]='N'))
ALTER TABLE [dbo].[bHQMT] ADD
CONSTRAINT [CK_bHQMT_CostECM] CHECK (([CostECM]='E' OR [CostECM]='C' OR [CostECM]='M'))
ALTER TABLE [dbo].[bHQMT] ADD
CONSTRAINT [CK_bHQMT_PriceECM] CHECK (([PriceECM]='E' OR [PriceECM]='C' OR [PriceECM]='M'))
ALTER TABLE [dbo].[bHQMT] ADD
CONSTRAINT [CK_bHQMT_Stocked] CHECK (([Stocked]='Y' OR [Stocked]='N'))
ALTER TABLE [dbo].[bHQMT] ADD
CONSTRAINT [CK_bHQMT_Taxable] CHECK (([Taxable]='Y' OR [Taxable]='N'))
GO
