...
ALTER TABLE [dbo].[bJBER] ADD
CONSTRAINT [CK_bJBER_RestrictByEquip] CHECK (([RestrictByEquip]='Y' OR [RestrictByEquip]='N'))
ALTER TABLE [dbo].[bJBER] ADD
CONSTRAINT [CK_bJBER_RestrictByRevCode] CHECK (([RestrictByRevCode]='Y' OR [RestrictByRevCode]='N'))
GO
