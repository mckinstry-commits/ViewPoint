...
ALTER TABLE [dbo].[bAPPH] ADD
CONSTRAINT [CK_bAPPH_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000)))
ALTER TABLE [dbo].[bAPPH] ADD
CONSTRAINT [CK_bAPPH_PurgeYN] CHECK (([PurgeYN]='Y' OR [PurgeYN]='N'))
ALTER TABLE [dbo].[bAPPH] ADD
CONSTRAINT [CK_bAPPH_VoidYN] CHECK (([VoidYN]='Y' OR [VoidYN]='N'))
GO
