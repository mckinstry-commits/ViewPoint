...
[Amount] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bARBA_Amount] DEFAULT ((0)),
[Job] [dbo].[bJob] NULL,
[Equipment] [dbo].[bEquip] NULL
) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biARBA] ON [dbo].[bARBA] ([Co], [Mth], [BatchId], [GLCo], [GLAcct], [BatchSeq], [ARLine], [OldNew]) WITH (FILLFACTOR=90) ON [PRIMARY]
GO
