...
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_ProjPercent] CHECK (([ProjPercent]='Y' OR [ProjPercent]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_ProjOverUnder] CHECK (([ProjOverUnder]='Y' OR [ProjOverUnder]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_ProjRemain] CHECK (([ProjRemain]='Y' OR [ProjRemain]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_AddJCSICode] CHECK (([AddJCSICode]='Y' OR [AddJCSICode]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_AuditChngOrders] CHECK (([AuditChngOrders]='Y' OR [AuditChngOrders]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_AuditCoParams] CHECK (([AuditCoParams]='Y' OR [AuditCoParams]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_AuditContracts] CHECK (([AuditContracts]='Y' OR [AuditContracts]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_AuditDepts] CHECK (([AuditDepts]='Y' OR [AuditDepts]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_AuditJobs] CHECK (([AuditJobs]='Y' OR [AuditJobs]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_DefaultBillType] CHECK (([DefaultBillType]='T' OR [DefaultBillType]='P' OR [DefaultBillType]='B' OR [DefaultBillType]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_GLCostOveride] CHECK (([GLCostOveride]='Y' OR [GLCostOveride]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_GLRevOveride] CHECK (([GLRevOveride]='Y' OR [GLRevOveride]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_PostClosedJobs] CHECK (([PostClosedJobs]='Y' OR [PostClosedJobs]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_PostCrewProgress] CHECK (([PostCrewProgress]='Y' OR [PostCrewProgress]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_ProjInactivePhases] CHECK (([ProjInactivePhases]='Y' OR [ProjInactivePhases]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_UseJobBilling] CHECK (([UseJobBilling]='Y' OR [UseJobBilling]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_UseTaxOnMaterial] CHECK (([UseTaxOnMaterial]='Y' OR [UseTaxOnMaterial]='N'))
ALTER TABLE [dbo].[bJCCO] ADD
CONSTRAINT [CK_bJCCO_ValidateMaterial] CHECK (([ValidateMaterial]='Y' OR [ValidateMaterial]='N'))
GO
