...
CONSTRAINT [biJCID] PRIMARY KEY CLUSTERED  ([JCCo], [Mth], [ItemTrans]) ON [PRIMARY]
CREATE NONCLUSTERED INDEX [IX_bJCID_CoContractItemTransMth] ON [dbo].[bJCID] ([JCCo], [Contract], [Item], [TransSource], [Mth]) WITH (FILLFACTOR=90) ON [PRIMARY]
