...
[UM] [dbo].[bUM] NOT NULL,
[UnitCost] [dbo].[bUnitCost] NOT NULL CONSTRAINT [DF_bJCOD_UnitCost] DEFAULT ((0)),
[EstHours] [dbo].[bHrs] NOT NULL CONSTRAINT [DF_bJCOD_EstHours] DEFAULT ((0)),
[EstUnits] [dbo].[bUnits] NOT NULL CONSTRAINT [DF_bJCOD_EstUnits] DEFAULT ((0)),
[EstCost] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bJCOD_EstCost] DEFAULT ((0)),
...
CREATE UNIQUE CLUSTERED INDEX [biJCOD] ON [dbo].[bJCOD] ([JCCo], [Job], [ACO], [ACOItem], [PhaseGroup], [Phase], [CostType]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCOD] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
