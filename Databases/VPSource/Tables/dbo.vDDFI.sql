...
ALTER TABLE [dbo].[vDDFI] ADD
CONSTRAINT [CK_vDDFI_ActiveLookup] CHECK (([ActiveLookup]='Y' OR [ActiveLookup]='N' OR [ActiveLookup] IS NULL))
ALTER TABLE [dbo].[vDDFI] ADD
CONSTRAINT [CK_vDDFI_Computed] CHECK (([Computed]='Y' OR [Computed]='N'))
ALTER TABLE [dbo].[vDDFI] ADD
CONSTRAINT [CK_vDDFI_Req] CHECK (([Req]='Y' OR [Req]='N'))
ALTER TABLE [dbo].[vDDFI] ADD
CONSTRAINT [CK_vDDFI_ShowForm] CHECK (([ShowForm]='Y' OR [ShowForm]='N'))
ALTER TABLE [dbo].[vDDFI] ADD
CONSTRAINT [CK_vDDFI_ShowGrid] CHECK (([ShowGrid]='Y' OR [ShowGrid]='N'))
GO
