...
ALTER TABLE [dbo].[vDDFIc] ADD
CONSTRAINT [CK_vDDFIc_ActiveLookup] CHECK (([ActiveLookup]='Y' OR [ActiveLookup]='N' OR [ActiveLookup] IS NULL))
ALTER TABLE [dbo].[vDDFIc] ADD
CONSTRAINT [CK_vDDFIc_Computed] CHECK (([Computed]='Y' OR [Computed]='N' OR [Computed] IS NULL))
ALTER TABLE [dbo].[vDDFIc] ADD
CONSTRAINT [CK_vDDFIc_InputSkip] CHECK (([InputSkip]='Y' OR [InputSkip]='N' OR [InputSkip] IS NULL))
ALTER TABLE [dbo].[vDDFIc] ADD
CONSTRAINT [CK_vDDFIc_Req] CHECK (([Req]='Y' OR [Req]='N' OR [Req] IS NULL))
ALTER TABLE [dbo].[vDDFIc] ADD
CONSTRAINT [CK_vDDFIc_ShowForm] CHECK (([ShowForm]='Y' OR [ShowForm]='N' OR [ShowForm] IS NULL))
ALTER TABLE [dbo].[vDDFIc] ADD
CONSTRAINT [CK_vDDFIc_ShowGrid] CHECK (([ShowGrid]='Y' OR [ShowGrid]='N' OR [ShowGrid] IS NULL))
GO
