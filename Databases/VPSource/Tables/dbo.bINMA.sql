...
ALTER TABLE [dbo].[bINMA] ADD
CONSTRAINT [CK_bINMA_BeginAvgECM] CHECK (([BeginAvgECM]='M' OR [BeginAvgECM]='C' OR [BeginAvgECM]='E'))
ALTER TABLE [dbo].[bINMA] ADD
CONSTRAINT [CK_bINMA_BeginLastECM] CHECK (([BeginLastECM]='M' OR [BeginLastECM]='C' OR [BeginLastECM]='E'))
ALTER TABLE [dbo].[bINMA] ADD
CONSTRAINT [CK_bINMA_BeginStdECM] CHECK (([BeginStdECM]='M' OR [BeginStdECM]='C' OR [BeginStdECM]='E'))
ALTER TABLE [dbo].[bINMA] ADD
CONSTRAINT [CK_bINMA_EndAvgECM] CHECK (([EndAvgECM]='M' OR [EndAvgECM]='C' OR [EndAvgECM]='E'))
ALTER TABLE [dbo].[bINMA] ADD
CONSTRAINT [CK_bINMA_EndLastECM] CHECK (([EndLastECM]='M' OR [EndLastECM]='C' OR [EndLastECM]='E'))
ALTER TABLE [dbo].[bINMA] ADD
CONSTRAINT [CK_bINMA_EndStdECM] CHECK (([EndStdECM]='M' OR [EndStdECM]='C' OR [EndStdECM]='E'))
GO
