...
ALTER TABLE [dbo].[bINIB] ADD
CONSTRAINT [CK_bINIB_ECM] CHECK (([ECM]='M' OR [ECM]='C' OR [ECM]='E'))
ALTER TABLE [dbo].[bINIB] ADD
CONSTRAINT [CK_bINIB_OldECM] CHECK (([OldECM]='M' OR [OldECM]='C' OR [OldECM]='E' OR [OldECM] IS NULL))
GO
