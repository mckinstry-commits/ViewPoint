...
ALTER TABLE [dbo].[bMSIH] ADD
CONSTRAINT [CK_bMSIH_CMAcct] CHECK (([CMAcct] IS NULL OR [CMAcct]>(0) AND [CMAcct]<(10000)))
ALTER TABLE [dbo].[bMSIH] ADD
CONSTRAINT [CK_bMSIH_InterCoInv] CHECK (([InterCoInv]='N' OR [InterCoInv]='Y'))
ALTER TABLE [dbo].[bMSIH] ADD
CONSTRAINT [CK_bMSIH_SepHaul] CHECK (([SepHaul]='N' OR [SepHaul]='Y'))
ALTER TABLE [dbo].[bMSIH] ADD
CONSTRAINT [CK_bMSIH_Void] CHECK (([Void]='N' OR [Void]='Y'))
GO
