...
ALTER TABLE [dbo].[bINCB] ADD
CONSTRAINT [CK_bINCB_ECM] CHECK (([ECM]='M' OR [ECM]='C' OR [ECM]='E'))
ALTER TABLE [dbo].[bINCB] ADD
CONSTRAINT [CK_bINCB_OldECM] CHECK (([OldECM]='M' OR [OldECM]='C' OR [OldECM]='E' OR [OldECM] IS NULL))
ALTER TABLE [dbo].[bINCB] ADD
CONSTRAINT [CK_bINCB_OldStkECM] CHECK (([OldStkECM]='M' OR [OldStkECM]='C' OR [OldStkECM]='E' OR [OldStkECM] IS NULL))
ALTER TABLE [dbo].[bINCB] ADD
CONSTRAINT [CK_bINCB_StkECM] CHECK (([StkECM]='M' OR [StkECM]='C' OR [StkECM]='E'))
GO
