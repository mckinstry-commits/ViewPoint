...
ALTER TABLE [dbo].[bEMWS] ADD
CONSTRAINT [CK_bEMWS_StatusType] CHECK (([StatusType]='N' OR [StatusType]='F' OR [StatusType]='B'))
ALTER TABLE [dbo].[bEMWS] ADD
CONSTRAINT [FK_bEMWS_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
