...
ALTER TABLE [dbo].[bHRAI] ADD
CONSTRAINT [CK_bHRAI_DOTReportableYN] CHECK (([DOTReportableYN]='Y' OR [DOTReportableYN]='N'))
ALTER TABLE [dbo].[bHRAI] ADD
CONSTRAINT [CK_bHRAI_EmergencyRoomYN] CHECK (([EmergencyRoomYN]='Y' OR [EmergencyRoomYN]='N'))
ALTER TABLE [dbo].[bHRAI] ADD
CONSTRAINT [CK_bHRAI_FatalityYN] CHECK (([FatalityYN]='Y' OR [FatalityYN]='N'))
ALTER TABLE [dbo].[bHRAI] ADD
CONSTRAINT [CK_bHRAI_HazMatYN] CHECK (([HazMatYN]='Y' OR [HazMatYN]='N'))
ALTER TABLE [dbo].[bHRAI] ADD
CONSTRAINT [CK_bHRAI_HospOvernightYN] CHECK (([HospOvernightYN]='Y' OR [HospOvernightYN]='N'))
ALTER TABLE [dbo].[bHRAI] ADD
CONSTRAINT [CK_bHRAI_HospitalYN] CHECK (([HospitalYN]='Y' OR [HospitalYN]='N'))
ALTER TABLE [dbo].[bHRAI] ADD
CONSTRAINT [CK_bHRAI_MSDSYN] CHECK (([MSDSYN]='Y' OR [MSDSYN]='N'))
ALTER TABLE [dbo].[bHRAI] ADD
CONSTRAINT [CK_bHRAI_PreventableYN] CHECK (([PreventableYN]='Y' OR [PreventableYN]='N'))
ALTER TABLE [dbo].[bHRAI] ADD
CONSTRAINT [CK_bHRAI_WorkersCompYN] CHECK (([WorkersCompYN]='Y' OR [WorkersCompYN]='N'))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHRAI].[PreventableYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHRAI].[FatalityYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHRAI].[HospitalYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHRAI].[HazMatYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHRAI].[MSDSYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHRAI].[DOTReportableYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHRAI].[WorkersCompYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHRAI].[EmergencyRoomYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHRAI].[HospOvernightYN]'
GO
