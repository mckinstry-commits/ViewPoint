...
ALTER TABLE [dbo].[bEMUE] ADD
CONSTRAINT [FK_bEMUE_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
ALTER TABLE [dbo].[bEMUE] ADD
CONSTRAINT [FK_bEMUE_bEMUH_AUTemplate] FOREIGN KEY ([EMCo], [AUTemplate]) REFERENCES [dbo].[bEMUH] ([EMCo], [AUTemplate]) ON DELETE CASCADE
ALTER TABLE [dbo].[bEMUE] ADD
CONSTRAINT [FK_bEMUE_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
ALTER TABLE [dbo].[bEMUE] ADD
CONSTRAINT [FK_bEMUE_bEMUR_RulesTable] FOREIGN KEY ([EMCo], [RulesTable]) REFERENCES [dbo].[bEMUR] ([EMCo], [RulesTable])
GO
