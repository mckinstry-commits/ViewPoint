...
CREATE UNIQUE CLUSTERED INDEX [biJCJP] ON [dbo].[bJCJP] ([JCCo], [Job], [PhaseGroup], [Phase]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biJCJPContract] ON [dbo].[bJCJP] ([JCCo], [Contract], [Item], [Job]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCJP] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bJCJP] ADD
CONSTRAINT [CK_bJCJP_ActiveYN] CHECK (([ActiveYN]='Y' OR [ActiveYN]='N'))
GO
