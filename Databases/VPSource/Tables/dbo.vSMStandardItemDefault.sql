...
ALTER TABLE [dbo].[vSMStandardItemDefault] ADD 
CONSTRAINT [PK_vSMStandardItemDefault] PRIMARY KEY CLUSTERED  ([SMStandardItemDefaultID]) ON [PRIMARY]
GO
...
ALTER TABLE [dbo].[vSMStandardItemDefault] ADD
CONSTRAINT [FK_vSMStandardItemDefault_vSMEntity] FOREIGN KEY ([SMCo], [EntitySeq]) REFERENCES [dbo].[vSMEntity] ([SMCo], [EntitySeq]) ON DELETE CASCADE
GO
