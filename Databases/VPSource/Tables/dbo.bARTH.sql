...
[CreditAmt] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bARTH_CreditAmt] DEFAULT ((0)),
[PayTerms] [dbo].[bPayTerms] NULL,
[AppliedMth] [dbo].[bMonth] NULL,
[AppliedTrans] [dbo].[bTrans] NULL,
[Invoiced] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bARTH_Invoiced] DEFAULT ((0)),
[Paid] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bARTH_Paid] DEFAULT ((0)),
[Retainage] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bARTH_Retainage] DEFAULT ((0)),
[DiscTaken] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bARTH_DiscTaken] DEFAULT ((0)),
[AmountDue] [dbo].[bDollar] NOT NULL CONSTRAINT [DF_bARTH_AmountDue] DEFAULT ((0)),
[PayFullDate] [dbo].[bDate] NULL,
[PurgeFlag] [dbo].[bYN] NOT NULL CONSTRAINT [DF_bARTH_PurgeFlag] DEFAULT ('N'),
...
CREATE UNIQUE CLUSTERED INDEX [biARTH] ON [dbo].[bARTH] ([ARCo], [Mth], [ARTrans]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biARTHApplied] ON [dbo].[bARTH] ([ARCo], [AppliedMth], [AppliedTrans]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biARTHTrans] ON [dbo].[bARTH] ([ARCo], [ARTrans]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biARTHCustomer] ON [dbo].[bARTH] ([ARCo], [CustGroup], [Customer]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biARTHInvoice] ON [dbo].[bARTH] ([ARCo], [Invoice]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bARTH] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biARTHudARTOPCID] ON [dbo].[bARTH] ([udARTOPCID]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biARTHudPAYARTOPCID] ON [dbo].[bARTH] ([udPAYARTOPCID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bARTH] ADD
CONSTRAINT [CK_bARTH_PurgeFlag] CHECK (([PurgeFlag]='Y' OR [PurgeFlag]='N'))
ALTER TABLE [dbo].[bARTH] ADD
CONSTRAINT [CK_bARTH_ARTransType] CHECK (([ARTransType]='A' OR [ARTransType]='C' OR [ARTransType]='F' OR [ARTransType]='I' OR [ARTransType]='M' OR [ARTransType]='P' OR [ARTransType]='R' OR [ARTransType]='V' OR [ARTransType]='W'))
ALTER TABLE [dbo].[bARTH] ADD
CONSTRAINT [CK_bARTH_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000) OR [CMAcct] IS NULL))
ALTER TABLE [dbo].[bARTH] ADD
CONSTRAINT [CK_bARTH_EditTrans] CHECK (([EditTrans]='Y' OR [EditTrans]='N'))
ALTER TABLE [dbo].[bARTH] ADD
CONSTRAINT [CK_bARTH_ExcludeFC] CHECK (([ExcludeFC]='Y' OR [ExcludeFC]='N'))
GO
