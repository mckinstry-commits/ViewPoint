...
ALTER TABLE [dbo].[bEMSH] WITH NOCHECK ADD
CONSTRAINT [FK_bEMSH_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
ALTER TABLE [dbo].[bEMSH] ADD
CONSTRAINT [CK_bEMSH_Basis] CHECK (([Basis]='F' OR [Basis]='G' OR [Basis]='M' OR [Basis]='H'))
ALTER TABLE [dbo].[bEMSH] ADD
CONSTRAINT [CK_bEMSH_AutoDelete] CHECK (([AutoDelete]='N' OR [AutoDelete]='Y' OR [AutoDelete] IS NULL))
ALTER TABLE [dbo].[bEMSH] ADD
CONSTRAINT [FK_bEMSH_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
