...
ALTER TABLE [dbo].[vRPRTc] ADD
CONSTRAINT [CK_vRPRTc_ShowOnMenu] CHECK (([ShowOnMenu]='Y' OR [ShowOnMenu]='N' OR [ShowOnMenu] IS NULL))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[vRPRTc].[ShowOnMenu]'
GO
