...
ALTER TABLE [dbo].[vSMDepartment] ADD 
CONSTRAINT [PK_vSMDepartment] PRIMARY KEY CLUSTERED  ([SMDepartmentID]) ON [PRIMARY]
GO
...
ALTER TABLE [dbo].[vSMDepartment] ADD
CONSTRAINT [FK_vSMDepartment_bGLAC_OtherCostGLAcct] FOREIGN KEY ([GLCo], [OtherCostGLAcct]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
ALTER TABLE [dbo].[vSMDepartment] ADD
CONSTRAINT [FK_vSMDepartment_bGLAC_OtherCostWIPGLAcct] FOREIGN KEY ([GLCo], [OtherCostWIPGLAcct]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
ALTER TABLE [dbo].[vSMDepartment] ADD
CONSTRAINT [FK_vSMDepartment_bGLAC_OtherRevGLAcct] FOREIGN KEY ([GLCo], [OtherRevGLAcct]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
ALTER TABLE [dbo].[vSMDepartment] ADD
CONSTRAINT [FK_vSMDepartment_bGLAC_OtherRevWIPGLAcct] FOREIGN KEY ([GLCo], [OtherRevWIPGLAcct]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
ALTER TABLE [dbo].[vSMDepartment] ADD
CONSTRAINT [FK_vSMDepartment_bGLAC_SubcontractCostGLAcct] FOREIGN KEY ([GLCo], [SubcontractCostGLAcct]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
ALTER TABLE [dbo].[vSMDepartment] ADD
CONSTRAINT [FK_vSMDepartment_bGLAC_SubcontractCostWIPGLAcct] FOREIGN KEY ([GLCo], [SubcontractCostWIPGLAcct]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
ALTER TABLE [dbo].[vSMDepartment] ADD
CONSTRAINT [FK_vSMDepartment_bGLAC_SubcontractRevGLAcct] FOREIGN KEY ([GLCo], [SubcontractRevGLAcct]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
ALTER TABLE [dbo].[vSMDepartment] ADD
CONSTRAINT [FK_vSMDepartment_bGLAC_SubcontractRevWIPGLAcct] FOREIGN KEY ([GLCo], [SubcontractRevWIPGLAcct]) REFERENCES [dbo].[bGLAC] ([GLCo], [GLAcct])
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
