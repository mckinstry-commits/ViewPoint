...
ALTER TABLE [dbo].[bMSTD] ADD
CONSTRAINT [CK_bMSTD_AuditYN] CHECK (([AuditYN]='Y' OR [AuditYN]='N'))
ALTER TABLE [dbo].[bMSTD] ADD
CONSTRAINT [CK_bMSTD_Changed] CHECK (([Changed]='Y' OR [Changed]='N'))
ALTER TABLE [dbo].[bMSTD] ADD
CONSTRAINT [CK_bMSTD_ECM] CHECK (([ECM]='E' OR [ECM]='M' OR [ECM]='C'))
ALTER TABLE [dbo].[bMSTD] ADD
CONSTRAINT [CK_bMSTD_Hold] CHECK (([Hold]='Y' OR [Hold]='N'))
ALTER TABLE [dbo].[bMSTD] ADD
CONSTRAINT [CK_bMSTD_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
ALTER TABLE [dbo].[bMSTD] ADD
CONSTRAINT [CK_bMSTD_VerifyHaul] CHECK (([VerifyHaul]='Y' OR [VerifyHaul]='N'))
ALTER TABLE [dbo].[bMSTD] ADD
CONSTRAINT [CK_bMSTD_Void] CHECK (([Void]='Y' OR [Void]='N'))
GO
