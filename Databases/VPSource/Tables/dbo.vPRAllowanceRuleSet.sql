...
GO
ALTER TABLE [dbo].[vPRAllowanceRuleSet] ADD CONSTRAINT [PK_vPRAllowanceRuleSet] PRIMARY KEY CLUSTERED  ([PRCo], [AllowanceRulesetName]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
