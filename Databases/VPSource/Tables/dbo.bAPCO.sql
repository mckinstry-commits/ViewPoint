...
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_APRefUnqYN] CHECK (([APRefUnqYN]='Y' OR [APRefUnqYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_AllAllowPayYN] CHECK (([AllAllowPayYN]='Y' OR [AllAllowPayYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_AllCompChkYN] CHECK (([AllCompChkYN]='Y' OR [AllCompChkYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_AuditCoParams] CHECK (([AuditCoParams]='Y' OR [AuditCoParams]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_AuditComp] CHECK (([AuditComp]='Y' OR [AuditComp]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_AuditHold] CHECK (([AuditHold]='Y' OR [AuditHold]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_AuditPay] CHECK (([AuditPay]='Y' OR [AuditPay]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_AuditPayTypes] CHECK (([AuditPayTypes]='Y' OR [AuditPayTypes]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_AuditRecur] CHECK (([AuditRecur]='Y' OR [AuditRecur]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_AuditTrans] CHECK (([AuditTrans]='Y' OR [AuditTrans]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_AuditUnappInv] CHECK (([AuditUnappInv]='Y' OR [AuditUnappInv]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_AuditVendors] CHECK (([AuditVendors]='Y' OR [AuditVendors]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000) OR [CMAcct] IS NULL))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_ICRptYN] CHECK (([ICRptYN]='Y' OR [ICRptYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_InvExceedRecvdYN] CHECK (([InvExceedRecvdYN]='Y' OR [InvExceedRecvdYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_InvTotYN] CHECK (([InvTotYN]='Y' OR [InvTotYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_JobLineDescDfltYN] CHECK (([JobLineDescDfltYN]='Y' OR [JobLineDescDfltYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_NetAmtOpt] CHECK (([NetAmtOpt]='Y' OR [NetAmtOpt]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_OverridePayType] CHECK (([OverridePayType]='Y' OR [OverridePayType]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_PMVendAddYN] CHECK (([PMVendAddYN]='Y' OR [PMVendAddYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_PMVendUpdYN] CHECK (([PMVendUpdYN]='Y' OR [PMVendUpdYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_POAllowPayYN] CHECK (([POAllowPayYN]='Y' OR [POAllowPayYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_POCompChkYN] CHECK (([POCompChkYN]='Y' OR [POCompChkYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_POItemTotYN] CHECK (([POItemTotYN]='Y' OR [POItemTotYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_POTotYN] CHECK (([POTotYN]='Y' OR [POTotYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_PayCategoryYN] CHECK (([PayCategoryYN]='Y' OR [PayCategoryYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_SLAllowPayYN] CHECK (([SLAllowPayYN]='Y' OR [SLAllowPayYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_SLCompChkYN] CHECK (([SLCompChkYN]='Y' OR [SLCompChkYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_SLTotYN] CHECK (([SLTotYN]='Y' OR [SLTotYN]='N'))
ALTER TABLE [dbo].[bAPCO] ADD
CONSTRAINT [CK_bAPCO_UseTaxDiscountYN] CHECK (([UseTaxDiscountYN]='Y' OR [UseTaxDiscountYN]='N'))
GO
