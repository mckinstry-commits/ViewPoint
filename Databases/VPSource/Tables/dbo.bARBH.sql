...
ALTER TABLE [dbo].[bARBH] ADD
CONSTRAINT [CK_bARBH_ARTransType] CHECK (([ARTransType]='A' OR [ARTransType]='C' OR [ARTransType]='F' OR [ARTransType]='I' OR [ARTransType]='M' OR [ARTransType]='P' OR [ARTransType]='R' OR [ARTransType]='V' OR [ARTransType]='W'))
ALTER TABLE [dbo].[bARBH] ADD
CONSTRAINT [CK_bARBH_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000) OR [CMAcct] IS NULL))
ALTER TABLE [dbo].[bARBH] ADD
CONSTRAINT [CK_bARBH_oldCMAcct] CHECK (([oldCMAcct]>(0) AND [oldCMAcct]<(10000) OR [oldCMAcct] IS NULL))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brARTransType]', N'[dbo].[bARBH].[ARTransType]'
GO
EXEC sp_bindrule N'[dbo].[brCMAcct]', N'[dbo].[bARBH].[CMAcct]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bARBH].[CreditAmt]'
GO
EXEC sp_bindrule N'[dbo].[brCMAcct]', N'[dbo].[bARBH].[oldCMAcct]'
GO
