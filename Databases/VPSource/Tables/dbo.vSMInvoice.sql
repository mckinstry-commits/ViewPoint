...
ALTER TABLE [dbo].[vSMInvoice] ADD 
CONSTRAINT [PK_vSMInvoice] PRIMARY KEY CLUSTERED  ([SMInvoiceID]) ON [PRIMARY]
GO
...
CONSTRAINT [FK_vSMInvoice_vSMCustomer] FOREIGN KEY ([SMCo], [CustGroup], [Customer]) REFERENCES [dbo].[vSMCustomer] ([SMCo], [CustGroup], [Customer])
ALTER TABLE [dbo].[vSMInvoice] WITH NOCHECK ADD
...
ALTER TABLE [dbo].[vSMInvoice] ADD
CONSTRAINT [CK_vSMInvoice_Invoiced] CHECK (([Invoiced]=case when [ARPostedMth] IS NOT NULL OR [ARTrans] IS NOT NULL then (1) else [Invoiced] end))
ALTER TABLE [dbo].[vSMInvoice] ADD
CONSTRAINT [CK_vSMInvoice_InvoiceType] CHECK (([InvoiceType]='W' OR [InvoiceType]='A'))
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
