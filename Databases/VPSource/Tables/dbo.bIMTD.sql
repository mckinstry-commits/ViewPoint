...
ALTER TABLE [dbo].[bIMTD] ADD
CONSTRAINT [CK_bIMTD_ImportPromptYN] CHECK (([ImportPromptYN]='Y' OR [ImportPromptYN]='N'))
ALTER TABLE [dbo].[bIMTD] ADD
CONSTRAINT [CK_bIMTD_OverrideYN] CHECK (([OverrideYN]='Y' OR [OverrideYN]='N'))
ALTER TABLE [dbo].[bIMTD] ADD
CONSTRAINT [CK_bIMTD_UpdateKeyYN] CHECK (([UpdateKeyYN]='Y' OR [UpdateKeyYN]='N'))
ALTER TABLE [dbo].[bIMTD] ADD
CONSTRAINT [CK_bIMTD_UpdateValueYN] CHECK (([UpdateValueYN]='Y' OR [UpdateValueYN]='N'))
GO
