...
ALTER TABLE [dbo].[bEMWH] ADD
CONSTRAINT [CK_bEMWH_Complete] CHECK (([Complete]='N' OR [Complete]='Y'))
ALTER TABLE [dbo].[bEMWH] ADD
CONSTRAINT [FK_bEMWH_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
ALTER TABLE [dbo].[bEMWH] ADD
CONSTRAINT [FK_bEMWH_bEMEM_Equipment] FOREIGN KEY ([EMCo], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment]) ON UPDATE CASCADE
ALTER TABLE [dbo].[bEMWH] ADD
CONSTRAINT [FK_bEMWH_bHQGP_ShopGroup] FOREIGN KEY ([ShopGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
