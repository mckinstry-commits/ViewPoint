...
CREATE UNIQUE CLUSTERED INDEX [biJCTI] ON [dbo].[bJCTI] ([JCCo], [InsTemplate], [PhaseGroup], [Phase]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCTI] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]
