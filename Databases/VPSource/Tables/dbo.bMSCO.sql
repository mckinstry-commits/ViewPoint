...
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_AuditCoParams] CHECK (([AuditCoParams]='N' OR [AuditCoParams]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_AuditHaulCodes] CHECK (([AuditHaulCodes]='N' OR [AuditHaulCodes]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_AuditHaulers] CHECK (([AuditHaulers]='N' OR [AuditHaulers]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_AuditInvDetail] CHECK (([AuditInvDetail]='N' OR [AuditInvDetail]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_AuditPayCodes] CHECK (([AuditPayCodes]='N' OR [AuditPayCodes]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_AuditQuotes] CHECK (([AuditQuotes]='N' OR [AuditQuotes]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_AuditTemplates] CHECK (([AuditTemplates]='N' OR [AuditTemplates]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_AuditYN] CHECK (([AuditYN]='N' OR [AuditYN]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_AutoApplyCash] CHECK (([AutoApplyCash]='N' OR [AutoApplyCash]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_AutoQuote] CHECK (([AutoQuote]='N' OR [AutoQuote]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_DateSort] CHECK (([DateSort]='N' OR [DateSort]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_HaulDisc] CHECK (([HaulDisc]='N' OR [HaulDisc]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_HaulHrs] CHECK (([HaulHrs]='N' OR [HaulHrs]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_HaulLoads] CHECK (([HaulLoads]='N' OR [HaulLoads]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_HaulMatlVendor] CHECK (([HaulMatlVendor]='N' OR [HaulMatlVendor]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_HaulMiles] CHECK (([HaulMiles]='N' OR [HaulMiles]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_HaulPay] CHECK (([HaulPay]='N' OR [HaulPay]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_HaulRev] CHECK (([HaulRev]='N' OR [HaulRev]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_HaulTax] CHECK (([HaulTax]='N' OR [HaulTax]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_HaulTimes] CHECK (([HaulTimes]='N' OR [HaulTimes]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_HaulZone] CHECK (([HaulZone]='N' OR [HaulZone]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_InterCoInv] CHECK (([InterCoInv]='N' OR [InterCoInv]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_LimitChk] CHECK (([LimitChk]='N' OR [LimitChk]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_LocSort] CHECK (([LocSort]='N' OR [LocSort]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_SaveDeleted] CHECK (([SaveDeleted]='N' OR [SaveDeleted]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_TicDisc] CHECK (([TicDisc]='N' OR [TicDisc]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_TicDriver] CHECK (([TicDriver]='N' OR [TicDriver]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_TicEmployee] CHECK (([TicEmployee]='N' OR [TicEmployee]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_TicHrs] CHECK (([TicHrs]='N' OR [TicHrs]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_TicLoads] CHECK (([TicLoads]='N' OR [TicLoads]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_TicMatlVendor] CHECK (([TicMatlVendor]='N' OR [TicMatlVendor]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_TicMiles] CHECK (([TicMiles]='N' OR [TicMiles]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_TicPay] CHECK (([TicPay]='N' OR [TicPay]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_TicReason] CHECK (([TicReason]='N' OR [TicReason]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_TicRev] CHECK (([TicRev]='N' OR [TicRev]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_TicTax] CHECK (([TicMiles]='N' OR [TicTax]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_TicTimes] CHECK (([TicTimes]='N' OR [TicTimes]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_TicWeights] CHECK (([TicWeights]='N' OR [TicWeights]='Y'))
ALTER TABLE [dbo].[bMSCO] ADD
CONSTRAINT [CK_bMSCO_TicZone] CHECK (([TicZone]='N' OR [TicZone]='Y'))
GO
