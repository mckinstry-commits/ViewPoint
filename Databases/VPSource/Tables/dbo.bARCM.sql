...
ALTER TABLE [dbo].[bARCM] ADD
CONSTRAINT [CK_bARCM_ExclContFromFC] CHECK (([ExclContFromFC]='Y' OR [ExclContFromFC]='N'))
ALTER TABLE [dbo].[bARCM] ADD
CONSTRAINT [CK_bARCM_MiscOnInv] CHECK (([MiscOnInv]='Y' OR [MiscOnInv]='N'))
ALTER TABLE [dbo].[bARCM] ADD
CONSTRAINT [CK_bARCM_MiscOnPay] CHECK (([MiscOnPay]='Y' OR [MiscOnPay]='N'))
ALTER TABLE [dbo].[bARCM] ADD
CONSTRAINT [CK_bARCM_SelPurge] CHECK (([SelPurge]='Y' OR [SelPurge]='N'))
ALTER TABLE [dbo].[bARCM] ADD
CONSTRAINT [CK_bARCM_SepHaul] CHECK (([SepHaul]='Y' OR [SepHaul]='N'))
ALTER TABLE [dbo].[bARCM] ADD
CONSTRAINT [CK_bARCM_Status] CHECK (([Status]='A' OR [Status]='H' OR [Status]='I'))
ALTER TABLE [dbo].[bARCM] ADD
CONSTRAINT [CK_bARCM_StmntPrint] CHECK (([StmntPrint]='Y' OR [StmntPrint]='N'))
ALTER TABLE [dbo].[bARCM] ADD
CONSTRAINT [CK_bARCM_StmtType] CHECK (([StmtType]='B' OR [StmtType]='O'))
ALTER TABLE [dbo].[bARCM] ADD
CONSTRAINT [CK_bARCM_TempYN] CHECK (([TempYN]='Y' OR [TempYN]='N'))
GO
