...
ALTER TABLE [dbo].[bARBL] ADD
CONSTRAINT [CK_bARBL_ECM] CHECK (([ECM]='E' OR [ECM]='C' OR [ECM]='M' OR [ECM] IS NULL))
ALTER TABLE [dbo].[bARBL] ADD
CONSTRAINT [CK_bARBL_oldECM] CHECK (([oldECM]='E' OR [oldECM]='C' OR [oldECM]='M' OR [oldECM] IS NULL))
GO
