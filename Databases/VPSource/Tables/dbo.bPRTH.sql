...
CREATE UNIQUE CLUSTERED INDEX [biPRTH] ON [dbo].[bPRTH] ([PRCo], [PRGroup], [PREndDate], [Employee], [PaySeq], [PostSeq]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRTH] ([KeyID]) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biPRTHEarnCode] ON [dbo].[bPRTH] ([PRCo], [Employee], [EarnCode]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biPRTHEmpPostDate] ON [dbo].[bPRTH] ([PRCo], [Employee], [PostDate], [InUseBatchId]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biPRTHEmpPREndDate] ON [dbo].[bPRTH] ([PRCo], [Employee], [PREndDate], [InUseBatchId]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biPRTHJobPostDate] ON [dbo].[bPRTH] ([PRCo], [JCCo], [Job], [PostDate], [InUseBatchId]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biPRTHJobEndDate] ON [dbo].[bPRTH] ([PRCo], [JCCo], [Job], [PREndDate], [InUseBatchId]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [ciPRTHJobCMRef] ON [dbo].[bPRTH] ([PRCo], [PREndDate], [Employee], [PaySeq], [Job], [udCMRef]) WITH (FILLFACTOR=85) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [ciPRTHCMRef] ON [dbo].[bPRTH] ([PRCo], [PREndDate], [Employee], [PaySeq], [udCMRef]) WITH (FILLFACTOR=85) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biPRTH_PRTBKeyID] ON [dbo].[bPRTH] ([PRTBKeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biPRTHUniqueAttchID] ON [dbo].[bPRTH] ([UniqueAttchID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bPRTH] ADD
CONSTRAINT [CK_bPRTH_Cert] CHECK (([Cert]='Y' OR [Cert]='N'))
