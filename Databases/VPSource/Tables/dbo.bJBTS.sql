...
ALTER TABLE [dbo].[bJBTS] ADD
CONSTRAINT [CK_bJBTS_APYN] CHECK (([APYN]='Y' OR [APYN]='N'))
ALTER TABLE [dbo].[bJBTS] ADD
CONSTRAINT [CK_bJBTS_EMYN] CHECK (([EMYN]='Y' OR [EMYN]='N'))
ALTER TABLE [dbo].[bJBTS] ADD
CONSTRAINT [CK_bJBTS_INYN] CHECK (([INYN]='Y' OR [INYN]='N'))
ALTER TABLE [dbo].[bJBTS] ADD
CONSTRAINT [CK_bJBTS_JCYN] CHECK (([JCYN]='Y' OR [JCYN]='N'))
ALTER TABLE [dbo].[bJBTS] ADD
CONSTRAINT [CK_bJBTS_MSYN] CHECK (([MSYN]='Y' OR [MSYN]='N'))
ALTER TABLE [dbo].[bJBTS] ADD
CONSTRAINT [CK_bJBTS_PRYN] CHECK (([PRYN]='Y' OR [PRYN]='N'))
GO
