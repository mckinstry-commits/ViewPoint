...
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [CK_bEMBF_AutoUsage] CHECK (([AutoUsage]='N' OR [AutoUsage]='Y'))
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [CK_bEMBF_INStkECM] CHECK (([INStkECM]='M' OR [INStkECM]='C' OR [INStkECM]='E' OR [INStkECM] IS NULL))
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [CK_bEMBF_OldINStkECM] CHECK (([OldINStkECM]='M' OR [OldINStkECM]='C' OR [OldINStkECM]='E' OR [OldINStkECM] IS NULL))
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [CK_bEMBF_OldPerECM] CHECK (([OldPerECM]='M' OR [OldPerECM]='C' OR [OldPerECM]='E' OR [OldPerECM] IS NULL))
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [CK_bEMBF_PerECM] CHECK (([PerECM]='M' OR [PerECM]='C' OR [PerECM]='E' OR [PerECM] IS NULL))
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [FK_bEMBF_bEMAH_AllocCode] FOREIGN KEY ([Co], [AllocCode]) REFERENCES [dbo].[bEMAH] ([EMCo], [AllocCode])
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [FK_bEMBF_bEMEM_Component] FOREIGN KEY ([Co], [Component]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment])
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [FK_bEMBF_bEMEM_Equipment] FOREIGN KEY ([Co], [Equipment]) REFERENCES [dbo].[bEMEM] ([EMCo], [Equipment])
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [FK_bEMBF_bEMWH_WorkOrder] FOREIGN KEY ([Co], [WorkOrder]) REFERENCES [dbo].[bEMWH] ([EMCo], [WorkOrder])
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [FK_bEMBF_bEMWI_WOItem] FOREIGN KEY ([Co], [WorkOrder], [WOItem]) REFERENCES [dbo].[bEMWI] ([EMCo], [WorkOrder], [WOItem])
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [FK_bEMBF_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [FK_bEMBF_bEMTY_ComponentTypeCode] FOREIGN KEY ([EMGroup], [ComponentTypeCode]) REFERENCES [dbo].[bEMTY] ([EMGroup], [ComponentTypeCode])
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [FK_bEMBF_bEMCC_CostCode] FOREIGN KEY ([EMGroup], [CostCode]) REFERENCES [dbo].[bEMCC] ([EMGroup], [CostCode])
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [FK_bEMBF_bEMCT_EMCostType] FOREIGN KEY ([EMGroup], [EMCostType]) REFERENCES [dbo].[bEMCT] ([EMGroup], [CostType])
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [FK_bEMBF_bEMPS_PartsStatusCode] FOREIGN KEY ([EMGroup], [PartsStatusCode]) REFERENCES [dbo].[bEMPS] ([EMGroup], [PartsStatusCode])
ALTER TABLE [dbo].[bEMBF] ADD
CONSTRAINT [FK_bEMBF_bEMRC_RevCode] FOREIGN KEY ([EMGroup], [RevCode]) REFERENCES [dbo].[bEMRC] ([EMGroup], [RevCode])
GO
...
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bEMBF].[INStkUnitCost]'
GO
EXEC sp_bindrule N'[dbo].[brECM]', N'[dbo].[bEMBF].[INStkECM]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bEMBF].[UnitPrice]'
GO
EXEC sp_bindrule N'[dbo].[brECM]', N'[dbo].[bEMBF].[PerECM]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bEMBF].[RevRate]'
GO
EXEC sp_bindrule N'[dbo].[brECM]', N'[dbo].[bEMBF].[OldINStkECM]'
GO
EXEC sp_bindrule N'[dbo].[brECM]', N'[dbo].[bEMBF].[OldPerECM]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bEMBF].[AutoUsage]'
GO
