...
CREATE UNIQUE CLUSTERED INDEX [biGLAJ] ON [dbo].[bGLAJ] ([GLCo], [Jrnl], [EntryId], [Seq]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bGLAJ] ADD CONSTRAINT [PK_bGLAJ] PRIMARY KEY NONCLUSTERED  ([KeyID]) WITH (FILLFACTOR=100) ON [PRIMARY]

ALTER TABLE [dbo].[bGLAJ] WITH NOCHECK ADD
CONSTRAINT [FK_bGLAJ_bGLJR_GLCoJrnl] FOREIGN KEY ([GLCo], [Jrnl]) REFERENCES [dbo].[bGLJR] ([GLCo], [Jrnl])
GO
