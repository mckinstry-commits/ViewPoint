...
ALTER TABLE [dbo].[vSMRateOverrideMatlBP] ADD 
CONSTRAINT [PK_vSMRateOverrideMatlBP] PRIMARY KEY CLUSTERED  ([SMRateOverrideMatlBPID]) ON [PRIMARY]
GO
...
ALTER TABLE [dbo].[vSMRateOverrideMatlBP] ADD
CONSTRAINT [FK_vSMRateOverrideMatlBP_vSMRateOverrideMaterial] FOREIGN KEY ([SMCo], [EntitySeq], [RateOverrideMaterialSeq]) REFERENCES [dbo].[vSMRateOverrideMaterial] ([SMCo], [EntitySeq], [Seq])
ALTER TABLE [dbo].[vSMRateOverrideMatlBP] ADD
CONSTRAINT [FK_vSMRateOverrideMatlBP_vSMEntity] FOREIGN KEY ([SMCo], [EntitySeq]) REFERENCES [dbo].[vSMEntity] ([SMCo], [EntitySeq]) ON DELETE CASCADE
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
