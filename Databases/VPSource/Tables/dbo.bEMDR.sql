...
ALTER TABLE [dbo].[bEMDR] ADD
CONSTRAINT [FK_bEMDR_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
ALTER TABLE [dbo].[bEMDR] ADD
CONSTRAINT [FK_bEMDR_bEMDM_Department] FOREIGN KEY ([EMCo], [Department]) REFERENCES [dbo].[bEMDM] ([EMCo], [Department])
ALTER TABLE [dbo].[bEMDR] ADD
CONSTRAINT [FK_bEMDR_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
ALTER TABLE [dbo].[bEMDR] ADD
CONSTRAINT [FK_bEMDR_bEMRC_RevCode] FOREIGN KEY ([EMGroup], [RevCode]) REFERENCES [dbo].[bEMRC] ([EMGroup], [RevCode])
GO
