...
ALTER TABLE [dbo].[bCMDB] ADD
CONSTRAINT [CK_bCMDB_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000)))
ALTER TABLE [dbo].[bCMDB] ADD
CONSTRAINT [CK_bCMDB_OldCMAcct] CHECK (([OldCMAcct]>(0) AND [OldCMAcct]<(10000) OR [OldCMAcct] IS NULL))
ALTER TABLE [dbo].[bCMDB] ADD
CONSTRAINT [CK_bCMDB_OldVoid] CHECK (([OldVoid]='Y' OR [OldVoid]='N' OR [OldVoid] IS NULL))
ALTER TABLE [dbo].[bCMDB] ADD
CONSTRAINT [CK_bCMDB_Void] CHECK (([Void]='Y' OR [Void]='N'))
GO
...
GO
ALTER TABLE [dbo].[bCMDB] ADD CONSTRAINT [CK_bCMDB_BatchTransType] CHECK (([BatchTransType]='D' OR [BatchTransType]='C' OR [BatchTransType]='A'))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brCMAcct]', N'[dbo].[bCMDB].[CMAcct]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bCMDB].[Void]'
GO
EXEC sp_bindrule N'[dbo].[brCMAcct]', N'[dbo].[bCMDB].[OldCMAcct]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bCMDB].[OldVoid]'
GO
