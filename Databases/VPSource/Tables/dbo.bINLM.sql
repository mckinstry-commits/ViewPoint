...
ALTER TABLE [dbo].[bINLM] ADD
CONSTRAINT [CK_bINLM_Active] CHECK (([Active]='Y' OR [Active]='N'))
ALTER TABLE [dbo].[bINLM] ADD
CONSTRAINT [CK_bINLM_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000) OR [CMAcct] IS NULL))
GO
