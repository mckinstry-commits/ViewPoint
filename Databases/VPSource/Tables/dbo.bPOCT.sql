...
ALTER TABLE [dbo].[bPOCT] ADD
CONSTRAINT [CK_bPOCT_Complied] CHECK (([Complied]='Y' OR [Complied]='N' OR [Complied] IS NULL))
ALTER TABLE [dbo].[bPOCT] ADD
CONSTRAINT [CK_bPOCT_PurgeYN] CHECK (([PurgeYN]='Y' OR [PurgeYN]='N'))
ALTER TABLE [dbo].[bPOCT] ADD
CONSTRAINT [CK_bPOCT_Verify] CHECK (([Verify]='Y' OR [Verify]='N'))
GO
