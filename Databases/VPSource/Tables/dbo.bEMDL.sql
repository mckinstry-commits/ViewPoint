...
ALTER TABLE [dbo].[bEMDL] ADD
CONSTRAINT [FK_bEMDL_bEMCO_EMCo] FOREIGN KEY ([EMCo]) REFERENCES [dbo].[bEMCO] ([EMCo])
ALTER TABLE [dbo].[bEMDL] ADD
CONSTRAINT [FK_bEMDL_bEMDM_Department] FOREIGN KEY ([EMCo], [Department]) REFERENCES [dbo].[bEMDM] ([EMCo], [Department])
GO
