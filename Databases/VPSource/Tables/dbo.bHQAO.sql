...
ALTER TABLE [dbo].[bHQAO] ADD
CONSTRAINT [CK_bHQAO_ByCompany] CHECK (([ByCompany]='Y' OR [ByCompany]='N' OR [ByCompany] IS NULL))
ALTER TABLE [dbo].[bHQAO] ADD
CONSTRAINT [CK_bHQAO_ByForm] CHECK (([ByForm]='Y' OR [ByForm]='N' OR [ByForm] IS NULL))
ALTER TABLE [dbo].[bHQAO] ADD
CONSTRAINT [CK_bHQAO_ByModule] CHECK (([ByModule]='Y' OR [ByModule]='N' OR [ByModule] IS NULL))
ALTER TABLE [dbo].[bHQAO] ADD
CONSTRAINT [CK_bHQAO_ByMonth] CHECK (([ByMonth]='Y' OR [ByMonth]='N' OR [ByMonth] IS NULL))
ALTER TABLE [dbo].[bHQAO] ADD
CONSTRAINT [CK_bHQAO_Custom] CHECK (([Custom]='Y' OR [Custom]='N' OR [Custom] IS NULL))
ALTER TABLE [dbo].[bHQAO] ADD
CONSTRAINT [CK_bHQAO_UseJPG] CHECK (([UseJPG]='Y' OR [UseJPG]='N'))
ALTER TABLE [dbo].[bHQAO] ADD
CONSTRAINT [CK_bHQAO_UseStructForAttYN] CHECK (([UseStructForAttYN]='Y' OR [UseStructForAttYN]='N'))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHQAO].[ByCompany]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHQAO].[ByModule]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHQAO].[ByForm]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHQAO].[ByMonth]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHQAO].[Custom]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHQAO].[UseJPG]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHQAO].[UseStructForAttYN]'
GO
