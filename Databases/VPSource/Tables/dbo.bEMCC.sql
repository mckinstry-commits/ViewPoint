...
ALTER TABLE [dbo].[bEMCC] ADD
CONSTRAINT [FK_bEMCC_bEMRT_RevBdownCode] FOREIGN KEY ([EMGroup], [RevBdownCode]) REFERENCES [dbo].[bEMRT] ([EMGroup], [RevBdownCode])
ALTER TABLE [dbo].[bEMCC] ADD
CONSTRAINT [FK_bEMCC_bHQGP_EMGroup] FOREIGN KEY ([EMGroup]) REFERENCES [dbo].[bHQGP] ([Grp])
GO
