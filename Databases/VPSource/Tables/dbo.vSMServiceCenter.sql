...
ALTER TABLE [dbo].[vSMServiceCenter] WITH NOCHECK ADD
CONSTRAINT [FK_vSMServiceCenter_vSMDepartment] FOREIGN KEY ([SMCo], [Department]) REFERENCES [dbo].[vSMDepartment] ([SMCo], [Department])
GO
