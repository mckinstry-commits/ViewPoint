...
ALTER TABLE [dbo].[bAPUR] ADD
CONSTRAINT [CK_bAPUR_ApprvdYN] CHECK (([ApprvdYN]='Y' OR [ApprvdYN]='N'))
ALTER TABLE [dbo].[bAPUR] ADD
CONSTRAINT [CK_bAPUR_Rejected] CHECK (([Rejected]='Y' OR [Rejected]='N' OR [Rejected] IS NULL))
GO
