...
CREATE UNIQUE CLUSTERED INDEX [biPREC] ON [dbo].[bPREC] ([PRCo], [EarnCode]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPREC] ([KeyID]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bPREC] ADD
CONSTRAINT [CK_bPREC_OTCalcs] CHECK (([OTCalcs]='Y' OR [OTCalcs]='N'))
ALTER TABLE [dbo].[bPREC] ADD
CONSTRAINT [CK_bPREC_AutoAP] CHECK (([AutoAP]='Y' OR [AutoAP]='N'))
ALTER TABLE [dbo].[bPREC] ADD
CONSTRAINT [CK_bPREC_CertRpt] CHECK (([CertRpt]='Y' OR [CertRpt]='N'))
ALTER TABLE [dbo].[bPREC] ADD
CONSTRAINT [CK_bPREC_IncldLiabDist] CHECK (([IncldLiabDist]='Y' OR [IncldLiabDist]='N'))
ALTER TABLE [dbo].[bPREC] ADD
CONSTRAINT [CK_bPREC_SubjToAddOns] CHECK (([SubjToAddOns]='Y' OR [SubjToAddOns]='N'))
ALTER TABLE [dbo].[bPREC] ADD
CONSTRAINT [CK_bPREC_SubjToAutoEarns] CHECK (([SubjToAutoEarns]='Y' OR [SubjToAutoEarns]='N'))
ALTER TABLE [dbo].[bPREC] ADD
CONSTRAINT [CK_bPREC_TransByEmployee] CHECK (([TransByEmployee]='Y' OR [TransByEmployee]='N' OR [TransByEmployee] IS NULL))
ALTER TABLE [dbo].[bPREC] ADD
CONSTRAINT [CK_bPREC_TrueEarns] CHECK (([TrueEarns]='Y' OR [TrueEarns]='N'))
