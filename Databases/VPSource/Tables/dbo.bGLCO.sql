...
ALTER TABLE [dbo].[bGLCO] ADD
CONSTRAINT [CK_bGLCO_AuditAccts] CHECK (([AuditAccts]='Y' OR [AuditAccts]='N'))
ALTER TABLE [dbo].[bGLCO] ADD
CONSTRAINT [CK_bGLCO_AuditAutoJrnl] CHECK (([AuditAutoJrnl]='Y' OR [AuditAutoJrnl]='N'))
ALTER TABLE [dbo].[bGLCO] ADD
CONSTRAINT [CK_bGLCO_AuditBals] CHECK (([AuditBals]='Y' OR [AuditBals]='N'))
ALTER TABLE [dbo].[bGLCO] ADD
CONSTRAINT [CK_bGLCO_AuditBudgets] CHECK (([AuditBudgets]='Y' OR [AuditBudgets]='N'))
ALTER TABLE [dbo].[bGLCO] ADD
CONSTRAINT [CK_bGLCO_AuditCoParams] CHECK (([AuditCoParams]='Y' OR [AuditCoParams]='N'))
ALTER TABLE [dbo].[bGLCO] ADD
CONSTRAINT [CK_bGLCO_AuditDetail] CHECK (([AuditDetail]='Y' OR [AuditDetail]='N'))
ALTER TABLE [dbo].[bGLCO] ADD
CONSTRAINT [CK_bGLCO_Consolid] CHECK (([Consolid]='Y' OR [Consolid]='N'))
ALTER TABLE [dbo].[bGLCO] ADD
CONSTRAINT [CK_bGLCO_Unbal] CHECK (([Unbal]='Y' OR [Unbal]='N'))
ALTER TABLE [dbo].[bGLCO] ADD
CONSTRAINT [CK_bGLCO_XCompJrnlEntryYN] CHECK (([XCompJrnlEntryYN]='Y' OR [XCompJrnlEntryYN]='N'))
GO
...
GO
ALTER TABLE [dbo].[bGLCO] ADD CONSTRAINT [CK_bGLCO_SubLedgerMonth] CHECK (([LastMthGLClsd]<=[LastMthSubClsd]))
GO
...
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bGLCO].[Consolid]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bGLCO].[Unbal]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bGLCO].[AuditCoParams]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bGLCO].[AuditAccts]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bGLCO].[AuditAutoJrnl]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bGLCO].[AuditBals]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bGLCO].[AuditBudgets]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bGLCO].[AuditDetail]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bGLCO].[XCompJrnlEntryYN]'
GO
