...
ALTER TABLE [dbo].[bPRPS] ADD
CONSTRAINT [CK_bPRPS_Bonus] CHECK (([Bonus]='Y' OR [Bonus]='N'))
ALTER TABLE [dbo].[bPRPS] ADD
CONSTRAINT [CK_bPRPS_OverrideDirDep] CHECK (([OverrideDirDep]='Y' OR [OverrideDirDep]='N'))
