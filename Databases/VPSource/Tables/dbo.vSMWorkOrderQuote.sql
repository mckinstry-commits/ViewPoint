...
GO
ALTER TABLE [dbo].[vSMWorkOrderQuote] ADD CONSTRAINT [FK_vSMWorkOrderQuote_bPREH] FOREIGN KEY ([PRCo], [SalesPerson]) REFERENCES [dbo].[bPREH] ([PRCo], [Employee])
GO
ALTER TABLE [dbo].[vSMWorkOrderQuote] ADD CONSTRAINT [FK_vSMWorkOrderQuote_vSMCustomer] FOREIGN KEY ([SMCo], [CustGroup], [Customer]) REFERENCES [dbo].[vSMCustomer] ([SMCo], [CustGroup], [Customer])
GO
ALTER TABLE [dbo].[vSMWorkOrderQuote] ADD CONSTRAINT [FK_vSMWorkOrderQuote_vSMServiceCenter] FOREIGN KEY ([SMCo], [ServiceCenter]) REFERENCES [dbo].[vSMServiceCenter] ([SMCo], [ServiceCenter])
GO
ALTER TABLE [dbo].[vSMWorkOrderQuote] ADD CONSTRAINT [FK_vSMWorkOrderQuote_vSMServiceSite] FOREIGN KEY ([SMCo], [ServiceSite]) REFERENCES [dbo].[vSMServiceSite] ([SMCo], [ServiceSite])
GO
