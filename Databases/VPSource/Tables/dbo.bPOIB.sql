...
ALTER TABLE [dbo].[bPOIB] ADD
CONSTRAINT [CK_bPOIB_OldOrigECM] CHECK (([OldOrigECM]='E' OR [OldOrigECM]='C' OR [OldOrigECM]='M' OR [OldOrigECM] IS NULL))
ALTER TABLE [dbo].[bPOIB] ADD
CONSTRAINT [CK_bPOIB_OldRecvYN] CHECK (([OldRecvYN]='Y' OR [OldRecvYN]='N' OR [OldRecvYN] IS NULL))
ALTER TABLE [dbo].[bPOIB] ADD
CONSTRAINT [CK_bPOIB_OrigECM] CHECK (([OrigECM]='E' OR [OrigECM]='C' OR [OrigECM]='M' OR [OrigECM] IS NULL))
ALTER TABLE [dbo].[bPOIB] ADD
CONSTRAINT [CK_bPOIB_RecvYN] CHECK (([RecvYN]='Y' OR [RecvYN]='N'))
GO
