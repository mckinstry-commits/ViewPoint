...
CREATE UNIQUE CLUSTERED INDEX [biPRPH] ON [dbo].[bPRPH] ([PRCo], [CMCo], [CMAcct], [PayMethod], [CMRef], [CMRefSeq], [EFTSeq]) WITH (FILLFACTOR=90) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [biPRPHCMRef] ON [dbo].[bPRPH] ([CMRef]) WITH (FILLFACTOR=90) ON [PRIMARY]

ALTER TABLE [dbo].[bPRPH] ADD
CONSTRAINT [CK_bPRPH_CMAcct] CHECK (([CMAcct]>(0) AND [CMAcct]<(10000)))
ALTER TABLE [dbo].[bPRPH] ADD
CONSTRAINT [CK_bPRPH_Purge] CHECK (([Purge]='Y' OR [Purge]='N'))
ALTER TABLE [dbo].[bPRPH] ADD
CONSTRAINT [CK_bPRPH_Void] CHECK (([Void]='Y' OR [Void]='N'))
...
EXEC sp_bindrule N'[dbo].[brCMAcct]', N'[dbo].[bPRPH].[CMAcct]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bPRPH].[Void]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bPRPH].[Purge]'
GO
