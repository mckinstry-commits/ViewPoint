...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMAT052    Script Date: 8/28/99 9:33:26 AM ******/
    CREATE proc [dbo].[bspPRMAT052]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @rate = .053, @procname = 'bspPRMAT052', @FICArate = .0765
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMAT052] TO [public]
GO
