...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRGAT04    Script Date: 8/28/99 9:33:20 AM ******/
   CREATE proc [dbo].[bspPRGAT04]
   /********************************************************
   ...
   **********************************************************/
   ...
   IF OBJECT_ID('dbo.bspPRGAT04') IS NOT NULL
       PRINT '<<< CREATED PROCEDURE dbo.bspPRGAT04 >>>'
   ELSE
       PRINT '<<< FAILED CREATING PROCEDURE dbo.bspPRGAT04 >>>'

GO
GRANT EXECUTE ON  [dbo].[bspPRGAT04] TO [public]
GO
