...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRNMT08]    Script Date: 12/13/2007 09:57:23 ******/
   CREATE proc [dbo].[bspPRNMT08]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @allowance = 3450, @procname = 'bspPRNMT08'
   ...
   if @status = 'S'
   	...
   	if @annualized_wage > 17900 select @tax_addition = 504.5, @wage_bracket = 17900, @rate = .049
   end
   ...
   if @status = 'M'
   	...
   	if @annualized_wage > 31250 select @tax_addition = 768, @wage_bracket = 31250, @rate = .049
   end
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNMT08] TO [public]
GO
