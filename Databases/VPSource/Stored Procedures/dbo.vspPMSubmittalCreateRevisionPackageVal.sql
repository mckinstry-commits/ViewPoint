...
CREATE  proc [dbo].[vspPMSubmittalCreateRevisionPackageVal]
/***********************************************************
...
BEGIN
	SET @msg = 'The package must already exist.'
	RETURN 1
END
...
GO
GRANT EXECUTE ON  [dbo].[vspPMSubmittalCreateRevisionPackageVal] TO [public]
GO
