...
CREATE proc [dbo].[cvsp_CMS_PRTH_OT] (@fromco smallint, @toco smallint, 
...
--deleted in cvsp_CMS_PRTH_Regular
...
select PRCo=@toco
	...
	, PostSeq=isnull((select max(PostSeq) 
			...
			where	b.PRCo=@toco
				...
				+ row_number() over(partition by PRTTCH.COMPANYNUMBER, WkEndDate,EMPLOYEENUMBER 
