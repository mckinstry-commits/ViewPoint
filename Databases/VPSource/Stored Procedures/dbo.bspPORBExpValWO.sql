...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPORBExpValWO    Script Date: 8/28/99 9:34:01 AM ******/
   CREATE procedure [dbo].[bspPORBExpValWO]
   /*********************************************
...
GO
GRANT EXECUTE ON  [dbo].[bspPORBExpValWO] TO [public]
GO
