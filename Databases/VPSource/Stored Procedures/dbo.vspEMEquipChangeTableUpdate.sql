...
@vpemco varchar(128),@totalrecords int, @recordschanged int output, @changestatusmsg varchar(256) output,@errmsg varchar(275) output)                   
/****************************************************
...
begin
	select @errmsg = 'Equipment Change Detail record doesnot exist!',@rcode = 1
	goto vspexit
End
...
AND  c.VPTableType Not In ('Aduit','View') and t.TABLE_NAME in (@oldvptable,@newvptable,@udtable)
