...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRWVT02    Script Date: 8/28/99 9:33:37 AM ******/
   CREATE      proc [dbo].[bspPRWVT02]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @allowance = 2000, @procname = 'bspPRWVT02'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRWVT02] TO [public]
GO
