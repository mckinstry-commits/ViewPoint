...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRMET11]    Script Date: 10/26/2007 10:20:46 ******/
   CREATE PROC [dbo].[bspPRMET11]
   /********************************************************
   ...
   **********************************************************/
	...
	-- #142397 defaulting to 'N' rather than passing it in because as of 12/30/2010 we're not prepared 
	-- to approve releasing the change to bspPRProcessState that will pass this value in
	DECLARE @nonresalienyn bYN
	SELECT @nonresalienyn = 'N'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMET11] TO [public]
GO
