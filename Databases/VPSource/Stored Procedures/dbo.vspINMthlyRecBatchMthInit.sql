...
SET ANSI_NULLS ON
GO
CREATE  proc [dbo].[vspINMthlyRecBatchMthInit]
/***********************************************************************************
...
**************************************************************************************/
---- #137438
(@inco TINYINT = 0, @mth bMonth = NULL output, @futuremth bMonth = NULL output, 
...
GO
GRANT EXECUTE ON  [dbo].[vspINMthlyRecBatchMthInit] TO [public]
GO
