...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPR_CA_BCT08]    Script Date: 02/27/2008 13:19:16 ******/
   CREATE  proc [dbo].[bspPR_CA_BCT08]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @calcamt = 0, @procname = 'bspPR_CA_BCT08'
   ...
   if @A <= 70033 select @rate = .0815, @KP = 980
   if @A <= 35016 select @rate = .0535, @KP = 0
...
GO
GRANT EXECUTE ON  [dbo].[bspPR_CA_BCT08] TO [public]
GO
