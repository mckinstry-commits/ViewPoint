...
CREATE            PROC [dbo].[vspDDSLUserColumn]
   /***********************************************************
    * CREATED BY: DANF 03/05/2004
    * MODIFIED By : JRK 11/07/2006 Updated to use vDDSLc rather than DDSL for VP6.
	*			  : JRK renamed to vsp. 
...
GO
GRANT EXECUTE ON  [dbo].[vspDDSLUserColumn] TO [public]
GO
