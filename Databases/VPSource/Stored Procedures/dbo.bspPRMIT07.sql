...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMIT07    Script Date: 8/28/99 9:33:27 AM ******/
  CREATE  proc [dbo].[bspPRMIT07]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @rate = .039,  @procname = 'bspPRMIT07'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMIT07] TO [public]
GO
