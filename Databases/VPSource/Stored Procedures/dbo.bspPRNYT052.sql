...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNYT052    Script Date: 8/28/99 9:33:30 AM ******/
    CREATE proc [dbo].[bspPRNYT052]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @allowance = 1000, @procname = 'bspPRNYT052'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNYT052] TO [public]
GO
