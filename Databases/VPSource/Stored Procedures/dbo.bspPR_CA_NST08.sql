...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPR_CA_NST08]    Script Date: 02/27/2008 13:19:16 ******/
   CREATE  proc [dbo].[bspPR_CA_NST08]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate = 0, @KP = 0, @K1P = 0, @K2P = 0, @T4 = 0, @V1 = 0, @LCP = 0, @T2 = 0
   select @calcamt = 0, @procname = 'bspPR_CA_NST08'
   ...
   select @LCP = case when .2 * @capstock < 1000 then .2 * @capstock else 1000 end
...
GO
GRANT EXECUTE ON  [dbo].[bspPR_CA_NST08] TO [public]
GO
