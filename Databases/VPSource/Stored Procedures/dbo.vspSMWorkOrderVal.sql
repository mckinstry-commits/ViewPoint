...
BEGIN
	...
	IF EXISTS(SELECT 1 FROM vfSMWorkOrderInvoiceDetail(@SMCo, @WorkOrder, null, null, null, null, null, null, null, null, null, null, null, null) WHERE InvoiceDetail IS NULL)
	BEGIN
		SET @isBillable = 'Y'
	END 
