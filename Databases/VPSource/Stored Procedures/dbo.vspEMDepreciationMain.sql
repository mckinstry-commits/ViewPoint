...
*			GF 04/16/2013 TFS-47368 minor change to disposal date message to Month Disposed
*
*			
* USAGE:
	...
	IF @DisposalMonth IS NOT NULL
		BEGIN
			...
			ELSE
				BEGIN
					----TFS-47368             
					SET @errmsg = 'To calculate a Depreciation Schedule - remove Month Disposed and press Calculate again.'
					SET @rcode = 1
				END
			GOTO vspExit
		END
