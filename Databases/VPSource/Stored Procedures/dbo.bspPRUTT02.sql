...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRUTT02    Script Date: 8/28/99 9:33:36 AM ******/
   CREATE   proc [dbo].[bspPRUTT02]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @procname = 'bspPRUTT02'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRUTT02] TO [public]
GO
