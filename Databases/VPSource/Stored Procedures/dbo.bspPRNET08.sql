...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRNET08]    Script Date: 11/07/2007 10:08:51 ******/
    CREATE proc [dbo].[bspPRNET08]
    /********************************************************
    ...
    *				EN 11/7/07 - issue 126098  update effective 1/1/2008
    *
    * USAGE:
    ...
    **********************************************************/
    ...
    select @rcode = 0, @allowance = 1700, @procname = 'bspPRNET08'
    ...
    if @status = 'M'
    	...
    	if @annualized_wage > 23700 select @tax_addition = 538.11, @wage_bracket = 23700, @rate = .0502
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNET08] TO [public]
GO
