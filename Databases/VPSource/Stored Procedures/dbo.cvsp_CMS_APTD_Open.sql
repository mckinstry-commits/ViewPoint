...
CREATE proc [dbo].[cvsp_CMS_APTD_Open] (@fromco smallint, @toco smallint, 
...
from bAPTL l
	...
	join (select distinct APCo=@toco, VENDORNUMBER, PAYMENTSELNO
		from CV_CMS_SOURCE.dbo.APTOPC 
		where COMPANYNUMBER=@fromco and CHECKNUMBER=0 and RECORDCODE<>4) 
		as a
		on l.APCo=a.APCo and h.Vendor=a.VENDORNUMBER and l.udYSN=a.PAYMENTSELNO
	left join APTD d on l.APCo=d.APCo and l.Mth=d.Mth and l.APTrans=d.APTrans and l.APLine=d.APLine
