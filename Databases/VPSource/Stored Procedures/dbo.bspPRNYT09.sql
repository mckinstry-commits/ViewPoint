...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNYT09    Script Date: 8/28/99 9:33:30 AM ******/
  CREATE  proc [dbo].[bspPRNYT09]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @allowance = 1000, @procname = 'bspPRNYT09'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNYT09] TO [public]
GO
