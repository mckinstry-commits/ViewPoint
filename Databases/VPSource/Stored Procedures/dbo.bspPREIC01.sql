...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPREIC01    Script Date: 8/28/99 9:33:34 AM ******/
   CREATE  proc [dbo].[bspPREIC01]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate1 = .204, @rate2 = .09588, @procname = 'bspPREIC01'
   ...
   if @@rowcount = 0 or (@@rowcount = 1 and @EICStatus <> 'S' and @EICStatus <> 'B')
       begin
   ...
   if @EICStatus = 'S'
       select @bracket1 = 7140, @bracket2 = 13090, @maxpayamt = 1457
   if @EICStatus = 'B'
       select @bracket1 = 3570, @bracket2 = 6545, @maxpayamt = 728
...
GO
GRANT EXECUTE ON  [dbo].[bspPREIC01] TO [public]
GO
