...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMIT05    Script Date: 8/28/99 9:33:27 AM ******/
    CREATE proc [dbo].[bspPRMIT05]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @rate = .039,  @procname = 'bspPRMIT05'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMIT05] TO [public]
GO
