...
CREATE   proc [dbo].[vspJCCIValWithUP]
/***********************************************************
* CREATED BY: DANF - 6.X
* MODIFIED By:	GF 04/25/2006 - Added SICode to output params 6.x
*	
*
* USAGE:
...
(@jcco bCompany = 0, @contract bContract = null, @item bContractItem = null,
 ...
 @sicode varchar(16) output, @msg varchar(255) output)
...
select @um = UM, @unitcost = UnitPrice, @msg = i.Description, @sicode=i.SICode
...
GO
GRANT EXECUTE ON  [dbo].[vspJCCIValWithUP] TO [public]
GO
