...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRKYT11]    Script Date: 12/20/2007 07:54:34 ******/
  CREATE proc [dbo].[bspPRKYT11]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @stddedn = 2240, @creditamt = 20
  select @procname = 'bspPRKYT11'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRKYT11] TO [public]
GO
