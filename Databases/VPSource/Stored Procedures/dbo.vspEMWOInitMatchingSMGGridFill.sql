...
/*Unused variables, research, confirm they can be deleted*/
--@comparisonmet varchar(60),
--@curryrfixeddate smalldatetime,
-- @displaydebuginfo char(1),
-- @duedate smalldatetime,
--@earliestlastdonedatethisyear smalldatetime,  
--@equip bEquip, 
--@SMICount smallint, 
--@linkedsmg varchar(10),
--@prioryr varchar(4), 
--@prioryrfixeddate smalldatetime, 	
--@smicopy bItem, 
--@smitest smallint, 
--@sql1 varchar(255), 
--@sql2 varchar(255), 
...
--@NotOnOpenWorkOrders int,
--@results varchar(255)

--Create table variable for final list of Equipment 
create table #DisplaySMGInfo(Equipment varchar(10) null, StdMaintGroup varchar(10) null, SMGDesc varchar(30) null, 
