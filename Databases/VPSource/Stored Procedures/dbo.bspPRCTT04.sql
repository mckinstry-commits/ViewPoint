...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRCTT04    Script Date: 8/28/99 9:33:14 AM ******/
    CREATE     proc [dbo].[bspPRCTT04]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @procname = 'bspPRCTT04'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRCTT04] TO [public]
GO
