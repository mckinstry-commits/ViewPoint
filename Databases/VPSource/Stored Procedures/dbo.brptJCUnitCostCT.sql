...
/****** Object:  Stored Procedure dbo.brptJCUnitCost    Script Date: 8/28/99 9:33:52 AM ******/
     ...
     CREATE        proc [dbo].[brptJCUnitCostCT]
       (@JCCo bCompany, @BeginJob bJob='', @EndJob bJob='zzzzzzzzzz',--@BeginContract bContract ='', @EndContract bContract= 'zzzzzzzzz',
    ...
    with recompile   
   	...
   	Mod 7/21/03  issue not created yet....added NOLOCKS to the From Clause CR 
           ...
           Mod 4/27/05 CR lengthened Phase from 16 to 20 Issue 28502*/ 
...
GO
GRANT EXECUTE ON  [dbo].[brptJCUnitCostCT] TO [public]
GO
