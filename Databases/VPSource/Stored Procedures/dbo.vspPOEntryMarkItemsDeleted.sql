...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[vspPOEntryMarkItemsDeleted]
  /*******************************************************************************************************
  * CREATED BY: 	 DC 6/15/06
  * MODIFIED By :  
  *
  * USAGE:  
  *		This will mark AP lines as delete.  Before 6.x this was a hard coded sql statement
  *		in POEntry.  I did not want to leave it there and created this sp.
  *
  * INPUTS:
  *	@co
  *	@mth
...
GO
GRANT EXECUTE ON  [dbo].[vspPOEntryMarkItemsDeleted] TO [public]
GO
