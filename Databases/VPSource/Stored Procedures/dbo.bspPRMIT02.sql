...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMIT02    Script Date: 8/28/99 9:33:27 AM ******/
   CREATE  proc [dbo].[bspPRMIT02]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate = .041,  @procname = 'bspPRMIT02'
   ...
   select @annualized_wage = (@subjamt * @ppds) - ((@exempts + @addtl_exempts) * 3000)
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMIT02] TO [public]
GO
