...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRAZT032    Script Date: 8/28/99 9:33:12 AM ******/
   CREATE   proc [dbo].[bspPRAZT032]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate = 0, @procname = 'bspPRAZT032'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRAZT032] TO [public]
GO
