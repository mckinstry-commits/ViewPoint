...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRLAT033    Script Date: 8/28/99 9:33:25 AM ******/
   CREATE proc [dbo].[bspPRLAT033]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @exempt = 4500, @credit = 1000, @taxrate1 = .021, @taxrate2 = .0135 select @procname = 'bspPRLAT033'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRLAT033] TO [public]
GO
