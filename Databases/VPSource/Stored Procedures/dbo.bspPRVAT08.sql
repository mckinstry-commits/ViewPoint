...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRVAT08]    Script Date: 12/04/2007 09:01:03 ******/
    CREATE proc [dbo].[bspPRVAT08]
    /********************************************************
	...
	*				EN 12/4/07 - issue 126391  update effective 1/1/2008
    *
    * USAGE:
    * 	Calculates Virginia Income Tax
    *
    * INPUT PARAMETERS:
    ...
    **********************************************************/
    ...
    select @rcode = 0, @deduction = 3000, @allowance1 = 930, @allowance2 = 800, @procname = 'bspPRVAT08'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRVAT08] TO [public]
GO
