...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRLAT03    Script Date: 8/28/99 9:33:25 AM ******/
   CREATE    proc [dbo].[bspPRLAT03]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @exempt = 4500, @credit = 1000, @taxrate1 = .021, @taxrate2 = .0135 select @procname = 'bspPRLAT03'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRLAT03] TO [public]
GO
