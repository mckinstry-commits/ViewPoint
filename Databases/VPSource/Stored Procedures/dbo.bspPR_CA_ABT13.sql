...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPR_CA_ABT13]    Script Date: 02/27/2008 13:19:16 ******/
CREATE  proc [dbo].[bspPR_CA_ABT13]
/********************************************************
* CREATED BY: 	EN	05/15/2008
* MODIFIED BY:	EN	05/15/2009	- #133697 set a default for total claim (@TCP)
...
*				CHS	11/29/2011	- #145152 tax update effective 1/1/2012
*				MV	12/10/2012	- TK-20137 tax update effective 1/1/2013. 
*
* USAGE:
...
BEGIN
	...
	IF @TCP IS NULL SELECT @TCP = 17593
...
GRANT EXECUTE ON  [dbo].[bspPR_CA_ABT13] TO [public]
GO
