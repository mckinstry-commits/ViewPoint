...
select ARCo         = @toco
	...
	, Invoice       = SPACE(10-DATALENGTH(rtrim(C.INVOICENO)))+RTRIM(C.INVOICENO)--INVOICENO
	, Source        = 'AR Invoice'
...
JOIN Viewpoint.dbo.budxrefJCJobs xj
	on xj.COMPANYNUMBER = C.COMPANYNUMBER and xj.DIVISIONNUMBER = C.DIVISIONNUMBER and xj.JOBNUMBER = C.JOBNUMBER
