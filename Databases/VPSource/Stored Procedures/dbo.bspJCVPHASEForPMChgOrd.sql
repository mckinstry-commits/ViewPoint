...
/****** Object:  Stored Procedure dbo.bspJCVPHASEForPMChgOrd   Script Date: 8/28/99 9:35:07 AM ******/
CREATE PROCEDURE [dbo].[bspJCVPHASEForPMChgOrd]
/***********************************************************
* CREATED BY:	GF 03/02/2009 - issue #120115
* MODIFIED By:  AMR 01/19/11 - #142350, making case insensitive by changing OUTPUT @PhaseGroup var
*
*
*
*
...
select @rcode = 0, @item=null, @JCJPexists='N', @msg = ''
...
select @desc = Description, @pphase = Phase, @item = Item, @active = ActiveYN, @inscode=InsCode
...
if @@rowcount = 1
    ...
    select Top 1 @desc = Description, @pphase = Phase, @item = Item
    from bJCJP with (nolock)
...
GO
GRANT EXECUTE ON  [dbo].[bspJCVPHASEForPMChgOrd] TO [public]
GO
