...
*				GF 05/13/2013 TFS-47315 V1099Type only applies for US (NOT CA/AU)
*
*
...
while (@@fetch_status = 0)
	begin
		...
		select @eft = m.EFT, @v1099yn = m.V1099YN,
				----TFS-47315
				@v1099type = CASE WHEN @HQCoDefaultCountry = 'US' THEN m.V1099Type
