...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMIT04    Script Date: 8/28/99 9:33:27 AM ******/
   CREATE    proc [dbo].[bspPRMIT04]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate = .039,  @procname = 'bspPRMIT04'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMIT04] TO [public]
GO
