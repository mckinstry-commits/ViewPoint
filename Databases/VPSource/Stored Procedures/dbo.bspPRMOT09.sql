...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRMOT09]    Script Date: 01/03/2008 10:56:16 ******/
 CREATE proc [dbo].[bspPRMOT09]
 /********************************************************
 ...
 **********************************************************/
 ...
 select @rcode = 0, @rate = 0, @counter = 1, @procname = 'bspPRMOT09', @allowances = 0
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMOT09] TO [public]
GO
