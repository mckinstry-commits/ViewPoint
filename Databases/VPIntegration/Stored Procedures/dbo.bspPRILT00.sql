...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRILT00    Script Date: 8/28/99 9:33:23 AM ******/
   CREATE   proc [dbo].[bspPRILT00]
   /********************************************************
...
GO
GRANT EXECUTE ON  [dbo].[bspPRILT00] TO [public]
GO
