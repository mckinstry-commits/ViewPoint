...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRVTT052    Script Date: 8/28/99 9:33:36 AM ******/
    CREATE proc [dbo].[bspPRVTT052]
     /********************************************************
     ...
     **********************************************************/
     ...
     select @rcode = 0, @procname = 'bspPRVTT052'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRVTT052] TO [public]
GO
