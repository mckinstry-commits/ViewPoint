...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRCTT09]    Script Date: 01/03/2008 16:16:03 ******/
  CREATE proc [dbo].[bspPRCTT09]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @procname = 'bspPRCTT09'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRCTT09] TO [public]
GO
