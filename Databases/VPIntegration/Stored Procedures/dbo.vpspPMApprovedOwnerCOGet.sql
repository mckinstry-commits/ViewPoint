...
CREATE PROCEDURE [dbo].[vpspPMApprovedOwnerCOGet]
/************************************************************
* CREATED:		11/16/06	chs
* MODIFIED:		6/7/07		CHS
*
* USAGE:
*   Returns the PM Approved Owner Change Orders
*
* CALLED FROM:
*	ViewpointCS Portal  
*
...
Select a.KeyID, a.PMCo, a.Project, a.ACO, a.Description, a.ACOSequence, 
	...
	Where a.PMCo=@JCCo and a.Project=@Job and a.IntExt = 'E'
...
GO
GRANT EXECUTE ON  [dbo].[vpspPMApprovedOwnerCOGet] TO [VCSPortal]
GO
