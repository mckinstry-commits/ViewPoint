...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNYT06    Script Date: 8/28/99 9:33:30 AM ******/
  CREATE  proc [dbo].[bspPRNYT06]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @allowance = 1000, @procname = 'bspPRNYT06'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNYT06] TO [public]
GO
