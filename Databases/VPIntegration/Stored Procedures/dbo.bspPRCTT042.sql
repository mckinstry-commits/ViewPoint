...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRCTT042    Script Date: 8/28/99 9:33:14 AM ******/
    CREATE proc [dbo].[bspPRCTT042]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @procname = 'bspPRCTT042'
    ...
    if @status = 'S' --aka. Conn. filing status 'F'
    	begin
    	 if @asubjamt <= 25250 select @exemptamt = 12625
    	 if @asubjamt >= 25250 and @asubjamt <= 37250 select @exemptamt = floor ((38250 - @asubjamt) / 1000) * 1000 - 375
    	end
    ...
    if @amt > @limit select @amt = (@amt - @limit) * .05 + @baseamt
    ...
    if @status = 'S' --issue 18326 these exemptions effective 7/1/02
    	begin
    	 if @asubjamt > 12625 and @asubjamt <=15750 select @pcredits = .75
    	 if @asubjamt > 15750 and @asubjamt <=16250 select @pcredits = .7
    	 if @asubjamt > 16250 and @asubjamt <=16750 select @pcredits = .65
    	 if @asubjamt > 16750 and @asubjamt <=17250 select @pcredits = .6
    	 if @asubjamt > 17250 and @asubjamt <=17750 select @pcredits = .55
    	 if @asubjamt > 17750 and @asubjamt <=18250 select @pcredits = .5
    	 if @asubjamt > 18250 and @asubjamt <=18750 select @pcredits = .45
    	 if @asubjamt > 18750 and @asubjamt <=19250 select @pcredits = .4
    	 if @asubjamt > 19250 and @asubjamt <=21050 select @pcredits = .35
    	 if @asubjamt > 21050 and @asubjamt <=21550 select @pcredits = .3
    	 if @asubjamt > 21550 and @asubjamt <=22050 select @pcredits = .25
    	 if @asubjamt > 22050 and @asubjamt <=22550 select @pcredits = .2
    	 if @asubjamt > 22550 and @asubjamt <=26800 select @pcredits = .15
    	 if @asubjamt > 26300 and @asubjamt <=26500 select @pcredits = .14
    	 if @asubjamt > 26800 and @asubjamt <=27300 select @pcredits = .13
    	 if @asubjamt > 27300 and @asubjamt <=27800 select @pcredits = .12
    	 if @asubjamt > 27800 and @asubjamt <=28300 select @pcredits = .11
    	 if @asubjamt > 28300 and @asubjamt <=50500 select @pcredits = .1
    	 if @asubjamt > 50500 and @asubjamt <=51000 select @pcredits = .09
    	 if @asubjamt > 51000 and @asubjamt <=51500 select @pcredits = .08
    	 if @asubjamt > 51500 and @asubjamt <=52000 select @pcredits = .07
    	 if @asubjamt > 52000 and @asubjamt <=52500 select @pcredits = .06
    	 if @asubjamt > 52500 and @asubjamt <=53000 select @pcredits = .05
    	 if @asubjamt > 53000 and @asubjamt <=53500 select @pcredits = .04
    	 if @asubjamt > 53500 and @asubjamt <=54000 select @pcredits = .03
    	 if @asubjamt > 54000 and @asubjamt <=54500 select @pcredits = .02
    	 if @asubjamt > 54500 and @asubjamt <=55000 select @pcredits = .01
    	 if @asubjamt > 55000 select @pcredits = 0
    	end
...
GO
GRANT EXECUTE ON  [dbo].[bspPRCTT042] TO [public]
GO
