...
insert bJCJP (JCCo, Job, PhaseGroup, Phase, Description, Contract, Item, ActiveYN,udSource,udConv,udCGCTable,udCGCTableID)
...
from CV_CMS_SOURCE.dbo.JCTMST j with(nolock)
join Viewpoint.dbo.budxrefPhase x
	on x.oldPhase=j.JCDISTRIBTUION and x.Company=j.COMPANYNUMBER
