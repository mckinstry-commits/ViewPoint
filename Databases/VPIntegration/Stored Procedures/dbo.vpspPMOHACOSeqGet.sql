...
/****** Object:  Stored Procedure dbo.vpspPMOHACOSeqGet    Script Date: 11/15/2005 ******/
CREATE proc dbo.vpspPMOHACOSeqGet
/*************************************
...
@project bJob, 
@aco bACO,
@acoseq smallint = 0 output, 
@dfltstatus varchar(6) = null output, 
...
GO
GRANT EXECUTE ON  [dbo].[vpspPMOHACOSeqGet] TO [VCSPortal]
GO
