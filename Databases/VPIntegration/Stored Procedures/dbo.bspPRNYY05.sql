...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNYY05    Script Date: 8/28/99 9:33:31 AM ******/
     CREATE proc [dbo].[bspPRNYY05]
     /********************************************************
     ...
     **********************************************************/
     ...
     select @rcode = 0, @allowance = 1000, @procname = 'bspPRNYY05'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNYY05] TO [public]
GO
