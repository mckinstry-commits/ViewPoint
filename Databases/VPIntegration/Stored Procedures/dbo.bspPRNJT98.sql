...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNJT98    Script Date: 8/28/99 9:33:29 AM ******/
   CREATE  proc [dbo].[bspPRNJT98]
   /********************************************************
   ...
   * USAGE:
   * 	Calculates 1998 New Jersey Income Tax
   *
   * INPUT PARAMETERS:
   ...
   **********************************************************/
   ...
   select @rcode = 0, @allowance = 1000, @procname = 'bspPRNJT98'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNJT98] TO [public]
GO
