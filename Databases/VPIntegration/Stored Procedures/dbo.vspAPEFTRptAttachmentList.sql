...
CREATE            PROC [dbo].[vspAPEFTRptAttachmentList]
    /************************************
	...
	*
    * This SP is called from form APEFT to return a list of BatchSeq with vendor info
    *
    ***********************************/
(
  @apco bCompany,
...
GO
GRANT EXECUTE ON  [dbo].[vspAPEFTRptAttachmentList] TO [public]
GO
