...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPREIC07    Script Date: 8/28/99 9:33:34 AM ******/
  CREATE  proc [dbo].[bspPREIC07]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @rate1 = .204, @rate2 = .09588, @procname = 'bspPREIC07'
  ...
  if @EICStatus = 'S'
      select @bracket1 = 8390, @bracket2 = 15390, @maxpayamt = 1712
  if @EICStatus = 'M'
      select @bracket1 = 8390, @bracket2 = 17390, @maxpayamt = 1712
  if @EICStatus = 'B'
      select @bracket1 = 4195, @bracket2 = 8695, @maxpayamt = 856
...
GO
GRANT EXECUTE ON  [dbo].[bspPREIC07] TO [public]
GO
