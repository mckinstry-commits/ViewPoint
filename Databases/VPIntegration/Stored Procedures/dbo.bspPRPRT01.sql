...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRPRT01    Script Date: 8/28/99 9:33:32 AM ******/
      CREATE  proc [dbo].[bspPRPRT01]
      /********************************************************
      ...
      **********************************************************/
      ...
      select @rcode = 0, @procname = 'bspPRPRT01'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRPRT01] TO [public]
GO
