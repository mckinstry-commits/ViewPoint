...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRDCT10]    Script Date: 01/10/2008 09:49:01 ******/
     CREATE  proc [dbo].[bspPRDCT10]
     /********************************************************
	...
	*			EN 1/22/2010 #137613  update effective 1/1/2010
     ...
     **********************************************************/
     ...
     select @rcode = 0, @procname = 'bspPRDCT10'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRDCT10] TO [public]
GO
