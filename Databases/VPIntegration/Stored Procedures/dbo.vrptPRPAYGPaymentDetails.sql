...
(	 SortValue, PreLoadedData, RecType, PRCo, TaxYear, Employee, BeginDate, EndDate, SummarySeq
...
(
SELECT 	 
	 j.SortValue, j.PreLoadedData, j.RecType, j.PRCo, j.TaxYear, j.Employee, j.BeginDate, j.EndDate, j.SummarySeq
