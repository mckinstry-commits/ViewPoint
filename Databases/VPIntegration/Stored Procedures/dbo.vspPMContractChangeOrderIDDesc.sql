...
SET ANSI_NULLS ON
GO
CREATE  proc [dbo].[vspPMContractChangeOrderIDDesc]
/***********************************************************
* CREATED BY:	GP	04/11/2011
* MODIFIED BY:	
*				
* USAGE:
* Used in PM Contract Change Order to return the description of the ID field.
*
* INPUT PARAMETERS
*   PMCo   
*   Contract
...
GO
GRANT EXECUTE ON  [dbo].[vspPMContractChangeOrderIDDesc] TO [public]
GO
