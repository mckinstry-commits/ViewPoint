...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMDT02    Script Date: 8/28/99 9:33:26 AM ******/
   CREATE  proc [dbo].[bspPRMDT02]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate = 0, @procname = 'bspPRMDT02'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMDT02] TO [public]
GO
