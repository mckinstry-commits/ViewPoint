...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMIT03    Script Date: 8/28/99 9:33:27 AM ******/
   CREATE   proc [dbo].[bspPRMIT03]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate = .04,  @procname = 'bspPRMIT03'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMIT03] TO [public]
GO
