...
select PRCo=@toco
	...
	, PostSeq=isnull((select max(PostSeq) 
						...
						where b.PREndDate=PRTTCH.WkEndDate and b.Employee=PRTTCH.EMPLOYEENUMBER),0) 
							+row_number() over(partition by COMPANYNUMBER, PRTTCH.WkEndDate,EMPLOYEENUMBER 
									order by COMPANYNUMBER, PRTTCH.WkEndDate,EMPLOYEENUMBER)
	, Type='J'
...
order by COMPANYNUMBER, EMPLOYEENUMBER, PRTTCH.WkEndDate;
