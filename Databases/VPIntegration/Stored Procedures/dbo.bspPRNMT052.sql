...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNMT052    Script Date: 8/28/99 9:33:30 AM ******/
    CREATE proc [dbo].[bspPRNMT052]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @allowance = 3250, @procname = 'bspPRNMT052'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNMT052] TO [public]
GO
