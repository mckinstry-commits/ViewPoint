...
/****** Object:  Stored Procedure dbo.bspSLXBPost    Script Date: 8/28/99 9:36:38 AM ******/
   ...
   ************************************************************************/   
   ...
   declare @rcode int, @SLxbcursor tinyint, @tablename char(20),
   	...
   	@jcum bUM, @SLitcursor tinyint, @bounits bUnits,
   ...
   posting_loopa:
   	...
   	declare bcSLIT cursor for select SLItem, CurCost, CurUnits, CurUnitCost,
   		InvUnits, InvCost, UM
   	...
   	item_loopa:
   	fetch next from bcSLIT into @SLitem, @bocost, @bounits, @curunitcost,
   		@invunits, @invcost, @um
