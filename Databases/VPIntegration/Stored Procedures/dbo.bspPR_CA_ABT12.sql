...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPR_CA_ABT12]    Script Date: 02/27/2008 13:19:16 ******/
CREATE  proc [dbo].[bspPR_CA_ABT12]
/********************************************************
...
BEGIN
	...
	IF @TCP IS NULL SELECT @TCP = 17282
...
END
GO
GRANT EXECUTE ON  [dbo].[bspPR_CA_ABT12] TO [public]
GO
