...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRAZT02    Script Date: 8/28/99 9:33:12 AM ******/
   CREATE     proc [dbo].[bspPRAZT02]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @rate = 0, @procname = 'bspPRAZT02'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRAZT02] TO [public]
GO
