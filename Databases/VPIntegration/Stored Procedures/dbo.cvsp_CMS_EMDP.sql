...
TtlToDepr, MonthDisposed, PurchasePrice, ResidualValue, SalePrice, AccumDeprAcct, DeprExpAcct, DeprAssetAcct,
 GLCo, Notes, UseResidualVal, udSource,udConv,udCGCTable,udCGCTableID/*, udPurchase, udMonths, udResidValue, udCGCDeprTaken*/)
 
 select @toco
 , Equipment = T.EQUIPMENTNUMBER
 , Asset = T.EQUIPMENTNUMBER
 , Description = T.DESC25A
 ...
 from CV_CMS_SOURCE.dbo.EQTDNM M
  join CV_CMS_SOURCE.dbo.EQTMST T on  M.COMPANYNUMBER=T.COMPANYNUMBER and M.EQUIPMENTNUMBER=T.EQUIPMENTNUMBER
 join Viewpoint.dbo.budxrefGLAcct Accum on Accum.Company = @fromco and Accum.oldGLAcct=M.RESVGLACCTNO
 join Viewpoint.dbo.budxrefGLAcct Asset on Asset.Company = @fromco and Asset.oldGLAcct=M.ASSETGLACCT
 join Viewpoint.dbo.budxrefGLAcct Expense on Expense.Company = @fromco and Expense.oldGLAcct=M.GLEXPENSEACCTNO
