...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRKYT08]    Script Date: 12/20/2007 07:54:34 ******/
  CREATE proc [dbo].[bspPRKYT08]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @stddedn = 2100, @creditamt = 20
  select @procname = 'bspPRKYT08'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRKYT08] TO [public]
GO
