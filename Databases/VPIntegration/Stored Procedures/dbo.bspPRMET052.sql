...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRMET052   Script Date: 8/28/99 9:33:27 AM ******/
    CREATE proc [dbo].[bspPRMET052]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @dedn = 2850, @procname = 'bspPRMET052'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMET052] TO [public]
GO
