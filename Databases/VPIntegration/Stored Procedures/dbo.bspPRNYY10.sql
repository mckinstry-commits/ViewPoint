...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNYY10    Script Date: 8/28/99 9:33:31 AM ******/
   CREATE  proc [dbo].[bspPRNYY10]
   /********************************************************
   ...
   **********************************************************/
   ...
   select @rcode = 0, @allowance = 1000, @procname = 'bspPRNYY10'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNYY10] TO [public]
GO
