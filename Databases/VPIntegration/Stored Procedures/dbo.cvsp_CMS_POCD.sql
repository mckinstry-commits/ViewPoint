...
join CV_CMS_SOURCE.dbo.POTMDT d
	on d.COMPANYNUMBER=c.COMPANYNUMBER and d.PONUMBER=c.PONUMBER and d.POITEMT=c.POITEMT and d.SEQUENCENO02=c.SEQUENCENO02
join bPOIT it
	on it.PO=c.PONUMBER and it.POItem=c.POITEMT and it.POCo=@fromco
