...
* Description:	Sends notification to given user as part of PMMF PO approval process
...
*				6/05/2012 - Nels H. - bugfix, changed comment query to use correct tables
*									- added initialization for variable to fix a rare bug
...
*
*****************************************************/
CREATE PROCEDURE [dbo].[vspWFNotifyPMMFApproval] 
...
BEGIN
	...
	where detail.SourceView = 'PMMF'
		...
		-- This prevents interfaced items from being returned
		and item.InterfaceDate is null	
...
GO
GRANT EXECUTE ON  [dbo].[vspWFNotifyPMMFApproval] TO [public]
GO
