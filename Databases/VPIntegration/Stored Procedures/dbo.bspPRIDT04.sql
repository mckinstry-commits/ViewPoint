...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRIDT04    Script Date: 8/28/99 9:33:22 AM ******/
   CREATE    proc [dbo].[bspPRIDT04]
   /********************************************************
...
GO
GRANT EXECUTE ON  [dbo].[bspPRIDT04] TO [public]
GO
