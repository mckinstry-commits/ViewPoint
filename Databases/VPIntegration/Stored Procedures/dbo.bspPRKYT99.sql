...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRKYT99    Script Date: 8/28/99 9:33:25 AM ******/
   CREATE  proc [dbo].[bspPRKYT99]
   /********************************************************
   * CREATED BY: 	EN 12/16/98
   ...
   **********************************************************/
   ...
   select @rcode = 0, @stddedn = 1500, @creditamt = 20
   select @procname = 'bspPRKYT99'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRKYT99] TO [public]
GO
