...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[vpspPMDailyActivityLogInsert]
/************************************************************
* CREATED:		6/13/06	CHS
* MODIFIED		6/6/07	chs
*		TRL  07/27/2011  TK-07143  Expand bPO parameters/varialbles to varchar(30)
* USAGE:
*   Inserts PM Daily Activity Log
*
* CALLED FROM:
*	ViewpointCS Portal  
*   
...
execute vpspPMDailyActivityLogGet @PMCo, @Project, @DailyLog, @LogDate, @VendorGroup, @KeyID
GO
GRANT EXECUTE ON  [dbo].[vpspPMDailyActivityLogInsert] TO [VCSPortal]
GO
