...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[vspJBCheckRateContraintJBLO]
...
(@jbco bCompany, @template varchar(10) = null, @category varchar(20) = null,
	@byemployeeYN bYN = null, @prco bCompany = null, @employee bEmployee = null, @byclassYN bYN = null, @class bClass = null,
	@bycraftYN bYN = null, @craft bCraft = null, @byearntypeYN bYN = null, @earntype bEarnType = null, @byfactorYN bYN = null, @factor bRate = null,
...
if exists(select 1
	...
	where JBCo = @jbco and Template = @template and LaborCategory = @category  
		and RestrictByEmployee = @byemployeeYN and isnull(PRCo, 0) = isnull(@prco, 0) and isnull(Employee, -1) = isnull(@employee, -1) 
		and RestrictByClass = @byclassYN and isnull(Class, '') = isnull(@class, '')
		and RestrictByCraft = @bycraftYN and isnull(Craft, '') = isnull(@craft, '') 
...
GO
GRANT EXECUTE ON  [dbo].[vspJBCheckRateContraintJBLO] TO [public]
GO
