...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPR_AU_PAYG12]    Script Date: 07/21/2011 13:42:32 ******/
   CREATE PROC [dbo].[bspPR_AU_PAYG12]
/********************************************************
...
BEGIN
	IF		@x BETWEEN    0 AND   44.99 SELECT @a = .1900, @b =    .1900
	ELSE IF @x BETWEEN   45 AND  360.99 SELECT @a = .2216, @b =   1.4232
	ELSE IF @x BETWEEN  361 AND  593.99 SELECT @a = .3427, @b =  45.2055
	ELSE IF @x BETWEEN  594 AND  700.99 SELECT @a = .3827, @b =  45.2055
	ELSE IF @x BETWEEN  701 AND  808.99 SELECT @a = .3877, @b =  45.2055
	ELSE IF @x BETWEEN  809 AND  869.99 SELECT @a = .3927, @b =  45.2055
	ELSE IF @x BETWEEN  870 AND  931.99 SELECT @a = .3977, @b =  45.2055
	ELSE IF @x BETWEEN  932 AND  960.99 SELECT @a = .3950, @b =  42.6890
	ELSE IF @x BETWEEN  961 AND 1069.99 SELECT @a = .4000, @b =  42.6890
	ELSE IF @x BETWEEN 1070 AND 1144.99 SELECT @a = .4050, @b =  42.6890
	ELSE IF @x BETWEEN 1145 AND 1187.99 SELECT @a = .4100, @b =  42.6890
	ELSE IF @x BETWEEN 1188 AND 1294.99 SELECT @a = .4550, @b =  96.1698
	ELSE IF @x BETWEEN 1295 AND 1402.99 SELECT @a = .4600, @b =  96.1698
	ELSE IF @x BETWEEN 1403 AND 3110.99 SELECT @a = .4650, @b =  96.1698
...
BEGIN
	...
	ELSE IF @x BETWEEN   45 AND  360.99 SELECT @a = .2216, @b =   1.4232
	ELSE IF @x BETWEEN  361 AND  593.99 SELECT @a = .3427, @b =  45.2055
	ELSE IF @x BETWEEN  594 AND  808.99 SELECT @a = .3627, @b =  45.2055
	ELSE IF @x BETWEEN  809 AND  931.99 SELECT @a = .3727, @b =  45.2055
	ELSE IF @x BETWEEN  932 AND 1187.99 SELECT @a = .3700, @b =  42.6890
	ELSE IF @x BETWEEN 1188 AND 1294.99 SELECT @a = .4150, @b =  96.1698
	ELSE IF @x BETWEEN 1295 AND 3110.99 SELECT @a = .4250, @b =  96.1698
...
BEGIN
	...
	ELSE IF @x BETWEEN   45 AND  360.99 SELECT @a = .2216, @b =   1.4232
	ELSE IF @x BETWEEN  361 AND  593.99 SELECT @a = .3427, @b =  45.2055
	ELSE IF @x BETWEEN  594 AND  700.99 SELECT @a = .4027, @b =  45.2055
	ELSE IF @x BETWEEN  701 AND  808.99 SELECT @a = .4077, @b =  45.2055
	ELSE IF @x BETWEEN  809 AND  869.99 SELECT @a = .4227, @b =  45.2055
	ELSE IF @x BETWEEN  870 AND  931.99 SELECT @a = .4277, @b =  45.2055
	ELSE IF @x BETWEEN  932 AND  960.99 SELECT @a = .4250, @b =  42.6890
	ELSE IF @x BETWEEN  961 AND 1069.99 SELECT @a = .4300, @b =  42.6890
	ELSE IF @x BETWEEN 1070 AND 1144.99 SELECT @a = .4350, @b =  42.6890
	ELSE IF @x BETWEEN 1145 AND 1187.99 SELECT @a = .4400, @b =  42.6890
	ELSE IF @x BETWEEN 1188 AND 1294.99 SELECT @a = .4850, @b =  96.1698
	ELSE IF @x BETWEEN 1295 AND 1402.99 SELECT @a = .5000, @b =  96.1698
	ELSE IF @x BETWEEN 1403 AND 3110.99 SELECT @a = .5050, @b =  96.1698
...
BEGIN
	...
	ELSE IF @x BETWEEN  355 AND  394.99 SELECT @a = .1900, @b =  67.4625
...
BEGIN
	...
	ELSE IF @x BETWEEN  395 AND  463.99 SELECT @a = .2900, @b = 106.9673
	ELSE IF @x BETWEEN  464 AND  710.99 SELECT @a = .2050, @b =  67.4636
	ELSE IF @x BETWEEN  711 AND  943.99 SELECT @a = .3427, @b = 165.4424
	ELSE IF @x BETWEEN  944 AND 1050.99 SELECT @a = .3827, @b = 165.4424
	ELSE IF @x BETWEEN 1051 AND 1158.99 SELECT @a = .3877, @b = 165.4424
	ELSE IF @x BETWEEN 1159 AND 1219.99 SELECT @a = .3927, @b = 165.4424
	ELSE IF @x BETWEEN 1220 AND 1281.99 SELECT @a = .3977, @b = 165.4424
	ELSE IF @x BETWEEN 1282 AND 1310.99 SELECT @a = .3950, @b = 161.9809
	ELSE IF @x BETWEEN 1311 AND 1419.99 SELECT @a = .4000, @b = 161.9809
	ELSE IF @x BETWEEN 1420 AND 1494.99 SELECT @a = .4050, @b = 161.9809
	ELSE IF @x BETWEEN 1495 AND 1537.99 SELECT @a = .4100, @b = 161.9809
	ELSE IF @x BETWEEN 1538 AND 1644.99 SELECT @a = .4550, @b = 231.2116
	ELSE IF @x BETWEEN 1645 AND 1752.99 SELECT @a = .4600, @b = 231.2116
	ELSE IF @x BETWEEN 1753 AND 3460.99 SELECT @a = .4650, @b = 231.2116
...
BEGIN
	...
	ELSE IF @x BETWEEN  464 AND  710.99 SELECT @a = .2050, @b =  67.4636
	ELSE IF @x BETWEEN  711 AND  943.99 SELECT @a = .3427, @b = 165.4424
	ELSE IF @x BETWEEN  944 AND 1158.99 SELECT @a = .3627, @b = 165.4424
	ELSE IF @x BETWEEN 1159 AND 1281.99 SELECT @a = .3727, @b = 165.4424
	ELSE IF @x BETWEEN 1282 AND 1537.99 SELECT @a = .3700, @b = 161.9809
	ELSE IF @x BETWEEN 1538 AND 1644.99 SELECT @a = .4150, @b = 231.2116
	ELSE IF @x BETWEEN 1645 AND 3460.99 SELECT @a = .4250, @b = 231.2116
	ELSE SELECT								   @a = .5450, @b = 508.1347
END
...
BEGIN
	...
	ELSE IF @x BETWEEN  464 AND  710.99 SELECT @a = .2050, @b =  67.4636
	ELSE IF @x BETWEEN  711 AND  943.99 SELECT @a = .3427, @b = 165.4424
	ELSE IF @x BETWEEN  944 AND 1050.99 SELECT @a = .4027, @b = 165.4424
	ELSE IF @x BETWEEN 1051 AND 1158.99 SELECT @a = .4077, @b = 165.4424
	ELSE IF @x BETWEEN 1159 AND 1219.99 SELECT @a = .4227, @b = 165.4424
	ELSE IF @x BETWEEN 1220 AND 1281.99 SELECT @a = .4277, @b = 165.4424
	ELSE IF @x BETWEEN 1282 AND 1310.99 SELECT @a = .4250, @b = 161.9809
	ELSE IF @x BETWEEN 1311 AND 1419.99 SELECT @a = .4300, @b = 161.9809
	ELSE IF @x BETWEEN 1420 AND 1494.99 SELECT @a = .4350, @b = 161.9809
	ELSE IF @x BETWEEN 1495 AND 1537.99 SELECT @a = .4400, @b = 161.9809
	ELSE IF @x BETWEEN 1538 AND 1644.99 SELECT @a = .4850, @b = 231.2116
	ELSE IF @x BETWEEN 1645 AND 1752.99 SELECT @a = .5000, @b = 231.2116
	ELSE IF @x BETWEEN 1753 AND 3460.99 SELECT @a = .5050, @b = 231.2116
...
BEGIN
	IF		@x BETWEEN    0 AND  943.99 SELECT @a = .3250, @b =    .3250
	ELSE IF @x BETWEEN  944 AND 1050.99 SELECT @a = .3650, @b =    .3250
	ELSE IF @x BETWEEN 1051 AND 1158.99 SELECT @a = .3700, @b =    .3250
	ELSE IF @x BETWEEN 1159 AND 1219.99 SELECT @a = .3750, @b =    .3250
	ELSE IF @x BETWEEN 1220 AND 1310.99 SELECT @a = .3800, @b =    .3250
	ELSE IF @x BETWEEN 1311 AND 1419.99 SELECT @a = .3850, @b =    .3250
	ELSE IF @x BETWEEN 1420 AND 1494.99 SELECT @a = .3900, @b =    .3250
	ELSE IF @x BETWEEN 1495 AND 1537.99 SELECT @a = .3950, @b =    .3250
	ELSE IF @x BETWEEN 1538 AND 1644.99 SELECT @a = .4400, @b =  69.2308
	ELSE IF @x BETWEEN 1645 AND 1752.99 SELECT @a = .4450, @b =  69.2308
	ELSE IF @x BETWEEN 1753 AND 3460.99 SELECT @a = .4500, @b =  69.2308
	ELSE SELECT								   @a = .5300, @b = 346.1538
END
ELSE IF @Scale = 34 -- SFSS: Foreign residents
BEGIN
	IF	    @x BETWEEN    0 AND  943.99 SELECT @a = .3250, @b =    .3250
	ELSE IF @x BETWEEN  944 AND 1158.99 SELECT @a = .3450, @b =    .3250
	ELSE IF @x BETWEEN 1159 AND 1537.99 SELECT @a = .3550, @b =    .3250
	ELSE IF @x BETWEEN 1538 AND 1644.99 SELECT @a = .4000, @b =  69.2308
	ELSE IF @x BETWEEN 1645 AND 3460.99 SELECT @a = .4100, @b =  69.2308
	ELSE SELECT								   @a = .4900, @b = 346.1538
END
ELSE IF @Scale = 35 -- SSFS & HELP: Foreign residents
BEGIN
	IF		@x BETWEEN    0 AND  943.99 SELECT @a = .3250, @b =    .3250
	ELSE IF @x BETWEEN  944 AND 1050.99 SELECT @a = .3850, @b =    .3250
	ELSE IF @x BETWEEN 1051 AND 1158.99 SELECT @a = .3900, @b =    .3250
	ELSE IF @x BETWEEN 1159 AND 1219.99 SELECT @a = .4050, @b =    .3250
	ELSE IF @x BETWEEN 1220 AND 1310.99 SELECT @a = .4100, @b =    .3250
	ELSE IF @x BETWEEN 1311 AND 1419.99 SELECT @a = .4150, @b =    .3250
	ELSE IF @x BETWEEN 1420 AND 1494.99 SELECT @a = .4200, @b =    .3250
	ELSE IF @x BETWEEN 1495 AND 1537.99 SELECT @a = .4250, @b =    .3250
	ELSE IF @x BETWEEN 1538 AND 1644.99 SELECT @a = .4700, @b =  69.2308
	ELSE IF @x BETWEEN 1645 AND 1752.99 SELECT @a = .4850, @b =  69.2308
	ELSE IF @x BETWEEN 1753 AND 3460.99 SELECT @a = .4900, @b =  69.2308
...
BEGIN
	IF		@x BETWEEN    0 AND  354.99 SELECT @a = 0,	   @b = 0
	ELSE IF @x BETWEEN  355 AND  710.99 SELECT @a = .1900, @b =  67.4635
	ELSE IF @x BETWEEN  711 AND  943.99 SELECT @a = .3277, @b = 165.4423
	ELSE IF @x BETWEEN  944 AND 1050.99 SELECT @a = .3677, @b = 165.4423
	ELSE IF @x BETWEEN 1051 AND 1158.99 SELECT @a = .3727, @b = 165.4423
	ELSE IF @x BETWEEN 1159 AND 1219.99 SELECT @a = .3777, @b = 165.4423
	ELSE IF @x BETWEEN 1220 AND 1281.99 SELECT @a = .3827, @b = 165.4423
	ELSE IF @x BETWEEN 1282 AND 1310.99 SELECT @a = .3800, @b = 161.9808
	ELSE IF @x BETWEEN 1311 AND 1419.99 SELECT @a = .3850, @b = 161.9808
	ELSE IF @x BETWEEN 1420 AND 1494.99 SELECT @a = .3900, @b = 161.9808
	ELSE IF @x BETWEEN 1495 AND 1537.99 SELECT @a = .3950, @b = 161.9808
	ELSE IF @x BETWEEN 1538 AND 1644.99 SELECT @a = .4400, @b = 231.2115
	ELSE IF @x BETWEEN 1645 AND 1752.99 SELECT @a = .4450, @b = 231.2115
	ELSE IF @x BETWEEN 1753 AND 3460.99 SELECT @a = .4500, @b = 231.2115
...
BEGIN
	...
	ELSE IF @x BETWEEN  355 AND  710.99 SELECT @a = .1900, @b =  67.4635
	ELSE IF @x BETWEEN  711 AND  943.99 SELECT @a = .3277, @b = 165.4423
	ELSE IF @x BETWEEN  944 AND 1158.99 SELECT @a = .3477, @b = 165.4423
	ELSE IF @x BETWEEN 1159 AND 1281.99 SELECT @a = .3577, @b = 165.4423
	ELSE IF @x BETWEEN 1282 AND 1537.99 SELECT @a = .3550, @b = 161.9808
	ELSE IF @x BETWEEN 1538 AND 1644.99 SELECT @a = .4000, @b = 231.2115
	ELSE IF @x BETWEEN 1645 AND 3460.99 SELECT @a = .4100, @b = 231.2115
...
BEGIN
	...
	ELSE IF @x BETWEEN  355 AND  710.99 SELECT @a = .1900, @b =  67.4635
	ELSE IF @x BETWEEN  711 AND  943.99 SELECT @a = .3277, @b = 165.4423
	ELSE IF @x BETWEEN  944 AND 1050.99 SELECT @a = .3877, @b = 165.4423
	ELSE IF @x BETWEEN 1051 AND 1158.99 SELECT @a = .3927, @b = 165.4423
	ELSE IF @x BETWEEN 1159 AND 1219.99 SELECT @a = .4077, @b = 165.4423
	ELSE IF @x BETWEEN 1220 AND 1281.99 SELECT @a = .4127, @b = 165.4423
	ELSE IF @x BETWEEN 1282 AND 1310.99 SELECT @a = .4100, @b = 161.9808
	ELSE IF @x BETWEEN 1311 AND 1419.99 SELECT @a = .4150, @b = 161.9808
	ELSE IF @x BETWEEN 1420 AND 1494.99 SELECT @a = .4200, @b = 161.9808
	ELSE IF @x BETWEEN 1495 AND 1537.99 SELECT @a = .4250, @b = 161.9808
	ELSE IF @x BETWEEN 1538 AND 1644.99 SELECT @a = .4700, @b = 231.2115
	ELSE IF @x BETWEEN 1645 AND 1752.99 SELECT @a = .4850, @b = 231.2115
	ELSE IF @x BETWEEN 1753 AND 3460.99 SELECT @a = .4900, @b = 231.2115
...
BEGIN
	...
	ELSE IF @x BETWEEN  629 AND  710.99 SELECT @a = .2400, @b =  98.9471
	ELSE IF @x BETWEEN  711 AND  739.99 SELECT @a = .3777, @b = 196.9260
	ELSE IF @x BETWEEN  740 AND  943.99 SELECT @a = .3352, @b = 165.4425
	ELSE IF @x BETWEEN  944 AND 1050.99 SELECT @a = .3752, @b = 165.4425
	ELSE IF @x BETWEEN 1051 AND 1158.99 SELECT @a = .3802, @b = 165.4425
	ELSE IF @x BETWEEN 1159 AND 1219.99 SELECT @a = .3852, @b = 165.4425
	ELSE IF @x BETWEEN 1220 AND 1281.99 SELECT @a = .3902, @b = 165.4425
	ELSE IF @x BETWEEN 1282 AND 1310.99 SELECT @a = .3875, @b = 161.9809
	ELSE IF @x BETWEEN 1311 AND 1419.99 SELECT @a = .3925, @b = 161.9809
	ELSE IF @x BETWEEN 1420 AND 1494.99 SELECT @a = .3975, @b = 161.9809
	ELSE IF @x BETWEEN 1495 AND 1537.99 SELECT @a = .4025, @b = 161.9809
	ELSE IF @x BETWEEN 1538 AND 1644.99 SELECT @a = .4475, @b = 231.2117
	ELSE IF @x BETWEEN 1645 AND 1752.99 SELECT @a = .4525, @b = 231.2117
	ELSE IF @x BETWEEN 1753 AND 3460.99 SELECT @a = .4575, @b = 231.2117
...
BEGIN
	...
	ELSE IF @x BETWEEN  711 AND  739.99 SELECT @a = .3777, @b = 196.9260
	ELSE IF @x BETWEEN  740 AND  943.99 SELECT @a = .3352, @b = 165.4425
	ELSE IF @x BETWEEN  944 AND 1158.99 SELECT @a = .3552, @b = 165.4425
	ELSE IF @x BETWEEN 1159 AND 1281.99 SELECT @a = .3652, @b = 165.4425
	ELSE IF @x BETWEEN 1282 AND 1537.99 SELECT @a = .3625, @b = 161.9809
	ELSE IF @x BETWEEN 1538 AND 1644.99 SELECT @a = .4075, @b = 231.2117
	ELSE IF @x BETWEEN 1645 AND 3460.99 SELECT @a = .4175, @b = 231.2117
...
BEGIN
	...
	ELSE IF @x BETWEEN  711 AND  739.99 SELECT @a = .3777, @b = 196.9260
	ELSE IF @x BETWEEN  740 AND  943.99 SELECT @a = .3352, @b = 165.4425
	ELSE IF @x BETWEEN  944 AND 1050.99 SELECT @a = .3952, @b = 165.4425
	ELSE IF @x BETWEEN 1051 AND 1158.99 SELECT @a = .4002, @b = 165.4425
	ELSE IF @x BETWEEN 1159 AND 1219.99 SELECT @a = .4152, @b = 165.4425
	ELSE IF @x BETWEEN 1220 AND 1281.99 SELECT @a = .4202, @b = 165.4425
	ELSE IF @x BETWEEN 1282 AND 1310.99 SELECT @a = .4175, @b = 161.9809
	ELSE IF @x BETWEEN 1311 AND 1419.99 SELECT @a = .4225, @b = 161.9809
	ELSE IF @x BETWEEN 1420 AND 1494.99 SELECT @a = .4275, @b = 161.9809
	ELSE IF @x BETWEEN 1495 AND 1537.99 SELECT @a = .4325, @b = 161.9809
	ELSE IF @x BETWEEN 1538 AND 1644.99 SELECT @a = .4775, @b = 231.2117
	ELSE IF @x BETWEEN 1645 AND 1752.99 SELECT @a = .4925, @b = 231.2117
	ELSE IF @x BETWEEN 1753 AND 3460.99 SELECT @a = .4975, @b = 231.2117
...
RETURN 0
GO
GRANT EXECUTE ON  [dbo].[bspPR_AU_PAYG12] TO [public]
GO
