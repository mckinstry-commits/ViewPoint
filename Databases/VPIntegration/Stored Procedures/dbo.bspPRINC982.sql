...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRINC982    Script Date: 8/28/99 9:33:23 AM ******/
    CREATE proc [dbo].[bspPRINC982]
    /********************************************************
...
GO
GRANT EXECUTE ON  [dbo].[bspPRINC982] TO [public]
GO
