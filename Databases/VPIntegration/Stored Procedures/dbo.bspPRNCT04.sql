...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRNCT04    Script Date: 8/28/99 9:33:29 AM ******/
    CREATE      proc [dbo].[bspPRNCT04]
    /********************************************************
    ...
    **********************************************************/
    ...
    select @rcode = 0, @procname = 'bspPRNCT04'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRNCT04] TO [public]
GO
