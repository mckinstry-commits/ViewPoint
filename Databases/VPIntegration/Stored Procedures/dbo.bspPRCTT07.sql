...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRCTT07    Script Date: 8/28/99 9:33:14 AM ******/
  CREATE proc [dbo].[bspPRCTT07]
  /********************************************************
  ...
  **********************************************************/
  ...
  select @rcode = 0, @procname = 'bspPRCTT07'
  ...
  if @status = 'S' --aka. Conn. filing status 'F'
  	begin
  	 if @asubjamt <= 25500 select @exemptamt = 12750
  	 if @asubjamt >= 25500 and @asubjamt <= 37500 select @exemptamt = floor ((38500 - @asubjamt) / 1000) * 1000 - 250
  	end
  ...
  if @status = 'S' --issue 18326 these exemptions effective 7/1/02
  	begin
  	 if @asubjamt > 12750 and @asubjamt <=15900 select @pcredits = .75
  	 if @asubjamt > 15900 and @asubjamt <=16400 select @pcredits = .7
  	 if @asubjamt > 16400 and @asubjamt <=16900 select @pcredits = .65
  	 if @asubjamt > 16900 and @asubjamt <=17400 select @pcredits = .6
  	 if @asubjamt > 17400 and @asubjamt <=17900 select @pcredits = .55
  	 if @asubjamt > 17900 and @asubjamt <=18400 select @pcredits = .5
  	 if @asubjamt > 18400 and @asubjamt <=18900 select @pcredits = .45
  	 if @asubjamt > 18900 and @asubjamt <=19400 select @pcredits = .4
  	 if @asubjamt > 19400 and @asubjamt <=21300 select @pcredits = .35
  	 if @asubjamt > 21300 and @asubjamt <=21800 select @pcredits = .3
  	 if @asubjamt > 21800 and @asubjamt <=22300 select @pcredits = .25
  	 if @asubjamt > 22300 and @asubjamt <=22800 select @pcredits = .2
  	 if @asubjamt > 22800 and @asubjamt <=26600 select @pcredits = .15
  	 if @asubjamt > 26600 and @asubjamt <=27100 select @pcredits = .14
  	 if @asubjamt > 27100 and @asubjamt <=27600 select @pcredits = .13
  	 if @asubjamt > 27600 and @asubjamt <=28100 select @pcredits = .12
  	 if @asubjamt > 28100 and @asubjamt <=28600 select @pcredits = .11
  	 if @asubjamt > 28600 and @asubjamt <=51000 select @pcredits = .1
  	 if @asubjamt > 51000 and @asubjamt <=51500 select @pcredits = .09
  	 if @asubjamt > 51500 and @asubjamt <=52000 select @pcredits = .08
  	 if @asubjamt > 52000 and @asubjamt <=52500 select @pcredits = .07
  	 if @asubjamt > 52500 and @asubjamt <=53000 select @pcredits = .06
  	 if @asubjamt > 53000 and @asubjamt <=53500 select @pcredits = .05
  	 if @asubjamt > 53500 and @asubjamt <=54000 select @pcredits = .04
  	 if @asubjamt > 54000 and @asubjamt <=54500 select @pcredits = .03
  	 if @asubjamt > 54500 and @asubjamt <=55000 select @pcredits = .02
  	 if @asubjamt > 55000 and @asubjamt <=55500 select @pcredits = .01
  	 if @asubjamt > 55500 select @pcredits = 0
  	end
...
GO
GRANT EXECUTE ON  [dbo].[bspPRCTT07] TO [public]
GO
