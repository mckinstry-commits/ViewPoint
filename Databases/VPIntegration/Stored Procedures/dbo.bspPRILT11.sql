...
SET ANSI_NULLS ON
GO
/****** Object:  Stored Procedure dbo.bspPRILT11    Script Date: 8/28/99 9:33:23 AM ******/
CREATE PROC [dbo].[bspPRILT11]
/********************************************************/
...
--			@msg varchar(255)
--
--	EXEC	@return_value = [dbo].[bspPRILT11]
--			@subjamt = 1800,
--			@ppds = 52,
--			@status = NULL,
--			@regexempts = 2,
...
SELECT @RegularAllowance = 2000, 
	   @AdditionalAllowance = 1000, 
	   @Rate = .05,
	   @ProcedureName = 'bspPRILT11'
...
GO
GRANT EXECUTE ON  [dbo].[bspPRILT11] TO [public]
GO
