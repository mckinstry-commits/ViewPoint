...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[bspPRMOT08]    Script Date: 01/03/2008 10:56:16 ******/
 CREATE proc [dbo].[bspPRMOT08]
 /********************************************************
 ...
 **********************************************************/
 ...
 select @rcode = 0, @rate = 0, @counter = 1, @procname = 'bspPRMOT08', @allowances = 0
 ...
 if @status = 'S'
 begin
 	select @dedn = 5450, @fedlimit = 5000, @allowances = 1200 * @exempts
 ...
 if @status = 'M'
 begin
 	select @dedn = 10900, @fedlimit = 10000, @allowances = 1200 * @exempts
 ...
 if @status = 'H'
 begin
 	select @dedn = 8000, @fedlimit = 5000
...
GO
GRANT EXECUTE ON  [dbo].[bspPRMOT08] TO [public]
GO
