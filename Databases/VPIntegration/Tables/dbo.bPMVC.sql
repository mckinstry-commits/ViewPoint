...
GO
ALTER TABLE [dbo].[bPMVC] ADD CONSTRAINT [PK_bPMVC] PRIMARY KEY CLUSTERED  ([ViewName], [Form], [ColSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMVC] ([KeyID]) ON [PRIMARY]
GO
