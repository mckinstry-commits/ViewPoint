...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMDR] ON [dbo].[bEMDR] ([EMCo], [Department], [EMGroup], [RevCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMDR] ([KeyID]) ON [PRIMARY]
GO
