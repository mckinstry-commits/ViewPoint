...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRWL] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRWL] ON [dbo].[bPRWL] ([PRCo], [TaxYear], [Employee], [State], [LocalCode]) ON [PRIMARY]
GO
