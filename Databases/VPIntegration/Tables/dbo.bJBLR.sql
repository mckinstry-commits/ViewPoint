...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biJBLR_EarnFactShift] ON [dbo].[bJBLR] ([JBCo], [LaborCategory], [Template], [RestrictByEarn], [EarnType], [RestrictByFactor], [Factor], [RestrictByShift], [Shift]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biJBLR] ON [dbo].[bJBLR] ([JBCo], [Template], [LaborCategory], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBLR] ([KeyID]) ON [PRIMARY]
GO
