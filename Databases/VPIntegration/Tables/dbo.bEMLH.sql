...
/****** Object:  Trigger dbo.btEMLHu    Script Date: 8/28/99 9:37:18 AM ******/
...
GO
CREATE NONCLUSTERED INDEX [biEMLHDate] ON [dbo].[bEMLH] ([EMCo], [Equipment], [DateIn], [TimeIn]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biEMLH] ON [dbo].[bEMLH] ([EMCo], [Month], [Trans]) ON [PRIMARY]
GO
