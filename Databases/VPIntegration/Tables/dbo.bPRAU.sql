...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRAU] ([KeyID]) ON [PRIMARY]
GO
CREATE CLUSTERED INDEX [biPRAU] ON [dbo].[bPRAU] ([PRCo], [LeaveCode], [EarnCode], [Type]) ON [PRIMARY]
GO
