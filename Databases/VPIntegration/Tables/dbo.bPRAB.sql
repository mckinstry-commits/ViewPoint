...
GO
CREATE UNIQUE CLUSTERED INDEX [biPRAB] ON [dbo].[bPRAB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRAB] ([KeyID]) ON [PRIMARY]
GO
