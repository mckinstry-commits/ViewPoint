...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPREL] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPREL] ON [dbo].[bPREL] ([PRCo], [Employee], [LeaveCode]) ON [PRIMARY]
GO
