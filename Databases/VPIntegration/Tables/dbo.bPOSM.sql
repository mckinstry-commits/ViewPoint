...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPOSM] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPOSM] ON [dbo].[bPOSM] ([VendorGroup], [Vendor], [MatlGroup], [Material], [UM], [VendMatId]) ON [PRIMARY]
GO
