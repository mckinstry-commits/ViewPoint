...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPOVC] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPOVC] ON [dbo].[bPOVC] ([VendorGroup], [Vendor], [MatlGroup], [Category]) ON [PRIMARY]
GO
