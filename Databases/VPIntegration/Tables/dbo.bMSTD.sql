...
GO
CREATE NONCLUSTERED INDEX [biMSTDMSInv] ON [dbo].[bMSTD] ([MSCo], [Mth], [MSInv]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biMSTD] ON [dbo].[bMSTD] ([MSCo], [Mth], [MSTrans]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biMSTDSaleDate] ON [dbo].[bMSTD] ([MSCo], [Mth], [SaleDate], [HaulerType]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bMSTD_SurchargeKeyID] ON [dbo].[bMSTD] ([SurchargeKeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biMSTDTicket] ON [dbo].[bMSTD] ([Ticket], [MSCo]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bMSTD_UniqueAttchID] ON [dbo].[bMSTD] ([UniqueAttchID]) ON [PRIMARY]
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bMSTD].[Hold]'
GO
EXEC sp_bindrule N'[dbo].[brECM]', N'[dbo].[bMSTD].[ECM]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bMSTD].[Void]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bMSTD].[VerifyHaul]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bMSTD].[AuditYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bMSTD].[Purge]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bMSTD].[Changed]'
GO
