...
GO
ALTER TABLE [dbo].[vPRAllowanceRules] ADD CONSTRAINT [PK_vPRAllowanceRules] PRIMARY KEY CLUSTERED  ([PRCo], [AllowanceRuleName], [AllowanceRulesetName]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_vPRAllowanceRules_AllowanceRulesetName] ON [dbo].[vPRAllowanceRules] ([AllowanceRulesetName]) ON [PRIMARY]
GO
