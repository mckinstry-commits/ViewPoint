...
GO
ALTER TABLE [dbo].[vWFChecklistSteps] ADD CONSTRAINT [PK_vWFChecklistSteps] PRIMARY KEY NONCLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_vWFChecklistSteps_Tasklist] ON [dbo].[vWFChecklistSteps] ([IsStepRequired], [Status]) INCLUDE ([Checklist], [Company], [Step], [Task]) ON [PRIMARY]
GO
CREATE CLUSTERED INDEX [IX_vWFChecklistSteps] ON [dbo].[vWFChecklistSteps] ([Step], [Task], [Checklist], [Company]) ON [PRIMARY]
GO
