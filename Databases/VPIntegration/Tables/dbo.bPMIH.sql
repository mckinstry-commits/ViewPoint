...
/*--------------------------------------------------------------
   ...
   RETURN 
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMIH] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMIH] ON [dbo].[bPMIH] ([PMCo], [Project], [Issue], [Seq]) ON [PRIMARY]
GO
