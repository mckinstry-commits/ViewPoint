...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMML] ON [dbo].[bEMSL] ([EMCo], [Equipment], [StdMaintGroup], [LinkedMaintGrp]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMSL] ([KeyID]) ON [PRIMARY]
GO
