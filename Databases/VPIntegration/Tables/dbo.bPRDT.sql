...
GO
CREATE NONCLUSTERED INDEX [biPRDTEmployee] ON [dbo].[bPRDT] ([Employee], [PRCo], [PRGroup]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bPRDT_PrcoEmpEDLOldAmt_PrintCheck] ON [dbo].[bPRDT] ([PRCo], [Employee], [EDLType], [EDLCode], [OldMth], [PREndDate], [PaySeq]) INCLUDE ([OldAmt]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRDT] ON [dbo].[bPRDT] ([PRCo], [PRGroup], [PREndDate], [Employee], [PaySeq], [EDLType], [EDLCode]) ON [PRIMARY]
GO
