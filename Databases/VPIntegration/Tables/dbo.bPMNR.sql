...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMNR] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMNR] ON [dbo].[bPMNR] ([PMCo], [Project], [NoteSeq], [Reviewer]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biPMNRReviewers] ON [dbo].[bPMNR] ([Reviewer]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[bPMNR] WITH NOCHECK ADD CONSTRAINT [FK_bPMNR_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
