...
GO
CREATE UNIQUE CLUSTERED INDEX [biAPUL] ON [dbo].[bAPUL] ([APCo], [UIMth], [UISeq], [Line]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPUL] ([KeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bAPUL_SLDetailKeyID] ON [dbo].[bAPUL] ([SLDetailKeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bAPUL_SLKeyID] ON [dbo].[bAPUL] ([SLKeyID]) ON [PRIMARY]
GO
