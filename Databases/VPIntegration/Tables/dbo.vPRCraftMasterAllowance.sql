...
GO
ALTER TABLE [dbo].[vPRCraftMasterAllowance] ADD CONSTRAINT [PK_vPRCraftMasterAllowance] PRIMARY KEY CLUSTERED  ([PRCo], [Craft], [AllowanceTypeName]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_vPRCraftMasterAllowance_AllowanceRulesetName] ON [dbo].[vPRCraftMasterAllowance] ([AllowanceRulesetName]) ON [PRIMARY]
GO
