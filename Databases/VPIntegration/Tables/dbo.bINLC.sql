...
GO
CREATE UNIQUE CLUSTERED INDEX [biINLC] ON [dbo].[bINLC] ([INCo], [Loc], [Co], [MatlGroup], [Category]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINLC] ([KeyID]) ON [PRIMARY]
GO
