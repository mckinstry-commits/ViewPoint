...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMDS] ON [dbo].[bEMDS] ([EMCo], [Equipment], [Asset], [Month]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMDS] ([KeyID]) ON [PRIMARY]
GO
