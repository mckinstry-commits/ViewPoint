...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRAD] ON [dbo].[bHRAD] ([HRCo], [Accident], [Seq], [BodyPart], [InjuryType]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRAD] ([KeyID]) ON [PRIMARY]
GO
