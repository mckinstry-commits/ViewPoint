...
GO
ALTER TABLE [dbo].[bPMPF] ADD CONSTRAINT [CK_bPMPF_EmailOption] CHECK (([EmailOption]='C' OR [EmailOption]='B' OR [EmailOption]='N'))
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMPF] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biPMPFSeq] ON [dbo].[bPMPF] ([PMCo], [Project], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMPF] ON [dbo].[bPMPF] ([PMCo], [Project], [VendorGroup], [FirmNumber], [ContactCode]) ON [PRIMARY]
GO
