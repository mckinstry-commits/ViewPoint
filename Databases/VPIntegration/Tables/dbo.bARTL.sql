...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biARTLApplied] ON [dbo].[bARTL] ([ARCo], [ApplyMth], [ApplyTrans], [ApplyLine], [Mth], [ARTrans], [ARLine]) WITH (STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biARTL] ON [dbo].[bARTL] ([ARCo], [Mth], [ARTrans], [ARLine]) WITH (STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biARTLContract] ON [dbo].[bARTL] ([JCCo], [Contract], [Item]) WITH (STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bARTL] ([KeyID]) WITH (STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [iARTLudARTOPDID] ON [dbo].[bARTL] ([udARTOPDID]) WITH (STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
