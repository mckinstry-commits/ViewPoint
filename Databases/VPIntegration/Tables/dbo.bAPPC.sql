...
GO
ALTER TABLE [dbo].[bAPPC] ADD CONSTRAINT [PK_bAPPC] PRIMARY KEY CLUSTERED  ([APCo], [PayCategory]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPPC] ([KeyID]) ON [PRIMARY]
GO
