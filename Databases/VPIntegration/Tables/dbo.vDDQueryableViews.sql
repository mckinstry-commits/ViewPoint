...
GO
ALTER TABLE [dbo].[vDDQueryableViews] ADD CONSTRAINT [PK_DDQueryableViews] PRIMARY KEY CLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_DDQueryableViews] ON [dbo].[vDDQueryableViews] ([Form]) ON [PRIMARY]
GO
