...
GO
ALTER TABLE [dbo].[bRQCO] ADD CONSTRAINT [biRQCO] PRIMARY KEY CLUSTERED  ([RQCo]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_bRQCO_KeyID] ON [dbo].[bRQCO] ([KeyID]) ON [PRIMARY]
GO
