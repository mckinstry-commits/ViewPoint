...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRTR] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRTR] ON [dbo].[bPRTR] ([PRCo], [Craft], [Template], [DLCode]) ON [PRIMARY]
GO
