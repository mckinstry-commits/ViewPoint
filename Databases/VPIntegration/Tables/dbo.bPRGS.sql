...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRGS] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRGS] ON [dbo].[bPRGS] ([PRCo], [PRGroup], [VPUserName]) ON [PRIMARY]
GO
