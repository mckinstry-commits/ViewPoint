...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMML] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMML] ON [dbo].[bPMML] ([PMCo], [Project], [MeetingType], [Meeting], [MinutesType], [Item], [ItemLine]) ON [PRIMARY]
GO
