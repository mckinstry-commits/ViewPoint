...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRRN] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRRN] ON [dbo].[bPRRN] ([PRCo], [Crew], [PostDate], [SheetNum], [Employee], [LineSeq]) ON [PRIMARY]
GO
