...
GO
CREATE UNIQUE CLUSTERED INDEX [biAPVA] ON [dbo].[bAPVA] ([APCo], [VendorGroup], [Vendor], [Mth]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPVA] ([KeyID]) ON [PRIMARY]
GO
