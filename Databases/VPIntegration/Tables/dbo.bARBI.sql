...
GO
CREATE UNIQUE CLUSTERED INDEX [biARBI] ON [dbo].[bARBI] ([ARCo], [Mth], [BatchId], [BatchSeq], [ARLine], [OldNew]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biARBIContract] ON [dbo].[bARBI] ([Contract], [Item], [JCCo]) ON [PRIMARY]
GO
