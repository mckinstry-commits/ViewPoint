...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMRR] ON [dbo].[bEMRR] ([EMCo], [Category], [RevCode], [EMGroup]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMRR] ([KeyID]) ON [PRIMARY]
GO
