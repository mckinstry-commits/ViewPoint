...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPOJM] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPOJM] ON [dbo].[bPOJM] ([VendorGroup], [Vendor], [MatlGroup], [Material], [UM], [JCCo], [Job]) ON [PRIMARY]
GO
