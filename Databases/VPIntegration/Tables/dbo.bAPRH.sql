...
GO
CREATE UNIQUE CLUSTERED INDEX [biAPRH] ON [dbo].[bAPRH] ([APCo], [VendorGroup], [Vendor], [InvId]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPRH] ([KeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPRHUniqueAttId] ON [dbo].[bAPRH] ([UniqueAttchID]) ON [PRIMARY]
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bAPRH].[MnthlyYN]'
GO
EXEC sp_bindrule N'[dbo].[brCMAcct]', N'[dbo].[bAPRH].[CMAcct]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bAPRH].[V1099YN]'
GO
