...
GO
CREATE UNIQUE CLUSTERED INDEX [IX_vVPCanvasGridColumnsUser_VPUserName_QueryName_CustomName_Name] ON [dbo].[vVPCanvasGridColumnsUser] ([VPUserName], [QueryName], [CustomName], [Name]) ON [PRIMARY]
GO
