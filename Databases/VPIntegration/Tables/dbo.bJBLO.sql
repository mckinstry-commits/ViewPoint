...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biJBLO_EmplClassCraft] ON [dbo].[bJBLO] ([JBCo], [Template], [LaborCategory], [RestrictByEmployee], [PRCo], [Employee], [RestrictByClass], [Class], [RestrictByCraft], [Craft], [RestrictByEarn], [EarnType], [RestrictByFactor], [Factor], [RestrictByShift], [Shift]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biJBLO] ON [dbo].[bJBLO] ([JBCo], [Template], [LaborCategory], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBLO] ([KeyID]) ON [PRIMARY]
GO
