...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMDD] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMDD] ON [dbo].[bPMDD] ([PMCo], [Project], [LogDate], [DailyLog], [LogType], [Seq]) ON [PRIMARY]
GO
