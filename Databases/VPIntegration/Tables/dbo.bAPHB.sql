...
GO
CREATE UNIQUE CLUSTERED INDEX [biAPHB] ON [dbo].[bAPHB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPHB] ([KeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bAPHB_SLKeyID] ON [dbo].[bAPHB] ([SLKeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPHBVendor] ON [dbo].[bAPHB] ([Vendor]) ON [PRIMARY]
GO
