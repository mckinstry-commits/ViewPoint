...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMWF] ON [dbo].[bEMWF] ([EMCo], [Equipment], [Sequence]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMWF] ([KeyID]) ON [PRIMARY]
GO
