...
GO
ALTER TABLE [dbo].[bPMWM] ADD CONSTRAINT [PK_bPMWM] PRIMARY KEY CLUSTERED  ([PMCo], [ImportId], [Sequence]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMWM] ([KeyID]) ON [PRIMARY]
GO
