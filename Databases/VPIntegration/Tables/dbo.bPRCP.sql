...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRCP] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRCP] ON [dbo].[bPRCP] ([PRCo], [Craft], [Class], [Shift]) ON [PRIMARY]
GO
