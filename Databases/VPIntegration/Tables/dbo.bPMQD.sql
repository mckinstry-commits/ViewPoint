...
GO
ALTER TABLE [dbo].[bPMQD] ADD CONSTRAINT [PK_bPMQD] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [PCOType], [PCO], [RFQ], [RFQSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMQD] ([KeyID]) ON [PRIMARY]
GO
