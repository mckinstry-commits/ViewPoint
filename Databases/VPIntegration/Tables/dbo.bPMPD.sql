...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMPD] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMPD] ON [dbo].[bPMPD] ([PMCo], [Project], [PunchList], [Item], [ItemLine]) ON [PRIMARY]
GO
