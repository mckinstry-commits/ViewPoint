...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRWC] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRWC] ON [dbo].[bPRWC] ([PRCo], [TaxYear], [Item], [EDLType], [EDLCode]) ON [PRIMARY]
GO
