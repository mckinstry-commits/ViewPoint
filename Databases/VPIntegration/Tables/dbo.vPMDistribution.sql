...
GO
ALTER TABLE [dbo].[vPMDistribution] ADD CONSTRAINT [CK_vPMDistribution_CC] CHECK (([CC]='N' OR [CC]='C' OR [CC]='B'))
GO
ALTER TABLE [dbo].[vPMDistribution] ADD CONSTRAINT [CK_vPMDistribution_PrefMethod] CHECK (([PrefMethod]='M' OR [PrefMethod]='E' OR [PrefMethod]='F'))
GO
ALTER TABLE [dbo].[vPMDistribution] ADD CONSTRAINT [CK_vPMDistribution_Send] CHECK (([Send]='Y' OR [Send]='N'))
GO
