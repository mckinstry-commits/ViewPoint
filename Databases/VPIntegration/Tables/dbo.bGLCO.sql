...
GO
ALTER TABLE [dbo].[bGLCO] ADD CONSTRAINT [PK_bGLCO] PRIMARY KEY NONCLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biGLCO] ON [dbo].[bGLCO] ([GLCo]) ON [PRIMARY]
GO
