...
GO
CREATE UNIQUE CLUSTERED INDEX [biPORB] ON [dbo].[bPORB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPORB] ([KeyID]) ON [PRIMARY]
GO
