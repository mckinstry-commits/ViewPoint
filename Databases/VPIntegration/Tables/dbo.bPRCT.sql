...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRCT] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRCT] ON [dbo].[bPRCT] ([PRCo], [Craft], [Template]) ON [PRIMARY]
GO
