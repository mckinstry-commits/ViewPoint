...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMTD] ON [dbo].[bEMTD] ([EMCo], [EMGroup], [RevTemplate], [Category], [RevCode], [RevBdownCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMTD] ([KeyID]) ON [PRIMARY]
GO
