...
GO
CREATE UNIQUE CLUSTERED INDEX [biHREB] ON [dbo].[bHREB] ([HRCo], [HRRef], [BenefitCode], [DependentSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHREB] ([KeyID]) ON [PRIMARY]
GO
