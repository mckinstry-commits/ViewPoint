...
GO
CREATE UNIQUE CLUSTERED INDEX [biJCTE] ON [dbo].[bJCTE] ([JCCo], [LiabTemplate], [LiabType], [EarnCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCTE] ([KeyID]) ON [PRIMARY]
GO
