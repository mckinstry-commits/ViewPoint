...
GO
ALTER TABLE [dbo].[bPMTC] ADD CONSTRAINT [PK_bPMTC] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [Transmittal], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMTC] ([KeyID]) ON [PRIMARY]
GO
