...
GO
CREATE UNIQUE CLUSTERED INDEX [biAPUI] ON [dbo].[bAPUI] ([APCo], [UIMth], [UISeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPUI] ([KeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bAPUI_SLKeyID] ON [dbo].[bAPUI] ([SLKeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPUIUniqueAttId] ON [dbo].[bAPUI] ([UniqueAttchID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPUIVendor] ON [dbo].[bAPUI] ([Vendor]) ON [PRIMARY]
GO
