...
GO
CREATE UNIQUE CLUSTERED INDEX [biARBM] ON [dbo].[bARBM] ([Co], [Mth], [BatchId], [CustGroup], [MiscDistCode], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bARBM] ([KeyID]) ON [PRIMARY]
GO
