...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINMU] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biINMU] ON [dbo].[bINMU] ([MatlGroup], [INCo], [Material], [Loc], [UM]) ON [PRIMARY]
GO
