...
GO
ALTER TABLE [dbo].[vSMWorkCompletedARTL] WITH NOCHECK ADD CONSTRAINT [FK_vSMWorkCompletedARTL_bARTL] FOREIGN KEY ([ARCo], [ApplyMth], [ApplyTrans], [ApplyLine], [Mth], [ARTrans], [ARLine]) REFERENCES [dbo].[bARTL] ([ARCo], [ApplyMth], [ApplyTrans], [ApplyLine], [Mth], [ARTrans], [ARLine])
GO
