...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRAL] ON [dbo].[bHRAL] ([HRCo], [Accident], [Seq], [DaySeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRAL] ([KeyID]) ON [PRIMARY]
GO
