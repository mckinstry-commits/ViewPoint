...
GO
CREATE UNIQUE CLUSTERED INDEX [biJBMD] ON [dbo].[bJBMD] ([JBCo], [BillMonth], [BillNumber], [CustGroup], [MiscDistCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBMD] ([KeyID]) ON [PRIMARY]
GO
