...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biARMTCustomer] ON [dbo].[bARMT] ([ARCo], [CustGroup], [Customer], [Mth]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biABMT] ON [dbo].[bARMT] ([ARCo], [Mth], [CustGroup], [Customer]) ON [PRIMARY]
GO
