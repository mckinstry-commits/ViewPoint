...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bSLWI] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biSLWI] ON [dbo].[bSLWI] ([SLCo], [UserName], [SL], [SLItem]) ON [PRIMARY]
GO
