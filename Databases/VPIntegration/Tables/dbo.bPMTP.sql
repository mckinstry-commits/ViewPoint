...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMTP] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMTP] ON [dbo].[bPMTP] ([PMCo], [Template], [PhaseGroup], [Phase]) ON [PRIMARY]
GO
