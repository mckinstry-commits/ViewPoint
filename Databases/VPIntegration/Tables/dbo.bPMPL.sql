...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMPL] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMPL] ON [dbo].[bPMPL] ([PMCo], [Project], [Location]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[bPMPL] WITH NOCHECK ADD CONSTRAINT [FK_bPMPL_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
