...
GO
ALTER TABLE [dbo].[bPMSI] ADD CONSTRAINT [PK_bPMSI] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [SubmittalType], [Submittal], [Rev], [Item]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMSI] ([KeyID]) ON [PRIMARY]
GO
