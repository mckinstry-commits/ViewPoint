...
GO
ALTER TABLE [dbo].[bPMED] ADD CONSTRAINT [PK_bPMED] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [BudgetNo], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMED] ([KeyID]) ON [PRIMARY]
GO
