...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRCD] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRCD] ON [dbo].[bPRCD] ([PRCo], [Craft], [Class], [DLCode], [Factor]) ON [PRIMARY]
GO
