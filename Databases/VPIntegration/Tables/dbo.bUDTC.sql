...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bUDTC] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biUDTC] ON [dbo].[bUDTC] ([TableName], [ColumnName]) ON [PRIMARY]
GO
