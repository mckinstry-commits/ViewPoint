...
GO
CREATE UNIQUE CLUSTERED INDEX [biMSMT] ON [dbo].[bMSMT] ([Co], [Mth], [BatchId], [BatchSeq], [TransMth], [MSTrans]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSMT] ([KeyID]) ON [PRIMARY]
GO
