...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPOCD] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPOCD] ON [dbo].[bPOCD] ([POCo], [PO], [POItem], [Mth], [POTrans], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biPOCDTrans] ON [dbo].[bPOCD] ([POTrans], [Mth], [POCo]) ON [PRIMARY]
GO
