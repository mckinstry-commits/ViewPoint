...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSPR] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biMSPR] ON [dbo].[bMSPR] ([MSCo], [PayCode], [LocGroup], [FromLoc], [MatlGroup], [Category], [Material], [TruckType], [VendorGroup], [Vendor], [Truck], [UM], [Zone]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biMSPRSeq] ON [dbo].[bMSPR] ([MSCo], [PayCode], [Seq]) ON [PRIMARY]
GO
