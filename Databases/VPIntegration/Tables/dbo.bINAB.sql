...
GO
CREATE UNIQUE CLUSTERED INDEX [biINAB] ON [dbo].[bINAB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINAB] ([KeyID]) ON [PRIMARY]
GO
