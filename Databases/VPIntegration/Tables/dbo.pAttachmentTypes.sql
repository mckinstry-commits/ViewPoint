...
GO
ALTER TABLE [dbo].[pAttachmentTypes] ADD CONSTRAINT [PK_pAttachmentTypes] PRIMARY KEY CLUSTERED  ([AttachmentTypeID]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_pAttachmentTypesName] ON [dbo].[pAttachmentTypes] ([Name]) ON [PRIMARY]
GO
