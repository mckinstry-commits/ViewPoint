...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRDS] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRDS] ON [dbo].[bPRDS] ([PRCo], [PRGroup], [PREndDate], [Employee], [PaySeq], [DistSeq]) ON [PRIMARY]
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bPRDS].[Amt]'
GO
