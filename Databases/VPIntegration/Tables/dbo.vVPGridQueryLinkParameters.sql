...
GO
CREATE UNIQUE CLUSTERED INDEX [IX_vVPGridQueryLinkParameters_QueryName_RelatedQueryName_ParameterName] ON [dbo].[vVPGridQueryLinkParameters] ([QueryName], [RelatedQueryName], [ParameterName]) ON [PRIMARY]
GO
