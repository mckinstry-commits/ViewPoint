...
GO
ALTER TABLE [dbo].[bGLAJ] ADD CONSTRAINT [PK_bGLAJ] PRIMARY KEY NONCLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biGLAJ] ON [dbo].[bGLAJ] ([GLCo], [Jrnl], [EntryId], [Seq]) ON [PRIMARY]
GO
