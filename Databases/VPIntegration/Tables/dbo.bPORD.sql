...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biPORDMonth] ON [dbo].[bPORD] ([POCo], [Mth], [POTrans]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPORD] ON [dbo].[bPORD] ([POCo], [PO], [POItem], [Mth], [POTrans]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biPORDTrans] ON [dbo].[bPORD] ([POTrans], [Mth], [POCo]) ON [PRIMARY]
GO
