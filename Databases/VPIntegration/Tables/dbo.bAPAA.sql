...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPAA] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biAPAA] ON [dbo].[bAPAA] ([VendorGroup], [Vendor], [AddressSeq]) ON [PRIMARY]
GO
