...
GO
CREATE UNIQUE CLUSTERED INDEX [biJCOD] ON [dbo].[bJCOD] ([JCCo], [Job], [ACO], [ACOItem], [PhaseGroup], [Phase], [CostType]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCOD] ([KeyID]) ON [PRIMARY]
GO
