...
GO
CREATE UNIQUE CLUSTERED INDEX [biINCW] ON [dbo].[bINCW] ([INCo], [UserName], [Loc], [MatlGroup], [Material]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINCW] ([KeyID]) ON [PRIMARY]
GO
