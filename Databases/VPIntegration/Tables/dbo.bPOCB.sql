...
GO
CREATE UNIQUE CLUSTERED INDEX [biPOCB] ON [dbo].[bPOCB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPOCB] ([KeyID]) ON [PRIMARY]
GO
