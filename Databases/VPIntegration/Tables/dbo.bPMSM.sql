...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMSM] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMSM] ON [dbo].[bPMSM] ([PMCo], [Project], [Submittal], [SubmittalType], [Rev]) ON [PRIMARY]
GO
