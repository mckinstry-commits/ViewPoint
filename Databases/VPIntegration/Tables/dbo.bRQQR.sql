...
GO
ALTER TABLE [dbo].[bRQQR] ADD CONSTRAINT [biRQQR] PRIMARY KEY CLUSTERED  ([RQCo], [Quote], [QuoteLine], [Reviewer]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bRQQR] ([KeyID]) ON [PRIMARY]
GO
