...
GO
CREATE UNIQUE CLUSTERED INDEX [biJBIS] ON [dbo].[bJBIS] ([JBCo], [BillMonth], [BillNumber], [Job], [Item], [ACO], [ACOItem]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bJBIS_Contract] ON [dbo].[bJBIS] ([JBCo], [Item], [BillMonth], [BillNumber], [Contract], [Job], [ACO], [ACOItem]) INCLUDE ([ChgOrderAmt], [ChgOrderUnits]) ON [PRIMARY]
GO
