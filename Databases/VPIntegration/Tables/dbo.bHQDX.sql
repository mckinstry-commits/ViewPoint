...
GO
CREATE UNIQUE CLUSTERED INDEX [biHQDX] ON [dbo].[bHQDX] ([Co], [Package], [TriggerName]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHQDX] ([KeyID]) ON [PRIMARY]
GO
