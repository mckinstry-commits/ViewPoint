...
GO
CREATE UNIQUE CLUSTERED INDEX [biAPVH] ON [dbo].[bAPVH] ([APCo], [VendorGroup], [Vendor], [HoldCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPVH] ([KeyID]) ON [PRIMARY]
GO
