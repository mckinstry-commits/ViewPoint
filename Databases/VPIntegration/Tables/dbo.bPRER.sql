...
GO
CREATE UNIQUE CLUSTERED INDEX [biPRER] ON [dbo].[bPRER] ([PRCo], [PRGroup], [PREndDate], [Mth], [EMCo], [Equipment], [EMGroup], [RevCode], [EMFields], [Employee], [PaySeq], [PostSeq]) ON [PRIMARY]
GO
