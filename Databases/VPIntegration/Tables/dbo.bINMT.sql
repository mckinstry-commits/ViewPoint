...
GO
ALTER TABLE [dbo].[bINMT] ADD CONSTRAINT [PK_bINMT] PRIMARY KEY NONCLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bINMT_IncoAudit] ON [dbo].[bINMT] ([INCo], [AuditYN]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [IX_bINMT_MatlGroupMatlLocInco] ON [dbo].[bINMT] ([MatlGroup], [Material], [Loc], [INCo]) ON [PRIMARY]
GO
