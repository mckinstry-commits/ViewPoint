...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPOVM] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPOVM] ON [dbo].[bPOVM] ([VendorGroup], [Vendor], [MatlGroup], [Material], [UM]) ON [PRIMARY]
GO
