...
GO
CREATE UNIQUE CLUSTERED INDEX [biJBIJ] ON [dbo].[bJBIJ] ([JBCo], [BillMonth], [BillNumber], [Line], [Seq], [JCMonth], [JCTrans]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBIJ] ([KeyID]) ON [PRIMARY]
GO
