...
GO
ALTER TABLE [dbo].[vWFChecklists] ADD CONSTRAINT [PK_vWFChecklists] PRIMARY KEY NONCLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [IX_vWFChecklists_Checklist] ON [dbo].[vWFChecklists] ([Checklist], [Company]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_vWFChecklists_Tasklist] ON [dbo].[vWFChecklists] ([Company], [EnforceOrder]) INCLUDE ([Checklist]) ON [PRIMARY]
GO
