...
GO
CREATE UNIQUE CLUSTERED INDEX [biJBIL] ON [dbo].[bJBIL] ([JBCo], [BillMonth], [BillNumber], [Line]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biJBILLineKey] ON [dbo].[bJBIL] ([JBCo], [LineKey], [TemplateSeq], [Item]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biJBILTempSeq] ON [dbo].[bJBIL] ([JBCo], [Template], [TemplateSeq], [LineType]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBIL] ([KeyID]) ON [PRIMARY]
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBIL].[ReseqYN]'
GO
EXEC sp_bindefault N'[dbo].[bdNo]', N'[dbo].[bJBIL].[ReseqYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBIL].[AuditYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBIL].[Purge]'
GO
