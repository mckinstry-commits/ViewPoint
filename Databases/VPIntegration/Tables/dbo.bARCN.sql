...
error:
	...
	rollback transaction
GO
CREATE UNIQUE CLUSTERED INDEX [biARCN] ON [dbo].[bARCN] ([CustGroup], [Customer], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bARCN] ([KeyID]) ON [PRIMARY]
GO
