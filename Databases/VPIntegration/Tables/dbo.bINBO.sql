...
GO
CREATE UNIQUE CLUSTERED INDEX [biINBO] ON [dbo].[bINBO] ([INCo], [MatlGroup], [Loc], [FinMatl], [CompLoc], [CompMatl]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINBO] ([KeyID]) ON [PRIMARY]
GO
