...
GO
CREATE UNIQUE CLUSTERED INDEX [biINPD] ON [dbo].[bINPD] ([Co], [Mth], [BatchId], [BatchSeq], [ProdSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINPD] ([KeyID]) ON [PRIMARY]
GO
