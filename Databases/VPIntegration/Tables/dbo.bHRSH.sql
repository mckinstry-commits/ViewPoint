...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRSH] ON [dbo].[bHRSH] ([HRCo], [HRRef], [EffectiveDate]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRSH] ([KeyID]) ON [PRIMARY]
GO
