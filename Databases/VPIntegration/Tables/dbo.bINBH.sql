...
*--------------------------------------------------------------*/
	...
	error:
		...
		rollback transaction
GO
CREATE UNIQUE CLUSTERED INDEX [biINBH] ON [dbo].[bINBH] ([INCo], [LocGroup], [MatlGroup], [FinMatl]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINBH] ([KeyID]) ON [PRIMARY]
GO
