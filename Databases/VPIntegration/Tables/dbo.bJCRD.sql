...
GO
CREATE UNIQUE CLUSTERED INDEX [biJCRD] ON [dbo].[bJCRD] ([JCCo], [RateTemplate], [PRCo], [Craft], [Class], [Shift], [EarnFactor], [Employee]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biJCRDSeq] ON [dbo].[bJCRD] ([JCCo], [RateTemplate], [Seq]) ON [PRIMARY]
GO
