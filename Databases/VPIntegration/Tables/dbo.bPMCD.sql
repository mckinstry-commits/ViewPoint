...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMCD] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMCD] ON [dbo].[bPMCD] ([PMCo], [Project], [PCOType], [PCO], [Seq]) ON [PRIMARY]
GO
