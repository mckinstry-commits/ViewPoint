...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMOD] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMOD] ON [dbo].[bPMOD] ([PMCo], [Project], [DocType], [Document]) ON [PRIMARY]
GO
