...
GO
CREATE NONCLUSTERED INDEX [biARBLApplied] ON [dbo].[bARBL] ([Co], [ApplyMth], [ApplyTrans], [ApplyLine], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biARBL] ON [dbo].[bARBL] ([Co], [Mth], [BatchId], [BatchSeq], [ARLine]) ON [PRIMARY]
GO
