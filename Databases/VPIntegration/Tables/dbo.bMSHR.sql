...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSHR] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biMSHR] ON [dbo].[bMSHR] ([MSCo], [HaulCode], [LocGroup], [FromLoc], [MatlGroup], [Category], [Material], [TruckType], [UM], [Zone]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biMSHRSeq] ON [dbo].[bMSHR] ([MSCo], [HaulCode], [Seq]) ON [PRIMARY]
GO
