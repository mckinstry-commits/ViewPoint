...
GO
CREATE UNIQUE CLUSTERED INDEX [biJBER] ON [dbo].[bJBER] ([JBCo], [Template], [EMCo], [EquipCategory], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biJBER_EquipRevCode] ON [dbo].[bJBER] ([JBCo], [Template], [EquipCategory], [RestrictByEquip], [EMCo], [Equipment], [RestrictByRevCode], [RevCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBER] ([KeyID]) ON [PRIMARY]
GO
