...
GO
ALTER TABLE [dbo].[bPMUT] ADD CONSTRAINT [PK_bPMUT] PRIMARY KEY CLUSTERED  ([Template]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMUT] ([KeyID]) ON [PRIMARY]
GO
