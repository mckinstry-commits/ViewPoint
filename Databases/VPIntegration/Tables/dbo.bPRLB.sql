...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRLB] ([KeyID]) ON [PRIMARY]
GO
CREATE CLUSTERED INDEX [biPRLB] ON [dbo].[bPRLB] ([PRCo], [Employee], [LeaveCode], [EarnCode], [Type]) ON [PRIMARY]
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bPRLB].[Rate]'
GO
