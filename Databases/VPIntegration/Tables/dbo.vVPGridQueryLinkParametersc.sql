...
GO
CREATE UNIQUE CLUSTERED INDEX [IX_vVPGridQueryLinkParametersc_QueryName_RelatedQueryName_ParameterName] ON [dbo].[vVPGridQueryLinkParametersc] ([QueryName], [RelatedQueryName], [ParameterName]) ON [PRIMARY]
GO
