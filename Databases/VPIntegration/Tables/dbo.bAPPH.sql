...
GO
CREATE UNIQUE CLUSTERED INDEX [biAPPH] ON [dbo].[bAPPH] ([APCo], [CMCo], [CMAcct], [PayMethod], [CMRef], [CMRefSeq], [EFTSeq]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPPHCMRef ] ON [dbo].[bAPPH] ([CMRef]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPPH] ([KeyID]) ON [PRIMARY]
GO
EXEC sp_bindrule N'[dbo].[brCMAcct]', N'[dbo].[bAPPH].[CMAcct]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bAPPH].[VoidYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bAPPH].[PurgeYN]'
GO
