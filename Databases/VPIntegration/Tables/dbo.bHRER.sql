...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRER] ON [dbo].[bHRER] ([HRCo], [HRRef], [ReviewDate]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRER] ([KeyID]) ON [PRIMARY]
GO
