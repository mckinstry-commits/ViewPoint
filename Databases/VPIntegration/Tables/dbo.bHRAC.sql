...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRAC] ON [dbo].[bHRAC] ([HRCo], [Accident], [Seq], [ClaimSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRAC] ([KeyID]) ON [PRIMARY]
GO
