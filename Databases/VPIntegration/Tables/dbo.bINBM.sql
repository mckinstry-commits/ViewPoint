...
GO
CREATE UNIQUE CLUSTERED INDEX [biINBM] ON [dbo].[bINBM] ([INCo], [LocGroup], [MatlGroup], [FinMatl], [CompMatl]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINBM] ([KeyID]) ON [PRIMARY]
GO
