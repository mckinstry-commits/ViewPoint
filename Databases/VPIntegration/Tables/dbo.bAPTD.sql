...
GO
CREATE UNIQUE CLUSTERED INDEX [biAPTD] ON [dbo].[bAPTD] ([APCo], [Mth], [APTrans], [APLine], [APSeq]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPTDCMRef] ON [dbo].[bAPTD] ([CMRef]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPTD] ([KeyID]) ON [PRIMARY]
GO
