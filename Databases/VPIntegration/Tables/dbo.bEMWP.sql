...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMWP] ON [dbo].[bEMWP] ([EMCo], [WorkOrder], [WOItem], [MatlGroup], [Material]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biEMWPSeq] ON [dbo].[bEMWP] ([EMCo], [WorkOrder], [WOItem], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMWP] ([KeyID]) ON [PRIMARY]
GO
