...
GO
CREATE UNIQUE CLUSTERED INDEX [IX_vVPCanvasGridGroupedColumnsUser_VPUserName_QueryName_CustomName_Name] ON [dbo].[vVPCanvasGridGroupedColumnsUser] ([VPUserName], [QueryName], [CustomName], [Name]) ON [PRIMARY]
GO
