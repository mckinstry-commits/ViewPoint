...
[ContUnitPrice] [dbo].[bUnitCost] NOT NULL,
...
GO
CREATE UNIQUE CLUSTERED INDEX [biJCOI] ON [dbo].[bJCOI] ([JCCo], [Job], [ACO], [ACOItem]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCOI] ([KeyID]) ON [PRIMARY]
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCOI].[ContractUnits]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCOI].[ContUnitPrice]'
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCOI].[ContractAmt]'
GO
