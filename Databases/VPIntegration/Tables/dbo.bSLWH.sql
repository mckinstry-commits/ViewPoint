...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bSLWH] ([KeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biSLWH_Job] ON [dbo].[bSLWH] ([SLCo], [JCCo], [Job]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bSLWH_SL] ON [dbo].[bSLWH] ([SLCo], [UserName], [SL]) ON [PRIMARY]
GO
