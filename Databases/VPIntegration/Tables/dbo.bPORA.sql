...
GO
CREATE UNIQUE CLUSTERED INDEX [biPORA] ON [dbo].[bPORA] ([POCo], [Mth], [BatchId], [JCCo], [Job], [PhaseGroup], [Phase], [JCCType], [BatchSeq], [OldNew]) ON [PRIMARY]
GO
EXEC sp_bindrule N'[dbo].[brECM]', N'[dbo].[bPORA].[ECM]'
GO
