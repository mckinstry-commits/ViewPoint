...
GO
CREATE UNIQUE CLUSTERED INDEX [biAPTL] ON [dbo].[bAPTL] ([APCo], [Mth], [APTrans], [APLine]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPTLJob] ON [dbo].[bAPTL] ([Job]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPTL] ([KeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPTLPO ] ON [dbo].[bAPTL] ([PO]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPTLSL] ON [dbo].[bAPTL] ([SL]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bAPTL_SLKeyID] ON [dbo].[bAPTL] ([SLKeyID]) ON [PRIMARY]
GO
