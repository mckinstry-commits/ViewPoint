...
GO
ALTER TABLE [dbo].[bPMEH] ADD CONSTRAINT [PK_bPMEH] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [BudgetNo]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMEH] ([KeyID]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[bPMEH] WITH NOCHECK ADD CONSTRAINT [FK_bPMEH_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
