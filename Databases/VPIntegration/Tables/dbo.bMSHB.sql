...
GO
CREATE UNIQUE CLUSTERED INDEX [biMSHB] ON [dbo].[bMSHB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSHB] ([KeyID]) ON [PRIMARY]
GO
