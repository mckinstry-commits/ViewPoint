...
GO
CREATE UNIQUE CLUSTERED INDEX [biAPFT] ON [dbo].[bAPFT] ([APCo], [YEMO], [VendorGroup], [Vendor], [V1099Type]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPFT] ([KeyID]) ON [PRIMARY]
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bAPFT].[AuditYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bAPFT].[TIN2]'
GO
