...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRED] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRED] ON [dbo].[bPRED] ([PRCo], [Employee], [DLCode]) ON [PRIMARY]
GO
