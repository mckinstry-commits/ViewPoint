...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRAP] ON [dbo].[bHRAP] ([HRCo], [HRRef], [PositionCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRAP] ([KeyID]) ON [PRIMARY]
GO
