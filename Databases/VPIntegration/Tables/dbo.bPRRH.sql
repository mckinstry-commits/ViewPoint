...
GO
CREATE NONCLUSTERED INDEX [biPRRHJob] ON [dbo].[bPRRH] ([JCCo], [Job], [PhaseGroup]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRRH] ON [dbo].[bPRRH] ([PRCo], [Crew], [PostDate], [SheetNum]) ON [PRIMARY]
GO
