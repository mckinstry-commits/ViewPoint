...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMRT] ON [dbo].[bEMRT] ([EMGroup], [RevBdownCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMRT] ([KeyID]) ON [PRIMARY]
GO
