...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRLD] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRLD] ON [dbo].[bPRLD] ([PRCo], [LocalCode], [DLCode]) ON [PRIMARY]
GO
