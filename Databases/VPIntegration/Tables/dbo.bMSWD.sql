...
GO
CREATE UNIQUE CLUSTERED INDEX [biMSWD] ON [dbo].[bMSWD] ([Co], [Mth], [BatchId], [BatchSeq], [TransMth], [MSTrans]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSWD] ([KeyID]) ON [PRIMARY]
GO
