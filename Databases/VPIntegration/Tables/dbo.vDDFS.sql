...
GO
CREATE UNIQUE CLUSTERED INDEX [viDDFS] ON [dbo].[vDDFS] ([Co], [Form], [SecurityGroup], [VPUserName]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [viDDFSUserForm] ON [dbo].[vDDFS] ([VPUserName], [Co], [Access]) INCLUDE ([AttachmentSecurityLevel], [Form], [RecAdd], [RecDelete], [RecUpdate], [SecurityGroup]) ON [PRIMARY]
GO
