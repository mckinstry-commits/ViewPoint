...
GO
ALTER TABLE [dbo].[bPMWP] ADD CONSTRAINT [PK_bPMWP] PRIMARY KEY CLUSTERED  ([PMCo], [ImportId], [Sequence]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMWP] ([KeyID]) ON [PRIMARY]
GO
