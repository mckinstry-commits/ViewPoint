...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMPS] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMPS] ON [dbo].[bPMPS] ([PhaseGroup], [Phase], [SubmittalType], [Seq]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[bPMPS] WITH NOCHECK ADD CONSTRAINT [FK_bPMPS_bJCPM] FOREIGN KEY ([PhaseGroup], [Phase]) REFERENCES [dbo].[bJCPM] ([PhaseGroup], [Phase])
GO
