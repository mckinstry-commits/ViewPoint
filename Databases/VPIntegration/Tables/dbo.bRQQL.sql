...
GO
ALTER TABLE [dbo].[bRQQL] ADD CONSTRAINT [biRQQL] PRIMARY KEY CLUSTERED  ([RQCo], [Quote], [QuoteLine]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bRQQL] ([KeyID]) ON [PRIMARY]
GO
