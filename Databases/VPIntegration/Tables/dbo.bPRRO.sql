...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRRO] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRRO] ON [dbo].[bPRRO] ([PRCo], [Crew], [PostDate], [SheetNum], [Employee], [LineSeq]) ON [PRIMARY]
GO
