...
ROLLBACK TRANSACTION
GO
CREATE UNIQUE CLUSTERED INDEX [biAPWH] ON [dbo].[bAPWH] ([APCo], [Mth], [APTrans]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPWH_UserId] ON [dbo].[bAPWH] ([APCo], [UserId]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPWH] ([KeyID]) ON [PRIMARY]
GO
