...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSQH] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biMSQH] ON [dbo].[bMSQH] ([MSCo], [Quote]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biMSQHCustomer] ON [dbo].[bMSQH] ([MSCo], [QuoteType], [CustGroup], [Customer], [CustJob], [CustPO], [Quote]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biMSQHLocation] ON [dbo].[bMSQH] ([MSCo], [QuoteType], [INCo], [Loc], [Quote]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biMSQHJob] ON [dbo].[bMSQH] ([MSCo], [QuoteType], [JCCo], [Job], [Quote]) ON [PRIMARY]
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bMSQH].[Active]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bMSQH].[SepInv]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bMSQH].[SepHaul]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bMSQH].[PurgeYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bMSQH].[UseUMMetricYN]'
GO
