...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biJBTC_SeqUnique] ON [dbo].[bJBTC] ([JBCo], [Template], [PhaseGroup], [CostType], [APYN], [EMYN], [INYN], [JCYN], [MSYN], [PRYN], [Category], [EarnLiabTypeOpt], [LiabilityType], [EarnType]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biJBTC] ON [dbo].[bJBTC] ([JBCo], [Template], [Seq], [PhaseGroup], [CostType]) ON [PRIMARY]
GO
