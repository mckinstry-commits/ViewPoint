...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRWA] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRWA] ON [dbo].[bPRWA] ([PRCo], [TaxYear], [Employee], [Item], [Seq]) ON [PRIMARY]
GO
