...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMSD] ON [dbo].[bEMSD] ([Co], [Mth], [EMTrans], [Line]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMSD] ([KeyID]) ON [PRIMARY]
GO
