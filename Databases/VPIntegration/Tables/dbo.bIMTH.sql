...
GO
CREATE UNIQUE CLUSTERED INDEX [biIMTH] ON [dbo].[bIMTH] ([ImportTemplate], [Form]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bIMTH] ([KeyID]) ON [PRIMARY]
GO
