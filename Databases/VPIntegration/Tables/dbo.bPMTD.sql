...
GO
CREATE UNIQUE CLUSTERED INDEX [bibPMTD] ON [dbo].[bPMTD] ([CostType], [PMCo], [Template], [PhaseGroup], [Phase]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMTD] ([KeyID]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[bPMTD] WITH NOCHECK ADD CONSTRAINT [FK_bPMTD_bPMTH] FOREIGN KEY ([PMCo], [Template]) REFERENCES [dbo].[bPMTH] ([PMCo], [Template]) ON DELETE CASCADE
GO
