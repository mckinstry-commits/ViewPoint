...
GO
ALTER TABLE [dbo].[pMenuTemplateLinkRoles] ADD CONSTRAINT [PK_pMenuTemplateLinkRoles] PRIMARY KEY CLUSTERED  ([MenuTemplateLinkID], [MenuTemplateID], [RoleID]) ON [PRIMARY]
GO
