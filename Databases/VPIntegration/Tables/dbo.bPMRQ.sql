...
GO
ALTER TABLE [dbo].[bPMRQ] ADD CONSTRAINT [PK_bPMRQ] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [PCOType], [PCO], [RFQ]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMRQ] ([KeyID]) ON [PRIMARY]
GO
