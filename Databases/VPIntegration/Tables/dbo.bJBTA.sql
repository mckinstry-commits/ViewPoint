...
GO
CREATE UNIQUE CLUSTERED INDEX [biJBTA] ON [dbo].[bJBTA] ([JBCo], [Template], [Seq], [AddonSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBTA] ([KeyID]) ON [PRIMARY]
GO
