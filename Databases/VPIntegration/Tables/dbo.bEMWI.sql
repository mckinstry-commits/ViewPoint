...
GO
CREATE NONCLUSTERED INDEX [biEMWIComponent] ON [dbo].[bEMWI] ([EMCo], [Equipment], [Component], [StdMaintGroup]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biEMWIDelete] ON [dbo].[bEMWI] ([EMCo], [WorkOrder], [Equipment], [DateCompl]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biEMWI] ON [dbo].[bEMWI] ([EMCo], [WorkOrder], [WOItem]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMWI] ([KeyID]) ON [PRIMARY]
GO
