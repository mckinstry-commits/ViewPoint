...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMDL] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMDL] ON [dbo].[bPMDL] ([PMCo], [Project], [LogDate], [DailyLog]) ON [PRIMARY]
GO
