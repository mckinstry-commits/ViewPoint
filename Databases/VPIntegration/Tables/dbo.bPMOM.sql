...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMOM] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMOM] ON [dbo].[bPMOM] ([PMCo], [Project], [PCOType], [PCO], [PCOItem], [PhaseGroup], [CostType]) ON [PRIMARY]
GO
