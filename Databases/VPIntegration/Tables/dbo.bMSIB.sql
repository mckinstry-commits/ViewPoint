...
GO
CREATE UNIQUE CLUSTERED INDEX [biMSIB] ON [dbo].[bMSIB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSIB] ([KeyID]) ON [PRIMARY]
GO
