...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRRC] ON [dbo].[bHRRC] ([HRCo], [HRRef], [DependSeq], [CoverageTermDate]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRRC] ([KeyID]) ON [PRIMARY]
GO
