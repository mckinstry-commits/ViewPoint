...
[SUIEarnings] [dbo].[bDollar] NOT NULL,
[PostToAll] [dbo].[bYN] NOT NULL,
[Processed] [dbo].[bYN] NOT NULL,
[CMInterface] [dbo].[bYN] NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [biPRSQEFT] ON [dbo].[bPRSQ] ([CMCo], [CMAcct], [PayMethod], [CMRef], [EFTSeq]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bPRSQ_PaidDate] ON [dbo].[bPRSQ] ([PaidDate], [PRCo]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biPRSQNoGroup] ON [dbo].[bPRSQ] ([PRCo], [PREndDate], [Employee], [CMCo], [CMAcct], [CMRef]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRSQ] ON [dbo].[bPRSQ] ([PRCo], [PRGroup], [PREndDate], [Employee], [PaySeq]) ON [PRIMARY]
GO
