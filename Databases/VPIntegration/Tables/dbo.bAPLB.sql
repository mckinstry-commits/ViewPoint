...
GO
CREATE UNIQUE CLUSTERED INDEX [biAPLB] ON [dbo].[bAPLB] ([Co], [Mth], [BatchId], [BatchSeq], [APLine]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bAPLB_SLDetailKeyID] ON [dbo].[bAPLB] ([SLDetailKeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bAPLB_SLKeyID] ON [dbo].[bAPLB] ([SLKeyID]) ON [PRIMARY]
GO
