...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMSP] ON [dbo].[bEMSP] ([EMCo], [Equipment], [StdMaintGroup], [StdMaintItem], [MatlGroup], [Material]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMSP] ([KeyID]) ON [PRIMARY]
GO
