...
GO
ALTER TABLE [dbo].[bGLBC] ADD CONSTRAINT [PK_bGLBC] PRIMARY KEY NONCLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biGLBC] ON [dbo].[bGLBC] ([GLCo], [BudgetCode]) ON [PRIMARY]
GO
