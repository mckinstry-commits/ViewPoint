...
GO
CREATE UNIQUE CLUSTERED INDEX [biIMWH] ON [dbo].[bIMWH] ([ImportId], [ImportTemplate]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bIMWH] ([KeyID]) ON [PRIMARY]
GO
