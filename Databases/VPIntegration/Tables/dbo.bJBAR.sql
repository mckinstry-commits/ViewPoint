...
GO
CREATE NONCLUSTERED INDEX [biJBARInvoice] ON [dbo].[bJBAR] ([Co], [Invoice]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biJBAR] ON [dbo].[bJBAR] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBAR].[RevRelRetgYN]'
GO
