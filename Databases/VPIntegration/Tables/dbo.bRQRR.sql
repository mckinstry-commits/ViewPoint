...
GO
ALTER TABLE [dbo].[bRQRR] ADD CONSTRAINT [biRQRR] PRIMARY KEY CLUSTERED  ([RQCo], [RQID], [RQLine], [Reviewer]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bRQRR] ([KeyID]) ON [PRIMARY]
GO
