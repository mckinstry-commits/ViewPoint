...
GO
ALTER TABLE [dbo].[vPRCraftClassTemplateAllowance] ADD CONSTRAINT [PK_vPRCraftClassTemplateAllowance] PRIMARY KEY CLUSTERED  ([PRCo], [Craft], [Class], [Template], [AllowanceTypeName]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_vPRCraftClassTemplateAllowance_AllowanceRulesetName] ON [dbo].[vPRCraftClassTemplateAllowance] ([AllowanceRulesetName]) ON [PRIMARY]
GO
