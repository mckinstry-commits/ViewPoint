...
GO
ALTER TABLE [dbo].[bRQQH] ADD CONSTRAINT [biRQQH] PRIMARY KEY CLUSTERED  ([RQCo], [Quote]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bRQQH] ([KeyID]) ON [PRIMARY]
GO
