...
GO
CREATE UNIQUE CLUSTERED INDEX [biIMTR] ON [dbo].[bIMTR] ([ImportTemplate], [RecordType], [Form]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bIMTR] ([KeyID]) ON [PRIMARY]
GO
