...
GO
CREATE UNIQUE CLUSTERED INDEX [biJBID] ON [dbo].[bJBID] ([JBCo], [BillMonth], [BillNumber], [Line], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBID] ([KeyID]) ON [PRIMARY]
GO
