...
GO
CREATE UNIQUE CLUSTERED INDEX [biHREI] ON [dbo].[bHREI] ([HRCo], [HRRef], [PositionCode], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHREI] ([KeyID]) ON [PRIMARY]
GO
