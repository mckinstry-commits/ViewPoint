...
GO
ALTER TABLE [dbo].[bGLJR] ADD CONSTRAINT [PK_bGLJR] PRIMARY KEY NONCLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biGLJR] ON [dbo].[bGLJR] ([GLCo], [Jrnl]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[bGLJR] WITH NOCHECK ADD CONSTRAINT [FK_bGLJR_bGLCO_GLCo] FOREIGN KEY ([GLCo]) REFERENCES [dbo].[bGLCO] ([GLCo])
GO
