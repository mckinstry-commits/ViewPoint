...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMPI] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMPI] ON [dbo].[bPMPI] ([PMCo], [Project], [PunchList], [Item]) ON [PRIMARY]
GO
