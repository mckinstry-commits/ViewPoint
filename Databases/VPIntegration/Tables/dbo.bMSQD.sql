...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSQD] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biMSQD] ON [dbo].[bMSQD] ([MSCo], [Quote], [FromLoc], [MatlGroup], [Material], [UM], [PhaseGroup], [Phase], [VendorGroup], [MatlVendor]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biMSQDSeq] ON [dbo].[bMSQD] ([MSCo], [Quote], [Seq]) ON [PRIMARY]
GO
