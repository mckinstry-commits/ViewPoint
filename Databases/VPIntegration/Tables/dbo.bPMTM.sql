...
GO
ALTER TABLE [dbo].[bPMTM] ADD CONSTRAINT [PK_bPMTM] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [Transmittal]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMTM] ([KeyID]) ON [PRIMARY]
GO
