...
SM_Process_End:
      ...
      error:
          ...
          rollback transaction
GO
CREATE UNIQUE CLUSTERED INDEX [biPRTB] ON [dbo].[bPRTB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biPRTBEmp] ON [dbo].[bPRTB] ([Employee]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biPRTBJob] ON [dbo].[bPRTB] ([Job]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRTB] ([KeyID]) ON [PRIMARY]
GO
