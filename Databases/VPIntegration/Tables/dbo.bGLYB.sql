...
GO
ALTER TABLE [dbo].[bGLYB] ADD CONSTRAINT [PK_bGLYB] PRIMARY KEY NONCLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biGLYB] ON [dbo].[bGLYB] ([GLCo], [FYEMO], [GLAcct]) ON [PRIMARY]
GO
