...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMUC] ON [dbo].[bEMUC] ([EMCo], [AUTemplate], [Category]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMUC] ([KeyID]) ON [PRIMARY]
GO
