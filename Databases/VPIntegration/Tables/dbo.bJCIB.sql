...
GO
CREATE UNIQUE CLUSTERED INDEX [biJCIB] ON [dbo].[bJCIB] ([Co], [Mth], [BatchId], [BatchSeq], [TransType]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCIB] ([KeyID]) ON [PRIMARY]
GO
