...
GO
ALTER TABLE [dbo].[bPMWD] ADD CONSTRAINT [PK_bPMWD] PRIMARY KEY CLUSTERED  ([PMCo], [ImportId], [Sequence]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMWD] ([KeyID]) ON [PRIMARY]
GO
