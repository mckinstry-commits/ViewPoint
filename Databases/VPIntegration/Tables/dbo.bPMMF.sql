...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMMF] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMMF] ON [dbo].[bPMMF] ([PMCo], [Project], [Seq]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biPMMFPOTotals] ON [dbo].[bPMMF] ([PO], [RecordType], [ACO], [MaterialOption], [POCo], [POItem], [Amount], [InterfaceDate], [SendFlag]) ON [PRIMARY]
GO
