...
GO
CREATE UNIQUE CLUSTERED INDEX [biJBGC] ON [dbo].[bJBGC] ([JBCo], [ProcessGroup], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBGC] ([KeyID]) ON [PRIMARY]
GO
