...
GO
ALTER TABLE [dbo].[bPMRD] ADD CONSTRAINT [PK_bPMRD] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [RFIType], [RFI], [RFISeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMRD] ([KeyID]) ON [PRIMARY]
GO
