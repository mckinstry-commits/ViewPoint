...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMLB] ON [dbo].[bEMLB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMLB] ([KeyID]) ON [PRIMARY]
GO
