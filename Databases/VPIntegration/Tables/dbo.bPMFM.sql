...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMFM] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMFM] ON [dbo].[bPMFM] ([VendorGroup], [FirmNumber]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bPMFM_VendorVendorGroup] ON [dbo].[bPMFM] ([VendorGroup], [Vendor]) INCLUDE ([FirmNumber]) ON [PRIMARY]
GO
