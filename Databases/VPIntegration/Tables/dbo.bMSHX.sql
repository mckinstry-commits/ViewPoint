...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSHX] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biMSHX] ON [dbo].[bMSHX] ([MSCo], [Quote], [LocGroup], [FromLoc], [MatlGroup], [Category], [Material], [TruckType], [UM]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biMSHXSeq] ON [dbo].[bMSHX] ([MSCo], [Quote], [Seq]) ON [PRIMARY]
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bMSHX].[Override]'
GO
