...
GO
ALTER TABLE [dbo].[bHQWO] ADD CONSTRAINT [PK_bHQWO] PRIMARY KEY CLUSTERED  ([TemplateType], [DocObject]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHQWO] ([KeyID]) ON [PRIMARY]
GO
