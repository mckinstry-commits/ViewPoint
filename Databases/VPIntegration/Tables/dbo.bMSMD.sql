...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSMD] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biMSMD] ON [dbo].[bMSMD] ([MSCo], [Quote], [LocGroup], [Loc], [MatlGroup], [Category], [UM], [PhaseGroup], [Phase]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biMSMDSeq] ON [dbo].[bMSMD] ([MSCo], [Quote], [Seq]) ON [PRIMARY]
GO
