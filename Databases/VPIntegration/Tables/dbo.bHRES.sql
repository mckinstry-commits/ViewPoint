...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRES] ON [dbo].[bHRES] ([HRCo], [HRRef], [Date], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRES] ([KeyID]) ON [PRIMARY]
GO
