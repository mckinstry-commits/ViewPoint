...
GO
ALTER TABLE [dbo].[vDMAttachmentTypesCustom] ADD CONSTRAINT [PK_vDMAttachmentTypesCustom] PRIMARY KEY CLUSTERED  ([AttachmentTypeID]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_vDMAttachmentTypesCustom] ON [dbo].[vDMAttachmentTypesCustom] ([Name]) ON [PRIMARY]
GO
