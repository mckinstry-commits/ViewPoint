...
GO
CREATE NONCLUSTERED INDEX [biARBHCustomer] ON [dbo].[bARBH] ([Co], [CustGroup], [Customer]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biARBHInvoice] ON [dbo].[bARBH] ([Co], [Invoice]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biARBH] ON [dbo].[bARBH] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bARBH] ([KeyID]) ON [PRIMARY]
GO
