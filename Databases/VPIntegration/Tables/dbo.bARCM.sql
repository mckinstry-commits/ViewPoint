...
GO
CREATE UNIQUE CLUSTERED INDEX [biARCM] ON [dbo].[bARCM] ([CustGroup], [Customer]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biARCMSortName] ON [dbo].[bARCM] ([CustGroup], [SortName]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bARCM] ([KeyID]) ON [PRIMARY]
GO
