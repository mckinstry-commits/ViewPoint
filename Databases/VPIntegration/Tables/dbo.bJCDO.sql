...
GO
CREATE UNIQUE CLUSTERED INDEX [biJCDO] ON [dbo].[bJCDO] ([JCCo], [Department], [PhaseGroup], [Phase]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCDO] ([KeyID]) ON [PRIMARY]
GO
