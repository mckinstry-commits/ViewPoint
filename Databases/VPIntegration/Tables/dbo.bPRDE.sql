...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRDE] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRDE] ON [dbo].[bPRDE] ([PRCo], [PRDept], [EarnType]) ON [PRIMARY]
GO
