...
GO
CREATE UNIQUE CLUSTERED INDEX [biINBL] ON [dbo].[bINBL] ([INCo], [Loc], [MatlGroup], [FinMatl]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINBL] ([KeyID]) ON [PRIMARY]
GO
