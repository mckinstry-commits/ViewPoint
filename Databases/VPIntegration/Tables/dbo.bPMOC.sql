...
GO
ALTER TABLE [dbo].[bPMOC] ADD CONSTRAINT [PK_bPMOC] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [DocType], [Document], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMOC] ([KeyID]) ON [PRIMARY]
GO
