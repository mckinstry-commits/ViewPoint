...
GO
CREATE UNIQUE CLUSTERED INDEX [biJBCC] ON [dbo].[bJBCC] ([JBCo], [BillMonth], [BillNumber], [Job], [ACO]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBCC] ([KeyID]) ON [PRIMARY]
GO
