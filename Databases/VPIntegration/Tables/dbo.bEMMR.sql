...
GO
CREATE NONCLUSTERED INDEX [biEMMREquip] ON [dbo].[bEMMR] ([EMCo], [Equipment]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biEMMR] ON [dbo].[bEMMR] ([EMCo], [Mth], [EMTrans]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMMR] ([KeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biEMMRAttchID] ON [dbo].[bEMMR] ([UniqueAttchID]) ON [PRIMARY]
GO
