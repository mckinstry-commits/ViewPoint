...
GO
ALTER TABLE [dbo].[bJCPB] ADD CONSTRAINT [PK_bJCPB] PRIMARY KEY CLUSTERED  ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biJCPB] ON [dbo].[bJCPB] ([Co], [Mth], [BatchId], [Job], [PhaseGroup], [Phase], [CostType]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCPB] ([KeyID]) ON [PRIMARY]
GO
