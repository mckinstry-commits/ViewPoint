...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMDE] ON [dbo].[bEMDE] ([EMCo], [Department], [EarnType]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMDE] ([KeyID]) ON [PRIMARY]
GO
