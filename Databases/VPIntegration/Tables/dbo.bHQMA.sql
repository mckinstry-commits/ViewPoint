...
GO
ALTER TABLE [dbo].[bHQMA] ADD CONSTRAINT [PK_bHQMA] PRIMARY KEY NONCLUSTERED  ([AuditID]) ON [PRIMARY]
GO
CREATE CLUSTERED INDEX [IX_biHQMA_DateTime] ON [dbo].[bHQMA] ([DateTime]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bHQMA_TableName] ON [dbo].[bHQMA] ([TableName]) ON [PRIMARY]
GO
