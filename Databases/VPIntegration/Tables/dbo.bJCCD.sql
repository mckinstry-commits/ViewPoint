...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biJCCDTrans] ON [dbo].[bJCCD] ([CostTrans], [Mth], [JCCo]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biJCCD] ON [dbo].[bJCCD] ([JCCo], [Job], [Phase], [CostType], [Mth], [CostTrans]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCCD] ([KeyID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bJCCD_MthJCCoTransSource] ON [dbo].[bJCCD] ([Mth], [JCCo], [CostTrans], [Source]) INCLUDE ([UniqueAttchID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biJCCDUniqueAttchID] ON [dbo].[bJCCD] ([UniqueAttchID]) ON [PRIMARY]
GO
