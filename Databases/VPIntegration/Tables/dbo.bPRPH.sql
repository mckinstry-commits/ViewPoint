...
GO
CREATE NONCLUSTERED INDEX [biPRPHCMRef] ON [dbo].[bPRPH] ([CMRef]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRPH] ON [dbo].[bPRPH] ([PRCo], [CMCo], [CMAcct], [PayMethod], [CMRef], [CMRefSeq], [EFTSeq]) ON [PRIMARY]
GO
