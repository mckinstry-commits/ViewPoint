...
GO
CREATE UNIQUE CLUSTERED INDEX [biJCIA] ON [dbo].[bJCIA] ([JCCo], [Mth], [BatchId], [GLCo], [GLAcct], [BatchSeq], [OldNew]) ON [PRIMARY]
GO
EXEC sp_bindefault N'[dbo].[bdZero]', N'[dbo].[bJCIA].[Amount]'
GO
