...
GO
CREATE UNIQUE CLUSTERED INDEX [biINLO] ON [dbo].[bINLO] ([INCo], [Loc], [MatlGroup], [Category]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINLO] ([KeyID]) ON [PRIMARY]
GO
