...
GO
CREATE UNIQUE CLUSTERED INDEX [biJCCB] ON [dbo].[bJCCB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCCB] ([KeyID]) ON [PRIMARY]
GO
