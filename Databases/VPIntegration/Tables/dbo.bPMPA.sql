...
GO
ALTER TABLE [dbo].[bPMPA] ADD CONSTRAINT [PK_bPMPA] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [AddOn]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMPA] ([KeyID]) ON [PRIMARY]
GO
