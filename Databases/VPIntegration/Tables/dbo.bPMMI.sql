...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMMI] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMMI] ON [dbo].[bPMMI] ([PMCo], [Project], [MeetingType], [Meeting], [MinutesType], [Item]) ON [PRIMARY]
GO
