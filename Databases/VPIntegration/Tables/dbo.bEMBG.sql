...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMBG] ON [dbo].[bEMBG] ([EMGroup], [EMCo], [Category], [RevCode], [RevBdownCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMBG] ([KeyID]) ON [PRIMARY]
GO
