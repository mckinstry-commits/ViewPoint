...
GO
CREATE UNIQUE CLUSTERED INDEX [biJBIT] ON [dbo].[bJBIT] ([JBCo], [BillMonth], [BillNumber], [Item]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biJBITContractItem] ON [dbo].[bJBIT] ([JBCo], [Contract], [Item]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBIT] ([KeyID]) ON [PRIMARY]
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBIT].[Purge]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBIT].[AuditYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBIT].[ChangedYN]'
GO
