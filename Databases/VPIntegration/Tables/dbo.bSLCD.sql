...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bSLCD] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biSLCD] ON [dbo].[bSLCD] ([SLCo], [Mth], [SLTrans]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biSLCDACO] ON [dbo].[bSLCD] ([SLCo], [SL], [AppChangeOrder], [Mth], [SLTrans]) ON [PRIMARY]
GO
