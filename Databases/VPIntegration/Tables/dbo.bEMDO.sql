...
GO
   ...
   /****** Object:  Trigger dbo.btEMDOi    Script Date: 8/28/99 9:37:14 AM ******/
...
/*--------------------------------------------------------------
   ...
   if @validcnt <> @numrows
      begin
      select @errmsg = 'CostCode Code is Invalid '
      goto error
      end
...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMDO] ON [dbo].[bEMDO] ([EMCo], [Department], [CostCode], [EMGroup]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMDO] ([KeyID]) ON [PRIMARY]
GO
