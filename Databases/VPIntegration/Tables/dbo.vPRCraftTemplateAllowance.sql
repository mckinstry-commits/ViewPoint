...
GO
ALTER TABLE [dbo].[vPRCraftTemplateAllowance] ADD CONSTRAINT [PK_vPRCraftTemplateAllowance] PRIMARY KEY CLUSTERED  ([PRCo], [Craft], [Template], [AllowanceTypeName]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_vPRCraftTemplateAllowance_AllowanceRulesetName] ON [dbo].[vPRCraftTemplateAllowance] ([AllowanceRulesetName]) ON [PRIMARY]
GO
