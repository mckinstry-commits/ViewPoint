...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHQMU] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biHQMU] ON [dbo].[bHQMU] ([MatlGroup], [Material], [UM]) ON [PRIMARY]
GO
