...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRCF] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRCF] ON [dbo].[bPRCF] ([PRCo], [Craft], [Class], [EarnCode], [Factor]) ON [PRIMARY]
GO
