...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSPX] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biMSPX] ON [dbo].[bMSPX] ([MSCo], [Quote], [LocGroup], [FromLoc], [MatlGroup], [Category], [Material], [TruckType], [VendorGroup], [Vendor], [Truck], [UM]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biMSPXSeq] ON [dbo].[bMSPX] ([MSCo], [Quote], [Seq]) ON [PRIMARY]
GO
