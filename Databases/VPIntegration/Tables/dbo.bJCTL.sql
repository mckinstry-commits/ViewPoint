...
GO
CREATE UNIQUE CLUSTERED INDEX [biJCTL] ON [dbo].[bJCTL] ([JCCo], [LiabTemplate], [LiabType]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCTL] ([KeyID]) ON [PRIMARY]
GO
