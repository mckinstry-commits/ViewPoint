...
GO
ALTER TABLE [dbo].[bRQRL] ADD CONSTRAINT [biRQRL] PRIMARY KEY CLUSTERED  ([RQCo], [RQID], [RQLine]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bRQRL] ([KeyID]) ON [PRIMARY]
GO
