...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPREH] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPREH] ON [dbo].[bPREH] ([PRCo], [Employee]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biPREHSortName] ON [dbo].[bPREH] ([SortName]) ON [PRIMARY]
GO
