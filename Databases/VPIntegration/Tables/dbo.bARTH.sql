...
GO
CREATE NONCLUSTERED INDEX [biARTHApplied] ON [dbo].[bARTH] ([ARCo], [AppliedMth], [AppliedTrans]) WITH (STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biARTHTrans] ON [dbo].[bARTH] ([ARCo], [ARTrans]) WITH (STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biARTHCustomer] ON [dbo].[bARTH] ([ARCo], [CustGroup], [Customer]) WITH (STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biARTHInvoice] ON [dbo].[bARTH] ([ARCo], [Invoice]) WITH (STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biARTH] ON [dbo].[bARTH] ([ARCo], [Mth], [ARTrans]) WITH (STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bARTH] ([KeyID]) WITH (STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biARTHudARTOPCID] ON [dbo].[bARTH] ([udARTOPCID]) WITH (STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biARTHudPAYARTOPCID] ON [dbo].[bARTH] ([udPAYARTOPCID]) WITH (STATISTICS_NORECOMPUTE=ON) ON [PRIMARY]
GO
