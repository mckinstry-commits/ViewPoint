...
GO
ALTER TABLE [dbo].[bGLDT] ADD CONSTRAINT [PK_bGLDT] PRIMARY KEY CLUSTERED  ([GLCo], [Mth], [GLTrans]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bGLDT_GLAcct] ON [dbo].[bGLDT] ([GLAcct]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bGLDT_Mth] ON [dbo].[bGLDT] ([Mth]) INCLUDE ([GLAcct], [GLCo]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_bGLDT_GLAcctMth] ON [dbo].[bGLDT] ([Mth], [GLCo], [GLAcct]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biGLDTUniqueAttchID] ON [dbo].[bGLDT] ([UniqueAttchID]) ON [PRIMARY]
GO
