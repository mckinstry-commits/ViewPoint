...
[BuyOutYN] [dbo].[bYN] NOT NULL,
[LastProjDate] [smalldatetime] NULL,
[Plugged] [dbo].[bYN] NOT NULL,
[ActiveYN] [dbo].[bYN] NOT NULL,
[OrigHours] [dbo].[bHrs] NOT NULL,
...
GO
CREATE UNIQUE CLUSTERED INDEX [biJCCH] ON [dbo].[bJCCH] ([JCCo], [Job], [PhaseGroup], [Phase], [CostType]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCCH] ([KeyID]) ON [PRIMARY]
GO
...
GO
CREATE STATISTICS [_dta_stat_2023678257_4_1_2] ON [dbo].[bJCCH] ([Job], [Phase], [JCCo])
GO
