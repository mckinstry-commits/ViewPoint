...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRAE] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRAE] ON [dbo].[bPRAE] ([PRCo], [Employee], [EarnCode], [Seq]) ON [PRIMARY]
GO
