...
GO
CREATE UNIQUE CLUSTERED INDEX [biMSMH] ON [dbo].[bMSMH] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSMH] ([KeyID]) ON [PRIMARY]
GO
