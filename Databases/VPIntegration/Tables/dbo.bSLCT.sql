...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bSLCT] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biSLCT] ON [dbo].[bSLCT] ([SLCo], [SL], [CompCode], [Seq]) ON [PRIMARY]
GO
