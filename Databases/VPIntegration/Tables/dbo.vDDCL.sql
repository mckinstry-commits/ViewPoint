...
GO
ALTER TABLE [dbo].[vDDCL] ADD CONSTRAINT [PK_vDDCL] PRIMARY KEY CLUSTERED  ([KeyID], [Culture]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_vDDCL_KeyID] ON [dbo].[vDDCL] ([KeyID]) ON [PRIMARY]
GO
