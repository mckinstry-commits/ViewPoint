...
GO
ALTER TABLE [dbo].[bJCIR] ADD CONSTRAINT [PK_bJCIR] PRIMARY KEY CLUSTERED  ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biJCIR] ON [dbo].[bJCIR] ([Co], [Mth], [BatchId], [Contract], [Item]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCIR] ([KeyID]) ON [PRIMARY]
GO
