...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRBE] ON [dbo].[bHRBE] ([HRCo], [HRRef], [BenefitCode], [DependentSeq], [EarnCode], [AutoEarnSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRBE] ([KeyID]) ON [PRIMARY]
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHRBE].[ReadyYN]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bHRBE].[StdHours]'
GO
