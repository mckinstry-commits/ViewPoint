...
GO
   ...
   /****** Object:  Trigger dbo.btEMDBi    Script Date: 8/28/99 9:37:14 AM ******/
...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMDB] ON [dbo].[bEMDB] ([EMCo], [Department], [EMGroup], [RevBdownCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMDB] ([KeyID]) ON [PRIMARY]
GO
