...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMTE] ON [dbo].[bEMTE] ([EMCo], [RevTemplate], [Equipment], [RevCode], [EMGroup]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMTE] ([KeyID]) ON [PRIMARY]
GO
