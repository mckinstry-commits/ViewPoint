...
GO
ALTER TABLE [dbo].[bGLDB] ADD CONSTRAINT [PK_bGLDB] PRIMARY KEY NONCLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biGLDBBatchSeq] ON [dbo].[bGLDB] ([BatchSeq], [Co], [Mth], [BatchId]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biGLDB] ON [dbo].[bGLDB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biGLDBInterCo] ON [dbo].[bGLDB] ([InterCo], [GLAcct]) ON [PRIMARY]
GO
