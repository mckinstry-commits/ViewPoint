...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bMSTP] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biMSTP] ON [dbo].[bMSTP] ([MSCo], [PriceTemplate], [LocGroup], [FromLoc], [MatlGroup], [Category], [Material], [UM]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biMSTPSeq] ON [dbo].[bMSTP] ([MSCo], [PriceTemplate], [Seq]) ON [PRIMARY]
GO
