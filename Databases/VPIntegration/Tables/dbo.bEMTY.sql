...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMTY] ON [dbo].[bEMTY] ([EMGroup], [ComponentTypeCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMTY] ([KeyID]) ON [PRIMARY]
GO
