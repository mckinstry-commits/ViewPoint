...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMMD] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biPMMDSeq] ON [dbo].[bPMMD] ([PMCo], [Project], [MeetingType], [Meeting], [MinutesType], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMMD] ON [dbo].[bPMMD] ([PMCo], [Project], [MeetingType], [Meeting], [MinutesType], [VendorGroup], [FirmNumber], [ContactCode]) ON [PRIMARY]
GO
