...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMTS] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMTS] ON [dbo].[bPMTS] ([PMCo], [Project], [Transmittal], [Seq]) ON [PRIMARY]
GO
