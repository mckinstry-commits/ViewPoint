...
GO
ALTER TABLE [dbo].[bGLJB] ADD CONSTRAINT [PK_bGLJB] PRIMARY KEY NONCLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biGLJB] ON [dbo].[bGLJB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
