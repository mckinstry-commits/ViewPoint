...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRTA] ON [dbo].[bHRTA] ([HRCo], [HRRef], [DateOut], [Asset]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRTA] ([KeyID]) ON [PRIMARY]
GO
