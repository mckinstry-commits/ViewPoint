...
GO
ALTER TABLE [dbo].[bPMWI] ADD CONSTRAINT [PK_bPMWI] PRIMARY KEY CLUSTERED  ([PMCo], [ImportId], [Sequence]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMWI] ([KeyID]) ON [PRIMARY]
GO
