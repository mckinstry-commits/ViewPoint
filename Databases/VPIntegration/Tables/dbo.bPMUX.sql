...
GO
ALTER TABLE [dbo].[bPMUX] ADD CONSTRAINT [PK_bPMUX] PRIMARY KEY CLUSTERED  ([Template], [XrefType], [XrefCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMUX] ([KeyID]) ON [PRIMARY]
GO
