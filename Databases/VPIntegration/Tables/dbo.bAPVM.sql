...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPVM] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biAPVMSortName] ON [dbo].[bAPVM] ([VendorGroup], [SortName]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biAPVM] ON [dbo].[bAPVM] ([VendorGroup], [Vendor]) ON [PRIMARY]
GO
