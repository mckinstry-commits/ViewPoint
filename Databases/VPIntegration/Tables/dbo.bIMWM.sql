...
GO
ALTER TABLE [dbo].[bIMWM] ADD CONSTRAINT [PK_bIMWM] PRIMARY KEY CLUSTERED  ([Sequence]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biIMWM] ON [dbo].[bIMWM] ([ImportId], [ImportTemplate], [RecordSeq], [Identifier]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biIMWMRecordSeq] ON [dbo].[bIMWM] ([ImportId], [RecordSeq], [ImportTemplate]) ON [PRIMARY]
GO
