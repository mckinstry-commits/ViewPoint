...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRPS] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRPS] ON [dbo].[bPRPS] ([PRCo], [PRGroup], [PREndDate], [PaySeq]) ON [PRIMARY]
GO
