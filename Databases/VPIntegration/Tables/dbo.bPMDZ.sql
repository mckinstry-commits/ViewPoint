...
GO
ALTER TABLE [dbo].[bPMDZ] ADD CONSTRAINT [PK_bPMDZ] PRIMARY KEY CLUSTERED  ([PMCo], [Project], [DocCategory], [UserName], [VendorGroup], [Sequence]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMDZ] ([KeyID]) ON [PRIMARY]
GO
