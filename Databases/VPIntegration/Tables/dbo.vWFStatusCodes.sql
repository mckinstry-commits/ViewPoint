...
END
GO
ALTER TABLE [dbo].[vWFStatusCodes] ADD CONSTRAINT [PK_vWFStatusCodes] UNIQUE NONCLUSTERED  ([StatusID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [IX_StatusType] ON [dbo].[vWFStatusCodes] ([StatusType], [StatusID]) ON [PRIMARY]
GO
