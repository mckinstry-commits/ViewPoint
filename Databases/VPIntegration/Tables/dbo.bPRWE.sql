...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPRWE] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPRWE] ON [dbo].[bPRWE] ([PRCo], [TaxYear], [Employee]) ON [PRIMARY]
GO
