...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biJBLX_CraftClass] ON [dbo].[bJBLX] ([JBCo], [Craft], [Class]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biJBLX] ON [dbo].[bJBLX] ([JBCo], [LaborCategory], [Seq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBLX] ([KeyID]) ON [PRIMARY]
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBLX].[RestrictByCraft]'
GO
EXEC sp_bindrule N'[dbo].[brYesNo]', N'[dbo].[bJBLX].[RestrictByClass]'
GO
