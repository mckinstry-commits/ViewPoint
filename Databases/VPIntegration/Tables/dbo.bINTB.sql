...
GO
CREATE UNIQUE CLUSTERED INDEX [biINTB] ON [dbo].[bINTB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bINTB] ([KeyID]) ON [PRIMARY]
GO
