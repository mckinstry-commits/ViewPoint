...
GO
ALTER TABLE [dbo].[vPMSubmittal] ADD CONSTRAINT [CK_vPMSubmittal_APCo] CHECK ((NOT ([APCo] IS NULL AND ([PurchaseOrder] IS NOT NULL OR [Subcontract] IS NOT NULL))))
GO
ALTER TABLE [dbo].[vPMSubmittal] ADD CONSTRAINT [CK_vPMSubmittal_ApprovingFirmContact] CHECK ((NOT ([ApprovingFirm] IS NULL AND [ApprovingFirmContact] IS NOT NULL)))
GO
ALTER TABLE [dbo].[vPMSubmittal] ADD CONSTRAINT [CK_vPMSubmittal_OurFirmContact] CHECK ((NOT ([OurFirm] IS NULL AND [OurFirmContact] IS NOT NULL)))
GO
ALTER TABLE [dbo].[vPMSubmittal] ADD CONSTRAINT [CK_vPMSubmittal_ResponsibleFirmContact] CHECK ((NOT ([ResponsibleFirm] IS NULL AND [ResponsibleFirmContact] IS NOT NULL)))
GO
