...
GO
ALTER TABLE [dbo].[bGLRB] ADD CONSTRAINT [PK_bGLRB] PRIMARY KEY NONCLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biGLRB] ON [dbo].[bGLRB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
