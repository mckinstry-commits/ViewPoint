...
GO
ALTER TABLE [dbo].[bGLRF] ADD CONSTRAINT [PK_bGLRF] PRIMARY KEY NONCLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biGLRF] ON [dbo].[bGLRF] ([GLCo], [Mth], [Jrnl], [GLRef]) ON [PRIMARY]
GO
