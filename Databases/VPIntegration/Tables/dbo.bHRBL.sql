...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRBL] ON [dbo].[bHRBL] ([HRCo], [HRRef], [BenefitCode], [DependentSeq], [DLCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRBL] ([KeyID]) ON [PRIMARY]
GO
