...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMIL] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMIL] ON [dbo].[bPMIL] ([PMCo], [Project], [InspectionType], [InspectionCode]) ON [PRIMARY]
GO
