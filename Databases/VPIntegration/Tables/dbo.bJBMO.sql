...
GO
CREATE UNIQUE CLUSTERED INDEX [biJBMO] ON [dbo].[bJBMO] ([JBCo], [Template], [MatlGroup], [Material]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJBMO] ([KeyID]) ON [PRIMARY]
GO
