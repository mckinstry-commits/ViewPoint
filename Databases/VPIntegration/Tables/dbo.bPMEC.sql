...
GO
ALTER TABLE [dbo].[bPMEC] ADD CONSTRAINT [PK_bPMEC] PRIMARY KEY CLUSTERED  ([PMCo], [BudgetCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMEC] ([KeyID]) ON [PRIMARY]
GO
