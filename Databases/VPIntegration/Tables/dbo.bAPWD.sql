...
GO
CREATE UNIQUE CLUSTERED INDEX [biAPWD] ON [dbo].[bAPWD] ([APCo], [Mth], [APTrans], [APLine], [APSeq]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [biAPWD_UserId] ON [dbo].[bAPWD] ([APCo], [UserId]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bAPWD] ([KeyID]) ON [PRIMARY]
GO
