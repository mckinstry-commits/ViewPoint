...
GO
CREATE UNIQUE CLUSTERED INDEX [viDDDU] ON [dbo].[vDDDU] ([Datatype], [Qualifier], [Instance], [VPUserName]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [viDDDUEmployee] ON [dbo].[vDDDU] ([Employee]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [viDDDUInstance] ON [dbo].[vDDDU] ([Instance]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [viDDDUUser] ON [dbo].[vDDDU] ([VPUserName]) ON [PRIMARY]
GO
