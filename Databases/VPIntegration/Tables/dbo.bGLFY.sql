...
GO
ALTER TABLE [dbo].[bGLFY] ADD CONSTRAINT [PK_bGLFY] PRIMARY KEY NONCLUSTERED  ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biGLFY] ON [dbo].[bGLFY] ([GLCo], [FYEMO]) ON [PRIMARY]
GO
