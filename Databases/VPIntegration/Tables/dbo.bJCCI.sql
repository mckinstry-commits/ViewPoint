...
[BillOriginalUnits] [dbo].[bUnits] NOT NULL,
[BillOriginalAmt] [dbo].[bDollar] NOT NULL,
[BillCurrentUnits] [dbo].[bUnits] NOT NULL,
[BillCurrentAmt] [dbo].[bDollar] NOT NULL,
[BillUnitPrice] [dbo].[bUnitCost] NOT NULL,
[Notes] [varchar] (max) COLLATE Latin1_General_BIN NULL,
[InitSubs] [dbo].[bYN] NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_bJCCI_ItemContract] ON [dbo].[bJCCI] ([Contract], [Item]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biJCCI] ON [dbo].[bJCCI] ([JCCo], [Contract], [Item]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bJCCI] ([KeyID]) ON [PRIMARY]
GO
