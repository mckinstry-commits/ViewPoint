...
GO
CREATE UNIQUE CLUSTERED INDEX [biPREM] ON [dbo].[bPREM] ([PRCo], [PRGroup], [PREndDate], [Mth], [EMCo], [Equipment], [EMGroup], [CostCode], [EMCType], [EMFields], [Employee], [PaySeq], [PostSeq]) ON [PRIMARY]
GO
