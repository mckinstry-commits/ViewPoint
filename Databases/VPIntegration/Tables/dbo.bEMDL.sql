...
GO
   ...
   /****** Object:  Trigger dbo.btEMDLi    Script Date: 8/28/99 9:37:14 AM ******/
...
GO
CREATE UNIQUE CLUSTERED INDEX [biEMDL] ON [dbo].[bEMDL] ([EMCo], [Department], [LiabType]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bEMDL] ([KeyID]) ON [PRIMARY]
GO
