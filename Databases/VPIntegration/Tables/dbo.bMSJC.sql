...
GO
CREATE UNIQUE CLUSTERED INDEX [biMSJC] ON [dbo].[bMSJC] ([MSCo], [Mth], [BatchId], [JCCo], [Job], [PhaseGroup], [Phase], [JCCType], [FromLoc], [MatlGroup], [Material], [BatchSeq], [HaulLine], [OldNew]) ON [PRIMARY]
GO
