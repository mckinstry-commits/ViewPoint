...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMPU] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMPL] ON [dbo].[bPMPU] ([PMCo], [Project], [PunchList]) ON [PRIMARY]
GO
