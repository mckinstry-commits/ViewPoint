...
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMMM] ([KeyID]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [biPMMM] ON [dbo].[bPMMM] ([PMCo], [Project], [MeetingType], [Meeting], [MinutesType]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[bPMMM] WITH NOCHECK ADD CONSTRAINT [FK_bPMMM_bPMDT] FOREIGN KEY ([MeetingType]) REFERENCES [dbo].[bPMDT] ([DocType])
GO
ALTER TABLE [dbo].[bPMMM] WITH NOCHECK ADD CONSTRAINT [FK_bPMMM_bJCJM] FOREIGN KEY ([PMCo], [Project]) REFERENCES [dbo].[bJCJM] ([JCCo], [Job])
GO
