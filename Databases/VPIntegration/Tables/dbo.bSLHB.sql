...
GO
CREATE UNIQUE CLUSTERED INDEX [biSLHB] ON [dbo].[bSLHB] ([Co], [Mth], [BatchId], [BatchSeq]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bSLHB] ([KeyID]) ON [PRIMARY]
GO
