...
GO
ALTER TABLE [dbo].[bPMWS] ADD CONSTRAINT [PK_bPMWS] PRIMARY KEY CLUSTERED  ([PMCo], [ImportId], [Sequence]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bPMWS] ([KeyID]) ON [PRIMARY]
GO
