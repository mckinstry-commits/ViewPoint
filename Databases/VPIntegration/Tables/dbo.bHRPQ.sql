...
GO
CREATE UNIQUE CLUSTERED INDEX [biHRPQ] ON [dbo].[bHRPQ] ([HRCo], [PositionCode], [SkillCode]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [biKeyID] ON [dbo].[bHRPQ] ([KeyID]) ON [PRIMARY]
GO
