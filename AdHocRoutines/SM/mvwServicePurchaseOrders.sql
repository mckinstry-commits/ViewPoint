...
DROP VIEW mers.mvwServicePurchaseOrders
go

CREATE VIEW mers.mvwServicePurchaseOrders
as
SELECT 
	pohd.POCo
,	pohd.PO
...
GRANT SELECT ON mers.mvwServicePurchaseOrders TO PUBLIC
GO


SELECT * FROM mers.mvwServicePurchaseOrders ORDER BY POCo,	PO