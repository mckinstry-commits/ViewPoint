...
// POIT_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace POViewer.UI.Controls.POIT_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the POIT_QuickSelector page.
// Do not modify this class. Instead override any method in SelectorTableControlRow.
public class BaseSelectorTableControlRow : POViewer.UI.BaseApplicationRecordControl
{
...
// Base class for the SelectorTableControl control on the POIT_QuickSelector page.
// Do not modify this class. Instead override any method in SelectorTableControl.
public class BaseSelectorTableControl : POViewer.UI.BaseApplicationTableControl
{
       ...
       public BaseSelectorTableControl()
        ...
        {    
            ...
            {
                BaseColumn col = POITView.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, POITView.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = POITView.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
...
#region "Helper Properties"
        ...
        public POViewer.UI.IThemeButton AddButton {
            get {
                return (POViewer.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "AddButton");
            }
        }
        
        public POViewer.UI.IThemeButton ClearButton {
            get {
                return (POViewer.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ClearButton");
            }
        }
        
        public POViewer.UI.IThemeButton CommitButton {
            get {
                return (POViewer.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CommitButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("POViewer.UI.Controls.POIT_QuickSelector.SelectorTableControlRow")));
        ...
        public SelectorTableControlRow[] GetRecordControls()
        {
            ...
            return (SelectorTableControlRow[])recordList.ToArray(Type.GetType("POViewer.UI.Controls.POIT_QuickSelector.SelectorTableControlRow"));
        }
