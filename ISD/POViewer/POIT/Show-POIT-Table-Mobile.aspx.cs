...
// This file implements the code-behind class for Show_POIT_Table_Mobile.aspx.
// Show_POIT_Table_Mobile.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_POIT_Table_Mobile
        : BaseApplicationPage
// Code-behind class for the Show_POIT_Table_Mobile page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_POIT_Table_Mobile()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetPOITTableControl()
        {
            SetPOITTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public POViewer.UI.Controls.Show_POIT_Table_Mobile.POITTableControl POITTableControl;
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.POITTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        POViewer.UI.Controls.Show_POIT_Table_Mobile.POITTableControl control = new POViewer.UI.Controls.Show_POIT_Table_Mobile.POITTableControl();
        ...
        SetPOITTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_MenuV")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "POITMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPOITTableControl_Base()           
        
        {        
            if (POITTableControl.Visible)
            {
                POITTableControl.LoadData();
                POITTableControl.DataBind();
            }
        }
