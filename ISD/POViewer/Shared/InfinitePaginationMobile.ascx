...
<%@ Control Language="C#" AutoEventWireup="false" Codebehind="InfinitePaginationMobile.ascx.cs" Inherits="POViewer.UI.InfinitePaginationMobile" %>
<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %><table class="mobileHeaderPagination"><tr><td class="mobilePaginationAreaFirst"><asp:ImageButton runat="server" id="_FirstPage" alt="&lt;%# GetResourceValue(&quot;Btn:FirstPage&quot;, &quot;POViewer&quot;) %>" causesvalidation="False" commandname="FirstPage" imageurl="../Images/MobileButtonFirst.png" onclientclick="return SubmitHRefOnce(this, &quot;&quot;);" tooltip="&lt;%# GetResourceValue(&quot;Btn:FirstPage&quot;, &quot;POViewer&quot;) %>" visible="False" style="visibility:hidden;display:none">		
	</asp:ImageButton></td><td class="mobilePaginationAreaPrevious"><asp:ImageButton runat="server" id="_PreviousPage" alt="&lt;%# GetResourceValue(&quot;Btn:PreviousPage&quot;, &quot;POViewer&quot;) %>" causesvalidation="False" commandname="PreviousPage" imageurl="../Images/MobileButtonPrevious.png" onclientclick="return SubmitHRefOnce(this, &quot;&quot;);" tooltip="&lt;%# GetResourceValue(&quot;Btn:PreviousPage&quot;, &quot;POViewer&quot;) %>" style="visibility:hidden;display:none">		
...
</td><td class="mobilePaginationAreaNext"><asp:ImageButton runat="server" id="_NextPage" alt="&lt;%# GetResourceValue(&quot;Btn:NextPage&quot;, &quot;POViewer&quot;) %>" causesvalidation="False" commandname="NextPage" imageurl="../Images/MobileButtonNext.png" onclientclick="return SubmitHRefOnce(this, &quot;&quot;);" tooltip="&lt;%# GetResourceValue(&quot;Btn:NextPage&quot;, &quot;POViewer&quot;) %>" style="visibility:hidden;display:none">		
	</asp:ImageButton></td><td class="mobilePaginationAreaLast"><asp:ImageButton runat="server" id="_LastPage" alt="&lt;%# GetResourceValue(&quot;Btn:LastPage&quot;, &quot;POViewer&quot;) %>" causesvalidation="False" commandname="LastPage" imageurl="../Images/MobileButtonLast.png" onclientclick="return SubmitHRefOnce(this, &quot;&quot;);" tooltip="&lt;%# GetResourceValue(&quot;Btn:LastPage&quot;, &quot;POViewer&quot;) %>" visible="False" style="visibility:hidden;display:none">		
	</asp:ImageButton></td><td class="prbggo"><asp:LinkButton runat="server" id="_PageSizeButton" causesvalidation="False" commandname="PageSize" cssclass="button_link" text="&lt;%# GetResourceValue(&quot;Txt:PageSize&quot;, &quot;POViewer&quot;) %>" style="visibility:hidden;display:none">		
