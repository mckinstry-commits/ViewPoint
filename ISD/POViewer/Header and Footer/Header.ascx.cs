...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      protected virtual void UserStatusInit() {
        ...
        case null:
        case "":
          this.UserStatusLbl.Text = GetResourceValue("Txt:UserNotSignedIn", "POViewer");
        break;
        default:
          this.UserStatusLbl.Text = GetResourceValue("Txt:Hello", "POViewer");
      ...
      protected virtual void SignInButtonInit(){
        ...
        switch (((BaseApplicationPage)(this.Page)).CurrentSecurity.GetUserStatus()) {
          ...
          case "":
              ...
              this.SignIn.Text = GetResourceValue("Txt:SignIn", "POViewer");
              this.SignIn.ToolTip = GetResourceValue("Txt:SignIn", "POViewer");
              
            break;
          default:
          
            this.SignIn.Text = GetResourceValue("Txt:SignOut", "POViewer");
            this.SignIn.ToolTip = GetResourceValue("Txt:SignOut", "POViewer");
