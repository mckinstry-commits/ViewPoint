...
<%@ Control Language="C#" AutoEventWireup="false" Codebehind="HeaderMobile.ascx.cs" Inherits="POViewer.UI.HeaderMobile" %><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="mobileHeader"><tr><td><table style="width: 100%"><tr><td class="mobileHeaderLeft"><asp:Image runat="server" id="_Logo" alt="&lt;%# GetResourceValue(&quot;Txt:PageHeader&quot;, &quot;POViewer&quot;) %>" imageurl="../Images/MobileLogo.png" style="border-width:0px;">		
