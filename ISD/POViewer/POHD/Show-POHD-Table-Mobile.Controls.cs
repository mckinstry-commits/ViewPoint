...
// Show_POHD_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace POViewer.UI.Controls.Show_POHD_Table_Mobile
{
...
// Base class for the POHDTableControlRow control on the Show_POHD_Table_Mobile page.
...
public class BasePOHDTableControlRow : POViewer.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetudAddressName()
        {
            ...
            // Set the udAddressName Label on the webpage with value from the
            // DatabaseViewpoint%dbo.POHD database record.

            // this.DataSource is the DatabaseViewpoint%dbo.POHD record retrieved from the database.
            // this.udAddressName is the ASP:Label on the webpage.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label udAddressName {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "udAddressName");
            }
        }
...
// Base class for the POHDTableControl control on the Show_POHD_Table_Mobile page.
...
public class BasePOHDTableControl : POViewer.UI.BaseApplicationTableControl
{
       ...
       public BasePOHDTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.udAddressNameFilter)) 				
                    initialVal = this.GetFromSession(this.udAddressNameFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"udAddressName\")");
                
                if (initialVal != null && initialVal != "")		
                {
                        
                    this.udAddressNameFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.udAddressNameFilter.SelectedValue = initialVal;
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            this.udAddressNameFilter.SelectedIndexChanged += new EventHandler(udAddressNameFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        public virtual void ResetControl()
        {
            ...
            this.udAddressNameFilter.ClearSelection();
      ...
      foreach(BaseColumn col in cols)
      {
            ...
            if (MiscUtils.IsValueSelected(this.udAddressNameFilter)) {
                        
                wc.iAND(POHDView.udAddressName, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.udAddressNameFilter, this.GetFromSession(this.udAddressNameFilter)), false, false);
      ...
      String udAddressNameFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "udAddressNameFilter_Ajax"];
            if (MiscUtils.IsValueSelected(udAddressNameFilterSelectedValue)) {

              
                wc.iAND(POHDView.udAddressName, BaseFilter.ComparisonOperator.EqualsTo, udAddressNameFilterSelectedValue, false, false);
            ...
            foreach (POHDRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, POHDView.udAddressName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
    ...
    POHDTableControlRow recControl = (POHDTableControlRow)(repItem.FindControl("POHDTableControlRow"));
      ...
      newRecordList.Add(rec);
        ...
        public virtual void SetudAddressNameFilter()
        {
            
            this.PopulateudAddressNameFilter(MiscUtils.GetSelectedValue(this.udAddressNameFilter,  GetFromSession(this.udAddressNameFilter)), 500);					
                    ...
                    
        {
            ...
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Address Name {Txt:Ascending}"), "udAddressName Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Address Name {Txt:Descending}"), "udAddressName Desc"));
        ...
        // Get the filters' data for udAddressNameFilter.
                
        protected virtual void PopulateudAddressNameFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.udAddressNameFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_udAddressNameFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_udAddressNameFilter function.
            // It is better to customize the where clause there.
          
            // Setup the static list items        
            
            // Add the All item.
            this.udAddressNameFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "POViewer"), "--ANY--"));
                              
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(POHDView.udAddressName, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = POHDView.GetValues(POHDView.udAddressName, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( POHDView.udAddressName.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = POHDView.udAddressName.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.udAddressNameFilter.Items.FindByText(fvalue);
                ...
                this.udAddressNameFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.udAddressNameFilter, selectedValue);
            ...
            if (this.udAddressNameFilter.SelectedValue != null && this.udAddressNameFilter.Items.FindByValue(this.udAddressNameFilter.SelectedValue) == null)
                this.udAddressNameFilter.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_udAddressNameFilter()
        {
            // Create a where clause for the filter udAddressNameFilter.
            // This function is called by the Populate method to load the items 
            // in the udAddressNameFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.udAddressNameFilter, this.udAddressNameFilter.SelectedValue);
      ...
      this.SaveToSession("udAddressNameFilter_Ajax", this.udAddressNameFilter.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.udAddressNameFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void OrderSort_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in POHDView.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(POHDView.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (POHDView.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && POHDView.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(POHDView.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(POHDView.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        protected virtual void udAddressNameFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList udAddressNameFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "udAddressNameFilter");
            }
        }
        
        public System.Web.UI.WebControls.Literal udAddressNameLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "udAddressNameLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual POHDTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (POHDTableControlRow[])((new ArrayList()).ToArray(Type.GetType("POViewer.UI.Controls.Show_POHD_Table_Mobile.POHDTableControlRow")));
        ...
        public POHDTableControlRow[] GetRecordControls()
        {
            ...
            return (POHDTableControlRow[])recordList.ToArray(Type.GetType("POViewer.UI.Controls.Show_POHD_Table_Mobile.POHDTableControlRow"));
        }
