...
// This file implements the code-behind class for Show_POHD_Table.aspx.
// Show_POHD_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_POHD_Table
        : BaseApplicationPage
// Code-behind class for the Show_POHD_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_POHD_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public POViewer.UI.Controls.Show_POHD_Table.POHDTableControl POHDTableControl;
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        POViewer.UI.Controls.Show_POHD_Table.POHDTableControl control = new POViewer.UI.Controls.Show_POHD_Table.POHDTableControl();
