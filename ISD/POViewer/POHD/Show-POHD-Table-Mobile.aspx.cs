...
// This file implements the code-behind class for Show_POHD_Table_Mobile.aspx.
// Show_POHD_Table_Mobile.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_POHD_Table_Mobile
        : BaseApplicationPage
// Code-behind class for the Show_POHD_Table_Mobile page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_POHD_Table_Mobile()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetPOHDTableControl()
        {
            SetPOHDTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public POViewer.UI.Controls.Show_POHD_Table_Mobile.POHDTableControl POHDTableControl;
        ...
        protected virtual void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Authorize("");
             if (!this.IsPostBack)
             {
                    ...
                    this.ValidationSummary1.HeaderText = GetResourceValue("ValidationSummaryHeaderText", "POViewer");
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.POHDTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        POViewer.UI.Controls.Show_POHD_Table_Mobile.POHDTableControl control = new POViewer.UI.Controls.Show_POHD_Table_Mobile.POHDTableControl();
        ...
        SetPOHDTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_MenuV")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "POHDMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPOHDTableControl_Base()           
        
        {        
            if (POHDTableControl.Visible)
            {
                POHDTableControl.LoadData();
                POHDTableControl.DataBind();
            }
        }
