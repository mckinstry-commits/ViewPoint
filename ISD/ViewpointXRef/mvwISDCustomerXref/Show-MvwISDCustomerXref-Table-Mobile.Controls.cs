...
namespace ViewpointXRef.UI.Controls.Show_MvwISDCustomerXref_Table_Mobile
{
...
public class BaseMvwISDCustomerXrefTableControlRow : ViewpointXRef.UI.BaseApplicationRecordControl
{
...
public class BaseMvwISDCustomerXrefTableControl : ViewpointXRef.UI.BaseApplicationTableControl
{
       ...
       public BaseMvwISDCustomerXrefTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.CustomerNameFilter)) 				
                    initialVal = this.GetFromSession(this.CustomerNameFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"CustomerName\")");
                
                if (initialVal != null && initialVal != "")		
                {
                        
                    this.CustomerNameFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.CustomerNameFilter.SelectedValue = initialVal;
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            this.CustomerNameFilter.SelectedIndexChanged += new EventHandler(CustomerNameFilter_SelectedIndexChanged);
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(ViewpointXRef.Business.MvwISDCustomerXrefRecord);
      ...
      public override void DataBind()
      {
        ...
        public virtual void ResetControl()
        {
            ...
            this.CustomerNameFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.CustomerNameFilter)) {
                        
                wc.iAND(MvwISDCustomerXrefView.CustomerName, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.CustomerNameFilter, this.GetFromSession(this.CustomerNameFilter)), false, false);
      ...
      String CustomerNameFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CustomerNameFilter_Ajax"];
            if (MiscUtils.IsValueSelected(CustomerNameFilterSelectedValue)) {

              
                wc.iAND(MvwISDCustomerXrefView.CustomerName, BaseFilter.ComparisonOperator.EqualsTo, CustomerNameFilterSelectedValue, false, false);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            ViewpointXRef.Business.MvwISDCustomerXrefRecord[] recordList  = MvwISDCustomerXrefView.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
    ...
    MvwISDCustomerXrefTableControlRow recControl = (MvwISDCustomerXrefTableControlRow)(repItem.FindControl("MvwISDCustomerXrefTableControlRow"));
      ...
      MvwISDCustomerXrefRecord rec = new MvwISDCustomerXrefRecord();
                        ...
                        if (recControl.CustGroup.Text != "") {
                            rec.Parse(recControl.CustGroup.Text, MvwISDCustomerXrefView.CustGroup);
                  }
      ...
      newRecordList.Add(rec);
        ...
        public virtual void SetCustomerNameFilter()
        {
            
            this.PopulateCustomerNameFilter(MiscUtils.GetSelectedValue(this.CustomerNameFilter,  GetFromSession(this.CustomerNameFilter)), 500);					
        ...
        // Get the filters' data for CustomerNameFilter.
                
        protected virtual void PopulateCustomerNameFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.CustomerNameFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_CustomerNameFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_CustomerNameFilter function.
            // It is better to customize the where clause there.
          
            // Setup the static list items        
            
            // Add the All item.
            this.CustomerNameFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "ViewpointXRef"), "--ANY--"));
                              
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(MvwISDCustomerXrefView.CustomerName, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = MvwISDCustomerXrefView.GetValues(MvwISDCustomerXrefView.CustomerName, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( MvwISDCustomerXrefView.CustomerName.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = MvwISDCustomerXrefView.CustomerName.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.CustomerNameFilter.Items.FindByText(fvalue);
                ...
                this.CustomerNameFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.CustomerNameFilter, selectedValue);
            ...
            if (this.CustomerNameFilter.SelectedValue != null && this.CustomerNameFilter.Items.FindByValue(this.CustomerNameFilter.SelectedValue) == null)
                this.CustomerNameFilter.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_CustomerNameFilter()
        {
            // Create a where clause for the filter CustomerNameFilter.
            // This function is called by the Populate method to load the items 
            // in the CustomerNameFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.CustomerNameFilter, this.CustomerNameFilter.SelectedValue);
      ...
      this.SaveToSession("CustomerNameFilter_Ajax", this.CustomerNameFilter.SelectedValue);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.CustomerNameFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void CustomerNameFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList CustomerNameFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustomerNameFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual MvwISDCustomerXrefTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MvwISDCustomerXrefTableControlRow[])(selectedList.ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDCustomerXref_Table_Mobile.MvwISDCustomerXrefTableControlRow")));
        ...
        public MvwISDCustomerXrefTableControlRow[] GetRecordControls()
        {
            ...
            return (MvwISDCustomerXrefTableControlRow[])recordList.ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDCustomerXref_Table_Mobile.MvwISDCustomerXrefTableControlRow"));
        }
