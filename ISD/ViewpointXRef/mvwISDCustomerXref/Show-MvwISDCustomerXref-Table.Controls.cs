...
namespace ViewpointXRef.UI.Controls.Show_MvwISDCustomerXref_Table
{
       ...
       public BaseMvwISDCustomerXrefTableControl()
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            // Setup the sorting events.
              ...
              this.CustGroupLabel.Click += CustGroupLabel_Click;
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "MvwISDCustomerXrefTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage2(document.getElementById('" + MiscUtils.FindControlRecursively(this, "MvwISDCustomerXrefTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
        ...
        public virtual void CustGroupLabel_Click(object sender, EventArgs args)
        {
            //Sorts by CustGroup when clicked.
              
            // Get previous sorting state for CustGroup.
        
            OrderByItem sd = this.CurrentSortOrder.Find(MvwISDCustomerXrefView.CustGroup);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for CustGroup.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(MvwISDCustomerXrefView.CustGroup, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by CustGroup, so just reverse.
                sd.Reverse();
            }
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              if (this.TotalRecords > 10000)
              {
                ...
                BaseColumn[] columns = new BaseColumn[] {
                             MvwISDCustomerXrefView.CustGroup,
             ...
             null};
              ...
              DataForExport data = new DataForExport(MvwISDCustomerXrefView.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(MvwISDCustomerXrefView.CustGroup, "0"));
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(MvwISDCustomerXrefView.CustGroup.Name, ReportEnum.Align.Right, "${CustGroup}", ReportEnum.Align.Right, 15);
                 ...
                 report.AddColumn(MvwISDCustomerXrefView.CustomerName.Name, ReportEnum.Align.Left, "${CustomerName}", ReportEnum.Align.Left, 30);
                 report.AddColumn(MvwISDCustomerXrefView.Address.Name, ReportEnum.Align.Left, "${Address}", ReportEnum.Align.Left, 30);
                 report.AddColumn(MvwISDCustomerXrefView.Address2.Name, ReportEnum.Align.Left, "${Address2}", ReportEnum.Align.Left, 30);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${CustGroup}", record.Format(MvwISDCustomerXrefView.CustGroup), ReportEnum.Align.Right, 300);
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton CustGroupLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustGroupLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual MvwISDCustomerXrefTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MvwISDCustomerXrefTableControlRow[])((new ArrayList()).ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDCustomerXref_Table.MvwISDCustomerXrefTableControlRow")));
        ...
        public MvwISDCustomerXrefTableControlRow[] GetRecordControls()
        {
            ...
            return (MvwISDCustomerXrefTableControlRow[])recordList.ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDCustomerXref_Table.MvwISDCustomerXrefTableControlRow"));
        }
