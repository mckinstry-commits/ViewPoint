...
namespace ViewpointXRef.UI.Controls.MvwISDCustomerXref_QuickSelector
{
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("ViewpointXRef.UI.Controls.MvwISDCustomerXref_QuickSelector.SelectorTableControlRow")));
        ...
        public SelectorTableControlRow[] GetRecordControls()
        {
            ...
            return (SelectorTableControlRow[])recordList.ToArray(Type.GetType("ViewpointXRef.UI.Controls.MvwISDCustomerXref_QuickSelector.SelectorTableControlRow"));
        }
