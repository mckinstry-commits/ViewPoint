...
// This file implements the code-behind class for Show_MvwISDCustomerXref_Table.aspx.
// Show_MvwISDCustomerXref_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_MvwISDCustomerXref_Table
        : BaseApplicationPage
// Code-behind class for the Show_MvwISDCustomerXref_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_MvwISDCustomerXref_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetMvwISDCustomerXrefTableControl()
        {
            SetMvwISDCustomerXrefTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public ViewpointXRef.UI.Controls.Show_MvwISDCustomerXref_Table.MvwISDCustomerXrefTableControl MvwISDCustomerXrefTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = "ISD Customer Cross Reference";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "MvwISDCustomerXrefTableControl":
                 SetMvwISDCustomerXrefTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.MvwISDCustomerXrefTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        ViewpointXRef.UI.Controls.Show_MvwISDCustomerXref_Table.MvwISDCustomerXrefTableControl control = new ViewpointXRef.UI.Controls.Show_MvwISDCustomerXref_Table.MvwISDCustomerXrefTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetMvwISDCustomerXrefTableControl_Base()           
        
        {        
            if (MvwISDCustomerXrefTableControl.Visible)
            {
                MvwISDCustomerXrefTableControl.LoadData();
                MvwISDCustomerXrefTableControl.DataBind();
            }
        }
