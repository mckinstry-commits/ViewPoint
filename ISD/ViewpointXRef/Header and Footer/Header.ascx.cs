...
#region "Section 2: Do not modify this section."
      ...
      public void Page_InitializeEventHandlers_Base(object sender, System.EventArgs e)
      {
          ...
          // Setup the pagination events.
                    ...
                    this.SIOImage.Click += SIOImage_Click;
    ...
    this.LoadData();
      ...
      protected virtual void UserStatusInit() {
        ...
        case null:
        case "":
          this.UserStatusLbl.Text = GetResourceValue("Txt:UserNotSignedIn", "ViewpointXRef");
        break;
        default:
          this.UserStatusLbl.Text = GetResourceValue("Txt:Hello", "ViewpointXRef");
      ...
      private void PrintButtonInit() {
        ...
        this.SignInBarPrintButton.Visible = false;
       ...
       protected void  LeftRightImageInit() {
      
           if(this.LeftImage.Visible == true && 
              this.LanguageSelector.Visible == false &&
              this.SignInBarPrintButton.Visible == false &&
              this.SignIn.Visible == false &&
              this.SIOImage.Visible == false&&
              this.ThemeSelector.Visible == false){
                   this.LeftImage.Visible = false;				   
           }
           if(this.RightImage.Visible == true && 
              this.LanguageSelector.Visible == false &&
              this.SignInBarPrintButton.Visible == false &&
              this.SignIn.Visible == false &&
              this.SIOImage.Visible == false&&
      ...
      protected virtual void SignInButtonInit(){
        ...
        switch (((BaseApplicationPage)(this.Page)).CurrentSecurity.GetUserStatus()) {
          ...
          case "":
            ...
            this.SIOImage.ImageUrl = "../Images/SignInBarSignIn.gif";
            this.SIOImage.Attributes.Add("onmouseover", "this.src='../Images/SignInBarSignInOver.gif'");
            this.SIOImage.Attributes.Add("onmouseout", "this.src='../Images/SignInBarSignIn.gif'");
            this.SIOImage.ToolTip = GetResourceValue("Txt:SignIn", "ViewpointXRef"); 
            break;
          default:
            ...
            this.SIOImage.ImageUrl = "../Images/SignInBarSignOut.gif";
            this.SIOImage.Attributes.Add("onmouseover", "this.src='../Images/SignInBarSignOutOver.gif'");
            this.SIOImage.Attributes.Add("onmouseout", "this.src='../Images/SignInBarSignOut.gif'");
            this.SIOImage.ToolTip = GetResourceValue("Txt:SignOut", "ViewpointXRef"); 
            break;
        }
      }
...
#region Interface Properties
        ...
        public System.Web.UI.WebControls.Image Divider0 {
            get {
                return (System.Web.UI.WebControls.Image)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_Divider0");
            }
        }
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public System.Web.UI.WebControls.Image RightImage {
            get {
                return (System.Web.UI.WebControls.Image)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_RightImage");
            }
        }
