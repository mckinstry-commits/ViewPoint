...
public partial class MenuMobile : BaseApplicationMenuControl , IMenuMobile
{
     ...
     private string ReplaceTextWithResourceValue(string value)
    {
        ...
        while (regex.IsMatch(value))
        {
            ...
            if (System.Text.RegularExpressions.Regex.IsMatch(value, "}"))
            {
                ...
                value = value.Replace(value.Substring(startIndex - 1, endIndex - startIndex + 2), GetResourceValue(textToLookUp, "ViewpointXRef"));
            }
        }
        return value;
    }
