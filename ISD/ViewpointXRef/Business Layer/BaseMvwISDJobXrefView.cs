...
public class BaseMvwISDJobXrefView : PrimaryKeyTable
{
    ...
    protected virtual void Initialize()
    {
        ...
        this.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("ViewpointXRef.Business", "ViewpointXRef.Business.MvwISDJobXrefView");
        def.InitializeTableDefinition(this.TableDefinition);
        this.ConnectionName = def.GetConnectionName();
        this.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("ViewpointXRef.Business", "ViewpointXRef.Business.MvwISDJobXrefRecord");
...
#region "Properties for columns"
    ...
    public BaseClasses.Data.UsaZipCodeColumn MailZipColumn
    {
        get
        {
            return (BaseClasses.Data.UsaZipCodeColumn)this.TableDefinition.ColumnList[10];
        }
    }
...
#region "Shared helper methods"
    ...
    public static MvwISDJobXrefRecord[] GetRecords(string where, OrderBy orderBy, int pageIndex, int pageSize)
    {
        ...
        return (MvwISDJobXrefRecord[])recList.ToArray(Type.GetType("ViewpointXRef.Business.MvwISDJobXrefRecord"));
    }   
