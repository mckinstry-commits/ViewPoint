...
public class BaseMvwISDVendorXrefView : PrimaryKeyTable
{
    ...
    protected virtual void Initialize()
    {
        ...
        this.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("ViewpointXRef.Business", "ViewpointXRef.Business.MvwISDVendorXrefView");
        def.InitializeTableDefinition(this.TableDefinition);
        this.ConnectionName = def.GetConnectionName();
        this.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("ViewpointXRef.Business", "ViewpointXRef.Business.MvwISDVendorXrefRecord");
...
#region "Shared helper methods"
    ...
    public static MvwISDVendorXrefRecord[] GetRecords(string where, OrderBy orderBy, int pageIndex, int pageSize)
    {
        ...
        return (MvwISDVendorXrefRecord[])recList.ToArray(Type.GetType("ViewpointXRef.Business.MvwISDVendorXrefRecord"));
    }   
