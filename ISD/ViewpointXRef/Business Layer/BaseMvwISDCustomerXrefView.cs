...
public class BaseMvwISDCustomerXrefView : PrimaryKeyTable
{
    ...
    protected virtual void Initialize()
    {
        ...
        this.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("ViewpointXRef.Business", "ViewpointXRef.Business.MvwISDCustomerXrefView");
        def.InitializeTableDefinition(this.TableDefinition);
        this.ConnectionName = def.GetConnectionName();
        this.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("ViewpointXRef.Business", "ViewpointXRef.Business.MvwISDCustomerXrefRecord");
...
#region "Shared helper methods"
    ...
    public static MvwISDCustomerXrefRecord[] GetRecords(string where, OrderBy orderBy, int pageIndex, int pageSize)
    {
        ...
        return (MvwISDCustomerXrefRecord[])recList.ToArray(Type.GetType("ViewpointXRef.Business.MvwISDCustomerXrefRecord"));
    }   
