...
#region "Section 2: Do not modify this section."
        ...
        public ViewpointXRef.UI.Controls.Show_MvwISDJobPhaseXref_Table_Mobile.MvwISDJobPhaseXrefTableControl MvwISDJobPhaseXrefTableControl;
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        ViewpointXRef.UI.Controls.Show_MvwISDJobPhaseXref_Table_Mobile.MvwISDJobPhaseXrefTableControl control = new ViewpointXRef.UI.Controls.Show_MvwISDJobPhaseXref_Table_Mobile.MvwISDJobPhaseXrefTableControl();
