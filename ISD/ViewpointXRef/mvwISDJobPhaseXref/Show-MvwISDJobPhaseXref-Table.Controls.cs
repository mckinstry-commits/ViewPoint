...
namespace ViewpointXRef.UI.Controls.Show_MvwISDJobPhaseXref_Table
{
...
public class BaseMvwISDJobPhaseXrefTableControlRow : ViewpointXRef.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.DeleteRowButton.Attributes.Add("onClick", "return (confirm(\"" + ((BaseApplicationPage)this.Page).GetResourceValue("DeleteRecordConfirm", "ViewpointXRef") + "\"));");            
                ...
                if(formattedValue != null){
                    ...
                    if (originalLength >= popupThreshold) {
                        ...
                        formattedValue = "<a onclick=\'gPersist=true;\' class=\'truncatedText\' onmouseout=\'detailRolloverPopupClose();\' " +
                            "onmouseover=\'SaveMousePosition(event); delayRolloverPopup(\"PageMethods.GetRecordFieldValue(\\\"" + "NULL" + "\\\", \\\"ViewpointXRef.Business.MvwISDJobPhaseXrefView, ViewpointXRef.Business\\\",\\\"" +
                              (HttpUtility.UrlEncode(this.DataSource.GetID().ToString())).Replace("\\","\\\\\\\\") + "\\\", \\\"ConversionNotes\\\", \\\"ConversionNotes\\\", \\\"" +NetUtils.EncodeStringForHtmlDisplay(name.Substring(0, name.Length)) + "\\\",\\\"" + Page.GetResourceValue("Btn:Close", "ViewpointXRef") + "\\\", " +
                        " false, 200," +
...
public class BaseMvwISDJobPhaseXrefTableControl : ViewpointXRef.UI.BaseApplicationTableControl
{
       ...
       public BaseMvwISDJobPhaseXrefTableControl()
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            // Setup the sorting events.
              ...
              this.JobKeyLabel.Click += JobKeyLabel_Click;
            
              this.PhaseKeyLabel.Click += PhaseKeyLabel_Click;
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        if (this.TotalRecords > 10000)
          this.ExcelButton.Attributes.Add("onClick", "return (confirm('" + ((BaseApplicationPage)this.Page).GetResourceValue("ExportConfirm", "ViewpointXRef") + "'));");
        else
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(MvwISDJobPhaseXrefView.JobKey, this.DataSource);
        }
      ...
      cols.Add(MvwISDJobPhaseXrefView.JobKey);
      
      cols.Add(MvwISDJobPhaseXrefView.VPJob);
      
      cols.Add(MvwISDJobPhaseXrefView.CGCJob);
      
      cols.Add(MvwISDJobPhaseXrefView.POCName);
      
      cols.Add(MvwISDJobPhaseXrefView.VPJobDesc);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            foreach (MvwISDJobPhaseXrefRecord rec in recordList ){
                ...
                resultItem = rec.Format(MvwISDJobPhaseXrefView.JobKey);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(MvwISDJobPhaseXrefView.JobKey.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobPhaseXrefView.JobKey.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(MvwISDJobPhaseXrefView.VPJob);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(MvwISDJobPhaseXrefView.VPJob.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobPhaseXrefView.VPJob.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(MvwISDJobPhaseXrefView.CGCJob);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(MvwISDJobPhaseXrefView.CGCJob.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobPhaseXrefView.CGCJob.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(MvwISDJobPhaseXrefView.POCName);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(MvwISDJobPhaseXrefView.POCName.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobPhaseXrefView.POCName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(MvwISDJobPhaseXrefView.VPJobDesc);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(MvwISDJobPhaseXrefView.VPJobDesc.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobPhaseXrefView.VPJobDesc.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
    ...
    MvwISDJobPhaseXrefTableControlRow recControl = (MvwISDJobPhaseXrefTableControlRow)(repItem.FindControl("MvwISDJobPhaseXrefTableControlRow"));
      ...
      MvwISDJobPhaseXrefRecord rec = new MvwISDJobPhaseXrefRecord();
                        ...
                        if (recControl.JobKey.Text != "") {
                            rec.Parse(recControl.JobKey.Text, MvwISDJobPhaseXrefView.JobKey);
                  }
      ...
      newRecordList.Add(rec);
        ...
        public virtual void SetCostTypeCodeFilter()
        {
            ...
            this.PopulateCostTypeCodeFilter(MiscUtils.GetSelectedValueList(this.CostTypeCodeFilter, CostTypeCodeFilterselectedFilterItemList), 500);
              ...
              this.CostTypeCodeFilter.Attributes["onClick"] = "initializePopupPage(this, '" + this.CostTypeCodeFilter.PostBackUrl + "', true, event); return false;";                  
                    ...
                    
        {
            ...
            if (this.CostTypeCodeFilter.Items.Count == 0)
                this.CostTypeCodeFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "ViewpointXRef"), "--ANY--"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                ...
                string javascriptCall = "";
                    ...
                    javascriptCall = "initializePopupPage2(document.getElementById('" + MiscUtils.FindControlRecursively(this, "MvwISDJobPhaseXrefTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
        ...
        public virtual void CGCCoLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(MvwISDJobPhaseXrefView.CGCCo);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(MvwISDJobPhaseXrefView.CGCCo, OrderByItem.OrderDir.Asc);
        ...
        public virtual void CGCJobLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(MvwISDJobPhaseXrefView.CGCJob);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(MvwISDJobPhaseXrefView.CGCJob, OrderByItem.OrderDir.Asc);
        ...
        public virtual void JobKeyLabel_Click(object sender, EventArgs args)
        {
            //Sorts by JobKey when clicked.
              
            // Get previous sorting state for JobKey.
        
            OrderByItem sd = this.CurrentSortOrder.Find(MvwISDJobPhaseXrefView.JobKey);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for JobKey.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(MvwISDJobPhaseXrefView.JobKey, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by JobKey, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void PhaseKeyLabel_Click(object sender, EventArgs args)
        {
            //Sorts by PhaseKey when clicked.
              
            // Get previous sorting state for PhaseKey.
        
            OrderByItem sd = this.CurrentSortOrder.Find(MvwISDJobPhaseXrefView.PhaseKey);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for PhaseKey.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(MvwISDJobPhaseXrefView.PhaseKey, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by PhaseKey, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void POCLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(MvwISDJobPhaseXrefView.POC);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(MvwISDJobPhaseXrefView.POC, OrderByItem.OrderDir.Asc);
        ...
        public virtual void POCNameLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(MvwISDJobPhaseXrefView.POCName);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(MvwISDJobPhaseXrefView.POCName, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             data.ColumnList.Add(new ExcelColumn(MvwISDJobPhaseXrefView.CGCCo, "Default"));
             ...
             data.ColumnList.Add(new ExcelColumn(MvwISDJobPhaseXrefView.JobKey, "Default"));
        ...
        if (target == null) target = ""; // avoid warning on VS
            ...
            if (shouldRedirect) {
                ...
                string javascriptCall = "";
                    ...
                    javascriptCall = "initializePopupPage2(document.getElementById('" + MiscUtils.FindControlRecursively(this, "MvwISDJobPhaseXrefTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
                ScriptManager.RegisterStartupScript(this, this.GetType(), "NewButton_Click", javascriptCall, true);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(MvwISDJobPhaseXrefView.CGCCo.Name, ReportEnum.Align.Left, "${CGCCo}", ReportEnum.Align.Left, 20);
                 report.AddColumn(MvwISDJobPhaseXrefView.CGCJob.Name, ReportEnum.Align.Left, "${CGCJob}", ReportEnum.Align.Left, 20);
                 report.AddColumn(MvwISDJobPhaseXrefView.VPJobDesc.Name, ReportEnum.Align.Left, "${VPJobDesc}", ReportEnum.Align.Left, 30);
                 ...
                 report.AddColumn(MvwISDJobPhaseXrefView.CostTypeDesc.Name, ReportEnum.Align.Left, "${CostTypeDesc}", ReportEnum.Align.Left, 24);
                 report.AddColumn(MvwISDJobPhaseXrefView.VPPhaseDescription.Name, ReportEnum.Align.Left, "${VPPhaseDescription}", ReportEnum.Align.Left, 30);
                 report.AddColumn(MvwISDJobPhaseXrefView.ConversionNotes.Name, ReportEnum.Align.Left, "${ConversionNotes}", ReportEnum.Align.Left, 30);
                 report.AddColumn(MvwISDJobPhaseXrefView.PhaseKey.Name, ReportEnum.Align.Left, "${PhaseKey}", ReportEnum.Align.Left, 25);
                 report.AddColumn(MvwISDJobPhaseXrefView.JobKey.Name, ReportEnum.Align.Left, "${JobKey}", ReportEnum.Align.Left, 20);

  
                int rowsPerQuery = 5000;
                int recordCount = 0;
                                
                report.Page = Page.GetResourceValue("Txt:Page", "ViewpointXRef");
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             report.AddData("${CGCCo}", record.Format(MvwISDJobPhaseXrefView.CGCCo), ReportEnum.Align.Left, 300);
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.JobKey)){
                                 report.AddData("${JobKey}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = MvwISDJobPhaseXrefView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(MvwISDJobPhaseXrefView.JobKey);
                                 _DFKA = MvwISDJobPhaseXrefView.GetDFKA(record.JobKey.ToString(), MvwISDJobPhaseXrefView.JobKey,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  MvwISDJobPhaseXrefView.JobKey.IsApplyDisplayAs){
                                     report.AddData("${JobKey}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${JobKey}", record.Format(MvwISDJobPhaseXrefView.JobKey), ReportEnum.Align.Left, 300);
                                 }
                             }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton JobKeyLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "JobKeyLabel");
            }
        }
        ...
        public ViewpointXRef.UI.IPaginationMedium Pagination {
            get {
                return (ViewpointXRef.UI.IPaginationMedium)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Pagination");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton PhaseKeyLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PhaseKeyLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual MvwISDJobPhaseXrefTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MvwISDJobPhaseXrefTableControlRow[])((new ArrayList()).ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDJobPhaseXref_Table.MvwISDJobPhaseXrefTableControlRow")));
        ...
        public MvwISDJobPhaseXrefTableControlRow[] GetRecordControls()
        {
            ...
            return (MvwISDJobPhaseXrefTableControlRow[])recordList.ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDJobPhaseXref_Table.MvwISDJobPhaseXrefTableControlRow"));
        }
