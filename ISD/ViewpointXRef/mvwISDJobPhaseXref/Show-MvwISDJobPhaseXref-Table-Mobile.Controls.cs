...
// Show_MvwISDJobPhaseXref_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace ViewpointXRef.UI.Controls.Show_MvwISDJobPhaseXref_Table_Mobile
{
...
// Base class for the MvwISDJobPhaseXrefTableControlRow control on the Show_MvwISDJobPhaseXref_Table_Mobile page.
...
// Base class for the MvwISDJobPhaseXrefTableControl control on the Show_MvwISDJobPhaseXref_Table_Mobile page.
...
public class BaseMvwISDJobPhaseXrefTableControl : ViewpointXRef.UI.BaseApplicationTableControl
{
      ...
      public override void DataBind()
      {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.POCNameFilter)) {
                ...
                wc.iAND(MvwISDJobPhaseXrefView.POCName, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.POCNameFilter, this.GetFromSession(this.POCNameFilter)), false, false);
      ...
      String POCNameFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "POCNameFilter_Ajax"];
            if (MiscUtils.IsValueSelected(POCNameFilterSelectedValue)) {
                ...
                wc.iAND(MvwISDJobPhaseXrefView.POCName, BaseFilter.ComparisonOperator.EqualsTo, POCNameFilterSelectedValue, false, false);
            ...
            foreach (MvwISDJobPhaseXrefRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobPhaseXrefView.POCName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
    ...
    MvwISDJobPhaseXrefTableControlRow recControl = (MvwISDJobPhaseXrefTableControlRow)(repItem.FindControl("MvwISDJobPhaseXrefTableControlRow"));
      ...
      newRecordList.Add(rec);
                    ...
                    
        {
            ...
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Job Key {Txt:Ascending}"), "JobKey Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Job Key {Txt:Descending}"), "JobKey Desc"));
                    ...
                    
        {
            ...
            orderBy.Add(MvwISDJobPhaseXrefView.POCName, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = MvwISDJobPhaseXrefView.GetValues(MvwISDJobPhaseXrefView.POCName, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( MvwISDJobPhaseXrefView.POCName.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = MvwISDJobPhaseXrefView.POCName.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
...
#region "Helper Functions"
        ...
        public virtual MvwISDJobPhaseXrefTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MvwISDJobPhaseXrefTableControlRow[])(selectedList.ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDJobPhaseXref_Table_Mobile.MvwISDJobPhaseXrefTableControlRow")));
        ...
        public MvwISDJobPhaseXrefTableControlRow[] GetRecordControls()
        {
            ...
            return (MvwISDJobPhaseXrefTableControlRow[])recordList.ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDJobPhaseXref_Table_Mobile.MvwISDJobPhaseXrefTableControlRow"));
        }
