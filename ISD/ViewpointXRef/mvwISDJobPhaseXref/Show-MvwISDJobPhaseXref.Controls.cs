...
namespace ViewpointXRef.UI.Controls.Show_MvwISDJobPhaseXref
{
...
public class BaseMvwISDJobPhaseXrefRecordControl : ViewpointXRef.UI.BaseApplicationRecordControl
{
...
//
            ...
            if (recId == null || recId.Length == 0) {
                ...
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "ViewpointXRef").Replace("{URL}", "MvwISDJobPhaseXref"));
            }
