...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="MvwISDJobXref-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="ViewpointXRef.UI.MvwISDJobXref_QuickSelector" %>
<%@ Register Tagprefix="ViewpointXRef" Namespace="ViewpointXRef.UI.Controls.MvwISDJobXref_QuickSelector" Assembly="ViewpointXRef" %>
