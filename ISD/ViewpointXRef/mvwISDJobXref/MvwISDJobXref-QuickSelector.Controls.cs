...
namespace ViewpointXRef.UI.Controls.MvwISDJobXref_QuickSelector
{
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("ViewpointXRef.UI.Controls.MvwISDJobXref_QuickSelector.SelectorTableControlRow")));
        ...
        public SelectorTableControlRow[] GetRecordControls()
        {
            ...
            return (SelectorTableControlRow[])recordList.ToArray(Type.GetType("ViewpointXRef.UI.Controls.MvwISDJobXref_QuickSelector.SelectorTableControlRow"));
        }
