...
namespace ViewpointXRef.UI.Controls.Show_MvwISDJobXref_Table
{
      ...
      newRecordList.Add(rec);
        ...
        public virtual void SetMailStateFilter()
        {
            ...
            this.PopulateMailStateFilter(MiscUtils.GetSelectedValueList(this.MailStateFilter, MailStateFilterselectedFilterItemList), 500);
              ...
              this.MailStateFilter.Attributes["onClick"] = "initializePopupPage(this, '" + this.MailStateFilter.PostBackUrl + "', true, event); return false;";                  
                    ...
                    
        {
            ...
            if (this.MailStateFilter.Items.Count == 0)
                this.MailStateFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "ViewpointXRef"), "--ANY--"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "MvwISDJobXrefTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage2(document.getElementById('" + MiscUtils.FindControlRecursively(this, "MvwISDJobXrefTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             data.ColumnList.Add(new ExcelColumn(MvwISDJobXrefView.CGCCo, "Default"));
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(MvwISDJobXrefView.CGCCo.Name, ReportEnum.Align.Left, "${CGCCo}", ReportEnum.Align.Left, 20);
                 report.AddColumn(MvwISDJobXrefView.CGCJob.Name, ReportEnum.Align.Left, "${CGCJob}", ReportEnum.Align.Left, 20);
                 report.AddColumn(MvwISDJobXrefView.VPJobDesc.Name, ReportEnum.Align.Left, "${VPJobDesc}", ReportEnum.Align.Left, 30);
                 report.AddColumn(MvwISDJobXrefView.MailAddress.Name, ReportEnum.Align.Left, "${MailAddress}", ReportEnum.Align.Left, 30);
                 report.AddColumn(MvwISDJobXrefView.MailAddress2.Name, ReportEnum.Align.Left, "${MailAddress2}", ReportEnum.Align.Left, 30);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             report.AddData("${CGCCo}", record.Format(MvwISDJobXrefView.CGCCo), ReportEnum.Align.Left, 300);
...
#region "Helper Functions"
        ...
        public virtual MvwISDJobXrefTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MvwISDJobXrefTableControlRow[])((new ArrayList()).ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDJobXref_Table.MvwISDJobXrefTableControlRow")));
        ...
        public MvwISDJobXrefTableControlRow[] GetRecordControls()
        {
            ...
            return (MvwISDJobXrefTableControlRow[])recordList.ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDJobXref_Table.MvwISDJobXrefTableControlRow"));
        }
