...
<%@ Register Tagprefix="ViewpointXRef" Namespace="ViewpointXRef.UI.Controls.Show_MvwISDJobXref_Table" Assembly="ViewpointXRef" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Show-MvwISDJobXref-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="ViewpointXRef.UI.Show_MvwISDJobXref_Table" %>
		...
		<asp:UpdatePanel runat="server" id="UpdatePanel1" UpdateMode="Conditional">
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0"><tr><td>
                        <ViewpointXRef:MvwISDJobXrefTableControl runat="server" id="MvwISDJobXrefTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="ms-rteThemeBackColor-3-0 dh"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><img src="../Images/space.gif" alt="" /></td><td><table cellpadding="0" cellspacing="0" border="0"><tr><td><asp:Literal runat="server" id="Title" Text="&lt;%#String.Concat(&quot;Job Cross Reference&quot;) %>">	</asp:Literal></td></tr></table>
...
</td><td class="fila"><ViewpointXRef:ThemeButton runat="server" id="SearchButton" button-causesvalidation="False" button-commandname="Search" button-text="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;ViewpointXRef&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;ViewpointXRef&quot;) %>" postback="False"></ViewpointXRef:ThemeButton></td></tr><tr><td class="fila"><asp:Literal runat="server" id="MailStateLabel1" Text="Mail State" visible="False">	</asp:Literal></td><td><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("FilterButton"))%>
<BaseClasses:QuickSelector runat="server" id="MailStateFilter" autopostback="True" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single" visible="False">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
            ...
            <!--To change the position of the pagination control, please search for "prspace" on the Online Help for instruction. --></td><td><img src="../Images/paginationRowEdgeR.gif" alt="" /></td><td></td></tr></table>
</td></tr><tr><td class="tre"><table id="MvwISDJobXrefTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="ms-rteThemeBackColor-3-0" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC; padding:3px;font-size: 10px;font-weight: bold;vertical-align: top;"></th><th class="ms-rteThemeBackColor-3-0" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC; padding:3px;font-size: 10px;font-weight: bold;vertical-align: top;"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="ms-rteThemeBackColor-3-0" scope="col" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC; padding:3px;font-size: 10px;font-weight: bold;vertical-align: top;"><asp:LinkButton runat="server" id="VPCoLabel" tooltip="Sort by VPCo" Text="VP Company" CausesValidation="False">	</asp:LinkButton>
                        ...
                        </th><th class="ms-rteThemeBackColor-3-0" scope="col" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC; padding:3px;font-size: 10px;font-weight: bold;vertical-align: top;"><asp:LinkButton runat="server" id="MailAddressLabel" tooltip="Sort by MailAddress" Text="Mail Address" CausesValidation="False">	</asp:LinkButton>
                        </th><th class="ms-rteThemeBackColor-3-0" scope="col" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC; padding:3px;font-size: 10px;font-weight: bold;vertical-align: top;"><asp:LinkButton runat="server" id="MailAddress2Label" tooltip="Sort by MailAddress2" Text="Mail Address 2" CausesValidation="False">	</asp:LinkButton>
                        </th><th class="ms-rteThemeBackColor-3-0" scope="col" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC; padding:3px;font-size: 10px;font-weight: bold;vertical-align: top;"><asp:LinkButton runat="server" id="MailCityLabel" tooltip="Sort by MailCity" Text="Mail City" CausesValidation="False">	</asp:LinkButton>
                        </th><th class="ms-rteThemeBackColor-3-0" scope="col" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC; padding:3px;font-size: 10px;font-weight: bold;vertical-align: top;"><asp:LinkButton runat="server" id="MailStateLabel" tooltip="Sort by MailState" Text="Mail State" CausesValidation="False">	</asp:LinkButton>
                        </th><th class="ms-rteThemeBackColor-3-0" scope="col" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC; padding:3px;font-size: 10px;font-weight: bold;vertical-align: top;"><asp:LinkButton runat="server" id="MailZipLabel" tooltip="Sort by MailZip" Text="Mail ZIP" CausesValidation="False">	</asp:LinkButton>
                        </th></tr><asp:Repeater runat="server" id="MvwISDJobXrefTableControlRepeater">		<ITEMTEMPLATE>		<ViewpointXRef:MvwISDJobXrefTableControlRow runat="server" id="MvwISDJobXrefTableControlRow">
...
<asp:Literal runat="server" id="VPCo"></asp:Literal></span>
 </td><td class="ttc"><asp:Literal runat="server" id="CGCCo"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="CGCJob"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="VPJob"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="VPJobDesc"></asp:Literal> </td><td class="ttc" style="text-align: right;"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="POC"></asp:Literal></span>
 </td><td class="ttc"><asp:Literal runat="server" id="POCName"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="MailAddress"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="MailAddress2"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="MailCity"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="MailState"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="MailZip"></asp:Literal> </td></tr></ViewpointXRef:MvwISDJobXrefTableControlRow>
</ITEMTEMPLATE>
