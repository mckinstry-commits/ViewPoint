...
namespace ViewpointXRef.UI.Controls.Show_MvwISDJobXref_Table_Mobile
{
...
public class BaseMvwISDJobXrefTableControlRow : ViewpointXRef.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetPOCName()
        {
            ...
            // this.POCName is the ASP:Label on the webpage.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label POCName {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "POCName");
            }
        }
...
public class BaseMvwISDJobXrefTableControl : ViewpointXRef.UI.BaseApplicationTableControl
{
       ...
       public BaseMvwISDJobXrefTableControl()
           ...
           // Setup the filter and search.
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.POCNameFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.POCNameFilter.SelectedValue = initialVal;
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            this.POCNameFilter.SelectedIndexChanged += new EventHandler(POCNameFilter_SelectedIndexChanged);
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(ViewpointXRef.Business.MvwISDJobXrefRecord);
      ...
      public override void DataBind()
      {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.POCNameFilter)) {
                ...
                wc.iAND(MvwISDJobXrefView.POCName, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.POCNameFilter, this.GetFromSession(this.POCNameFilter)), false, false);
      ...
      String POCNameFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "POCNameFilter_Ajax"];
            if (MiscUtils.IsValueSelected(POCNameFilterSelectedValue)) {
                ...
                wc.iAND(MvwISDJobXrefView.POCName, BaseFilter.ComparisonOperator.EqualsTo, POCNameFilterSelectedValue, false, false);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            ViewpointXRef.Business.MvwISDJobXrefRecord[] recordList  = MvwISDJobXrefView.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
    ...
    MvwISDJobXrefTableControlRow recControl = (MvwISDJobXrefTableControlRow)(repItem.FindControl("MvwISDJobXrefTableControlRow"));
      ...
      newRecordList.Add(rec);
        ...
        public virtual void SetPOCNameFilter()
        {
            ...
            this.PopulatePOCNameFilter(MiscUtils.GetSelectedValue(this.POCNameFilter,  GetFromSession(this.POCNameFilter)), 500);					
                    ...
                    
        {
            ...
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("VP Job {Txt:Ascending}"), "VPJob Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("VP Job {Txt:Descending}"), "VPJob Desc"));
        ...
        protected virtual void PopulatePOCNameFilter(string selectedValue, int maxItems)
                    
        {
            ...
            // Add the All item.
            this.POCNameFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "ViewpointXRef"), "--ANY--"));
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.POCNameFilter, selectedValue);
            ...
            if (this.POCNameFilter.SelectedValue != null && this.POCNameFilter.Items.FindByValue(this.POCNameFilter.SelectedValue) == null)
                this.POCNameFilter.SelectedValue = null;
        ...
        public virtual WhereClause CreateWhereClause_POCNameFilter()
        {
            ...
            // in the POCNameFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.POCNameFilter, this.POCNameFilter.SelectedValue);
      ...
      this.SaveToSession("POCNameFilter_Ajax", this.POCNameFilter.SelectedValue);
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList POCNameFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "POCNameFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual MvwISDJobXrefTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MvwISDJobXrefTableControlRow[])(selectedList.ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDJobXref_Table_Mobile.MvwISDJobXrefTableControlRow")));
        ...
        public MvwISDJobXrefTableControlRow[] GetRecordControls()
        {
            ...
            return (MvwISDJobXrefTableControlRow[])recordList.ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDJobXref_Table_Mobile.MvwISDJobXrefTableControlRow"));
        }
