<%@ Page Language="C#" AutoEventWireup="false" Codebehind="SharePointMenuRedirect.aspx.cs" Inherits="ViewpointXRef.UI.SharePointMenuRedirect" %>
		  	...
		  	<td class="dialog_header" colspan="3">
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
				  <tr>
					...
					<td class="dialog_header_text" style="font-size:15px;">Internal Server Error</td>
