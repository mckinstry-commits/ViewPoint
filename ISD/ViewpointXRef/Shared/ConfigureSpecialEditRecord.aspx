<%@ Page Language="C#" AutoEventWireup="true" Inherits="ViewpointXRef.UI.BaseApplicationPage" %>
                                                    ...
                                                    <ol>
                                                        ...
                                                        <li>Go to the Application Explorer tab, navigate in the tree to the page that contains
                                                            ...
                                                            <ul style="list-style-type: disc">
                                                                <li>Select the name of the Edit button or icon on the page. Then click the 'Button actions' in the Properties sheet.</li>
