<%@ Page Language="vb" AutoEventWireup="false" Inherits="ViewpointXRef.UI.BaseApplicationPage" MasterPageFile="~/Master Pages/Blank.master"%>
                                        ...
                                        <ol>
                                            ...
                                            <li>Go to the Application Explorer tab, navigate in the tree to the page that contains
                                                ...
                                                <ul style="list-style-type: disc">
                                                    <li>Select the name of the Edit button or icon on the page. Then click the 'Button actions' on the Properties sheet.</li>
