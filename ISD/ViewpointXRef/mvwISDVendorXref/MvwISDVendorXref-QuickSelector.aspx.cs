...
// This file implements the code-behind class for MvwISDVendorXref_QuickSelector.aspx.
// MvwISDVendorXref_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
public partial class MvwISDVendorXref_QuickSelector
        : BaseApplicationPage
// Code-behind class for the MvwISDVendorXref_QuickSelector page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public MvwISDVendorXref_QuickSelector()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public ViewpointXRef.UI.Controls.MvwISDVendorXref_QuickSelector.SelectorTableControl SelectorTableControl;
    ...
    public static string[] GetAutoCompletionList_Search_Base(string prefixText, int count)
    {
        ...
        ViewpointXRef.UI.Controls.MvwISDVendorXref_QuickSelector.SelectorTableControl control = new ViewpointXRef.UI.Controls.MvwISDVendorXref_QuickSelector.SelectorTableControl();
