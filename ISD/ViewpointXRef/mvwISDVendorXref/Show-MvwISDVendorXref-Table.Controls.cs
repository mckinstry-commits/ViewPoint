...
namespace ViewpointXRef.UI.Controls.Show_MvwISDVendorXref_Table
{
       ...
       public BaseMvwISDVendorXrefTableControl()
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            // Setup the sorting events.
              ...
              this.VendorGroupLabel.Click += VendorGroupLabel_Click;
      ...
      newRecordList.Add(rec);
        ...
        public virtual void SetIsSubcontractorFilter()
        {
            ...
            this.PopulateIsSubcontractorFilter(MiscUtils.GetSelectedValueList(this.IsSubcontractorFilter, IsSubcontractorFilterselectedFilterItemList), 500);
              ...
              this.IsSubcontractorFilter.Attributes["onClick"] = "initializePopupPage(this, '" + this.IsSubcontractorFilter.PostBackUrl + "', true, event); return false;";                  
                    ...
                    
        {
            ...
            if (this.IsSubcontractorFilter.Items.Count == 0)
                this.IsSubcontractorFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "ViewpointXRef"), "--ANY--"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "MvwISDVendorXrefTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage2(document.getElementById('" + MiscUtils.FindControlRecursively(this, "MvwISDVendorXrefTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
        ...
        public virtual void VendorGroupLabel_Click(object sender, EventArgs args)
        {
            //Sorts by VendorGroup when clicked.
              
            // Get previous sorting state for VendorGroup.
        
            OrderByItem sd = this.CurrentSortOrder.Find(MvwISDVendorXrefView.VendorGroup);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for VendorGroup.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(MvwISDVendorXrefView.VendorGroup, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by VendorGroup, so just reverse.
                sd.Reverse();
            }
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              if (this.TotalRecords > 10000)
              {
                ...
                BaseColumn[] columns = new BaseColumn[] {
                             MvwISDVendorXrefView.VendorGroup,
             ...
             null};
              ...
              DataForExport data = new DataForExport(MvwISDVendorXrefView.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(MvwISDVendorXrefView.VendorGroup, "0"));
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(MvwISDVendorXrefView.VendorGroup.Name, ReportEnum.Align.Right, "${VendorGroup}", ReportEnum.Align.Right, 15);
                 ...
                 report.AddColumn(MvwISDVendorXrefView.VendorName.Name, ReportEnum.Align.Left, "${VendorName}", ReportEnum.Align.Left, 30);
                 ...
                 report.AddColumn(MvwISDVendorXrefView.Address.Name, ReportEnum.Align.Left, "${Address}", ReportEnum.Align.Left, 30);
                 report.AddColumn(MvwISDVendorXrefView.Address2.Name, ReportEnum.Align.Left, "${Address2}", ReportEnum.Align.Left, 30);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${VendorGroup}", record.Format(MvwISDVendorXrefView.VendorGroup), ReportEnum.Align.Right, 300);
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton VendorGroupLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VendorGroupLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual MvwISDVendorXrefTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MvwISDVendorXrefTableControlRow[])((new ArrayList()).ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDVendorXref_Table.MvwISDVendorXrefTableControlRow")));
        ...
        public MvwISDVendorXrefTableControlRow[] GetRecordControls()
        {
            ...
            return (MvwISDVendorXrefTableControlRow[])recordList.ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDVendorXref_Table.MvwISDVendorXrefTableControlRow"));
        }
