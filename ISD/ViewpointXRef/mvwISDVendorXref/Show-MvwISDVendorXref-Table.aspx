...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Show-MvwISDVendorXref-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="ViewpointXRef.UI.Show_MvwISDVendorXref_Table" %>
<%@ Register Tagprefix="ViewpointXRef" TagName="PaginationMedium" Src="../Shared/PaginationMedium.ascx" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="ViewpointXRef" Namespace="ViewpointXRef.UI.Controls.Show_MvwISDVendorXref_Table" Assembly="ViewpointXRef" %>
		...
		<asp:UpdatePanel runat="server" id="UpdatePanel1" UpdateMode="Conditional">
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0"><tr><td>
                        <ViewpointXRef:MvwISDVendorXrefTableControl runat="server" id="MvwISDVendorXrefTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="ms-rteThemeBackColor-3-0 dh"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><img src="../Images/space.gif" alt="" /></td><td><table cellpadding="0" cellspacing="0" border="0"><tr><td><asp:Literal runat="server" id="Title" Text="&lt;%#String.Concat(&quot;Vendor Cross Reference&quot;) %>">	</asp:Literal></td></tr></table>
...
<%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("SearchButton"))%>
</td><td class="fila"><ViewpointXRef:ThemeButton runat="server" id="SearchButton" button-causesvalidation="False" button-commandname="Search" button-text="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;ViewpointXRef&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;ViewpointXRef&quot;) %>" postback="False"></ViewpointXRef:ThemeButton></td></tr><tr><td class="fila"><asp:Literal runat="server" id="IsSubcontractorLabel1" Text="Is Subcontractor">	</asp:Literal></td><td><BaseClasses:QuickSelector runat="server" id="IsSubcontractorFilter" autopostback="True" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector></td><td class="filbc" rowspan="1"></td></tr></table>
            ...
            <!--To change the position of the pagination control, please search for "prspace" on the Online Help for instruction. --></td><td><img src="../Images/paginationRowEdgeR.gif" alt="" /></td><td></td></tr></table>
</td></tr><tr><td class="tre"><table id="MvwISDVendorXrefTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="ms-rteThemeBackColor-3-0" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC; padding:3px;font-size: 10px;font-weight: bold;vertical-align: top;" colspan="2"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="ms-rteThemeBackColor-3-0" scope="col" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC; padding:3px;font-size: 10px;font-weight: bold;vertical-align: top;"><asp:LinkButton runat="server" id="VendorGroupLabel" tooltip="Sort by VendorGroup" Text="Vendor Group" CausesValidation="False">	</asp:LinkButton>
                        </th><th class="ms-rteThemeBackColor-3-0" scope="col" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC; padding:3px;font-size: 10px;font-weight: bold;vertical-align: top;"><asp:LinkButton runat="server" id="VPVendorLabel" tooltip="Sort by VPVendor" Text="VP Vendor" CausesValidation="False">	</asp:LinkButton>
                        </th><th class="ms-rteThemeBackColor-3-0" scope="col" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC; padding:3px;font-size: 10px;font-weight: bold;vertical-align: top;"><asp:LinkButton runat="server" id="CGCVendorLabel" tooltip="Sort by CGCVendor" Text="CGC Vendor" CausesValidation="False">	</asp:LinkButton>
                        </th><th class="ms-rteThemeBackColor-3-0" scope="col" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC; padding:3px;font-size: 10px;font-weight: bold;vertical-align: top;"><asp:LinkButton runat="server" id="VendorNameLabel" tooltip="Sort by VendorName" Text="Vendor Name" CausesValidation="False">	</asp:LinkButton>
                        </th><th class="ms-rteThemeBackColor-3-0" scope="col" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC; padding:3px;font-size: 10px;font-weight: bold;vertical-align: top;"><asp:LinkButton runat="server" id="IsSubcontractorLabel" tooltip="Sort by IsSubcontractor" Text="Is Subcontractor" CausesValidation="False">	</asp:LinkButton>
                        ...
                        </th></tr><asp:Repeater runat="server" id="MvwISDVendorXrefTableControlRepeater">		<ITEMTEMPLATE>		<ViewpointXRef:MvwISDVendorXrefTableControlRow runat="server" id="MvwISDVendorXrefTableControlRow">
<tr><td class="ticnb" scope="row"> 
<asp:ImageButton runat="server" id="ViewRowButton" causesvalidation="False" commandname="Redirect" cssclass="button_link" imageurl="../Images/icon_view.gif" onmouseout="this.src='../Images/icon_view.gif'" onmouseover="this.src='../Images/icon_view_over.gif'" tooltip="&lt;%# GetResourceValue(&quot;Txt:ViewRecord&quot;, &quot;ViewpointXRef&quot;) %>">		
...
<asp:Literal runat="server" id="VPVendor"></asp:Literal></span>
 </td><td class="ttc"><asp:Literal runat="server" id="CGCVendor"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="VendorName"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="IsSubcontractor"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="Address"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="Address2"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="City"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="State"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="Zip"></asp:Literal> </td></tr></ViewpointXRef:MvwISDVendorXrefTableControlRow>
</ITEMTEMPLATE>
...
</ViewpointXRef:MvwISDVendorXrefTableControl>
