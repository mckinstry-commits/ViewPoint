...
// This file implements the code-behind class for Show_MvwISDVendorXref_Table.aspx.
// Show_MvwISDVendorXref_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_MvwISDVendorXref_Table
        : BaseApplicationPage
// Code-behind class for the Show_MvwISDVendorXref_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_MvwISDVendorXref_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetMvwISDVendorXrefTableControl()
        {
            SetMvwISDVendorXrefTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public ViewpointXRef.UI.Controls.Show_MvwISDVendorXref_Table.MvwISDVendorXrefTableControl MvwISDVendorXrefTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = "ISD Vendor Cross Reference";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "MvwISDVendorXrefTableControl":
                 SetMvwISDVendorXrefTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.MvwISDVendorXrefTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        ViewpointXRef.UI.Controls.Show_MvwISDVendorXref_Table.MvwISDVendorXrefTableControl control = new ViewpointXRef.UI.Controls.Show_MvwISDVendorXref_Table.MvwISDVendorXrefTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetMvwISDVendorXrefTableControl_Base()           
        
        {        
            if (MvwISDVendorXrefTableControl.Visible)
            {
                MvwISDVendorXrefTableControl.LoadData();
                MvwISDVendorXrefTableControl.DataBind();
            }
        }
