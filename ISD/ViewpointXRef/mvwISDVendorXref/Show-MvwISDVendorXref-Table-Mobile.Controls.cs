...
// Show_MvwISDVendorXref_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace ViewpointXRef.UI.Controls.Show_MvwISDVendorXref_Table_Mobile
{
...
// Base class for the MvwISDVendorXrefTableControlRow control on the Show_MvwISDVendorXref_Table_Mobile page.
// Do not modify this class. Instead override any method in MvwISDVendorXrefTableControlRow.
public class BaseMvwISDVendorXrefTableControlRow : ViewpointXRef.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetVendorName()
        {
            ...
            // Set the VendorName Label on the webpage with value from the
            // DatabaseViewpoint%dbo.mvwISDVendorXref database record.

            // this.DataSource is the DatabaseViewpoint%dbo.mvwISDVendorXref record retrieved from the database.
            // this.VendorName is the ASP:Label on the webpage.
...
//
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../mvwISDVendorXref/Show-MvwISDVendorXref-Mobile.aspx?MvwISDVendorXref={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label VendorName {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VendorName");
            }
        }
...
// Base class for the MvwISDVendorXrefTableControl control on the Show_MvwISDVendorXref_Table_Mobile page.
// Do not modify this class. Instead override any method in MvwISDVendorXrefTableControl.
public class BaseMvwISDVendorXrefTableControl : ViewpointXRef.UI.BaseApplicationTableControl
{
       ...
       public BaseMvwISDVendorXrefTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.VendorNameFilter)) 				
                    initialVal = this.GetFromSession(this.VendorNameFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"VendorName\")");
                
                if (initialVal != null && initialVal != "")		
                {
                        
                    this.VendorNameFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.VendorNameFilter.SelectedValue = initialVal;
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            this.VendorNameFilter.SelectedIndexChanged += new EventHandler(VendorNameFilter_SelectedIndexChanged);
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(ViewpointXRef.Business.MvwISDVendorXrefRecord);
      ...
      public override void DataBind()
      {
        ...
        public virtual void ResetControl()
        {
            ...
            this.VendorNameFilter.ClearSelection();
      ...
      foreach(BaseColumn col in cols)
      {
            ...
            if (MiscUtils.IsValueSelected(this.VendorNameFilter)) {
                        
                wc.iAND(MvwISDVendorXrefView.VendorName, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.VendorNameFilter, this.GetFromSession(this.VendorNameFilter)), false, false);
      ...
      String VendorNameFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "VendorNameFilter_Ajax"];
            if (MiscUtils.IsValueSelected(VendorNameFilterSelectedValue)) {

              
                wc.iAND(MvwISDVendorXrefView.VendorName, BaseFilter.ComparisonOperator.EqualsTo, VendorNameFilterSelectedValue, false, false);
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            ViewpointXRef.Business.MvwISDVendorXrefRecord[] recordList  = MvwISDVendorXrefView.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            ...
            foreach (MvwISDVendorXrefRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDVendorXrefView.VendorName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
    ...
    MvwISDVendorXrefTableControlRow recControl = (MvwISDVendorXrefTableControlRow)(repItem.FindControl("MvwISDVendorXrefTableControlRow"));
      ...
      MvwISDVendorXrefRecord rec = new MvwISDVendorXrefRecord();
                        ...
                        if (recControl.VendorGroup.Text != "") {
                            rec.Parse(recControl.VendorGroup.Text, MvwISDVendorXrefView.VendorGroup);
                  }
      ...
      newRecordList.Add(rec);
        ...
        public virtual void SetVendorNameFilter()
        {
            
            this.PopulateVendorNameFilter(MiscUtils.GetSelectedValue(this.VendorNameFilter,  GetFromSession(this.VendorNameFilter)), 500);					
        ...
        // Get the filters' data for VendorNameFilter.
                
        protected virtual void PopulateVendorNameFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.VendorNameFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_VendorNameFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_VendorNameFilter function.
            // It is better to customize the where clause there.
          
            // Setup the static list items        
            
            // Add the All item.
            this.VendorNameFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "ViewpointXRef"), "--ANY--"));
                              
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(MvwISDVendorXrefView.VendorName, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = MvwISDVendorXrefView.GetValues(MvwISDVendorXrefView.VendorName, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( MvwISDVendorXrefView.VendorName.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = MvwISDVendorXrefView.VendorName.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.VendorNameFilter.Items.FindByText(fvalue);
                ...
                this.VendorNameFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.VendorNameFilter, selectedValue);
            ...
            if (this.VendorNameFilter.SelectedValue != null && this.VendorNameFilter.Items.FindByValue(this.VendorNameFilter.SelectedValue) == null)
                this.VendorNameFilter.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_VendorNameFilter()
        {
            // Create a where clause for the filter VendorNameFilter.
            // This function is called by the Populate method to load the items 
            // in the VendorNameFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.VendorNameFilter, this.VendorNameFilter.SelectedValue);
      ...
      this.SaveToSession("VendorNameFilter_Ajax", this.VendorNameFilter.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.VendorNameFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void VendorNameFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public ViewpointXRef.UI.IThemeButtonMobile MenuButton {
            get {
                return (ViewpointXRef.UI.IThemeButtonMobile)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MenuButton");
            }
        }
        ...
        public ViewpointXRef.UI.IInfinitePaginationMobile Pagination {
            get {
                return (ViewpointXRef.UI.IInfinitePaginationMobile)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Pagination");
            }
        }
        
        public ViewpointXRef.UI.IThemeButtonMobile SearchButton {
            get {
                return (ViewpointXRef.UI.IThemeButtonMobile)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SearchButton");
            }
        }
        ...
        public System.Web.UI.WebControls.DropDownList VendorNameFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VendorNameFilter");
            }
        }
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (MvwISDVendorXrefTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        MvwISDVendorXrefTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual MvwISDVendorXrefTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MvwISDVendorXrefTableControlRow[])(selectedList.ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDVendorXref_Table_Mobile.MvwISDVendorXrefTableControlRow")));
        ...
        public MvwISDVendorXrefTableControlRow[] GetRecordControls()
        {
            ...
            return (MvwISDVendorXrefTableControlRow[])recordList.ToArray(Type.GetType("ViewpointXRef.UI.Controls.Show_MvwISDVendorXref_Table_Mobile.MvwISDVendorXrefTableControlRow"));
        }
