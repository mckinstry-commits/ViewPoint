...
// This file implements the code-behind class for Show_MvwISDVendorXref_Table_Mobile.aspx.
// Show_MvwISDVendorXref_Table_Mobile.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_MvwISDVendorXref_Table_Mobile
        : BaseApplicationPage
// Code-behind class for the Show_MvwISDVendorXref_Table_Mobile page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_MvwISDVendorXref_Table_Mobile()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public ViewpointXRef.UI.Controls.Show_MvwISDVendorXref_Table_Mobile.MvwISDVendorXrefTableControl MvwISDVendorXrefTableControl;
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        ViewpointXRef.UI.Controls.Show_MvwISDVendorXref_Table_Mobile.MvwISDVendorXrefTableControl control = new ViewpointXRef.UI.Controls.Show_MvwISDVendorXref_Table_Mobile.MvwISDVendorXrefTableControl();
