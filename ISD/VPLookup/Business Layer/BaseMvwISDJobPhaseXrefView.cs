...
public class BaseMvwISDJobPhaseXrefView : PrimaryKeyTable
{
    ...
    protected virtual void Initialize()
    {
        ...
        this.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("VPLookup.Business", "VPLookup.Business.MvwISDJobPhaseXrefView");
        def.InitializeTableDefinition(this.TableDefinition);
        this.ConnectionName = def.GetConnectionName();
        this.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("VPLookup.Business", "VPLookup.Business.MvwISDJobPhaseXrefRecord");
        ...
        IsPhaseActiveColumn.CodeName = "IsPhaseActive";
...
#region "Properties for columns"
    ...
    /// <summary>
    /// This is a convenience property that provides direct access to the table's mvwISDJobPhaseXref_.VPCustomer column object.
    /// </summary>
    ...
    public static BaseClasses.Data.NumberColumn VPCustomer
    {
        get
        {
            return MvwISDJobPhaseXrefView.Instance.VPCustomerColumn;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's mvwISDJobPhaseXref_.VPCustomerName column object.
    /// </summary>
    ...
    public static BaseClasses.Data.StringColumn VPCustomerName
    {
        get
        {
            return MvwISDJobPhaseXrefView.Instance.VPCustomerNameColumn;
        }
    }
    ...
    /// <summary>
    /// This is a convenience property that provides direct access to the table's mvwISDJobPhaseXref_.SalesPerson column object.
    /// </summary>
    ...
    public static BaseClasses.Data.NumberColumn SalesPerson
    {
        get
        {
            return MvwISDJobPhaseXrefView.Instance.SalesPersonColumn;
        }
    }
    
    
    /// <summary>
    /// This is a convenience property that provides direct access to the table's mvwISDJobPhaseXref_.SalesPersonName column object.
    /// </summary>
    ...
    public static BaseClasses.Data.StringColumn SalesPersonName
    {
        get
        {
            return MvwISDJobPhaseXrefView.Instance.SalesPersonNameColumn;
        }
    }
    ...
    /// <summary>
    /// This is a convenience property that provides direct access to the table's mvwISDJobPhaseXref_.IsPhaseActive column object.
    /// </summary>
    public BaseClasses.Data.StringColumn IsPhaseActiveColumn
    {
        get
        {
    ...
    /// This is a convenience property that provides direct access to the table's mvwISDJobPhaseXref_.IsPhaseActive column object.
    /// </summary>
    public static BaseClasses.Data.StringColumn IsPhaseActive
    {
        get
        {
            return MvwISDJobPhaseXrefView.Instance.IsPhaseActiveColumn;
        }
    }
    ...
    /// <summary>
    /// This is a convenience property that provides direct access to the table's mvwISDJobPhaseXref_.CustomerKey column object.
    /// </summary>
    ...
    public static BaseClasses.Data.StringColumn CustomerKey
    {
        get
        {
            return MvwISDJobPhaseXrefView.Instance.CustomerKeyColumn;
        }
    }
...
#region "Shared helper methods"
    ...
    public static MvwISDJobPhaseXrefRecord[] GetRecords(string where, OrderBy orderBy, int pageIndex, int pageSize)
    {
        ...
        return (MvwISDJobPhaseXrefRecord[])recList.ToArray(Type.GetType("VPLookup.Business.MvwISDJobPhaseXrefRecord"));
    }   
    ...
    public static BaseColumn GetColumnByName(string name)
    {
        ...
        rec.SetString(IsPhaseActiveValue, IsPhaseActiveColumn);
