...
/// <see cref="MvwISDCustomerXrefView">VPLookup.MvwISDCustomerXrefView</see> class
...
#region "Definition (XML) for MvwISDCustomerXrefDefinition table"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(  @"<TableStoredProcPrefix>pVPLookupMvwISDCustomerXref</TableStoredProcPrefix>");
