...
/// <see cref="MvwISDVendorXrefView">VPLookup.MvwISDVendorXrefView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="MvwISDVendorXrefView"></seealso>
public class MvwISDVendorXrefDefinition
{
#region "Definition (XML) for MvwISDVendorXrefDefinition table"
	//Next 307 lines contain Table Definition (XML) for table "MvwISDVendorXrefDefinition"
	...
	/// <see cref="MvwISDVendorXrefView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>VPVendor</columnName>");
         tbf.Append(      @"<columnUIName>VP Vendor</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         ...
         tbf.Append(      @"<columnName>CGCVendor</columnName>");
         tbf.Append(      @"<columnUIName>CGC Vendor</columnUIName>");
         ...
         tbf.Append(      @"<columnName>VendorName</columnName>");
         tbf.Append(      @"<columnUIName>Vendor Name</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>varchar</columnDBType>");
         ...
         tbf.Append(      @"<columnName>IsSubcontractor</columnName>");
         tbf.Append(      @"<columnUIName>Is Subcontractor</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         ...
         tbf.Append(      @"<columnName>VendorKey</columnName>");
         tbf.Append(      @"<columnUIName>Vendor Key</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>varchar</columnDBType>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>mvwISDVendorXref</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>mvwISDVendorXref_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>mvwISDVendorXref</FolderName>");
         tbf.Append(  @"<MenuName>ISD Vendor Cross Reference</MenuName>");
         tbf.Append(  @"<QSPath>../mvwISDVendorXref/MvwISDVendorXref-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>MvwISDVendorXref</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pVPLookupMvwISDVendorXref</TableStoredProcPrefix>");
