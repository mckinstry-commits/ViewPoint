...
namespace VPLookup.UI.Controls.Show_MvwISDJobPhaseXref_Mobile
{
...
public class BaseMvwISDJobPhaseXrefRecordControl : VPLookup.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.DeleteButton.Attributes.Add("onClick", "return (confirm(\"" + ((BaseApplicationPage)this.Page).GetResourceValue("DeleteConfirmOneRecord", "VPLookup") + "\"));");
