...
namespace VPLookup.UI.Controls.MvwISDJobPhaseXref_QuickSelector
{
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("VPLookup.UI.Controls.MvwISDJobPhaseXref_QuickSelector.SelectorTableControlRow")));
        ...
        public SelectorTableControlRow[] GetRecordControls()
        {
            ...
            return (SelectorTableControlRow[])recordList.ToArray(Type.GetType("VPLookup.UI.Controls.MvwISDJobPhaseXref_QuickSelector.SelectorTableControlRow"));
        }
