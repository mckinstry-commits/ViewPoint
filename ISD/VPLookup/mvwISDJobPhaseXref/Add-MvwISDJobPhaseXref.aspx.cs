...
// This file implements the code-behind class for Add_MvwISDJobPhaseXref.aspx.
// Add_MvwISDJobPhaseXref.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_MvwISDJobPhaseXref
        : BaseApplicationPage
// Code-behind class for the Add_MvwISDJobPhaseXref page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_MvwISDJobPhaseXref()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetMvwISDJobPhaseXrefRecordControl()
        {
            SetMvwISDJobPhaseXrefRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public VPLookup.UI.Controls.Add_MvwISDJobPhaseXref.MvwISDJobPhaseXrefRecordControl MvwISDJobPhaseXrefRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = GetResourceValue("Title:Add") + "" + " ISD Job Phase Cross Reference";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "MvwISDJobPhaseXrefRecordControl":
                 SetMvwISDJobPhaseXrefRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.MvwISDJobPhaseXrefRecordControl.SaveData();
        ...
        SetMvwISDJobPhaseXrefRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "MvwISDJobPhaseXrefMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetMvwISDJobPhaseXrefRecordControl_Base()           
        
        {        
            if (MvwISDJobPhaseXrefRecordControl.Visible)
            {
                MvwISDJobPhaseXrefRecordControl.LoadData();
                MvwISDJobPhaseXrefRecordControl.DataBind();
            }
        }
              ...
              
        {
            ...
            if (EvaluateFormula("URL(\"SaveAndNewVisible\")").ToLower() == "true") 
                ...
                MiscUtils.FindControlRecursively(this, "SaveAndNewButton").Visible = false;
                    ...
                    this.SaveAndNewButton.Button.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.GetResourceValue("Txt:SaveRecord", "VPLookup") + "\");");
              ...
              
        {
                    ...
                    this.SaveButton.Button.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.GetResourceValue("Txt:SaveRecord", "VPLookup") + "\");");
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.MvwISDJobPhaseXrefRecordControl != null && this.MvwISDJobPhaseXrefRecordControl.DataSource != null)
                  {
                        id = this.MvwISDJobPhaseXrefRecordControl.DataSource.GetValue(this.MvwISDJobPhaseXrefRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.MvwISDJobPhaseXrefRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.MvwISDJobPhaseXrefRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.MvwISDJobPhaseXrefRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.MvwISDJobPhaseXrefRecordControl.DataSource.GetValue(this.MvwISDJobPhaseXrefRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
