...
namespace VPLookup.UI.Controls.Show_MvwISDJobPhaseXref_Table_Mobile
{
...
public class BaseMvwISDJobPhaseXrefTableControlRow : VPLookup.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetVPCustomerName()
        {
            ...
            // Set the VPCustomerName Label on the webpage with value from the
            // DatabaseViewpoint%dbo.mvwISDJobPhaseXref database record.

            // this.DataSource is the DatabaseViewpoint%dbo.mvwISDJobPhaseXref record retrieved from the database.
            // this.VPCustomerName is the ASP:Label on the webpage.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label VPCustomerName {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPCustomerName");
            }
        }
...
public class BaseMvwISDJobPhaseXrefTableControl : VPLookup.UI.BaseApplicationTableControl
{
       ...
       public BaseMvwISDJobPhaseXrefTableControl()
           ...
           // Setup the filter and search.
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.VPCustomerNameFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.VPCustomerNameFilter.SelectedValue = initialVal;
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            this.VPCustomerNameFilter.SelectedIndexChanged += new EventHandler(VPCustomerNameFilter_SelectedIndexChanged);
      ...
      foreach(BaseColumn col in cols)
      {
            ...
            if (MiscUtils.IsValueSelected(this.VPCustomerNameFilter)) {
                ...
                wc.iAND(MvwISDJobPhaseXrefView.VPCustomerName, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.VPCustomerNameFilter, this.GetFromSession(this.VPCustomerNameFilter)), false, false);
      ...
      String VPCustomerNameFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "VPCustomerNameFilter_Ajax"];
            if (MiscUtils.IsValueSelected(VPCustomerNameFilterSelectedValue)) {
                ...
                wc.iAND(MvwISDJobPhaseXrefView.VPCustomerName, BaseFilter.ComparisonOperator.EqualsTo, VPCustomerNameFilterSelectedValue, false, false);
            ...
            foreach (MvwISDJobPhaseXrefRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobPhaseXrefView.VPCustomerName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
    ...
    MvwISDJobPhaseXrefTableControlRow recControl = (MvwISDJobPhaseXrefTableControlRow)(repItem.FindControl("MvwISDJobPhaseXrefTableControlRow"));
      ...
      newRecordList.Add(rec);
        ...
        public virtual void SetVPCustomerNameFilter()
        {
            ...
            this.PopulateVPCustomerNameFilter(MiscUtils.GetSelectedValue(this.VPCustomerNameFilter,  GetFromSession(this.VPCustomerNameFilter)), 500);					
        ...
        protected virtual void PopulateVPCustomerNameFilter(string selectedValue, int maxItems)
                    
        {
            ...
            // Add the All item.
            this.VPCustomerNameFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "VPLookup"), "--ANY--"));
                              
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(MvwISDJobPhaseXrefView.VPCustomerName, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = MvwISDJobPhaseXrefView.GetValues(MvwISDJobPhaseXrefView.VPCustomerName, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( MvwISDJobPhaseXrefView.VPCustomerName.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = MvwISDJobPhaseXrefView.VPCustomerName.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.VPCustomerNameFilter, selectedValue);
            ...
            if (this.VPCustomerNameFilter.SelectedValue != null && this.VPCustomerNameFilter.Items.FindByValue(this.VPCustomerNameFilter.SelectedValue) == null)
                this.VPCustomerNameFilter.SelectedValue = null;
        ...
        public virtual WhereClause CreateWhereClause_VPCustomerNameFilter()
        {
            ...
            // in the VPCustomerNameFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.VPCustomerNameFilter, this.VPCustomerNameFilter.SelectedValue);
      ...
      this.SaveToSession("VPCustomerNameFilter_Ajax", this.VPCustomerNameFilter.SelectedValue);
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList VPCustomerNameFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "VPCustomerNameFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual MvwISDJobPhaseXrefTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MvwISDJobPhaseXrefTableControlRow[])(selectedList.ToArray(Type.GetType("VPLookup.UI.Controls.Show_MvwISDJobPhaseXref_Table_Mobile.MvwISDJobPhaseXrefTableControlRow")));
        ...
        public MvwISDJobPhaseXrefTableControlRow[] GetRecordControls()
        {
            ...
            return (MvwISDJobPhaseXrefTableControlRow[])recordList.ToArray(Type.GetType("VPLookup.UI.Controls.Show_MvwISDJobPhaseXref_Table_Mobile.MvwISDJobPhaseXrefTableControlRow"));
        }
