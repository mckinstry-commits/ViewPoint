...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="MvwISDJobPhaseXref-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="VPLookup.UI.MvwISDJobPhaseXref_QuickSelector" %>
<%@ Register Tagprefix="VPLookup" Namespace="VPLookup.UI.Controls.MvwISDJobPhaseXref_QuickSelector" Assembly="VPLookup" %>
