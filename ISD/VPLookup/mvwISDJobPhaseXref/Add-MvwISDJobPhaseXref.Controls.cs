...
// Add_MvwISDJobPhaseXref.aspx page.  The Row or RecordControl classes are the 
...
namespace VPLookup.UI.Controls.Add_MvwISDJobPhaseXref
{
...
// Base class for the MvwISDJobPhaseXrefRecordControl control on the Add_MvwISDJobPhaseXref page.
...
public class BaseMvwISDJobPhaseXrefRecordControl : VPLookup.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (MvwISDJobPhaseXrefRecord)MvwISDJobPhaseXrefRecord.Copy(recList[0], false);
        ...
        public virtual void SetJobKey()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"JobKey\")");
...
//
            ...
            string recId = this.Page.Request.QueryString["MvwISDJobPhaseXref"];
            ...
            HttpContext.Current.Session["QueryString in Add-MvwISDJobPhaseXref"] = recId;
...
#region "Helper Properties"
    ...
    MvwISDJobPhaseXrefRecord rec = null;
             ...
             
        {
            ...
            return new MvwISDJobPhaseXrefRecord();
