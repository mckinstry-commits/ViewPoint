...
// This file implements the code-behind class for Show_MvwISDPhaseMasterCostTypes_Mobile.aspx.
// Show_MvwISDPhaseMasterCostTypes_Mobile.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_MvwISDPhaseMasterCostTypes_Mobile
        : BaseApplicationPage
// Code-behind class for the Show_MvwISDPhaseMasterCostTypes_Mobile page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_MvwISDPhaseMasterCostTypes_Mobile()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetMvwISDPhaseMasterCostTypesRecordControl()
        {
            SetMvwISDPhaseMasterCostTypesRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public VPLookup.UI.Controls.Show_MvwISDPhaseMasterCostTypes_Mobile.MvwISDPhaseMasterCostTypesRecordControl MvwISDPhaseMasterCostTypesRecordControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "MvwISDPhaseMasterCostTypesRecordControl":
                 SetMvwISDPhaseMasterCostTypesRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.MvwISDPhaseMasterCostTypesRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetMvwISDPhaseMasterCostTypesRecordControl_Base()           
        
        {        
            if (MvwISDPhaseMasterCostTypesRecordControl.Visible)
            {
                MvwISDPhaseMasterCostTypesRecordControl.LoadData();
                MvwISDPhaseMasterCostTypesRecordControl.DataBind();
            }
        }
