...
// This file implements the code-behind class for MvwISDPhaseMasterCostTypes_QuickSelector.aspx.
// MvwISDPhaseMasterCostTypes_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
public partial class MvwISDPhaseMasterCostTypes_QuickSelector
        : BaseApplicationPage
// Code-behind class for the MvwISDPhaseMasterCostTypes_QuickSelector page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public MvwISDPhaseMasterCostTypes_QuickSelector()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public VPLookup.UI.Controls.MvwISDPhaseMasterCostTypes_QuickSelector.SelectorTableControl SelectorTableControl;
    ...
    public static string[] GetAutoCompletionList_Search_Base(string prefixText, int count)
    {
        ...
        VPLookup.UI.Controls.MvwISDPhaseMasterCostTypes_QuickSelector.SelectorTableControl control = new VPLookup.UI.Controls.MvwISDPhaseMasterCostTypes_QuickSelector.SelectorTableControl();
