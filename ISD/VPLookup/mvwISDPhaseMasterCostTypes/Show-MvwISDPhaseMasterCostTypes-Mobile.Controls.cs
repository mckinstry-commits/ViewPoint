...
// Show_MvwISDPhaseMasterCostTypes_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace VPLookup.UI.Controls.Show_MvwISDPhaseMasterCostTypes_Mobile
{
...
// Base class for the MvwISDPhaseMasterCostTypesRecordControl control on the Show_MvwISDPhaseMasterCostTypes_Mobile page.
// Do not modify this class. Instead override any method in MvwISDPhaseMasterCostTypesRecordControl.
public class BaseMvwISDPhaseMasterCostTypesRecordControl : VPLookup.UI.BaseApplicationRecordControl
{
        public BaseMvwISDPhaseMasterCostTypesRecordControl()
        {
        ...
        // To customize, override this method in MvwISDPhaseMasterCostTypesRecordControl.
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "MvwISDPhaseMasterCostTypesRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            MvwISDPhaseMasterCostTypesRecord[] recList = MvwISDPhaseMasterCostTypesView.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = MvwISDPhaseMasterCostTypesView.GetRecord(recList[0].GetID().ToXmlString(), true);
...
//Bryan Check
            ...
            bool hasFiltersMvwISDPhaseMasterCostTypesRecordControl = false;
            hasFiltersMvwISDPhaseMasterCostTypesRecordControl = hasFiltersMvwISDPhaseMasterCostTypesRecordControl && false; // suppress warning
...
//
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["MvwISDPhaseMasterCostTypes"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "VPLookup").Replace("{URL}", "MvwISDPhaseMasterCostTypes"));
            }
            HttpContext.Current.Session["QueryString in Show-MvwISDPhaseMasterCostTypes-Mobile"] = recId;
            ...
            if (KeyValue.IsXmlKey(recId)) {
                ...
                wc.iAND(MvwISDPhaseMasterCostTypesView.PhaseMasterCostTypeKey, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(MvwISDPhaseMasterCostTypesView.PhaseMasterCostTypeKey));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
                wc.iAND(MvwISDPhaseMasterCostTypesView.PhaseMasterCostTypeKey, BaseFilter.ComparisonOperator.EqualsTo, recId);
...
//
      ...
      this.Page.RedirectBack();
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseMvwISDPhaseMasterCostTypesRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseMvwISDPhaseMasterCostTypesRecordControl_Rec"] = value;
            }
        }
