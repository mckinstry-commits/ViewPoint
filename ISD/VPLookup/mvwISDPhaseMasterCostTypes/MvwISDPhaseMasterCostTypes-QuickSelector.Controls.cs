...
// MvwISDPhaseMasterCostTypes_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace VPLookup.UI.Controls.MvwISDPhaseMasterCostTypes_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the MvwISDPhaseMasterCostTypes_QuickSelector page.
...
// Base class for the SelectorTableControl control on the MvwISDPhaseMasterCostTypes_QuickSelector page.
...
public class BaseSelectorTableControl : VPLookup.UI.BaseApplicationTableControl
{
       ...
       public BaseSelectorTableControl()
        ...
        {    
            ...
            {
                BaseColumn col = MvwISDPhaseMasterCostTypesView.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, MvwISDPhaseMasterCostTypesView.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = MvwISDPhaseMasterCostTypesView.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("VPLookup.UI.Controls.MvwISDPhaseMasterCostTypes_QuickSelector.SelectorTableControlRow")));
        ...
        public SelectorTableControlRow[] GetRecordControls()
        {
            ...
            return (SelectorTableControlRow[])recordList.ToArray(Type.GetType("VPLookup.UI.Controls.MvwISDPhaseMasterCostTypes_QuickSelector.SelectorTableControlRow"));
        }
