...
// Show_MvwISDPhaseMasterCostTypes_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace VPLookup.UI.Controls.Show_MvwISDPhaseMasterCostTypes_Table
{
...
// Base class for the MvwISDPhaseMasterCostTypesTableControlRow control on the Show_MvwISDPhaseMasterCostTypes_Table page.
...
//
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../mvwISDPhaseMaster/Show-MvwISDPhaseMaster.aspx?MvwISDPhaseMaster={MvwISDPhaseMasterCostTypesTableControlRow:FV:PhaseMasterKey}";
...
// Base class for the MvwISDPhaseMasterCostTypesTableControl control on the Show_MvwISDPhaseMasterCostTypes_Table page.
...
public class BaseMvwISDPhaseMasterCostTypesTableControl : VPLookup.UI.BaseApplicationTableControl
{
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.CostTypeCodeFilter)) {
                ...
                foreach (ListItem item in this.CostTypeCodeFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(MvwISDPhaseMasterCostTypesView.CostTypeCode, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      cols.Add(MvwISDPhaseMasterCostTypesView.Phase);
      ...
      String CostTypeCodeFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CostTypeCodeFilter_Ajax"];
        ...
        if (CostTypeCodeFilterSelectedValue != null){
                        ...
                        foreach (string item in CostTypeCodeFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(MvwISDPhaseMasterCostTypesView.CostTypeCode, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
            ...
            foreach (MvwISDPhaseMasterCostTypesRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDPhaseMasterCostTypesView.CostTypeDesc.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(MvwISDPhaseMasterCostTypesView.Phase);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(MvwISDPhaseMasterCostTypesView.Phase.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDPhaseMasterCostTypesView.Phase.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      newRecordList.Add(rec);
        ...
        public virtual void SetCostTypeCodeFilter()
        {
            ...
            this.PopulateCostTypeCodeFilter(MiscUtils.GetSelectedValueList(this.CostTypeCodeFilter, CostTypeCodeFilterselectedFilterItemList), 500);
              ...
              string url = this.ModifyRedirectUrl("../mvwISDPhaseMasterCostTypes/MvwISDPhaseMasterCostTypes-QuickSelector.aspx", "", true);
                    ...
                    
        {
            ...
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Bill Flag {Txt:Ascending}"), "BillFlag Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Bill Flag {Txt:Descending}"), "BillFlag Desc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Cost Type {Txt:Ascending}"), "CostType Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Cost Type {Txt:Descending}"), "CostType Desc"));
            ...
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Item Unit Flag {Txt:Ascending}"), "ItemUnitFlag Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Item Unit Flag {Txt:Descending}"), "ItemUnitFlag Desc"));
            ...
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Phase Master Cost Type Key {Txt:Ascending}"), "PhaseMasterCostTypeKey Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Phase Master Cost Type Key {Txt:Descending}"), "PhaseMasterCostTypeKey Desc"));
            ...
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Phase Unit Flag {Txt:Ascending}"), "PhaseUnitFlag Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Phase Unit Flag {Txt:Descending}"), "PhaseUnitFlag Desc"));
                    ...
                    
        {
            ...
            orderBy.Add(MvwISDPhaseMasterCostTypesView.CostTypeCode, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = MvwISDPhaseMasterCostTypesView.GetValues(MvwISDPhaseMasterCostTypesView.CostTypeCode, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( MvwISDPhaseMasterCostTypesView.CostTypeCode.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = MvwISDPhaseMasterCostTypesView.CostTypeCode.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
        ...
        public virtual WhereClause CreateWhereClause_CostTypeCodeFilter()
        {
            ...
            else            
            {
                foreach (string item in CostTypeCodeFilterselectedFilterItemList)
                {
                    ...
                    wc.iOR(MvwISDPhaseMasterCostTypesView.CostTypeCode, BaseFilter.ComparisonOperator.EqualsTo, item);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-MvwISDPhaseMasterCostTypes-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "mvwISDPhaseMasterCostTypes";
                // If Show-MvwISDPhaseMasterCostTypes-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-MvwISDPhaseMasterCostTypes-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "mvwISDPhaseMasterCostTypes";
                // If Show-MvwISDPhaseMasterCostTypes-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual MvwISDPhaseMasterCostTypesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MvwISDPhaseMasterCostTypesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("VPLookup.UI.Controls.Show_MvwISDPhaseMasterCostTypes_Table.MvwISDPhaseMasterCostTypesTableControlRow")));
        ...
        public MvwISDPhaseMasterCostTypesTableControlRow[] GetRecordControls()
        {
            ...
            return (MvwISDPhaseMasterCostTypesTableControlRow[])recordList.ToArray(Type.GetType("VPLookup.UI.Controls.Show_MvwISDPhaseMasterCostTypes_Table.MvwISDPhaseMasterCostTypesTableControlRow"));
        }
