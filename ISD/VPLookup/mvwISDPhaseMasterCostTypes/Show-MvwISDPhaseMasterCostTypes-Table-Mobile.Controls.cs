...
// Show_MvwISDPhaseMasterCostTypes_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace VPLookup.UI.Controls.Show_MvwISDPhaseMasterCostTypes_Table_Mobile
{
...
// Base class for the MvwISDPhaseMasterCostTypesTableControlRow control on the Show_MvwISDPhaseMasterCostTypes_Table_Mobile page.
...
public class BaseMvwISDPhaseMasterCostTypesTableControlRow : VPLookup.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetPhase()
        {
            ...
            if (this.DataSource != null && this.DataSource.PhaseSpecified) {
              ...
              this.Phase.Text = MvwISDPhaseMasterCostTypesView.Phase.Format(MvwISDPhaseMasterCostTypesView.Phase.DefaultValue);
        ...
        public virtual void SetCostTypeDescLabel1()
                  {
...
//
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../mvwISDPhaseMasterCostTypes/Show-MvwISDPhaseMasterCostTypes-Mobile.aspx?MvwISDPhaseMasterCostTypes={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal CostTypeDescLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CostTypeDescLabel1");
            }
        }
...
// Base class for the MvwISDPhaseMasterCostTypesTableControl control on the Show_MvwISDPhaseMasterCostTypes_Table_Mobile page.
...
public class BaseMvwISDPhaseMasterCostTypesTableControl : VPLookup.UI.BaseApplicationTableControl
{
       ...
       public BaseMvwISDPhaseMasterCostTypesTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.CostTypeDescFilter)) 				
                    initialVal = this.GetFromSession(this.CostTypeDescFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"CostTypeDesc\")");
                
                if (initialVal != null && initialVal != "")		
                {
                        
                    this.CostTypeDescFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.CostTypeDescFilter.SelectedValue = initialVal;
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            this.CostTypeDescFilter.SelectedIndexChanged += new EventHandler(CostTypeDescFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        public virtual void ResetControl()
        {
            ...
            this.CostTypeDescFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.CostTypeDescFilter)) {
                        
                wc.iAND(MvwISDPhaseMasterCostTypesView.CostTypeDesc, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.CostTypeDescFilter, this.GetFromSession(this.CostTypeDescFilter)), false, false);
      ...
      cols.Add(MvwISDPhaseMasterCostTypesView.CostTypeDesc);
      ...
      String CostTypeDescFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CostTypeDescFilter_Ajax"];
            if (MiscUtils.IsValueSelected(CostTypeDescFilterSelectedValue)) {

              
                wc.iAND(MvwISDPhaseMasterCostTypesView.CostTypeDesc, BaseFilter.ComparisonOperator.EqualsTo, CostTypeDescFilterSelectedValue, false, false);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            VPLookup.Business.MvwISDPhaseMasterCostTypesRecord[] recordList  = MvwISDPhaseMasterCostTypesView.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (MvwISDPhaseMasterCostTypesRecord rec in recordList ){
                ...
                resultItem = rec.Format(MvwISDPhaseMasterCostTypesView.CostTypeDesc);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(MvwISDPhaseMasterCostTypesView.CostTypeDesc.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDPhaseMasterCostTypesView.CostTypeDesc.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
    ...
    MvwISDPhaseMasterCostTypesTableControlRow recControl = (MvwISDPhaseMasterCostTypesTableControlRow)(repItem.FindControl("MvwISDPhaseMasterCostTypesTableControlRow"));
      ...
      MvwISDPhaseMasterCostTypesRecord rec = new MvwISDPhaseMasterCostTypesRecord();
                        ...
                        if (recControl.Phase.Text != "") {
                            rec.Parse(recControl.Phase.Text, MvwISDPhaseMasterCostTypesView.Phase);
                  }
      ...
      newRecordList.Add(rec);
        ...
        public virtual void SetCostTypeDescFilter()
        {
            
            this.PopulateCostTypeDescFilter(MiscUtils.GetSelectedValue(this.CostTypeDescFilter,  GetFromSession(this.CostTypeDescFilter)), 500);					
        ...
        // Get the filters' data for CostTypeDescFilter.
                
        protected virtual void PopulateCostTypeDescFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.CostTypeDescFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_CostTypeDescFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_CostTypeDescFilter function.
            // It is better to customize the where clause there.
          
            // Setup the static list items        
            
            // Add the All item.
            this.CostTypeDescFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "VPLookup"), "--ANY--"));
                              
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(MvwISDPhaseMasterCostTypesView.CostTypeDesc, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = MvwISDPhaseMasterCostTypesView.GetValues(MvwISDPhaseMasterCostTypesView.CostTypeDesc, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( MvwISDPhaseMasterCostTypesView.CostTypeDesc.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = MvwISDPhaseMasterCostTypesView.CostTypeDesc.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.CostTypeDescFilter.Items.FindByText(fvalue);
                ...
                this.CostTypeDescFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.CostTypeDescFilter, selectedValue);
            ...
            if (this.CostTypeDescFilter.SelectedValue != null && this.CostTypeDescFilter.Items.FindByValue(this.CostTypeDescFilter.SelectedValue) == null)
                this.CostTypeDescFilter.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_CostTypeDescFilter()
        {
            // Create a where clause for the filter CostTypeDescFilter.
            // This function is called by the Populate method to load the items 
            // in the CostTypeDescFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.CostTypeDescFilter, this.CostTypeDescFilter.SelectedValue);
      ...
      this.SaveToSession("CostTypeDescFilter_Ajax", this.CostTypeDescFilter.SelectedValue);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.CostTypeDescFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void OrderSort_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in MvwISDPhaseMasterCostTypesView.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(MvwISDPhaseMasterCostTypesView.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (MvwISDPhaseMasterCostTypesView.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && MvwISDPhaseMasterCostTypesView.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(MvwISDPhaseMasterCostTypesView.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(MvwISDPhaseMasterCostTypesView.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        protected virtual void CostTypeDescFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList CostTypeDescFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CostTypeDescFilter");
            }
        }
        ...
        public VPLookup.UI.IThemeButtonMobile FilterButton {
            get {
                return (VPLookup.UI.IThemeButtonMobile)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FilterButton");
            }
        }
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (MvwISDPhaseMasterCostTypesTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        MvwISDPhaseMasterCostTypesTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual MvwISDPhaseMasterCostTypesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MvwISDPhaseMasterCostTypesTableControlRow[])(selectedList.ToArray(Type.GetType("VPLookup.UI.Controls.Show_MvwISDPhaseMasterCostTypes_Table_Mobile.MvwISDPhaseMasterCostTypesTableControlRow")));
        ...
        public MvwISDPhaseMasterCostTypesTableControlRow[] GetRecordControls()
        {
            ...
            return (MvwISDPhaseMasterCostTypesTableControlRow[])recordList.ToArray(Type.GetType("VPLookup.UI.Controls.Show_MvwISDPhaseMasterCostTypes_Table_Mobile.MvwISDPhaseMasterCostTypesTableControlRow"));
        }
