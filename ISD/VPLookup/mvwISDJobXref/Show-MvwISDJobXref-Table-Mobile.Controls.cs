...
// Show_MvwISDJobXref_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace VPLookup.UI.Controls.Show_MvwISDJobXref_Table_Mobile
{
...
// Base class for the MvwISDJobXrefTableControlRow control on the Show_MvwISDJobXref_Table_Mobile page.
...
// Base class for the MvwISDJobXrefTableControl control on the Show_MvwISDJobXref_Table_Mobile page.
            ...
            foreach (MvwISDJobXrefRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobXrefView.VPJobDesc.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobXrefView.VPJob.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobXrefView.CGCJob.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobXrefView.VPCustomer.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobXrefView.POCName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobXrefView.SalesPersonName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobXrefView.VPCustomerName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobXrefView.POC.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDJobXrefView.SalesPerson.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
    ...
    MvwISDJobXrefTableControlRow recControl = (MvwISDJobXrefTableControlRow)(repItem.FindControl("MvwISDJobXrefTableControlRow"));
      ...
      newRecordList.Add(rec);
                    ...
                    
        {
            ...
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Sales Person Email {Txt:Ascending}"), "SalesPersonEmail Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Sales Person Email {Txt:Descending}"), "SalesPersonEmail Desc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("POC Email {Txt:Ascending}"), "POCEmail Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("POC Email {Txt:Descending}"), "POCEmail Desc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Job Status {Txt:Ascending}"), "JobStatus Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Job Status {Txt:Descending}"), "JobStatus Desc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("GL Department Number {Txt:Ascending}"), "GLDepartmentNumber Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("GL Department Number {Txt:Descending}"), "GLDepartmentNumber Desc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("GL Department Name {Txt:Ascending}"), "GLDepartmentName Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("GL Department Name {Txt:Descending}"), "GLDepartmentName Desc"));
                    ...
                    
        {
            ...
            // Add the All item.
            this.GLDepartmentNumberFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "VPLookup"), "--ANY--"));
                    ...
                    
        {
            ...
            // Add the All item.
            this.JobStatusFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "VPLookup"), "--ANY--"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void OrderSort_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in MvwISDJobXrefView.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(MvwISDJobXrefView.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (MvwISDJobXrefView.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && MvwISDJobXrefView.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(MvwISDJobXrefView.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(MvwISDJobXrefView.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal GLDepartmentNumberLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "GLDepartmentNumberLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual MvwISDJobXrefTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MvwISDJobXrefTableControlRow[])(selectedList.ToArray(Type.GetType("VPLookup.UI.Controls.Show_MvwISDJobXref_Table_Mobile.MvwISDJobXrefTableControlRow")));
        ...
        public MvwISDJobXrefTableControlRow[] GetRecordControls()
        {
            ...
            return (MvwISDJobXrefTableControlRow[])recordList.ToArray(Type.GetType("VPLookup.UI.Controls.Show_MvwISDJobXref_Table_Mobile.MvwISDJobXrefTableControlRow"));
        }
