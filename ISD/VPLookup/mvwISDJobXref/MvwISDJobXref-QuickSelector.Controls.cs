...
// MvwISDJobXref_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace VPLookup.UI.Controls.MvwISDJobXref_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the MvwISDJobXref_QuickSelector page.
...
// Base class for the SelectorTableControl control on the MvwISDJobXref_QuickSelector page.
...
public class BaseSelectorTableControl : VPLookup.UI.BaseApplicationTableControl
{
       ...
       public BaseSelectorTableControl()
        ...
        {    
            ...
            {
                BaseColumn col = MvwISDJobXrefView.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, MvwISDJobXrefView.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = MvwISDJobXrefView.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void AddButton_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../mvwISDJobXref/Add-MvwISDJobXref.aspx?TabVisible=False&SaveAndNewVisible=False";
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("VPLookup.UI.Controls.MvwISDJobXref_QuickSelector.SelectorTableControlRow")));
        ...
        public SelectorTableControlRow[] GetRecordControls()
        {
            ...
            return (SelectorTableControlRow[])recordList.ToArray(Type.GetType("VPLookup.UI.Controls.MvwISDJobXref_QuickSelector.SelectorTableControlRow"));
        }
