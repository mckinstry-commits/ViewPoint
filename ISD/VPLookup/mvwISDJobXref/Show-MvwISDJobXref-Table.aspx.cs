...
// This file implements the code-behind class for Show_MvwISDJobXref_Table.aspx.
// Show_MvwISDJobXref_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_MvwISDJobXref_Table
        : BaseApplicationPage
// Code-behind class for the Show_MvwISDJobXref_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_MvwISDJobXref_Table()
        {
            this.Initialize();
...
//[System.Web.Services.WebMethod]
//        public static string[] GetAutoCompletionList_MvwISDJobPhaseXrefSearchText1(string prefixText, int count)
//        {
//            // GetMvwISDJobPhaseXrefSearchText1CompletionList gets the list of suggestions from the database.
//            // prefixText is the search text typed by the user .
//            // count specifies the number of suggestions to be returned.
//            // Customize by adding code before or after the call to  GetAutoCompletionList_MvwISDJobPhaseXrefSearchText1_Base()
//            // or replace the call to GetAutoCompletionList_MvwISDJobPhaseXrefSearchText1_Base().
//            return GetAutoCompletionList_MvwISDJobPhaseXrefSearchText1_Base(prefixText, count);
//        }
#endregion
...
#region "Section 2: Do not modify this section."
        ...
        public VPLookup.UI.Controls.Show_MvwISDJobXref_Table.MvwISDJobXrefTableControl MvwISDJobXrefTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = "Job Cross Reference";
      ...
      public void SaveData_Base()
      {
        ...
        this.MvwISDJobXrefTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        VPLookup.UI.Controls.Show_MvwISDJobXref_Table.MvwISDJobXrefTableControl control = new VPLookup.UI.Controls.Show_MvwISDJobXref_Table.MvwISDJobXrefTableControl();
        ...
        SetMvwISDJobXrefTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "MvwISDJobXrefMenuItem";
                    }
                }
