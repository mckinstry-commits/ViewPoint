...
// This file implements the code-behind class for Show_MvwISDJobXref.aspx.
// Show_MvwISDJobXref.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_MvwISDJobXref
        : BaseApplicationPage
// Code-behind class for the Show_MvwISDJobXref page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_MvwISDJobXref()
        {
            this.Initialize();
...
//        public void SetMvwISDJobXrefTabContainer()
//        {
//            SetMvwISDJobXrefTabContainer_Base(); 
//        }
        
        public void SetMvwISDJobPhaseXrefTableControl()
        {
            SetMvwISDJobPhaseXrefTableControl_Base(); 
        }
        
        public void SetMvwISDJobXrefRecordControl()
        {
            SetMvwISDJobXrefRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public VPLookup.UI.Controls.Show_MvwISDJobXref.MvwISDJobPhaseXrefTableControl MvwISDJobPhaseXrefTableControl;
          
        public VPLookup.UI.Controls.Show_MvwISDJobXref.MvwISDJobXrefRecordControl MvwISDJobXrefRecordControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "MvwISDJobPhaseXrefTableControl":
                 SetMvwISDJobPhaseXrefTableControl();
                 break;
          
              case "MvwISDJobXrefRecordControl":
      ...
      public void SaveData_Base()
      {
        ...
        this.MvwISDJobXrefRecordControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        VPLookup.UI.Controls.Show_MvwISDJobXref.MvwISDJobPhaseXrefTableControl control = new VPLookup.UI.Controls.Show_MvwISDJobXref.MvwISDJobPhaseXrefTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetMvwISDJobPhaseXrefTableControl_Base()           
        
        {        
            if (MvwISDJobPhaseXrefTableControl.Visible)
            {
                MvwISDJobPhaseXrefTableControl.LoadData();
                MvwISDJobPhaseXrefTableControl.DataBind();
            }
        }
      
        public void SetMvwISDJobXrefRecordControl_Base()           
