...
// This file implements the code-behind class for Show_MvwISDJobXref_Table_Mobile.aspx.
// Show_MvwISDJobXref_Table_Mobile.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_MvwISDJobXref_Table_Mobile
        : BaseApplicationPage
// Code-behind class for the Show_MvwISDJobXref_Table_Mobile page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_MvwISDJobXref_Table_Mobile()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public VPLookup.UI.Controls.Show_MvwISDJobXref_Table_Mobile.MvwISDJobXrefTableControl MvwISDJobXrefTableControl;
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        VPLookup.UI.Controls.Show_MvwISDJobXref_Table_Mobile.MvwISDJobXrefTableControl control = new VPLookup.UI.Controls.Show_MvwISDJobXref_Table_Mobile.MvwISDJobXrefTableControl();
