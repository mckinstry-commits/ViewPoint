...
// Show_MvwISDPhaseMaster_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace VPLookup.UI.Controls.Show_MvwISDPhaseMaster_Table
{
...
public class MvwISDPhaseMasterTableControlRow : BaseMvwISDPhaseMasterTableControlRow
{
      
        // The BaseMvwISDPhaseMasterTableControlRow implements code for a ROW within the
        // the MvwISDPhaseMasterTableControl table.  The BaseMvwISDPhaseMasterTableControlRow implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of MvwISDPhaseMasterTableControl.
...
public class MvwISDPhaseMasterTableControl : BaseMvwISDPhaseMasterTableControl
{
    // The BaseMvwISDPhaseMasterTableControl class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The MvwISDPhaseMasterTableControlRow class offers another place where you can customize
...
//public class MvwISDPhaseMasterCostTypesRecordControl : BaseMvwISDPhaseMasterCostTypesRecordControl
//{
//      
//        // The BaseMvwISDPhaseMasterCostTypesRecordControl implements the LoadData, DataBind and other
...
// Base class for the MvwISDPhaseMasterCostTypesTableControlRow control on the Show_MvwISDPhaseMaster_Table page.
...
public class BaseMvwISDPhaseMasterCostTypesTableControlRow : VPLookup.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetPhaseGroup1()
        {
            ...
            // this.DataSource is the DatabaseViewpoint%dbo.mvwISDPhaseMasterCostTypes record retrieved from the database.
            // this.PhaseGroup1 is the ASP:Literal on the webpage.
                  
            if (this.DataSource != null && this.DataSource.PhaseGroupSpecified) {
                								
                // If the PhaseGroup is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(MvwISDPhaseMasterCostTypesView.PhaseGroup);
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.PhaseGroup1.Text = formattedValue;
              ...
              this.PhaseGroup1.Text = MvwISDPhaseMasterCostTypesView.PhaseGroup.Format(MvwISDPhaseMasterCostTypesView.PhaseGroup.DefaultValue);
            		
            }
            
            // If the PhaseGroup is NULL or blank, then use the value specified  
            // on Properties.
            if (this.PhaseGroup1.Text == null ||
                this.PhaseGroup1.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.PhaseGroup1.Text = "&nbsp;";
            }
        ...
        MvwISDPhaseMasterTableControlRow parentCtrl;
      				  
          parentCtrl = (MvwISDPhaseMasterTableControlRow)MiscUtils.GetParentControlObject(this, "MvwISDPhaseMasterTableControlRow");		  
        ...
        public virtual void GetPhaseGroup1()
        {
...
//Bryan Check
            ...
            bool hasFiltersMvwISDPhaseMasterTableControl = false;
            hasFiltersMvwISDPhaseMasterTableControl = hasFiltersMvwISDPhaseMasterTableControl && false; // suppress warning
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal PhaseGroup1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PhaseGroup1");
            }
        }
...
// Base class for the MvwISDPhaseMasterCostTypesTableControl control on the Show_MvwISDPhaseMaster_Table page.
...
public class BaseMvwISDPhaseMasterCostTypesTableControl : VPLookup.UI.BaseApplicationTableControl
{
      ...
      public override void DataBind()
      {
        ...
        public virtual WhereClause CreateWhereClause()
        {
          ...
          KeyValue selectedRecordKeyValue = new KeyValue();
              ...
              KeyValue mvwISDPhaseMasterRecordObj = null;
              // make variable assignment here to avoid possible incorrect compiler warning
              KeyValue tmp = mvwISDPhaseMasterRecordObj;
              mvwISDPhaseMasterRecordObj = tmp;
            MvwISDPhaseMasterTableControlRow mvwISDPhaseMasterTableControlObjRow = (MiscUtils.GetParentControlObject(this, "MvwISDPhaseMasterTableControlRow") as MvwISDPhaseMasterTableControlRow);
              
                if (mvwISDPhaseMasterTableControlObjRow != null && mvwISDPhaseMasterTableControlObjRow.GetRecord() != null && mvwISDPhaseMasterTableControlObjRow.GetRecord().PhaseMasterKey != null)
                {
                    wc.iAND(MvwISDPhaseMasterCostTypesView.PhaseMasterKey, BaseFilter.ComparisonOperator.EqualsTo, mvwISDPhaseMasterTableControlObjRow.GetRecord().PhaseMasterKey.ToString());
                }
                else
                {
                    wc.RunQuery = false;
        ...
        public virtual WhereClause CreateWhereClause(String searchText, String fromSearchControl, String AutoTypeAheadSearch, String AutoTypeAheadWordSeparators)
        {
          ...
          string selectedRecordInMvwISDPhaseMasterTableControl = HttpContext.Current.Session["MvwISDPhaseMasterCostTypesTableControlWhereClause"] as string;
          
          if (selectedRecordInMvwISDPhaseMasterTableControl != null && KeyValue.IsXmlKey(selectedRecordInMvwISDPhaseMasterTableControl)) 
          {
              KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInMvwISDPhaseMasterTableControl);
    ...
    MvwISDPhaseMasterCostTypesTableControlRow recControl = (MvwISDPhaseMasterCostTypesTableControlRow)(repItem.FindControl("MvwISDPhaseMasterCostTypesTableControlRow"));
      ...
      MvwISDPhaseMasterCostTypesRecord rec = new MvwISDPhaseMasterCostTypesRecord();
                        ...
                        if (recControl.PhaseGroup1.Text != "") {
                            rec.Parse(recControl.PhaseGroup1.Text, MvwISDPhaseMasterCostTypesView.PhaseGroup);
                  }
      ...
      newRecordList.Add(rec);
        ...
        public virtual void SetPhaseGroupLabel1()
                  {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal PhaseGroupLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PhaseGroupLabel1");
            }
        }
        
        public System.Web.UI.WebControls.Literal PhaseLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PhaseLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual MvwISDPhaseMasterCostTypesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MvwISDPhaseMasterCostTypesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("VPLookup.UI.Controls.Show_MvwISDPhaseMaster_Table.MvwISDPhaseMasterCostTypesTableControlRow")));
        ...
        public MvwISDPhaseMasterCostTypesTableControlRow[] GetRecordControls()
        {
            ...
            return (MvwISDPhaseMasterCostTypesTableControlRow[])recordList.ToArray(Type.GetType("VPLookup.UI.Controls.Show_MvwISDPhaseMaster_Table.MvwISDPhaseMasterCostTypesTableControlRow"));
        }
...
// Base class for the MvwISDPhaseMasterTableControlRow control on the Show_MvwISDPhaseMaster_Table page.
// Do not modify this class. Instead override any method in MvwISDPhaseMasterTableControlRow.
public class BaseMvwISDPhaseMasterTableControlRow : VPLookup.UI.BaseApplicationRecordControl
{
        public BaseMvwISDPhaseMasterTableControlRow()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in MvwISDPhaseMasterTableControlRow.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        public virtual void LoadData()  
        {
            ...
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BaseMvwISDPhaseMasterTableControl when the data for the entire
            // table is loaded.
        ...
        SetMvwISDPhaseMasterCostTypesTableControl();
        ...
        public virtual void SetPhaseGroup()
        {
            ...
            if (this.DataSource != null && this.DataSource.PhaseGroupSpecified) {
                ...
                // If the PhaseGroup is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(MvwISDPhaseMasterView.PhaseGroup);
              ...
              this.PhaseGroup.Text = MvwISDPhaseMasterView.PhaseGroup.Format(MvwISDPhaseMasterView.PhaseGroup.DefaultValue);
        ...
        public virtual void SetMvwISDPhaseMasterCostTypesTableControl()           
        
        {        
            if (MvwISDPhaseMasterCostTypesTableControl.Visible)
            {
                MvwISDPhaseMasterCostTypesTableControl.LoadData();
                MvwISDPhaseMasterCostTypesTableControl.DataBind();
            }
        }
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                // Set the DataChanged flag to True for the for the related panels so they get refreshed as well.
                ((MvwISDPhaseMasterTableControl)MiscUtils.GetParentControlObject(this, "MvwISDPhaseMasterTableControl")).DataChanged = true;
                ((MvwISDPhaseMasterTableControl)MiscUtils.GetParentControlObject(this, "MvwISDPhaseMasterTableControl")).ResetData = true;
            }
            ...
            this.CheckSum = "";
            // For Master-Detail relationships, save data on the Detail table(s)            
          MvwISDPhaseMasterCostTypesTableControl recMvwISDPhaseMasterCostTypesTableControl = (MvwISDPhaseMasterCostTypesTableControl)(MiscUtils.FindControlRecursively(this, "MvwISDPhaseMasterCostTypesTableControl"));
...
//
        ...
        public virtual void ExpandRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                MvwISDPhaseMasterTableControl panelControl = (MiscUtils.GetParentControlObject(this, "MvwISDPhaseMasterTableControl") as MvwISDPhaseMasterTableControl);

          MvwISDPhaseMasterTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (MvwISDPhaseMasterTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "MvwISDPhaseMasterTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../mvwISDPhaseMaster/Show-MvwISDPhaseMaster.aspx?MvwISDPhaseMaster={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseMvwISDPhaseMasterTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseMvwISDPhaseMasterTableControlRow_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public MvwISDPhaseMasterCostTypesTableControl MvwISDPhaseMasterCostTypesTableControl {
            get {
                return (MvwISDPhaseMasterCostTypesTableControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MvwISDPhaseMasterCostTypesTableControl");
            }
        }
...
// Base class for the MvwISDPhaseMasterTableControl control on the Show_MvwISDPhaseMaster_Table page.
// Do not modify this class. Instead override any method in MvwISDPhaseMasterTableControl.
public class BaseMvwISDPhaseMasterTableControl : VPLookup.UI.BaseApplicationTableControl
{
         

       public BaseMvwISDPhaseMasterTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        protected virtual void Control_Load(object sender, EventArgs e)
        {
            ...
            // Setup the sorting events.
              ...
              this.PhaseGroupLabel.Click += PhaseGroupLabel_Click;
            
              this.PhaseLabel.Click += PhaseLabel_Click;
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                        // Initialize an empty array of records
                      ArrayList alist = new ArrayList(0);
                      Type myrec = typeof(VPLookup.Business.MvwISDPhaseMasterRecord);
                      this.DataSource = (MvwISDPhaseMasterRecord[])(alist.ToArray(myrec));
                      // Add records to the list if needed.
                      this.AddNewRecords();
                      this._TotalRecords = 0;
                      this._TotalPages = 0;
                ...
                if (this.AddNewRecord > 0) {
                    // Make sure to preserve the previously entered data on new rows.
                    ArrayList postdata = new ArrayList(0);
                    foreach (MvwISDPhaseMasterTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                            rc.DataSource = rc.GetRecord();
                            rc.GetUIData();
                            postdata.Add(rc.DataSource);
                    ...
                    Type myrec = typeof(VPLookup.Business.MvwISDPhaseMasterRecord);
                    this.DataSource = (MvwISDPhaseMasterRecord[])(postdata.ToArray(myrec));
                } 
                else {
                    // Get the records from the database
        ...
        public virtual MvwISDPhaseMasterRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            // by default, Select * will be executed to get a list of records.  If you want to run Select Distinct with certain column only, add the column to selCols
            ColumnList selCols = new ColumnList();                 
            ...
            // However, if you don't specify PK, row button click might show an error message.
            // And make sure you write similar code in GetRecordCount as well
            // selCols.Add(MvwISDPhaseMasterView.Column1, true);          
            // selCols.Add(MvwISDPhaseMasterView.Column2, true);          
            // selCols.Add(MvwISDPhaseMasterView.Column3, true);          
                  ...
                  
            {
                ...
                return MvwISDPhaseMasterView.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                MvwISDPhaseMasterView databaseTable = new MvwISDPhaseMasterView();
                databaseTable.SelectedColumns.Clear();
                databaseTable.SelectedColumns.AddRange(selCols);
                ...
                orderBy.ExpandForeignKeyColums = false;
                recList = databaseTable.GetRecordList(join, where.GetFilter(), null, orderBy, pageIndex, pageSize);
                return (recList.ToArray(typeof(MvwISDPhaseMasterRecord)) as MvwISDPhaseMasterRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return MvwISDPhaseMasterView.GetRecordCount(join, where);
            else
            {
                MvwISDPhaseMasterView databaseTable = new MvwISDPhaseMasterView();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        // Bind the repeater with the list of records to expand the UI.
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MvwISDPhaseMasterTableControlRepeater"));
        if (rep == null){return;}
        rep.DataSource = this.DataSource;
        rep.DataBind();
        ...
        {
            // Loop through all rows in the table, set its DataSource and call DataBind().
            MvwISDPhaseMasterTableControlRow recControl = (MvwISDPhaseMasterTableControlRow)(repItem.FindControl("MvwISDPhaseMasterTableControlRow"));
            recControl.DataSource = this.DataSource[index];            
            if (this.UIData.Count > index)
                recControl.PreviousUIData = this.UIData[index];
            recControl.DataBind();
        ...
        MvwISDPhaseMasterTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "MvwISDPhaseMasterTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for MvwISDPhaseMasterTableControl pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (MvwISDPhaseMasterTableControlRow recCtl in this.GetRecordControls())
            {
      ...
      cols.Add(MvwISDPhaseMasterView.Description);
      
      cols.Add(MvwISDPhaseMasterView.Notes);
      
      cols.Add(MvwISDPhaseMasterView.Phase);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            VPLookup.Business.MvwISDPhaseMasterRecord[] recordList  = MvwISDPhaseMasterView.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (MvwISDPhaseMasterRecord rec in recordList ){
                ...
                resultItem = rec.Format(MvwISDPhaseMasterView.Description);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(MvwISDPhaseMasterView.Description.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDPhaseMasterView.Description.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(MvwISDPhaseMasterView.Notes);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(MvwISDPhaseMasterView.Notes.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDPhaseMasterView.Notes.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(MvwISDPhaseMasterView.Phase);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(MvwISDPhaseMasterView.Phase.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDPhaseMasterView.Phase.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
    ...
    MvwISDPhaseMasterTableControlRow recControl = (MvwISDPhaseMasterTableControlRow)(repItem.FindControl("MvwISDPhaseMasterTableControlRow"));
      ...
      if (recControl.Visible && recControl.IsNewRecord) {
      MvwISDPhaseMasterRecord rec = new MvwISDPhaseMasterRecord();
        
                        if (recControl.Description.Text != "") {
                            rec.Parse(recControl.Description.Text, MvwISDPhaseMasterView.Description);
                  }
                
                        if (recControl.Phase.Text != "") {
                            rec.Parse(recControl.Phase.Text, MvwISDPhaseMasterView.Phase);
                  }
                
                        if (recControl.PhaseGroup.Text != "") {
                            rec.Parse(recControl.PhaseGroup.Text, MvwISDPhaseMasterView.PhaseGroup);
                  }
      ...
      newRecordList.Add(rec);
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new MvwISDPhaseMasterRecord());
                newUIDataList.Insert(0, new Hashtable());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(VPLookup.Business.MvwISDPhaseMasterRecord);
                this.DataSource = (MvwISDPhaseMasterRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(MvwISDPhaseMasterTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(MvwISDPhaseMasterTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
                    ...
                    
        {
            ...
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Phase {Txt:Ascending}"), "Phase Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Phase {Txt:Descending}"), "Phase Desc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Phase Group {Txt:Ascending}"), "PhaseGroup Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Phase Group {Txt:Descending}"), "PhaseGroup Desc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Phase Master Key {Txt:Ascending}"), "PhaseMasterKey Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Phase Master Key {Txt:Descending}"), "PhaseMasterKey Desc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Proj Minimum Percent {Txt:Ascending}"), "ProjMinPct Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Proj Minimum Percent {Txt:Descending}"), "ProjMinPct Desc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("CGC {Txt:Ascending}"), "udCGCTable Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("CGC {Txt:Descending}"), "udCGCTable Desc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("CGC Table {Txt:Ascending}"), "udCGCTableID Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("CGC Table {Txt:Descending}"), "udCGCTableID Desc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("UD Conv {Txt:Ascending}"), "udConv Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("UD Conv {Txt:Descending}"), "udConv Desc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("UD CSI DIV {Txt:Ascending}"), "udCSIDiv Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("UD CSI DIV {Txt:Descending}"), "udCSIDiv Desc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Parent Phase {Txt:Ascending}"), "udParentPhase Asc"));
                            							
            this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Parent Phase {Txt:Descending}"), "udParentPhase Desc"));
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["MvwISDPhaseMasterTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["MvwISDPhaseMasterTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=MvwISDPhaseMaster" ;
        ...
        public virtual void DescriptionLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(MvwISDPhaseMasterView.Description);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(MvwISDPhaseMasterView.Description, OrderByItem.OrderDir.Asc);
        ...
        public virtual void PhaseGroupLabel_Click(object sender, EventArgs args)
        {
            //Sorts by PhaseGroup when clicked.
              
            // Get previous sorting state for PhaseGroup.
        
            OrderByItem sd = this.CurrentSortOrder.Find(MvwISDPhaseMasterView.PhaseGroup);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for PhaseGroup.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(MvwISDPhaseMasterView.PhaseGroup, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by PhaseGroup, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void PhaseLabel_Click(object sender, EventArgs args)
        {
            //Sorts by Phase when clicked.
              
            // Get previous sorting state for Phase.
        
            OrderByItem sd = this.CurrentSortOrder.Find(MvwISDPhaseMasterView.Phase);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(MvwISDPhaseMasterView.Phase, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = MvwISDPhaseMasterView.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             MvwISDPhaseMasterView.PhaseGroup,
             MvwISDPhaseMasterView.Phase,
             MvwISDPhaseMasterView.Description,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(MvwISDPhaseMasterView.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(MvwISDPhaseMasterView.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(MvwISDPhaseMasterView.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(MvwISDPhaseMasterView.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(MvwISDPhaseMasterView.PhaseGroup, "0"));
             data.ColumnList.Add(new ExcelColumn(MvwISDPhaseMasterView.Phase, "Default"));
             data.ColumnList.Add(new ExcelColumn(MvwISDPhaseMasterView.Description, "Default"));
              ...
              {
                val = MvwISDPhaseMasterView.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-MvwISDPhaseMaster-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "mvwISDPhaseMaster";
                // If Show-MvwISDPhaseMaster-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(MvwISDPhaseMasterView.PhaseGroup.Name, ReportEnum.Align.Right, "${PhaseGroup}", ReportEnum.Align.Right, 15);
                 report.AddColumn(MvwISDPhaseMasterView.Phase.Name, ReportEnum.Align.Left, "${Phase}", ReportEnum.Align.Left, 20);
                 report.AddColumn(MvwISDPhaseMasterView.Description.Name, ReportEnum.Align.Left, "${Description}", ReportEnum.Align.Left, 28);
                ...
                ColumnList columns = MvwISDPhaseMasterView.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = MvwISDPhaseMasterView.GetRecordCount(joinFilter,whereClause);
                MvwISDPhaseMasterRecord[] records = null;
                
                do
                {
                    
                    records = MvwISDPhaseMasterView.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( MvwISDPhaseMasterRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${PhaseGroup}", record.Format(MvwISDPhaseMasterView.PhaseGroup), ReportEnum.Align.Right, 300);
                             report.AddData("${Phase}", record.Format(MvwISDPhaseMasterView.Phase), ReportEnum.Align.Left, 300);
                             report.AddData("${Description}", record.Format(MvwISDPhaseMasterView.Description), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-MvwISDPhaseMaster-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "mvwISDPhaseMaster";
                // If Show-MvwISDPhaseMaster-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        protected virtual void OrderSort_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in MvwISDPhaseMasterView.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(MvwISDPhaseMasterView.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (MvwISDPhaseMasterView.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && MvwISDPhaseMasterView.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(MvwISDPhaseMasterView.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(MvwISDPhaseMasterView.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = MvwISDPhaseMasterView.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
                return (this._TotalRecords);
            }
            set {
        ...
        public  MvwISDPhaseMasterRecord[] DataSource {
            ...
            get {
                return (MvwISDPhaseMasterRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton PhaseGroupLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PhaseGroupLabel");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton PhaseLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PhaseLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            bool needToProcess = AreAnyUrlParametersForMe(url, arg);
            if (needToProcess) {
                MvwISDPhaseMasterTableControlRow recCtl = this.GetSelectedRecordControl();
                if (recCtl == null && url.IndexOf("{") >= 0) {
                    // Localization.
                    throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "VPLookup"));
                }
        ...
        public virtual MvwISDPhaseMasterTableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual MvwISDPhaseMasterTableControlRow[] GetSelectedRecordControls()
        {
        
            return (MvwISDPhaseMasterTableControlRow[])((new ArrayList()).ToArray(Type.GetType("VPLookup.UI.Controls.Show_MvwISDPhaseMaster_Table.MvwISDPhaseMasterTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            MvwISDPhaseMasterTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "VPLookup"));
            }
            
            foreach (MvwISDPhaseMasterTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
                    if (!recCtl.IsNewRecord) {
        ...
        public MvwISDPhaseMasterTableControlRow[] GetRecordControls()
        {
            ArrayList recordList = new ArrayList();
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("MvwISDPhaseMasterTableControlRepeater");
            if (rep == null){return null;}
            foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
            {
              MvwISDPhaseMasterTableControlRow recControl = (MvwISDPhaseMasterTableControlRow)repItem.FindControl("MvwISDPhaseMasterTableControlRow");
            ...
            return (MvwISDPhaseMasterTableControlRow[])recordList.ToArray(Type.GetType("VPLookup.UI.Controls.Show_MvwISDPhaseMaster_Table.MvwISDPhaseMasterTableControlRow"));
        }
