...
// This file implements the code-behind class for Show_MvwISDPhaseMaster.aspx.
// Show_MvwISDPhaseMaster.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_MvwISDPhaseMaster
        : BaseApplicationPage
// Code-behind class for the Show_MvwISDPhaseMaster page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_MvwISDPhaseMaster()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetMvwISDPhaseMasterTabContainer()
        {
            SetMvwISDPhaseMasterTabContainer_Base(); 
        }
        
        public void SetMvwISDPhaseMasterCostTypesTableControl()
        {
            SetMvwISDPhaseMasterCostTypesTableControl_Base(); 
        }
        
        public void SetMvwISDPhaseMasterRecordControl()
        {
            SetMvwISDPhaseMasterRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public VPLookup.UI.Controls.Show_MvwISDPhaseMaster.MvwISDPhaseMasterCostTypesTableControl MvwISDPhaseMasterCostTypesTableControl;
          
        public VPLookup.UI.Controls.Show_MvwISDPhaseMaster.MvwISDPhaseMasterRecordControl MvwISDPhaseMasterRecordControl;
          
        public AjaxControlToolkit.TabContainer MvwISDPhaseMasterTabContainer;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "MvwISDPhaseMasterCostTypesTableControl":
                 SetMvwISDPhaseMasterCostTypesTableControl();
                 break;
          
              case "MvwISDPhaseMasterRecordControl":
                 SetMvwISDPhaseMasterRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.MvwISDPhaseMasterRecordControl.SaveData();
    ...
    DbUtils.StartTransaction();
            ...
            SetMvwISDPhaseMasterTabContainer(); 
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetMvwISDPhaseMasterTabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "MvwISDPhaseMasterTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "MvwISDPhaseMasterTabContainer").Visible = false;
         
  
        }      
      
        public void SetMvwISDPhaseMasterCostTypesTableControl_Base()           
        ...
        public void SetMvwISDPhaseMasterRecordControl_Base()           
        
        {        
            if (MvwISDPhaseMasterRecordControl.Visible)
            {
                MvwISDPhaseMasterRecordControl.LoadData();
                MvwISDPhaseMasterRecordControl.DataBind();
            }
        }
