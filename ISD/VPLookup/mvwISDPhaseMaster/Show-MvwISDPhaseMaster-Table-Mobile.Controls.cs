...
// Show_MvwISDPhaseMaster_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace VPLookup.UI.Controls.Show_MvwISDPhaseMaster_Table_Mobile
{
...
// Base class for the MvwISDPhaseMasterTableControlRow control on the Show_MvwISDPhaseMaster_Table_Mobile page.
...
//
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../mvwISDPhaseMaster/Show-MvwISDPhaseMaster-Mobile.aspx?MvwISDPhaseMaster={PK}";
...
// Base class for the MvwISDPhaseMasterTableControl control on the Show_MvwISDPhaseMaster_Table_Mobile page.
            ...
            foreach (MvwISDPhaseMasterRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDPhaseMasterView.Description.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MvwISDPhaseMasterView.Phase.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (MvwISDPhaseMasterTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        MvwISDPhaseMasterTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual MvwISDPhaseMasterTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MvwISDPhaseMasterTableControlRow[])(selectedList.ToArray(Type.GetType("VPLookup.UI.Controls.Show_MvwISDPhaseMaster_Table_Mobile.MvwISDPhaseMasterTableControlRow")));
        ...
        public MvwISDPhaseMasterTableControlRow[] GetRecordControls()
        {
            ...
            return (MvwISDPhaseMasterTableControlRow[])recordList.ToArray(Type.GetType("VPLookup.UI.Controls.Show_MvwISDPhaseMaster_Table_Mobile.MvwISDPhaseMasterTableControlRow"));
        }
