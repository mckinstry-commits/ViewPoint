...
// This file implements the code-behind class for MvwISDPhaseMaster_QuickSelector.aspx.
// MvwISDPhaseMaster_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
public partial class MvwISDPhaseMaster_QuickSelector
        : BaseApplicationPage
// Code-behind class for the MvwISDPhaseMaster_QuickSelector page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public MvwISDPhaseMaster_QuickSelector()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public VPLookup.UI.Controls.MvwISDPhaseMaster_QuickSelector.SelectorTableControl SelectorTableControl;
    ...
    public static string[] GetAutoCompletionList_Search_Base(string prefixText, int count)
    {
        ...
        VPLookup.UI.Controls.MvwISDPhaseMaster_QuickSelector.SelectorTableControl control = new VPLookup.UI.Controls.MvwISDPhaseMaster_QuickSelector.SelectorTableControl();
