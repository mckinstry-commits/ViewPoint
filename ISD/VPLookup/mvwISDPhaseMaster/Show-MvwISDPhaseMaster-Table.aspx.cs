...
// This file implements the code-behind class for Show_MvwISDPhaseMaster_Table.aspx.
// Show_MvwISDPhaseMaster_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_MvwISDPhaseMaster_Table
        : BaseApplicationPage
// Code-behind class for the Show_MvwISDPhaseMaster_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_MvwISDPhaseMaster_Table()
        {
            this.Initialize();
...
//[System.Web.Services.WebMethod]
//        public static string[] GetAutoCompletionList_MvwISDPhaseMasterCostTypesSearchText1(string prefixText, int count)
//        {
//            // GetMvwISDPhaseMasterCostTypesSearchText1CompletionList gets the list of suggestions from the database.
//            // prefixText is the search text typed by the user .
//            // count specifies the number of suggestions to be returned.
//            // Customize by adding code before or after the call to  GetAutoCompletionList_MvwISDPhaseMasterCostTypesSearchText1_Base()
//            // or replace the call to GetAutoCompletionList_MvwISDPhaseMasterCostTypesSearchText1_Base().
//            return GetAutoCompletionList_MvwISDPhaseMasterCostTypesSearchText1_Base(prefixText, count);
//        }
#endregion
...
#region "Section 2: Do not modify this section."
        ...
        public VPLookup.UI.Controls.Show_MvwISDPhaseMaster_Table.MvwISDPhaseMasterTableControl MvwISDPhaseMasterTableControl;
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        VPLookup.UI.Controls.Show_MvwISDPhaseMaster_Table.MvwISDPhaseMasterTableControl control = new VPLookup.UI.Controls.Show_MvwISDPhaseMaster_Table.MvwISDPhaseMasterTableControl();
