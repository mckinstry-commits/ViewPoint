...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="MvwISDPhaseMaster-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="VPLookup.UI.MvwISDPhaseMaster_QuickSelector" %>
<%@ Register Tagprefix="VPLookup" Namespace="VPLookup.UI.Controls.MvwISDPhaseMaster_QuickSelector" Assembly="VPLookup" %>
