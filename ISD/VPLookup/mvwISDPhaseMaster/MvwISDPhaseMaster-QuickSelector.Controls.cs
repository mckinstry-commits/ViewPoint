...
// MvwISDPhaseMaster_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace VPLookup.UI.Controls.MvwISDPhaseMaster_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the MvwISDPhaseMaster_QuickSelector page.
// Do not modify this class. Instead override any method in SelectorTableControlRow.
public class BaseSelectorTableControlRow : VPLookup.UI.BaseApplicationRecordControl
{
...
// Base class for the SelectorTableControl control on the MvwISDPhaseMaster_QuickSelector page.
// Do not modify this class. Instead override any method in SelectorTableControl.
public class BaseSelectorTableControl : VPLookup.UI.BaseApplicationTableControl
{
       ...
       public BaseSelectorTableControl()
        ...
        {    
            ...
            {
                BaseColumn col = MvwISDPhaseMasterView.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, MvwISDPhaseMasterView.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = MvwISDPhaseMasterView.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
...
#region "Helper Properties"
        ...
        public VPLookup.UI.IThemeButton AddButton {
            get {
                return (VPLookup.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "AddButton");
            }
        }
        
        public VPLookup.UI.IThemeButton ClearButton {
            get {
                return (VPLookup.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ClearButton");
            }
        }
        
        public VPLookup.UI.IThemeButton CommitButton {
            get {
                return (VPLookup.UI.IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CommitButton");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("VPLookup.UI.Controls.MvwISDPhaseMaster_QuickSelector.SelectorTableControlRow")));
        ...
        public SelectorTableControlRow[] GetRecordControls()
        {
            ...
            return (SelectorTableControlRow[])recordList.ToArray(Type.GetType("VPLookup.UI.Controls.MvwISDPhaseMaster_QuickSelector.SelectorTableControlRow"));
        }
