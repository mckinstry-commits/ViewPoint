...
// This file implements the code-behind class for Show_MvwISDCustomerXref.aspx.
// Show_MvwISDCustomerXref.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_MvwISDCustomerXref
        : BaseApplicationPage
// Code-behind class for the Show_MvwISDCustomerXref page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_MvwISDCustomerXref()
        {
            this.Initialize();
...
//        }
        ...
        public void SetMvwISDCustomerXrefTabContainer()
        {
            SetMvwISDCustomerXrefTabContainer_Base(); 
        }
        
        public void SetMvwISDCustomerXrefRecordControl()
        {
            SetMvwISDCustomerXrefRecordControl_Base(); 
        }
        
        public void SetMvwISDJobXrefTableControl()
        {
            SetMvwISDJobXrefTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public VPLookup.UI.Controls.Show_MvwISDCustomerXref.MvwISDCustomerXrefRecordControl MvwISDCustomerXrefRecordControl;
          
        public AjaxControlToolkit.TabContainer MvwISDCustomerXrefTabContainer;
        
        public VPLookup.UI.Controls.Show_MvwISDCustomerXref.MvwISDJobXrefTableControl MvwISDJobXrefTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = "Customer Cross Reference";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "MvwISDCustomerXrefRecordControl":
                 SetMvwISDCustomerXrefRecordControl();
                 break;
          
              case "MvwISDJobXrefTableControl":
                 SetMvwISDJobXrefTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.MvwISDCustomerXrefRecordControl.SaveData();
    ...
    DbUtils.StartTransaction();
            ...
            SetMvwISDCustomerXrefTabContainer(); 
        ...
        SetMvwISDCustomerXrefRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "MvwISDCustomerXrefMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetMvwISDCustomerXrefTabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "MvwISDCustomerXrefTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "MvwISDCustomerXrefTabContainer").Visible = false;
         
  
        }      
      
        public void SetMvwISDCustomerXrefRecordControl_Base()           
        ...
        public void SetMvwISDJobXrefTableControl_Base()           
        
        {        
            if (MvwISDJobXrefTableControl.Visible)
            {
                MvwISDJobXrefTableControl.LoadData();
                MvwISDJobXrefTableControl.DataBind();
            }
        }
