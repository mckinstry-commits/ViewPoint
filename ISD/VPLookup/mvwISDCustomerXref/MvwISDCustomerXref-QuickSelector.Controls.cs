...
// MvwISDCustomerXref_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace VPLookup.UI.Controls.MvwISDCustomerXref_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the MvwISDCustomerXref_QuickSelector page.
...
// Base class for the SelectorTableControl control on the MvwISDCustomerXref_QuickSelector page.
...
public class BaseSelectorTableControl : VPLookup.UI.BaseApplicationTableControl
{
       ...
       public BaseSelectorTableControl()
        ...
        {    
            ...
            {
                BaseColumn col = MvwISDCustomerXrefView.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, MvwISDCustomerXrefView.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = MvwISDCustomerXrefView.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("VPLookup.UI.Controls.MvwISDCustomerXref_QuickSelector.SelectorTableControlRow")));
        ...
        public SelectorTableControlRow[] GetRecordControls()
        {
            ...
            return (SelectorTableControlRow[])recordList.ToArray(Type.GetType("VPLookup.UI.Controls.MvwISDCustomerXref_QuickSelector.SelectorTableControlRow"));
        }
