...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      protected virtual void UserStatusInit() {
        ...
        case null:
        case "":
          this.UserStatusLbl.Text = GetResourceValue("Txt:UserNotSignedIn", "VPLookup");
        break;
        default:
          this.UserStatusLbl.Text = GetResourceValue("Txt:Hello", "VPLookup");
      ...
      protected virtual void SignInButtonInit(){
        ...
        switch (((BaseApplicationPage)(this.Page)).CurrentSecurity.GetUserStatus()) {
          ...
          case "":
              ...
              this.SignIn.Text = GetResourceValue("Txt:SignIn", "VPLookup");
              this.SignIn.ToolTip = GetResourceValue("Txt:SignIn", "VPLookup");
              
            break;
          default:
          
            this.SignIn.Text = GetResourceValue("Txt:SignOut", "VPLookup");
            this.SignIn.ToolTip = GetResourceValue("Txt:SignOut", "VPLookup");
