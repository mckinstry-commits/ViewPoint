...
<%@ Register Tagprefix="VPLookup" Namespace="VPLookup.UI.Controls.Show_MvwISDVendorXref_Table" Assembly="VPLookup" %>

<%@ Register Tagprefix="Selectors" Namespace="VPLookup" Assembly="VPLookup" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Show-MvwISDVendorXref-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="VPLookup.UI.Show_MvwISDVendorXref_Table" %>
		...
		<asp:UpdatePanel runat="server" id="UpdatePanel1" UpdateMode="Conditional">
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td>
                        <VPLookup:MvwISDVendorXrefTableControl runat="server" id="MvwISDVendorXrefTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title" Text="&lt;%#String.Concat(&quot;Vendors&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<BaseClasses:QuickSelector runat="server" id="CityFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                                ...
                                </td></tr><tr><td class="popupTableCellLabel"><asp:Literal runat="server" id="StateLabel1" Text="State">	</asp:Literal></td><td class="popupTableCellValue"><asp:DropDownList runat="server" id="StateFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList> </td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td></tr><tr><td class="popupTableCellLabel"><asp:Literal runat="server" id="IsSubcontractorLabel1" Text="Is Subcontractor">	</asp:Literal></td><td class="popupTableCellValue"><BaseClasses:QuickSelector runat="server" id="IsSubcontractorFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector> </td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td></tr><tr><td class="popupTableCellLabel"><asp:Label runat="server" id="SortByLabel" Text="&lt;%# GetResourceValue(&quot;Txt:SortBy&quot;, &quot;VPLookup&quot;) %>">	</asp:Label></td><td class="popupTableCellValue"><asp:DropDownList runat="server" id="OrderSort" autopostback="True" cssclass="Filter_Input" priorityno="1">	</asp:DropDownList></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td></tr></table>

                          </div>
                        </td><td class="dher"><img src="../Images/space.gif" alt="" /></td></tr></table>

                </td><td class="panelHeaderR"></td></tr><tr><td class="panelL"></td><td>
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="MvwISDVendorXrefTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="2" style="white-space: nowrap"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="thc" style="white-space: nowrap"><asp:LinkButton runat="server" id="VPVendorLabel" Text="VP Vendor" CausesValidation="False">	</asp:LinkButton></th><th class="thc" style="white-space: nowrap"><asp:LinkButton runat="server" id="CGCVendorLabel" Text="CGC Vendor" CausesValidation="False">	</asp:LinkButton></th><th class="thc" style="white-space: nowrap"><asp:LinkButton runat="server" id="VendorNameLabel" Text="Vendor Name" CausesValidation="False">	</asp:LinkButton></th><th class="thc" style="white-space: nowrap"><asp:LinkButton runat="server" id="IsSubcontractorLabel" Text="Is Subcontractor" CausesValidation="False">	</asp:LinkButton></th><th class="thc" style="white-space: nowrap"><asp:LinkButton runat="server" id="AddressLabel" Text="Address" CausesValidation="False">	</asp:LinkButton></th><th class="thc" style="white-space: nowrap"><asp:LinkButton runat="server" id="Address2Label" Text="Address 2" CausesValidation="False">	</asp:LinkButton></th><th class="thc" style="white-space: nowrap"><asp:LinkButton runat="server" id="CityLabel" Text="City" CausesValidation="False">	</asp:LinkButton></th><th class="thc" style="white-space: nowrap"><asp:LinkButton runat="server" id="StateLabel" Text="State" CausesValidation="False">	</asp:LinkButton></th><th class="thc" style="white-space: nowrap"><asp:LinkButton runat="server" id="ZipLabel" Text="ZIP" CausesValidation="False">	</asp:LinkButton></th></tr><asp:Repeater runat="server" id="MvwISDVendorXrefTableControlRepeater">		<ITEMTEMPLATE>		<VPLookup:MvwISDVendorXrefTableControlRow runat="server" id="MvwISDVendorXrefTableControlRow">
...
</td><td class="tableCellValue" style="white-space: nowrap"><asp:Literal runat="server" id="CGCVendor"></asp:Literal></td><td class="tableCellValue" style="white-space: nowrap"><asp:Literal runat="server" id="VendorName"></asp:Literal></td><td class="tableCellValue" style="white-space: nowrap"><asp:Literal runat="server" id="IsSubcontractor"></asp:Literal></td><td class="tableCellValue" style="white-space: nowrap"><asp:Literal runat="server" id="Address"></asp:Literal></td><td class="tableCellValue" style="white-space: nowrap"><asp:Literal runat="server" id="Address2"></asp:Literal></td><td class="tableCellValue" style="white-space: nowrap"><asp:Literal runat="server" id="City"></asp:Literal></td><td class="tableCellValue" style="white-space: nowrap"><asp:Literal runat="server" id="State"></asp:Literal></td><td class="tableCellValue" style="white-space: nowrap"><asp:Literal runat="server" id="Zip"></asp:Literal></td></tr></VPLookup:MvwISDVendorXrefTableControlRow>
</ITEMTEMPLATE>
