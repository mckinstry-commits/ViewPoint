...
#region "Section 2: Do not modify this section."
        ...
        public VPLookup.UI.Controls.Show_MvwISDVendorXref_Table_Mobile.MvwISDVendorXrefTableControl MvwISDVendorXrefTableControl;
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        VPLookup.UI.Controls.Show_MvwISDVendorXref_Table_Mobile.MvwISDVendorXrefTableControl control = new VPLookup.UI.Controls.Show_MvwISDVendorXref_Table_Mobile.MvwISDVendorXrefTableControl();
