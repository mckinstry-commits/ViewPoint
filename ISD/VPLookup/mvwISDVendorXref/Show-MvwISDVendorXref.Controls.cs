...
// Show_MvwISDVendorXref.aspx page.  The Row or RecordControl classes are the 
...
namespace VPLookup.UI.Controls.Show_MvwISDVendorXref
{
...
// Base class for the MvwISDVendorXrefRecordControl control on the Show_MvwISDVendorXref page.
// Do not modify this class. Instead override any method in MvwISDVendorXrefRecordControl.
public class BaseMvwISDVendorXrefRecordControl : VPLookup.UI.BaseApplicationRecordControl
{
...
//Bryan Check
            ...
            bool hasFiltersMvwISDVendorXrefRecordControl = false;
            hasFiltersMvwISDVendorXrefRecordControl = hasFiltersMvwISDVendorXrefRecordControl && false; // suppress warning
...
//
            ...
            if (recId == null || recId.Length == 0) {
                ...
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "VPLookup").Replace("{URL}", "MvwISDVendorXref"));
            }
            HttpContext.Current.Session["QueryString in Show-MvwISDVendorXref"] = recId;
