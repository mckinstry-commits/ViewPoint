...
update DDFIc set DisableInput='Y', ShowGrid='N' where Form in ('JCJPCostTypes','PMCostTypes') and ColumnName in 
(
...
if exists ( select 1 from sysobjects where type='P' and name='mspGenJCCHJobPercentage')
begin
	print 'drop procedure mspGenJCCHJobPercentage'
	drop procedure mspGenJCCHJobPercentage
end
go

print 'create procedure mspGenJCCHJobPercentage'
go

create procedure mspGenJCCHJobPercentage
(
	@JCCo			bCompany
,	@Job		bContract
,	@Month			bMonth
