...
as
-- ========================================================================
-- Object Name: mers.mspGetCostBatchPivot
...
set @query = 'SELECT JCCo, Job, Month, PhaseGroup, Phase, CostType, Equipment, Craft, Class, UM, ' + @cols + ' from 
             (
                select d.JCCo AS JCCo, d.Job, ''' + convert(varchar(10), @dispMonth, 120) + ''' as Month, CH.PhaseGroup, CH.Phase, CH.CostType, PD.Equipment, PD.Craft, PD.Class, PD.UM, PD.Amount,
