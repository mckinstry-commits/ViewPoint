...
--				J.Ziebell  
--				L.Gurdian		3.8.2018	 added JCCo
-- ========================================================================
returns table as return

select b.Contract as ContractOrJob, a.BatchId, a.Mth, 'Revenue' as Type, b.Co as JCCo
	FROM HQBC a 
		INNER JOIN JCIR b
			ON a.Co = b.Co
			AND a.Mth = b.Mth
	...
	WHERE a.Source='JC RevProj'
		...
		AND a.Status<5
UNION
select b.Job as ContractOrJob, a.BatchId, a.Mth, 'Cost' as Type, b.Co as JCCo
	FROM HQBC a 
		INNER JOIN JCPB b
			ON a.Co = b.Co
			AND a.Mth = b.Mth
