...
--				J.Ziebell   10/6/2016  Add GMAX
--              J.Ziebell   12/14/2016 Add FullETC field
--				J.Ziebell   10/19/2017 Add HoursWeeks
-- ========================================================================
...
BEGIN
	INSERT INTO mers.ProphecyLog (VPUserName, DateTime, Version, JCCo, Contract, Job, Mth, BatchId, Action, FullETC, HoursWeeks, Details, ErrorText)
		VALUES (@User, @ActionDate,	@Version, @Company, @Contract, @Job, @bMonth, @BatchId, @Action, @FullETC, @HoursWeeks, @Details, @ErrorTxt)
END
