/*
   Wednesday, December 14, 20162:42:56 PM
   User: 
...
IF EXISTS(SELECT * FROM mers.ProphecyLog)
	 EXEC('INSERT INTO mers.Tmp_ProphecyLog (KeyID, VPUserName, DateTime, Version, JCCo, Contract, Job, Mth, BatchId, Action, Details, ErrorText)
		SELECT KeyID, VPUserName, DateTime, Version, JCCo, Contract, Job, Mth, BatchId, Action, Details, ErrorText FROM mers.ProphecyLog WITH (HOLDLOCK TABLOCKX)')
GO
