...
namespace McKinstry.Data.Viewpoint
{
    public class POs
    {
        public static List<dynamic> GetPOs(string job)
        {
            string _sql = "Select * From dbo.mckfnPOMaster(@Job) ORDER BY 1;";
            ...
            catch (Exception e) { throw new Exception("GetPOs: " + e.Message); }
