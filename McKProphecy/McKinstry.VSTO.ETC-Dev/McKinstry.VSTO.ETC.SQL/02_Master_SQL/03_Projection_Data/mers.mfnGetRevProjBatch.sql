...
-- Description:	Prophecy Project - McKinstry Projections - Select SUM of projection values by Project Phase and Cost Type
...
SELECT 
	...
	, 'CALCME' AS 'Projected Contract'
	, T.ProjCost AS 'Posted Projected Cost'
	, T.ProjCost AS 'Margin Seek'
	, 'CALCME' AS 'Projected Contract Item Margin %'
FROM JCCI I
	INNER JOIN HQCO HQ
		ON I.JCCo = HQ.HQCo
