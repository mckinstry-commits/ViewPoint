...
as
-- ========================================================================
-- Object Name: mers.mspGetCostProjectionHoursPivot
-- Author:		Ziebell, Jonathan
-- Create date: 06/21/2016
-- Description:	Cost Projection Hours Pivot Procedure - Selects all Job Cost Projection Detail with a > 0 Hours Value for a given Job. 
...
set @query = 'SELECT JCCo, Job, Month, PhaseGroup, Phase, CostType, Equipment, Craft, Class, UM, ' + @cols + ' from 
             (
                select d.JCCo, d.Job, ''' + convert(varchar(10), @dispMonth, 120) + ''' as Month, CH.PhaseGroup, CH.Phase, CH.CostType, PR.Equipment, PR.Craft, PR.Class, PR.UM, PR.Hours,
