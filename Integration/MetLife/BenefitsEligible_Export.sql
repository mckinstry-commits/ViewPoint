...
,	ber.STATE
,	ber.ZIPCODE
,	(substring(ber.BIRTHDATE,1,2) + '/' + substring(ber.BIRTHDATE,3,2) + '/' + substring(ber.BIRTHDATE,5,4)) AS BIRTHDATE
,	(substring(ber.HIREDATE,1,2) + '/' + substring(ber.HIREDATE,3,2) + '/' + substring(ber.HIREDATE,5,4)) AS HIREDATE
