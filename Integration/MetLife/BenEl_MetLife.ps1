...
$script:logFile = $script:homeDir + "\Log\MetLifeProcessLog_" + + (Get-Date -format "yyyyMMdd") + ".txt" 
...
$script:HostName = "METFTP2.METLIFE.COM"
$script:UserName = "XT17130478"
#Testing
$script:Password= "Dkny001!"
#Production
