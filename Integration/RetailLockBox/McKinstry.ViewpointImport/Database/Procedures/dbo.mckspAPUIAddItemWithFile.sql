...
SELECT @rcode = -1, @RetVal = -1, @HeaderKeyID = -1, @FooterKeyID = -1, @AttachmentID = -1, @UniqueAttachmentID = NULL, @AttachmentFilePath = NULL, @Notes = NULL, 
	@AttachParamsCheck=1, @AttachCheck=1, @HeaderParamsCheck=1, @HeaderCheck=1, @FooterParamsCheck=1, @FooterCheck=1, @UnmatchedParamsCheck=1, @UnmatchedCheck=1
...
-- Zero invoice amount means unmatched
...
EXECUTE @rcode = [dbo].[mckspAPUIAdd] @Company, @UIMonth, @VendorGroup, @Vendor, @CollectedInvoiceNumber, @Description, @Notes, @CollectedInvoiceDate, 
...
IF @rcode<>0
	BEGIN
		BEGIN TRY
			...
			EXECUTE @rcode = [dbo].[mckspAPUIAdd] @UnmatchedCompany, @UIMonth, @UnmatchedVendorGroup, @UnmatchedVendor, @CollectedInvoiceNumber, '*', @Notes, @CollectedInvoiceDate, 
				@CollectedInvoiceAmount, @CollectedShippingAmount, @HeaderKeyID OUTPUT, @UISeq OUTPUT
