...
,	[VendorGroup]
,	CAST([Vendor] AS VARCHAR(20)) AS Vendor
,	[VendorName]
,	[TransactionDate]
,	[JCCo]
,	[Job]
,	[JobDescription]
,	REPLACE(REPLACE([PurchaseOrderDescription],char(10),' '),char(13),' ') AS Description
,	[DetailLineCount]
,	[TotalOrigCost]
,	[TotalOrigTax]
,	[RemainingAmount]
...
,	[Job]
,	[JobDescription]
,	REPLACE(REPLACE([SubcontractDescription],char(10),' '),char(13),' ')
,	[DetailLineCount]
,	[SLOriginalCost]
,	[SLOriginalTax]
,	[Amount]
...
,	[Job]
,	[JobDescription]
,	REPLACE(REPLACE([PurchaseOrderDescription],char(10),' '),char(13),' ')
,	[DetailLineCount]
,	[MaxLimit]
,	[TotalOrigTax]
,	[RemainingAmount]
