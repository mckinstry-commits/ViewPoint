...
namespace McK.APImport.Viewpoint
{
    internal class APImport
    {
        ...
        public string Name => "McKinstry Viewpoint AP Import";
        ...
        /// </summary>
        public APImport(int importBatchID)
        {
            //this.importBatchID = importBatchID;
            this.batchID = importBatchID;
        ...
        public void RunImport()
        {
            ...
            try
            {
                ...
                string[] exceptionFiles = Directory.Exists(file.ExceptionsPath) ? Directory.GetFiles(file.ExceptionsPath, "*.pdf", SearchOption.TopDirectoryOnly)
                                                   .Select(f => Path.GetFileName(f)).ToArray<string>() : new string[0];
                ...
                ViewpointDb viewpointDb = new ViewpointDb();
