...
namespace McK.APImport.Viewpoint
{
    ...
    {
        public string Name => "Process New AP Exceptions Command";

        public string Description => "Updates unprocessed AP records with new exceptions added to Exceptions folder in AP manual processing.";
