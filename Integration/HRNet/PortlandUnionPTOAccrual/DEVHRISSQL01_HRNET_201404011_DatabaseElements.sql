...
--insert [mnepto].[TimeCardManualEntries] ( CompanyNumber, EmployeeNumber, EmployeeName, WeekEnding, GroupID, RegularHours, OvertimeHours, OtherHours, OtherHoursType )  select /*@tmpRowId,*/ 1, 184,'',20140119,null,0,0,4,'38'
...
FROM 
	...
	[mnepto].[mvwActiveEmployees] e ON
