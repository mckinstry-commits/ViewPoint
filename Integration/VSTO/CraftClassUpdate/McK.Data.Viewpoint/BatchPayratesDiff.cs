...
namespace McK.Data.Viewpoint
{
    public static partial class Batch
    {
        ...
        public static List<dynamic> PayratesDiff(uint? batch)
        {
            ...
            try
            {
                using (SqlConnection _conn = new SqlConnection(HelperData._conn_string))
                {
                    ...
                    using (var _cmd = new SqlCommand("dbo.MCKspPRCPdiff", _conn))
                    {
            ...
            {
                ex.Data.Add(0, "Batch.PayratesDiff");
                throw ex;
            }
            return table;
        }

        //public static List<dynamic> PayratesNotInVP(uint? batch)
        //{
        //    SqlParameter _batch = new SqlParameter("@Rbatchid", SqlDbType.Int)
        //    {
        //        SqlValue = batch ?? (object)DBNull.Value
        ...
        //            using (var _cmd = new SqlCommand("dbo.MCKspPRCPnotInVP", _conn))
        //            {
        //                CancelToken.Token.ThrowIfCancellationRequested();
        //                CancelToken.Token.Register(() => _cmd?.Cancel());
        ...
        //    catch (Exception ex)
        //    {
        //        ex.Data.Add(0, "Batch.PayratesNotInVP");
        //        throw ex;
        //    }
        //    return table;
        //}
