...
namespace McK.Data.Viewpoint
{
    public static class CloseBatch
    {
        ...
        public static uint? MCKspContractCloseBatch(byte JCCo, string mth, char closeType)
        {
            const string _sql = @"EXEC dbo.MCKspContractCloseBatch @co=@JCCo, @month=@mth, @Istatus=@status, @Rbatchid=@batchId output;";
