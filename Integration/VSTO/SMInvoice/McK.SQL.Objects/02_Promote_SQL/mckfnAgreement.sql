...
AS
 /* 
	...
	08.20.19 LG add Fire verbaige TFS 5164
...
, CAST(CAST(MIN(CONVERT(NVARCHAR(20),A.EffectiveDate, 1)) as VARCHAR(20)) + ' - ' + CAST(MAX(CONVERT(NVARCHAR(20),A.ExpirationDate,1))as VARCHAR(20)) as VARCHAR(800)) 
	+ CASE WHEN S.Division = 'FIRE' THEN  '  FIRE PROTECTION SERVICE BILLING AS PER AGREEMENT' -- TFS 5164
		ELSE  ' PREVENTIVE MAINTENANCE BILLING AS PER AGREEMENT'
	  END
	AS BillingPeriod 
...
Select * From dbo.mckfnAgreement(1, '10701', '10075160' ) -- FIRE
*/