...
AS
 /* 
	...
	08.20.2019 LG - Remove "Service Repair" as default for FIRE - TFS 5164
 ...
 IF @flat = 1
  BEGIN
	...
	SELECT DISTINCT --TOP (10) 
			...
			, CASE WHEN smdiv.udGLDept IN ('0250','0251') AND S.PriceMethod = 'F' THEN '' -- TFS 4172, 4780 FIRE STANDARD description 6.11.19 LG
					ELSE	
						CASE WHEN Q.WorkOrderQuote IS NULL THEN
