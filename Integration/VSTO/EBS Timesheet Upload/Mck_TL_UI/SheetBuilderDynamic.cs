...
namespace Mck_TL_UI
{
    public static class SheetBuilderDynamic
    {
        ...
        public static Excel.ListObject BuildTable(Excel.Worksheet ws, List<dynamic> table, string tableName, int atRow = 3, int atColumn = 1, bool showTotals = true, bool bandedRows = false)
        {
            ...
            try
            {
                ...
                _rng2 = ws.Cells[headerRow + totalRows, atColumn + any_row.Count - 1];
