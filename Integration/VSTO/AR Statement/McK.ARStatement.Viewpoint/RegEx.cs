...
namespace McK.ARStatement.Viewpoint
{
    public static class RegEx
    {
        ...
        private const string _illegalInFileName = @"[\\/:*?""<>|]";
        ...
        //public static string GetValidFileName(string input, string illegalInFileName = _illegalInFileName)
        //{
        //    Regex rx = new Regex(illegalInFileName, RegexOptions.Compiled | RegexOptions.Multiline);
        //    if (rx.Matches(input).Count > 0 )
        //    {
        //        foreach (var c in rx.Matches)
        //        {
