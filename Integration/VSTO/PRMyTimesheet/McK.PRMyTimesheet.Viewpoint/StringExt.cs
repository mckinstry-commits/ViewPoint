...
namespace McK.PRMyTimesheet.Viewpoint
{
    ...
    public static class StringExt
    {
        ...
        /// <param name="comp">Optional compare type</param>
        /// <returns></returns>
        public static bool EqualsIgnoreCase(this string lookIn, string lookFor, System.StringComparison comp = StringComparison.OrdinalIgnoreCase) => string.Equals(lookIn, lookFor, comp);
