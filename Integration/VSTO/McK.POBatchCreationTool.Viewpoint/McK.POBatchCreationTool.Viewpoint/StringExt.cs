...
namespace McK.POBatchCreationTool.Viewpoint
{
    ...
    public static class StringExt
    {
        ...
        /// <returns></returns>
        public static bool Contains(this string lookIn, string lookFor, System.StringComparison comp = StringComparison.OrdinalIgnoreCase) => lookIn.IndexOf(lookFor, comp) >= 0;
