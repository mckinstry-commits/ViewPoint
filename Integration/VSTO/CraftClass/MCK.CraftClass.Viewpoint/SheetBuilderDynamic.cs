...
namespace MCK.CraftClass.Viewpoint
{
    public static class SheetBuilderDynamic
    {
        ...
        public static Excel.ListObject BuildTable(Excel.Worksheet ws, List<dynamic> table, string tableName, int offsetFromLastUsedCell = 3, bool showTotals = true, bool bandedRows = false)

        {
            ...
            try
            {
                ...
                listObject = HelperUI.FormatAsTable(_rng, "tbl" + tableName, showTotals: showTotals, bandedRows: bandedRows);
                ...
                foreach (KeyValuePair<string, object> _field in any_row) 
                {
                    ...
                    if (datatype_value.Key == "String" || datatype_value.Key == "Double" || datatype_value.Key == "Byte" || datatype_value.Key == "Int16" ||
                    ...
                    else if (datatype_value.Key == "Decimal")
                    {
