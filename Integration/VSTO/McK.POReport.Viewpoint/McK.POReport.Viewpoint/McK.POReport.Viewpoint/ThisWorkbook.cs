...
namespace McK.POReport.Viewpoint
{
    public partial class ThisWorkbook
    {
        ...
        private void ThisWorkbook_Startup(object sender, System.EventArgs e)
        {
            ...
            this.Application.CommandBars["Task Pane"].Width = 155;
        ...
        private void ThisWorkbook_BeforeClose(ref bool Cancel)
        {
            try
            {
                if (POs.UniquePOs != 0)
                {
                    string wkbName = "McK PO"; 
                    wkbName += POs.UniquePOs > 1 ? "s " + _actionPane.txtPOFrom.Text + " - " + _actionPane.txtPOTo.Text : " " + _actionPane.txtPOFrom.Text;
