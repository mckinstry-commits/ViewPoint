...
namespace McK.Data.Viewpoint
{
    ...
    {
        /// <summary>
        /// Get SM Quotes Summary view
        /// </summary>
        /// <param name="SMCo">SM Company</param>
        /// <param name="quoteStatus">A-Approved, C-Cancelled, N-New</param>
        ...
        /// <returns></returns>
        public static List<dynamic> GetQuotesSumView(byte SMCo, int customer, string workOrderQuote, char quoteStatus)
        {
            ...
            try
            {
                ...
                {
                    using (var _cmd = new SqlCommand("Select * From dbo.mckfnGetSMQuotesSumView(@SMCo, @Customer, @WorkOrderQuote, @QuoteStatus)", _conn))
                    {
                        _conn.Open();
            ...
            {
                ex.Data.Add(0, "QuotesSearch.GetQuotesSumView");
                throw ex;
            }
            return tableOut;
        }
