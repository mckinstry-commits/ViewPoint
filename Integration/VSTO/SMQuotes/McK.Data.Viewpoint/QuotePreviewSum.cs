...
namespace McK.Data.Viewpoint
{
    public static partial class QuotePreview
    {
        ...
        /// <returns></returns>
        public static List<dynamic> GetQuoteSummary(byte SMCo, int customer, string workOrderQuote)
        {
            ...
            try
            {
                ...
                {
                    using (var _cmd = new SqlCommand("Select * From dbo.mckfnGetSMQuoteSum(@SMCo, @Customer, @WorkOrderQuote)", _conn))
                    {
                        _conn.Open();
            ...
            {
                ex.Data.Add(0, "QuotePreview.GetQuoteSummary");
                throw ex;
            }
            return tableOut;
        }
