...
function doEmail {
	...
	$script:emailToList="billo@mckinstry.com,erptest@mckinstry.com"
	...
	$msg.subject = "Adaptive Planning Budget Export Export [" + $Server + "." + $Database + "]"
	
#	$script:msgBody = "<B><FONT COLOR='RED'>Live Production</FONT></B><BR/><HR/>"
