...
alter FUNCTION mfnBenefitEligibleEmployeesFromVP
(
...
SELECT * FROM dbo.mfnBenefitEligibleEmployeesFromVP('9/1/2013')
SELECT * FROM dbo.mfnBenefitEligibleEmployeesFromVP('9/8/2013')
SELECT * FROM dbo.mfnBenefitEligibleEmployeesFromVP(null) ORDER BY PeriodEnding